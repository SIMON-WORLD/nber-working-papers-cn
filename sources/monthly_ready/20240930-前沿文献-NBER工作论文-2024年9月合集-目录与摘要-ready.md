# 【前沿文献】NBER工作论文 2024年9月合集 目录与摘要

> 2024 年 9 月 NBER 更新 116 篇工作论文，其中与中国研究相关的有 3 篇（20、31、102）。
> 其中，中国相关研究包括：#32993（第 20 篇，中国：威权主义2.0）；#32982（第 31 篇，大规模挖掘中国历史文献：一种研究清朝国家能力的机器学习方法）；#32910（第 102 篇，日本进口中的计价货币与汇率传递：面板VAR分析）。

## 一、目录速览

1. **APT or “AIPT”? The Surprising Dominance of Large Factor Models {#33012}**  
   APT还是“AIPT”？大型因子模型的惊人主导地位  
   <font color=grey>Antoine Didisheim, Shikun (Barry) Ke, Bryan T. Kelly, Semyon Malamud</font>

2. **Fear and Dreams: Understanding the Non-Institutional sources of Leader Strategy {#33011}**  
   恐惧与梦想：理解领导人战略的非制度性来源  
   <font color=grey>Maria Angélica Bautista, Juan Sebastián Galán, James A. Robinson, Rafael F. Torres, Ragnar Torvik</font>

3. **Social Interactions, Information, and Preferences for Schools: Experimental Evidence from Los Angeles {#33010}**  
   社会互动、信息与学校偏好：来自洛杉矶的实验证据  
   <font color=grey>Christopher Campos</font>

4. **Intergenerational Transmission of Occupation: Lessons from the United States Army {#33009}**  
   职业的代际传递：来自美国陆军的教训  
   <font color=grey>Kyle Greenberg, Matthew Gudgeon, Adam Isen, Corbin L. Miller, Richard W. Patterson</font>

5. **The Unintended Consequences of Merit-based Teacher Selection: Evidence from Large-scale Reform in Colombia {#33008}**  
   基于绩效的教师选拔的非预期后果：来自哥伦比亚大规模改革的证据  
   <font color=grey>Matias Busso, Sebastián Montaño, Juan S. Muñoz-Morales, Nolan G. Pope</font>

6. **Estimating the Regional Welfare Impact of Tariff Changes: Application to the United States {#33007}**  
   估算关税变化的区域福利影响：以美国为例  
   <font color=grey>Robert C. Feenstra, Chang Hong</font>

7. **Cross-Border Shopping: Evidence and Welfare Implications for Switzerland {#33006}**  
   跨境购物：瑞士的证据与福利影响  
   <font color=grey>Ariel Burstein, Sarah M. Lein, Jonathan Vogel</font>

8. **Do Elite Universities Overpay Their Faculty? {#33005}**  
   精英大学是否向其教师支付过高薪酬？  
   <font color=grey>Cesar Luis Garro-Marin, Shulamit Kahn, Kevin Lang</font>

9. **Finance Without Exotic Risk {#33004}**  
   无奇异风险的金融  
   <font color=grey>Pedro Bordalo, Nicola Gennaioli, Rafael La Porta, Andrei Shleifer</font>

10. **Currency Centrality in Equity Markets, Exchange Rates and Global Financial Cycles {#33003}**  
   股票市场、汇率与全球金融周期中的货币中心性  
   <font color=grey>Hélène Rey, Vania Stavrakeva, Jenny Tang</font>

11. **Child Penalties and Parental Role Models: Classroom Exposure Effects {#33002}**  
   子女惩罚与父母角色模型：课堂接触效应  
   <font color=grey>Henrik Kleven, Giulia Olivero, Eleonora Patacchini</font>

12. **Financial Advice and Investor Beliefs: Experimental Evidence on Active vs. Passive Strategies {#33001}**  
   金融建议与投资者信念：关于主动与被动策略的实验证据  
   <font color=grey>Antoinette Schoar, Yang Sun</font>

13. **Capital-Skill Complementarity in Firms and in the Aggregate Economy {#33000}**  
   企业与总体经济中的资本-技能互补性  
   <font color=grey>Giuseppe Berlingieri, Filippo Boeri, Danial Lashkari, Jonathan Vogel</font>

14. **Welfare in the Volunteer’s Dilemma {#32999}**  
   志愿者困境中的福利  
   <font color=grey>Marco Battaglini, Thomas R. Palfrey</font>

15. **Interdealer Price Dispersion and Intermediary Capacity {#32998}**  
   交易商间价格离散与中介能力  
   <font color=grey>Andrea L. Eisfeldt, Bernard Herskovic, Shuo Liu</font>

16. **Hours Worked and Lifetime Earnings Inequality {#32997}**  
   工作时间与终生收入不平等  
   <font color=grey>Alexander Bick, Adam Blandin, Richard Rogerson</font>

17. **Bridging the Gaps: The Impact of Interregional Transmission on Emissions and Reliability {#32996}**  
   弥合差距：区域间输电对排放与可靠性的影响  
   <font color=grey>Audun Botterud, Christopher R. Knittel, John Parsons, Juan Ramon Senga, Drew Story</font>

18. **The Efficiency of Dynamic Electricity Prices {#32995}**  
   动态电价的效率  
   <font color=grey>Andrew J. Hinchberger, Mark R. Jacobsen, Christopher R. Knittel, James M. Sallee, Arthur A. van Benthem</font>

19. **Nonparametric Estimation of Demand with Switching Costs: the Case of Habitual Brand Loyalty {#32994}**  
   具有转换成本的需求非参数估计：习惯性品牌忠诚度案例  
   <font color=grey>Xinyao Kong, Jean-Pierre H. Dubé, Øystein Daljord</font>

20. **China: Autocracy 2.0 {#32993}**  
   中国：威权主义2.0  
   <font color=grey>David Y. Yang</font>

21. **Equity and Efficiency in Technology Adoption: Evidence from Digital Health {#32992}**  
   技术采纳中的公平与效率：来自数字健康的证据  
   <font color=grey>Itzik Fadlon, Parag Agnihotri, Christopher Longhurst, Ming Tai-Seale</font>

22. **Fiscal and Monetary Policy with Heterogeneous Agents {#32991}**  
   异质性主体下的财政与货币政策  
   <font color=grey>Adrien Auclert, Matthew Rognlie, Ludwig Straub</font>

23. **Cultural Remittances and Modern Fertility {#32990}**  
   文化汇款与现代生育率  
   <font color=grey>Mickael Melki, Hillel Rapoport, Enrico Spolaore, Romain Wacziarg</font>

24. **Privacy Protection and Accuracy: What Do We Know? Do We Know Things?? Let's Find Out! {#32989}**  
   隐私保护与准确性：我们知道什么？我们知道事情吗？？让我们一探究竟！  
   <font color=grey>Evan S. Totty, Thor Watson</font>

25. **Evaluating Monetary Policy Counterfactuals: (When) Do We Need Structural Models? {#32988}**  
   评估货币政策反事实：我们何时需要结构性模型？  
   <font color=grey>Tomás E. Caravello, Alisdair McKay, Christian K. Wolf</font>

26. **Theodore Roosevelt, the Election of 1912, and the Founding of the Federal Reserve {#32987}**  
   西奥多·罗斯福、1912年大选与美联储的创立  
   <font color=grey>Matthew S. Jaremski, David C. Wheelock</font>

27. **Do Investor Differences Impact Monetary Policy Spillovers to Emerging Markets? {#32986}**  
   投资者差异会影响货币政策对新兴市场的溢出效应吗？  
   <font color=grey>Ester Faia, Karen K. Lewis, Haonan Zhou</font>

28. **Are We Adapting to Climate Change? {#32985}**  
   我们正在适应气候变化吗？  
   <font color=grey>Marshall Burke, Mustafa Zahid, Mariana C. M. Martins, Christopher W. Callahan, Richard Lee, Tumenkhusel Avirmed, Sam Heft-Neal, Mathew Kiang, Solomon M. Hsiang, David Lobell</font>

29. **Investing in Vaccines to Mitigate Harm from COVID-19 and Future Pandemics {#32984}**  
   投资疫苗以减轻COVID-19和未来大流行病的危害  
   <font color=grey>Rachel Glennerster, Catherine Che, Sarrin M. Chethik, Claire T. McMahon, Christopher M. Snyder</font>

30. **On the Identifying Power of Generalized Monotonicity for Average Treatment Effects {#32983}**  
   论广义单调性对平均处理效应的识别力  
   <font color=grey>Yuehao Bai, Shunzhuang Huang, Sarah Moon, Azeem Shaikh, Edward J. Vytlacil</font>

31. **Mining Chinese Historical Sources At Scale: A Machine Learning-Approach to Qing State Capacity {#32982}**  
   大规模挖掘中国历史文献：一种研究清朝国家能力的机器学习方法  
   <font color=grey>Wolfgang Keller, Carol H. Shiue, Sen Yan</font>

32. **The Economics of Recycling Heterogeneity {#32981}**  
   回收异质性的经济学  
   <font color=grey>Don Fullerton, Thomas C. Kinnaman</font>

33. **Economic Policy Challenges for the Age of AI {#32980}**  
   人工智能时代的经济政策挑战  
   <font color=grey>Anton Korinek</font>

34. **Synthetic Data and Social Science Research: Accuracy Assessments and Practical Considerations from the SIPP Synthetic Beta {#32979}**  
   合成数据与社会科学研究：来自SIPP合成测试版的准确性评估与实践考量  
   <font color=grey>Jordan C. Stanley, Evan S. Totty</font>

35. **Despair and Death in the United States {#32978}**  
   美国的绝望与死亡  
   <font color=grey>Christopher J. Ruhm</font>

36. **Who should work how much? {#32977}**  
   谁应该工作多少？  
   <font color=grey>Timo Boppart, Per Krusell, Jonna Olsson</font>

37. **Exchange Rates, Natural Rates, and the Price of Risk {#32976}**  
   汇率、自然利率与风险价格  
   <font color=grey>Rohan Kekre, Moritz Lenel</font>

38. **The Selective Disclosure of Evidence: An Experiment {#32975}**  
   证据的选择性披露：一项实验  
   <font color=grey>Agata Farina, Guillaume Fréchette, Alessandro Ispano, Alessandro Lizzeri, Jacopo Perego</font>

39. **Entry Costs Rise with Growth {#32974}**  
   进入成本随增长而上升  
   <font color=grey>Peter J. Klenow, Huiyu Li</font>

40. **Behavioral Attenuation {#32973}**  
   行为衰减  
   <font color=grey>Benjamin Enke, Thomas Graeber, Ryan Oprea, Jeffrey Yang</font>

41. **Perry Preschool at 50: What Lessons Should Be Drawn and Which Criticisms Ignored? {#32972}**  
   佩里学前教育项目50周年：应汲取哪些教训，忽略哪些批评？  
   <font color=grey>Alison W. Baulos, Jorge Luis García, James J. Heckman</font>

42. **Midlife Health and Later Life Economic Inequality {#32971}**  
   中年健康与晚年经济不平等  
   <font color=grey>Nicolò Russo, Rory McGee, Mariacristina De Nardi, Margherita Borella, Ross Abram</font>

43. **Moving to Opportunity, Together {#32970}**  
   共同迁徙，把握机遇  
   <font color=grey>Seema Jayachandran, Lea Nassal, Matthew J. Notowidigdo, Marie Paul, Heather Sarsons, Elin Sundberg</font>

44. **A Secure Query System to Improve Access to Individual Income Tax Data {#32969}**  
   改善个人所得税数据访问的安全查询系统  
   <font color=grey>Amy O'Hara, Stephanie Straus, Ron Borzekowski, Paul Arnsberger, Barry Johnson</font>

45. **Experimentally Validating Welfare Evaluation of School Vouchers {#32968}**  
   实验验证学校代金券的福利评估  
   <font color=grey>Peter Arcidiacono, Karthik Muralidharan, John D. Singleton</font>

46. **Of Markets and Marriages: A Multidisciplinary, Multibook Review Essay of Recent Work on the Causes of U.S. Poverty {#32967}**  
   市场与婚姻：关于美国贫困成因近期著作的多学科、多书评论文  
   <font color=grey>Elizabeth Ananat</font>

47. **The Rapid Adoption of Generative AI {#32966}**  
   生成式人工智能的快速采用  
   <font color=grey>Alexander Bick, Adam Blandin, David J. Deming</font>

48. **Patent Hunters {#32965}**  
   专利猎手  
   <font color=grey>Lauren Cohen, Umit Gurun, Katie Moon, Paula Suh</font>

49. **Do Higher Tipped Minimum Wages Reduce Race, Ethnic, or Gender Earnings Gaps for Restaurant Workers? {#32964}**  
   提高含小费最低工资能否缩小餐饮业员工的种族、民族或性别收入差距？  
   <font color=grey>David Neumark, Emma Wohl</font>

50. **Climate Change through the Lens of Macroeconomic Modeling {#32963}**  
   宏观经济建模视角下的气候变化  
   <font color=grey>Jesús Fernández-Villaverde, Kenneth Gillingham, Simon Scheidegger</font>

51. **Aid for Incumbents: The Electoral Consequences of COVID-19 Relief {#32962}**  
   对现任者的援助：新冠疫情救济的选举后果  
   <font color=grey>Jeffrey Clemens, Julia A. Payson, Stan Veuger</font>

52. **Optimal Financing of Government Purchases {#32961}**  
   政府购买的最优融资  
   <font color=grey>Andrew B. Abel, Stavros Panageas</font>

53. **Green Bonds: New Label, Same Projects {#32960}**  
   绿色债券：新标签，老项目  
   <font color=grey>Pauline Lam, Jeffrey Wurgler</font>

54. **The Impact of Early Childhood Parenting Interventions on Child Learning: A Systematic Review and Meta-Analysis {#32959}**  
   早期儿童养育干预对儿童学习的影响：系统综述与元分析  
   <font color=grey>Kimberly Dadisman, Andre Nickow, Philip Oreopoulos</font>

55. **The Distributional Consequences of Trade: Evidence from the Grain Invasion {#32958}**  
   贸易的分配后果：来自谷物入侵的证据  
   <font color=grey>Stephan Heblich, Stephen J. Redding, Yanos Zylberberg</font>

56. **The Resilience of Central, Eastern and Southeastern Europe (CESEE) Countries During ECB’s Monetary Cycles {#32957}**  
   中欧、东欧和东南欧国家在欧洲央行货币政策周期中的韧性  
   <font color=grey>Joshua Aizenman, Jamel Saadaoui</font>

57. **Why Do Workers Dislike Inflation? Wage Erosion and Conflict Costs {#32956}**  
   工人为何厌恶通胀？工资侵蚀与冲突成本  
   <font color=grey>Joao Guerreiro, Jonathon Hazell, Chen Lian, Christina Patterson</font>

58. **Measuring the Costs and Benefits of Regulation {#32955}**  
   衡量监管的成本与收益  
   <font color=grey>Matilde Bombardini, Francesco Trebbi, Miao Ben Zhang</font>

59. **Inclusive Teaching: Spotting Social Isolation in the Classroom {#32954}**  
   包容性教学：识别课堂中的社会孤立  
   <font color=grey>Sule Alan, Michela Carlana, Marinella Leone</font>

60. **The Increasing Cost of Buying American {#32953}**  
   购买美国货的日益高昂成本  
   <font color=grey>Matilde Bombardini, Andres Gonzalez-Lira, Bingjing Li, Chiara Motta</font>

61. **Horowitz-Manski-Lee Bounds With Multilayered Sample Selection {#32952}**  
   多层样本选择下的Horowitz-Manski-Lee界  
   <font color=grey>Kory Kroft, Ismael Mourifié, Atom Vayalinkal</font>

62. **Putting the "Finance" into "Public Finance": A Theory of Capital Gains Taxation {#32951}**  
   将“金融”注入“公共财政”：资本利得税理论  
   <font color=grey>Mark A. Aguiar, Benjamin Moll, Florian Scheuer</font>

63. **Hell with the Lid Off: Racial Segregation and Environmental Equity in America’s Most Polluted City {#32950}**  
   揭开地狱之盖：美国污染最严重城市的种族隔离与环境公平  
   <font color=grey>H. Spencer Banzhaf, William Mathews, Randall Walsh</font>

64. **Information and Market Power in DeFi Intermediation {#32949}**  
   DeFi中介中的信息与市场势力  
   <font color=grey>Pablo D. Azar, Adrian Casillas, Maryam Farboodi</font>

65. **Hidden Debt Revelations {#32947}**  
   隐性债务的揭示  
   <font color=grey>Sebastian Horn, David Mihalyi, Philipp Nickol, César Sosa-Padilla</font>

66. **Social Status, Economic Development and Female Labor Force (Non) Participation {#32946}**  
   社会地位、经济发展与女性劳动力（非）参与  
   <font color=grey>Kaivan Munshi, Swapnil Singh</font>

67. **Inflation Expectation and Cryptocurrency Investment {#32945}**  
   通胀预期与加密货币投资  
   <font color=grey>Lin William Cong, Pulak Ghosh, Jiasun Li, Qihong Ruan</font>

68. **Cournot Competition, Informational Feedback, and Real Efficiency {#32944}**  
   古诺竞争、信息反馈与实际效率  
   <font color=grey>Lin William Cong, Xiaohong Huang, Siguang Li, Jian Ni</font>

69. **Work from Home and Disability Employment {#32943}**  
   居家办公与残疾人就业  
   <font color=grey>Nicholas Bloom, Gordon B. Dahl, Dan-Olof Rooth</font>

70. **Expected EPS × Trailing P/E {#32942}**  
   预期每股收益 × 历史市盈率  
   <font color=grey>Itzhak Ben-David, Alex Chinco</font>

71. **Voting Rules, Turnout, and Economic Policies {#32941}**  
   投票规则、投票率与经济政策  
   <font color=grey>Enrico Cantoni, Vincent Pons, Jérôme Schäfer</font>

72. **Data Privacy for Record Linkage and Beyond {#32940}**  
   记录链接及其他场景中的数据隐私  
   <font color=grey>Shurong Lin, Eric Kolaczyk</font>

73. **The Effect of Inflation Uncertainty on Household Expectations and Spending {#32939}**  
   通胀不确定性对家庭预期和支出的影响  
   <font color=grey>Olena Kostyshyna, Luba Petersen</font>

74. **Firm Productivity and Learning with Digital Technologies: Evidence from Cloud Computing {#32938}**  
   数字技术下的企业生产率与学习：来自云计算的证据  
   <font color=grey>James M. Brand, Mert Demirer, Connor Finucane, Avner A. Kreps</font>

75. **Carbon VIX: Carbon Price Uncertainty and Decarbonization Investments {#32937}**  
   碳VIX：碳价不确定性与脱碳投资  
   <font color=grey>Maximilian Fuchs, Johannes Stroebel, Julian Terstegge</font>

76. **Perpetual Futures Pricing {#32936}**  
   永续期货定价  
   <font color=grey>Damien Ackerer, Julien Hugonnier, Urban Jermann</font>

77. **Assessing Nonresponse Bias in Macro Indicators by Combining Para-, Administrative, and Survey Data {#32935}**  
   结合准数据、行政数据和调查数据评估宏观指标中的无应答偏差  
   <font color=grey>Ori Heffetz, Guy Lichtinger, Daniel B. Reeves</font>

78. **Patent Text and Long-Run Innovation Dynamics: The Critical Role of Model Selection {#32934}**  
   专利文本与长期创新动态：模型选择的关键作用  
   <font color=grey>Ina Ganguli, Jeffrey Lin, Vitaly Meursault, Nicholas F. Reynolds</font>

79. **Climate Capitalists {#32933}**  
   气候资本家  
   <font color=grey>Niels Joachim Gormsen, Kilian Huber, Sangmin Simon Oh</font>

80. **The New Digital Divide {#32932}**  
   新的数字鸿沟  
   <font color=grey>Mayana Pereira, Shane Greenstein, Raffaella Sadun, Prasanna Tambe, Lucia Ronchi Darre, Tammy Glazer, Allen Kim, Rahul Dodhia, Juan Lavista Ferres</font>

81. **Black Reparations and Child Well-Being: A Framework and Policy Considerations {#32931}**  
   黑人赔偿与儿童福祉：一个框架与政策考量  
   <font color=grey>Lisa A. Gennetian, Christina M. Gibson-Davis, William Darity</font>

82. **Democracy, Capitalism, and Equality: The Importance of Impersonal Rules {#32930}**  
   民主、资本主义与平等：非人格化规则的重要性  
   <font color=grey>Naomi R. Lamoreaux, John Joseph Wallis</font>

83. **Gender Reveals in the Labor Market: Evidence on Gender Signaling and Statistical Discrimination in an Online Health Care Market {#32929}**  
   劳动力市场中的性别揭示：在线医疗市场中性别信号与统计歧视的证据  
   <font color=grey>Haoran He, David Neumark, Qian Weng</font>

84. **Business Failures by Branch of Business in the United States, 1895 to 1935: A Statistical History {#32928}**  
   美国各行业的企业破产情况，1895年至1935年：一部统计史  
   <font color=grey>Gary Richardson, Marco Del Angel, Michael Gou</font>

85. **Instrumental Variables with Unobserved Heterogeneity in Treatment Effects {#32927}**  
   存在处理效应未观测异质性时的工具变量方法  
   <font color=grey>Magne Mogstad, Alexander Torgovitsky</font>

86. **The Realities Of Disclosure Risks In The Age Of Dark Patterns And Big Data {#32926}**  
   暗黑模式与大数据时代信息披露风险的真实状况  
   <font color=grey>Ramon Abraham A. Sarmiento</font>

87. **Own-Wage Elasticity: Quantifying the Impact of Minimum Wages on Employment {#32925}**  
   自身工资弹性：量化最低工资对就业的影响  
   <font color=grey>Arindrajit Dube, Ben Zipperer</font>

88. **The Nonlinear Effects of Air Pollution on Health: Evidence from Wildfire Smoke {#32924}**  
   空气污染对健康的非线性影响：来自野火烟雾的证据  
   <font color=grey>Nolan H. Miller, David Molitor, Eric Zou</font>

89. **An Anatomy of Firms’ Political Speech {#32923}**  
   企业政治言论的剖析  
   <font color=grey>Pablo Ottonello, Wenting Song, Sebastian Sotelo</font>

90. **Estimating Flexible Income Processes from Subjective Expectations Data: Evidence from India and Colombia {#32922}**  
   从主观预期数据估计灵活的收入过程：来自印度和哥伦比亚的证据  
   <font color=grey>Manuel Arellano, Orazio Attanasio, Samuel Crossman, Víctor Sancibrián</font>

91. **Optimal Monetary Policy with Redistribution {#32921}**  
   考虑再分配的最优货币政策  
   <font color=grey>Jennifer La'O, Wendy A. Morrison</font>

92. **Judges Judging Judges: Polarization in the U.S. Courts of Appeals {#32920}**  
   法官评判法官：美国上诉法院中的极化现象  
   <font color=grey>Alma Cohen, Rajeev H. Dehejia</font>

93. **Optimal Trade Policies and Labor Markets {#32919}**  
   最优贸易政策与劳动力市场  
   <font color=grey>Yan Bai, Dan Lu, Hanxi Wang</font>

94. **Businesses and Borrowing during the Roaring ‘20s and at the Onset of the Great Depression {#32918}**  
   咆哮的二十年代与大萧条初期企业的借贷行为  
   <font color=grey>Gary Richardson, Marco Del Angel</font>

95. **Credit Scores: Performance and Equity {#32917}**  
   信用评分：表现与公平性  
   <font color=grey>Stefania Albanesi, Domonkos F. Vamossy</font>

96. **Racial Differences in the Total Rate of Return on Owner-Occupied Housing {#32916}**  
   自住住房总回报率的种族差异  
   <font color=grey>Rebecca Diamond, William F. Diamond</font>

97. **Is Broader Always Better? Preexisting Distortions, Emissions Elasticities, and the Scope of Emissions Pricing {#32915}**  
   更广泛总是更好吗？既有扭曲、排放弹性与排放定价的范围  
   <font color=grey>Lawrence H. Goulder, Marc A.C. Hafstead, Roberton C. Williams III</font>

98. **Optimal Monetary and Fiscal Policies in Disaggregated Economies {#32914}**  
   非加总经济中的最优货币与财政政策  
   <font color=grey>Lydia Cox, Jiacheng Feng, Gernot Müller, Ernesto Pastén, Raphael Schoenle, Michael Weber</font>

99. **Effective Regulation and Firm Compliance: The Case of German Privacy Policies {#32913}**  
   有效监管与企业合规：德国隐私政策的案例  
   <font color=grey>Jacopo Gambato, Bernhard Ganglmair, Julia K. Krämer</font>

100. **Understanding the Impact of Low-Cost Loans on Forced Labor {#32912}**  
   理解低成本贷款对强迫劳动的影响  
   <font color=grey>Anisha Sharma, Manisha Shah, Beata Łuczywek</font>

101. **How Do Holistic Wrap-Around Anti-Poverty Programs Affect Employment and Individualized Outcomes? {#32911}**  
   整体性全方位反贫困项目如何影响就业和个性化结果？  
   <font color=grey>Javier Espinosa, William N. Evans, David C. Phillips, Tim Spilde</font>

102. **Invoicing Currency and Exchange Rate Pass-Through in Japanese Imports: A Panel VAR Analysis {#32910}**  
   日本进口中的计价货币与汇率传递：面板VAR分析  
   <font color=grey>Taiyo Yoshimi, Uraku Yoshimoto, Takatoshi Ito, Kiyotaka Sato, Junko Shimizu, Yushi Yoshida</font>

103. **The Case for Researching Applied Privacy Enhancing Technologies {#32909}**  
   研究应用型隐私增强技术的理由  
   <font color=grey>Claire M. Bowen, Joshua Snoke, Aaron R. Williams, Andrés F. Barrientos</font>

104. **Skills and Human Capital in the Labor Market {#32908}**  
   劳动力市场中的技能与人力资本  
   <font color=grey>David J. Deming, Mikko I. Silliman</font>

105. **Failing Banks {#32907}**  
   失败银行  
   <font color=grey>Sergio A. Correia, Stephan Luck, Emil Verner</font>

106. **Adapting to Misspecification {#32906}**  
   适应模型误设  
   <font color=grey>Timothy Armstrong, Patrick M. Kline, Liyang Sun</font>

107. **The Complexities of Differential Privacy for Survey Data {#32905}**  
   差分隐私在调查数据中的复杂性  
   <font color=grey>Jörg Drechsler, James Bailie</font>

108. **Trade, Innovation and Firm Financing {#32904}**  
   贸易、创新与企业融资  
   <font color=grey>Paul Bergin, Ling Feng, Ching-Yi Lin</font>

109. **Privacy Elasticity: A (Hopefully) Useful New Concept {#32903}**  
   隐私弹性：一个（希望是）有用的新概念  
   <font color=grey>Inbal Dekel, Rachel Cummings, Ori Heffetz, Katrina Ligett</font>

110. **Restaurant Employment, Minimum Wages, and Border Discontinuities {#32902}**  
   餐饮业就业、最低工资与边界不连续性  
   <font color=grey>Arindrajit Dube, Michael Reich, Akash Bhatt, Denis Sosinskiy</font>

111. **What’s Across the Border? Re-Evaluating the Cross-Border Evidence on Minimum Wage Effects {#32901}**  
   边界对面是什么？重新评估最低工资效应的跨境证据  
   <font color=grey>Priyaranjan Jha, David Neumark, Antonio Rodriguez-Lopez</font>

112. **Reassessing Sources of Risk Premiums in Currency Markets {#32900}**  
   重新评估货币市场风险溢价的来源  
   <font color=grey>Mikhail Chernov, Magnus Dahlquist, Lars A. Lochstoer</font>

113. **Incentives to Vaccinate {#32899}**  
   疫苗接种激励措施  
   <font color=grey>Pol Campos-Mercade, Armando N. Meier, Stephan Meier, Devin G. Pope, Florian H. Schneider, Erik Wengström</font>

114. **Equilibrium Evictions {#32898}**  
   均衡驱逐  
   <font color=grey>Dean Corbae, Andrew Glover, Michael Nattinger</font>

115. **Federal Pandemic Relief and Academic Recovery {#32897}**  
   联邦疫情救助与学业恢复  
   <font color=grey>Dan C. Dewey, Erin M. Fahle, Thomas J. Kane, Sean F. Reardon, Douglas O. Staiger</font>

116. **(Dis)Information Wars {#32896}**  
   （虚假）信息战  
   <font color=grey>Adrian Casillas, Maryam Farboodi, Layla Hashemi, Maryam Saeedi, Steven Wilson</font>
...
【**Author**】: Antoine Didisheim, Shikun (Barry) Ke, Bryan T. Kelly, Semyon Malamud
...
【**摘要**】：我们提出了人工智能定价理论（AIPT）。与APT关于收益率存在低维因子结构的基础假设相反，AIPT推测收益率是由大量因子驱动的。我们首先通过实证验证了这一推测，并表明，与更简单的基准模型相比，使用数量惊人的因子（远多于训练观测值或基础资产数量）的复杂非线性模型在描述资产收益率的样本外行为方面要成功得多。从经济角度看，我们表明，复杂模型对长期宏观经济活动的敏感性是更简单基准模型的两倍以上。最后，我们从理论上刻画了大型因子定价模型的行为，并由此表明，AIPT的“多因子”推测忠实地解释了我们的实证发现，而APT的“少因子”推测则与数据相矛盾。

【**NBER**】: NBER Working Paper No. 33012，https://www.nber.org/papers/w33012

#### 2. Fear and Dreams: Understanding the Non-Institutional sources of Leader Strategy {#33011}

【**Author**】: Maria Angélica Bautista, Juan Sebastián Galán, James A. Robinson, Rafael F. Torres, Ragnar Torvik
...
【**摘要**】：政治领导人的政策选择往往难以通过制度来解释。我们利用哥伦比亚准军事组织的行为作为研究环境，探讨在如何结合公共品供给与暴力以控制民众方面，非制度性来源的差异。我们假设，一个重要的差异来源在于准军事指挥官的社会偏好。互惠者采取一种策略，即提供公共品以换取支持，但也使用暴力来惩罚那些不回报的人。互惠性是通过童年社会化形成的，是农村“农民”的一个特征。我们构建了一个模型来生成这些假设，并使用从过渡时期司法文件中编制的独特数据集对其进行了检验。

【**NBER**】: NBER Working Paper No. 33011，https://www.nber.org/papers/w33011
...
【**摘要**】：本文衡量了家长对学校质量和同伴质量的信念，关于每种质量的信息如何影响学校选择和学生成果，以及社会互动如何调节这些效应。家长低估了学校质量，高估了同伴质量。交叉随机化的学校质量和同伴质量信息，结合一个溢出效应设计表明，当家长收到信息时，他们及其邻居的偏好转向了增值更高的学校，这突显了家长对学校质量的更强偏好以及社会互动的作用。这些需求反应转化为真实的教育收益。接触到改进信息的学龄儿童进入了更有效的学校，取得了更高的考试成绩，报告了改善的社会情感福祉，并且更有可能进入大学。实验证据表明，即使在控制同伴质量的条件下，家长也重视学校效能，并且改善信息环境可以提升许多与政策相关的成果。

【**NBER**】: NBER Working Paper No. 33010，https://www.nber.org/papers/w33010

#### 4. Intergenerational Transmission of Occupation: Lessons from the United States Army {#33009}

【**Author**】: Kyle Greenberg, Matthew Gudgeon, Adam Isen, Corbin L. Miller, Richard W. Patterson
...
【**摘要**】：本文利用武装部队资格测试中父母服役资格的不连续性，估计了军队中职业的代际因果传递。父母在陆军服役使其子女的从军倾向增加了58%至110%。代际职业传递率因种族和性别而异——对于其父母从服役中获得最大经济收益的人口群体以及同性别的亲子对而言，该比率最高。我们的发现为驱动代际职业相关性的机制提供了新证据，并表明增加获得良好职业的机会是改善弱势群体代际经济流动性的重要渠道。

【**NBER**】: NBER Working Paper No. 33009，https://www.nber.org/papers/w33009

#### 5. The Unintended Consequences of Merit-based Teacher Selection: Evidence from Large-scale Reform in Colombia {#33008}

【**Author**】: Matias Busso, Sebastián Montaño, Juan S. Muñoz-Morales, Nolan G. Pope
...
【**摘要**】：教师质量是提高学生学业成绩的关键因素。因此，教育政策制定者努力设计系统以招聘最有效的教师。本文考察了哥伦比亚一项国家政策改革的影响，该改革建立了一个基于绩效的教师招聘系统，旨在提高教师质量并改善学生学习。该政策于2005年在所有公立学校实施，将教师招聘决策与候选人在评估学科知识和教学能力的考试中的表现挂钩。该政策的实施导致许多有经验的合同教师被考试表现优异的新手教师所取代。我们发现，尽管该政策大幅提高了教师的大学入学前考试成绩，但它也降低了教师经验的总体存量，并导致学生考试成绩和受教育程度的急剧下降。使用双重差分策略比较公立和私立学校学生在二十多年间的成果，我们表明，这项招聘改革使学生在高中毕业考试中的成绩下降了8%个标准差，并将学生进入大学和大学毕业的可能性降低了超过10%。这些结果强调，仅依赖特定的教师质量事前衡量标准来筛选候选人，特别是以牺牲教师经验为代价，可能会无意中减少学生的学习收益。

【**NBER**】: NBER Working Paper No. 33008，https://www.nber.org/papers/w33008
...
【**摘要**】：我们提出了一种实证方法，使用超越对数支出函数来估算进口关税变化对区域福利的影响，并将此方法应用于美国。假设关税收入按人均分配，因此，对于这些产品，产量较大的州将从关税中获得福利收益（由于生产者剩余增加），而产量较少的州将遭受损失（由于消费者剩余减少）。在2002年至2017年间，我们发现28个州从降低的关税中受益，2017年全国福利收益为58亿美元，即每户50美元。这些全国性收益在2017年后的关税增加中被抵消，2019年每户全国损失为57美元，到2022年上升至每户103美元，但仍有25个州获得收益。这些对关税增加造成的全国性损失的估计低于其他针对2017-2019年期间的研究结果，原因是本研究纳入了产品排除条款，这些条款降低了对某些产品的关税，同时也由于计算方法上的差异。

【**NBER**】: NBER Working Paper No. 33007，https://www.nber.org/papers/w33007

#### 7. Cross-Border Shopping: Evidence and Welfare Implications for Switzerland {#33006}

【**Author**】: Ariel Burstein, Sarah M. Lein, Jonathan Vogel
...
【**摘要**】：消费者通过在国内购买或出国购物来获取外国商品。我们展示了瑞士家庭跨境购物的新事实，例如，相同产品的价格在邻国更低，跨境购物份额随距边境距离的增加而下降，以及价格差距和跨境购物份额在2015年瑞士法郎升值后上升。我们使用一个简单的跨境购物模型来量化，跨境购物在空间上的差异如何导致生活成本对国际价格变化（如2015年瑞士法郎升值和2020年与新冠疫情相关的边境关闭）的异质性反应。

【**NBER**】: NBER Working Paper No. 33006，https://www.nber.org/papers/w33006

#### 8. Do Elite Universities Overpay Their Faculty? {#33005}

【**Author**】: Cesar Luis Garro-Marin, Shulamit Kahn, Kevin Lang
...
【**摘要**】：精英大学是否向其教师支付过高薪酬？如果你相信AKM模型，答案是否定的。然而，尽管AKM模型拟合良好，但在这种情况下，它不太可能是正确的解释。

【**NBER**】: NBER Working Paper No. 33005，https://www.nber.org/papers/w33005
...
【**摘要**】：我们通过使用分析师对盈利增长的实际预期来解决横截面资产定价中的联合假设问题。我们构建了一个基于预期的回报（EBRs）的公司层面指标，该指标利用分析师的预测误差和修正，并消除了所需回报的任何横截面差异。我们得到了三个结果。首先，EBRs的变动解释了价值、投资、规模和动量因子中横截面回报差异的很大一部分。其次，这些差异的时间变化是可预测的，并且由EBRs的可预测时间变化所代理。即使控制了可能捕捉时变所需回报差异的缩放价格变量，这一结果仍然成立。第三，通常被视为捕捉风险的公司特征预测了预期（以及EBRs）的落空。总体而言，通常归因于奇异风险因子的回报差异，可以通过公司盈利增长的非理性预期的可预测变动来解释。

【**NBER**】: NBER Working Paper No. 33004，https://www.nber.org/papers/w33004

#### 10. Currency Centrality in Equity Markets, Exchange Rates and Global Financial Cycles {#33003}

【**Author**】: Hélène Rey, Vania Stavrakeva, Jenny Tang
...
【**摘要**】：本文实证探讨了汇率与全球股票持有网络之间的紧密联系。汇率可以用“股票净货币供给”来表示，即以投资者货币计价的本地股票市场市值减去股票持有量，以及反映货币在全球股票市场中“中心性”的弹性。我们的汇率分解的观测成分平均解释了28种货币对美元双边汇率月度变动的95%，以及对欧元双边汇率月度变动的98%。我们利用这一分解来阐明美元在通过全球股票网络传递风险厌恶和美国宏观经济新闻方面的独特作用。我们的发现有助于解释全球金融周期和“风险偏好”/“风险规避”时期。

【**NBER**】: NBER Working Paper No. 33003，https://www.nber.org/papers/w33003

#### 11. Child Penalties and Parental Role Models: Classroom Exposure Effects {#33002}

【**Author**】: Henrik Kleven, Giulia Olivero, Eleonora Patacchini
...
【**摘要**】：本文研究了子女对女性相对于男性劳动力市场结果的影响——即子女惩罚——是否受到青春期同伴父母工作行为的塑造。利用学校内不同年级队列中拥有在职母亲的同伴比例的外生变化，我们发现，更多地接触在职母亲会降低日后生活中就业方面的子女惩罚。这一效应在经济意义上显著，估计精确，并且在各种设定下稳健。关于机制的证据表明，这些效应是由将母亲就业作为父母角色模型的接触所驱动的，从而塑造了劳动力市场中与子女相关的性别差距。

【**NBER**】: NBER Working Paper No. 33002，https://www.nber.org/papers/w33002

#### 12. Financial Advice and Investor Beliefs: Experimental Evidence on Active vs. Passive Strategies {#33001}

【**Author**】: Antoinette Schoar, Yang Sun
...
【**摘要**】：通过一项随机对照试验，我们测试了散户投资者如何根据不同类型的金融建议来评估和更新他们的先验信念，这些建议要么与其先验信念一致，要么相悖。我们比较了强调被动投资策略（如分散化和低费用）或主动策略（如选股和市场择时）好处的建议。我们发现，当建议与其先验信念一致而非相悖时，参与者对建议的评价显著更高。但人们会朝着所收到建议的方向更新他们对投资策略的信念，而与其先验信念无关。同时，基于受试者的金融素养存在显著的异质性。金融素养较高的受试者在看到被动建议时会积极更新，但大多数人在接触主动建议时不会更新（并且对建议给予负面评价）。相比之下，金融素养较低的受试者则受到两种类型建议的强烈影响。最后，如果认为顾问的激励不匹配，与激励更匹配的情况相比，受试者对建议的评价更低。

【**NBER**】: NBER Working Paper No. 33001，https://www.nber.org/papers/w33001

#### 13. Capital-Skill Complementarity in Firms and in the Aggregate Economy {#33000}

【**Author**】: Giuseppe Berlingieri, Filippo Boeri, Danial Lashkari, Jonathan Vogel
...
【**摘要**】：我们在一个多部门框架中研究资本-技能互补性，该框架具有企业特定的多要素生产函数，并允许企业特定的要素价格楔子。我们以企业层面的要素间替代弹性、企业与部门间的替代弹性以及要素密集度来刻画技能溢价对资本设备价格的弹性。利用法国数据，我们提供了这些企业层面弹性的可信识别。结合这些要素，我们首次识别了总体资本-技能互补性，同时允许企业、行业和总体层面不可观测的技能偏向型技术进步存在任意趋势。我们发现总体资本-技能互补性在经济和统计上均显著，但仅凭这一力量不足以产生数据中观察到的高技能工人相对需求的全部增长。技能增进型技术进步（并非体现在资本设备中）发挥了重要作用。

【**NBER**】: NBER Working Paper No. 33000，https://www.nber.org/papers/w33000
...
【**摘要**】：我们研究了具有异质性偏好和私人信息环境下的志愿者困境。我们刻画了均衡的效率特征，这与以往所有仅关注群体成功概率的文献不同。虽然成功概率可能随群体规模非单调变化，但我们表明人均福利对所有类型总是递增的，对足够高的类型严格递增。随着群体规模增加，每种类型的期望效用收敛到具有最低可能成本类型的期望效用，这与不存在搭便车问题时的期望效用相同，即当游戏中只有一个参与者且该参与者具有最低可能成本时。

【**NBER**】: NBER Working Paper No. 32999，https://www.nber.org/papers/w32999

#### 15. Interdealer Price Dispersion and Intermediary Capacity {#32998}

【**Author**】: Andrea L. Eisfeldt, Bernard Herskovic, Shuo Liu
...
【**摘要**】：不同交易商的中介能力存在差异，因此信用风险的错配降低了交易商部门的风险承担能力，并增加了市场层面的有效风险厌恶。当交易商部门内部信用风险的有效再配置受损时，交易商间的价格离散会增加。实证上，当交易商间价格离散增加时，债券价格下降。交易商间价格离散解释了债券利差变化、债券回报横截面以及债券利差与公允价值利差之间基差变化的很大一部分。我们得出结论，交易商间的摩擦降低了中介的风险承担能力，并且对中介债券定价至关重要。

【**NBER**】: NBER Working Paper No. 32998，https://www.nber.org/papers/w32998
...
【**摘要**】：我们利用NLSY79数据记录了终生工作时间的巨大差异，并认为这些差异是终生收入不平等的重要来源。为了确立这一点，我们开发并校准了一个丰富的异质性代理人模型，该模型包含劳动供给和人力资本积累，允许工作偏好、初始人力资本和学习能力的异质性，以及整个生命周期中人力资本的异质性冲击。我们的校准模型表明，终生收入方差中近20%可由终生工作时间的差异解释，其中超过90%的影响来自偏好的异质性。更高的终生工作时间通过两个渠道对终生收入做出贡献：直接渠道（在给定生产率下更多时间用于生产）和人力资本渠道（更多时间用于投资人力资本，从而提高未来生产率）。终生工作时间对终生收入的影响中大约一半来自人力资本渠道。对于许多工人来说，更高的终生工作时间也是生命周期中向上收入流动性的重要来源。

【**NBER**】: NBER Working Paper No. 32997，https://www.nber.org/papers/w32997

#### 17. Bridging the Gaps: The Impact of Interregional Transmission on Emissions and Reliability {#32996}

【**Author**】: Audun Botterud, Christopher R. Knittel, John Parsons, Juan Ramon Senga, Drew Story
...
【**摘要**】：近几十年来，风能和太阳能发电成本的大幅下降显著改变了能源格局。随着这些技术在经济上变得可行，即使没有严格的脱碳政策，区域间输电的作用也日益重要。本研究考察了在当前政策和深度脱碳情景下，区域间输电对美国电网的价值。通过利用GenX容量扩展模型，我们评估了拟议的《大电网法案》（BIG WIRES Act），该法案规定了最低区域间输电能力要求。我们的分析聚焦于四个关键领域：区域间输电建设与电网特性、电力系统成本节约、极端天气事件下的电网可靠性以及气候效益。结果显示，在当前政策下，该法案可使区域间输电能力增加68%，每年节省系统成本4.87亿美元，并减少4333万吨二氧化碳排放。在95%的二氧化碳减排要求下，效益甚至更大。该研究强调了区域间输电在优化可再生能源利用、增强电网可靠性以及实现成本节约和减排方面的重要性。

【**NBER**】: NBER Working Paper No. 32996，https://www.nber.org/papers/w32996

#### 18. The Efficiency of Dynamic Electricity Prices {#32995}

【**Author**】: Andrew J. Hinchberger, Mark R. Jacobsen, Christopher R. Knittel, James M. Sallee, Arthur A. van Benthem
...
【**摘要**】：电力的边际成本每小时都在波动，但零售客户通常面临固定价格。利用美国所有七个批发市场的数据以及一种评估预先设定替代费率的新方法（该方法考虑了均衡价格效应），我们估算了通过更好地使价格与成本保持一致的分时电价计划所带来的效率收益。我们有三项主要发现。首先，分时电价和关键峰值定价这两种最常见的时间变化电价计划，各自纠正了约10%的错误定价。其次，基于历史价格的复杂费率结构往往适得其反。第三，带有价格上限的实时电价可以捕获大部分潜在效率收益，同时限制客户风险。

【**NBER**】: NBER Working Paper No. 32995，https://www.nber.org/papers/w32995

#### 19. Nonparametric Estimation of Demand with Switching Costs: the Case of Habitual Brand Loyalty {#32994}

【**Author**】: Xinyao Kong, Jean-Pierre H. Dubé, Øystein Daljord
...
【**摘要**】：我们研究习惯性品牌忠诚度，这是最早被实证研究的转换成本形式之一，也是消费者需求中结构性状态依赖的经典来源。辅助工具和经济动机驱动的限制可以收紧选择面板数据中品牌忠诚度程度的非参数界限。我们还证明，嵌套在我们非参数框架中的经典动态离散选择模型，具有“内置”的排除限制，这些限制在半参数上识别了折现因子，并且对于转换成本的标准参数化，可以点识别它。对几个大型消费品类别的案例研究表明，在所研究的类别中，品牌忠诚度至少占观察到的选择的10.8%，但不超过72.2%。在某些类别中，它占观察到的重复购买行为的90%以上。消费者被发现具有前瞻性，但比实际利率所暗示的更加缺乏耐心。

【**NBER**】: NBER Working Paper No. 32994，https://www.nber.org/papers/w32994
...
【**摘要**】：以现代中国为代表的威权主义2.0，经济强劲、技术先进、全球参与，并通过微妙而复杂的方法进行控制。是什么定义了中国政治经济学，又是什么驱动了威权主义2.0？其未来方向如何？我首先讨论威权主义面临的两个关键挑战：激励和信息。然后，我描述了威权主义1.0如何依赖恐惧和压制来解决这些问题。它不做任何可信的承诺，使用强制手段来确保服从，导致低信息环境。接下来，我介绍威权主义2.0，强调其在处理承诺和信息挑战方面的重大转变。中国利用经济激励使个人利益与政权生存保持一致，从而培养支持。它采用先进的官僚结构和技术来管理激励和信息，使其能够在高信息环境中取得成功。最后，我探讨了威权主义3.0的潜力。在中国，随着增长放缓但期望依然高涨，各种力量可能会回归威权主义1.0，利用技术进行国家控制。在全球范围内，以中国为首的现代威权主义正成为主要的地缘政治力量，挑战自由民主秩序。

【**NBER**】: NBER Working Paper No. 32993，https://www.nber.org/papers/w32993

#### 21. Equity and Efficiency in Technology Adoption: Evidence from Digital Health {#32992}

【**Author**】: Itzik Fadlon, Parag Agnihotri, Christopher Longhurst, Ming Tai-Seale
...
【**摘要**】：数字技术正在为现代社会带来巨大进步，但如果被服务不足的社区以较低比率采纳，也存在着加剧差距的风险。我们通过研究一项“远程患者监测”干预措施来调查数字健康技术进步中的效率和公平问题，该措施使患者能够传输实时临床数据以获得及时治疗。该项目在学术医疗中心加州大学圣地亚哥健康中心面向多样化的患者群体实施，针对高血压管理以降低心血管疾病风险。从效率角度来看，我们发现心血管风险显著且持续降低，这在性别、年龄、种族/民族和地理富裕程度的所有子群体中都很显著。证据表明，其机制既包括减少了护理提供中的摩擦，也包括改善了健康行为。该项目还因高血压控制改善而显著降低了医疗保健利用成本。然而，从公平角度来看，我们发现该计划带来的长期健康收益在服务不足的患者亚群中有所不足，导致了心血管风险降低方面的不平等。新技术被黑人和西班牙裔患者以及来自弱势地理社区的患者系统性地以较低比率采纳，他们要么不太可能参与该项目，要么不太可能坚持该项目。总体而言，我们的分析强调了数字健康技术同时带来的希望和风险。我们进一步提供证据表明，初级保健医生及其与患者关系的性质，可以在促进更广泛和更公平地采纳数字健康方面发挥有希望的作用。

【**NBER**】: NBER Working Paper No. 32992，https://www.nber.org/papers/w32992
...
【**摘要**】：在过去十年中，一种新的财政与货币政策分析范式已经出现，它将收入和财富不平等的经典宏观模型与新凯恩斯模型相结合。这些异质性主体新凯恩斯（“HANK”）模型具有新的传导渠道，并允许联合研究总量效应和分配效应。我们通过一个经典HANK模型的视角回顾了这一文献的关键发展。货币和平衡预算财政政策具有与标准新凯恩斯模型相似的总量效应，而赤字融资的财政政策则更具扩张性。我们讨论了政策的直接效应和间接效应之间的划分，以及周期性收入风险、期限结构、名义资产、行为摩擦和模型的许多其他扩展的含义。在整个过程中，我们强调了使用序列空间方法求解和分析这类模型的好处。

【**NBER**】: NBER Working Paper No. 32991，https://www.nber.org/papers/w32991

#### 23. Cultural Remittances and Modern Fertility {#32990}

【**Author**】: Mickael Melki, Hillel Rapoport, Enrico Spolaore, Romain Wacziarg
...
【**摘要**】：我们认为，在19世纪末，移民在人口转变从法国扩散到欧洲其他地区的过程中发挥了重要作用。利用1850年至1930年来自其他欧洲地区向法国移民的新数据，我们发现，在几十年后，向法国的移民增加转化为原籍地区生育率的降低——无论是在不同时期的跨地区回归中，还是在包含地区固定效应的面板设定中。这些结果在包含各种控制变量以及多种设定下都是稳健的。我们还发现，那些自己成为法国公民的移民实现了更低的生育率，尤其是那些迁移到法国生育率最低地区的移民。我们将这些发现解释为文化汇款，这与一个理论框架的见解一致，在该框架中，移民充当文化传播的载体，将有关现代生育率的新信息、社会规范和偏好传播到他们的原籍地区。

【**NBER**】: NBER Working Paper No. 32990，https://www.nber.org/papers/w32990

#### 24. Privacy Protection and Accuracy: What Do We Know? Do We Know Things?? Let's Find Out! {#32989}

【**Author**】: Evan S. Totty, Thor Watson
...
【**摘要**】：统计机构肩负着双重使命：提供准确的数据，并保护数据主体的隐私和机密性。这些使命从根本上相互矛盾，因此必须加以平衡：更准确的数据会降低隐私，而隐私保护会引入降低准确性的误差。平衡准确性和隐私需要，除其他外，我们能够量化准确性和隐私。由于差分隐私，量化隐私变得更容易。相比之下，量化准确性听起来可能很容易，但要有效地做到这一点存在许多挑战。在本文中，我们首先讨论与量化数据准确性相关的一些挑战。然后，我们聚焦于一个经常被忽视的挑战，即被保护数据中存在调查误差。我们概述了隐私保护误差与总调查误差之间的关系。我们还总结了最近利用验证数据量化隐私保护误差相对于其他调查误差来源及其条件影响的工作。最后，我们讨论了未来关于数据隐私和调查误差研究的机遇与挑战。

【**NBER**】: NBER Working Paper No. 32989，https://www.nber.org/papers/w32989

#### 25. Evaluating Monetary Policy Counterfactuals: (When) Do We Need Structural Models? {#32988}

【**Author**】: Tomás E. Caravello, Alisdair McKay, Christian K. Wolf

【**Abstract**】: To evaluate the evolution of the macro-economy under alternative assumptions on monetary policy, it suffices, under weak structural assumptions, to know the causal effects of monetary shocks on macroeconomic outcomes. The existing empirical literature estimates the effects of monetary shocks to the short end of the yield curve, thus allowing the evaluation of counterfactuals that change assumptions on near-term policy. If the contemplated policy changes are instead more persistent, then model structure becomes necessary, for one sole purpose: to extrapolate from the estimated short-end effects to those of policy shocks further out on the yield curve. Among popular models of monetary policy transmission, market incompleteness (i.e., “HANK”) does not change this extrapolation much, while behavioral frictions do.

【**摘要**】：在弱结构假设下，要评估不同货币政策假设下的宏观经济演变，只需知道货币冲击对宏观经济结果的因果效应即可。现有实证文献估计了货币冲击对收益率曲线短端的影响，从而允许评估改变近期政策假设的反事实情景。如果所考虑的政策变化更具持续性，那么模型结构就变得必要，其唯一目的是：从估计的短端效应外推至收益率曲线更远端政策冲击的效应。在流行的货币政策传导模型中，市场不完全性（即“HANK”）对这种外推影响不大，而行为摩擦则会产生显著影响。

【**NBER**】: NBER Working Paper No. 32988，https://www.nber.org/papers/w32988
...
【**摘要**】：《联邦储备法》是相互竞争的经济和政治利益之间妥协的产物。众多研究考察了该法案如何形成，但大多将国会和行政部门的构成视为既定事实，而未考虑导致这种政治分布的独特环境。本文考察了1912年大选如何改变国会构成，增加了中央银行立法的可能性，并塑造了该法案。西奥多·罗斯福和其他进步派人士决定以第三方候选人身份参选，分裂了共和党，使民主党得以入主白宫并控制国会。我们表明，这次选举产生了一个极化程度较低的国会，新当选的议员更有可能投票支持该法案。如果没有他们的党内分裂，共和党很可能仍将控制白宫和国会，任何建立中央银行的立法几乎肯定会大不相同。

【**NBER**】: NBER Working Paper No. 32987，https://www.nber.org/papers/w32987

#### 27. Do Investor Differences Impact Monetary Policy Spillovers to Emerging Markets? {#32986}

【**Author**】: Ester Faia, Karen K. Lewis, Haonan Zhou
...
【**摘要**】：我们利用欧元区投资者的部门级证券持有数据，重新审视了以资本流动逆转形式出现的货币政策对新兴市场经济体的溢出效应。作为对意外货币紧缩的回应，投资基金等活跃投资者会将其投资组合从新兴市场重新配置出去，而保险公司和银行等更为被动、长期的投资者平均而言没有表现出显著反应。对于活跃投资者而言，当美联储和欧洲央行同步实施货币紧缩时，从新兴市场的重新配置似乎更为强劲。然而，当货币紧缩意外包含关于欧元区经济的积极消息时，这些投资者甚至可能向新兴市场证券注入更多资本。发行国的货币财政稳定性可能解释了这些溢出效应的异质性影响。

【**NBER**】: NBER Working Paper No. 32986，https://www.nber.org/papers/w32986

#### 28. Are We Adapting to Climate Change? {#32985}

【**Author**】: Marshall Burke, Mustafa Zahid, Mariana C. M. Martins, Christopher W. Callahan, Richard Lee, Tumenkhusel Avirmed, Sam Heft-Neal, Mathew Kiang, Solomon M. Hsiang, David Lobell
...
【**摘要**】：我们研究了在过去半个世纪中，经济、健康和生计结果对气候极端事件的敏感性是否有所下降，这与适应行为一致。了解这种适应是否已经发生，对于预测未来气候损害、校准减排努力所需的雄心水平，以及理解为避免额外损害可能需要的额外适应投资至关重要。利用涵盖不同地理区域和结果（包括死亡率、农业生产力、犯罪、冲突、经济产出以及洪水和热带气旋造成的损害数据）的综合面板数据，我们发现迄今为止有限的系统性适应证据。在我们研究的21个结果中，有6个显示出对气候变化敏感性在统计上显著下降，5个显示出敏感性上升，其余则没有统计上显著的变化。我们的结果并不意味着特定的已记录适应努力无效或某些地点没有适应，而是表明现有行动的综合净效应在很大程度上未能成功地在总体上显著减少气候影响。为了避免变暖带来的持续和未来损害，我们的结果表明需要识别有前景的适应策略并理解如何扩大其规模。

【**NBER**】: NBER Working Paper No. 32985，https://www.nber.org/papers/w32985

#### 29. Investing in Vaccines to Mitigate Harm from COVID-19 and Future Pandemics {#32984}

【**Author**】: Rachel Glennerster, Catherine Che, Sarrin M. Chethik, Claire T. McMahon, Christopher M. Snyder
...
【**摘要**】：本文评估了投资于疫苗研究、开发和制造能力以进行大流行病防范和应对的社会价值。在大流行期间快速接种疫苗可以显著降低死亡率、经济损失和社会混乱。然而，疫苗制造商往往缺乏足够的激励来加快速度和扩大产能。政府和国际组织的战略政策可以增强这些激励，并改善公平的疫苗分配。

【**NBER**】: NBER Working Paper No. 32984，https://www.nber.org/papers/w32984

#### 30. On the Identifying Power of Generalized Monotonicity for Average Treatment Effects {#32983}

【**Author**】: Yuehao Bai, Shunzhuang Huang, Sarah Moon, Azeem Shaikh, Edward J. Vytlacil
...
【**摘要**】：在二元结果、处理变量和工具变量的背景下，Balke 和 Pearl (1993, 1997) 确立了 Imbens 和 Angrist (1994) 的单调性条件在工具外生性之外，对于平均潜在结果和平均处理效应没有额外的识别力，其含义是：只要这些限制与可观测数据的分布一致，将单调性条件添加到工具外生性中并不会缩小这些参数的识别集。本文表明，在具有多值结果、处理变量和工具变量的更广泛设定下，在我们称之为广义单调性的单调性条件扩展下，这一现象仍然成立。我们进一步表明，对于任何比广义单调性更强的处理反应限制，只要这些更强的限制不限制潜在结果，这一现象也成立。重要的是，文献中先前考虑的许多潜在处理模型都隐含了广义单调性，包括 Kline 和 Walters (2016)、Kirkeboen 等人 (2016) 以及 Heckman 和 Pinto (2018) 考虑的单调性限制类型，以及处理选择由特定类别的加性随机效用模型决定的限制。我们通过一系列例子表明，当对潜在处理的限制意味着广义单调性条件被违反时，这些限制可以在工具外生性之外为平均潜在结果和平均处理效应提供识别力。通过这种方式，我们的结果揭示了在识别平均潜在结果和平均处理效应时所需限制的类型。

【**NBER**】: NBER Working Paper No. 32983，https://www.nber.org/papers/w32983

#### 31. Mining Chinese Historical Sources At Scale: A Machine Learning-Approach to Qing State Capacity {#32982}

【**Author**】: Wolfgang Keller, Carol H. Shiue, Sen Yan
...
【**摘要**】：由于获取和提取原始信息的人力成本高昂——尤其是在资源匮乏的环境中——原始历史文献常常被二手文献所取代。我们提出了一种用于中文历史数据自然语言处理的监督式机器学习方法。将其应用于识别《清实录》中不同形式的社会动荡，表明该方法在不受人为偏见影响、可重复且足够灵活以解决特定问题的同时，大幅降低了使用原始文献数据的成本。关于动荡触发因素的外部证据也表明，基于计算机的方法在识别社会动荡方面并不比人类研究者逊色。

【**NBER**】: NBER Working Paper No. 32982，https://www.nber.org/papers/w32982
...
【**摘要**】：我们总结了城市固体废物回收的经济学。经合组织的数据表明，成员国总回收率在近几十年已趋于平稳。即使经过数十年的学习和参与，美国某些材料的回收率仍然很低。可能需要重大的新政策来提高回收率。总体回收目标在美国和经合组织很常见，但可能不再有效。我们讨论了许多经常被忽视的回收异质性来源。首先，可回收材料彼此差异很大。经济体和自然环境因空间而异，技术随时间而变化。忽视异质性的回收政策可能设置不当。如果政策成本足够低，可以为每个地区的每种材料设定独特的回收政策，那么精准的回收策略可能更好地服务社会。汽车电池的具体回收政策与庭院废物的政策大不相同，因为这两种材料不同。精准的回收政策可以扩展这种做法，使得铝罐的规则不同于塑料壶或玻璃瓶。忽视这些跨材料、地点和时间的异质性可能会阻碍未来回收目标的实现。

【**NBER**】: NBER Working Paper No. 32981，https://www.nber.org/papers/w32981
...
【**摘要**】：本文探讨了人工智能向通用人工智能（AGI）的变革性进展将为经济学家和经济政策制定者带来的深刻挑战。我考察了人工智能时代如何通过削弱劳动的作用来彻底改变我们经济的基本结构，带来前所未有的生产率提升，但也引发了对就业冲击、收入分配以及教育和人力资本价值的担忧。我探讨了后AGI时代劳动可能保留的角色，以及哪些生产要素的重要性将增加。随后，本文指出了人工智能时代经济政策的八个关键挑战：（1）不平等与收入分配，（2）教育与技能发展，（3）社会与政治稳定，（4）宏观经济政策，（5）反垄断与市场监管，（6）知识产权，（7）环境影响，以及（8）全球人工智能治理。最后，本文强调了经济学家如何能够为更好地理解这些挑战做出贡献。

【**NBER**】: NBER Working Paper No. 32980，https://www.nber.org/papers/w32980

#### 34. Synthetic Data and Social Science Research: Accuracy Assessments and Practical Considerations from the SIPP Synthetic Beta {#32979}

【**Author**】: Jordan C. Stanley, Evan S. Totty
...
【**摘要**】：合成微观数据——在保留原始微观数据结构的同时，用建模值替换原始值以保护隐私的数据——为数据用户提供了增加有用微观数据访问机会的途径，同时满足了数据提供者的隐私和保密要求。合成数据可能足以满足许多目的，但持续的准确性担忧可以通过一个验证系统来解决，在该系统中，数据提供者在内部数据上运行外部研究人员的代码，并将清理后的输出与研究人员共享。美国人口普查局有运行此类系统的经验。在本章中，我们首先描述了合成数据在分层数据访问系统中的作用，以及合成数据准确性在实现可行的合成数据产品中的重要性。接下来，我们回顾了我们最近进行的一系列实证分析的结果，这些分析旨在评估收入与项目参与调查（SIPP）合成测试版（SSB）的准确性，SSB是人口普查局的一个产品，它使关联的调查-行政数据公开可用。基于这一分析以及我们在SSB项目上的工作经验，我们最后就未来结合验证的合成数据实施提出了想法和问题。

【**NBER**】: NBER Working Paper No. 32979，https://www.nber.org/papers/w32979
...
【**摘要**】：“绝望死亡”的增加被假设为21世纪初某些群体不利死亡率经历的一个重要来源。本研究考察了这种可能性，并揭示了以下主要发现。首先，在1993年至2019年间，所有被考察的人口亚群的心理健康状况都恶化了。其次，这些恶化提高了死亡率，并导致了1999-2019年间壮年非西班牙裔白人以及（在较小程度上）黑人经历的不利死亡率趋势。然而，心理健康恶化并不是这些趋势的主要解释。第三，就这些关系支持“绝望死亡”的一般概念而言，构成该概念的具体死因应该比之前认识到的更广泛且不同：仍然包括药物死亡率，可能还包括酒精死亡，但用心脏病、下呼吸道疾病、凶杀以及可能癌症导致的死亡取代自杀。第四，在解释心理健康对死亡率的总体影响中的黑白差异时，给定心理健康恶化程度增加所带来的后果异质性通常比心理健康恶化程度变化的大小更重要。

【**NBER**】: NBER Working Paper No. 32978，https://www.nber.org/papers/w32978

#### 36. Who should work how much? {#32977}

【**Author**】: Timo Boppart, Per Krusell, Jonna Olsson
...
【**摘要**】：从生产效率的角度自然会导致这样的结论：生产率更高的个体应该比生产率更低的个体工作更多。然而，在高工资和低工资个体之间实际工作时间的系统性差异几乎不明显。我们强调，家庭可获得的保险是这一事实背后的重要决定因素。使用一个包含保险摩擦的动态异质性主体模型、校准以匹配跨时间和空间的总工作时间的收入效应，以及产生现实财富分散的金融摩擦，我们报告了保险的显著影响：完美保险将使总劳动生产率提高9.6%，并使工作时间减少7.7%。

【**NBER**】: NBER Working Paper No. 32977，https://www.nber.org/papers/w32977
...
【**摘要**】：我们使用一个包含商品和金融市场冲击的一般均衡模型来研究汇率波动的来源。这些冲击在它们引起的汇率、利率和数量之间的共同变动上有所不同。一个匹配美国和G10货币国家数据的校准表明，反映在持久利率差异中的相对需求的持久冲击，解释了美元/G10汇率方差的75%。然而，货币中介冲击在产生高频偏离无抛补利率平价以及解释危机中美元升值方面是重要的。

【**NBER**】: NBER Working Paper No. 32976，https://www.nber.org/papers/w32976

#### 38. The Selective Disclosure of Evidence: An Experiment {#32975}

【**Author**】: Agata Farina, Guillaume Fréchette, Alessandro Ispano, Alessandro Lizzeri, Jacopo Perego
...
【**摘要**】：我们对沟通中的选择性披露进行了实验分析。在我们的模型中，一个知情的发送者旨在通过披露从更大可用证据池中选择的可验证证据来影响接收者。我们的实验设计利用了该模型丰富的比较静态预测，从而能够系统性地检验证据选择相对于证据隐瞒在沟通中的相对重要性。我们的发现证实了理论的关键定性预测，表明选择（而非隐瞒）通常是沟通中的主要扭曲。我们还识别出与理论的偏离：少数发送者相对于预测过度沟通，而一些接收者则部分忽视了他们所观察到的证据的选择性本质。

【**NBER**】: NBER Working Paper No. 32975，https://www.nber.org/papers/w32975
...
【**摘要**】：在美国，随着时间的推移和跨州，企业数量与总就业的关系比与人均产出的关系更为紧密。在许多具有自由进入条件的企业动态、贸易和增长模型中，这些事实意味着创建新企业的成本随着生产率增长而急剧增加。这种进入成本的增加可能源于用于进入的劳动力成本上升，以及来自先前进入的微弱或负面的知识溢出。进入成本如何随增长变化对福利很重要。例如，我们的发现表明，提高生产率的政策不会诱导企业进入，从而限制了此类政策对福利的总影响。

【**NBER**】: NBER Working Paper No. 32974，https://www.nber.org/papers/w32974

#### 40. Behavioral Attenuation {#32973}

【**Author**】: Benjamin Enke, Thomas Graeber, Ryan Oprea, Jeffrey Yang
...
【**摘要**】：我们报告了一项关于行为衰减的大规模检验：由于信息处理约束，人们决策对基本面的弹性通常过小。我们实施了30个实验，涵盖广泛的经济决策，包括选择、估值、信念形成、策略博弈和一般优化。在我们的实验中，93%的情况下，决策对基本面的弹性随着参与者的认知不确定性增加而减小。此外，在具有客观解决方案的决策问题中，弹性普遍小于最优值。我们表明，衰减的程度部分由决策问题的复杂性驱动。许多被广泛研究的异常现象代表了行为衰减的特例。

【**NBER**】: NBER Working Paper No. 32973，https://www.nber.org/papers/w32973

#### 41. Perry Preschool at 50: What Lessons Should Be Drawn and Which Criticisms Ignored? {#32972}

【**Author**】: Alison W. Baulos, Jorge Luis García, James J. Heckman
...
【**摘要**】：佩里学前教育项目是对早期儿童教育项目进行的最长期的实验研究，它展示了此类干预措施如何为弱势群体带来长期的个人、社会和代际收益。证据明确：对高质量早期儿童教育和家长参与的投入，即使在50年后也能产生回报。该项目的发现在科学上依然稳健，尤其是在通过严格的小样本推断方法进行分析时。该项目的发现也反驳了对学前教育的常见批评，因为当正确衡量时，治疗对智商的影响并未消退。本文从最初的创始人和近期的实证研究中汲取见解，强调了家长参与在早期教育中的关键作用。作者主张建立一个科学议程，专注于理解治疗效果背后的机制，而非复制特定项目。该分析还强调了早期儿童干预对社会流动性和人力资本形成的更广泛影响。早期儿童教育分析人士应认识到，虽然资质和正式课程有助于项目的成功，但质量的真正衡量标准在于成人与儿童的互动，这起着至关重要的作用。

【**NBER**】: NBER Working Paper No. 32972，https://www.nber.org/papers/w32972

#### 42. Midlife Health and Later Life Economic Inequality {#32971}

【**Author**】: Nicolò Russo, Rory McGee, Mariacristina De Nardi, Margherita Borella, Ross Abram
...
【**摘要**】：健康状况影响着晚年一系列对宏观经济学和公共政策至关重要的结果，包括残疾补助领取、退休、长期护理使用和生存。然而，我们对中年健康差异在多大程度上导致按种族、民族和性别划分的晚年结果差异知之甚少。利用健康与退休研究，我们基于虚弱程度构建了一个健康指标，并记录了中年时期的巨大差异。55岁时，黑人男性和女性的虚弱程度分别相当于比他们年长13岁和20岁的白人男性和女性，而西班牙裔男性和女性的相应差距则为8岁和12岁。然后，我们估计了一个将55岁时的健康状况与后续结果联系起来的动态系统。使各群体在55岁时的健康分布均等化，能显著减少在健康状况不佳、残疾补助领取和养老院居住时间方面的差异。重要的是，中年健康对晚年差异的解释力超过了教育、医疗保险覆盖和婚姻状况的总和。

【**NBER**】: NBER Working Paper No. 32971，https://www.nber.org/papers/w32971

#### 43. Moving to Opportunity, Together {#32970}

【**Author**】: Seema Jayachandran, Lea Nassal, Matthew J. Notowidigdo, Marie Paul, Heather Sarsons, Elin Sundberg
...
【**摘要**】：许多夫妇面临着在推进一方或另一方职业生涯之间的权衡。我们利用德国和瑞典的行政数据研究这一权衡。通过事件研究方法，我们发现当夫妇跨通勤区迁移时，男性的收入增长超过女性。为了区分男性更高的潜在收入与优先考虑男性职业的性别规范，我们研究了当女性潜在收入高于其丈夫时，这些模式有何不同。然后，我们估计了一个家庭决策模型，在该模型中，家庭可以（并且确实）更重视男性赚取的收入。

【**NBER**】: NBER Working Paper No. 32970，https://www.nber.org/papers/w32970

#### 44. A Secure Query System to Improve Access to Individual Income Tax Data {#32969}

【**Author**】: Amy O'Hara, Stephanie Straus, Ron Borzekowski, Paul Arnsberger, Barry Johnson
...
【**摘要**】：近年来，利用个人所得税数据进行统计研究产生了重要且引人注目的发现。对这些微观数据的需求持续增长，这些数据可通过《国内税收法》下的税收管理权限以及美国国税局收入统计司的联合统计研究项目获取。本文描述了一种满足政府机构和非营利组织对此类统计数据需求的新方法。该项目探索了建立一个连接数据最终用户、数据中介机构和收入统计司的隐私保护安全查询系统的可行性。在开发的早期阶段，最终用户可能是州或地方政府机构或非营利组织（例如社区大学的非学位项目）；中介机构是乔治城大学；所有处理工作将在收入统计司内部并由其工作人员完成。目标是让安全查询系统客户端（例如州社会服务部门）准备并提交一个包含个人标识符的数据集，供收入统计司与个人所得税记录进行匹配，以生成预定义输出统计数据的表格。这种高效自动化的流程应能以更低的成本和负担为客户和收入统计司生产更多证据。

【**NBER**】: NBER Working Paper No. 32969，https://www.nber.org/papers/w32969

#### 45. Experimentally Validating Welfare Evaluation of School Vouchers {#32968}

【**Author**】: Peter Arcidiacono, Karthik Muralidharan, John D. Singleton

【**Abstract**】: We leverage a unique two-stage experiment that randomized access to private school vouchers in rural India to estimate willingness-to-pay for greater school choice, a key input for assessing welfare impacts of alternative voucher designs. We find that a voucher targeted to households with limited assets, a proxy for ability-to-pay constraints, yields a marginal value of public funds (MVPF) greater than 3. We obtain this result using a multistep research design that isolates the information contributed by experimental data. We begin by estimating several models of school choice on control data alone, reserving data from treatment markets for model selection via out-of-sample validation. All of the models underpredict take-up of the randomized voucher offer. Evidence from treatment markets points to why: the program induced household search and led private schools to use voucher surplus to attract students. We incorporate these mechanisms into a unified model, estimated with both treatment and control data, that successfully explains the observed choice patterns. Our experience highlights that credible policy analysis requires modeling choice frictions and supply responses and using experimental data in estimation.

【**摘要**】：我们利用印度农村地区一项独特的、将私立学校代金券获取权随机化的两阶段实验，来估计对更大择校权的支付意愿，这是评估不同代金券设计福利影响的关键输入。我们发现，针对资产有限（作为支付能力约束的代理变量）家庭的代金券，其公共资金边际价值大于3。我们通过一个多步骤的研究设计获得了这一结果，该设计分离了实验数据所贡献的信息。我们首先仅使用对照组数据估计了几个学校选择模型，保留处理组市场的数据用于通过样本外验证进行模型选择。所有模型都低估了随机代金券要约的接受率。来自处理组市场的证据指出了原因：该项目引发了家庭搜寻，并导致私立学校利用代金券盈余来吸引学生。我们将这些机制整合到一个统一的模型中，该模型使用处理组和对照组数据进行估计，成功解释了观察到的选择模式。我们的经验强调，可信的政策分析需要对选择摩擦和供给反应进行建模，并在估计中使用实验数据。

【**NBER**】: NBER Working Paper No. 32968，https://www.nber.org/papers/w32968

#### 46. Of Markets and Marriages: A Multidisciplinary, Multibook Review Essay of Recent Work on the Causes of U.S. Poverty {#32967}

【**Author**】: Elizabeth Ananat
...
【**摘要**】：我讨论了近期对持续存在的美国贫困提出不同解释的著作。Desmond（2023）认为，对低收入美国人的援助被更强大的市场参与者攫取。我将这一担忧置于归宿问题的背景下，并考虑了改变归宿的政策（通过改变外部选择）以及侧重于减少无谓损失和重新分配剩余的补充性批评。Kearney（2023）认为，婚姻减少意味着美国儿童在资源更少的家庭中成长。我提出，这种减少可能反映了在男性日益成为家庭经济不稳定来源而女性外部选择改善的时代，使婚姻有效所需的“软”技能不足。我考虑了改善软技能的政策以及支持家庭经济稳定的政策，这些政策可以降低对配偶技能的要求。最后，我鼓励与新兴的政策反馈文献进行互动，该文献探讨了为何像所讨论的那些受欢迎且基于证据的政策迄今未在美国被采纳。

【**NBER**】: NBER Working Paper No. 32967，https://www.nber.org/papers/w32967

#### 47. The Rapid Adoption of Generative AI {#32966}

【**Author**】: Alexander Bick, Adam Blandin, David J. Deming
...
【**摘要**】：生成式人工智能是一项潜在的重要新技术，但其对经济的影响取决于采用的速度和强度。本文报告了一系列具有全国代表性的美国调查结果，内容涉及在工作场所和家庭中使用生成式人工智能的情况。截至2024年底，近40%的18-64岁美国人口使用生成式人工智能。23%的受雇受访者在上周至少使用过一次生成式人工智能进行工作，9%的人每个工作日都使用。相对于每项技术的首个大众市场产品发布，生成式人工智能在工作中的采用速度与个人电脑一样快，而总体采用速度则快于个人电脑或互联网。生成式人工智能和个人电脑在按教育、职业和其他特征划分的早期采用模式上非常相似。目前，1%至5%的总工作时间得到了生成式人工智能的辅助，受访者报告的时间节省相当于总工作时间的1.4%。这表明生成式人工智能可能带来可观的生产力提升。

【**NBER**】: NBER Working Paper No. 32966，https://www.nber.org/papers/w32966

#### 48. Patent Hunters {#32965}

【**Author**】: Lauren Cohen, Umit Gurun, Katie Moon, Paula Suh
...
【**摘要**】：通过分析美国专利商标局在1976年至2020年间授予的数百万项专利，我们发现了一种模式，即特定专利只有在相当长的时间过去后才变得突出。在这些大器晚成的影响力专利中，我们展示了存在关键参与者（专利猎手），他们持续识别并开发这些专利。尽管最初被忽视，但这些大器晚成的专利平均而言比早期被认可的专利具有显著更大的影响力，并且与显著更多的新产品发布相关。专利猎手作为这些大器晚成专利的早期发现者和采用者，也与显著的正租金相关。他们采用这些被忽视的专利与销售额增长6.4%（t=3.02）、托宾Q值增加2.2%（t=3.91）以及新产品供应增加2.2%（t=2.97）相关。我们为专利猎手行为寻找工具变量，并发现强有力的证据表明这些收益是由专利猎手行为因果导致的。与专利猎手相关的租金平均而言超过了原始专利创造者自身的租金。被猎取的专利更接近专利猎手的核心技术，对原始撰写者而言更边缘化，并且处于竞争较少的领域。最后，专利猎手似乎是一个持久的公司特征，并且具有发明人层面的组成部分。

【**NBER**】: NBER Working Paper No. 32965，https://www.nber.org/papers/w32965

#### 49. Do Higher Tipped Minimum Wages Reduce Race, Ethnic, or Gender Earnings Gaps for Restaurant Workers? {#32964}

【**Author**】: David Neumark, Emma Wohl
...
【**摘要**】：支持大幅提高最低工资的一个日益常见的论点是，这能缩小少数族裔或女性的工资或收入差距（例如，Derenoncourt 和 Montialoux, 2021）。这一论点尤其针对餐饮业员工，因为小费中的歧视不受同工同酬政策约束。当然，即使提高含小费最低工资能缩小群体间的小时工资差异，它也可能减少餐饮业员工的就业或工时（Neumark 和 Yen, 2023），且这些影响可能因种族和性别而异，因此对小时收入的影响未必能推广到总收入。我们估算了含小费最低工资（或等价地，小费抵免）变化对餐饮业员工收入的影响（这忽略了就业变化，但包含了工时变化）。我们发现，含小费最低工资提高了女性的小时收入，但对黑人或西班牙裔没有影响。然而，含小费最低工资通常并未提高这些群体的周收入（因为女性工时减少）。相比之下，常规最低工资提高了所有三类餐饮业员工的小时和周收入，其影响来自非小费员工。

【**NBER**】: NBER Working Paper No. 32964，https://www.nber.org/papers/w32964

#### 50. Climate Change through the Lens of Macroeconomic Modeling {#32963}

【**Author**】: Jesús Fernández-Villaverde, Kenneth Gillingham, Simon Scheidegger
...
【**摘要**】：关于气候变化宏观经济学的文献正在迅速发展。本综述聚焦于结构性综合评估模型（IAMs）的构建与求解进展，强调了最前沿自然科学与一般均衡理论的结合。我们讨论了在求解具有尖锐非线性、多区域和多风险源的动态随机IAMs时所面临的挑战。深度学习及其他机器学习方法的关键创新克服了许多计算难题，并提升了政策发现的准确性和相关性。最后，我们概述了IAMs的最新应用及关键政策启示。

【**NBER**】: NBER Working Paper No. 32963，https://www.nber.org/papers/w32963

#### 51. Aid for Incumbents: The Electoral Consequences of COVID-19 Relief {#32962}

【**Author**】: Jeffrey Clemens, Julia A. Payson, Stan Veuger
...
【**摘要**】：新冠疫情导致联邦政府向州政府转移支付达到前所未有的水平。这笔资金是否在选举中惠及现任政治家？识别收入意外之财对投票的影响具有挑战性，因为导致现金流入的条件本身也可能因其他原因使现任者受益或受损。我们开发了一个工具变量，使我们能够根据国会代表权的差异来预测对各州的拨款分配。我们发现，在2020年、2021年和2022年的全州竞选中，那些因在国会中代表权过高而获得更多救济资金的州的现任者表现显著更好。这些结果在多种设定下以及调整了各种经济和政治控制变量后依然稳健。我们一致发现，在疫情期间，获得更多援助的州的现任政治家的选举优势，显著超过了这些州的政治家在疫情前享有的较为温和的优势。本文有助于我们理解危机时期的经济投票和现任优势，以及新冠疫情和联邦层面不平等的政治代表权所带来的下游选举后果。

【**NBER**】: NBER Working Paper No. 32962，https://www.nber.org/papers/w32962
...
【**摘要**】：我们在一个具有外生政府购买、私人观察到的资本折旧率异质性冲击以及将旧资本转化为消费的成比例投资逆转成本的世代交叠模型中，刻画了计划者对消费和资本的最优配置。我们展示了如何通过一揽子税收和政府债券来为政府购买融资，并支持与计划者最优相同的平衡增长路径。最优资本所得税率实现了计划者对异质性折旧风险的最优（但不完全）分担，同时尊重了这些风险的私人性质。

【**NBER**】: NBER Working Paper No. 32961，https://www.nber.org/papers/w32961

#### 53. Green Bonds: New Label, Same Projects {#32960}

【**Author**】: Pauline Lam, Jeffrey Wurgler
...
【**摘要**】：绿色金融强调“额外性”，即所资助的项目应提供超越常规实践的独特环境效益。然而，对美国公司和市政绿色债券的分析表明，绝大多数绿色债券收益用于再融资普通债务、延续现有项目或启动对发行方而言不具有新颖绿色特征的项目。只有2%的公司和市政绿色债券收益启动了具有明显新颖绿色特征的项目。投资者和市场参与者也不区分额外性水平：发行收益率、公告效应、绿色债券指数纳入以及绿色债券基金持有量与额外性无关。

【**NBER**】: NBER Working Paper No. 32960，https://www.nber.org/papers/w32960

#### 54. The Impact of Early Childhood Parenting Interventions on Child Learning: A Systematic Review and Meta-Analysis {#32959}

【**Author**】: Kimberly Dadisman, Andre Nickow, Philip Oreopoulos
...
【**摘要**】：养育被广泛认为是影响早期儿童发展的最重要因素之一。但早期儿童养育项目在多大程度上以及在何种情况下能够改善儿童的学习成果？尽管近年来在解答这些问题方面取得了实质性进展，但很少有研究试图系统性地综合现有证据，以服务于推广和政策制定。本文通过一项系统综述（包括定量元分析和详细的叙述性分析）来填补这一空白，该综述评估了测试早期儿童养育项目对学习成果影响的随机评估。我们发现，这些项目在广泛的情境中产生了显著效果，其中最大的影响来自中低收入国家实施的项目以及采用认知刺激课程的项目。团体养育项目产生的平均效应量通常与家访项目相当，但成本通常低得多。对规模化项目评估的定性分析表明，行政实施障碍（而非项目无效）可能是影响效果的主要障碍。最后，我们反思了对理论、政策和未来研究优先事项的启示。

【**NBER**】: NBER Working Paper No. 32959，https://www.nber.org/papers/w32959

#### 55. The Distributional Consequences of Trade: Evidence from the Grain Invasion {#32958}

【**Author**】: Stephan Heblich, Stephen J. Redding, Yanos Zylberberg
...
【**摘要**】：通胀对工人的成本有多高？对此问题的回答一直聚焦于通胀期间实际工资的路径。我们认为，工人必须采取代价高昂的行动（“冲突”）才能使名义工资赶上通胀，这意味着即使实际工资在通胀上升时并未下降，也会产生福利成本。我们研究了一个菜单成本型模型，其中工人选择是否与雇主发生冲突以确保加薪。我们表明，在通胀上升后，因冲突更频繁而导致的工资追赶并不会提高福利。相反，通胀对工人福利的影响取决于我们所谓的“工资侵蚀”——即如果工人的冲突决策不对通胀做出反应，通胀将如何降低实际工资。因此，使用观察到的工资增长来衡量工人福利会低估通胀的成本。我们进行了一项调查，显示工人愿意牺牲约1.75%的工资来避免冲突。将模型校准到调查数据后，我们发现纳入冲突显著提高了通胀对工人的成本。

【**NBER**】: NBER Working Paper No. 32956，https://www.nber.org/papers/w32956

#### 58. Measuring the Costs and Benefits of Regulation {#32955}

【**Author**】: Matilde Bombardini, Francesco Trebbi, Miao Ben Zhang
...
【**摘要**】：本文讨论了政府监管成本与收益评估领域近期的方法论创新，涵盖前瞻性和回顾性两方面。现有进展大多体现在私人合规成本方面。私人收益、社会成本和社会收益仍缺乏系统性的组织，且更难进行定量评估，这主要是由于难以标准化局部和一般均衡的反事实情景。我们讨论了成本收益分析中未来潜在的方法论改进。

【**NBER**】: NBER Working Paper No. 32955，https://www.nber.org/papers/w32955

#### 59. Inclusive Teaching: Spotting Social Isolation in the Classroom {#32954}

【**Author**】: Sule Alan, Michela Carlana, Marinella Leone
...
【**摘要**】：我们评估了一项干预措施，该措施通过向教师提供其学生的社交网络信息以及与社会排斥相关的发育风险信息，旨在提高教师对社会孤立的意识。利用友谊数据和反社会及亲社会行为的激励相容度量，我们发现该干预减少了社会孤立和反社会行为，但并未改善亲社会行为。反社会行为的减少带来了受干预班级更好的经济结果，以平均收益和基尼系数衡量。我们的发现凸显了缓解学校中社会排斥和反社会同伴关系的个人及社区益处。

【**NBER**】: NBER Working Paper No. 32954，https://www.nber.org/papers/w32954

#### 60. The Increasing Cost of Buying American {#32953}

【**Author**】: Matilde Bombardini, Andres Gonzalez-Lira, Bingjing Li, Chiara Motta
...
【**摘要**】：美国近期旨在减少进口和促进国内生产的政策再度兴起，其中包括扩大“购买美国货”条款。虽然其中一些政策是新的且未经检验，但本文评估了美国联邦政府对购买外国产品的长期采购限制。我们利用采购微观数据首先绘制并衡量了政府购买对就业的积极影响。然后，我们校准了一个量化贸易模型，该模型经过调整以纳入与《购买美国货法案》相关的特征：政府部门、最终品和中间品的政策壁垒、劳动力参与率以及外部规模经济。我们表明，当前对最终品购买的“购买美国货”条款创造了多达10万个就业岗位，每个岗位的成本在111,500美元至137,700美元之间。然而，最近宣布的关于使用外国投入品的政策收紧将创造更少的就业岗位，每个岗位的成本更高，在154,000美元至237,800美元之间。我们还发现，几乎没有证据表明“购买美国货”规则被用作有效的产业政策。

【**NBER**】: NBER Working Paper No. 32953，https://www.nber.org/papers/w32953

#### 61. Horowitz-Manski-Lee Bounds With Multilayered Sample Selection {#32952}

【**Author**】: Kory Kroft, Ismael Mourifié, Atom Vayalinkal
...
【**摘要**】：本文研究了在企业异质性存在的情况下，职业培训对工资率的因果效应。当培训影响工人向企业的分类时，样本选择不再是二元的，而是“多层的”。本文将经典的Heckman（1979）样本选择模型——该模型假设选择是二元的——扩展到选择是多层的情境。在这种情境下，Lee界集识别了一个总效应，该效应结合了跨企业职业培训对工资率因果效应的加权平均值，与在固定培训水平下不同企业之间工资对比的加权平均值。因此，只有当企业支付同质工资和/或职业培训不影响工人跨企业分类时，Lee界集才识别出一个与政策相关的估计量。我们推导了每个企业内职业培训对工资率因果效应的尖锐界的解析表达式，该表达式利用了企业特定工资的信息。我们通过两个职业培训实验的实证应用来说明我们的部分识别方法。我们的估计表明，即使传统的Lee界严格为正，我们的企业内界也可能紧贴0，这表明经典的Lee界可能仅捕捉了职业培训的纯分类效应。

【**NBER**】: NBER Working Paper No. 32952，https://www.nber.org/papers/w32952

#### 62. Putting the "Finance" into "Public Finance": A Theory of Capital Gains Taxation {#32951}

【**Author**】: Mark A. Aguiar, Benjamin Moll, Florian Scheuer
...
【**摘要**】：标准的最优资本税理论抽象掉了资产价格的建模，因此不适合思考资本利得和财富税。我们在资产价格变化的环境中研究最优再分配税收，采纳现代金融的观点，即资产价格不仅因现金流变化而波动，还因其他因素（“贴现率”）而波动。我们表明，最优税基（i）通常不同于资产价格不变的情况，并且（ii）取决于资产价格变化的来源。每当资产价格波动且并非完全由现金流变化驱动时，税收必须针对已实现的交易，并且通常涉及基于实现的资本利得税和股息税的组合。这一结果与经典的Haig-Simons综合所得税概念以及最近关于财富税或应计制资本利得税的提议形成对比。

【**NBER**】: NBER Working Paper No. 32951，https://www.nber.org/papers/w32951

#### 63. Hell with the Lid Off: Racial Segregation and Environmental Equity in America’s Most Polluted City {#32950}

【**Author**】: H. Spencer Banzhaf, William Mathews, Randall Walsh
...
【**摘要**】：本研究考察了1910年至1940年间匹兹堡种族隔离与环境公平之间的关系。利用新数字化的历史数据，分析在这个可能是美国污染最严重的城市中空气污染的空间分布，我们研究了在这一隔离加剧时期，种族间空气污染暴露差异如何演变。我们的发现表明，黑人居民经历的污染水平显著高于白人居民，并且这种差异随时间推移而扩大。我们将城市内迁移确定为加剧这种不公平的关键因素，因为迁移的黑人面临更高的污染暴露。我们还提供了空气污染资本化进入住房市场的证据。总体而言，我们的结果强调了在讨论种族和经济不平等时考虑环境因素的重要性。

【**NBER**】: NBER Working Paper No. 32950，https://www.nber.org/papers/w32950

#### 64. Information and Market Power in DeFi Intermediation {#32949}

【**Author**】: Pablo D. Azar, Adrian Casillas, Maryam Farboodi
...
【**摘要**】：本文考察了“DeFi中介链”——即以太坊原生加密货币ETH创建和分配所依据的市场结构——以审视信息不对称如何塑造中介租金。我们认为，在DeFi中使用权益证明区块链技术导致了一种新颖的套利限制，源于套利者的隐私需求与区块链透明度之间的张力。利用一个区分以太坊中私有和公开交易的新数据集，我们发现私人信息优势每增加1%，中介的利润份额就会增加1.4%。我们开发了一个动态讨价还价模型，该模型预测信息市场势力完全源于参与者的私人信息优势。我们的分析说明了区块链技术如何在低进入壁垒的情况下维持套利机会。

【**NBER**】: NBER Working Paper No. 32949，https://www.nber.org/papers/w32949

#### 65. Hidden Debt Revelations {#32947}

【**Author**】: Sebastian Horn, David Mihalyi, Philipp Nickol, César Sosa-Padilla
...
【**摘要**】：公共债务统计数据的可靠性如何？本文通过追踪世界银行债务统计数据库超过50个版本的事后数据修正，量化了隐性债务的规模、特征和时机。基于涵盖146个国家和53年数据的债务样本，本文确立了三个新的典型事实：（i）债务统计数据被系统性低估；（ii）隐性债务在经济繁荣时期积累，往往在经济低迷时期（通常是在国际货币基金组织项目期间和主权违约期间）被揭示；（iii）在债务重组中，更高的隐性债务与更大的债权人损失相关。这些新数据被用于数值上约束一个包含隐性债务积累和触发揭示的内生监测决策的量化主权债务模型。模型模拟表明，隐性债务对违约风险、债务承载能力和资产价格产生不利影响，因此对福利是有害的。

【**NBER**】: NBER Working Paper No. 32947，https://www.nber.org/papers/w32947

#### 66. Social Status, Economic Development and Female Labor Force (Non) Participation {#32946}

【**Author**】: Kaivan Munshi, Swapnil Singh
...
【**摘要**】：本研究为伴随经济发展而持续增加的女性劳动力不参与（FLFNP）提供了一种基于地位的解释。这一解释基于以下观点：发展中国家的家庭或族群可以通过让女性退出劳动力市场来彰显其财富，从而提高其社会地位。如果社会地位的价值或承担信号成本的意愿随经济发展而增加，那么这将解释FLFNP的持续增加。为了为这一论点提供实证支持，我们利用两个独立的外生变异来源——印度各地区的截面变异和地区内随时间的变化——来确立地位考量决定了农村FLFNP。我们用于推导上述检验的基于地位的模型，能够匹配推动我们分析的印度农村FLFNP的增长。对估计模型的反事实模拟表明，传统的政策处方，例如降低女性教育成本，可能会通过增加潜在家庭收入从而提高竞争社会地位的意愿，而“提高”FLFNP。近几十年来女性教育的急剧增长，可能矛盾地进一步增加了印度的FLFNP。

【**NBER**】: NBER Working Paper No. 32946，https://www.nber.org/papers/w32946

#### 67. Inflation Expectation and Cryptocurrency Investment {#32945}

【**Author**】: Lin William Cong, Pulak Ghosh, Jiasun Li, Qihong Ruan
...
【**摘要**】：利用印度主要加密货币交易所的专有数据以及该国的家庭通胀预期调查，我们记录了通胀预期与个人加密货币购买之间存在显著的正相关关系。更高的通胀预期也与更多的新加密货币投资者相关。我们从多个维度研究了投资异质性，发现这种效应集中在比特币（BTC）和泰达币（USDT）交易中。在控制了通过投资者预期加密货币回报调查所捕捉的投机需求后，结果依然稳健，并且通过使用多个工具变量确认了因果解释。我们的发现提供了直接证据，表明家庭已经采用加密货币进行通胀对冲，这反过来解释了它们在缺乏全球主导货币的发展中国家的高采用率。

【**NBER**】: NBER Working Paper No. 32945，https://www.nber.org/papers/w32945

#### 68. Cournot Competition, Informational Feedback, and Real Efficiency {#32944}

【**Author**】: Lin William Cong, Xiaohong Huang, Siguang Li, Jian Ni
...
【**摘要**】：我们在一个具有金融市场信息反馈的新颖环境中重新审视了企业竞争与实际效率之间的关系。尽管加剧的竞争可以降低生产中的市场集中度，但它会降低投机者专有信息（例如市场前景）的价值，并抑制金融市场中的信息生产和价格发现。因此，竞争通过两个相互竞争的渠道产生非单调的福利效应：市场集中度和信息生产。当股票价格中反映的信息对生产决策足够有价值时，竞争可能损害消费者福利和实际效率。我们的结果在跨资产交易和学习下是稳健的，并强调了在反垄断政策（例如关于横向合并的监管）中考虑产品市场与金融市场之间相互作用的重要性。

【**NBER**】: NBER Working Paper No. 32944，https://www.nber.org/papers/w32944

#### 69. Work from Home and Disability Employment {#32943}

【**Author**】: Nicholas Bloom, Gordon B. Dahl, Dan-Olof Rooth
...
【**摘要**】：自疫情以来，残疾人就业率显著上升。与此同时，居家办公（WFH）的比例增长了四倍。本文探讨两者之间是否存在因果关系。在控制了构成变化和劳动力市场紧张程度后，居家办公比例每增加1个百分点，身体残疾人士的全职就业率增加1.0%。疫情后居家办公的增加解释了全职就业率上升的68%-85%。工资数据表明，居家办公增加了身体残疾人士的劳动力供给，这可能是通过减少通勤成本和更好地控制工作条件来实现的。

【**NBER**】: NBER Working Paper No. 32943，https://www.nber.org/papers/w32943
...
【**摘要**】：所有资产定价理论目前都源于一个关键假设：价格等于预期贴现后的收益。而我们关于贴现率的大部分认知来自于研究一种特定的预期收益：分析师报告中的盈利预测。研究人员通常通过一个易于使用的数据库获取这些数字，而从未阅读过底层文档。这很不幸，因为每份报告的文本都包含分析师如何为其自身盈利预测定价的明确描述。我们研究了513份报告样本，发现大多数分析师使用历史市盈率（P/E）而非贴现率。他们不是计算公司未来收益的现值，而是问：“一家盈利相似的公司去年是如何被定价的？”即使其他投资者做法不同，但如果市场参与者并不总是使用贴现率，那么将贴现率置于每个资产定价模型的核心是没有意义的。还有其他选择。过去十二个月的市盈率解释了分析师目标价变动的91%。我们围绕这一事实构建了一种新型资产定价模型，并表明它解释了市场对盈利意外的反应。

【**NBER**】: NBER Working Paper No. 32942，https://www.nber.org/papers/w32942

#### 71. Voting Rules, Turnout, and Economic Policies {#32941}

【**Author**】: Enrico Cantoni, Vincent Pons, Jérôme Schäfer
...
【**摘要**】：近年来，选民身份法和便利投票引发了激烈的党派辩论。为了阐明这些政策问题，我们调查了关于投票率的制度决定因素和影响的最新证据，并将视角扩展到最具争议的规则之外。我们首先讨论了选举参与的重要性，既因为它对政策选择的影响，也因为它对民主合法性的意义。基于一个简单的投票成本收益模型，我们随后回顾了研究投票程序和其他选举规则影响的（准）实验性工作。投票程序（决定人们如何投票）主要影响参与成本。当这些障碍发生在选举之前、利害关系不突出时（例如选民登记要求），它们造成的影响更大；而当政党动员选民反对它们、并且存在替代投票方式时（例如人们可以选择邮寄投票或亲自投票），影响则较小。选举上游的选举规则（如竞选财务法）和下游的规则（如使用比例代表制与多数制将选票选择映射为一组选举获胜者）主要通过收益发挥作用，例如通过影响选举竞争性和候选人数量。最后，我们强调了未来研究的问题。

【**NBER**】: NBER Working Paper No. 32941，https://www.nber.org/papers/w32941

#### 72. Data Privacy for Record Linkage and Beyond {#32940}

【**Author**】: Shurong Lin, Eric Kolaczyk
...
【**摘要**】：在一个数据驱动的世界中，两个突出的研究问题分别是记录链接和数据隐私。记录链接通过整合来自不同来源的同一实体的信息，对于改进决策至关重要。另一方面，数据隐私研究旨在平衡从数据中提取准确见解的需求与保护相关实体隐私的必要性。在记录链接的背景下，数据隐私问题不可避免地会出现。本文识别了这两个领域交叉点的两个互补方面：（1）如何在记录链接过程中确保隐私，以及（2）如何在记录链接后发布分析结果时减轻隐私风险。我们具体讨论了隐私保护记录链接、差分隐私回归及相关主题。

【**NBER**】: NBER Working Paper No. 32940，https://www.nber.org/papers/w32940

#### 73. The Effect of Inflation Uncertainty on Household Expectations and Spending {#32939}

【**Author**】: Olena Kostyshyna, Luba Petersen
...
【**摘要**】：我们利用一项新的加拿大住户调查，研究通胀不确定性如何影响通胀预期和支出。通过随机信息干预，我们提供包含或不包含二阶矩的通胀统计数据，从而在家庭中产生通胀不确定性的差异。所有信息类型均有效降低了通胀预期和不确定性。虽然传达通胀不确定性并不影响预期或不确定性水平，但它增加了预期通胀率落在所传达区间附近的概率。利用Nielsen IQ Homescanner数据，我们发现更高的通胀预期和不确定性会减少家庭在商品上的支出。传达带有区间的通胀统计数据，通过降低预期和减少不确定性来增加支出。

【**NBER**】: NBER Working Paper No. 32939，https://www.nber.org/papers/w32939

#### 74. Firm Productivity and Learning with Digital Technologies: Evidence from Cloud Computing {#32938}

【**Author**】: James M. Brand, Mert Demirer, Connor Finucane, Avner A. Kreps
...
【**摘要**】：数字技术已经改变了所有行业的企业生产。在本文中，我们通过研究企业如何高效使用云计算，记录了关于企业在新兴技术下生产率的新事实。利用来自近10万家企业的高频CPU利用率数据，我们发现企业云生产率存在巨大且持续的差异。然而，在这种情境下，生产率具有高度动态性：企业在采用云计算后的第一年内，其云生产率提高了33%，并且需要四年才能达到稳定水平，这表明学习该技术需要较长的调整期。尽管最初效率较低的企业学习速度更快，使得生产率差异随时间推移减少了60%，但即使在十年后，显著的异质性依然存在。最后，生产率的提高主要发生在企业内部的各个部门内部，部门之间的知识转移微乎其微。

【**NBER**】: NBER Working Paper No. 32938，https://www.nber.org/papers/w32938

#### 75. Carbon VIX: Carbon Price Uncertainty and Decarbonization Investments {#32937}

【**Author**】: Maximilian Fuchs, Johannes Stroebel, Julian Terstegge
...
【**摘要**】：我们研究碳价不确定性对企业运营脱碳决策的影响。我们首先利用欧洲排放交易体系中排放配额期权的定价信息，构建了碳VIX——一种基于市场的高频碳价不确定性衡量指标。碳价不确定性水平较高，随时间大幅波动，并在重大气候政策事件期间经历持续性冲击。为了探究碳价不确定性对预期总脱碳投资的影响，我们分析了其对帮助其他企业脱碳的企业股票回报的影响。为了识别这些“碳解决方案提供商”，我们从一项大型企业调查中提取了常见的脱碳投资类型，然后确定了提供相关商品和服务的公司。我们发现，这些碳解决方案提供商的股票回报与碳价正相关，但与碳价不确定性负相关。碳价不确定性上升对我们代理的预期脱碳投资的影响在经济上很大，其幅度与碳价下降的影响相当。这些发现支持了实物期权理论的预测，即当面临未来排放成本的不确定性时，企业可能会推迟脱碳投资。

【**NBER**】: NBER Working Paper No. 32937，https://www.nber.org/papers/w32937

#### 76. Perpetual Futures Pricing {#32936}

【**Author**】: Damien Ackerer, Julien Hugonnier, Urban Jermann
...
【**摘要**】：永续期货是没有到期日的合约，其中期货价格与现货价格的锚定通过多头向空头的定期资金支付来保证。我们推导了各种永续合约（包括离散时间和连续时间下的线性、反向和双币种期货）的无套利价格的显式表达式。特别地，我们表明期货价格由现货在反映价格锚定强度的随机时间点上的风险中性预期给出。此外，我们确定了能保证期货与现货价格一致的资金支付规范，并表明对于此类规范，永续期货合约可以通过在基础证券中进行动态交易来复制。

【**NBER**】: NBER Working Paper No. 32936，https://www.nber.org/papers/w32936

#### 77. Assessing Nonresponse Bias in Macro Indicators by Combining Para-, Administrative, and Survey Data {#32935}

【**Author**】: Ori Heffetz, Guy Lichtinger, Daniel B. Reeves
...
【**摘要**】：全国性调查对于估算关键经济总量指标至关重要，包括失业率、劳动力参与率和家庭支出。由于应答率下降以及随之而来的无应答偏差风险，这些指标的准确性正受到越来越多的审视。我们如何评估这些关键经济总量指标中的无应答偏差？

【**NBER**】: NBER Working Paper No. 32935，https://www.nber.org/papers/w32935

#### 78. Patent Text and Long-Run Innovation Dynamics: The Critical Role of Model Selection {#32934}

【**Author**】: Ina Ganguli, Jeffrey Lin, Vitaly Meursault, Nicholas F. Reynolds
...
【**摘要**】：正如扭曲的地图可能误导人，自然语言处理模型也可能产生误判。我们如何知道该信任哪个自然语言处理模型？我们为选择和运用专利文本的自然语言处理表示提供了全面指导。我们开发了新颖的验证任务来评估几个领先的自然语言处理模型。这些任务评估了候选模型与专家及非专家对专利相似性判断的一致性程度。最先进的语言模型显著优于TF-IDF等传统方法。利用我们经过验证的表示，我们衡量了同期专利相似性的长期下降趋势：发明人正在不断扩展的知识前沿上“分散开来”。这一发现得到了来自新近数字化的历史专利冲突记录的多重发明率下降的证实。相比之下，在不验证替代方案的情况下选择另一种单一表示，则会产生模糊甚至相反的趋势。因此，我们的框架解决了在不同黑箱自然语言处理模型中进行选择这一根本性挑战，这些模型会产生不同的经济测量结果。为促进未来研究，我们计划提供我们的验证任务数据以及1836年至2023年间所有美国专利的嵌入向量。

【**NBER**】: NBER Working Paper No. 32934，https://www.nber.org/papers/w32934

#### 79. Climate Capitalists {#32933}

【**Author**】: Niels Joachim Gormsen, Kilian Huber, Sangmin Simon Oh
...
【**摘要**】：理论上，资本成本渠道可以像碳税一样激励绿色投资。这一渠道要求企业认为绿色资本的成本低于棕色资本。利用手工收集的数据，我们表明自2016年以来，当金融投资者和政府对气候问题的关注激增时，绿色企业确实认为其资本成本低了1个百分点。此外，一些能源企业已为其绿色部门使用了较低的资本成本。这些发现表明，资本成本可以激励资本在企业间和企业内部向更绿色的投资重新配置。

【**NBER**】: NBER Working Paper No. 32933，https://www.nber.org/papers/w32933

#### 80. The New Digital Divide {#32932}

【**Author**】: Mayana Pereira, Shane Greenstein, Raffaella Sadun, Prasanna Tambe, Lucia Ronchi Darre, Tammy Glazer, Allen Kim, Rahul Dodhia, Juan Lavista Ferres
...
【**摘要**】：我们构建并分析了新的数字使用指标，这些指标利用了微软在操作系统更新期间从美国四千万台Windows设备收集的遥测数据。这些美国住户数字使用指标比任何现有商业或政府调查提供的指标都要全面得多。我们构建了邮政编码层面的设备表示，并发现存在显著的城乡差异证据。我们还表明，即使在狭义的都市统计区内，也存在巨大的使用差异。收入和受教育程度与这些观察到的差异相关。这些影响很大，表明数字素养差距超出了当地基本信息技术基础设施的可获得性。这些发现呼吁采取超越传统基础设施接入关注点的干预措施，并解决使用和技能发展问题。这些指数已公开提供，以支持未来的研究。

【**NBER**】: NBER Working Paper No. 32932，https://www.nber.org/papers/w32932

#### 81. Black Reparations and Child Well-Being: A Framework and Policy Considerations {#32931}

【**Author**】: Lisa A. Gennetian, Christina M. Gibson-Davis, William Darity
...
【**摘要**】：我们提出了一个以儿童为中心的赔偿框架，并考虑了政策影响及其对被奴役非裔美国人后裔儿童的意义。我们运用人力资本经济理论，结合生物生态发展系统理论，阐述了奴隶制和种族主义遗留问题所造成的多层次伤害。我们对估算数据的整理显示，与白人同龄人相比，黑人儿童从出生到青年时期，在不利于教育和经济繁荣的结果方面，面临的风险高出两倍以上。我们还发现，有子女家庭中的持久种族财富差异大于无子女家庭；2019年有子女家庭中的种族财富差距与60年前的水平相当。模拟结果表明，在儿童早期为每个孩子提供13万美元的财富转移，可将黑人与白人在高中毕业率上的差距缩小13个百分点，并将大学入学率提高26个百分点。对现有美国赔偿举措的回顾显示，很少有项目包含专门针对黑人家庭或儿童的直接资金转移或其他形式的投资。基于一项当代调查，我们发现，有年幼子女的黑人父母表示支持以直接现金支付以及其他形式的经济援助作为赔偿方式。

【**NBER**】: NBER Working Paper No. 32931，https://www.nber.org/papers/w32931
...
【**摘要**】：当一个国家开始从专制政府形式向民主政府形式转变时，我们通常认为这是一种进步。然而，选举和其他早期民主形式的引入，往往会产生加剧政治不稳定的反常效应。这也增加了当权者为政治目的操纵经济的动机，从而常常对经济增长产生负面影响。我们认为，要超越这些有害影响——即调和民主与资本主义——关键在于转向一种基于非人格化规则的治理结构，这些规则以相同的方式适用于所有人（或至少适用于广泛的类别）。我们阐述了这一论点的理论基础，并以美国、英国和德国的案例中这种转型如何（或未能）实现的证据加以说明。

【**NBER**】: NBER Working Paper No. 32930，https://www.nber.org/papers/w32930
...
【**摘要**】：我们研究了一个在线医疗市场中的性别歧视。统计歧视理论意味着，随着评论的积累，性别对价格的影响应该下降，而评论的影响应该上升。然而，在我们的情境中，这一推论并不成立，因为医生会主动选择如何强烈地传递性别信号。我们基于这种选择，开发了一种新的检验统计歧视推论的方法。我们发现了与统计歧视一致的证据：在男性主导的领域，女性医生受到歧视，反之亦然。例如，在男性主导的领域，女性医生最初会更强地隐藏性别，并且随着评论的积累，性别信号传递的差距会缩小。

【**NBER**】: NBER Working Paper No. 32929，https://www.nber.org/papers/w32929

#### 84. Business Failures by Branch of Business in the United States, 1895 to 1935: A Statistical History {#32928}

【**Author**】: Gary Richardson, Marco Del Angel, Michael Gou
...
【**摘要**】：《邓氏评论》在19世纪90年代开始按月发布按行业分类的破产数据。这些序列经历了多次演变。本文重建了1895年至1935年的序列，并讨论了如何将其用于经济分析。

【**NBER**】: NBER Working Paper No. 32928，https://www.nber.org/papers/w32928

#### 85. Instrumental Variables with Unobserved Heterogeneity in Treatment Effects {#32927}

【**Author**】: Magne Mogstad, Alexander Torgovitsky
...
【**摘要**】：本章综合并批判性地评述了允许处理效应存在未观测异质性（UHTE）的现代工具变量（IV）文献。我们首先讨论了为什么UHTE通常是经济学中IV应用的一个重要方面，并解释了允许其存在所带来的概念性挑战。然后，我们回顾并概述了纳入UHTE的两种通用策略。第一种策略是继续使用为经典常数（同质）处理效应模型设计的线性IV估计量，承认它们可能存在的设定错误，并试图在存在UHTE的情况下逆向推导出一个有吸引力的解释。这种策略通常导致对线性IV的解释涉及局部平均处理效应（LATE）。我们回顾了自20世纪90年代初LATE概念引入以来，其使用和论证方式扩展与收缩的各种途径。第二种策略是正向设计明确允许UHTE的新估计量。该策略源于20世纪70年代的Gronau-Heckman选择模型，其思想通过边际处理效应（MTE）分析得以复兴。我们讨论了MTE方法的实施，并建立了其与分散在计量经济学和因果推断文献中的相关控制函数法和边界法的联系。

【**NBER**】: NBER Working Paper No. 32927，https://www.nber.org/papers/w32927

#### 86. The Realities Of Disclosure Risks In The Age Of Dark Patterns And Big Data {#32926}

【**Author**】: Ramon Abraham A. Sarmiento
...
【**摘要**】：本文探讨了当前大数据环境下信息披露风险的真实状况，考察了对个人、社会以及不断演变的伦理格局的影响。其中一个现实是数据收集中暗黑模式的普遍使用。暗黑模式是精心设计的用户界面，旨在诱骗用户做出违背自身利益的行为，例如损害其隐私。这引发了关于平衡保密与隐私义务以及精确研究数据需求的重要伦理和法律辩论。因此，本文旨在阐明这些由数据隐私、统计数据使用和暗黑模式应用交叉产生的信息披露风险所带来的法律和伦理困境，例如现有数据保护措施可能存在的不足及其在大数据时代可能过时的问题。

【**NBER**】: NBER Working Paper No. 32926，https://www.nber.org/papers/w32926

#### 87. Own-Wage Elasticity: Quantifying the Impact of Minimum Wages on Employment {#32925}

【**Author**】: Arindrajit Dube, Ben Zipperer
...
【**摘要**】：利用最低工资上涨估算的就业自身工资弹性（OWE）提供了该政策对就业影响的一个具有经济意义的衡量指标。我们讨论了如何解释OWE的大小，包括从福利角度以及在不同劳动力市场模型下的解释。我们提供了来自88项研究的全面OWE估计值集合，并介绍了一个定期更新的估计值数据库——https://economic.github.io/owe——为学者和政策制定者提供现有文献的最新快照。我们发现，迄今为止大多数研究表明最低工资对就业的影响相当温和：在学术期刊上发表的72项研究中，OWE估计值的中位数为-0.13，这表明最低工资上涨带来的潜在收益中，只有约13%因相关的就业损失而被抵消。2010年以来发表的估计值往往更接近于零。

【**NBER**】: NBER Working Paper No. 32925，https://www.nber.org/papers/w32925

#### 88. The Nonlinear Effects of Air Pollution on Health: Evidence from Wildfire Smoke {#32924}

【**Author**】: Nolan H. Miller, David Molitor, Eric Zou
...
【**摘要**】：我们估算了美国野火烟雾导致的急性空气污染暴露如何影响人类健康，并允许存在非线性效应。野火烟雾无处不在，并根据风力和烟羽厚度产生强度不同的空气质量冲击。利用2007-2019年的行政医疗保险记录，我们估计，在65岁及以上成年人中，野火烟雾占环境PM2.5浓度的18%，占死亡人数的0.42%，占急诊就诊人数的0.69%。较小的污染冲击会产生不成比例的巨大健康影响，这表明即使在符合当前监管标准的地区，改善空气质量也能带来显著的健康益处。

【**NBER**】: NBER Working Paper No. 32924，https://www.nber.org/papers/w32924

#### 89. An Anatomy of Firms’ Political Speech {#32923}

【**Author**】: Pablo Ottonello, Wenting Song, Sebastian Sotelo
...
【**摘要**】：我们研究了美国企业政治言论的分布情况。通过训练一个大型语言模型来识别包含政治观点的陈述，我们基于企业的沟通（财报电话会议、监管文件及社交媒体）开发了一个衡量政治参与度的指标。利用这些数据，我们记录了关于企业政治参与的五项事实：（1）企业中进行政治参与的情况很少见；（2）政治参与集中在大型企业；（3）企业倾向于专注于特定的议题和渠道；（4）大型企业往往涉及更广泛的议题和渠道；（5）2020年企业政治参与的激增与中型企业参与度的提升以及政治议题组合的变化有关。

【**NBER**】: NBER Working Paper No. 32923，https://www.nber.org/papers/w32923

#### 90. Estimating Flexible Income Processes from Subjective Expectations Data: Evidence from India and Colombia {#32922}

【**Author**】: Manuel Arellano, Orazio Attanasio, Samuel Crossman, Víctor Sancibrián
...
【**摘要**】：我们开发了一种方法，用于在可获得未来收入的主观概率评估时对家庭收入过程进行建模。这使得我们能够直接利用所获取的个人主观概率来灵活地估计条件累积分布函数，并获得主观风险与持续性的经验测量。随后，我们利用在印度农村和哥伦比亚农村收集的两项纵向调查数据，探讨了这些背景下收入动态的性质。我们的结果表明，在这两种情况下，线性收入过程都被拒绝，而更灵活的版本得到支持；主观收入分布呈现出异方差性、条件偏度以及非线性持续性。

【**NBER**】: NBER Working Paper No. 32922，https://www.nber.org/papers/w32922

#### 91. Optimal Monetary Policy with Redistribution {#32921}

【**Author**】: Jennifer La'O, Wendy A. Morrison
...
【**摘要**】：我们在一个包含异质性主体和名义刚性的一般均衡经济中研究最优货币政策。家庭在类型特定的、状态依存的劳动生产率以及初始企业所有权方面存在差异，但市场是完备的。财政当局可以使用具有非状态依存税率和统一的一次性税收（或转移支付）的线性税收计划。我们推导出了实施弹性价格配置为最优的充分条件。然后我们证明，当不同家庭之间的相对劳动生产率存在波动时，货币政策最优的做法是放弃弹性价格基准，转而瞄准一个状态依存的加成率。该最优加成率与一个衡量劳动收入不平等的充分统计量呈正相关。在该模型的校准版本中，反周期的收入不平等意味着反周期的最优加成率。

【**NBER**】: NBER Working Paper No. 32921，https://www.nber.org/papers/w32921

#### 92. Judges Judging Judges: Polarization in the U.S. Courts of Appeals {#32920}

【**Author**】: Alma Cohen, Rajeev H. Dehejia

【**Abstract**】: While prior literature has documented politicization in appellate decision-making, our focus — beyond replicating and extending this pattern — is on polarization, defined as differential treatment of trial judges who share the appellate panel members’ political affiliations. Using a dataset of more than 400,000 cases from 1985 to 2020, we document both phenomena. Panels with more Democratic-appointed judges are systematically more likely to reverse throughout the sample period. Polarization, however, emerges significantly only post-2000 and, while most pronounced in published cases, is present in both published and unpublished cases once reversal and publication are modeled jointly using a bivariate probit. Against a baseline reversal rate of 39 percent, moving from an all-Republican to an all-Democratic panel post-2000 increases the conditional reversal rate of Republican-nominated trial judges by approximately 9 percentage points — a 23 percent relative increase — and this effect is attenuated by roughly one-third when the trial judge is also Democratic-nominated. Polarization is strongest in ideological cases and persists among judges appointed pre-2000, indicating behavioral shifts beyond appointment effects. We find no evidence of gender-based polarization.

【**摘要**】：尽管已有文献记录了上诉法院决策中的政治化现象，但我们的关注点——除了复制和扩展这一模式之外——在于极化，即对与上诉小组成员政治派别相同的初审法官给予差别对待。利用1985年至2020年间超过40万起案件的数据集，我们记录了这两种现象。在整个样本期内，由更多民主党任命法官组成的小组系统性地更有可能推翻原判。然而，极化现象仅在2000年之后才显著出现，并且虽然在已判决案件中最为明显，但当使用双变量Probit模型联合建模推翻判决和判决发布时，这种极化在已判决和未判决案件中均存在。以39%的基准推翻率作为参照，在2000年之后，从一个全共和党任命的小组转变为一个全民主党任命的小组，会使共和党任命的初审法官被有条件推翻的概率增加约9个百分点——相对增加23%——而当初审法官也是民主党任命时，这一效应会减弱大约三分之一。极化在涉及意识形态的案件中最为强烈，并且在2000年之前任命的法官中持续存在，这表明除了任命效应之外，还存在行为上的转变。我们没有发现基于性别的极化证据。

【**NBER**】: NBER Working Paper No. 32920，https://www.nber.org/papers/w32920

#### 93. Optimal Trade Policies and Labor Markets {#32919}

【**Author**】: Yan Bai, Dan Lu, Hanxi Wang
...
【**摘要**】：我们为多部门、一般均衡的李嘉图模型提供了最优单边政策的一般公式，该模型包含了各种广泛采用的劳动力市场设定。特定部门的关税由部分供给弹性矩阵以及本国进口占外国收入的份额来概括，这反映了本国的进口市场势力。特定部门的出口税取决于贸易弹性以及本国在外围消费中的市场份额，这反映了本国的出口市场势力。本国对具有更大市场势力的部门征收更高的关税或出口税。我们将该一般公式应用于具体情形：完全流动的劳动力、部门间不完全流动的劳动力、李嘉图-罗伊模型以及无效率的劳动力市场。

【**NBER**】: NBER Working Paper No. 32919，https://www.nber.org/papers/w32919

#### 94. Businesses and Borrowing during the Roaring ‘20s and at the Onset of the Great Depression {#32918}

【**Author**】: Gary Richardson, Marco Del Angel
...
【**摘要**】：鉴于大量文献讨论了20世纪30年代美国的银行业困境，在大萧条初期哪些企业依赖商业银行获取信贷、哪些企业不依赖，似乎是一个重要的问题。然而，这个问题尚未得到解答。本文通过分析美国国税局出版物《收入统计》中的数据来探讨这一问题。这些迄今未被探索的数据揭示，所有行业的小型企业都大量从商业银行借款，并依赖它们获得维持运营所必需的信贷。大多数行业中最大的企业在银行的存款多于其借款。其企业最依赖商业银行信贷的行业是批发业、零售业、服务业以及农产品加工业。相比之下，采矿业和建筑业中近一半的经济活动、制造业中的大部分产出以及运输业中的绝大多数企业都独立于商业银行运作。

【**NBER**】: NBER Working Paper No. 32918，https://www.nber.org/papers/w32918

#### 95. Credit Scores: Performance and Equity {#32917}

【**Author**】: Stefania Albanesi, Domonkos F. Vamossy
...
【**摘要**】：信用评分对于在美国分配消费信贷至关重要，但关于其表现如何的证据却很少。我们将一个广泛使用的信用评分与一个消费者违约的机器学习模型进行基准比较，发现存在显著的借款人误分类，尤其是那些低分借款人。我们的模型提高了对年轻、低收入和少数族裔群体的预测准确性，这是因为它在处理低质量数据时表现更优，从而使得这些人群的信用状况得到改善。我们的研究结果表明，提高信用评分的表现可能会带来更公平的信贷获取机会。

【**NBER**】: NBER Working Paper No. 32917，https://www.nber.org/papers/w32917

#### 96. Racial Differences in the Total Rate of Return on Owner-Occupied Housing {#32916}

【**Author**】: Rebecca Diamond, William F. Diamond
...
【**摘要**】：我们在1974年至2021年间一个具有全国代表性的房主样本中，量化了住房总回报率的种族差异。我们开发了一种新方法来估计每套自住住房的租金价值，即利用房屋的转售价值来代理不可观测的质量。黑人和西班牙裔房主的总回报率高于白人房主，但波动性也更大，这部分是由于更高的租金收益率所致。这些差异在很大程度上可以由家庭收入和受教育程度的差异来解释。将样本中未发生交易的房产的回报纳入考虑，对于准确衡量总回报率的种族差异至关重要。

【**NBER**】: NBER Working Paper No. 32916，https://www.nber.org/papers/w32916

#### 97. Is Broader Always Better? Preexisting Distortions, Emissions Elasticities, and the Scope of Emissions Pricing {#32915}

【**Author**】: Lawrence H. Goulder, Marc A.C. Hafstead, Roberton C. Williams III
...
【**摘要**】：经济学家通常认为，广泛的碳定价（无论是碳税形式还是总量控制与交易形式）是减少二氧化碳排放的最有效政策。与豁免某些排放源的较窄政策相比，更广泛的政策往往更受青睐，因为它可以利用更多低成本的减排机会，并减少向未覆盖源的排放泄漏。然而，较窄的方法已获得相当大的政治支持，部分原因是它们避免了被视为对家庭预算特别重要的产出（如汽油）的价格上涨。一些分析人士可能会对任何偏离广泛碳定价的做法感到遗憾，并引用效率成本。本文提供的理论和数值模拟表明，这种转变不一定牺牲效率。这一结果反映了不同部门在既有税收扭曲和碳排放对碳价格弹性方面的差异。我们的分析模型揭示，利用这些差异的较窄政策可能比具有广泛、经济范围税基的政策更具成本效益。我们对美国经济的数值模型定量比较了经济范围碳价格与几种较窄政策的效果，包括仅适用于电力部门的政策、豁免汽油的政策以及豁免能源密集型贸易暴露行业的政策。我们在政策严格性的替代规范下比较了这些政策，并发现更广泛的政策在足够高的严格性下总是变得更具成本效益。

【**NBER**】: NBER Working Paper No. 32915，https://www.nber.org/papers/w32915

#### 98. Optimal Monetary and Fiscal Policies in Disaggregated Economies {#32914}

【**Author**】: Lydia Cox, Jiacheng Feng, Gernot Müller, Ernesto Pastén, Raphael Schoenle, Michael Weber
...
【**摘要**】：在一个具有部门政府支出和生产率冲击的多部门新凯恩斯模型中，联合最优的货币与财政政策组合涉及角色分离：部门政府支出最优地调整以应对部门产出缺口和通胀率——这一政策得到了来自部门联邦采购数据的证据支持。货币政策最优地专注于总体稳定，但偏离了零通胀目标；然而，在针对美国进行的模型校准中，它实际上近似于零通胀目标。由于货币政策是一种钝器，而政府支出在稳定与最优水平的公共品提供之间进行权衡，因此无法实现第一最优。

【**NBER**】: NBER Working Paper No. 32914，https://www.nber.org/papers/w32914

#### 99. Effective Regulation and Firm Compliance: The Case of German Privacy Policies {#32913}

【**Author**】: Jacopo Gambato, Bernhard Ganglmair, Julia K. Krämer
...
【**摘要**】：本章探讨了在数据监管背景下，难以执行规则的执行与合规之间的相互作用。我们聚焦于GDPR的引入及其透明度原则对德国大型企业样本隐私政策可读性的影响。德国拥有州级数据保护机构体系。这些数据监管机构执行相同的规则，但面临不同的资金状况，这为研究监管机构能力在企业合规决策中的作用提供了理想环境。我们发现，虽然平均而言，GDPR导致政策可读性下降，但那些过去受到更多监管审查的行业中的活跃企业，以及那些位于资金更充足的数据监管机构管辖区域内的企业，表现出对GDPR可读性要求更强的合规性。这些结果例证了监管机构执法活动与企业监管合规之间更普遍的相互作用。

【**NBER**】: NBER Working Paper No. 32913，https://www.nber.org/papers/w32913

#### 100. Understanding the Impact of Low-Cost Loans on Forced Labor {#32912}

【**Author**】: Anisha Sharma, Manisha Shah, Beata Łuczywek
...
【**摘要**】：2021年约有2750万人成为强迫劳动的受害者。印度建筑业尤其容易受到强迫劳动的影响，因为工人面临过长工时、强制休息日工作以及工资拖欠。负责管理工人环境的微型承包商，由于获得营运资金的渠道有限，常常自身面临财务约束。本研究调查了在班加罗尔和德里，通过向随机选择的微型承包商提供低成本贷款，缓解其流动性约束是否能改善其工人的劳动条件。我们的研究结果显示，这一干预措施总体上并未改善工作条件；事实上，某些结果略有恶化。然而，由受教育程度更高且非移民的微型承包商雇用的工人经历了显著更好的劳动条件，这突显了微型承包商之间的重要异质性。这项研究为打击强迫劳动的努力提供了新的因果见解。

【**NBER**】: NBER Working Paper No. 32912，https://www.nber.org/papers/w32912

#### 101. How Do Holistic Wrap-Around Anti-Poverty Programs Affect Employment and Individualized Outcomes? {#32911}

【**Author**】: Javier Espinosa, William N. Evans, David C. Phillips, Tim Spilde
...
【**摘要**】：新一波社会服务项目旨在通过帮助客户定义自己的目标，然后灵活且密集地支持他们多年以实现这些目标，从而构建一条摆脱贫困的路径。我们对其中一个项目进行了随机对照试验。与仅提供即时需求帮助的对照组相比，随机分配到密集、整体、全方位服务的参与者在一年后的就业率高出10个百分点。这种效果的大部分似乎在项目结束后仍然持续。然而，我们发现的有限证据表明，密集、整体的服务会影响就业以外的领域，即使生活的其他领域是参与者的主要目标。我们找到一些证据表明，该项目通过增加参与者的希望感和能动性来发挥作用，这可能更有助于支持劳动力参与，而非实现其他目标。

【**NBER**】: NBER Working Paper No. 32911，https://www.nber.org/papers/w32911

#### 102. Invoicing Currency and Exchange Rate Pass-Through in Japanese Imports: A Panel VAR Analysis {#32910}

【**Author**】: Taiyo Yoshimi, Uraku Yoshimoto, Takatoshi Ito, Kiyotaka Sato, Junko Shimizu, Yushi Yoshida
...
【**摘要**】：本研究利用2014年至2020年详细的日本海关数据，考察汇率传递对日本进口价格的影响。它主要关注计价货币选择对汇率传递的影响。以出口商货币计价的产品的汇率传递弹性大于以日元计价的产品。在全样本分析中，以出口商货币计价的产品的汇率传递弹性为0.75，而以日元计价的产品约为0.19。我们发现从两个亚洲强国——中国和泰国——进口时也存在同样的趋势。以出口商货币计价的产品与以第三方货币（即日元或出口商货币以外的货币）计价的产品之间，在汇率传递弹性上没有显著差异。此外，还发现了非对称传递，即日元升值阶段的汇率传递高于贬值阶段。这一发现被解释为，在日元贬值阶段，外国出口商为了维持其市场份额而加强了定价行为。

【**NBER**】: NBER Working Paper No. 32910，https://www.nber.org/papers/w32910

#### 103. The Case for Researching Applied Privacy Enhancing Technologies {#32909}

【**Author**】: Claire M. Bowen, Joshua Snoke, Aaron R. Williams, Andrés F. Barrientos
...
【**摘要**】：过去二十年，关于共享数据的隐私增强方法的研究显著增长。这种日益增长的兴趣导致了广泛的理论和方法研究，但隐私增强技术的实际应用数量远远落后。本文概述了安全数据技术项目以及我们为进行隐私研究所采取的方法，其具体目标是将理论付诸实践并纳入用户意见。我们概述了更广泛的项目目标，旨在安全地扩大对目前高度受限的行政税务数据的访问。我们强调，理解用户与隐私增强方法的互动如何推动了我们的研究路径，并挑战了支撑许多理论工作的往往不切实际的假设。我们回顾了研究的主要发现，讨论了未来方向的计划，并主张研究人员应追求类似的应用探究路线。

【**NBER**】: NBER Working Paper No. 32909，https://www.nber.org/papers/w32909

#### 104. Skills and Human Capital in the Labor Market {#32908}

【**Author**】: David J. Deming, Mikko I. Silliman
...
【**摘要**】：本文综合了关于技能和人力资本的经济学文献，特别关注社会技能和决策技能等高级能力。我们从微观和宏观角度回顾了人力资本回报的实证证据，以及生命周期中人力资本投资回报的证据。我们强调了当前实施的人力资本理论的两个关键局限性。首先，先前的工作大多假设人力资本是一维的，可以仅通过教育或考试成绩来衡量。其次，人力资本通常被建模为增加劳动的边际产品，工人被视为生产要素，就像物质资本一样。我们主张一种新方法，将工人视为决定如何将劳动分配到工作任务中的代理人。传统的认知技能使工人在任何任务中都更有效率，而高级技能则支配工人选择执行哪些任务以及是单独工作还是团队合作。我们通过包含团队合作和决策技能的程式化模型来说明这种方法的价值，并生成关于技能回报如何随环境变化的预测。

【**NBER**】: NBER Working Paper No. 32908，https://www.nber.org/papers/w32908
...
【**摘要**】：银行为何会失败？我们构建了一个涵盖1863年至2024年大多数商业银行的面板数据，以研究美国失败银行的历史。失败银行的特征是资产损失上升、偿付能力恶化以及对昂贵的非核心融资的依赖日益增加。这些共性意味着，使用公开财务报表中的简单会计指标可以高度预测银行失败。在存款保险制度建立之前，伴随挤兑的失败很常见，但这些失败与薄弱的基本面密切相关，这使人们对非基本面挤兑的重要性产生了怀疑。此外，失败银行资产的低回收率表明，除非对接管造成的价值破坏做出强有力的假设，否则大多数失败银行在根本上是资不抵债的。总而言之，我们的证据表明，银行失败和银行危机的主要原因几乎总是且在任何地方都是银行基本面的恶化。

【**NBER**】: NBER Working Paper No. 32907，https://www.nber.org/papers/w32907

#### 106. Adapting to Misspecification {#32906}

【**Author**】: Timothy Armstrong, Patrick M. Kline, Liyang Sun
...
【**摘要**】：实证研究通常涉及稳健性与效率之间的权衡。试图估计标量参数的研究者可以借助强假设来推导出一个精确但可能存在严重偏误的受限估计量，或者他们可以放宽其中一些假设，以推导出一个更稳健但波动性更大的非受限估计量。当受限估计量的偏误上界已知时，将非受限估计量向受限估计量收缩是最优的。对于受限估计量偏误上界未知的情况，我们提出了自适应估计量，该估计量能够最小化相对于知道该上界的理想估计量的最坏情况风险百分比增加。我们证明，自适应估计量解决了一个加权凸极小极大问题，并提供了便于其快速计算的查找表。通过重新审视一些涉及模型设定问题的知名实证研究，我们检验了适应模型误设（而非检验模型误设）的优势。

【**NBER**】: NBER Working Paper No. 32906，https://www.nber.org/papers/w32906
...
【**摘要**】：差分隐私（DP）的概念近年来获得了广泛关注，尤其是在美国人口普查局宣布将其用于2020年十年一次的人口普查之后。然而，尽管其理论特性颇具吸引力，在实践中实施DP仍然具有挑战性，尤其是在调查数据方面。在本文中，我们介绍了一个由美国人口普查局资助的正在进行中的项目的一些结果，该项目正在探索DP在调查数据中的可能性和局限性。具体来说，我们确定了在调查背景下采用DP时需要考虑的五个方面：数据生产的多阶段性质；复杂抽样设计带来的有限隐私放大效应；调查加权估计的含义；针对无应答和其他数据缺陷的加权调整；以及缺失值的插补。我们总结了项目在每一个方面的关键发现，并讨论了在DP成为统计机构新的数据保护标准之前仍需解决的一些挑战。

【**NBER**】: NBER Working Paper No. 32905，https://www.nber.org/papers/w32905

#### 108. Trade, Innovation and Firm Financing {#32904}

【**Author**】: Paul Bergin, Ling Feng, Ching-Yi Lin
...
【**摘要**】：尽管贸易文献倾向于将出口活动和创新视为互补活动，但我们提供的证据表明，融资约束是导致这两种活动对小型出口商而言可能表现为替代关系的一个原因。特别是，我们发现小型出口商的研发支出低于可比的非出口商，并且我们在小型企业资本结构的杠杆率中发现了相应的模式。一个结合了企业在创新量、出口和内生金融资本结构方面决策的模型能够解释这些实证发现。该模型表明，由于融资约束，小型企业无法充分获得出口收益，因为它们会削减研发以资助参与出口的成本。

【**NBER**】: NBER Working Paper No. 32904，https://www.nber.org/papers/w32904
...
【**摘要**】：隐私考量及其对行为的影响正变得越来越重要。然而，完全隐私和完全没有隐私这两种极端情况很少是可行的选择。行为会随着隐私的微小变化而发生多大程度的改变？Dekel等人（2023）引入了隐私弹性的概念，即经济变量对隐私保护微小变化的响应程度。这个概念结合了弹性（衡量一个变量对另一个变量变化的响应程度的关键经济指标）和差分隐私（一种计算机科学理论，正成为保护和量化隐私的标准工具）。两者共同创造了一个可移植且可在不同情境下进行比较的隐私弹性度量。通过回顾如何在公共品实验室实验中估计隐私弹性，我们展示了这一概念的适用性。

【**NBER**】: NBER Working Paper No. 32903，https://www.nber.org/papers/w32903

#### 110. Restaurant Employment, Minimum Wages, and Border Discontinuities {#32902}

【**Author**】: Arindrajit Dube, Michael Reich, Akash Bhatt, Denis Sosinskiy

【**Abstract**】: Dube, Lester and Reich (2010), using cross-state border county pairs (BCPs), did not detect restaurant employment losses from higher minimum wages. Jha, Neumark and Rodriguez- Lopez (2024, JNR), using multi-state commuting zones (MSCZs), do find disemployment effects. However, JNR’s results are confounded by 1990s-era parallel trends violations amplified by the two-way-fixed-effects (TWFE) model, which is also unreliable for detecting such violations. With post-2000 data, JNR’s specification does not indicate substantial disemployment. BCPs are much less affected by such pre-trends than MSCZs. Importantly, modern event study designs (using either MSCZs or BCPs) show no local pre-tends, and find no meaningful employment decline.

【**摘要**】：Dube, Lester和Reich（2010）使用跨州边界县对（BCPs）并未发现更高最低工资导致餐饮业就业损失。Jha, Neumark和Rodriguez-Lopez（2024，JNR）使用多州通勤区（MSCZs）则发现了就业抑制效应。然而，JNR的结果受到了20世纪90年代平行趋势假设违反的干扰，这种违反被双向固定效应（TWFE）模型放大，而该模型在检测此类违反时也不可靠。使用2000年后的数据，JNR的设定并未表明存在显著的就业抑制。与MSCZs相比，BCPs受此类事前趋势的影响要小得多。重要的是，现代事件研究设计（使用MSCZs或BCPs）均未显示局部事前趋势，也未发现任何有意义的就业下降。

【**NBER**】: NBER Working Paper No. 32902，https://www.nber.org/papers/w32902

#### 111. What’s Across the Border? Re-Evaluating the Cross-Border Evidence on Minimum Wage Effects {#32901}

【**Author**】: Priyaranjan Jha, David Neumark, Antonio Rodriguez-Lopez
...
【**摘要**】：Dube, Lester和Reich（2010）认为，与经济冲击相关的州级最低工资变化会产生虚假证据，表明更高的最低工资会减少就业。通过使用共享州边界的相邻县对内的最低工资变化，他们发现美国餐饮业的最低工资与就业之间没有关系。使用相同的研究设计，我们表明，如果改用多州通勤区（它提供了对地方经济区域的更优定义），这一结果就会被推翻。这些对比结果可以通过县对设定在使用来自不同通勤区的县对时存在的正向偏误来解释。

【**NBER**】: NBER Working Paper No. 32901，https://www.nber.org/papers/w32901
...
【**摘要**】：我们表明，与G10货币相比，一小部分采用浮动汇率的新兴市场显著扩展了投资前沿。该前沿的特征是一个样本外均值-方差有效投资组合，该组合无条件地以及有条件地对基于G10和新兴市场的交易策略进行定价。我们的方法揭示，显著交易策略的回报在很大程度上由不要求风险溢价的因子驱动。在对这些未定价风险进行实时对冲后，这些策略的夏普比率大幅提高，为货币定价模型提供了新的基准。例如，利差交易策略的夏普比率从0.71增加到1.29。未定价风险与基于地理的货币因子有关，而驱动货币风险溢价的定价风险则与总消费敞口有关。

【**NBER**】: NBER Working Paper No. 32900，https://www.nber.org/papers/w32900

#### 113. Incentives to Vaccinate {#32899}

【**Author**】: Pol Campos-Mercade, Armando N. Meier, Stephan Meier, Devin G. Pope, Florian H. Schneider, Erik Wengström
...
【**摘要**】：货币激励能否改变行为以及如何设计这些激励措施是基本的经济学问题。我们通过一项大规模疫苗接种实地实验（样本量N=5,324），结合独特的行政数据和调查数据，克服了典型的数据限制。研究发现，20美元的确定性激励在短期内使疫苗接种率提高13个百分点，长期内提高9个百分点。确定性激励比基于抽奖、亲社会或针对个人的激励更有效，尽管所有激励措施都促进了疫苗接种。这些激励措施对未来疫苗接种没有产生意外后果，也未基于疫苗接种态度和激励性经济偏好表现出异质性。此外，关于亲属的行政数据显示出显著的正向溢出效应。我们的研究结果证明了激励措施在改善公共卫生方面的巨大潜力，并为其设计提供了指导。

【**NBER**】: NBER Working Paper No. 32899，https://www.nber.org/papers/w32899

#### 114. Equilibrium Evictions {#32898}

【**Author**】: Dean Corbae, Andrew Glover, Michael Nattinger
...
【**摘要**】：我们构建了一个简单的住房租赁市场均衡模型，其中驱逐是内生的。房东和租户都缺乏承诺；如果房东预期未来的总租金支付无法覆盖成本，就会驱逐拖欠租金的租户，而租户则无法承诺支付超出其能力或意愿（基于其寻找新租房的替代选择）的租金。持续拖欠租金的租户更可能被驱逐，并且每质量调整单位住房的支付高于不太可能拖欠租金的租户。因租户无力支付而导致的驱逐在社会效率上从未达到最优，并且会导致住房质量投资降低以及相对于社会最优配置而言过少的空置率。与自由放任相比，限制房东驱逐能力的政府政策可以改善福利，但全面暂停驱逐只有在为应对大规模不利冲击而临时采用时才能提高福利。最后，租金支持即使不覆盖所有拖欠租金，也能有效消除驱逐，并且带来的收益显著大于驱逐限制。

【**NBER**】: NBER Working Paper No. 32898，https://www.nber.org/papers/w32898

#### 115. Federal Pandemic Relief and Academic Recovery {#32897}

【**Author**】: Dan C. Dewey, Erin M. Fahle, Thomas J. Kane, Sean F. Reardon, Douglas O. Staiger
...
【**摘要**】：我们测量了2022-23学年期间，来自29个州超过5000个学区的样本中，学区使用联邦疫情救助资金的效果。我们依赖于联邦拨款中几个看似外生的变异来源：各州Title I资助公式的差异、人口普查局地方贫困率估计的误差，以及联邦Title I资格和补贴午餐资格的差异。我们发现，每名学生每增加1000美元支出，数学成绩提高0.0086个标准差，阅读成绩提高0.0049个标准差。这两个结果与Jackson和Mackevicius（2023）近期关于支出影响的元分析一致。作为安慰剂检验，我们发现2022-23学年尚未支出的联邦资金与学业成绩之间没有关系。我们还使用合成控制组方法，比较了高贫困学区中联邦援助金额高和低的群体，这些群体在2022年之前的成绩趋势相似，得出了类似的结果。由于联邦援助针对高贫困学区，我们发现联邦资金不仅促进了学业恢复，还有助于缩小疫情期间扩大的成绩差距。

【**NBER**】: NBER Working Paper No. 32897，https://www.nber.org/papers/w32897

#### 116. (Dis)Information Wars {#32896}

【**Author**】: Adrian Casillas, Maryam Farboodi, Layla Hashemi, Maryam Saeedi, Steven Wilson
...
【**摘要**】：在过去十年中，社交媒体平台已成为展示异议的重要载体。作为回应，各种行为者越来越多地在这些平台上传播假新闻以削弱反对派——即（虚假）信息战。我们分析了一种利用新闻发起者网络特征来识别虚假信息的方法，并使用来自Twitter（现为X）的数据评估该方法在限制虚假信息传播方面的有效性。我们发现，该方法在不误判任何真实新闻的情况下，至少检测出85%的已验证虚假信息案例，并将虚假信息的账户参与度和生命周期至少降低一半，这凸显了快速发现虚假信息以中断其指数级传播的重要性。

【**NBER**】: NBER Working Paper No. 32896，https://www.nber.org/papers/w32896
