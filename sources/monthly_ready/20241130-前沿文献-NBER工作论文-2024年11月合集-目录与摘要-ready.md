# 【前沿文献】NBER工作论文 2024年11月合集 目录与摘要

> 2024 年 11 月 NBER 更新 123 篇工作论文，其中与中国研究相关的有 6 篇（21、45、59、92、97、120）。
> 其中，中国相关研究包括：#33197（第 21 篇，基于排放率的排放交易与重叠政策：来自理论的见解及对中国的一个应用）；#33173（第 45 篇，金融科技平台与非对称网络效应：来自市场借贷的理论与证据）；#33159（第 59 篇，超越基本面：媒体驱动叙事如何影响跨境资本流动）；#33126（第 92 篇，中美贸易战如何加速越南北部城市经济增长与环境进步）；#33121（第 97 篇，应对重大冲击的精英策略：以明朝灭亡为例）。

## 一、目录速览

1. **Painful Bargaining: Evidence from Anesthesia Rollups {#33217}**  
   痛苦的谈判：来自麻醉业务整合的证据  
   <font color=grey>Aslihan Asil, Paulo Ramos, Amanda Starc, Thomas G. Wollmann</font>

2. **Predicting College Closures and Financial Distress {#33216}**  
   预测大学关闭与财务困境  
   <font color=grey>Robert J. Kelchen, Dubravka Ritter, Douglas A. Webber</font>

3. **Dispersed Information, Nominal Rigidities and Monetary Business Cycles: A Hayekian Perspective {#33215}**  
   分散信息、名义刚性与货币商业周期：哈耶克视角  
   <font color=grey>Christian Hellwig, Venky Venkateswaran</font>

4. **The Causal Effects of Income on Political Attitudes and Behavior: A Randomized Field Experiment {#33214}**  
   收入对政治态度和行为的因果效应：一项随机实地实验  
   <font color=grey>David E. Broockman, Elizabeth Rhodes, Alexander W. Bartik, Karina Dotson, Sarah Miller, Patrick K. Krause, Eva Vivalt</font>

5. **Subsidizing Medical Spending through the Tax Code: Take-Up, Targeting and the Cost of Claiming {#33213}**  
   通过税法补贴医疗支出：参与率、目标定位与申报成本  
   <font color=grey>Gopi Shah Goda</font>

6. **The Political Economy of School Finance Systems with Endogenous State and Local Tax Policies {#33212}**  
   具有内生州和地方税收政策的学校财政体系的政治经济学  
   <font color=grey>Stephen Calabrese, Dennis Epple, Richard Romano</font>

7. **Systemic Risk Measures: From the Panic of 1907 to the Banking Stress of 2023 {#33211}**  
   系统性风险度量：从1907年恐慌到2023年银行业压力  
   <font color=grey>Viral V. Acharya, Markus K. Brunnermeier, Diane Pierret</font>

8. **Unresolved Conflict in Workers' Compensation: The Impact of Legal Representation on Workers' Compensation Benefits {#33210}**  
   工伤保险中未解决的冲突：法律代理对工伤保险赔偿的影响  
   <font color=grey>Bogdan Savych, David Neumark</font>

9. **Household Responses to Guaranteed Income: Experimental Evidence from Compton, California {#33209}**  
   家庭对保证收入的反应：来自加利福尼亚州康普顿的实验证据  
   <font color=grey>Sidhya Balakrishnan, Sewin Chan, Sara Constantino, Johannes Haushofer, Jonathan Morduch</font>

10. **FinTech Lending to Borrowers with No Credit History {#33208}**  
   金融科技向无信用记录借款人的贷款  
   <font color=grey>Laura Chioda, Paul Gertler, Sean Higgins, Paolina C. Medina</font>

11. **The End of Oil {#33207}**  
   石油的终结  
   <font color=grey>Ryan Kellogg</font>

12. **Financial Conditions Targeting {#33206}**  
   金融状况目标制  
   <font color=grey>Ricardo J. Caballero, Tomás E. Caravello, Alp Simsek</font>

13. **Estimating Gross Output Production Functions {#33205}**  
   估计总产出生产函数  
   <font color=grey>Markus Trunschke, Kenneth L. Judd</font>

14. **From Novelty to Norm: Uncovering the Drivers of Virtual Tour Effectiveness in Real Estate Sales {#33204}**  
   从新奇到常态：揭示虚拟看房在房地产销售中的有效性驱动因素  
   <font color=grey>Miremad Soleymanian, Yi Qian</font>

15. **Gender-Based Violence in Schools and Girls’ Education: Experimental Evidence from Mozambique {#33203}**  
   校园性别暴力与女童教育：来自莫桑比克的实验证据  
   <font color=grey>Sofia Amaral, Aixa Garcia-Ramos, Selim Gulesci, Alejandra Ramos, Sarita P. Ore-Quispe, Maria Micaela Sviatschi</font>

16. **r-g before and after the Great Wars 1507-2023 {#33202}**  
   大战前后的r-g：1507-2023  
   <font color=grey>Kenneth S. Rogoff, Paul Schmelzing</font>

17. **Market Power and Redeemable Loyalty Token Design {#33201}**  
   市场势力与可赎回忠诚代币设计  
   <font color=grey>Kenneth S. Rogoff, Zhiheng He, Yang You</font>

18. **Labor Force Transitions {#33200}**  
   劳动力状态转换  
   <font color=grey>Rui Castro, Fabian Lange, Markus Poschke</font>

19. **The Effects of Lump-Sum Food Benefits during the COVID-19 Pandemic on Spending, Hardship, and Health {#33199}**  
   COVID-19疫情期间一次性食品福利对支出、困难与健康的影响  
   <font color=grey>Lauren L. Bauer, Krista J. Ruffini, Diane Whitmore Schanzenbach</font>

20. **Generative AI for Economic Research: LLMs Learn to Collaborate and Reason {#33198}**  
   用于经济学研究的生成式AI：大语言模型学会协作与推理  
   <font color=grey>Anton Korinek</font>

21. **Rate-Based Emissions Trading with Overlapping Policies: Insights from Theory and an Application to China {#33197}**  
   基于排放率的排放交易与重叠政策：来自理论的见解及对中国的一个应用  
   <font color=grey>Carolyn Fischer, Chenfei Qu, Lawrence H. Goulder</font>

22. **Using Stock Price Movements to Estimate the Harm from Collusive Drug Patent Litigation Settlements {#33196}**  
   利用股价变动估算合谋性药品专利诉讼和解造成的损害  
   <font color=grey>Keith M. Drake, Thomas McGuire</font>

23. **Liquidity Traps: A Unified Theory of the Great Depression and Great Recession {#33195}**  
   流动性陷阱：大萧条与大衰退的统一理论  
   <font color=grey>Gauti B. Eggertsson, Sergey K. Egiev</font>

24. **Private Equity for Pension Plans? Evaluating Private Equity Performance from an Investor's Perspective {#33194}**  
   养老金计划的私募股权投资？从投资者角度评估私募股权表现  
   <font color=grey>Arthur Korteweg, Stavros Panageas, Anand Systla</font>

25. **How Institutions Interact with Exchange Rates After the 2024 US Presidential Election: New High-Frequency Evidence {#33193}**  
   2024年美国总统大选后制度如何与汇率互动：新的高频证据  
   <font color=grey>Joshua Aizenman, Jamel Saadaoui</font>

26. **How Important Are Cultural Frictions for Internal Migration? Evidence from the Nineteenth Century United States {#33192}**  
   文化摩擦对国内移民有多重要？来自十九世纪美国的证据  
   <font color=grey>Taylor Jaworski, Erik O. Kimbrough, Nicole Saito</font>

27. **Development Mismatch? Evidence from Agricultural Projects in Pastoral Africa {#33191}**  
   发展错配？来自非洲牧区农业项目的证据  
   <font color=grey>Eoin F. McGuirk, Nathan Nunn</font>

28. **Sticky Inflation: Monetary Policy when Debt Drags Inflation Expectations {#33190}**  
   粘性通胀：当债务拖累通胀预期时的货币政策  
   <font color=grey>Saki Bigio, Nicolas Caramp, Dejanir Silva</font>

29. **Taxing the Wealth of the Poor: Evidence from the Danish Old-Age Support Asset Test {#33189}**  
   对穷人财富征税：来自丹麦老年支持计划资产审查的证据  
   <font color=grey>Niels Johannesen, Johan Sæverud, Emmanuel Saez</font>

30. **Why Has Construction Productivity Stagnated? The Role of Land-Use Regulation {#33188}**  
   为什么建筑业生产率停滞不前？土地使用监管的作用  
   <font color=grey>Leonardo D'Amico, Edward L. Glaeser, Joseph Gyourko, William R. Kerr, Giacomo A.M. Ponzetto</font>

31. **Adverse Selection and (un)Natural Monopoly in Insurance Markets {#33187}**  
   保险市场中的逆向选择与（非）自然垄断  
   <font color=grey>Edward Kong, Timothy Layton, Mark Shepard</font>

32. **Racial Screening on the Big Screen? Evidence from the Motion Picture Industry {#33186}**  
   大银幕上的种族筛选？来自电影业的证据  
   <font color=grey>Liang Zhong, Angela Crema, M. Daniele Paserman</font>

33. **Shifting Patterns of Social Interaction: Exploring the Social Life of Urban Spaces Through A.I. {#33185}**  
   社交互动模式的变迁：通过人工智能探索城市空间的社会生活  
   <font color=grey>Arianna Salazar-Miranda, Zhuangyuan Fan, Michael B. Baick, Keith N. Hampton, Fabio Duarte, Becky P.Y. Loo, Edward L. Glaeser, Carlo Ratti</font>

34. **Assortative Matching and Wages: The Role of Selection {#33184}**  
   分类匹配与工资：选择的作用  
   <font color=grey>Katarína Borovičková, Robert Shimer</font>

35. **Fintech, Visual Attention, and Financial Inclusion: A Field Experiment on Migrant Remittances {#33183}**  
   金融科技、视觉注意力与金融包容性：关于移民汇款的实地实验  
   <font color=grey>Eduardo Nakasone, Máximo Torero, Angelino Viceisza</font>

36. **Long-Run Effects of Food Assistance: Evidence from the Food Stamp Program and Administrative Data {#33182}**  
   食品援助的长期效应：来自食品券计划与行政数据的证据  
   <font color=grey>Marianne Bitler, Theodore F. Figinski</font>

37. **Household Saving in Japan: The Past, Present, and Future {#33181}**  
   日本的家庭储蓄：过去、现在与未来  
   <font color=grey>Charles Yuji Horioka</font>

38. **The Forward Guidance Puzzle is not a Puzzle {#33180}**  
   前瞻指引之谜并非谜题  
   <font color=grey>Gauti B. Eggertsson, Finn D. Schüle</font>

39. **Overcoming Racial Gaps in School Preferences: The Effect of Peer Diversity on School Choice {#33179}**  
   克服学校偏好中的种族差距：同伴多样性对择校的影响  
   <font color=grey>Clemence M. Idoux, Viola Corradini</font>

40. **The Rise of E-Wallet Super-Apps and Buy-Now-Pay-Later {#33178}**  
   电子钱包超级应用与先买后付的兴起  
   <font color=grey>Wenlong Bian, Lin William Cong, Yang Ji</font>

41. **Flexible Pay and Labor Supply: Evidence from Uber’s Instant Pay {#33177}**  
   灵活支付与劳动力供给：来自优步即时支付的证据  
   <font color=grey>M. Keith Chen, Katherine Feinerman, Kareem Haggag</font>

42. **Couch-Locked with the Munchies: Effects of Recreational Marijuana Laws on Exercise and Nutrition {#33176}**  
   沙发锁与零食瘾：娱乐用大麻合法化对锻炼和营养的影响  
   <font color=grey>Thomas Wilk, Monica Deza, Timothy Hodge, Shooshan Danagoulian</font>

43. **A New Measure of Surviving Children that Sheds Light on Long-term Trends in Fertility {#33175}**  
   衡量存活子女数的新指标及其对生育率长期趋势的启示  
   <font color=grey>Anup Malani, Ari Jacob</font>

44. **Federal Reserve Independence and Congressional Intent: A Reappraisal of Marriner Eccles’ Role in the Reformulation of the Fed in 1935 {#33174}**  
   美联储独立性与国会意图：对马瑞纳·埃克尔斯在1935年美联储改革中角色的重新评估  
   <font color=grey>Gary Richardson, David W. Wilcox</font>

45. **FinTech Platforms and Asymmetric Network Effects: Theory and Evidence from Marketplace Lending {#33173}**  
   金融科技平台与非对称网络效应：来自市场借贷的理论与证据  
   <font color=grey>Lin William Cong, Ke Tang, Danxia Xie, Weiyi Zhao</font>

46. **From Labor to Intermediates: Firm Growth, Input Substitution, and Monopsony {#33172}**  
   从劳动到中间品：企业成长、投入替代与买方垄断  
   <font color=grey>Matthias Mertens, Benjamin Schoefer</font>

47. **Investing in Customer Capital {#33171}**  
   投资于客户资本  
   <font color=grey>Bianca He, Lauren I. Mostrom, Amir Sufi</font>

48. **Greens are Right to be Suspicious of Carbon Offsets {#33170}**  
   环保主义者有理由对碳抵消持怀疑态度  
   <font color=grey>Geoffrey Heal</font>

49. **The Signaling Value of Government Action: The Effect of Istanbul Convention on Female Murders {#33169}**  
   政府行为的信号价值：《伊斯坦布尔公约》对女性谋杀案的影响  
   <font color=grey>Güneş Aşık, Naci H. Mocan</font>

50. **Textual Factors: A Scalable, Interpretable, and Data-driven Approach to Analyzing Unstructured Information {#33168}**  
   文本因子：一种可扩展、可解释且数据驱动的非结构化信息分析方法  
   <font color=grey>Lin William Cong, Tengyuan Liang, Xiao Zhang, Wu Zhu</font>

51. **Minimum Wages and Race Disparities {#33167}**  
   最低工资与种族差异  
   <font color=grey>David Neumark, Jyotsana Kala</font>

52. **Immobility As Memory: Some New Approaches to Characterizing Intergenerational Persistence via Markov Chains {#33166}**  
   作为记忆的固化：基于马尔可夫链刻画代际持续性的新方法  
   <font color=grey>Lawrence Blume, Neil A. Cholli, Steven N. Durlauf, Aleksandra Lukina</font>

53. **The Value of Statistical Life for Seniors {#33165}**  
   老年人的统计生命价值  
   <font color=grey>Jonathan D. Ketcham, Nicolai V. Kuminoff, Nirman Saha</font>

54. **The G.I. Bill, Standardized Testing, and Socioeconomic Origins of the U.S. Educational Elite Over a Century {#33164}**  
   《退伍军人权利法案》、标准化考试与美国精英阶层教育背景的百年社会经济渊源  
   <font color=grey>Ran Abramitzky, Jennifer K. Kowalski, Santiago Pérez, Joseph Price</font>

55. **The Misery of Diversity {#33163}**  
   多样性的痛苦  
   <font color=grey>Resul Cesur, Sadullah Yıldırım</font>

56. **The Politics of Global Public Goods {#33162}**  
   全球公共产品的政治经济学  
   <font color=grey>Bård Harstad</font>

57. **On International Cooperation {#33161}**  
   论国际合作  
   <font color=grey>Bård Harstad</font>

58. **A Simple Model of Average Inflation Targeting {#33160}**  
   平均通胀目标制的简单模型  
   <font color=grey>Laurence M. Ball, Junnan Zhang</font>

59. **Beyond the Fundamentals: How Media-Driven Narratives Influence Cross-Border Capital Flows {#33159}**  
   超越基本面：媒体驱动叙事如何影响跨境资本流动  
   <font color=grey>Isha Agarwal, Wentong Chen, Eswar S. Prasad</font>

60. **Economic Surveillance using Corporate Text {#33158}**  
   利用企业文本进行经济监测  
   <font color=grey>Tarek Alexander Hassan, Stephan Hollander, Aakash Kalyani, Laurence van Lent, Markus Schwedeler, Ahmed Tahoun</font>

61. **The Distributional Implications of Itemized Medical Deductions {#33157}**  
   分项医疗扣除的分配影响  
   <font color=grey>Gopi Shah Goda, Ithai Lurie, Priyanka S. Parikh, Chelsea Swete</font>

62. **Forecasting Natural Gas Prices in Real Time {#33156}**  
   实时预测天然气价格  
   <font color=grey>Christiane Baumeister, Florian Huber, Thomas K. Lee, Francesco Ravazzolo</font>

63. **Nonpayment and Eviction in the Rental Housing Market {#33155}**  
   租赁住房市场中的欠租与驱逐  
   <font color=grey>John Eric Humphries, Scott T. Nelson, Dam Linh Nguyen, Winnie van Dijk, Daniel C. Waldinger</font>

64. **Unwarranted Racial Disparity in U.S. Foster Care Placement {#33154}**  
   美国寄养安置中无根据的种族差异  
   <font color=grey>E. Jason Baron, Joseph J. Doyle Jr., Natalia Emanuel, Peter Hull</font>

65. **The Evolution of Gender in the Labor Market {#33153}**  
   劳动力市场中性别角色的演变  
   <font color=grey>Claudia Olivetti, Jessica Pan, Barbara Petrongolo</font>

66. **The Economics of “Buy Now, Pay Later”: A Merchant’s Perspective {#33152}**  
   “先买后付”的经济学：商家视角  
   <font color=grey>Tobias Berg, Valentin Burg, Jan Keil, Manju Puri</font>

67. **Estimating Aggregate Human Capital Externalities {#33151}**  
   估算总体人力资本外部性  
   <font color=grey>Junjie Guo, Nicolas A. Roys, Ananth Seshadri</font>

68. **The Color of Ideas: Racial Dynamics and Citations in Economics {#33150}**  
   思想的色彩：经济学中的种族动态与引用  
   <font color=grey>Marlène Koffi, Roland Pongou, Leonard Wantchekon</font>

69. **Wage Adjustment in Efficient Long-Term Employment Relationships {#33149}**  
   高效长期雇佣关系中的工资调整  
   <font color=grey>Michael W. L. Elsby, Axel Gottfries, Pawel M. Krolikowski, Gary Solon</font>

70. **The Economics of Net Zero Banking {#33148}**  
   净零银行业的经济学  
   <font color=grey>Adair Morse, Parinitha R. Sastry</font>

71. **Therapy to Reduce Violence and Improve Institutional Safety During Incarceration {#33147}**  
   减少暴力并改善监禁期间机构安全的疗法  
   <font color=grey>Mary Kate Batistich, William N. Evans, Tyler Giles, Rebecca Margolit-Chan</font>

72. **The Power of Daughters: How Physicians' Family Influences Female Patients' Health {#33146}**  
   女儿的力量：医生的家庭如何影响女性患者的健康  
   <font color=grey>Mette Gørtz, Ida L. Kristiansen, Tianyi Wang</font>

73. **Capital Flow Stability and Policy Challenges in Southeast Asia: Historical Perspectives from the 19th to the 21st Century {#33145}**  
   资本流动稳定性与东南亚政策挑战：19至21世纪的历史视角  
   <font color=grey>Christopher M. Meissner, Kensuke Molnar-Tanaka</font>

74. **Nonlinear Pricing and Misallocation {#33144}**  
   非线性定价与资源错配  
   <font color=grey>Gideon Bornstein, Alessandra Peter</font>

75. **Trade, Trees, and Lives {#33143}**  
   贸易、树木与生命  
   <font color=grey>Xinming Du, Lei Li, Eric Zou</font>

76. **Liquidity Shocks and Firm Exports: Evidence from Cash Shortages During India’s Demonetization {#33142}**  
   流动性冲击与企业出口：来自印度废钞期间现金短缺的证据  
   <font color=grey>Ritam Chaurey, Ryan Kim, Pravin Krishna</font>

77. **Information Span in Credit Market Competition {#33141}**  
   信贷市场竞争中的信息广度  
   <font color=grey>Zhiguo He, Jing Huang, Cecilia Parlatore</font>

78. **Evaluating Minimum Taxation {#33140}**  
   评估最低税制  
   <font color=grey>James R. Hines Jr.</font>

79. **Concentrating Intelligence: Scaling and Market Structure in Artificial Intelligence {#33139}**  
   集中智能：人工智能中的规模与市场结构  
   <font color=grey>Anton Korinek, Jai Vipra</font>

80. **Industrial Policies and Innovation: Evidence from the Global Automobile Industry {#33138}**  
   产业政策与创新：来自全球汽车行业的证据  
   <font color=grey>Panle Jia Barwick, Hyuk-Soo Kwon, Shanjun Li, Yucheng Wang, Nahim B. Zahur</font>

81. **Income Inequality and Job Creation {#33137}**  
   收入不平等与就业创造  
   <font color=grey>Sebastian K. Doerr, Thomas Drechsel, Donggyu Lee</font>

82. **Central Bank Information or Neo-Fisher Effect? {#33136}**  
   央行信息效应还是新费雪效应？  
   <font color=grey>Stephanie Schmitt-Grohé, Martín Uribe</font>

83. **Education and Preferences for Desired Traits in Children {#33135}**  
   教育与对儿童期望特质的偏好  
   <font color=grey>Naci H. Mocan, Nur Orak</font>

84. **Randomized Entry: The Equilibrium Effects of Entry in Digital Financial Markets {#33134}**  
   随机进入：数字金融市场中进入的均衡效应  
   <font color=grey>Francis Annan</font>

85. **Resolving Puzzles of Monetary Policy Transmission in Emerging Markets {#33133}**  
   解开新兴市场货币政策传导之谜  
   <font color=grey>Jongrim Ha, Dohan Kim, M. Ayhan Kose, Eswar S. Prasad</font>

86. **Tax Policy, Investment and Profit Shifting {#33132}**  
   税收政策、投资与利润转移  
   <font color=grey>Katarzyna A. Bilicka, Michael P. Devereux, İrem Güçeri</font>

87. **Forced Displacement, the Perpetuation of Autocratic Leaders, and Development in Origin Countries {#33131}**  
   被迫流离失所、威权领导人的延续与原籍国的发展  
   <font color=grey>Nicolas Cabra-Ruiz, Sandra V. Rozo, Maria Micaela Sviatschi</font>

88. **Quantitative Urban Economics {#33130}**  
   定量城市经济学  
   <font color=grey>Stephen J. Redding</font>

89. **Macro-Level Institutions and Micro-Level Economic Behavior: A Meta-Meta Analysis of 1,126 Studies {#33129}**  
   宏观制度与微观经济行为：基于1126项研究的元元分析  
   <font color=grey>Jason A. Aimone, Sheryl Ball, Esha Dwibedi, Jeremy J. Jackson, James E. West</font>

90. **Input Price Dispersion Across Buyers and Misallocation {#33128}**  
   买方间投入品价格离散与资源错配  
   <font color=grey>Ariel Burstein, Javier Cravino, Marco Rojas</font>

91. **Trade Policy as an Exogenous Shock: Focusing on the Specifics {#33127}**  
   作为外生冲击的贸易政策：聚焦具体关税  
   <font color=grey>Andrew Greenland, John Lopresti</font>

92. **How the US-China Trade War Accelerated Urban Economic Growth and Environmental Progress in Northern Vietnam {#33126}**  
   中美贸易战如何加速越南北部城市经济增长与环境进步  
   <font color=grey>Matthew E. Kahn, Wen-Chi Liao, Siqi Zheng</font>

93. **Spatial Economics {#33125}**  
   空间经济学  
   <font color=grey>Stephen J. Redding</font>

94. **On the Limits of Chronological Age {#33124}**  
   论生理年龄的局限性  
   <font color=grey>Rainer Kotschy, David E. Bloom, Andrew J. Scott</font>

95. **Monetary-Fiscal Coordination with International Hegemon {#33123}**  
   国际霸权下的货币财政协调  
   <font color=grey>Xuning Ding, Zhengyang Jiang</font>

96. **Earnings, Marriage, and the Variance of Family Income by Age, Gender, and Cohort {#33122}**  
   收入、婚姻与家庭收入方差：基于年龄、性别和队列的视角  
   <font color=grey>Joseph Altonji, Daniel Giraldo Páez, Disa M. Hynsjö, Ivan Vidangos</font>

97. **Elite Strategies for Big Shocks: The Case of the Fall of the Ming {#33121}**  
   应对重大冲击的精英策略：以明朝灭亡为例  
   <font color=grey>Carol H. Shiue, Wolfgang Keller</font>

98. **Small Changes, Big Impact: Nudging Employees Toward Sustainable Behaviors {#33120}**  
   小改变，大影响：助推员工走向可持续行为  
   <font color=grey>Laura Cappellucci, Lan Ha, Jeremy Honig, Christopher R. Knittel, Amy Vetter, Richard Wilner</font>

99. **Expecting Climate Change: A Nationwide Field Experiment in the Housing Market {#33119}**  
   预期气候变化：住房市场中的全国性实地实验  
   <font color=grey>Daryl Fairweather, Matthew E. Kahn, Robert D. Metcalfe, Sebastian Sandoval Olascoaga</font>

100. **Using Information to Curb Racial Discrimination {#33118}**  
   利用信息遏制种族歧视  
   <font color=grey>Christopher R. Knittel, Donald MacKenzie, Michiko Namazu, Bora Ozaltun, Dan Svirsky, Stephen Zoepf</font>

101. **Taming the Curse of Dimensionality: Quantitative Economics with Deep Learning {#33117}**  
   驯服维度灾难：基于深度学习的数量经济学  
   <font color=grey>Jesús Fernández-Villaverde, Galo Nuño, Jesse Perla</font>

102. **Robots and Labor in Nursing Homes {#33116}**  
   养老院中的机器人与劳动力  
   <font color=grey>Yong Suk Lee, Toshiaki Iizuka, Karen Eggleston</font>

103. **Two Wrongs Can Sometimes Make a Right: The Environmental Benefits of Market Power in Oil {#33115}**  
   两个错误有时能成就一个正确：石油市场势力的环境效益  
   <font color=grey>John Asker, Allan Collard-Wexler, Charlotte De Canniere, Jan De Loecker, Christopher R. Knittel</font>

104. **Industry and Identity: The Migration Linkage Between Economic and Cultural Change in 19th Century Britain {#33114}**  
   产业与身份：19世纪英国经济与文化变迁的迁移关联  
   <font color=grey>Vasiliki Fouka, Theo Serlin</font>

105. **Is Free Trade Good for Renewable Resources: Brander & Taylor Redux {#33113}**  
   自由贸易对可再生资源有益吗：布兰德与泰勒再探讨  
   <font color=grey>M. Scott Taylor</font>

106. **Short-Time Work Extensions {#33112}**  
   短时工作延期  
   <font color=grey>Christina Brinkmann, Simon Jäger, Moritz Kuhn, Farzad Saidi, Stefanie Wolter</font>

107. **The Mental Health of the Young in Latin America {#33111}**  
   拉丁美洲年轻人的心理健康  
   <font color=grey>David G. Blanchflower, Alex Bryson</font>

108. **Carbon Burden {#33110}**  
   碳负担  
   <font color=grey>Lubos Pastor, Robert F. Stambaugh, Lucian A. Taylor</font>

109. **The Complexity of Economic Decisions {#33109}**  
   经济决策的复杂性  
   <font color=grey>Xavier Gabaix, Thomas Graeber</font>

110. **Gambling Away Stability: Sports Betting’s Impact on Vulnerable Households {#33108}**  
   赌博侵蚀稳定：体育博彩对弱势家庭的影响  
   <font color=grey>Scott R. Baker, Justin Balthrop, Mark J. Johnson, Jason D. Kotter, Kevin Pisciotta</font>

111. **Information Discovery for Industrial Policy {#33107}**  
   产业政策的信息发现  
   <font color=grey>Michael Sockin, Wei Xiong</font>

112. **Current Account Dynamics and the Saving-Investment Nexus In a Changing and Uncertain World {#33106}**  
   变化与不确定世界中的经常账户动态与储蓄-投资关系  
   <font color=grey>Menzie D. Chinn, Hiro Ito</font>

113. **Using Policy and Innovation to Improve Life-Saving Access to Naloxone {#33105}**  
   利用政策与创新改善纳洛酮的救命可及性  
   <font color=grey>Evan D. Peet, David Powell, Rosalie Liccardo Pacula</font>

114. **Unwarranted Disparity in High-Stakes Decisions: Race Measurement and Policy Responses {#33104}**  
   高风险决策中的不当差异：种族测量与政策回应  
   <font color=grey>E. Jason Baron, Joseph J. Doyle Jr., Natalia Emanuel, Peter Hull, Joseph P. Ryan</font>

115. **The ECB’s Climate Activities and Public Trust {#33103}**  
   欧洲央行的气候活动与公众信任  
   <font color=grey>Sandra Eickmeier, Luba Petersen</font>

116. **Deficits and Inflation: HANK meets FTPL {#33102}**  
   赤字与通胀：HANK模型遇上FTPL理论  
   <font color=grey>George-Marios Angeletos, Chen Lian, Christian K. Wolf</font>

117. **Unbalanced Trade: Is Growing Dispersion from Financial or Trade Reforms? {#33101}**  
   失衡贸易：日益加剧的分散性源于金融改革还是贸易改革？  
   <font color=grey>George A. Alessandria, Yan Bai, Soo Kyung Woo</font>

118. **Did Tariffs Make American Manufacturing Great? New Evidence from the Gilded Age {#33100}**  
   关税是否让美国制造业再次伟大？来自镀金时代的新证据  
   <font color=grey>Alexander Klein, Christopher M. Meissner</font>

119. **The GDPR and SDK Usage In Android Mobile Apps {#33099}**  
   《通用数据保护条例》与安卓移动应用中的软件开发工具包使用  
   <font color=grey>Ginger Zhe Jin, Ziqiao Liu, Liad Wagman</font>

120. **The China Shock Revisited: Job Reallocation and Industry Switching in U.S. Labor Markets {#33098}**  
   再探中国冲击：美国劳动力市场中的就业再配置与行业转换  
   <font color=grey>Nicholas Bloom, Kyle Handley, André Kurmann, Philip A. Luck</font>

121. **Everyone Steps Back? The Widespread Retraction of Crowd-Funding Support for Minority Creators when Migration Fear is High {#33097}**  
   人人退后？当移民恐惧高涨时，众筹对少数族裔创作者的支持普遍撤回  
   <font color=grey>John (Jianqiu) Bai, William R. Kerr, Chi Wan, Alptug Y. Yorulmaz</font>

122. **Willingness-To-Pay vs Administrative Hurdles: Understanding Barriers to Social Insurance Enrollment in Thailand {#33096}**  
   支付意愿与行政障碍：理解泰国社会保险参保的障碍  
   <font color=grey>Benjamin A. Olken, Rema Hanna, Phitawat Poonpolkul, Nada Wasi</font>

123. **Revisiting Stock Market Signals as a Lens for Patent Valuation {#33056}**  
   重新审视股票市场信号作为专利估值的视角  
   <font color=grey>Ashish Arora, Sharon Belenzon, Elia Ferracuti, Jay Prakash Nagar</font>
...
【**Author**】: Aslihan Asil, Paulo Ramos, Amanda Starc, Thomas G. Wollmann
...
【**摘要**】：业务整合是指财务发起人通过一系列收购来巩固所有权。这种策略正日益塑造着经济上重要的市场，但从历史上看，它一直逃脱了反垄断执法。我们研究了麻醉行业的这一现象，该行业是美国历史上首个基于业务整合的反垄断案件的发生地。首先，我们识别了另外18个麻醉业务的整合案例，它们在观察特征上与那三个被诉讼的案例相似。其次，我们表明，在竞争性业务被收购后，整合会巩固所有权，价格会急剧上涨。最后，我们估计了一个结构性讨价还价模型，并模拟了各种补救措施下的反事实均衡。

【**NBER**】: NBER Working Paper No. 33217，https://www.nber.org/papers/w33217

#### 2. Predicting College Closures and Financial Distress {#33216}

【**Author**】: Robert J. Kelchen, Dubravka Ritter, Douglas A. Webber
...
【**摘要**】：在本文中，我们汇编了迄今为止最全面的大学特征数据集，包括2002年至2023年的运营日期、机构环境、学生群体、教职员工和财务数据。我们详细描述了已关闭大学与未关闭机构相比已知和未知的信息。利用这些数据，我们首先开发了一系列财务困境预测模型，利用运营收入/支出模式、收入来源、流动性和杠杆指标、招生/员工模式以及重大财务压力的先前迹象等因素。我们将这些模型与现有的联邦政府筛选机制（如财务责任评分和加强现金监控）进行基准比较。我们记录了最终关闭的大学中存在大量缺失数据，并表明这是识别风险机构的关键障碍。然后，我们证明，结合更丰富数据的现代机器学习技术在预测大学关闭方面比线性概率模型有效得多，并且比现有的问责指标有效得多。我们首选的模型将现成的机器学习算法与最丰富的解释变量集相结合，即使对于数据完整的机构也能显著提高预测准确性，但对于预测数据不完整机构的财务困境实例尤其有帮助。最后，我们利用我们的估计进行模拟，以预测未来关闭的可能增加，表明在合理情景下，即将到来的人口悬崖导致的招生挑战可能会显著增加每年的大学关闭数量。

【**NBER**】: NBER Working Paper No. 33216，https://www.nber.org/papers/w33216

#### 3. Dispersed Information, Nominal Rigidities and Monetary Business Cycles: A Hayekian Perspective {#33215}

【**Author**】: Christian Hellwig, Venky Venkateswaran

【**Abstract**】: We study the propagation of nominal shocks in a dispersed information economy where firms learn from and respond to information generated by their activities in product and factor markets. We prove the existence of a “Hayekian benchmark”, defined by conditions under which imperfect information has no effect on equilibrium outcomes. This occurs under fairly general conditions when prices are flexible, i.e. without nominal frictions, informational frictions are irrelevant. With sticky prices, however, this irrelevance obtains only if there are no strategic complementarities in pricing and aggregate and idiosyncratic shocks are equally persistent. With complementarities and/or differences in persistence, the interaction of nominal and informational frictions slows down price adjustment, amplifying real effects from nominal shocks (relative to a full information model with only nominal frictions). In a calibrated model, the amplification is most pronounced over the medium to long term. In the short run, market generated information leads to substantial aggregate price adjustment, even though firms may be completely unaware of changes in aggregate conditions.

【**摘要**】：我们研究了名义冲击在分散信息经济中的传导机制，在该经济中，企业从其在产品和要素市场活动中产生的信息中学习并做出反应。我们证明了“哈耶克基准”的存在，该基准由不完全信息对均衡结果没有影响的条件所定义。当价格具有弹性时，即在没有名义摩擦的情况下，信息摩擦是无关紧要的，这在相当一般的条件下成立。然而，在价格粘性的情况下，这种无关性只有在定价中没有战略互补性且总体冲击和特质冲击具有同等持续性时才能实现。当存在互补性和/或持续性差异时，名义摩擦和信息摩擦的相互作用会减缓价格调整，从而放大名义冲击的实际效应（相对于仅存在名义摩擦的完全信息模型）。在校准模型中，这种放大效应在中长期最为显著。在短期内，市场产生的信息会导致总体价格大幅调整，即使企业可能完全不了解总体状况的变化。

【**NBER**】: NBER Working Paper No. 33215，https://www.nber.org/papers/w33215

#### 4. The Causal Effects of Income on Political Attitudes and Behavior: A Randomized Field Experiment {#33214}

【**Author**】: David E. Broockman, Elizabeth Rhodes, Alexander W. Bartik, Karina Dotson, Sarah Miller, Patrick K. Krause, Eva Vivalt
...
【**摘要**】：我们通过一项实地实验研究了收入对政治态度和行为的因果效应。在实验中，一个非营利组织向1000名低收入美国人每月免税赠送1000美元，为期三年，并向2000名对照组参与者每月赠送50美元。与参与的资源模型相反，我们发现对政治参与或投入没有影响，并排除了相当于投票率与收入之间观察关联的效应。政治偏好基本没有改变，这些估计再次与经济保守主义随收入增加而增强的观察关系区分开来。诸如对政府的信任、两极分化和对民主的支持等倾向也没有改变。我们确实发现了与情绪错误归因一致的效应：对自己种族群体、其他种族群体以及一些政治人物的情感略有改善。还有一些证据表明，受试者认为工作对个人、社会更重要，甚至是获得政府项目的必要条件；定性证据阐明了潜在的机制。我们的发现与政府资助或应税转移等其他经济冲击的发现形成对比——从而有助于澄清可能造成其影响的机制——并强调了政治倾向的持久性。

【**NBER**】: NBER Working Paper No. 33214，https://www.nber.org/papers/w33214
...
【**摘要**】：美国税法通过列举式医疗扣除（IMD）部分补贴自付医疗支出。在本文中，利用健康与退休研究中的详细信息，我发现，虽然美国老年人医疗支出中有相当一部分通过税法进行了扣除，但参与率并不完全：61.8%（50.5%）的潜在税收节省（扣除）被申报，导致每年损失54亿美元的税收节省。此外，参与中的摩擦导致税收节省从需求更高的群体中转移。我研究了潜在机制，并估计了一个离散选择模型，以模拟不同政策反事实下的资格、参与率和隐含的申报成本。结果表明，通过税法补贴医疗支出带来了显著的经济负担，减少了纳税人可获得的净补贴。

【**NBER**】: NBER Working Paper No. 33213，https://www.nber.org/papers/w33213

#### 6. The Political Economy of School Finance Systems with Endogenous State and Local Tax Policies {#33212}

【**Author**】: Stephen Calabrese, Dennis Epple, Richard Romano
...
【**摘要**】：从20世纪70年代开始，许多州法院宣布学校间教育支出的普遍不平等违反了州宪法。随后出现的资助体系为州和地方对教育的支持提供了不同的方法。我们开发了一个理论框架，并描述了替代体系下的结果。我们的框架的独特之处在于，在州和地方选举中都有对政策的投票。我们还开发了一个校准的计算模型，以比较替代学校财政体系下的均衡结果，并考察各州之间支出的差异。该模型预测，选民偏好混合州和地方财政的体系，其设计与实践中观察到的模式相似。

【**NBER**】: NBER Working Paper No. 33212，https://www.nber.org/papers/w33212

#### 7. Systemic Risk Measures: From the Panic of 1907 to the Banking Stress of 2023 {#33211}

【**Author**】: Viral V. Acharya, Markus K. Brunnermeier, Diane Pierret
...
【**摘要**】：我们评估了基于市场的系统性风险度量的有效性，这些度量依赖于1895年至2023年压力时期美国金融公司股票收益与市场或行业范围收益的共同变动。压力事件通过公司债券利差扩大和叙事日期确定，范围从1907年恐慌到2023年银行业压力。在压力事件开始前观察到的度量预测了市场结果（已实现波动率和收益）、资产负债表结果（贷款、盈利能力和挤兑风险）以及银行倒闭。具体来说，这些度量：（i）在捕捉压力事件下机构的横截面排名方面特别有效，而非总体结果；（ii）当压力事件严重时信息量更大；（iii）对银行和非银行金融机构都相关，尽管包含市场杠杆的度量对银行尤其具有信息量。比较分析表明，基于市场的指标提供了与监管和宏观审慎风险评估中使用的传统资产负债表指标不同且互补的信息。

【**NBER**】: NBER Working Paper No. 33211，https://www.nber.org/papers/w33211

#### 8. Unresolved Conflict in Workers' Compensation: The Impact of Legal Representation on Workers' Compensation Benefits {#33210}

【**Author**】: Bogdan Savych, David Neumark
...
【**摘要**】：我们估计了律师介入对工人受伤后获得的伤残赔偿金的因果效应。为了解决索赔和伤害可能在未测量的维度上存在差异（这些差异同时影响律师介入和获得的赔偿）这一根本性挑战，我们提出并使用两种工具变量。第一个工具变量是基于骨折、撕裂伤和挫伤索赔子集（无永久性部分残疾和/或一次性付款）得出的当地基线律师介入率。第二个工具变量是首次伤残赔偿金的延迟支付。我们的结果是工人受伤后获得的总伤残赔偿金，这涵盖了因工伤导致的工作时间损失和其他不利影响的支付。我们对超过95万起损失时间超过七天的索赔的分析表明，律师介入显著增加了支付给工人的总伤残赔偿金。

【**NBER**】: NBER Working Paper No. 33210，https://www.nber.org/papers/w33210

#### 9. Household Responses to Guaranteed Income: Experimental Evidence from Compton, California {#33209}

【**Author**】: Sidhya Balakrishnan, Sewin Chan, Sara Constantino, Johannes Haushofer, Jonathan Morduch
...
【**摘要**】：我们研究了2021年至2023年间在加利福尼亚州康普顿针对低收入家庭实施的两年期无条件现金转移计划的效果。695户家庭被随机分配，在两年期间平均每月获得约500美元的转移支付，另有1402户家庭被随机分配到对照组。为衡量转移支付频率的影响，一半受助者每月领取两次，另一半则每季度领取一次。我们在转移支付开始18个月后对1074名受访者进行了调查。获得保证收入对全职工作者的劳动供给没有影响，但兼职工作者（在基线时）的劳动市场参与率降低了13个百分点。与对照组相比，收入（不包括转移支付）平均每月减少333美元，支出每月减少302美元。同时，相对于对照组，平均非住房债务余额在18个月内下降了2190美元，尽管这一下降在统计上并不显著。我们发现住房保障有显著改善，但对心理和财务福祉指数没有整体影响。与每季度领取转移支付的受助者相比，每月领取两次的受助者更可能拥有汽车，信用卡债务更低，粮食保障更高，但除此之外，转移支付频率影响甚微。与男性受助者相比，女性受助者报告财务安全感有更大提升，而劳动收入和支出减少幅度更小。

【**NBER**】: NBER Working Paper No. 33209，https://www.nber.org/papers/w33209

#### 10. FinTech Lending to Borrowers with No Credit History {#33208}

【**Author**】: Laura Chioda, Paul Gertler, Sean Higgins, Paolina C. Medina

【**Abstract**】: Despite the promise of FinTech lending to expand credit access to populations without a formal credit history, FinTech lenders primarily lend to applicants with a formal credit history and rely on conventional credit bureau scores as an input to their algorithms. Using data from a large FinTech lender in Mexico, we show that alternative data from digital transactions through a delivery app are effective at predicting creditworthiness for borrowers with no credit history. Using account-by-month level data on revenues and costs, a machine learning model predicting profits generates similar profits as a model predicting default.

【**摘要**】：尽管金融科技贷款有望扩大对无正式信用记录人群的信贷获取，但金融科技贷款机构主要向有正式信用记录的申请人放贷，并依赖传统的信用局评分作为其算法的输入。利用墨西哥一家大型金融科技贷款机构的数据，我们表明，来自配送应用程序数字交易的替代数据能有效预测无信用记录借款人的信用worthiness。使用按月计算的收入和成本账户数据，一个预测利润的机器学习模型产生的利润与预测违约的模型相似。

【**NBER**】: NBER Working Paper No. 33208，https://www.nber.org/papers/w33208
...
【**摘要**】：现在可以设想这样的情景：到本世纪末，全球原油需求可能降至基本为零，这由清洁能源技术的进步、严格气候政策的采纳或两者共同推动。本文探讨了这种预期中的需求下降对全球石油供应可能意味着什么。一种可能性是众所周知的“绿色悖论”：由于石油是一种可耗竭资源，生产商可能会加速近期开采以赶在需求下降之前。这种反应会增加近期的二氧化碳排放，甚至可能导致气候损害的总现值比需求根本没有下降时还要大。然而，由于石油开采需要对油井和其他基础设施进行可能长期的投资，相反的情况也可能发生：预期的需求下降会降低生产商的投资率，从而减少近期的石油产量和二氧化碳排放。为了评估这种投资减少效应是否超过绿色悖论，或者反之，我开发了一个易于处理的全球石油供应模型，该模型同时包含了这两种效应，并捕捉了行业特征，如异质性生产商、低成本欧佩克生产商行使市场力量以及边际钻井成本随钻井率上升。我发现，对于具有最强实证支持的模型输入，投资减少效应超过了传统的绿色悖论。为了使预期效应净增加全球累计石油开采量，我发现行业投资必须具有短时间视野，并且生产商的贴现率必须与美国国库券利率相当。

【**NBER**】: NBER Working Paper No. 33207，https://www.nber.org/papers/w33207

#### 12. Financial Conditions Targeting {#33206}

【**Author**】: Ricardo J. Caballero, Tomás E. Caravello, Alp Simsek
...
【**摘要**】：我们提供的证据表明，有噪声的金融流动会影响金融状况和宏观经济活动。货币政策应如何应对这种噪声？我们开发了一个模型，在该模型中，央行最优的做法是瞄准并（部分）稳定金融状况，即使其超出了对产出和通胀缺口的直接影响，尽管稳定的金融状况本身并非社会目标。在我们的模型中，噪声同时影响金融状况和宏观经济活动，而套利者由于总体回报波动性而不愿逆噪声交易。我们的主要结果表明，金融状况指数目标制——宣布一个（软性的、临时的）金融状况指数目标，并在近期内设定政策利率以使实际金融状况指数接近目标——能够降低金融状况指数的波动性并稳定产出缺口。这种改善之所以发生，是因为更可预测的金融状况指数使套利者能够更积极地交易以对抗噪声冲击，从而“招募”他们来隔离金融状况指数免受金融噪声的影响。金融状况指数目标制类似于提供关于金融状况指数的前瞻指引，在我们的框架中，它严格优于提供关于政策利率的前瞻指引。最后，我们扩展了最近的政策反事实方法，以纳入我们模型的内生风险降低机制，并将其应用于美国数据。我们估计，金融状况指数目标制本可以使产出缺口、通胀和利率的方差分别降低36%、2%和6%，并使金融状况指数的条件方差降低55%。与利率前瞻指引相比，它本可以使产出缺口方差降低21%。我们还表明，金融状况指数目标制的大部分收益可以通过一个增强版的泰勒规则来实现，该规则对简化的金融状况目标赋予了较大权重。

【**NBER**】: NBER Working Paper No. 33206，https://www.nber.org/papers/w33206

#### 13. Estimating Gross Output Production Functions {#33205}

【**Author**】: Markus Trunschke, Kenneth L. Judd
...
【**摘要**】：本文开发了一种估计生产函数的新方法。早期的论文依赖于关于生产函数函数形式的特殊假设。我们的方法有效地估计了任何具有希克斯中性生产率的生产函数的所有参数，无需额外的外生变量或灵活投入需求的变化来源。我们提供了蒙特卡洛模拟证据来证明我们方法的性能，并利用智利和哥伦比亚制造业的经验数据测试了我们的方法。

【**NBER**】: NBER Working Paper No. 33205，https://www.nber.org/papers/w33205

#### 14. From Novelty to Norm: Uncovering the Drivers of Virtual Tour Effectiveness in Real Estate Sales {#33204}

【**Author**】: Miremad Soleymanian, Yi Qian
...
【**摘要**】：本研究利用结合了多重上市服务数据、政府评估房产价值和经纪人营销活动的独特数据集，考察了虚拟看房和数字营销策略在提升房地产销售方面的有效性。虽然虚拟看房通常被视为促进销售的强大工具，但其影响取决于具体情境。使用经典计量经济学模型和因果机器学习技术，我们发现虚拟看房平均能使房产销售价格上涨1%。然而，这种效应随时间推移而减弱，尤其是在新冠疫情之后，表明它已从一项新颖功能转变为标准做法。使用因果随机森林的进一步分析揭示了其有效性在房产属性、市场条件和经纪人特征之间存在显著的异质性。虚拟看房对高度差异化的房产影响较小，但在竞争激烈的市场中以及对缺乏当地市场经验的新手经纪人更为有益。这些结果表明，房地产经纪人在决定如何使用虚拟看房时，或许应考虑房产特征、市场动态和自身经验。我们的发现为寻求优化数字营销策略和提升销售业绩的从业者提供了宝贵的见解。

【**NBER**】: NBER Working Paper No. 33204，https://www.nber.org/papers/w33204

#### 15. Gender-Based Violence in Schools and Girls’ Education: Experimental Evidence from Mozambique {#33203}

【**Author**】: Sofia Amaral, Aixa Garcia-Ramos, Selim Gulesci, Alejandra Ramos, Sarita P. Ore-Quispe, Maria Micaela Sviatschi
...
【**摘要**】：校园性别暴力是一个普遍存在的问题，影响着全球数百万青春期女童。我们与莫桑比克教育部合作，开发了一项干预措施，旨在提高关键学校人员应对性别暴力的能力，并改善学生的认知及主动行为。为了理解性别暴力对女童教育的作用，我们不仅随机分配了是否接受干预，还随机分配了学生部分是否仅针对女童、仅针对男童或两者都针对。我们的研究结果表明，无论针对哪个性别群体，教师和学校工作人员对女童的性暴力都有所减少，这为提升关键学校人员能力以威慑施暴者的作用提供了证据。利用行政记录，我们还发现，在鼓励女童采取主动行为的学校中，女童的入学率有所提高，这主要是由于受害者举报性别暴力的倾向增加。我们的研究结果表明，要有效减轻暴力以改善女童教育，需要双管齐下：威慑潜在的施暴者，并培养受害者（如增加举报）的主动姿态。

【**NBER**】: NBER Working Paper No. 33203，https://www.nber.org/papers/w33203

#### 16. r-g before and after the Great Wars 1507-2023 {#33202}

【**Author**】: Kenneth S. Rogoff, Paul Schmelzing
...
【**摘要**】：我们提供了国际金融体系中关键经济体几个世纪以来r-g序列的新长期样本。通过多种计量经济学方法，包括期限匹配的构建，我们证明了这些序列存在趋势平稳性的有力证据。尽管我们确认了趋势平稳性，但我们发现了20世纪前三分之一时期存在一个重大结构性断裂的有力证据。r-g长达数个世纪的下降趋势似乎在1930年左右趋于平稳，此后r-g表现出高波动性并伴有明显的上行压力：值得注意的是，尽管实际利率可能仍然看似有利地偏低，但自两次世界大战期间以来，发达经济体的总体增长率正在向下漂移，这给r-g和债务可持续性带来了长期压力。我们的结果与近期许多文献形成对比，并表明在假设全球公共债务可持续性呈良性趋势时需要更加谨慎。同时，当加入资本回报中风险较高的要素时，数据支持结构性增强的“动态效率”。然后，我们将关键的1930年代拐点与发达经济体福利国家的建立和增长以及非国防、非利息支出的激增联系起来。

【**NBER**】: NBER Working Paper No. 33202，https://www.nber.org/papers/w33202

#### 17. Market Power and Redeemable Loyalty Token Design {#33201}

【**Author**】: Kenneth S. Rogoff, Zhiheng He, Yang You
...
【**摘要**】：数字化导致忠诚代币迅速扩张，这些代币通常作为产品价格的一部分捆绑销售。一个悬而未决的问题是，随着技术发展，企业是否有强烈动机使忠诚代币可交易，从而引发监管问题，包括货币和银行当局的关注。我们的主要发现是，在相当一般的假设下，企业仍然有强烈动机维持代币的不可交易性。这似乎令人惊讶，因为单个消费者愿意为可交易代币支付溢价。然而，只要代币不向非平台消费者提供便利收益，不可交易性通过在任何时点扩大流通中的代币存量来补偿，从而提供一种更好的整体融资形式。我们进一步表明，具有更强市场势力的发行者倾向于使其收入更依赖代币。来自航空里程和酒店奖励计划的实证结果与我们的理论一致。

【**NBER**】: NBER Working Paper No. 33201，https://www.nber.org/papers/w33201

#### 18. Labor Force Transitions {#33200}

【**Author**】: Rui Castro, Fabian Lange, Markus Poschke
...
【**摘要**】：劳动力状态及其之间的流动是模拟劳动力市场中个体动态的有用工具。本章回顾了近期文献，这些文献揭示了劳动力状态转换中存在显著的异质性。我们通过使用加拿大数据复制领先研究来回顾方法和结果，并将我们的发现与关于召回型非就业、持续时间依赖性和工作阶梯的重要文献联系起来。

【**NBER**】: NBER Working Paper No. 33200，https://www.nber.org/papers/w33200

#### 19. The Effects of Lump-Sum Food Benefits during the COVID-19 Pandemic on Spending, Hardship, and Health {#33199}

【**Author**】: Lauren L. Bauer, Krista J. Ruffini, Diane Whitmore Schanzenbach
...
【**摘要**】：本文研究了疫情期间向家庭提供一次性实物援助如何影响食品困难、经济福祉和母亲健康。我们研究了一项新计划P-EBT的引入，该计划在2020年春夏期间为每位学生提供价值约300美元的食品券。利用各州计划实施时间的差异，我们发现家庭在收到福利后的6周内，每周每位学生支出增加18-42美元。低收入家庭中，家庭食品不足和儿童食品不安全状况在收到福利后的一个月内下降了27-49%，母亲心理健康改善了0.9个标准差。

【**NBER**】: NBER Working Paper No. 33199，https://www.nber.org/papers/w33199
...
【**摘要**】：在过去一年中，大语言模型在速度、成本效率、准确性以及处理更大文本量的能力方面取得了显著进步。本文是一份实用指南，旨在更新经济学家如何在研究中使用这些进展。涵盖的主要创新包括：(i) 新的推理能力，(ii) 用于交互式LLM协作的新型工作空间，如Claude的Artifacts、ChatGPT的Canvas或Microsoft的Copilot，以及(iii) LLM驱动的互联网搜索的最新改进。将这些能力融入工作中，使经济学家能够实现显著的生产力提升。此外，我还强调了在研究推广中的新用例，例如通过Google的NotebookLM自动生成的博客文章、演示幻灯片、访谈以及播客。

【**NBER**】: NBER Working Paper No. 33198，https://www.nber.org/papers/w33198

#### 21. Rate-Based Emissions Trading with Overlapping Policies: Insights from Theory and an Application to China {#33197}

【**Author**】: Carolyn Fischer, Chenfei Qu, Lawrence H. Goulder
...
【**摘要**】：本文提出了一个统一框架来解释三次重大经济衰退：美国大萧条、美国大衰退和日本长期衰退。银行危机和过度债务积累等暂时性经济冲击可能在短期内将自然利率推入负值区域。同时，人口下降和不平等加剧等结构性因素可能在短期和长期内压低自然利率。负自然利率和零下限是流动性陷阱的必要条件。可信的货币政策可以抵消短期流动性陷阱的不利影响。货币政策可信度下降或持续的自然利率为负可能需要财政干预。该框架揭示了低利率环境下的宏观经济挑战，并强调了政策体制的核心重要性。最后，我们反思了我们这个时代的重大宏观经济问题：一旦2020年代的通货膨胀激增成为过去，且美国政治格局发生巨大变化，短期利率是否会再次跌回零？

【**NBER**】: NBER Working Paper No. 33195，https://www.nber.org/papers/w33195

#### 24. Private Equity for Pension Plans? Evaluating Private Equity Performance from an Investor's Perspective {#33194}

【**Author**】: Arthur Korteweg, Stavros Panageas, Anand Systla
...
【**摘要**】：我们提出了一种基于不同地点之间名字构成和教会教派差异的文化距离新度量。我们使用引力方程估算了1850年至1870年间美国移民流对文化距离两个组成部分以及通过交通网络衡量的标准旅行成本的弹性。我们的研究结果表明，在解释移民流方面，文化距离相对于旅行成本的作用较小。我们构建了反映文化距离和旅行成本各自贡献的移民成本，并使用移民的经济地理模型来量化其影响。对于总体福利而言，旅行成本比文化距离重要得多。尽管如此，我们提供的证据表明，文化距离的组成部分在决定迁移人数及其最终目的地方面发挥着作用。

【**NBER**】: NBER Working Paper No. 33192，https://www.nber.org/papers/w33192
...
【**摘要**】：我们研究了当代发展倡议与非洲传统经济实践之间冲突的后果。近年来，作物农业在整个非洲大陆显著扩张。这种扩张大部分发生在传统牧区，这些地区的土地通常根据习惯安排进行管理。这被认为是导致牧民和农业族群之间冲突的主要原因。我们利用1995年至2014年非洲各地农业发展项目的地理编码数据来检验这一假设。我们发现，在传统牧区实施农业项目会导致冲突风险增加近两倍。对于在传统农业区实施的农业项目，或在任何地点实施的非农业项目，我们没有发现类似的影响。我们还发现，这种机制以圣战袭击的形式助长了极端宗教冲突的蔓延。当农业项目与牧业项目配套实施时，这种影响会减弱。当牧民群体拥有更多政治权力时，这种情况更有可能发生。尽管存在这些对冲突的影响，我们发现作物农业项目在农业区和牧区都增加了夜间灯光亮度。来自调查数据的证据表明，牧区的收益集中在非牧户家庭。我们的研究结果表明，“发展错配”——即推行与当地人口不匹配的项目——可能代价高昂。

【**NBER**】: NBER Working Paper No. 33191，https://www.nber.org/papers/w33191

#### 28. Sticky Inflation: Monetary Policy when Debt Drags Inflation Expectations {#33190}

【**Author**】: Saki Bigio, Nicolas Caramp, Dejanir Silva
...
【**摘要**】：我们将对货币-财政改革的预期纳入一个标准的新凯恩斯主义模型。如果改革发生，货币政策将暂时通过一轮短暂的通货膨胀来帮助维持债务可持续性。对可能改革的预期将债务水平与通胀预期联系起来。因此，利率产生两种效应：它们影响需求，并以相反方向影响预期通胀。预期效应与利率对公共债务的影响相关。虽然通过需求控制在短期内降低通胀是可能的，但由于其对通胀预期的影响（粘性通胀），通胀往往会再次上升。最优货币政策可能允许在财政冲击后维持低实际利率，暂时偏离泰勒原则。我们评估了美联储在最近疫情后通胀飙升期间“落后于曲线”的策略是否正确。

【**NBER**】: NBER Working Paper No. 33190，https://www.nber.org/papers/w33190

#### 29. Taxing the Wealth of the Poor: Evidence from the Danish Old-Age Support Asset Test {#33189}

【**Author**】: Niels Johannesen, Johan Sæverud, Emmanuel Saez
...
【**摘要**】：我们利用全面的行政数据，记录了对丹麦一项老年支持计划进行资产审查所产生的强烈行为反应。我们表明，相对于由类似但不符合条件的个体组成的对照组，该审查所针对的流动资产密度分布在处理组阈值以下呈现出大量但分散的过剩质量。利用面板结构的队列分析表明，该计划在阈值附近将流动资产减少了20%。对资产和现金提取的高频银行数据进行分析表明，阈值附近的过剩质量在很大程度上反映了永久性而非暂时性的反应。

【**NBER**】: NBER Working Paper No. 33189，https://www.nber.org/papers/w33189

#### 30. Why Has Construction Productivity Stagnated? The Role of Land-Use Regulation {#33188}

【**Author**】: Leonardo D'Amico, Edward L. Glaeser, Joseph Gyourko, William R. Kerr, Giacomo A.M. Ponzetto
...
【**摘要**】：我们记录了20世纪美国建筑业生产率的库兹涅茨曲线。1900年至1940年间，每位建筑工人建造的房屋数量停滞不前，二战后激增，然后在1970年后急剧下降。1940年至1970年的生产率繁荣表明，技术进步在建筑业中并非天生不可能。是什么阻止了它？我们提出了一个模型，其中地方土地使用管制限制了建筑项目的规模。这种约束降低了建筑公司的均衡规模，从而减少了规模经济和投资于创新的激励。我们的模型表明，在一个竞争性行业中，这种公司规模和技术投资的低效减少是限制性项目监管的独特后果，而经典的监管进入壁垒则会增加公司规模。该模型与关于建筑业性质的一系列广泛关键事实相一致。1970年后的生产率下降与我们最佳的土地使用监管代理变量的增加相吻合。如今开发项目的规模很小，并且随着时间的推移而下降。建筑公司的规模也相当小，尤其是相对于其他商品生产公司而言，并且较小的建筑商生产率较低。土地使用监管更严格的地区，建筑企业规模特别小且生产率低下。建筑业的专利活动停滞不前，并与其他行业分化。一个粗略的计算表明，如果企业规模与生产率之间观察到的联系有一半是因果关系，那么如果美国住宅建筑公司的规模分布与制造业相匹配，其生产率将提高约60%。

【**NBER**】: NBER Working Paper No. 33188，https://www.nber.org/papers/w33188

#### 31. Adverse Selection and (un)Natural Monopoly in Insurance Markets {#33187}

【**Author**】: Edward Kong, Timothy Layton, Mark Shepard
...
【**摘要**】：逆向选择是一种经典的市场失灵，已知会限制或“瓦解”高质量保险以及许多其他经济环境中的交易。虽然标准理论强调质量扭曲，但我们认为逆向选择还有另一个宏观层面的含义：它瓦解了差异化公司之间的竞争，导致幸存竞争者减少——在极端情况下，导致我们所谓的“非自然”垄断。逆向选择促使公司进行激进的价格削减，以吸引对价格敏感的低风险消费者。这在平均成本和边际成本之间创造了一个楔子（类似于标准模型中的固定成本），限制了有多少公司能够盈利地生存。我们通过一个简单的保险公司进入和价格竞争模型来展示这一见解，并使用来自马萨诸塞州健康保险交易所的行政数据进行估计。我们发现一个巨大的“选择楔子”，占平均成本的20-30%，在没有纠正性政策的情况下，这会将市场瓦解为垄断。我们的分析提出了一个令人惊讶的政策含义：限制价格削减的干预措施可以通过支持更多公司进入来改善福利，并最终降低价格。

【**NBER**】: NBER Working Paper No. 33187，https://www.nber.org/papers/w33187

#### 32. Racial Screening on the Big Screen? Evidence from the Motion Picture Industry {#33186}

【**Author**】: Liang Zhong, Angela Crema, M. Daniele Paserman
...
【**摘要**】：我们开发了一个歧视模型，使我们能够将观察到的、在通过筛选测试后各组之间的结果差异解释为基于偏好的（雇主）、统计性或顾客歧视。我们应用这个框架来调查美国电影业中非白人代表性不足的性质。利用一个包含7000部电影演员种族标识符的新数据集，我们表明，在制作条件给定的情况下，非白人电影表现出更高的平均收入和更小的方差。在我们的模型背景下，如果非白人电影被要求达到更高的制作标准，我们的发现可以得到合理解释。

【**NBER**】: NBER Working Paper No. 33186，https://www.nber.org/papers/w33186

#### 33. Shifting Patterns of Social Interaction: Exploring the Social Life of Urban Spaces Through A.I. {#33185}

【**Author**】: Arianna Salazar-Miranda, Zhuangyuan Fan, Michael B. Baick, Keith N. Hampton, Fabio Duarte, Becky P.Y. Loo, Edward L. Glaeser, Carlo Ratti
...
【**摘要**】：我们分析了纽约、波士顿和费城四个城市公共空间在30年间行人行为的变化。基于William Whyte于1980年手动记录行人行为的观察性研究，我们采用计算机视觉和深度学习技术，检查了1979-80年和2008-10年的视频资料。我们的分析测量了步行速度、逗留行为、群体规模和群体形成的变化。我们发现，平均步行速度增加了15%，而在这些空间中逗留的时间在所有地点都减少了一半。尽管独自行走的行人比例保持相对稳定（从67%到68%），但群体相遇的频率下降了，表明公共空间中的互动减少。这种转变表明，城市居民越来越将街道视为通道而非社交空间，这对公共空间在促进社会参与方面的作用具有重要影响。

【**NBER**】: NBER Working Paper No. 33185，https://www.nber.org/papers/w33185

#### 34. Assortative Matching and Wages: The Role of Selection {#33184}

【**Author**】: Katarína Borovičková, Robert Shimer
...
【**摘要**】：我们开发了一个具有双边异质性和匹配特定生产率冲击的随机搜索模型，以解释为什么高生产率工人倾向于在高生产率企业工作，尽管低生产率工人从这种匹配中获得的收益几乎相同。我们的模型有两个关键预测：i) 工人获得的平均对数工资随工人和雇主生产率的提高而增加，低生产率工人在高生产率企业获得的比例收益更大；ii) 工人生产率与其雇主生产率之间存在分类匹配。选择性的工作接受驱动了这些模式。所有工人遇到所有企业的可能性相同，但工人在遇到生产率相似的企业时拥有更高的剩余。高剩余会议更频繁地导致匹配，从而产生分类匹配。只有在行政工资数据中观察到的那些导致匹配的会议子集，才塑造了工资。我们表明，我们的发现与最近的实证结果在数量上一致。此外，我们证明这种选择无法通过标准实证方法检测到，这突显了理论指导的实证工作的重要性。我们的结果表明，鼓励高工资企业雇佣低工资工人，在减少工资不平等方面的效果可能不如工资模式所暗示的那样有效。

【**NBER**】: NBER Working Paper No. 33184，https://www.nber.org/papers/w33184

#### 35. Fintech, Visual Attention, and Financial Inclusion: A Field Experiment on Migrant Remittances {#33183}

【**Author**】: Eduardo Nakasone, Máximo Torero, Angelino Viceisza
...
【**摘要**】：移民汇款数额巨大，但汇款成本仍然相对较高。政策制定者认为，金融科技，特别是像kayak.com这样的汇款比较网站，可以促进金融包容性并降低汇款价格。然而，对于受教育程度有限且对数字方法信任度不高的移民如何与金融科技互动，我们知之甚少。我们在一个比较网站上进行了实地实验，并向移民展示了汇款公司的不同属性，特别是交付时间和客户评价。我们使用视觉注意力数据来探索搜索行为。我们发现：(1) 虽然10-28%的移民表现出某种汇款习惯，但超过一半的人在获得金融科技信息后会尝试不同的公司；(2) 虽然移民对信息的反应是理性的，搜索似乎有针对性，但存在相当大的异质性——那些对比较网站认知度低、金融素养低或信息处理能力差的移民对金融科技的反应较弱；(3) 当提供金融科技信息时，移民有44%的可能性会做出与他们在研究之外表现出的属性偏好相悖的行为。因此，尽管他们通常会寻找最便宜的公司，但他们支付的费用却高出20-30%。这些发现表明，金融科技在改善金融包容性和消费者福利方面具有微妙的潜力。

【**NBER**】: NBER Working Paper No. 33183，https://www.nber.org/papers/w33183

#### 36. Long-Run Effects of Food Assistance: Evidence from the Food Stamp Program and Administrative Data {#33182}

【**Author**】: Marianne Bitler, Theodore F. Figinski
...
【**摘要**】：先前主要基于自我报告的研究显示，早期接触食品券对自给自足、健康和福祉有巨大且积极的影响，这种影响持续到成年期。我们将相同的采用时间与关于收入、就业和残疾福利使用的行政数据相结合。在早期生活中可获得食品券的县出生的女性，在32岁时的收入高出3%。在食品券实施前已有另一种实物食品计划的县，其效应更大。食品券依赖于该其他计划预先存在的行政资格认定。我们的结果建立了预先存在的行政基础设施与食品券后期生活影响之间的联系。

【**NBER**】: NBER Working Paper No. 33182，https://www.nber.org/papers/w33182
...
【**摘要**】：本文的主要目标是探讨日本家庭储蓄率水平及其随时间变化趋势的决定因素，重点关注人口年龄结构的影响，并对其未来趋势进行预测。本文发现，与普遍看法相反，日本的家庭储蓄率无论从绝对水平还是相对于其他国家而言，并非一直很高；如果仅限于战后时期，只有在1961年至1986年的25年间，其储蓄率才超过15%。日本家庭储蓄率的过去和未来趋势在很大程度上可以通过其人口年龄结构的变化来解释，但退休老年家庭储蓄率的下降是近期家庭储蓄率下降的一个更重要的解释。然而，其他因素，如消费信贷的不可获得性、社会安全网的缺失、高经济增长率、储蓄税收减免、储蓄促进政策以及高昂且不断上涨的土地和住房价格，也可能部分解释了为什么日本家庭储蓄率在1961-86年间如此之高，以及随后为何大幅下降。至于日本家庭储蓄率的未来趋势，它可能会进一步下降，尽管不一定以快速的速度下降。

【**NBER**】: NBER Working Paper No. 33181，https://www.nber.org/papers/w33181
...
【**摘要**】：在标准的新凯恩斯模型中，未来的降息比当前的降息具有更大的效应——这被称为前瞻指引之谜。我们认为前瞻指引之谜并非谜题。我们表明，这个谜题源于一个难以置信的大规模货币制度变迁，其规模超过了美国自大萧条以来的任何历史事件。通过将我们的模型校准到美国大萧条时期的四次制度变迁，并以长期债券收益率的变化为约束，我们发现模型的预测与历史数据大体一致。

【**NBER**】: NBER Working Paper No. 33180，https://www.nber.org/papers/w33180

#### 39. Overcoming Racial Gaps in School Preferences: The Effect of Peer Diversity on School Choice {#33179}

【**Author**】: Clemence M. Idoux, Viola Corradini
...
【**摘要**】：种族间的择校差异导致了学校隔离和获得有效学校机会的不平等。在控制考试成绩和居住区的情况下，黑人和西班牙裔家庭始终选择白人学生和亚裔学生较少、平均成绩较低、增值较低的学校。本文结合纽约市的独特调查数据和行政数据，以识别种族择校差距的决定因素，并表明就读更多元化的中学可以缩小种族选择差距。工具变量估计显示，接触更多元化同伴的中学学生在申请和入读高中时，也会选择更多元化的学校。这些效应尤其有利于黑人和西班牙裔学生，他们因此入读了增值更高的高中。对高中申请者监护人的申请后调查表明，大多数跨种族选择差异源于信息差距和对学校人口统计特征的同质性偏好。调查结果还显示，接触多元化的中学同伴通过解决这些潜在决定因素来减少种族选择差异：它增加了对同伴多样性的偏好，并拓宽了已知学校选择的范围。

【**NBER**】: NBER Working Paper No. 33179，https://www.nber.org/papers/w33179
...
【**摘要**】：超级应用数字钱包的兴起不仅提供了通往银行的渠道，还提供了内部支付选项，包括先买后付（BNPL）。我们首次利用来自一家领先电子钱包超级应用的、与商户和消费者信息匹配的交易数据，并结合随机实验进行补充分析。我们记录了BNPL作为一种主导形式的“数字现金”，它扩大了服务不足消费者的支付和信贷获取渠道，尽管他们的支出增加了，但并未增加负债或违约率。这些发现关键取决于超级应用生态系统的交叉销售能力和内在的纪律激励。我们的发现强调了信贷与支付之间的协同作用，并为那些通过超级应用驱动平台向无现金经济转型的经济体提供了新颖见解，在这些经济体中，金融科技信贷看到了最大的潜力。

【**NBER**】: NBER Working Paper No. 33178，https://www.nber.org/papers/w33178

#### 41. Flexible Pay and Labor Supply: Evidence from Uber’s Instant Pay {#33177}

【**Author**】: M. Keith Chen, Katherine Feinerman, Kareem Haggag
...
【**摘要**】：现代科技平台为劳动者提供了对工作时间的实时控制，并日益提供灵活支付：即工作后立即获得报酬的选项。我们研究了支付灵活性对劳动力供给的影响，以及零工经济工作者中现时偏好的含义。利用优步在全国范围内开展的随机对照试验的精细数据，我们估计了从固定周薪制切换到即时支付系统（一种允许按需、当日提现的系统）的效果。我们发现，灵活支付显著增加了司机的劳动时间。此外，与现时偏好一致，当司机距离其反事实的每周支付周期结束时间越远时，这种反应显著更高。我们讨论了在劳动者能够灵活提供劳动力的情境下的福利和更广泛的影响。

【**NBER**】: NBER Working Paper No. 33177，https://www.nber.org/papers/w33177

#### 42. Couch-Locked with the Munchies: Effects of Recreational Marijuana Laws on Exercise and Nutrition {#33176}

【**Author**】: Thomas Wilk, Monica Deza, Timothy Hodge, Shooshan Danagoulian
...
【**摘要**】：在过去十年中，随着娱乐用大麻法律扩大了获取大麻的渠道，关于娱乐用大麻法律对两种可能因大麻消费而产生的昂贵社会行为（不健康饮食和久坐生活方式）的影响，我们知之甚少。利用尼尔森IQ消费者面板数据，我们发现娱乐用大麻法律的通过导致涉及“垃圾食品”的杂货店购物次数以及支出金额的增加。这种效应尤其由冰淇淋、薯片和糖果的购买增加所驱动。利用行为风险因素监测系统和美国时间使用调查数据，我们发现娱乐用大麻法律的通过也导致锻炼减少，尤其是有氧运动的减少，并有提示性证据表明在家时间增加。这些结果表明，娱乐用大麻法律通过不健康饮食和减少体育活动对健康产生不利影响，对与饮食和生活方式相关的慢性疾病构成了重大的公共卫生挑战。

【**NBER**】: NBER Working Paper No. 33176，https://www.nber.org/papers/w33176

#### 43. A New Measure of Surviving Children that Sheds Light on Long-term Trends in Fertility {#33175}

【**Author**】: Anup Malani, Ari Jacob
...
【**摘要**】：自工业革命以来，世界经历了总和生育率的急剧下降。然而，这种下降的后果不仅源于出生人数的减少，还源于存活子女数的减少。我们提出了一个衡量每位女性存活子女数的新指标，称为有效生育率。有效生育率可以近似为总和生育率与存活概率的乘积。此外，总和生育率的变化可以分解为保持有效生育率不变的变化和改变有效生育率的变化。我们将有效生育率专门化，以衡量存活到生育年龄的女儿数量（生殖有效生育率）和存活到成为劳动者的子女数量（劳动有效生育率）。我们使用三个数据集来揭示不同地区随时间变化的有效生育率。首先，我们利用1950年至2019年间165个国家的数据表明，在此期间全球总和生育率下降的三分之一并未改变劳动有效生育率，这表明相当一部分生育率下降仅仅是对更高存活率的补偿。关注劳动有效生育率的变化，至少40%的变异无法用收入、价格、教育水平、结构转型和城市化等经济因素解释，为文化变迁等解释留下了空间。其次，利用自1750年以来欧洲国家的历史人口数据，我们发现欧洲的劳动有效生育率在两次世界大战前后出现了剧烈波动，这一现象与人口转变截然不同。然而，在此波动之前，即使欧洲国家正在经历人口转变，有效生育率却异常稳定。事实上，即使在1975年后有效生育率降至2以下，我们发现有效生育率保持稳定而非持续下降。第三，自1800年以来美国的数据显示，尽管死亡率存在巨大差异，但黑人和白人群体的存活子女数随时间推移却惊人地相似。

【**NBER**】: NBER Working Paper No. 33175，https://www.nber.org/papers/w33175

#### 44. Federal Reserve Independence and Congressional Intent: A Reappraisal of Marriner Eccles’ Role in the Reformulation of the Fed in 1935 {#33174}

【**Author**】: Gary Richardson, David W. Wilcox
...
【**摘要**】：国会关于美联储独立性的意图至关重要，因为它保护公众免受货币政策政治化的影响。试图将货币政策置于总统控制之下的行为很容易最终诉诸最高法院。此类案件的结果将在很大程度上取决于历史记录。理解国会在设计美联储决策结构时的意图，需要清晰理解马瑞纳·埃克尔斯关于1935年《银行法》第二章中货币政策制定结构的提案以及国会的回应。埃克尔斯的提案将货币政策制定权赋予一个听命于总统的机构。埃克尔斯认为，美联储领导人应由总统酌情任命并执行总统的货币计划。参议院和众议院否决了埃克尔斯的提案，并明确设计了美联储的领导结构，以限制政治家——特别是总统——对货币政策制定的影响。

【**NBER**】: NBER Working Paper No. 33174，https://www.nber.org/papers/w33174

#### 45. FinTech Platforms and Asymmetric Network Effects: Theory and Evidence from Marketplace Lending {#33173}

【**Author**】: Lin William Cong, Ke Tang, Danxia Xie, Weiyi Zhao
...
【**摘要**】：我们从概念上识别并利用市场借贷数据实证验证了金融科技平台区别于非金融平台的特征：（i）引入个体和平台层面违约风险的长期合同；（ii）贷款人通过投资分散化来缓解个体违约风险；（iii）平台层面的违约风险导致更大的非对称用户粘性，并使得平台层面的跨边网络效应（我们引入的一个新指标）对采用和市场动态至关重要。我们将这些特征纳入一个具有潜在失败和内生参与/费用的双边金融科技平台模型。该模型预测了贷款人的单归属、偶尔对借款人收取较低费用、非对称的平台层面跨边网络效应，以及贷款人平台层面跨边网络效应对预测平台失败的预测能力。中国的市场借贷实证证实了我们的模型预测，该行业以进入、退出和网络外部性为特征，充满动态变化。具体而言，在衰退或更成熟的平台上，贷款人的平台层面跨边网络效应在经验上低于增长或新平台。此外，贷款人的平台层面跨边网络效应能够预测平台的生存可能性，即使在非常早期的阶段也是如此。我们的发现为从业者和监管者提供了关于多边金融科技平台的新经济见解。

【**NBER**】: NBER Working Paper No. 33173，https://www.nber.org/papers/w33173

#### 46. From Labor to Intermediates: Firm Growth, Input Substitution, and Monopsony {#33172}

【**Author**】: Matthias Mertens, Benjamin Schoefer

【**Abstract**】: We document and dissect a stylized fact about firm growth: the shift from labor to intermediate inputs. This shift occurs in input quantities, cost and output shares, and output elasticities. We establish this regularity in firm data for Germany and in firm (and industry) data for 11 (20) additional countries, and also in response to exogenous product demand shocks. We explain this regularity through a parsimonious model with two features: (i) an elasticity of substitution between intermediates and labor above one, and (ii) an increasing shadow price of labor (monopsony or adjustment costs). Our firm growth regressions identify a labor-intermediates substitution elasticity between 1.8 and 4.2. Labor-intermediates substitution also accounts for much of the labor share decline that we document accompanies firm and industry growth.

【**摘要**】：我们记录并剖析了一个关于企业成长的典型事实：从劳动投入向中间投入的转变。这种转变发生在投入数量、成本和产出份额以及产出弹性中。我们在德国的企业数据以及另外11个（20个）国家的企业（和行业）数据中确立了这一规律，并且这种转变也出现在对外生产品需求冲击的响应中。我们通过一个简约模型解释了这一规律，该模型具有两个特征：（i）中间品与劳动之间的替代弹性大于1，以及（ii）劳动影子价格上升（买方垄断或调整成本）。我们的企业增长回归识别出劳动与中间品的替代弹性在1.8到4.2之间。劳动与中间品的替代也解释了我们在企业增长和行业增长中记录的大部分劳动份额下降。

【**NBER**】: NBER Working Paper No. 33172，https://www.nber.org/papers/w33172

#### 47. Investing in Customer Capital {#33171}

【**Author**】: Bianca He, Lauren I. Mostrom, Amir Sufi
...
【**摘要**】：企业大量投资于客户资本；这种投资是无形资本价值的主要来源。客户资本投资通过损益表中的销售和营销费用、支付给销售和营销人员的工资以及美国证券交易委员会文件中的文本进行衡量。不同行业的客户资本投资存在巨大且持续的差异；投资最多的行业在企业总价值中所占份额正在增长。销售和营销费用的变化解释了行业层面无形资本价值的大部分变化。以信息摩擦和需求侧网络效应为特征的行业在客户资本上投资最多。

【**NBER**】: NBER Working Paper No. 33171，https://www.nber.org/papers/w33171
...
【**摘要**】：我们提出了一种分析大规模文本数据的一般方法，结合了神经网络语言处理和生成式统计建模的优势，为非结构化数据创建因子结构，以用于社会科学中常见的下游回归分析。我们通过以下步骤生成文本因子：(i) 使用词向量嵌入表示文本，(ii) 使用局部敏感哈希对向量进行聚类以生成主题的支持集，以及(iii) 通过主题建模识别相对可解释的跨越性聚类（即文本因子）。我们的数据驱动方法能够捕捉复杂的语言结构，同时确保计算可扩展性和经济可解释性，可能在某些方面优于并补充研究人员使用的其他非结构化数据分析方法，包括新兴的大语言模型。我们对框架进行了初步验证测试，并讨论了其三种应用类型：(i) 利用文本增强预测和推断，(ii) 解释（非基于文本的）模型，以及(iii) 构建新的基于文本的度量指标和解释变量。我们使用金融和经济学中的例子来说明每种应用，例如基于新闻文章进行宏观经济预测、从公司文件中解释多因子资产定价模型，以及从专利中衡量基于主题的技术突破。最后，我们提供了一个灵活的文本因子统计软件包以供在线分发，以促进未来的研究和应用。

【**NBER**】: NBER Working Paper No. 33168，https://www.nber.org/papers/w33168

#### 51. Minimum Wages and Race Disparities {#33167}

【**Author**】: David Neumark, Jyotsana Kala
...
【**摘要**】：我们全面分析了最低工资对黑人的影响，以及对黑人与白人的相对影响。我们不仅研究了青少年——最低工资与就业关系文献的主要关注点——还研究了更广泛的低技能群体。我们发现证据表明，最低工资提高导致的就业损失效应在黑人中更为明显——尤其是黑人男性。相比之下，在白人中这种效应并不显著。此外，最低工资的影响通常大到足以对黑人的收入（及相对收入）产生不利影响。鉴于美国存在强烈的种族居住隔离，最低工资影响的种族差异意味着不利影响落在黑人人口比例高的地区。我们还发现证据表明，无论个人种族如何，最低工资在黑人地区的影响更为不利，这加剧了最低工资不利影响集中在黑人人口占比极高地区的现象。

【**NBER**】: NBER Working Paper No. 33167，https://www.nber.org/papers/w33167

#### 52. Immobility As Memory: Some New Approaches to Characterizing Intergenerational Persistence via Markov Chains {#33166}

【**Author**】: Lawrence Blume, Neil A. Cholli, Steven N. Durlauf, Aleksandra Lukina
...
【**摘要**】：本文提出了一些衡量代际持续性的新指标，其核心思想是刻画连接父母与子女社会经济阶层的随机过程中对出身背景的“记忆”特征。我们针对家族王朝的任何初始阶层条件，引入了所有未来世代的“记忆曲线”，揭示了初始条件如何与父母与子女之间的转移过程相互作用，从而产生流动性和持续性。我们还提出了跨不同阶层聚合信息的方法，以生成对人口整体流动性的总体刻画。为了说明我们的指标，我们使用美国调查数据估计了职业“记忆曲线”。我们的研究结果表明，平均而言，对初始条件的记忆在三代之内基本消散，尽管源自不同职业阶层的家族王朝在流动率上存在显著的异质性。

【**NBER**】: NBER Working Paper No. 33166，https://www.nber.org/papers/w33166

#### 53. The Value of Statistical Life for Seniors {#33165}

【**Author**】: Jonathan D. Ketcham, Nicolai V. Kuminoff, Nirman Saha
...
【**摘要**】：我们开发了一个新的显示性偏好框架来估计统计生命价值（VSL）。我们的框架从一个医疗保健的特征模型出发，在该模型中，异质性个体选择在降低死亡风险的医疗服务上花费多少。他们的选择产生了一个均衡的生存函数，该函数可以被微分以恢复他们对降低死亡风险的边际支付意愿。我们的IV估计器使用了66岁以上美国人的调查数据，并将其与联邦行政记录相关联。平均VSL在67岁时约为100万美元，并且随健康状况、收入、教育程度和预期寿命的增加而增加。

【**NBER**】: NBER Working Paper No. 33165，https://www.nber.org/papers/w33165

#### 54. The G.I. Bill, Standardized Testing, and Socioeconomic Origins of the U.S. Educational Elite Over a Century {#33164}

【**Author**】: Ran Abramitzky, Jennifer K. Kowalski, Santiago Pérez, Joseph Price
...
【**摘要**】：我们整理、转录并标准化了65所美国精英（私立和公立）大学250万名学生的历史记录。通过将这些数据与更近期的调查和行政数据相结合，我们构建了过去100年来美国大学学生社会经济背景的最大数据集。我们记录了以下发现：第一，尽管低收入学生在整个大学入学人口中的比例大幅增加，但这些学生在精英私立或公立大学中的代表性在过去一个世纪中一直保持在同样低的水平。第二，高收入学生在精英大学中的代表性在二战后有所下降，但自1980年代以来，这一群体已重新获得高代表性。第三，尽管精英私立和公立大学的经济多样性没有增加，但这些大学在种族和地理上变得更加多样化。第四，美国高等教育史上的两项重大政策变革，即二战后的《退伍军人权利法案》和引入标准化入学考试，在增加低收入和中等收入学生在精英大学中的代表性方面收效甚微。

【**NBER**】: NBER Working Paper No. 33164，https://www.nber.org/papers/w33164

#### 55. The Misery of Diversity {#33163}

【**Author**】: Resul Cesur, Sadullah Yıldırım
...
【**摘要**】：进化论观点认为，虽然多样性可能通过造成进化心理倾向与当前社会环境之间的进化错配而降低主观幸福感（SWB），但人类社会可以通过在适当条件下的群体间接触来适应多样性。利用历史上一个新颖的自然实验，我们考察了由人口多样性所代表的社会环境对主观幸福感的影响。我们发现多样性降低了主观幸福感的认知和享乐维度。多样性导致宏观社会环境质量恶化——表现为社会凝聚力下降、国家能力受阻和经济机会不平等加剧——是解释我们研究结果的机制。对欧洲和美国第一代及第二代移民的分析表明，即使在消除了社会环境的作用之后，原籍国多样性的痛苦依然存在。然而，这些影响在第二代中有所减弱，表明社会环境的长期改善可以减轻多样性的负担。最后，在探索人类社会能否适应多样性时，我们发现有证据表明，多样性促使人们采纳能够缓解多样性痛苦的文化特征（例如建立更强的家庭纽带、赋予友谊更重要的地位以及采取积极竞争的态度）。这些结果在经历了一系列详尽的稳健性检验后依然成立。

【**NBER**】: NBER Working Paper No. 33163，https://www.nber.org/papers/w33163

#### 56. The Politics of Global Public Goods {#33162}

【**Author**】: Bård Harstad

【**Abstract**】: Below, I illustrate how a wide range of political economics forces influence nations' provisions of global public goods. The forces can make it difficult for international cooperation to succeed, but they can also be taken advantage of by carefully designed treaties, so that they are stronger because of the domestic political forces. The chapter concludes that global cooperation and democratization reinforce each other, so that multiple equilibrium outcomes are possible. The models are simple and the text is accessible to students at any level.

【**摘要**】：下文我将阐述广泛的政治经济学力量如何影响各国对全球公共产品的供给。这些力量可能使国际合作难以成功，但精心设计的条约也可以利用这些力量，使其因国内政治力量而变得更加强大。本章的结论是，全球合作与民主化相互强化，因此可能存在多重均衡结果。模型简单，文本适用于任何层次的学生。

【**NBER**】: NBER Working Paper No. 33162，https://www.nber.org/papers/w33162
...
【**摘要**】：本文利用一个简单的动态博弈模型来分析国际环境问题和气候协议。不同国家随时间推移既进行排放，也投资于绿色技术。在此框架下，我们可以分析一切照常的结果、短期与长期协议、自我执行协议、参与、合规、替代设计方案，以及从《京都议定书》到《巴黎协定》的发展历程。本文内容应适用于任何层次的学生。

【**NBER**】: NBER Working Paper No. 33161，https://www.nber.org/papers/w33161

#### 58. A Simple Model of Average Inflation Targeting {#33160}

【**Author**】: Laurence M. Ball, Junnan Zhang
...
【**摘要**】：本文在一个具有锚定通胀预期和利率有效下限（ELB）的简单模型中推导出最优货币政策规则，假设长期通胀目标为2%。在预期完全锚定的情况下，最优政策是平均通胀目标制的一种形式：为了抵消ELB迫使通胀低于2%的时期，政策制定者在不受约束时设定一个高于2%的固定通胀目标。在预期部分锚定而非完全锚定的情况下，远离ELB的通胀目标随经济状态而变化。对于某些参数值，目标在通胀持续低迷的时期之后达到最高。

【**NBER**】: NBER Working Paper No. 33160，https://www.nber.org/papers/w33160

#### 59. Beyond the Fundamentals: How Media-Driven Narratives Influence Cross-Border Capital Flows {#33159}

【**Author**】: Isha Agarwal, Wentong Chen, Eswar S. Prasad
...
【**摘要**】：我们提供了关于媒体驱动叙事如何影响跨境机构投资流动的首个实证证据。通过对150万篇报纸文章应用自然语言处理技术，我们记录了15个国家国内媒体关于中国的叙事所构建的情绪和风险指数存在显著的跨国差异。这些叙事显著影响投资组合流动，即使在控制了宏观经济和金融基本面之后也是如此。对于对中国更熟悉或拥有更多私人信息的投资者，这种影响较小；在不确定性加剧时期，这种影响更大。政治和环境叙事与经济叙事同样具有影响力。投资者对负面叙事的反应比正面叙事更为剧烈。

【**NBER**】: NBER Working Paper No. 33159，https://www.nber.org/papers/w33159

#### 60. Economic Surveillance using Corporate Text {#33158}

【**Author**】: Tarek Alexander Hassan, Stephan Hollander, Aakash Kalyani, Laurence van Lent, Markus Schwedeler, Ahmed Tahoun
...
【**摘要**】：本文应用计算语言学的简单方法来分析非结构化企业文本以进行经济监测。我们将文本即数据方法应用于财报电话会议记录、专利文本和职位招聘信息，以揭示市场和公司如何应对经济冲击（如核灾难或地缘政治事件）的独特见解——这些见解往往被传统数据源所忽略。这种方法增强了我们从文本数据中提取可操作情报的能力，从而有助于政策制定和战略企业决策。通过将计算语言学整合到经济冲击分析中，我们的研究为实时经济监测开辟了新的可能性，并提供了对波动经济环境中企业层面反应更细致的理解。

【**NBER**】: NBER Working Paper No. 33158，https://www.nber.org/papers/w33158

#### 61. The Distributional Implications of Itemized Medical Deductions {#33157}

【**Author**】: Gopi Shah Goda, Ithai Lurie, Priyanka S. Parikh, Chelsea Swete
...
【**摘要**】：2021年，大约760亿美元的自付医疗支出被作为分项医疗扣除（IMD）扣除，导致约90亿美元的联邦税收收入损失。我们利用美国纳税申报数据，研究这些税收节省如何在收入和年龄之间分配，其分配与抵押贷款利息扣除有何不同，以及分配如何随着2017年《减税与就业法案》而变化。虽然对于高收入家庭来说，给定水平的医疗支出不太可能超过收入门槛，但分项扣除率和边际税率随收入增加而增加，导致税收节省向高收入纳税人倾斜：94%的税收节省归于收入分布上半部分的人群。税收节省也高度集中在老年人群体，42%归于65岁以上人群。利用关于自付医疗支出的丰富调查数据，我们说明了税收节省的分配如何随政策替代方案而变化。我们发现，扩大税收补贴的资格可能会降低高收入群体的税收节省集中度，并增加老年群体的税收优惠集中度。

【**NBER**】: NBER Working Paper No. 33157，https://www.nber.org/papers/w33157

#### 62. Forecasting Natural Gas Prices in Real Time {#33156}

【**Author**】: Christiane Baumeister, Florian Huber, Thomas K. Lee, Francesco Ravazzolo
...
【**摘要**】：本文对月度频率下美国天然气实际价格的可预测性进行了全面分析，考虑了一系列在复杂性和经济内容上各不相同的模型。我们的关键发现是，对于长达两年的预测期，相对于随机游走基准，均方预测误差可以在实时中实现显著降低。一个特别有前景的模型是包含天然气供需基本决定因素的六变量贝叶斯向量自回归模型。为了捕捉这些及其他预测变量的实时数据约束，我们从多个来源汇编了一个丰富的历史数据版本数据库。我们还将基于模型的预测与专家和期货市场提供的现成无模型预测进行了比较。鉴于没有单一预测方法能主导所有其他方法，我们探讨了预测池化的有用性，并发现基于实时表现选择个体模型并组合其预测，能提供最准确的预测。

【**NBER**】: NBER Working Paper No. 33156，https://www.nber.org/papers/w33156
...
【**摘要**】：近期研究记录了驱逐的普遍性和后果，但我们对驱逐率潜在驱动因素以及政策影响其范围的理解仍然有限。在本文中，我们研究房东驱逐租户的决定，以及这些决定如何可能受到政策影响。我们将来自低收入租赁市场的新颖租约层面分类账数据与房东驱逐决策模型相结合，以刻画租户违约风险冲击的持续性、房东关于这些冲击的信息以及房东的驱逐成本。我们的数据显示，欠租很常见，经常被房东容忍，并且往往随后得到恢复，这表明房东面临一个权衡：是启动成本高昂的驱逐，还是等待了解租户是否能继续支付。我们的驱逐决策动态离散选择模型捕捉了这一权衡。估计表明，提起驱逐诉讼使房东承担相当于2-3个月租金的成本，并且大多数驱逐涉及未来不太可能继续支付的租户。这意味着统一适用的政策可以为租户带来额外的宽限，但并不能阻止大多数驱逐。我们发现，15%的被驱逐者本可以恢复支付租金，这表明更有针对性的干预措施可以发挥作用。在我们考虑的政策工具中，对房东的直接财政激励——如税收和补贴——比程序性延迟更有可能持久地防止驱逐。

【**NBER**】: NBER Working Paper No. 33155，https://www.nber.org/papers/w33155

#### 64. Unwarranted Racial Disparity in U.S. Foster Care Placement {#33154}

【**Author**】: E. Jason Baron, Joseph J. Doyle Jr., Natalia Emanuel, Peter Hull
...
【**摘要**】：美国黑人儿童被送入寄养机构的可能性是白人儿童的两倍。这种种族差异引发了对歧视的担忧，但也可能反映了需要干预的潜在需求的差异。本文利用全国数据估计了无根据的差异（UDs）——即对于具有相同未来虐待可能性的儿童，其安置率的种族差异。我们使用基于弱且透明假设的未来儿童虐待可能性的非参数边界。在全国范围内，我们发现黑人儿童被送入寄养机构的比率高于具有相同后续虐待经历可能性的白人儿童；这种UD比控制可观测变量的传统估计大42%。我们证明UD在各州之间存在差异，并且州内黑人人口比例和个案工作者的种族构成是预测UD水平的关键因素。最后，我们表明，在具有后续虐待可能性的儿童中，UD比没有这种可能性的儿童大五倍，并且从2008年到2020年，UD有所下降，这主要是由于具有后续虐待可能性的黑人儿童安置率下降所致。UD集中在具有未来虐待可能性的案例中，这产生了重要的政策含义，因为它可能表明白人儿童被“安置不足”——随着时间的推移，种族差距的缩小可能会增加黑人儿童遭受虐待的风险。

【**NBER**】: NBER Working Paper No. 33154，https://www.nber.org/papers/w33154

#### 65. The Evolution of Gender in the Labor Market {#33153}

【**Author**】: Claudia Olivetti, Jessica Pan, Barbara Petrongolo
...
【**摘要**】：本章追溯了劳动力市场中性别研究的发展历程，重点关注学术界对该主题的思考如何与20世纪80年代至今性别不平等的现实发展同步演进。我们提出了一个简单的女性劳动力供给模型，以说明文献中讨论的各种力量（例如生产率差异、不平等的性别角色、工资压价）如何影响性别收入差距。该文献的一个主要进展是更清晰地区分了男性和女性在偏好与技能上的内在差异，与导致性别差距的不同约束条件。我们讨论了关于这些解释相对重要性的研究见解，及其对经济效率的影响。我们强调，当今大部分文献都关注性别约束的相关性，即女性和男性通常在家庭与职业之间面临不同的权衡，这对工作选择、求职和收入都有影响。这些约束根植于家庭内部的性别角色，而家庭角色又受到更广泛社会规范的塑造。我们回顾了近期研究，这些研究确立了身份认同和规范对于理解劳动力市场中性别不平等的相关性，既包括供给方也包括需求方，并探讨了这些规范形成和演变的驱动因素。最后，我们提出了对未来研究的建议。

【**NBER**】: NBER Working Paper No. 33153，https://www.nber.org/papers/w33153

#### 66. The Economics of “Buy Now, Pay Later”: A Merchant’s Perspective {#33152}

【**Author**】: Tobias Berg, Valentin Burg, Jan Keil, Manju Puri
...
【**摘要**】：“先买后付”（BNPL）是消费者支付领域的一项关键创新。它将产品销售与补贴贷款捆绑在一起，实际上为信用度较低的客户提供了更低的价格。因此，BNPL允许商家在具有不同支付意愿的客户之间进行价格歧视。与价格歧视机制一致，我们表明BNPL使销售额增加了20%，这一增长主要由信用度较低的客户以及市场势力较大的产品驱动。我们发现，提供BNPL的收益显著超过了商家的成本。我们的发现有助于解释BNPL在全球电子商务中迅速流行的原因。

【**NBER**】: NBER Working Paper No. 33152，https://www.nber.org/papers/w33152

#### 67. Estimating Aggregate Human Capital Externalities {#33151}

【**Author**】: Junjie Guo, Nicolas A. Roys, Ananth Seshadri
...
【**摘要**】：本文估算了人力资本外部性的两种度量。通过将外部性纳入一个包含义务教育法的人力资本积累世代交叠模型，我们表明，人力资本外部性可以从一代人的义务教育法对其他代际工资的影响中估算出来。使用从模型中推导出的工具变量策略，我们发现，在美国州级层面，平均受教育年限每增加一年，会使个人工资提高6-8%。考虑到这一简化形式估计值，我们发现典型企业的生产率相对于经济体平均人力资本的弹性为0.121。

【**NBER**】: NBER Working Paper No. 33151，https://www.nber.org/papers/w33151

#### 68. The Color of Ideas: Racial Dynamics and Citations in Economics {#33150}

【**Author**】: Marlène Koffi, Roland Pongou, Leonard Wantchekon
...
【**摘要**】：本文利用经济学论文引用网络，研究了思想传播中是否存在种族差异。利用1950年至2021年间超过33万篇出版物的综合数据集，并结合从数千名经济学家简历中手动收集的数据，我们记录了非白人学者（黑人、西班牙裔或亚裔）撰写的论文被引次数比白人学者撰写的论文少5.1%至9.6%。随着作者资历和传统质量指标的提高，引用差距仍然存在甚至扩大，对于黑人作者尤为明显。此外，非白人学者撰写的论文作为引用桥梁的可能性较低，并且根据中心性指数衡量，被高被引论文引用的频率也较低，从而限制了它们的直接和间接影响力。我们的分析表明，这种差异并非归因于研究质量、作者能力或可见度的差异。相反，它很大程度上是由引用模式中的同质性以及网络中的种族聚类所驱动，即学者倾向于引用其同一种族群体的作者。这些发现可以通过一个简单的理论模型得到合理解释，该模型中引用成本和同行评审偏好影响引用行为。然后，我们提供了暗示性证据，表明减少信息摩擦（从而降低引用成本）可以将种族引用差距减少高达50%。最后，利用自然语言处理，我们强调了不同种族群体在研究中的互补性，并讨论了种族障碍对思想传播可能造成的损失。

【**NBER**】: NBER Working Paper No. 33150，https://www.nber.org/papers/w33150

#### 69. Wage Adjustment in Efficient Long-Term Employment Relationships {#33149}

【**Author**】: Michael W. L. Elsby, Axel Gottfries, Pawel M. Krolikowski, Gary Solon
...
【**摘要**】：我们提出了一个模型，在该模型中，高效长期雇佣关系通过由生产率冲击和外部工作机会引发的工资调整得以维持。由于存在重新谈判成本，这些工资调整仅偶尔发生。该模型可进行解析求解，为若干劳动力市场现象提供了新见解，包括：（1）在职者工资变动经验分布的关键特征；（2）工资动态中的近乎“无记忆”特性，即雇佣工资对后续工资和分配决策的影响有限；（3）招聘和留任奖金在维持高效雇佣关系中的关键作用。

【**NBER**】: NBER Working Paper No. 33149，https://www.nber.org/papers/w33149

#### 70. The Economics of Net Zero Banking {#33148}

【**Author**】: Adair Morse, Parinitha R. Sastry
...
【**摘要**】：银行已自愿承诺将其贷款组合与通往脱碳经济的净零路径保持一致。在这篇综述中，我们探讨了投资组合脱碳为何可能与贷款机构利润最大化相一致的经济渠道。我们通过假设净零贷款可能通过风险和回报渠道创造差异化价值来构建问题框架，其中回报主题涵盖利润率与贷款簿增长论点。然后，我们利用该框架的视角来审视文献，并指出研究知识中的空白。我们发现了风险论点影响脱碳的多种作用。此外，脱碳和绿色投资通过银行贷款增长与盈利能力提升相关联。然而，文献中仍有许多点有待连接。我们建议，未来的工作可以进一步连接气候金融文献与更广泛的银行业文献之间的联系，以加深我们对银行在净零转型中将扮演角色的理解。

【**NBER**】: NBER Working Paper No. 33148，https://www.nber.org/papers/w33148

#### 71. Therapy to Reduce Violence and Improve Institutional Safety During Incarceration {#33147}

【**Author**】: Mary Kate Batistich, William N. Evans, Tyler Giles, Rebecca Margolit-Chan
...
【**摘要**】：我们评估了“Step Up”项目的影响，这是一个在德克萨斯州拉伯克县拘留中心对囚犯实施的认知行为疗法项目。Step Up旨在通过小组课程、一对一咨询和结构化工作手册相结合的方式，解决自我毁灭的思维和行为模式。我们在一个非平衡的双向固定效应框架中，比较了随时间推移进入Step Up项目的个体与一组符合条件且感兴趣但未参与的个体。尽管在可观测特征和初始行为指标上具有相似性，但进入Step Up的个体每月行为事件发生率比未治疗组降低了49%，这大约相当于下降了8个百分点。典型参与者在项目中花费约3个月时间，我们发现有证据表明，行为改善在项目完成后持续存在。

【**NBER**】: NBER Working Paper No. 33147，https://www.nber.org/papers/w33147

#### 72. The Power of Daughters: How Physicians' Family Influences Female Patients' Health {#33146}

【**Author**】: Mette Gørtz, Ida L. Kristiansen, Tianyi Wang
...
【**摘要**】：尽管医生对患者结果至关重要，但决定医生行为和决策的因素仍有待理解。在本文中，我们研究了医生的家庭特征如何影响医生的行为以及患者的健康结果。利用丹麦的行政数据和子女性别的自然实验，我们发现拥有女儿会影响男性初级保健医生的执业行为及其女性患者的健康。具体而言，与多一个儿子相比，由多一个女儿的男性医生照料的女性患者，死于女性特定癌症（包括乳腺癌和妇科癌症）的可能性降低5.5%。这种结果的改善似乎源于加强的癌症筛查和预防工作，从而导致了更早的发现和更成功的预防。在探索潜在机制时，我们发现拥有更多女儿的男性医生对女性特定健康指南表现出更高的关注度，并且更有可能与女性合作。我们还从调查数据中发现了暗示性证据，表明女性患者报告称，与这些医生相处时感受到更高的信任度、同理心以及更清晰的沟通。

【**NBER**】: NBER Working Paper No. 33146，https://www.nber.org/papers/w33146

#### 73. Capital Flow Stability and Policy Challenges in Southeast Asia: Historical Perspectives from the 19th to the 21st Century {#33145}

【**Author**】: Christopher M. Meissner, Kensuke Molnar-Tanaka
...
【**摘要**】：在过去200年间，经济体在应对全球化过程中积累了管理资本流动的丰富经验。本研究考察了自19世纪以来的资本流动管理，旨在为当今东南亚提供历史教训。我们从19世纪末全球化时期的全球英镑/金本位制入手，随后讨论了动荡的两次世界大战间期。接着，我们分析了20世纪50年代以来东南亚国家的政策。在20世纪80年代和90年代，许多经济体因全球资本流动的恢复而面临日益加剧的金融不稳定，最显著的是东南亚在亚洲金融危机期间。本文考察了汇率政策对资本流动稳定性的历史重要性。21世纪的资本流动管理面临着各种挑战，例如国家干预的增强和数字货币的出现。

【**NBER**】: NBER Working Paper No. 33145，https://www.nber.org/papers/w33145

#### 74. Nonlinear Pricing and Misallocation {#33144}

【**Author**】: Gideon Bornstein, Alessandra Peter
...
【**摘要**】：本文研究了非线性定价对加成率和资源错配的影响。我们构建了一个允许企业设定依赖于数量的定价方案的一般均衡模型——这与宏观经济模型中的典型假设相反。在没有线性定价限制的情况下，加成率异质性不再是资源错配的标志。大企业收取更高的加成率，但资源在企业间的配置是有效的。此外，我们指出了一种新的资源错配来源。在一般均衡中，高品味消费者被分配了过多的每种商品，而低品味消费者则过少。当劳动供给具有弹性时，企业的市场势力压低了总劳动量，但这种效应与经济中总加成率的水平无关。利用零售部门的微观数据，我们展示了非线性定价的普遍性并对模型进行了量化。我们发现，在非线性定价下，消费者之间的资源错配造成的福利损失远大于在线性定价下企业之间的资源错配造成的福利损失。

【**NBER**】: NBER Working Paper No. 33144，https://www.nber.org/papers/w33144

#### 75. Trade, Trees, and Lives {#33143}

【**Author**】: Xinming Du, Lei Li, Eric Zou
...
【**摘要**】：本文展示了一种级联机制，通过这种机制，国际贸易导致的森林砍伐使得远离贸易活动发生的城市的健康结果下降。我们以巴西为研究对象，该国在过去二十年中为满足日益增长的全球需求而加大了农业出口。使用份额转移研究设计，我们首先表明出口冲击导致了当地农业的大规模扩张和森林覆盖率的几乎一对一的下降。然后，我们构建了一个动态影响区域模型，该模型预测了由于森林损失（这些森林原本可以在空气污染物传播过程中过滤和吸收它们），砍伐区域下风向地区应感受到的大气变化。利用这些大气联系中的准随机变化，我们建立了上游森林砍伐与下游空气污染和过早死亡增加之间的因果关系，其中死亡率影响主要由心血管和呼吸系统原因驱动。我们的估计揭示了一个巨大的贸易森林砍伐远程耦合健康外部性：在过去二十年中，巴西有超过70万人过早死亡。这相当于研究期间每1美元农业出口造成0.18美元的统计生命价值损失。

【**NBER**】: NBER Working Paper No. 33143，https://www.nber.org/papers/w33143

#### 76. Liquidity Shocks and Firm Exports: Evidence from Cash Shortages During India’s Demonetization {#33142}

【**Author**】: Ritam Chaurey, Ryan Kim, Pravin Krishna
...
【**摘要**】：本文研究了由现金短缺引起的流动性冲击如何影响出口。我们在印度2016年货币废钞的背景下探讨了这一点，这是一项突然的政府政策公告，导致该国流通中86%的货币在数小时内变为非法。我们的分析使用了新颖的数据，包括与出口企业及其资产负债表以及地区间国内贸易相匹配的高频海关交易记录。虽然现金短缺并不直接影响出口企业，但我们发现，对于其国内客户遭受流动性冲击的企业，实际出口出现了显著且即时的下降。

【**NBER**】: NBER Working Paper No. 33142，https://www.nber.org/papers/w33142

#### 77. Information Span in Credit Market Competition {#33141}

【**Author**】: Zhiguo He, Jing Huang, Cecilia Parlatore
...
【**摘要**】：我们构建了一个信贷市场竞争模型，该模型区分了信息广度（宽度）和信号精度（质量），捕捉了金融科技/非银行贷款的兴起，其中传统上主观的（软）信息被转化为客观的（硬）数据。借款人质量取决于多维基本面，通过硬信号或软信号进行评估。两家银行观察到私有的硬信号，但只有专业银行收到一个软信号。扩大硬信息的广度使得非专业银行能够评估以前只有专家才能获得的特征，并减轻其赢家诅咒。相比之下，硬信号精度的提高则加强了专业银行的信息优势。

【**NBER**】: NBER Working Paper No. 33141，https://www.nber.org/papers/w33141
...
【**摘要**】：最低税规则仅约束税率最低的司法管辖区。由于更高的最低税率会扩大受影响国家的范围，从而增加任何进一步变化的影响，因此可能存在一个支配区域，在该区域内没有任何参数值能使最低税有效。对2020年法定公司税率的分布应用泰勒近似，4%-27%的范围是一个支配区域：可能存在低于4%或高于27%的有效最低税率，但不存在介于4%和27%之间的有效全球最低税率。设定在流行税率上的最低税尤其低效——15%的最低税率产生的价值，当为正时，相当于抵消了税收竞争影响的不到百分之一。

【**NBER**】: NBER Working Paper No. 33140，https://www.nber.org/papers/w33140

#### 79. Concentrating Intelligence: Scaling and Market Structure in Artificial Intelligence {#33139}

【**Author**】: Anton Korinek, Jai Vipra
...
【**摘要**】：本文考察了快速增长的基础模型市场（特别是大型语言模型）的演变结构和竞争动态。我们描述了塑造人工智能行业并导致领先参与者之间激烈竞争的技术特征。本文分析了基础模型的成本结构，强调了计算资源、数据和人才等关键投入的重要性，并识别了可能导致未来市场集中度提高的显著规模经济和范围经济。我们探讨了竞争的两个担忧，即市场倾斜的风险和垂直整合的影响，并评估了旨在维持竞争格局的政策补救措施。展望未来日益变革性的人工智能系统，我们讨论了市场集中度如何转化为前所未有的权力积累，强调了竞争政策的更广泛社会利害关系。

【**NBER**】: NBER Working Paper No. 33139，https://www.nber.org/papers/w33139

#### 80. Industrial Policies and Innovation: Evidence from the Global Automobile Industry {#33138}

【**Author**】: Panle Jia Barwick, Hyuk-Soo Kwon, Shanjun Li, Yucheng Wang, Nahim B. Zahur
...
【**摘要**】：本文考察了产业政策对全球汽车行业创新的影响。我们编制了首个将全球产业政策与2008年至2023年汽车行业相关专利数据联系起来的综合数据集。我们记录了政策重点的重大转变：到2022年，近一半的产业政策针对电动汽车相关领域，而2008年几乎为零。与此同时，从内燃机技术到电动汽车创新的技术转型已经清晰可见。我们的分析发现政策支持与创新活动之间存在正相关关系。在国家层面，五年累计电动汽车目标产业政策每增加一个标准差，与新的电动汽车专利申请量增加百分之四相关。企业层面分析（使用OLS、IV和PPML）表明，汽车制造商和电动汽车电池制造商获得的电动汽车财政激励每增加百分之十，会导致电动汽车创新同样增加约百分之四。我们确认了汽车行业技术变革方向中路径依赖的重要性，但未发现电动汽车目标产业政策刺激内燃机技术创新的证据。

【**NBER**】: NBER Working Paper No. 33138，https://www.nber.org/papers/w33138

#### 81. Income Inequality and Job Creation {#33137}

【**Author**】: Sebastian K. Doerr, Thomas Drechsel, Donggyu Lee
...
【**摘要**】：我们提出了一个新的渠道，通过该渠道，不断上升的收入不平等会影响就业创造和宏观经济结果。高收入家庭相对更多地储蓄于股票和债券，而较少存入银行存款。因此，顶层收入份额的上升增加了依赖银行融资的企业的相对融资成本，这些企业进而会创造更少的就业岗位。利用美国各州顶层收入份额的差异以及工具变量策略，我们为这一渠道提供了证据。随后，我们构建了一个包含异质性家庭和异质性企业的一般均衡宏观模型，并根据我们的实证估计对其进行校准。该模型表明，自1980年以来，顶层收入的长期上升解释了小企业就业份额下降的13%。通过这一新渠道，不断上升的不平等还降低了劳动收入份额和总产出。模型实验显示，忽视不平等与就业创造之间的联系会低估收入再分配的福利效应。

【**NBER**】: NBER Working Paper No. 33137，https://www.nber.org/papers/w33137
...
【**摘要**】：央行信息效应和新费雪效应会产生相似的结果：在两种效应下，货币紧缩都未能降低通胀和产出。分别估计这些效应存在将两者混淆的风险。为了区分这两个渠道，我们在一个新凯恩斯模型中引入了多种波动来源，其中包括一个产生新费雪效应的永久性货币冲击，以及一个央行据此做出反应并产生央行信息效应的偏好冲击。我们利用战后美国季度数据对模型进行估计。我们发现这两种效应都很重要：新费雪效应解释了约三分之一的通胀变化。而关闭美联储对偏好冲击的直接反应会导致通胀方差翻倍，产出方差增加20%。该结果在假设私人主体拥有不完全信息时依然稳健，这表明存在央行信息渠道，但不存在央行信息优势，至少在季度频率上是如此。

【**NBER**】: NBER Working Paper No. 33136，https://www.nber.org/papers/w33136

#### 83. Education and Preferences for Desired Traits in Children {#33135}

【**Author**】: Naci H. Mocan, Nur Orak
...
【**摘要**】：父母的偏好和信念与其子女之间存在强相关性。此外，受教育程度较高的父母的子女往往比受教育程度较低父母的子女拥有不同的偏好和信念。然而，关于教育是否会影响成年人对于希望灌输给子女的特质的偏好，目前尚缺乏证据。本文旨在填补这一空白。利用19个欧洲国家实施的义务教育改革以及综合价值观调查的数据——该调查包含关于儿童应在家中学习的必备品质的问题——我们证明，因这些改革而获得额外教育的女性更有可能将想象力、决心和毅力以及责任感视为应灌输给儿童的重要特质。相反，她们不太倾向于将宗教信仰、服从和无私视为儿童应在家里学习的基本属性。此外，我们发现教育降低了女性的宗教信仰程度。这些影响主要由天主教女性和生活在天主教占多数的国家的女性驱动。相比之下，教育对男性的宗教信仰程度或他们认为重要的儿童特质没有显著影响。

【**NBER**】: NBER Working Paper No. 33135，https://www.nber.org/papers/w33135

#### 84. Randomized Entry: The Equilibrium Effects of Entry in Digital Financial Markets {#33134}

【**Author**】: Francis Annan

【**Abstract**】: We created randomized variation across and within markets to estimate the equilibrium effects of small microenterprises’ entry into a new market: the market for mobile money services. Entry has a negative net effect on firm misconduct in mobile money. There is a positive direct effect but a similar-sized negative indirect effect on prices for non-financial goods/services. Market-level price-cost markups decreased, indicating net gains in consumer surplus. We ﬁnd evidence of within-market revenue reallocation for mobile money, and a large services multiplier: revenues for non-financial goods/services increased by 20%. We show the improvements come from adoption externalities and decreased transaction costs.

【**摘要**】：我们通过跨市场和市场内随机化创造了变异，以估计小型微型企业进入一个新市场——移动货币服务市场——的均衡效应。进入对移动货币中的企业不当行为产生了负的净效应。存在一个正向的直接效应，但对非金融商品/服务的价格有一个规模相似的负向间接效应。市场层面的价格-成本加成下降，表明消费者剩余净增加。我们发现了移动货币市场内收入重新分配的证据，以及一个巨大的服务乘数：非金融商品/服务的收入增加了20%。我们表明这些改善来自于采纳外部性和交易成本的降低。

【**NBER**】: NBER Working Paper No. 33134，https://www.nber.org/papers/w33134

#### 85. Resolving Puzzles of Monetary Policy Transmission in Emerging Markets {#33133}

【**Author**】: Jongrim Ha, Dohan Kim, M. Ayhan Kose, Eswar S. Prasad
...
【**摘要**】：关于新兴市场经济体货币政策传导的传统实证模型会产生令人费解的结果：货币紧缩常常导致价格上涨（价格之谜）和货币贬值（外汇之谜）。我们表明，将前瞻性预期纳入标准的开放经济结构向量自回归模型可以解开这些谜团。具体而言，我们在模型中加入了基于消费者、企业和专业预测的新型调查预期指标。我们发现，货币紧缩后的价格上涨与货币贬值有关，因此消除外汇之谜有助于解决价格之谜。

【**NBER**】: NBER Working Paper No. 33133，https://www.nber.org/papers/w33133

#### 86. Tax Policy, Investment and Profit Shifting {#33132}

【**Author**】: Katarzyna A. Bilicka, Michael P. Devereux, İrem Güçeri
...
【**摘要**】：宏观层面估计的利润转移弹性通常超过微观层面。我们通过在一个模型中考虑利润报告的广延边际决策来调和这些差异，在该模型中，跨国公司面临未观测到的、异质性的利润转移固定成本和可变成本。利用英国行政数据，我们发现微观半弹性将总体半弹性低估了约50%。我们估计利润转移的平均固定成本和可变成本分别占真实税基的1.5%和3.1%。我们利用一个限制意大利跨国公司利润转移的准自然实验验证了该模型，并用其评估两类税收政策改革。

【**NBER**】: NBER Working Paper No. 33132，https://www.nber.org/papers/w33132

#### 87. Forced Displacement, the Perpetuation of Autocratic Leaders, and Development in Origin Countries {#33131}

【**Author**】: Nicolas Cabra-Ruiz, Sandra V. Rozo, Maria Micaela Sviatschi

【**Abstract**】: When millions flee an autocratic regime, what happens to economic development in the country they leave behind? In Venezuela, nearly eight million people (38.8% of the population in 1990) have left since 2013. Using a difference-in-differences design exploiting historical foreign settlement shares (as migration networks) and post-2013 oil shocks, we find affected municipalities experienced a 29.4 percent GDP contraction (mirrored in lower income per capita and employment) and higher inequality at origin. Paradoxically, this exodus sustains autocracy by silencing political opposition and strengthening organized crime that channels illicit rents and armed enforcement to the regime. These linked economic and political shifts reveal how large-scale migration from weak institutional contexts can entrench autocracy and deepen long-run underdevelopment.

【**摘要**】：当数百万人逃离一个威权政权时，他们留下的国家的经济发展会发生什么？在委内瑞拉，自2013年以来已有近八百万人（占1990年人口的38.8%）离开。利用基于历史外国定居份额（作为移民网络）和2013年后石油冲击的双重差分设计，我们发现受影响的市镇经历了29.4%的国内生产总值收缩（反映在较低的人均收入和就业上），并且原籍国的不平等加剧。矛盾的是，这种外流通过压制政治反对派和加强向政权输送非法租金和武装力量的有组织犯罪，反而维持了威权统治。这些相互关联的经济和政治变化揭示了来自弱制度背景的大规模移民如何能够巩固威权统治并加深长期的不发达状态。

【**NBER**】: NBER Working Paper No. 33131，https://www.nber.org/papers/w33131
...
【**摘要**】：本文回顾了最近的定量城市模型。这些模型足够丰富，能够捕捉数据中观察到的特征，例如许多非对称区位和丰富的交通网络地理结构。然而，这些模型仍然足够易于处理，以至于可以对其理论性质进行分析性刻画。由于只需要估计少量结构参数（弹性），它们便于进行透明的识别。由于这些模型能够合理化城市内部经济活动的观测空间分布，它们可用于对经验上现实的政策干预对该观测分布的影响进行反事实分析。实证应用包括估计集聚经济强度，评估交通基础设施改善（例如铁路、公路、快速公交系统）、分区和土地使用法规、地方性政策以及远程工作等新技术的影响。

【**NBER**】: NBER Working Paper No. 33130，https://www.nber.org/papers/w33130

#### 89. Macro-Level Institutions and Micro-Level Economic Behavior: A Meta-Meta Analysis of 1,126 Studies {#33129}

【**Author**】: Jason A. Aimone, Sheryl Ball, Esha Dwibedi, Jeremy J. Jackson, James E. West
...
【**摘要**】：我们将1996年至2017年间51个国家的社会层面制度指标与来自六项元分析中1126项实验室实验的个人决策结果数据相结合，评估国内制度变迁对亲社会行为和纳什行为的影响。我们发现，政府效能和监管自由度与亲社会行为呈正相关。我们还发现，以下各项监管组成部分的自由度——利率管制、具有约束力的最低工资、工人解雇保护、征兵制以及行政要求——均与亲社会行为相关，并与纳什行为呈负相关。这些结果表明，在设计政府政策时，考虑亲社会行为的溢出效应具有重要意义。

【**NBER**】: NBER Working Paper No. 33129，https://www.nber.org/papers/w33129

#### 90. Input Price Dispersion Across Buyers and Misallocation {#33128}

【**Author**】: Ariel Burstein, Javier Cravino, Marco Rojas
...
【**摘要**】：我们利用智利企业电子发票的全面数据集，记录了制成品中间投入品在不同买方之间价格离散的新事实。超过一半的企业间制造业销售来自同一月份被多个买方购买的产品。买方间的价格离散普遍存在，平均产品的买方间价格范围达46个百分点。价格差异在时间上高度持久，且与同一买方购买的不同产品之间存在强相关性。虽然价格差异与买方-卖方配对的可观测特征（如买方规模和交易规模）共同变动，但这些因素仅解释了价格差异总体变化的一小部分。我们使用一个生产网络的标准模型来量化消除同一产品买方间观测到的价格离散所带来的生产率提升，假设这种离散是由买方-产品特定的加成率驱动的。总生产率（按受处理的多买方企业销售份额标准化）的提升幅度在2%到7%之间，具体取决于替代弹性的校准。消除买方间加成率离散所带来的收益，与消除产品间加成率离散所带来的收益同样显著。

【**NBER**】: NBER Working Paper No. 33128，https://www.nber.org/papers/w33128

#### 91. Trade Policy as an Exogenous Shock: Focusing on the Specifics {#33127}

【**Author**】: Andrew Greenland, John Lopresti
...
【**摘要**】：本文引入了一种新方法，通过利用在价格变化情况下对特定关税的异质性依赖，来量化关税保护对经济结果的影响。我们构建了一个涵盖1900年至1940年间美国五个贸易政策体制下所有关税税目的数据库，并表明我们测度的“实际保护”变化指标能强有力地预测该时期的进口增长和劳动力市场结果。利用关联的全量人口普查数据，我们表明进口暴露通过减缓年轻人尤其从农业向扩张中的制造业部门的转型，抑制了结构性变革。

【**NBER**】: NBER Working Paper No. 33127，https://www.nber.org/papers/w33127

#### 92. How the US-China Trade War Accelerated Urban Economic Growth and Environmental Progress in Northern Vietnam {#33126}

【**Author**】: Matthew E. Kahn, Wen-Chi Liao, Siqi Zheng
...
【**摘要**】：特朗普政府的关税在中国生产者与美国消费者之间互利贸易的链条上制造了楔子。将生产转移到邻近的越南使企业能够跨越关税壁垒。在越南境内，距离中国更近（就距离和产业结构而言）的城市增长更快，并吸引了更多外国直接投资。这些城市越来越多地消耗可再生能源来推动本地经济发展。我们研究了与区域贸易增长相关的本地空气质量改善和二氧化碳减排。中国区域贸易的增长对整个亚洲城市体系的崛起具有重要影响。

【**NBER**】: NBER Working Paper No. 33126，https://www.nber.org/papers/w33126
...
【**摘要**】：本文回顾了空间经济学领域的最新研究。空间经济学关注经济活动在地理空间中区位的决定因素和影响。它分析地理位置如何塑造经济主体所从事的经济活动、它们之间的相互作用、它们的福利以及公共政策干预的效果。该领域的研究受益于新理论技术、地理信息系统数据新来源、计算能力快速进步、机器学习和人工智能以及公共政策对基础设施和对被全球化和技术“抛在后面”地区适当政策的重新关注。这些研究的见解包括：商品和通勤市场可达性在决定区位选择中的作用；经济活动区位以多重均衡为特征的条件；暂时性冲击可能产生永久性效应（滞后或路径依赖）的情形；局部冲击的异质性和持续性影响；集聚经济的规模及其随距离的衰减；以及集聚力和土地利用内生变化在塑造交通基础设施改善影响中的作用。

【**NBER**】: NBER Working Paper No. 33125，https://www.nber.org/papers/w33125

#### 94. On the Limits of Chronological Age {#33124}

【**Author**】: Rainer Kotschy, David E. Bloom, Andrew J. Scott
...
【**摘要**】：人口老龄化分析通常以生理年龄为框架。然而，生理年龄本身不一定能深入揭示老龄化过程。本文回顾了相关文献并进行了实证分析，旨在探究在用于经济行为和结果模型时，生理年龄是否是生理功能的可靠代理变量。我们表明，由于老龄化在不同人群、健康领域以及时间上的显著差异，生理年龄是生理功能的不可靠代理变量。我们进一步证明，当替代生理功能使用时，生理年龄要么无法预测经济变量，要么预测出与生理老龄化基本无关的经济行为和结果的额外效应。持续依赖生理年龄作为生理功能的代理变量，可能会阻碍社会充分利用长寿增长带来的益处。

【**NBER**】: NBER Working Paper No. 33124，https://www.nber.org/papers/w33124

#### 95. Monetary-Fiscal Coordination with International Hegemon {#33123}

【**Author**】: Xuning Ding, Zhengyang Jiang
...
【**摘要**】：货币政策和财政政策需要协调以实现理想的宏观经济结果。自Leeper（1991）以来的文献主要关注两种体制：货币主导和财政主导。在这两种情况下，一种政策是主动的，而另一种是被动的并适应前者。我们在国际经济中研究这一协调问题，并发现了第三种体制——霸权主导。在这种情况下，霸权国的货币和财政当局可以追求各自独立的政策目标，而另一国的货币和财政政策则都是适应性的。例如，霸权国可以推行一种不受其财政政策支持的货币政策。当这种情况发生时，外国货币当局必须采取与霸权国相同的立场，外国财政当局必须为两国共同采取的货币立场提供财政支持，而汇率则进行调整以使经济达到均衡。我们的结果表明，美国财政政策相对于其货币政策的独立性可以通过外国的适应性政策实现，并且美联储抗击通胀的努力可以成功，尽管公共债务水平很高——在封闭经济中，这种高债务水平本需要巨大的财政支持。

【**NBER**】: NBER Working Paper No. 33123，https://www.nber.org/papers/w33123

#### 96. Earnings, Marriage, and the Variance of Family Income by Age, Gender, and Cohort {#33122}

【**Author**】: Joseph Altonji, Daniel Giraldo Páez, Disa M. Hynsjö, Ivan Vidangos

【**Abstract**】: For birth cohorts 1935–44, 1945–62, and 1964–74, we estimate the contribution of edu-cation; permanent heterogeneity in wage rates, employment, and hours; labor market shocks; spouse characteristics and shocks; nonlabor income shocks; and marital histories to the age profiles of the variance of family income per adult equivalent. Education and employment heterogeneity are key sources of the rise in the variance with age and across cohorts. Wage heterogeneity is important at all ages. Own characteristics and shocks matter more for men than women, while spouse characteristics and shocks matter more for women. Gender differences have declined across cohorts.

【**摘要**】：针对1935-44年、1945-62年和1964-74年出生队列，我们估算了教育、工资率、就业和工作时间的永久性异质性、劳动力市场冲击、配偶特征与冲击、非劳动收入冲击以及婚姻史对按成人等价计算的家庭收入方差年龄曲线的贡献。教育和就业异质性是方差随年龄和队列上升的关键来源。工资异质性在所有年龄段都很重要。自身特征和冲击对男性的影响大于女性，而配偶特征和冲击对女性的影响更大。性别差异在各队列间有所下降。

【**NBER**】: NBER Working Paper No. 33122，https://www.nber.org/papers/w33122

#### 97. Elite Strategies for Big Shocks: The Case of the Fall of the Ming {#33121}

【**Author**】: Carol H. Shiue, Wolfgang Keller
...
【**摘要**】：本文记录了尽管经历王朝更迭，中国中部地区精英家族权力仍持续存在的现象。我们研究了明朝（1368-1644年）灭亡对夫妻及其后代的影响（对人的处理效应），并提供了多代家族谱系应对重大冲击的证据。地方明朝精英在短期内影响力下降，但长期来看，其后代恢复了权力，并以新清朝（1644-1911年）精英的身份加强了对权力的掌控。与家族谱系的恢复相反，明朝灭亡对历史上受该冲击负面影响最严重的地区（对地区的处理效应）产生了更持久的负面冲击。本文认为，精英逆转是由于明朝灭亡造成的创伤，促使社会规范转向以科举考试为基础的最受社会尊重的职业道路；这些规范在明朝灭亡中遭受更大破坏的家族谱系中，以更大程度代际传递。

【**NBER**】: NBER Working Paper No. 33121，https://www.nber.org/papers/w33121

#### 98. Small Changes, Big Impact: Nudging Employees Toward Sustainable Behaviors {#33120}

【**Author**】: Laura Cappellucci, Lan Ha, Jeremy Honig, Christopher R. Knittel, Amy Vetter, Richard Wilner
...
【**摘要**】：我们与一家运营超过160个血浆捐献中心的大型生物制药公司合作，设计并进行了三项随机对照试验，旨在工作场所环境中促进可持续行为。具体而言，我们专注于减少导致收集材料掉落、冷冻柜门长时间打开以及不当回收操作的操作错误。为实现这些目标，我们运用社会规范来助推员工：1）减少浪费的收集材料，2）最小化冷冻柜门开启的持续时间，以及3）改进回收操作。我们发现，因收集材料掉落产生的塑料垃圾以及相关成本平均减少了约70%。冷冻柜门警报的频率下降了超过80%，警报持续时间根据实证规范不同下降了超过45%。我们还观察到未压扁纸板减少了约40%，而其他类型污染物的结果在统计上不显著。重要的是，对于每项干预措施，我们没有发现处理效应随时间减弱或影响业务运营的证据。我们的研究为在工作场所环境中促进可持续行为提供了重要启示，填补了关于助推在工作场所有效性的文献中的一个重要空白。

【**NBER**】: NBER Working Paper No. 33120，https://www.nber.org/papers/w33120

#### 99. Expecting Climate Change: A Nationwide Field Experiment in the Housing Market {#33119}

【**Author**】: Daryl Fairweather, Matthew E. Kahn, Robert D. Metcalfe, Sebastian Sandoval Olascoaga
...
【**摘要**】：气候变化为美国房产带来了新风险。由于获取特定位置房产风险数据成本高昂且有时不可得，购房者可以从获取这些风险知识中大大受益。为探究这一点，我们通过Redfin进行了一项大规模全国性自然实地实验，以估计提供特定房屋洪水风险信息对购房者在搜索、出价和购买决策方面行为的因果影响。Redfin随机分配了1750万用户，使其接收关于他们在平台上搜索房产的洪水风险详细信息。我们的分析揭示了几个关键发现：（1）洪水风险信息影响购房过程的每个阶段，包括初始搜索、出价活动和最终购买；（2）个体愿意在房产便利设施方面做出权衡，以拥有洪水风险较低的房产；（3）洪水风险信息对行为的影响在洪水高风险区域进行搜索的用户中更为显著，但在共和党县和民主党县的购房者之间没有显著差异；（4）该信息导致了房产价格的变化并改变了市场的享乐均衡，提供了一个新的发现，即气候适应可以是前瞻性和主动性的。

【**NBER**】: NBER Working Paper No. 33119，https://www.nber.org/papers/w33119

#### 100. Using Information to Curb Racial Discrimination {#33118}

【**Author**】: Christopher R. Knittel, Donald MacKenzie, Michiko Namazu, Bora Ozaltun, Dan Svirsky, Stephen Zoepf
...
【**摘要**】：我们检验了更多关于顾客的信息是否会减少种族偏见。我们的研究场景是共享出行服务市场。Ge等人（2020）的先前研究发现，如果乘客的名字是非裔美国人常用的名字，优步司机取消行程的可能性是其他情况的两倍。在一项随机对照试验中，我们测试了对优步平台应用程序的两项修改是否能减少种族歧视。在标准优步应用程序中，司机在接受行程前只能看到乘客的评分。一旦接受行程，他们才能看到乘客的名字。在第一项干预中，我们增大了评分的字体大小，以引起对乘客质量的注意。在第二项干预中，乘客的名字从一开始就显示。利用对照组观察数据，我们确认了乘客名字越可能是非裔美国人使用的名字，司机取消行程的可能性就越大。然而，增大乘客评分的字体大小消除了这种种族偏见。相比之下，我们没有发现太多证据表明在初始屏幕上显示名字会降低或提高取消率。

【**NBER**】: NBER Working Paper No. 33118，https://www.nber.org/papers/w33118

#### 101. Taming the Curse of Dimensionality: Quantitative Economics with Deep Learning {#33117}

【**Author**】: Jesús Fernández-Villaverde, Galo Nuño, Jesse Perla
...
【**摘要**】：我们认为深度学习为驯服数量经济学中的维度灾难提供了一条有前景的途径。我们首先探讨了求解动态均衡模型所面临的独特挑战，特别是个体代理人决策与均衡所需的总体一致性条件之间的反馈循环。随后，我们介绍了深度神经网络，并通过求解随机新古典增长模型来展示其应用。接着，我们将深度神经网络与数量经济学中的传统求解方法进行了比较。最后，我们综述了神经网络在数量经济学中的应用，并给出了谨慎乐观的理由。

【**NBER**】: NBER Working Paper No. 33117，https://www.nber.org/papers/w33117

#### 102. Robots and Labor in Nursing Homes {#33116}

【**Author**】: Yong Suk Lee, Toshiaki Iizuka, Karen Eggleston
...
【**摘要**】：就业、任务和生产率如何随机器人采用而变化？与制造业不同，在机器人采用正在扩大的服务业中，我们对这些问题知之甚少。作为填补这一空白的第一步，我们利用包含所使用不同机器人和所执行任务的原始机构层面面板数据，研究了日本的养老院。我们发现，机器人采用伴随着就业率和留任率的提高，这种关系对于非正式护理工人和监控机器人最为显著。特定任务由机器人执行的份额随着相应类型机器人的采用而增加，导致护理工人的努力重新分配到支持优质护理的“人际接触”任务上。机器人还与质量改善（约束使用和压疮的减少）以及生产率提高相关联。

【**NBER**】: NBER Working Paper No. 33116，https://www.nber.org/papers/w33116

#### 103. Two Wrongs Can Sometimes Make a Right: The Environmental Benefits of Market Power in Oil {#33115}

【**Author**】: John Asker, Allan Collard-Wexler, Charlotte De Canniere, Jan De Loecker, Christopher R. Knittel
...
【**摘要**】：市场势力会减少均衡产量并扭曲生产，通常导致福利损失。然而，正如Buchanan（1969）所指出的，市场势力可能缓解由负外部性导致的过度生产。本文在全球石油市场中检验了这一观点，其中欧佩克的市场势力影响着石油产量和碳强度。我们估计，从1970年到2021年，欧佩克的市场势力减少了超过67 GtCO2的排放，相当于40,730亿美元的气候损害，以及实现《巴黎协定》1.5°C目标所需碳预算的17.8%。这一环境效益超过了因扭曲生产分配而造成的福利损失。

【**NBER**】: NBER Working Paper No. 33115，https://www.nber.org/papers/w33115
...
【**摘要**】：经济现代化如何影响群体身份？现代化理论强调劳动力迁移如何导致共同身份的采纳。然而，经济发展可能减少移民的激励，从而保护地方文化。我们研究了第二次工业革命期间的英格兰和威尔士，这一时期以新产业发展以及交通和通讯成本下降为特征。利用关于个人姓名和迁移决策的微观数据，我们量化了身份变化及其空间差异。我们开发并估计了一个定量空间模型，其中迁移和文化身份相互依赖。经济现代化的不同组成部分对身份变化产生了不同影响。下降的迁移成本使边缘地区同质化。相比之下，产业发展导致了异质性，既增加了伦敦文化的整体流行度，也通过减少工业化边缘地区的向外迁移而创造了地方身份的坚守者。现代化既促进了国家身份，也促进了工业化边缘地区持久的地方身份。

【**NBER**】: NBER Working Paper No. 33114，https://www.nber.org/papers/w33114
...
【**摘要**】：本文对布兰德和泰勒关于开放获取可再生资源利用与贸易的原始模型进行了推广，以回应三项常见批评。首先，我在收获生产率方面引入代理人异质性，以平滑模型中的极端专业化模式，同时保持其李嘉图结构和可处理性。其次，我通过构建一个政策严格度函数，突破了原始模型对开放获取的假设，该函数允许部分、最优和内生资源政策。第三，通过利用代理人异质性带来的平滑替代可能性以及政策严格度函数可能因国家而异的洞察，我展示了如何运用与增长计量经济学相关的方法来评估模型的核心预测。

【**NBER**】: NBER Working Paper No. 33113，https://www.nber.org/papers/w33113

#### 106. Short-Time Work Extensions {#33112}

【**Author**】: Christina Brinkmann, Simon Jäger, Moritz Kuhn, Farzad Saidi, Stefanie Wolter

【**Abstract**】: Governments use short-time work (STW) schemes to subsidize job retention. A key policy lever during crises is the extension of potential benefit duration (PBD)—how long firms can receive STW subsidies. Using unique German administrative data from 2009 to 2021, we show that separations rise and employment falls when firms exhaust benefits. Yet the uptick in separations at exhaustion almost entirely reflects job-to-job moves rather than transitions into unemployment, even in slack labor markets, consistent with STW delaying reallocation rather than preventing unemployment. We develop a model to analyze exogenous shifts in PBD and show that wage flexibility can substitute for longer benefit duration. Exploiting a 2012 reform that doubled the PBD from six to twelve months, we find no evidence that the extension prevented unemployment and, if anything, reduced reallocation to other firms. In line with the model, firms without extensions reduced wages relative to those with extended support, and across labor market cells, larger wage adjustments coincide with smaller employment losses. Our findings imply that STW extensions operated mainly as wage subsidies rather than job-saving measures.

【**摘要**】：政府使用短时工作计划来补贴就业保留。危机期间的一个关键政策杠杆是延长潜在福利期限——即企业可以领取短时工作补贴的时长。利用2009年至2021年独特的德国行政数据，我们表明当企业福利耗尽时，离职率上升而就业下降。然而，在福利耗尽时离职率的上升几乎完全反映了工作转换而非向失业的转变，即使在劳动力市场疲软时也是如此，这与短时工作延迟了重新配置而非防止失业的观点一致。我们开发了一个模型来分析福利期限的外生变化，并表明工资灵活性可以替代更长的福利期限。利用2012年一项将福利期限从六个月翻倍至十二个月的改革，我们没有发现延期防止失业的证据，反而发现它减少了向其他企业的重新配置。与模型一致，未获得延期的企业相对于获得延期支持的企业降低了工资，并且在劳动力市场单元中，较大的工资调整伴随着较小的就业损失。我们的发现表明，短时工作延期主要作为工资补贴而非就业保护措施运作。

【**NBER**】: NBER Working Paper No. 33112，https://www.nber.org/papers/w33112
...
【**摘要**】：我们利用来自五项跨国比较研究的数据，以及墨西哥一个国家的横截面和季度时间序列数据，考察了18个拉丁美洲国家年轻人的心理健康状况。我们检验了年轻人心理健康是否出现下降，如果是，这种下降是否像在美国和其他地方那样，消除了拉丁美洲幸福感的U形曲线和不幸福感的驼峰形曲线。在全球心智数据中，年轻人的心理健康状况比老年群体更差。墨西哥的恩比亚雷调查表明，年轻人幸福感的下降改变了该国（不）幸福感的年龄分布。经合组织国际学生评估项目数据显示，拉丁美洲学龄儿童的心理健康状况下降，并且心理健康问题在那些早期接触或过度使用数字设备的人群中更为突出。然而，在盖洛普世界民意调查和拉丁美洲晴雨表中，年轻人仍然比老年群体更幸福，尽管在一些拉丁美洲国家年轻人的幸福感有所下降。我们推测了不同调查之间趋势可能存在差异的原因。

【**NBER**】: NBER Working Paper No. 33111，https://www.nber.org/papers/w33111
...
【**摘要**】：我们通过计算美国企业部门的“碳负担”——其未来碳排放社会成本的现值——来量化其未来的碳损害。我们的基线估计显示，碳负担占企业总股权价值的131%。即使排除间接排放，仍有13%的企业的碳负担超过其市值。前30大排放企业占据了美国企业到2050年预测的所有脱碳量。预测的减排量，甚至企业的目标，都未能达到《巴黎协定》的要求。碳负担已被定价：碳负担较高的企业具有更高的资本成本，即使在控制过去排放的情况下也是如此。

【**NBER**】: NBER Working Paper No. 33110，https://www.nber.org/papers/w33110

#### 109. The Complexity of Economic Decisions {#33109}

【**Author**】: Xavier Gabaix, Thomas Graeber
...
【**摘要**】：我们提出了一种关于经济决策复杂性的理论。利用生产函数的宏观经济框架，我们将心智概念化为一个认知经济体，其中任务的复杂性由其认知操作的构成决定。复杂性表现为思考一项任务的全要素生产率的倒数。它随着重要性加权组成部分的数量增加而增加，并随着一个或少数几个组成部分对最优行动的影响占主导地位的程度增加而减少。更高的复杂性会产生更大的决策错误和对问题参数变化的行为衰减。该模型适用于连续选择和离散选择。我们开发了一种理论指导的实验方法，用于测量复杂性的主观感知，该方法简单且可移植。一系列实验检验并证实了我们模型关于复杂性感知、行为衰减和决策错误的核心预测。我们提供了一个将该框架应用于核心经济决策领域的模板，然后开发了几个应用，包括具有一个或多个相互作用商品的静态消费选择、跨期消费、税收体系、预测以及商品之间的离散选择的复杂性。

【**NBER**】: NBER Working Paper No. 33109，https://www.nber.org/papers/w33109

#### 110. Gambling Away Stability: Sports Betting’s Impact on Vulnerable Households {#33108}

【**Author**】: Scott R. Baker, Justin Balthrop, Mark J. Johnson, Jason D. Kotter, Kevin Pisciotta
...
【**摘要**】：我们利用家庭交易数据和交错双重差分框架，估计了在线体育博彩对家庭投资、支出和债务管理决策的因果效应。在合法化之后，体育博彩迅速蔓延，参与者和下注频率都随时间增加。这种增加并未取代其他赌博或消费，但显著减少了储蓄，因为风险赌注挤出了正期望值的投资。这些影响集中在财务受限的家庭中，表现为信用卡债务增加、可用信贷减少以及透支频率上升。我们的发现凸显了在线体育博彩对弱势家庭的潜在不利影响。

【**NBER**】: NBER Working Paper No. 33108，https://www.nber.org/papers/w33108

#### 111. Information Discovery for Industrial Policy {#33107}

【**Author**】: Michael Sockin, Wei Xiong
...
【**摘要**】：在产业政策日益受到关注的背景下，我们构建了一个模型，探讨市场驱动的信息发现与政策制定者职业激励之间的张力。虽然基于市场的信息发现有助于解决政策制定者面临的信息障碍，但职业激励可能促使他们积极推行议程以展示政治能力，从而将动态转向以政府为中心的均衡。在这种均衡中，市场参与者更关注政策相关信息而非行业基本面，削弱了市场在信息发现中的作用，并降低了政策效率。我们的分析强调了官僚摩擦和市场驱动的信息发现在共同塑造产业政策实施有效性方面的重要性。

【**NBER**】: NBER Working Paper No. 33107，https://www.nber.org/papers/w33107

#### 112. Current Account Dynamics and the Saving-Investment Nexus In a Changing and Uncertain World {#33106}

【**Author**】: Menzie D. Chinn, Hiro Ito
...
【**摘要**】：我们重新审视了经常账户余额的决定因素以及储蓄-投资关系，重点关注新兴市场和发展中经济体。我们正处在一个新时代，不仅面临经济挑战，还面临其他非经济挑战，如全球气候变化、日益增多的自然灾害和战争。我们需要重新审视经常账户余额以及国民储蓄和投资的决定因素。我们首先采用事件研究方法，考察这些变量在战争、自然灾害和大流行之后的历史演变。其次是关于经常账户余额、国民储蓄和投资的跨国面板研究。在全球金融不稳定的情况下，新兴市场和发展中经济体由于投资下降，经常账户余额往往改善。油价上涨同时增加了国民储蓄和投资，但投资的变化大于国民储蓄的变化，从而恶化了经常账户余额。美联储的紧缩性货币政策倾向于降低国民储蓄和投资，但对经常账户余额的影响在统计上不显著。一个国家经历战争的频率越高，其经常账户余额平均而言往往改善。当发生气候或地理灾害时，其经常账户余额、国民储蓄和投资往往改善。美国货币政策不确定性水平的上升导致经常账户余额改善，这主要是由于投资下降。

【**NBER**】: NBER Working Paper No. 33106，https://www.nber.org/papers/w33106

#### 113. Using Policy and Innovation to Improve Life-Saving Access to Naloxone {#33105}

【**Author**】: Evan D. Peet, David Powell, Rosalie Liccardo Pacula
...
【**摘要**】：纳洛酮是一种有助于逆转阿片类药物过量影响的救命药物。改善纳洛酮的可及性是联邦政府应对美国日益恶化的阿片类药物危机的核心支柱。现有研究评估了各州纳洛酮获取法律的效果，包括那些允许药房直接向消费者配发纳洛酮的法律。然而，这些文献忽略了像Narcan这样的药物创新的作用。Narcan于2016年2月上市，是一种纳洛酮鼻喷雾剂，允许非专业人士无需培训即可成功施用该药物。我们首先检验了在Narcan出现之前，仅凭纳洛酮获取法律就增加了纳洛酮分发的假设，随后检验了Narcan的引入进一步扩大了纳洛酮分发及其救命效果的假设。我们分析了各州在采纳纳洛酮获取法律方面的差异及其相对于Narcan引入的时间安排。我们发现，在Narcan引入后，那些允许药剂师向消费者配发纳洛酮的州，其纳洛酮配发量显著增加，其效果远超法律本身的独立效应。我们还发现，虽然这些纳洛酮获取法律本身并未降低非合成阿片类药物相关的死亡率，但一旦Narcan被引入，这些死亡率显著下降。这些发现表明了创新与政策的重要相互作用。

【**NBER**】: NBER Working Paper No. 33105，https://www.nber.org/papers/w33105

#### 114. Unwarranted Disparity in High-Stakes Decisions: Race Measurement and Policy Responses {#33104}

【**Author**】: E. Jason Baron, Joseph J. Doyle Jr., Natalia Emanuel, Peter Hull, Joseph P. Ryan
...
【**摘要**】：关于种族歧视的研究通常以内生的种族测量指标或可能本身受歧视影响的早期决策为条件。我们开发了准实验工具，用于估计种族错误分类对不当差异测量指标的影响，以及设计针对不当差异的政策回应，这些政策回应需考虑早期决策中的歧视。我们将这些工具应用于儿童保护服务（CPS）的背景下，在该背景下，先前的研究发现，与未来虐待风险相同的白人儿童相比，黑人儿童被安置到寄养机构的比率更高。CPS调查员相对于儿童自我报告的种族，错误分类了8-9%的黑人和白人儿童，这种错误分类掩盖了大约24%的寄养安置决策中的不当差异。使用算法建议来消除安置率中总不当差异的政策，也显著受到CPS呼叫筛查中早期歧视的影响。

【**NBER**】: NBER Working Paper No. 33104，https://www.nber.org/papers/w33104

#### 115. The ECB’s Climate Activities and Public Trust {#33103}

【**Author**】: Sandra Eickmeier, Luba Petersen
...
【**摘要**】：随着包括欧洲央行（ECB）在内的中央银行承担与气候相关的责任，评估公众支持变得至关重要。基于2023年6月的德国央行家庭调查，我们发现69%的家庭报告称，由于欧洲央行的气候行动，他们对欧洲央行的信任度有所提高，他们看重该机构更广泛的职责范围和关切。虽然17%和20%的家庭对价格稳定或独立性面临的风险表示担忧，但23%的家庭认为气候参与强化了欧洲央行的核心目标。一项信息干预表明，对家庭通胀预期的影响微乎其微，这表明机构信任与通胀前景之间存在脱节。一项内部调查显示，央行官员准确评估了信任影响，但倾向于高估对通胀预期的影响。总体而言，我们的研究结果表明公众广泛支持欧洲央行的气候倡议。

【**NBER**】: NBER Working Paper No. 33103，https://www.nber.org/papers/w33103

#### 116. Deficits and Inflation: HANK meets FTPL {#33102}

【**Author**】: George-Marios Angeletos, Chen Lian, Christian K. Wolf

【**Abstract**】: In the Fiscal Theory of the Price Level (FTPL), households are Ricardian, so fiscal deficits drive output and inflation only under hard-to-test assumptions about which policy authority is “active” or “dominant.” In the Heterogeneous Agent New Keynesian (HANK) paradigm, households are instead non-Ricardian, so deficits drive aggregate demand, and thereby also inflation, through classical wealth or liquidity effects. Because of this difference, HANK is free of FTPL’s fragilities and controversies. Despite this difference, HANK actually reproduces FTPL’s core empirical predictions regarding the relation between deficits and inflation. This is true even for the most extreme FTPL scenario, where unfunded deficits are financed entirely by inflation-induced debt erosion. In practice, however, deficit-financed fiscal stimuli can help expand output and thus tax revenue, substituting for debt erosion and moderating the associated inflationary pressures.

【**摘要**】：在价格水平的财政理论（FTPL）中，家庭是李嘉图式的，因此财政赤字仅在关于哪个政策当局是“活跃”或“主导”的难以检验的假设下才驱动产出和通胀。在异质性代理人新凯恩斯（HANK）范式中，家庭反而是非李嘉图式的，因此赤字通过经典的财富效应或流动性效应驱动总需求，从而也驱动通胀。由于这一差异，HANK模型摆脱了FTPL的脆弱性和争议。尽管存在这种差异，HANK模型实际上再现了FTPL关于赤字与通胀之间关系的核心经验预测。即使对于最极端的FTPL情景——即无资金支持的赤字完全由通胀引发的债务侵蚀来融资——也是如此。然而，在实践中，赤字融资的财政刺激有助于扩大产出，从而增加税收收入，这可以替代债务侵蚀并缓和相关的通胀压力。

【**NBER**】: NBER Working Paper No. 33102，https://www.nber.org/papers/w33102

#### 117. Unbalanced Trade: Is Growing Dispersion from Financial or Trade Reforms? {#33101}

【**Author**】: George A. Alessandria, Yan Bai, Soo Kyung Woo
...
【**摘要**】：我们研究了1970年至2019年间国际收支失衡和总体贸易大幅同步增长的原因。我们表明，这两个显著特征——国际贸易净额和总额的上升——在很大程度上是期内贸易壁垒减少的结果，而非跨期贸易摩擦大幅减少或商业周期不对称性加剧的结果。除了解释总贸易和净贸易分布的变化外，期内贸易摩擦的下降与其他关键宏观经济时间序列（包括实际汇率、贸易条件、进出口比率、相对支出和相对GDP）在国家间分散性的下降是一致的。

【**NBER**】: NBER Working Paper No. 33101，https://www.nber.org/papers/w33101

#### 118. Did Tariffs Make American Manufacturing Great? New Evidence from the Gilded Age {#33100}

【**Author**】: Alexander Klein, Christopher M. Meissner
...
【**摘要**】：我们研究了1870年至1909年间美国制造业关税与劳动生产率之间的关系。使用高度细化的关税数据、制造业部门的州-行业数据以及工具变量策略，结果表明关税降低了劳动生产率。关税通常也降低了行业内企业的平均规模，但提高了产出价格、增加值、总产出、就业和企业数量。我们还发现，在不同行业组别中，关税与增加值、总产出、就业和企业数量之间的关联存在异质性证据。我们得出结论，关税可能通过削弱进口竞争以及诱导规模更小、生产率更低的本土企业进入，从而降低了制造业的劳动生产率。我们的研究还揭示，强大且高生产率的行业可能进行了游说活动。该时代的高关税不太可能帮助美国成为具有全球竞争力的制造商。

【**NBER**】: NBER Working Paper No. 33100，https://www.nber.org/papers/w33100

#### 119. The GDPR and SDK Usage In Android Mobile Apps {#33099}

【**Author**】: Ginger Zhe Jin, Ziqiao Liu, Liad Wagman
...
【**摘要**】：利用软件开发工具包（SDK）的数据，我们研究了安卓应用中的SDK使用情况与欧盟于2018年5月采纳《通用数据保护条例》（GDPR）之间的关系。相对于仅在美国上线的应用，在GDPR之后，仅在欧盟五国（EU5）上线的应用中每个应用使用的非谷歌SDK数量下降了1.3%，而在美国和欧盟五国同时上线的应用中则下降了6.3%。这些效应主要由排名较低的应用驱动。以应用的月活跃用户为权重，计算应用类别和国家组中用户对SDK的平均暴露程度，我们发现，相对于仅在美国上线的应用，仅在欧盟五国上线的应用中用户对SDK的平均暴露程度没有显著变化。在同时上线的应用中，唯一显著的变化是用户对小型SDK提供商开发的SDK的暴露程度下降了4.2%，尽管来自谷歌和主要SDK提供商的SDK被独立评估为比来自小型SDK提供商的SDK风险更高。

【**NBER**】: NBER Working Paper No. 33099，https://www.nber.org/papers/w33099

#### 120. The China Shock Revisited: Job Reallocation and Industry Switching in U.S. Labor Markets {#33098}

【**Author**】: Nicholas Bloom, Kyle Handley, André Kurmann, Philip A. Luck
...
【**摘要**】：利用美国人口普查局的机密行政数据，我们重新审视了中国进口渗透率上升如何重塑美国地方劳动力市场。受中国冲击影响更大的地方劳动力市场经历了从制造业岗位向服务业岗位更大的再配置。这种再配置大部分发生在同时收缩制造业运营并扩大服务业就业的企业内部。值得注意的是，约40%的制造业岗位损失效应是由于持续经营的企业将其主要活动从制造业转向贸易相关服务业（如研究、管理和批发）所致。中国进口渗透率的影响因地方劳动力市场特征而异。在人力资本高的地区，包括西海岸大部分地区和大城市，从制造业到服务业的就业再配置规模巨大。在人力资本低且初始制造业份额高的地区，包括中西部和南部大部分地区，我们发现就业再配置有限。我们估计，对中国冲击的这种差异化反应解释了1997年至2007年间这些地区之间就业增长差距的一半。

【**NBER**】: NBER Working Paper No. 33098，https://www.nber.org/papers/w33098

#### 121. Everyone Steps Back? The Widespread Retraction of Crowd-Funding Support for Minority Creators when Migration Fear is High {#33097}

【**Author**】: John (Jianqiu) Bai, William R. Kerr, Chi Wan, Alptug Y. Yorulmaz
...
【**摘要**】：我们研究了2009年至2021年间Kickstarter上多个族裔群体的资金缺口。通过扩展种族显著事件的概念，我们量化了少数族裔在众筹中的资金缺口与围绕移民的激烈政治言论之间的紧密联动关系。与基线相比，在政治言论最激烈的时期，少数族裔的资金缺口增加了一倍以上。对于西班牙裔创作者而言，结果尤为严重。通常，来自远方、主要是白人的支持者对于项目达到关键资金支持门槛至关重要。在紧张时期，对少数族裔创作者的支持撤回在空间上也是普遍的，在自由派城市和保守派城市中同样存在。

【**NBER**】: NBER Working Paper No. 33097，https://www.nber.org/papers/w33097

#### 122. Willingness-To-Pay vs Administrative Hurdles: Understanding Barriers to Social Insurance Enrollment in Thailand {#33096}

【**Author**】: Benjamin A. Olken, Rema Hanna, Phitawat Poonpolkul, Nada Wasi
...
【**摘要**】：许多政府社会保险政策的参保率较低。为了理解这是由于行政障碍、信息问题还是对保险的低估值，我们研究了泰国一项不寻常的政策实验，该实验为选定省份的非正规工人提供一笔非常大的一次性激励，以鼓励他们加入自愿性的工人社会保险计划。利用行政数据，我们发现，临时参保激励在短短几个月内将覆盖率提高了67个百分点——从非正规工人的6%提高到73%。然而，12个月后，这些新参保者中只有13%仍留在该计划中，远低于没有激励而加入者的留存率。通过利用新参保者在保险层级间的选择来反推其揭示的保险估值，我们发现，那些因激励而参保的人对保险的估值低于那些没有激励而参保的人。综合来看，结果表明，社会保险参保率低可能是由于事前对保险的估值低，而非行政障碍。

【**NBER**】: NBER Working Paper No. 33096，https://www.nber.org/papers/w33096

#### 123. Revisiting Stock Market Signals as a Lens for Patent Valuation {#33056}

【**Author**】: Ashish Arora, Sharon Belenzon, Elia Ferracuti, Jay Prakash Nagar
...
【**摘要**】：估算专利的私人价值很重要，但也具有挑战性。Kogan、Papanikolaou、Seru和Stoffman（2017）（KPSS）通过开发一种基于股票市场回报的方法来估算单个专利价值，为新的研究开辟了途径。我们刻画了KPSS中的测量误差——真实专利价值与相应KPSS估计值之间的差异——并表明它与真实专利价值呈负相关。然后，我们研究了KPSS估计值在两种不同应用中的使用。首先，我们表明，使用KPSS值来衡量不同专利组之间的价值差异在内部是不一致的，并引入了衰减偏差。我们提供了两种解决方案：扩展原始的KPSS方法以允许专利来自两个不同的价值分布，以及使用异常股票市场回报。我们在与组织学者相关的几个背景下比较了这两种方法与原始KPSS估计值，例如大型和小型团队的专利、科学和非科学专利、离岸和国内发明的专利。其次，我们表明，当KPSS用作解释变量时，它们会产生无偏估计。这些分析使我们能够刻画每种方法的主要权衡，并为研究人员提供实用指导。

【**NBER**】: NBER Working Paper No. 33056，https://www.nber.org/papers/w33056
