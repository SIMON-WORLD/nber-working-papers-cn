# 【前沿文献】NBER工作论文 2026年5月合集 目录与摘要

> 2026 年 5 月 NBER 更新 127 篇工作论文，其中涉及中国相关研究的有 4 篇（9、16、112、123）。具体如下：[#35281]()（第 9 篇，大学平权行动与学生成果：剂量问题）；[#35274]()（第 16 篇，多产品生产中的要素偏向与异质性产出质量，研究中国台湾）；[#35178]()（第 112 篇，盈余管理与价格信息含量）；[#35167]()（第 123 篇，低工资离岸外包对创新的负面影响，研究加拿大企业创新但把中国作为作为冲击来源）。
>
> 每篇文章均附工作论文编号和官网链接，需要的朋友可以浏览器下载。

## 一、目录速览

1. **What do news readers want? {#35289}**新闻读者想要什么？`<font color=grey>`Gregory J. Martin, Shoshana Vasserman, Cameron Pfiffer `</font>`
2. **Water Works: Causes and Consequences of Safe Drinking Water in America {#35288}**水的作用：美国安全饮用水的原因与后果 `<font color=grey>`David A. Keiser, Bhashkar Mazumder, David Molitor, Joseph S. Shapiro `</font>`
3. **The U.S. Civil War's Impact on Women's Work and Political Participation {#35287}**美国内战对女性工作与政治参与的影响 `<font color=grey>`Madison K. Arnsbarger, Andreas Ferrara, Paige Montrose `</font>`
4. **Beliefs and Stock Market Fluctuations: New Evidence from the Past Seven Decades {#35286}**信念与股市波动：来自过去七十年的新证据 `<font color=grey>`David Thesmar, Emil Verner `</font>`
5. **Does the Import Invasion Explain the Mysterious Disappearance of Productivity Growth in U.S. Manufacturing? {#35285}**进口入侵是否解释了美国制造业生产率增长的离奇消失？`<font color=grey>`Robert J. Gordon, Kenneth Ryu `</font>`
6. **Optimal Long-Term Care Provision and Insurance with Heterogeneous Preferences and Risks {#35284}**具有异质性偏好和风险的最优长期护理提供与保险 `<font color=grey>`Nicholas-James Clavet, Pierre-Carl Michaud, Julien Navaux `</font>`
7. **AI for Structural Estimation {#35283}**用于结构估计的人工智能 `<font color=grey>`Victor Duarte, Julia Fonseca `</font>`
8. **Insurer Risk and Public Risk-Sharing: Quantifying the Value of Reinsurance {#35282}**保险公司风险与公共风险分担：量化再保险的价值 `<font color=grey>`Paul H.S. Kim, Anran Li `</font>`
9. **College Affirmative Action and Students' Outcomes: A Matter of the Dose {#35281}**大学平权行动与学生成果：剂量问题 `<font color=grey>`Yi Chen, Chao Fu, Hongbin Li, Teng Li, Siyan Tang `</font>`
10. **Medicare Home Health Fraud: How Much, Where, and Who? {#35280}**医疗保险家庭健康欺诈：程度、地点与实施者 `<font color=grey>`Liran Einav, Amy Finkelstein, Yunan Ji, Neale Mahoney, Gideon Moore `</font>`
11. **Non-User Externalities {#35279}**非用户外部性 `<font color=grey>`Leonardo Bursztyn, Jan Fasnacht, Benjamin R. Handel, Rafael Jiménez-Durán, Aaron Leonard, Filip Milojević, Christopher Roth, Cass R. Sunstein `</font>`
12. **An Ethical Pollution Tax {#35278}**一种伦理污染税 `<font color=grey>`Garth Heutel `</font>`
13. **Deadly Stigma {#35277}**致命污名 `<font color=grey>`Manasvini Singh `</font>`
14. **The AGI Race and Existential Risk {#35276}**通用人工智能竞赛与生存风险 `<font color=grey>`Ethan Bueno de Mesquita, Wioletta Dziuda, Mattias Polborn `</font>`
15. **Writing Code vs. Shipping Code: Productivity Effects Across Generations of AI Coding Tools {#35275}**编写代码与交付代码：AI编码工具各代际的生产率效应 `<font color=grey>`Mert Demirer, Leon Musolff, Liyuan Yang `</font>`
16. **Factor Bias and Heterogeneous Output Quality in Multiproduct Production {#35274}**多产品生产中的要素偏向与异质性产出质量 `<font color=grey>`Yi Lee, Shengyu Li, Mark J. Roberts `</font>`
17. **The Growth and Performance of Artificial Intelligence in Asset Management {#35273}**资产管理中人工智能的增长与表现 `<font color=grey>`Shuang Chen, Clemens Sialm, David X. Xu `</font>`
18. **Geopolitical Fragmentation, Sovereign Debt, and Dollar Dominance {#35272}**地缘政治碎片化、主权债务与美元主导地位 `<font color=grey>`Felipe Benguria, Eugenio I. Rojas, Felipe Saffie `</font>`
19. **Beyond Exposure: Predicting AI Adoption Based on Comparative Advantage {#35271}**超越暴露度：基于比较优势预测人工智能采用 `<font color=grey>`Ilse Lindenlaub, Ryungha Oh, Maria Alejandra Rodriguez, Laura Veldkamp `</font>`
20. **Dust in the Wind: The Health Costs of Great Salt Lake Desiccation {#35270}**风中之尘：大盐湖干涸的健康成本 `<font color=grey>`Lena Harris, Eric C. Edwards, Danae Hernandez-Cortes `</font>`
21. **Frontier Knowledge in College and Student Success {#35269}**大学前沿知识与学生成功 `<font color=grey>`Barbara Biasi, Song Ma `</font>`
22. **An Unfunded Mandate? Medicaid Continuous Coverage Requirements and State Fiscal Burdens During COVID-19 {#35268}**一项无资金支持的指令？新冠疫情期间医疗补助持续覆盖要求与州财政负担 `<font color=grey>`Jeffrey Clemens, Anwita Mahajan `</font>`
23. **Persistent Effects of Early Academic Rank on Cognitive and Noncognitive Outcomes {#35267}**早期学业排名对认知与非认知结果的持续影响 `<font color=grey>`Eunsik Chang, María Padilla-Romo, Cecilia Peluffo `</font>`
24. **The Missing Value of Data {#35266}**缺失的数据价值 `<font color=grey>`Ankit Bhutani, Guillermo Ordoñez, Laura Veldkamp `</font>`
25. **Off the Labor Supply Curve: The Zero Employer Size Wage Effect Within Large Firms {#35265}**脱离劳动力供给曲线：大型企业内部零雇主规模工资效应 `<font color=grey>`André Diegmann, Steffen Müller, Benjamin Schoefer `</font>`
26. **Where There’s Smoke: Stochastic Caregiving Shocks and Mothers’ Labor Market Outcomes {#35264}**有烟之处：随机照料冲击与母亲的劳动力市场结果 `<font color=grey>`Joshua S. Graff Zivin, Seunghoon Lee `</font>`
27. **How Efficient was the Affordable Care Act at Reducing Uninsured Rates? {#35263}**《平价医疗法案》在降低无保险率方面的效率如何？`<font color=grey>`Anuj Gangopadhyaya, Robert Kaestner `</font>`
28. **How Much and How Fast Do Investors Respond to Equity Premium Changes? Evidence from Wealth Taxation {#35262}**投资者对股权溢价变化的反应程度和速度有多快？来自财富税的证据 `<font color=grey>`Andreas Fagereng, Luigi Guiso, Marius A. K. Ring `</font>`
29. **Startups in Africa {#35261}**非洲的初创企业 `<font color=grey>`Emanuele Colonnelli, Marcio Cruz, Mariana Pereira-Lopez, Tommaso Porzio, Chun Zhao `</font>`
30. **The Risk-free Rate and the Risk-adjusted Growth Rate {#35260}**无风险利率与风险调整后的增长率 `<font color=grey>`Stavros Panageas `</font>`
31. **A Bayesian Critic for Frequentist Procedures {#35259}**频率学派方法的贝叶斯批评者 `<font color=grey>`Isaiah Andrews, Simon C. Essig Aberg, Jesse M. Shapiro `</font>`
32. **Towards a Methodology for Measuring Rental Property Ownership in the United States {#35258}**迈向衡量美国租赁房产所有权的方法论 `<font color=grey>`Stephanie Kestelman, Rebecca Diamond, John Eric Humphries, Kate Pennington, Winnie van Dijk, John L. Voorheis `</font>`
33. **The Federal Government's Discretionary Spending {#35257}**联邦政府的可自由支配支出 `<font color=grey>`Karen Dynan, Douglas Elmendorf, Theresa Gullo `</font>`
34. **Housing Capital and Intergenerational Mobility in the United States {#35256}**美国的住房资本与代际流动性 `<font color=grey>`Ariel J. Binder, Max Risch, John L. Voorheis `</font>`
35. **Deep-Tech Innovation: A Multi-Method Study toward a Conceptual Framework and Research Agenda {#35255}**深度技术创新：迈向概念框架与研究议程的多方法研究 `<font color=grey>`Johann Kortsch, Stefan Raff-Heinen, David Bendig, Martin Murmann, Colin Schulz, Fiona Murray `</font>`
36. **Defining Innovatisation: The Case of NewSpace and the Changing Space Sector {#35254}**定义“创新化”：以新航天与不断变化的航天部门为例 `<font color=grey>`Benoit Cornet, Marc-André Chavy-Macdonald, Dominique Foray `</font>`
37. **The Sisyphean Pursuit of Evidence for Poverty Traps {#35253}**为贫困陷阱寻找证据的西西弗斯式追求 `<font color=grey>`Dean Karlan, Amol Singh Raswan, Christopher R. Udry `</font>`
38. **Distribution Costs {#35252}**分销成本 `<font color=grey>`Cian Ruane, Alessandra Peter `</font>`
39. **The Word Is Not Enough: Testing the Effects of Information Treatments on Perceived Corruption in Ukraine {#35251}**仅凭言语是不够的：检验信息干预对乌克兰腐败感知的影响 `<font color=grey>`Yuriy Gorodnichenko, Ilona Sologoub, Yuriy Fedyk `</font>`
40. **Nonresponse Imputations and Related Measurement Issues in the CPI for Shelter {#35250}**住房CPI中的无应答插补及相关测量问题 `<font color=grey>`Lara Loewenstein, Hugh G. Montag, Randal Verbrugge `</font>`
41. **The Price of Protection: Tariff Incidence and Import Collapse under the Infamous Smoot-Hawley Tariff {#35249}**保护的价格：臭名昭著的斯穆特-霍利关税下的关税归宿与进口崩溃 `<font color=grey>`Kris James Mitchener, Mathieu Pedemonte `</font>`
42. **Electoral Incentives and Government Transparency: Evidence from Freedom of Information Requests {#35248}**选举激励与政府透明度：来自信息自由请求的证据 `<font color=grey>`Raymond Fisman, Aron Malatinszky, Eyub Yegen `</font>`
43. **Scaling Point-in-Time Language Models {#35247}**扩展时点语言模型 `<font color=grey>`Bryan T. Kelly, Semyon Malamud, Johannes Schwab, Teng Andrea Xu `</font>`
44. **Complex Modern Portfolio Theory {#35246}**复杂现代投资组合理论 `<font color=grey>`Oliver Hellum, Theis I. Jensen, Bryan T. Kelly, Semyon Malamud `</font>`
45. **How Much Has Shale Gas Saved U.S. Consumers? {#35245}**页岩气为美国消费者节省了多少钱？`<font color=grey>`Lucas W. Davis `</font>`
46. **Will The University Endowment Tax Slow Scientific Progress? Evidence from Elite Economics PhD Programs {#35244}**大学捐赠税会减缓科学进步吗？来自精英经济学博士项目的证据 `<font color=grey>`Joshua Angrist, Marc Diederichs, Glenn Ellison `</font>`
47. **A Tale of Two Market Returns: The Broad Market Factor and The Idiosyncratic Financial Factor {#35243}**两种市场回报的故事：广泛市场因子与特质金融因子 `<font color=grey>`Sung Je Byun, Johnathan Loudis, Lawrence D.W. Schmidt `</font>`
48. **Comparative Advantage and Openness under Global Fragmentation: Lessons from the Past 65 Years {#35242}**全球碎片化下的比较优势与开放：过去65年的教训 `<font color=grey>`Joshua Aizenman, Hiro Ito, Jamel Saadaoui `</font>`
49. **From People’s War to People’s Rule: Rebel Governance and the Foundations of Inclusive Democracy {#35241}**从人民战争到人民统治：叛乱治理与包容性民主的基础 `<font color=grey>`Bhishma Bhusal, Michael Callen, Rohini Pande, Soledad A. Prillaman, Deepak Singhania, Apurva Subedi `</font>`
50. **Preference for Explainable AI {#35240}**对可解释人工智能的偏好 `<font color=grey>`Alex Chan `</font>`
51. **The Heterogeneous Bank Lending Channel of Monetary Policy {#35239}**货币政策异质性银行信贷渠道 `<font color=grey>`Jorge Abad, Saki Bigio, Salomon Garcia-Villegas, Joël Marbet, Galo Nuño `</font>`
52. **The Human Capital Production Function: New Estimates and Implications for Labor Supply and Taxes {#35238}**人力资本生产函数：新估计及其对劳动供给和税收的含义 `<font color=grey>`Han Gao, Michael P. Keane, Kaja Kierulf, Alan Woodland `</font>`
53. **Unlocking Mortgage Lock-In: Equilibrium Effects in a Spatial Housing Ladder Model {#35237}**解锁抵押贷款锁定效应：空间住房阶梯模型中的均衡效应 `<font color=grey>`Julia Fonseca, Lu Liu, Pierre Mabille `</font>`
54. **Firm-Worker Matches: Experience or Inspection Goods? {#35236}**企业-工人匹配：体验品还是检验品？`<font color=grey>`Victoria Gregory, Guido Menzio, Giovanni M. Topa `</font>`
55. **Cheapflation Cycles {#35235}**廉价通胀周期 `<font color=grey>`Kunal Sangani `</font>`
56. **Attorney Value-Added and Racial Disparities in the Criminal Justice System {#35234}**律师增值与刑事司法系统中的种族差异 `<font color=grey>`Maya Mikdash, Mark Hoekstra, Suhyeon Oh `</font>`
57. **The Educational Impacts of School Phone Bans: Evidence from Brazil {#35233}**校园手机禁令的教育影响：来自巴西的证据 `<font color=grey>`Guilherme Lichand, Luca Moreno-Louzada, Thiago da Costa, Matthew Gentzkow `</font>`
58. **Designing More Informative Tests: Separating Execution from Recognition {#35232}**设计更具信息量的测试：将执行能力与识别能力分离 `<font color=grey>`Andrew Caplin, Leo Zhu `</font>`
59. **Has the United States Bent the Health Care Cost Curve? {#35231}**美国是否已经扭转了医疗成本曲线？`<font color=grey>`David M. Cutler, Lev R. Klarnet `</font>`
60. **The (Lack of) Efficacy of Social Belonging and Growth Mindset Interventions Among College Students {#35230}**社会归属感和成长心态干预对大学生效果的（缺乏）有效性 `<font color=grey>`Abid N. Alam, Philip Oreopoulos, Uros Petronijevic `</font>`
61. **The Limits of Targeted Hiring Subsidies: Evidence from the Work Opportunity Tax Credit {#35229}**定向雇佣补贴的局限性：来自工作机会税收抵免的证据 `<font color=grey>`Manisha Jain, Corina Mommaerts, Jeffrey Weaver `</font>`
62. **Industrial Concentration, Property Values, and Municipal Bond Spreads {#35228}**产业集中度、房产价值与市政债券利差 `<font color=grey>`Kenneth R. Ahern `</font>`
63. **The Optimal Use of AI in Financial Regulation {#35227}**人工智能在金融监管中的最优使用 `<font color=grey>`Christopher Clayton, Antonio Coppola `</font>`
64. **A Promise Worth Keeping? Impacts of Free Community College on Degrees and Earnings {#35226}**值得信守的承诺？免费社区大学对学位和收入的影响 `<font color=grey>`Paige Schoonover, Jonathon Attridge, Celeste K. Carruthers, Jilleah G. Welch `</font>`
65. **States as Financiers: International Lending in War and Peace {#35225}**国家作为金融家：战争与和平时期的国际借贷 `<font color=grey>`Sebastian Horn, Carmen M. Reinhart, Christoph Trebesch `</font>`
66. **Credit Supply, Firms, and Earnings Inequality {#35224}**信贷供给、企业与收入不平等 `<font color=grey>`Christian Moser, Farzad Saidi, Benjamin Wirth, Stefanie Wolter `</font>`
67. **Management of Health Care Facilities and Patient Attendance during Major Disruptions: Evidence from Kenya {#35223}**重大干扰期间医疗设施管理与患者就诊率：来自肯尼亚的证据 `<font color=grey>`Kathryn Andrews, Fabiano Dal-Ri, Roberta Gatti, Renata Lemos, Mario Macis, Lydia Nakhone `</font>`
68. **Explaining Movements in Government Debt {#35222}**解释政府债务的变动 `<font color=grey>`Tatiana Kirsanova, Eric M. Leeper, Campbell B. Leith, Ding Liu `</font>`
69. **Proposed Mergers Where Efficiencies Are Needed Most Might Be the Least Likely to Deliver Them {#35221}**最需要效率的拟议合并可能最不可能带来效率 `<font color=grey>`Robert D. Metcalfe, Alexandre B. Sollaci, Chad Syverson `</font>`
70. **Trust, Financial Literacy, and Financial Behaviors: Shaping Retirement Security {#35220}**信任、金融素养与金融行为：塑造退休保障 `<font color=grey>`Maya Haran Rosen, Annamaria Lusardi, Olivia S. Mitchell `</font>`
71. **Lands of Opportunity: Differences in the Geography of Wealth and Income Mobility in the United States {#35219}**机遇之地：美国财富与收入流动性的地理差异 `<font color=grey>`Ariel J. Binder, Max Risch, John L. Voorheis `</font>`
72. **California Billionaires: Wealth, Taxes, and Wealth Tax Revenue Estimates {#35218}**加州亿万富翁：财富、税收与财富税收入估算 `<font color=grey>`Jasper Boll, Emmanuel Saez, Gabriel Zucman `</font>`
73. **The Limits of Political Representation: Evidence from India {#35217}**政治代表性的局限：来自印度的证据 `<font color=grey>`Veda Narasimhan, Jeffrey Weaver `</font>`
74. **Divergence in Climate Change Communication: LLM-Based Evidence from the IPCC and the Press {#35216}**气候变化传播中的分歧：基于大语言模型的IPCC与媒体证据 `<font color=grey>`Sebastian Galiani, Franco Mettola La Giglia, Raul A. Sosa `</font>`
75. **Valuing Disaster Prevention: Desert Locust Monitoring and Control {#35215}**灾害预防的价值评估：沙漠蝗虫监测与控制 `<font color=grey>`Joséphine Gantois, Anouch Missirian, Evelina Linnros, Anna Tompsett, Amir Jina, Gordon C. McCord, Eyal G. Frank `</font>`
76. **The Psychology of Macroeconomic Expectations {#35214}**宏观经济预期的心理学 `<font color=grey>`Pedro Bordalo, Nicola Gennaioli, Florencio Lopez-de-Silanes, Simon G. Schröder, Andrei Shleifer, Maarten van Rooij `</font>`
77. **Sophisticated Borrowing Constraints and Macroeconomic Dynamics {#35213}**复杂的借贷约束与宏观经济动态 `<font color=grey>`Al-Mahdi Ebsim, Chen Lian, Yueran Ma, Pablo Ottonello, Diego J. Perez `</font>`
78. **Old Space, New Space: A Commercial Revolution in Innovation? {#35212}**旧太空，新太空：创新的商业革命？`<font color=grey>`Ruben Gaetani, Alexander T. Whalley `</font>`
79. **Endogenous Task Bundling, Skills and Automation {#35211}**内生任务捆绑、技能与自动化 `<font color=grey>`Joshua S. Gans `</font>`
80. **Medical Innovation and Racial Health Disparities: Evidence from a Breakthrough Treatment {#35210}**医学创新与种族健康差异：来自突破性治疗方法的证据 `<font color=grey>`D. Mark Anderson, Kerwin Kofi Charles, Daniel I. Rees `</font>`
81. **State Dependence of Monetary Policy During Global Supply Chain Disruptions {#35209}**全球供应链中断期间货币政策的路径依赖性 `<font color=grey>`Xiwen Bai, Jesús Fernández-Villaverde, Yiliang Li, Francesco Zanetti `</font>`
82. **Estimating the Present Value of R&D Tax Benefits in the United States {#35208}**估算美国研发税收优惠的现值 `<font color=grey>`Brandon Pecoraro, Nicholas C. Hoffman, Martin Lopez-Daneri, Elena C. Derby, Rachel Moore, Shannon E. Sledz `</font>`
83. **More Paths or More Contrast? A Theory of Experimentation Breadth {#35207}**更多路径还是更多对比？关于实验广度的理论 `<font color=grey>`Joshua S. Gans, Luca Gius `</font>`
84. **The Cost of Intermediary Market Power for Distressed Borrowers {#35206}**中介市场势力对困境借款人的成本 `<font color=grey>`Winston Wei Dou, Wei Wang, Wenyu Wang `</font>`
85. **Tatonnement and Price Setting in General Equilibrium {#35205}**一般均衡中的试探过程和价格设定 `<font color=grey>`Guido Lorenzoni, Iván Werning `</font>`
86. **Flood Risk, Insurance, and Housing in the United States {#35204}**美国的洪水风险、保险与住房 `<font color=grey>`Suvy Qin, John L. Voorheis `</font>`
87. **The Geography of Lifecycle Human Capital Accumulation {#35203}**生命周期人力资本积累的地理分布 `<font color=grey>`Ben Sprung-Keyser, Sonya Porter `</font>`
88. **Fiscal Policy and Transition Risk {#35202}**财政政策与转型风险 `<font color=grey>`Stefano Carattini, Garth Heutel, Givi Melkadze, Inès Mourelon `</font>`
89. **Intertemporal Arbitrage and Optimal Operation of Pumped Hydro Energy Storage {#35201}**抽水蓄能的时间套利与最优运营 `<font color=grey>`Isabel Figuerola-Ferretti, Eduardo S. Schwartz `</font>`
90. **Credibility and Precommitment in Socialist Constitutionalism {#35200}**社会主义宪政中的可信度与预先承诺 `<font color=grey>`Sebastian Edwards `</font>`
91. **How do Workers Learn? Theory and Evidence on the Roots of Lifecycle Human Capital Accumulation {#35199}**工人如何学习？生命周期人力资本积累根源的理论与证据 `<font color=grey>`Xiao Ma, Alejandro Nakab, Daniela Vidart `</font>`
92. **The Effects of GLP-1 Use on Mental Health, Self-rated Health, Employment and Marriage {#35198}**GLP-1药物使用对心理健康、自评健康、就业和婚姻的影响 `<font color=grey>`Robert Kaestner, Cuiping Schiman `</font>`
93. **Global Policy Spillovers: How Environmental Policies Propagate through Product Attributes {#35197}**全球政策溢出效应：环境政策如何通过产品属性传播 `<font color=grey>`Koichiro Ito, James M. Sallee, Jonathan (Andrew) Smith `</font>`
94. **Making Sense of Labor Market Indicators Amid Data Imperfections {#35196}**在数据不完美中解读劳动力市场指标 `<font color=grey>`Scott A. Brave, Erin E. Crust, Stefano Eusepi, Bart Hobijn, Ayşegül Şahin `</font>`
95. **AlphaPortfolio: Goal-Oriented Investment Management Through Deep Reinforcement Learning {#35195}**AlphaPortfolio：通过深度强化学习实现目标导向的投资管理 `<font color=grey>`Lin William Cong, Ke Tang, Jingyuan Wang `</font>`
96. **Data Centers and Local Economies in the Age of AI: A Shift--Share Approach {#35194}**人工智能时代的数据中心与地方经济：一种偏移-份额方法 `<font color=grey>`Fernando E. Alvarez, David Argente, Joyce Chow, Diana Van Patten `</font>`
97. **Mortality Rates by Race and Ethnicity Among People with Disabilities {#35193}**残疾人群体的种族与族裔死亡率差异 `<font color=grey>`Madeline S. Helfer, Becky Staiger, Jessica Van Parys `</font>`
98. **Algorithmic Credentialism {#35192}**算法证书主义 `<font color=grey>`Peter Q. Blair, Rui Guo `</font>`
99. **Organization Capital, Large Startups, and the Dearth of IPOs {#35191}**组织资本、大型初创企业与IPO匮乏 `<font color=grey>`Rüdiger Fahlenbrach, Leandro Sanz, René M. Stulz `</font>`
100. **The Long-Run Effects of the Affordable Care Act: Evidence from a Partially Pre-Committed Research Design Over the COVID-19 Recession and Recovery {#35190}**《平价医疗法案》的长期效应：来自COVID-19衰退与复苏期间部分预先承诺研究设计的证据 `<font color=grey>`Jeffrey Clemens, Anwita Mahajan, Joseph J. Sabia `</font>`
101. **Crimes Against Campbell-Shiller {#35189}**对坎贝尔-席勒的“犯罪”`<font color=grey>`Itzhak Ben-David, Alex Chinco `</font>`
102. **Deep Research on a Loop: Using AI Agents to Construct Economic Datasets {#35188}**循环深度研究：使用AI代理构建经济数据集 `<font color=grey>`Santiago Afonso, Sebastian Galiani, Ramiro H. Gálvez, Raul A. Sosa `</font>`
103. **Anti-Harassment Policy and the Startup Labor Market {#35187}**反骚扰政策与初创企业劳动力市场 `<font color=grey>`Jun Chen, Song Ma, Feng Zhang `</font>`
104. **AlphaGlass: Interpretable Characteristic-Based Portfolio Choice {#35186}**AlphaGlass：可解释的基于特征的投资组合选择 `<font color=grey>`Sebastian Bell, Ali Kakhbod, Martin Lettau, Abdolreza Nazemi `</font>`
105. **Revealing Life Preferences Through LLMs {#35185}**通过大语言模型揭示生活偏好 `<font color=grey>`Omar Abdel Haq, Amitabh Chandra, Tomáš Jagelka, Erzo F.P. Luttmer, Joshua Schwartzstein `</font>`
106. **Breaking the Early Bell: Lessons from the First Statewide Mandate on School Start Times {#35184}**打破早铃：首个全州范围上学时间强制令的经验教训 `<font color=grey>`Jialu (Gloria) Dou, Rania Gihleb, Osea Giuntella, Jakub Lonsky `</font>`
107. **What Does A Grade Mean? Informativeness and Strategic Manipulation of Grading Systems {#35183}**成绩意味着什么？评分系统的信息性和策略性操纵 `<font color=grey>`Joshua S. Gans, Scott Duke Kominers `</font>`
108. **Growth is Getting Harder to Find, Not Ideas {#35182}**增长越来越难找到，而非创意 `<font color=grey>`Teresa C. Fort, Nathan Goldschlag, Jack Liang, Peter K. Schott, Nikolas Zolas `</font>`
109. **Youth Mental Health and School Smartphone Bans: Early Evidence {#35181}**青少年心理健康与学校智能手机禁令：初步证据 `<font color=grey>`Henry Saffer `</font>`
110. **The Persistence of Power: How Family Origins Shape Political Representation and Policy {#35180}**权力的持久性：家庭出身如何塑造政治代表性和政策 `<font color=grey>`Eric Chyn, Katherine Cohen, Kareem Haggag, Bryan A. Stuart `</font>`
111. **Bachelors Without Bachelor's: Gender Gaps in Education and Declining Marriage Rates {#35179}**没有学士学位的单身汉：教育中的性别差距与下降的结婚率 `<font color=grey>`Clara Chambers, Benjamin Goldman, Joseph Winkelmann `</font>`
112. **Earnings Management and Price Informativeness {#35178}**盈余管理与价格信息含量 `<font color=grey>`Zhiguo He, Wenxi Jiang, Wei Xiong `</font>`
113. **Separations Revisited: Do Layoffs or Quits Drive Lower Separation Rates in High-Quality Firms? {#35177}**离职再审视：高质量企业较低的离职率是由解雇还是辞职驱动的？`<font color=grey>`Cauê Dobbin, Daniel Fernandez, Tom Zohar `</font>`
114. **Measuring Water Misallocation in California {#35176}**衡量加利福尼亚州的水资源错配 `<font color=grey>`Will Rafey `</font>`
115. **The Causal Effects of Expected Depreciations {#35175}**预期贬值的因果效应 `<font color=grey>`Martha Elena Delgado Rojas, Juan Herreño, Marc Hofstetter, Mathieu Pedemonte `</font>`
116. **Authority Figures and the Polarization of Gender Norms {#35174}**权威人物与性别规范的两极分化 `<font color=grey>`Ali Abboud, Samuel Bazzi, Serena Canaan, Antoine Deeb, Pierre Mouganie `</font>`
117. **How does Medicare Eligibility affect Choice and Utilization? Evidence from Veterans {#35173}**医疗保险资格如何影响选择与利用？来自退伍军人的证据 `<font color=grey>`Marion Aouad, Liam Rose, Todd Wagner `</font>`
118. **Competitive Exposure and Entrepreneurial Experimentation {#35172}**竞争暴露与创业实验 `<font color=grey>`Joshua S. Gans `</font>`
119. **Labor Market Effects of California’s $\$20$ Fast-Food Minimum Wage {#35171}**加州20美元快餐最低工资的劳动力市场效应 `<font color=grey>`Arindrajit Dube `</font>`
120. **Extreme Equilibria: The Benefits of Correlation {#35170}**极端均衡：相关性的益处 `<font color=grey>`Kirill Rudov, Fedor Sandomirskiy, Leeat Yariv `</font>`
121. **Opt In? Opt Out? {#35169}**选择加入？选择退出？`<font color=grey>`Alex Chan, Ayush Gupta, Yetong Xu `</font>`
122. **The Postpandemic U.S. Immigration Surge: New Facts and Inflationary Implications {#35168}**后疫情时代的美国移民潮：新事实与通胀影响 `<font color=grey>`Anton Cheremukhin, Sewon Hur, Ronald R. Mau, Karel Mertens, Alexander W. Richter, Xiaoqing Zhou `</font>`
123. **On the Negative Consequences of Low-Wage Offshoring for Innovation {#35167}**低工资离岸外包对创新的负面影响 `<font color=grey>`Wulong Gu, Alla Lileeva, Daniel Trefler `</font>`
124. **Interest Rate Caps, Competition, and Strategic Borrowing: Evidence from Kenya {#35166}**利率上限、竞争与策略性借贷：来自肯尼亚的证据 `<font color=grey>`Aroon Narayanan, Tavneet Suri, Prashant Bharadwaj `</font>`
125. **Health Inequalities Among Danish Retirees 2004-2022 {#35165}**2004-2022年丹麦退休人员的健康不平等 `<font color=grey>`Paul Bingley, Nabanita Datta Gupta, Malene Kallestrup-Lamb, Alexander O.K. Marin `</font>`
126. **How Should Central Banks Respond to Commodity Price Shocks? Optimal Monetary and Exchange Rate Frameworks for Commodity-Exposed Economies {#35164}**中央银行应如何应对大宗商品价格冲击？大宗商品暴露经济体的最优货币与汇率框架 `<font color=grey>`Thomas Drechsel, Michael McLeay, Silvana Tenreyro, Enrico D. Turri `</font>`
127. **Building Opportunity: The Intergenerational Effects of Chilean School Construction {#35042}**
     创造机会：智利学校建设的代际效应
     `<font color=grey>`Adrienne Lucas, Patrick McEwan `</font>`

## 二、摘要

`<font color=grey>`注：以下中文摘要为 AI 辅助翻译与校对，仅供学术交流，请以原文为准。`</font>`

#### 1. What do news readers want?

【**Author**】: Gregory J. Martin, Shoshana Vasserman, Cameron Pfiffer
...
【**摘要**】：利用一个涵盖2020年至2024年间美国某大都市报纸个体层面网络流量和数字订阅完整历史的新数据集，我们研究了消费者对不同类别新闻内容的支付意愿，特别关注那些被认为能产生公民外部性的报道类型。我们的识别策略依赖于付费墙事件的准随机出现，这些事件迫使消费者如果想继续阅读就必须订阅。利用这种变化，我们估计了一个消费者需求模型，并在不同的反事实收入模型下构建了报纸的最优员工配置：一个完全基于订阅的模型和一个完全由广告支持的模型。我们的结果表明，读者愿意为本地报道付费，并且仅基于时间使用的需求度量大大低估了关于地方政治和公共卫生等主题的“硬”新闻报道的价值。然而，即使在报纸收入最高的板块，仅靠数字订阅收入也不足以覆盖员工成本。我们利用模型来估算扩大报纸调查性报道生产所需的补贴。

【**NBER**】: NBER Working Paper No. 35289，https://www.nber.org/papers/w35289

#### 2. Water Works: Causes and Consequences of Safe Drinking Water in America

【**Author**】: David A. Keiser, Bhashkar Mazumder, David Molitor, Joseph S. Shapiro
...
【**摘要**】：自1974年《安全饮用水法》颁布以来，美国已花费2万亿美元来提供安全饮用水，然而仍有10%至20%的美国人的饮用水不符合标准。我们利用通过数十次《信息自由法》及相关请求从48个州获得的、涵盖数十年间1250种污染物的2.66亿条读数，研究了美国饮用水污染的趋势、原因和后果。我们将污染数据与关于美国老年人健康结果的行政医疗保险数据联系起来。三个发现浮现出来。首先，美国饮用水污染已迅速下降；从2003年到2019年，超过现行健康标准的读数比例下降了一半。未受监管的污染物下降得更慢。低收入地区的污染更高；黑人和西班牙裔社区的污染模式更为复杂。其次，《安全饮用水法》向供水系统提供的贷款减少了污染。按估计的平均贷款成本效益计算，这些贷款可以消除超过健康标准的污染，每人每年仅需46美元。第三，这些贷款降低了美国老年人的死亡率。尽管财政联邦制警告不要为像饮用水这样跨辖区外部性很少的地方公共产品提供联邦资金，但我们估计《安全饮用水法》贷款带来了巨大的收益。

【**NBER**】: NBER Working Paper No. 35288，https://www.nber.org/papers/w35288

#### 3. The U.S. Civil War's Impact on Women's Work and Political Participation

【**Author**】: Madison K. Arnsbarger, Andreas Ferrara, Paige Montrose
...
【**摘要**】：本文研究了通过劳动力市场的经济参与在促进弱势群体政治动员中的作用。具体而言，我们研究了美国内战后联邦军残疾士兵的妻子和女儿。将联邦军征兵记录与1860年和1870年美国人口普查联系起来，我们发现残疾退伍军人的妻子和女儿比非残疾退伍军人的妻子和女儿更有可能参与劳动力市场。历史证据表明，残疾退伍军人在战后也更易受到酒精和药物滥用的影响，增加了女性面临的家庭负担。城镇层面的数据显示，女性劳动力参与率的提高与残疾退伍军人比例的增加相结合，预示着1873-74年间会有更多的禁酒运动活动。通过报纸提供信息以及靠近其他抗议城镇放大了这些效应。使用单位层面的残疾率作为退伍军人残疾状况的工具变量，支持了劳动力市场效应的因果解释。我们的结果表明，劳动力参与可以成为弱势群体政治动员的重要促进因素。

【**NBER**】: NBER Working Paper No. 35287，https://www.nber.org/papers/w35287

#### 4. Beliefs and Stock Market Fluctuations: New Evidence from the Past Seven Decades

【**Author**】: David Thesmar, Emil Verner
...
【**摘要**】：我们从一个独立的股票分析公司构建了一个新的长期主观预期股票收益率序列，时间跨度为1956年至2024年。这些预期收益率与盈利价格比呈强正相关，对过去收益率呈负反应，并能预测未来收益率。这些模式与个人投资者和专业预测者的主观预期形成对比，后两者与我们的新指标呈弱相关或负相关。成熟投资者与个人投资者之间的分歧与更高的交易量相关。我们的发现与一个异质性信念模型一致，在该模型中，天真的投资者会外推过去的收益率，而不是过去的股息，而成熟的投资者则接近理性。

【**NBER**】: NBER Working Paper No. 35286，https://www.nber.org/papers/w35286

#### 5. Does the Import Invasion Explain the Mysterious Disappearance of Productivity Growth in U.S. Manufacturing?

【**Author**】: Robert J. Gordon, Kenneth Ryu
...
【**摘要**】：为什么美国制造业生产率在2010年后停止增长？生产率增长消失了，从1987年至2010年间每年3.3%的增长率蒸发为2010年至2023年间的-0.3%。本文将注意力从2010年这个谜题开始的时间点转移到十年前产出停止增长的时候。2000年产出的停止增长归因于进口入侵，它关闭了国内工厂，摧毁了就业机会，并挤压了利润。随后出现了一系列因果关系，最终破坏了生产率增长——从产能利用率下降，到固定资本和研发投资减少，再到创新受到侵蚀。除了进口入侵，本文还识别出一系列障碍，从私营制造企业的自伤行为到政府资助的研发支出显著减少。企业资金从生产性投资转向股票回购。投资受到环境、健康、安全和燃油经济性法规的扭曲。创新放缓不仅是因为研发的回报递减，还因为公共研发的减少，以及私人研发从基础科学和工艺改进转向产品改良和品牌延伸。在缺乏足够的公共和私人职业培训投资的情况下，熟练工人短缺已困扰制造业数十年。

【**NBER**】: NBER Working Paper No. 35285，https://www.nber.org/papers/w35285

#### 6. Optimal Long-Term Care Provision and Insurance with Heterogeneous Preferences and Risks

【**Author**】: Nicholas-James Clavet, Pierre-Carl Michaud, Julien Navaux
...
【**摘要**】：我们开发了一个具有异质性风险和偏好的最优长期护理提供与保险模型。通过一项新颖的调查实验，我们估计了对护理环境和服务包的偏好（需求）。然后，我们使用加拿大魁北克省的行政数据校准了健康转变和服务的供给。最优保险方案在养老院中具有较低的共同保险率，在家庭护理中具有较高的共同保险率，同时导致家庭护理服务的受限扩张。与现行体系相比，最优提供增加了家庭护理的使用，将公共支出提高了三倍，并带来了消费者剩余的大幅增加。

【**NBER**】: NBER Working Paper No. 35284，https://www.nber.org/papers/w35284

#### 7. AI for Structural Estimation

【**Author**】: Victor Duarte, Julia Fonseca
...
【**摘要**】：我们开发了一种全局方法来求解和估计动态均衡模型，该方法将价格视为伪参数，将市场出清视为矩条件，并将估计时间从几天缩短到几分钟。我们的方法利用了人工智能算法、软件和硬件，并包含三个构建模块。首先，我们将状态空间扩展到包括均衡价格和模型参数，这使我们能够通过一次性求解模型来出清市场和估计参数。其次，我们通过在模型模拟数据上训练神经网络来近似参数与矩之间的映射，这些神经网络充当矩条件的闭式表达式。第三，我们利用这个映射，通过最小化模型矩与数据矩之间的距离来估计参数，并通过设定市场出清不平衡为零的目标来寻找均衡价格。我们还利用这个映射来全局评估识别性，验证估计目标函数对于每个参数是否具有唯一最小值。我们通过估计一个具有三个状态变量、三个控制变量、内生违约、昂贵股权发行和非凸调整成本的杠杆与投资动态一般均衡模型来说明我们的方法。传统方法在四天后仍未达到我们在不到20分钟内实现的损失。我们构建了一个人工智能代理，它可以根据自然语言提示将我们的方法应用于新模型。

【**NBER**】: NBER Working Paper No. 35283，https://www.nber.org/papers/w35283

#### 8. Insurer Risk and Public Risk-Sharing: Quantifying the Value of Reinsurance

【**Author**】: Paul H.S. Kim, Anran Li
...
【**摘要**】：我们研究了在企业面临巨大成本不确定性的市场中公共风险分担的作用，重点关注健康保险中的公共再保险。我们开发了一个模型，其中保险公司通过提高有效边际成本的风险费用来内化成本不确定性，并为再保险创造了作用。公共再保险降低了预期成本和成本波动性，特别是对于较小的保险公司，从而降低了价格并增强了竞争。利用交错实施的州级再保险项目的事件研究，我们表明公共再保险导致保险公司降低价格和减少私人再保险购买，使财务受限的保险公司受益最大。结构估计表明，风险费用占保费成本差额的很大一部分，并突显了公共再保险相对于保费补贴的比较优势，因为它提供了风险保护并增强了竞争。我们的结果强调了在政策设计中考虑企业风险暴露的重要性，并为理解公共风险分担政策提供了一个通用框架。

【**NBER**】: NBER Working Paper No. 35282，https://www.nber.org/papers/w35282

#### 9. College Affirmative Action and Students' Outcomes: A Matter of the Dose

【**Author**】: Yi Chen, Chao Fu, Hongbin Li, Teng Li, Siyan Tang
...
【**摘要**】：关于高等教育中的平权行动（AA）是否“有效”的讨论广泛存在，尽管在实践中AA是一种连续的政策工具。我们利用中国集中式大学招生体系中的少数民族加分政策，研究AA对其预期受益者的剂量效应，其中目标学生获得明确的分数优势。通过探索考试分数分布的队列层面波动（这产生了AA有效剂量的外生变化），我们发现较高的AA剂量增加了受益者进入大学和精英大学的机会，但降低了他们的学术排名，将他们转向收入较低的专业，并降低了他们对大学生活的满意度。通过将高考记录与高考后10至23年的综合卡交易记录相关联，我们发现低AA剂量使长期消费增加19%，但高剂量使其减少25%。这种非单调的剂量反应存在于各个支出类别中，包括与儿童相关的支出，表明可能对后代产生影响。异质性分析显示，虽然低AA剂量的积极效应在不同学生群体中持续存在，但来自较强学术背景的学生更能抵御高AA剂量的负面效应。总体而言，我们的结果表明，仔细校准AA政策对于实现其预期目标至关重要。

【**NBER**】: NBER Working Paper No. 35281，https://www.nber.org/papers/w35281

#### 10. Medicare Home Health Fraud: How Much, Where, and Who?

【**Author**】: Liran Einav, Amy Finkelstein, Yunan Ji, Neale Mahoney, Gideon Moore
...
【**摘要**】：医疗保险中存在多少欺诈行为，以及谁在实施欺诈？我们针对家庭健康领域（一个被广泛认为欺诈尤为猖獗的领域）提供了答案。我们将被联邦打击部队起诉的家庭健康机构定义为欺诈机构。通过将涵盖所有家庭健康机构的医疗保险索赔数据与手工收集的2009年至2013年间打击部队运作的九个联邦司法区的起诉记录相结合，我们训练了一个机器学习模型，用于样本外预测：如果存在打击部队，其余85个司法区中的每个家庭健康机构被起诉的概率。我们估计，2008年，医疗保险家庭健康支出的3.4%（约5.2亿美元）是由欺诈性家庭健康机构开具账单的。打击部队的目标定位准确：其九个司法区仅占家庭健康支出的40%，却占欺诈支出的65%。欺诈性家庭健康机构表现出直观的特征：它们更可能依赖极高转诊量的医生，表现出异常统一的护理模式，并服务于比平均更健康的患者。

【**NBER**】: NBER Working Paper No. 35280，https://www.nber.org/papers/w35280

#### 11. Non-User Externalities

【**Author**】: Leonardo Bursztyn, Jan Fasnacht, Benjamin R. Handel, Rafael Jiménez-Durán, Aaron Leonard, Filip Milojević, Christopher Roth, Cass R. Sunstein
...
【**摘要**】：我们回顾了一个新兴文献，该文献研究非用户外部性——即产品采纳对非用户与用户产生的差异化收益或损害——如何塑造市场结果。我们首先提出了一个统一框架，将非用户外部性与网络效应以及经典外部性（如污染）区分开来。一个关键区别在于，受经典外部性损害的人无法通过加入产生外部性的活动来减轻损害，而受负面非用户外部性损害的人则可以通过成为用户来减轻损害。这可能会扩大剩余非用户所承受的损害，产生级联动态，最终可能导致产品市场陷阱：即个体宁愿该产品不存在，但仍选择采纳它而非保持非用户身份的情况。利用涵盖25个产品市场的新调查证据，我们记录了负面非用户外部性的普遍性，其背后的机制在不同产品间存在系统性差异，并且它们对非用户产生了采纳压力。然后，我们讨论了非用户外部性如何影响福利分析、企业的战略激励以及市场结构。最后，我们讨论了政策应对措施，包括设计监管和集体协调机制。

【**NBER**】: NBER Working Paper No. 35279，https://www.nber.org/papers/w35279

#### 12. An Ethical Pollution Tax
...
【**摘要**】：通过理论和数值模拟，我探讨了如何设计一种污染税以容纳伦理上的反对意见。我考虑了伦理学家提出的四类反对意见——基于公平关切、不可通约性、公民责任和商品化。在每种情况下，我从理论上推导出一种旨在回应这些反对意见的税收，并使用一个以美国经济和二氧化碳污染为校准依据的一般均衡模型，定量地展示了这些调整如何影响税收的幅度以及由此产生的排放水平。一些调整可能对碳税率影响较小，而其他调整则可能导致税率增加五倍。

【**NBER**】: NBER Working Paper No. 35278，https://www.nber.org/papers/w35278
...
【**摘要**】：污名在“现实世界”中有多有害？答案难以捉摸，因为污名在观测数据中难以衡量，并且要隔离其影响需要污名的外生变化，而污名化特征本身不变。本研究通过关注住院医疗这一高风险环境中的一种普遍污名形式——体重污名——来应对这些挑战。BMI类别在电子病历中显著地展示给医疗服务提供者，而肥胖在社会上受到严重污名化。因此，在“肥胖”临界点，污名可能发生离散变化，而潜在特征（BMI）则不会。利用利用这一制度特征的断点回归设计，我发现尽管患者健康状况没有变化，但该临界点的院内死亡率出现了不连续的增加。两种模式表明基于污名的歧视是作用机制。首先，刚达到肥胖标准的患者比接近肥胖标准的患者接受的诊断努力更少。其次，一个经医生验证的LLM在临界点识别出临床记录中污名化语言的增加——具体而言，是施加道德评判、削弱患者可信度以及对患者进行刻板印象的语言——这在最具污名化的医疗服务提供者中最为明显，而他们也推动了死亡率结果。总体而言，这些结果表明污名是一种强大的社会力量，可能带来生死攸关的后果。

【**NBER**】: NBER Working Paper No. 35277，https://www.nber.org/papers/w35277

#### 14. The AGI Race and Existential Risk

【**Author**】: Ethan Bueno de Mesquita, Wioletta Dziuda, Mattias Polborn
...
【**摘要**】：关于通用人工智能竞赛的担忧通常假设竞争和资源通过加速发展来增加风险。我们研究了一个模型，其中企业在速度和安全性之间分配稀缺资源。速度增加了企业率先达到AGI的机会，但留给安全性的资源更少；安全性降低了毁灭风险，但减缓了到达速度。碎片化通过将固定的行业资源池转向速度，增加了总速度和条件毁灭风险。该模型还识别出一个关键市场规模：低于该规模时，企业从实现AGI中获得正预期收益；而高于该规模时，即使实现AGI具有负预期价值，企业仍会竞赛。更多的企业资源总是加速预期到达时间，但它们对条件毁灭风险的影响在此临界点改变符号。政策通过改变均衡激励来影响风险：在某些环境中，整合、资源监管、承诺机制和谨慎的公共进入可以改善福利。结果表明，AGI风险不仅取决于技术考量，还取决于市场结构、资源约束以及塑造速度与安全性之间均衡配置的制度。

【**NBER**】: NBER Working Paper No. 35276，https://www.nber.org/papers/w35276

#### 15. Writing Code vs. Shipping Code: Productivity Effects Across Generations of AI Coding Tools

【**Author**】: Mert Demirer, Leon Musolff, Liyuan Yang
...
【**摘要**】：AI的生产率效应如何在连续几代工具中演变，以及任务层面的收益最终在多大程度上转化为最终产出？我们在软件开发背景下研究这些问题，使用了超过10万名GitHub开发者的数据及其AI使用遥测数据。在一个匹配的事件研究设计中，我们发现自动补全、交互式编码代理和自主编码代理各自显著增加了编码活动（“提交”），累计效应分别为40%、140%和180%。然而，这些收益在生产层级中急剧衰减：180%的累计效应在项目数量上降至50%，在实际发布上降至30%。这种模式与弱环节假说一致：AI带来的强劲生产率收益被生产链中的人力瓶颈所削弱，AI与人力努力之间的替代弹性估计为0.25，这表明存在强互补性。我们进一步在四个主要应用市场中确认了这些结果，发现新应用数量适度增加，但总使用量没有增加。因此，迄今为止，任务层面巨大的AI生产率收益仅部分转化为已交付和已使用的软件。

【**NBER**】: NBER Working Paper No. 35275，https://www.nber.org/papers/w35275

#### 16. Factor Bias and Heterogeneous Output Quality in Multiproduct Production

【**Author**】: Yi Lee, Shengyu Li, Mark J. Roberts
...
【**摘要**】：本文开发并估计了一个多产品生产的结构模型，该模型允许工厂-产品质量和要素增强型投入效率。使用台湾纺织业的工厂级数据，我们设定了一个包含投入份额和产出供给方程的超对数多产品成本函数，并通过GMM估计方程组。该模型恢复了工厂特定的投入效率、产出质量、规模经济和范围经济以及替代弹性。它不对非联合生产或投入-产出可分离性施加限制，也不需要估算产品层面的投入分配。我们记录了规模报酬递增、劳动力和材料之间的可替代性以及联合生产的成本互补性。劳动力份额和产品组合的变化是由投入效率和产出质量方面巨大且持久的异质性共同驱动的。一个多边生产率指数表明，投入效率和产出质量的变化是工厂间生产率差异的主要来源。

【**NBER**】: NBER Working Paper No. 35274，https://www.nber.org/papers/w35274

#### 17. The Growth and Performance of Artificial Intelligence in Asset Management

【**Author**】: Shuang Chen, Clemens Sialm, David X. Xu
...
【**摘要**】：我们研究了人工智能驱动投资的增长与表现。利用投资顾问的监管披露、劳动力市场数据和基金策略描述，我们记录到自2010年代初以来，人工智能驱动投资稳步增长，且主要集中在对冲基金领域。早期，人工智能对冲基金的表现优于非人工智能对冲基金，但这种超额收益随时间推移而下降，即使在早期采用者中也是如此。与对人工智能驱动策略同质化的担忧相反，人工智能对冲基金表现出比非人工智能同行更低的回报联动性。我们的发现既凸显了人工智能作为投资绩效来源的阿尔法生成潜力，也揭示了其局限性。

【**NBER**】: NBER Working Paper No. 35273，https://www.nber.org/papers/w35273

#### 18. Geopolitical Fragmentation, Sovereign Debt, and Dollar Dominance

【**Author**】: Felipe Benguria, Eugenio I. Rojas, Felipe Saffie
...
【**摘要**】：各国以美元借款，因为美元债务市场深度大、流动性强。本文发展了一个理论，探讨当各国继承了美元负债但收入日益与人民币挂钩时，这种主导地位何时变得脆弱。在模型中，各国最初持有以美元计价的主权债务。地缘政治碎片化通过两个渠道提高了它们的人民币收入份额：与美元挂钩市场的贸易壁垒提高，将出口转向人民币挂钩市场；以及在该贸易中使用美元的成本上升，使人民币结算更具吸引力。随后，政府面临选择：用与美元关联度较低的收入偿还美元债务、违约，或重组为人民币债务。本文识别了重组带来的流动性溢出效应：从美元到人民币的重组深化了人民币债务市场，降低了再融资成本，并鼓励了更多重组。模型展示了碎片化何时导致有限的重组，以及何时触发从美元债务向人民币债务的自我强化转变。这种级联效应要求人民币重组的流动性反馈强于各国人民币收入敞口的分散程度。

【**NBER**】: NBER Working Paper No. 35272，https://www.nber.org/papers/w35272

#### 19. Beyond Exposure: Predicting AI Adoption Based on Comparative Advantage
...
【**摘要**】：我们记录并解释了工作场所中人工智能暴露度指标与人工智能采用指标之间的差距。这促使我们提出一个基于比较优势的新人工智能采用指数。利用具有代表性的德国DiWaBe员工调查数据（与工人和企业信息相关联），我们将工人报告的人工智能使用情况与著名的暴露度指标进行比较，发现两者关系较弱。受此差距启发，我们构建了一个框架，其中采用不仅取决于技术可行性（即由暴露度衡量的人工智能绝对优势），还取决于盈利能力（即人工智能相对于特定工人的比较（劣势）优势），平衡人工智能生产率与人工智能用户成本，以及工人生产率与工资。我们在任务层面操作化该框架，通过（i）估计工人相对于薪酬的生产率，（ii）将暴露度指数映射为人工智能生产率，以及（iii）从显示性偏好采用中推断任务特定的人工智能用户成本。由此产生的职业层面指数解释了观察到的跨职业人工智能采用差异的近60%，而仅基于暴露度的模型仅解释了14%。对于约30%的工人，这两种方法存在显著差异，这凸显了比较优势——而非仅暴露度——对于评估人工智能对劳动力市场影响至关重要。

【**NBER**】: NBER Working Paper No. 35271，https://www.nber.org/papers/w35271

#### 20. Dust in the Wind: The Health Costs of Great Salt Lake Desiccation

【**Author**】: Lena Harris, Eric C. Edwards, Danae Hernandez-Cortes
...
【**摘要**】：来自自然源的空气污染通常受到的监管监督较少，但仍可能由人类活动引起。理解政策的作用需要量化该源的污染贡献，但目前尚无标准方法论。本文利用犹他州大盐湖萎缩的背景，模拟高度易侵蚀且不断扩大的裸露湖床面积对空气质量的影响。使用空气污染文献中四种常见的识别策略以及三种替代污染测量技术，我们发现了在非冬季月份，湖泊萎缩导致污染显著增加的一致证据。估计值对测量技术相对不敏感，但不同识别策略间存在差异。边际年成本范围为每100平方公里裸露湖床8100万至1.75亿美元。按总裸露湖床面积推算，与干涸相关的年度健康成本估计在11亿至23亿美元之间。鉴于流域内人类用水与裸露湖床之间的直接关系，这些结果为旨在减少消耗性用水的政策的成本效益提供了证据。

【**NBER**】: NBER Working Paper No. 35270，https://www.nber.org/papers/w35270

#### 21. Frontier Knowledge in College and Student Success

【**Author**】: Barbara Biasi, Song Ma
...
【**摘要**】：我们研究大学期间接触前沿知识是否影响学生成果。结合来自七所德克萨斯公立大学的459,415份教学大纲、1.07亿篇出版物以及关联的学生记录，我们衡量每门课程与其领域内近期研究相对于较旧研究的接近度。利用入学时未观察到的教学大纲更新，我们发现前沿接触提高了毕业率、平均绩点、研究生院入学率和收入，并缩短了毕业所需时间。毕业率、平均绩点和学业进展方面的收益是广泛的，而研究生院和收入回报对于准备更充分、家庭资源更丰富的学生更大。证据表明存在两种机制：前沿内容保持学生参与度，而持续接触则培养了劳动力市场技能。

【**NBER**】: NBER Working Paper No. 35269，https://www.nber.org/papers/w35269

#### 22. An Unfunded Mandate? Medicaid Continuous Coverage Requirements and State Fiscal Burdens During COVID-19

【**Author**】: Jeffrey Clemens, Anwita Mahajan
...
【**摘要**】：在新冠疫情爆发之初，联邦政府通过2020年3月《家庭优先冠状病毒应对法案》中的两项条款，实施了影响各州医疗补助计划相关收入和支出的重大变革。这些条款包括将各州的联邦医疗援助百分比提高6.2个百分点，这增加了各州的收入，但前提是遵守持续覆盖要求。后一项条款通过阻止因收入或其他与资格相关情况变化而本应失去资格的个人退出保险，从而增加了支出。虽然这些条款事前预期会导致规模相近的支出和成本，但事后实现情况尚未量化。在全国范围内，我们估计各州承担的持续覆盖条款成本份额为1392亿美元，这比各州通过提高联邦医疗援助百分比获得的收入总额大约少110亿美元。然而，各州的收入和成本差异很大，成本超过收入的程度高达人均594美元，而收入超过成本的程度高达人均838美元。联邦政府承担各州医疗补助支出份额的基准参数，是决定持续覆盖要求在多大程度上可被视为一项无资金支持的联邦指令的关键驱动因素。

【**NBER**】: NBER Working Paper No. 35268，https://www.nber.org/papers/w35268

#### 23. Persistent Effects of Early Academic Rank on Cognitive and Noncognitive Outcomes

【**Author**】: Eunsik Chang, María Padilla-Romo, Cecilia Peluffo
...
【**摘要**】：本文在墨西哥背景下估计了小学早期学业排名对后期认知和非认知结果的影响。我们使用关联的行政记录，比较三年级学业成绩相似但序数排名不同的学生。这些排名差异源于小学同年级学生成绩分布的特异性变化。我们发现，更高的三年级排名能提高高风险高中入学考试的成绩。当联合估计时，更广泛的学校年级排名和班级排名都对这一成绩提升有贡献。更高的排名导致更选择性的高中选择，并改善了九年级末自我报告的自感知、学业抱负、课堂责任感、学习策略和团队合作态度等指标。我们还提供了证据，表明更高的小学排名改善了学生的高中录取结果。

【**NBER**】: NBER Working Paper No. 35267，https://www.nber.org/papers/w35267

#### 24. The Missing Value of Data

【**Author**】: Ankit Bhutani, Guillermo Ordoñez, Laura Veldkamp
...
【**摘要**】：数据资产在现代经济中日益重要，但宏观经济计量并未很好地适应捕捉其价值。部分问题在于数据是一种无形资产：数据投资在国民账户中被遗漏，折旧损失在企业资产负债表中被遗漏。另一个独特的问题是，数据在现代经济中充当支付手段：为数据而交换的消费也被排除在国民账户之外。我们提出了一种基于产出的方法来衡量缺失的数据价值。我们将数据视为一种资产，根据企业收入预测的质量衡量其数量，并内生地确定其折旧。然后，我们对数据价值进行资本化，并探讨如果数据像实物资产一样被处理和交易，所测量的国内生产总值会是多少。我们的发现表明，数据的总价值约占国内生产总值的1.5%。

【**NBER**】: NBER Working Paper No. 35266，https://www.nber.org/papers/w35266

#### 25. Off the Labor Supply Curve: The Zero Employer Size Wage Effect Within Large Firms

【**Author**】: André Diegmann, Steffen Müller, Benjamin Schoefer
...
【**摘要**】：我们重新审视了雇主规模工资效应（ESWE）——这可以说是对劳动力单一价格法则最基本且最具影响力的背离。我们的主要发现是，这一经典事实在同一企业的不同分支机构之间完全消失，尽管这些分支机构在不同的地方劳动力市场运营。我们通过将企业固定效应纳入原本标准的、对工资与机构规模进行横截面回归的模型中，揭示并剖析了这一事实。我们在德国覆盖全人口的企业-机构-员工三级关联数据中实施了这一要求严格的设定。这一结果在ESWE文献中是全新的（本文也为此提供了首次系统的元分析）。这种工资与规模的脱钩很难与以下观点相协调：即就业是由一条有限弹性的、雇主特定的劳动力供给曲线决定的——也就是说，雇主恰好支付劳动力数量所需的最低工资，但不会更多——这是买方垄断观点的基石。相比之下，大型多机构企业（MEF）似乎是在其劳动力供给曲线之外雇佣劳动力（或者这些曲线非常有弹性），支付高于买方垄断最低水平的工资溢价，并留下过剩的劳动力供给。我们发现在低溢价MEF内部，ESWE有重新出现的证据。总体而言，至少对于ESWE消失的大型企业（占德国就业的25%）而言，工资设定和就业决定可能更好地由替代模型来解释，即容纳高于市场出清的工资溢价和劳动力供给配给，例如效率工资理论。

【**NBER**】: NBER Working Paper No. 35265，https://www.nber.org/papers/w35265

#### 26. Where There’s Smoke: Stochastic Caregiving Shocks and Mothers’ Labor Market Outcomes

【**Author**】: Joshua S. Graff Zivin, Seunghoon Lee
...
【**摘要**】：正规儿童保育和公立学校被广泛认为对母亲的劳动力市场依附至关重要。然而，大量文献发现，即使是大幅扩展正规儿童保育，对母亲就业的影响也微乎其微或为零。我们研究了随机照料需求冲击的作用，这些冲击导致即使在有正规保育的情况下，儿童保育约束也会间歇性地收紧。利用野火烟雾暴露的合理外生变化，我们表明烟雾增加了学校关闭和学生缺勤，从而产生了照料需求。此外，通过比较其最小子女对学校保育依赖程度不同的母亲，我们发现这些冲击带来了巨大的同期成本，并且当累积起来时，会减少就业。在非男性主导行业工作的母亲中，就业损失被完全抵消，这与工作场所的容忍度调节了间歇性照料需求后果的观点一致。

【**NBER**】: NBER Working Paper No. 35264，https://www.nber.org/papers/w35264

#### 27. How Efficient was the Affordable Care Act at Reducing Uninsured Rates?

【**Author**】: Anuj Gangopadhyaya, Robert Kaestner
...
【**摘要**】：衡量《平价医疗法案》（ACA）效率的一种方法是，公共支持的健康保险覆盖面的增加在多大程度上降低了无保险率。利用2008-2024年美国社区调查的数据，我们按收入与联邦贫困线（FPL）的比率定义的群体，考察了无保险率、公共保险覆盖率和雇主提供的保险（ESI）的时间趋势。我们利用各州在ACA实施上的逐年差异，估计了公共保险覆盖率变化与无保险率和ESI变化之间的关联。重要的是，我们估计了ACA的总效应——包括医疗补助扩展和市场覆盖——对无保险率和ESI的影响。对于家庭收入低于联邦贫困线150%的成年人，公共保险覆盖率的增加与无保险率的一对一减少相关，而ESI没有变化。对于收入在联邦贫困线151%-400%之间的成年人，公共保险覆盖率每增加一个百分点，与无保险率约0.6个百分点的下降和ESI约0.4个百分点的下降（即挤出效应）相关。在ACA实施前ESI率较高的群体中，如父母和已婚成年人，挤出效应更大。仅利用医疗补助扩展的变异来评估ACA对ESI的影响，会导致夸大低收入成年人（低于150% FPL）的挤出效应，并低估高收入成年人（高于250% FPL）的挤出效应。我们的发现表明，旨在补贴较高收入群体健康保险的政策（例如，增强型保费补贴）的效率远低于旨在进一步向低收入群体扩展公共保险的政策（例如，在非扩展州）。

【**NBER**】: NBER Working Paper No. 35263，https://www.nber.org/papers/w35263

#### 28. How Much and How Fast Do Investors Respond to Equity Premium Changes? Evidence from Wealth Taxation

【**Author**】: Andreas Fagereng, Luigi Guiso, Marius A. K. Ring
...
【**摘要**】：利用挪威投资者投资组合的行政面板数据，我们记录了投资者对由持久性财富税引起的股权溢价冲击的强烈但缓慢的投资组合配置反应。短期反应类似于通过调查记录的适度敏感性。长期反应则大得多，并且可以通过适度的风险厌恶来合理化。我们记录了股权溢价冲击影响股市进入但不影响退出，这表明进入成本主导了参与成本。我们发现反应缓慢的结论支持了利用调整摩擦来解释重要资产定价谜题的资产定价文献，并且对当不同资产的税率不同时的最优资本税具有启示意义。

【**NBER**】: NBER Working Paper No. 35262，https://www.nber.org/papers/w35262

#### 29. Startups in Africa

【**Author**】: Emanuele Colonnelli, Marcio Cruz, Mariana Pereira-Lopez, Tommaso Porzio, Chun Zhao
...
【**摘要**】：我们构建了关于非洲初创企业的新数据，以研究这些企业需要哪些类型的融资、融资在实践中是如何分配的，以及对初创企业创建和该行业构成的影响。我们结合了一项覆盖整个非洲大陆的创始人调查、一项估计融资偏好的激励相容实验，以及匹配了创始人教育背景和工作经历的风险投资（VC）交易记录。我们发现，初创企业强烈偏好股权而非债务，但股权主要由外国投资者提供，并且不成比例地流向具有海外背景的创始人。大约80%的风险投资交易涉及外国投资者，超过60%获得融资的创始人曾在非洲以外学习或工作。一个简单的核算框架表明，这种“外国性”反映了三个主要力量：稀缺的本地股权资本、能够获得初创企业融资的本地企业家群体薄弱，以及限制本地企业家接触外国投资者的摩擦。这些力量共同减少了初创企业的创建，并使该行业向外国投资者和具有海外背景的创始人倾斜。

【**NBER**】: NBER Working Paper No. 35261，https://www.nber.org/papers/w35261

#### 30. The Risk-free Rate and the Risk-adjusted Growth Rate

【**Author**】: Stavros Panageas

【**Abstract**】: Several important questions — such as the possibility of debt-rollover without primary surpluses — turn on whether the present value of the aggregate endowment is finite, i.e., whether the economic growth rate under the “risk-neutral” measure, lies below the risk-free rate. It is tempting to argue that the endowment must be finitely valued, since there exist finitely-valued, non-depreciating assets whose cash flows are cointegrated with aggregate output. This paper shows why this argument is incorrect. A remarkable historical episode in which French government bonds were indexed to aggregate growth allows direct measurement of the risk-adjusted growth rate, which is found to exceed the risk-free rate.

【**摘要**】：几个重要问题——例如在没有基本盈余的情况下进行债务展期的可能性——取决于总禀赋的现值是否有限，即“风险中性”测度下的经济增长率是否低于无风险利率。人们很容易认为总禀赋的估值必然是有限的，因为存在估值有限且不折旧的资产，其现金流与总产出是协整的。本文说明了为什么这个论点是不正确的。一个值得注意的历史事件——法国政府债券与总体增长挂钩——使得直接测量风险调整后的增长率成为可能，结果发现该增长率超过了无风险利率。

【**NBER**】: NBER Working Paper No. 35260，https://www.nber.org/papers/w35260

#### 31. A Bayesian Critic for Frequentist Procedures

【**Author**】: Isaiah Andrews, Simon C. Essig Aberg, Jesse M. Shapiro
...
【**摘要**】：我们提出了一种方法，用于在给定设定下对程序（例如，估计量、置信区间）的频率学派性质（例如，偏差、覆盖率）进行自动化的概率评估。一个贝叶斯批评者观察数据样本，并更新其对潜在数据生成过程（DGP）的先验信念。由此产生的关于DGP的后验信念意味着关于感兴趣性质的后验信念。当批评者的先验属于低精度狄利克雷过程类时，批评者的后验可以通过贝叶斯自助法来近似，从而使该方法完全自动化。我们将该方法应用于几个经典设定，并表明批评者分享了先前工作中提出的一些担忧，并提供了新的见解。

【**NBER**】: NBER Working Paper No. 35259，https://www.nber.org/papers/w35259

#### 32. Towards a Methodology for Measuring Rental Property Ownership in the United States

【**Author**】: Stephanie Kestelman, Rebecca Diamond, John Eric Humphries, Kate Pennington, Winnie van Dijk, John L. Voorheis
...
【**摘要**】：大约三分之一的美国住户租房居住，然而衡量谁拥有租赁房产却很困难：所有权经常被有限责任公司（LLC）、合伙企业和其他中介实体所掩盖，这些实体将法律控制权与经济控制权分离开来。我们开发了一种通过行政记录追溯所有权的方法——将契约和房产评估与人口普查局的商业登记册、国税局附表K-1申报表以及美国证券交易委员会关于房地产投资信托基金（REIT）的申报文件相结合——以识别最终所有者，并构建涵盖整个房东规模分布的房产组合。将该方法应用于11个大型大都市统计区（CBSA），我们发现个人房东拥有绝大多数租赁单元，尽管他们的份额在不同市场之间存在显著差异。我们还表明，广泛使用的邮寄地址聚合方法会以系统性的方式低估和高估投资组合规模。该方法旨在扩展到全国覆盖范围，并支持衡量美国租赁市场中的房东身份、投资组合构成和所有权集中度。我们还讨论了该方法当前的局限性，并概述了改进和验证的方向。

【**NBER**】: NBER Working Paper No. 35258，https://www.nber.org/papers/w35258

#### 33. The Federal Government's Discretionary Spending

【**Author**】: Karen Dynan, Douglas Elmendorf, Theresa Gullo

【**Abstract**】: This paper examines federal discretionary spending, including its place in the overall budget, its composition, and the economic and political forces shaping its size. Both defense and nondefense discretionary spending show no trend relative to national output over the past three decades, reflecting underlying factors rather than explicit targets. This stability implies a less favorable fiscal outlook than appears in official projections. Because discretionary spending is generally set annually, it will face continuing pressure from concerns about rising federal debt, a challenge compounded by the erosion of the structured budget process envisioned in the Budget Act fifty years ago.

【**摘要**】：本文考察了联邦可自由支配支出，包括其在整体预算中的地位、构成，以及影响其规模的经济和政治力量。过去三十年来，国防和非国防可自由支配支出相对于国民产出均未呈现趋势性变化，这反映了潜在因素而非明确目标的作用。这种稳定性意味着财政前景比官方预测所显示的要更为不利。由于可自由支配支出通常每年设定一次，它将持续面临来自对不断上升的联邦债务的担忧所带来的压力，而五十年前《预算法》所设想的结构化预算程序的侵蚀又加剧了这一挑战。

【**NBER**】: NBER Working Paper No. 35257，https://www.nber.org/papers/w35257

#### 34. Housing Capital and Intergenerational Mobility in the United States

【**Author**】: Ariel J. Binder, Max Risch, John L. Voorheis
...
【**摘要**】：我们利用一个将十年一次的人口普查数据与超过340万个家庭的行政财产和所得税记录联系起来的新数据集，记录了美国住房资本的代际流动性。我们发现，住房资本在代际间的持续性远高于收入。此外，白人和黑人子女之间的住房资本差距在父母分布中急剧扩大，其程度超过收入差距。利用一个资本积累和传递框架，我们研究了资产和收入如何共同塑造代际住房资本的持续性。这种持续性中只有不到一半是通过子女的收入起作用的，这为资本资产和知识的直接传递留下了相当大的空间。收入差异解释了父母分布底层白人与黑人住房差距的大部分，但在顶层则解释了不到一半。最后，我们提供了准实验证据，表明地方住房供给约束通过扩大来自低资源和高资源家庭子女之间的住房拥有率差距，加剧了代际持续性。总之，我们的发现表明，经济资源在代际间的集中程度比仅关注收入的研究所暗示的要高。

【**NBER**】: NBER Working Paper No. 35256，https://www.nber.org/papers/w35256

#### 35. Deep-Tech Innovation: A Multi-Method Study toward a Conceptual Framework and Research Agenda

【**Author**】: Johann Kortsch, Stefan Raff-Heinen, David Bendig, Martin Murmann, Colin Schulz, Fiona Murray
...
【**摘要**】：“深度技术创新”一词在研究、政策和实践中日益受到关注，但其应用不一致且缺乏公认的定义。这限制了知识的累积性构建，并模糊了深度技术创新与相关概念之间的关系。我们通过开发一个将深度技术创新视为独特研究对象的框架来填补这一空白。采用结合系统性、整合性、以概念为中心的文献综述与对深度技术创始人的半结构化访谈的多方法设计，我们识别出十二个定义性属性，这些属性结构化为三个层面：发明、企业和生态系统。在发明层面（概念核心），我们指定了六个属性：三个基础属性，捕捉发明的科学和技术基础；以及三个属性，描述其特征性风险暴露概况。其余六个属性捕捉了在企业层面（分阶段融资策略、科学与商业双重成熟、团队的多学科扩展）和生态系统层面（多主体互动、专业化孵化支持、以及产业去风险与规模化合作伙伴关系）的反复出现的含义。我们利用这一框架来界定深度技术创新的边界，将其与相邻概念区分开来，并提出了未来研究的议程。

【**NBER**】: NBER Working Paper No. 35255，https://www.nber.org/papers/w35255

#### 36. Defining Innovatisation: The Case of NewSpace and the Changing Space Sector

【**Author**】: Benoit Cornet, Marc-André Chavy-Macdonald, Dominique Foray
...
【**摘要**】：航天部门已变得更具活力和创新性，新参与者（如初创企业、风险资本）进入，私营企业的重要性日益增长。在本文中，我们引入了一个新概念——“创新化”，以理解这一现象。创新化描述了一个部门在两种模式之间的转型。在技术成就模式下，只有技术（而非经济）表现重要，主要出于声望目的；而在创新模式下，客户偏好、商业机会和成本变得至关重要。通过研究阿波罗计划的经济学和1980年代的商业化尝试，我们展示了航天部门长期以来如何以技术成就逻辑为特征。然后，通过分析近期趋势，我们提供了定量经验证据（例如成本），表明由于各种驱动力的作用，创新现在正在塑造该部门。创新化过程背后的驱动力是基于Jones (2022)和颠覆性创新理论来识别的。

【**NBER**】: NBER Working Paper No. 35254，https://www.nber.org/papers/w35254

#### 37. The Sisyphean Pursuit of Evidence for Poverty Traps

【**Author**】: Dean Karlan, Amol Singh Raswan, Christopher R. Udry
...
【**摘要**】：发展经济学的大部分研究，无论是微观还是宏观，都提出了贫困陷阱的理论并探索其经验证据。一个常见的理论围绕资产阈值贫困陷阱展开，在该陷阱中，资本的边际回报在超过某个阈值后急剧增加，且金融市场不完善。这种组合导致高于此阈值的家庭繁荣，而低于此阈值的家庭则持续倒退，陷入贫困陷阱。然而，在经济学中，据我们所知，假设存在此类阈值的论文远多于经验证明其存在的论文。在最近一个关键例外中，Balboni等人 (2022)（以下简称“BBBGH”）认为，来自孟加拉国的数据为近期接受大推动转移支付项目的受助者识别出了略高于一头牛成本的明确阈值证据。我们将此分析应用于低收入国家其他七个类似项目的数据，并未发现资产阈值贫困陷阱的证据。然后，我们回到BBBGH，认为他们的数据并不支持贫困陷阱的识别，分歧点在于对数转换挑战和潜在的地理混杂因素。在来自孟加拉国和加纳的长期代表性农村面板数据中，我们没有发现偏离任何特定阈值的分化证据。虽然阈值理论对某些家庭无疑是正确的，但我们认为，为广泛人群寻找资产阈值贫困陷阱的明确证据很可能是一个因多种可能机制与异质性主体的交织而无法实现的理想目标。

【**NBER**】: NBER Working Paper No. 35253，https://www.nber.org/papers/w35253

#### 38. Distribution Costs

【**Author**】: Cian Ruane, Alessandra Peter
...
【**摘要**】：我们提供了制造业工厂所产生分销费用的首次直接估计，并量化了其对总消费和测算资源错配的重要性。利用来自印度年度工业调查的一个新颖指标，我们记录了三个事实：分销费用超过劳动力成本的一半；对于最大十分位数的工厂，其占销售额的比例是最小十分位数工厂的三倍以上；并且从2000年到2010年下降了三分之一。我们建立了一个异质性制造业企业的模型，这些企业依赖分销服务在空间上进行销售。在此期间分销的改善使制造业消费提高了24.5%。这些收益迅速实现，但并不均衡：大型企业扩张，而许多小型本地企业收缩或退出。分销成本对测算的资源错配也很重要：标准的TFPR指标会产生虚假的离散度以及与规模的正相关关系。在ASI中，考虑分销成本后，测算的TFPR离散度降低了5.1%，TFPR相对于工厂规模的弹性降低了7.0%。

【**NBER**】: NBER Working Paper No. 35252，https://www.nber.org/papers/w35252

#### 39. The Word Is Not Enough: Testing the Effects of Information Treatments on Perceived Corruption in Ukraine

【**Author**】: Yuriy Gorodnichenko, Ilona Sologoub, Yuriy Fedyk
...
【**摘要**】：利用一个超过7000名乌克兰人的代表性样本，我们研究了信息干预如何影响腐败感知和亲社会行为。我们记录了感知腐败与经历腐败之间的巨大差距：虽然大多数受访者认为腐败普遍存在且是一个重大的国家问题，但报告直接接触腐败的人数要少得多。通过一项随机对照试验，我们发现，告知公民成功起诉的信息会提高人们对政府打击腐败意愿的感知，但不会降低整体的腐败感知。仅传达腐败规模的信息不会产生显著效果。信息干预对假设性或实际的捐赠和志愿服务几乎没有影响，这表明从信念改变到亲社会行为的传导有限。因此，虽然信息干预可以增强制度可信度，但仅凭它们本身并不足以切实改善公民参与或减少腐败感知。

【**NBER**】: NBER Working Paper No. 35251，https://www.nber.org/papers/w35251

#### 40. Nonresponse Imputations and Related Measurement Issues in the CPI for Shelter

【**Author**】: Lara Loewenstein, Hugh G. Montag, Randal Verbrugge
...
【**摘要**】：住房是美国消费者价格指数通胀的最大组成部分；因此，住房通胀的准确性对于整体CPI通胀的准确性至关重要。支撑CPI住房通胀测量的BLS住房调查中的无应答率自2000年以来有所上升，目前约占总观测值的40%。缺失的租金数据目前使用基于租金等级的类均值方法进行插补，这可能导致有偏的插补，因为我们发现无应答与租金等级以外的因素相关。我们研究了基于与无应答和租金增长均相关的变量（包括建筑类型和租住时长）的替代简单插补方法。一个简单模型表明，替代方法可能产生截然不同的指数偏差。然而，在实践中，我们发现这些替代方法产生了相似的住房通胀指数，这表明任何指数偏差可能都是适度的。

【**NBER**】: NBER Working Paper No. 35250，https://www.nber.org/papers/w35250

#### 41. The Price of Protection: Tariff Incidence and Import Collapse under the Infamous Smoot-Hawley Tariff

【**Author**】: Kris James Mitchener, Mathieu Pedemonte
...
【**摘要**】：在不受限制的互联网语料库上训练的大型语言模型不可避免地嵌入了未来的信息，引入了前瞻性偏差，损害了金融和社会科学中回测和因果推断的有效性。时点语言模型——仅使用截至每个日历日期可用的文本进行训练——通过构造消除了这种信息泄漏，但现有的努力通常产生的模型性能明显落后于其不受限制的对应模型。我们表明，这种性能差距可以通过规模扩展来缩小。通过在来自FineWeb的1万亿个按时间顺序过滤的令牌上训练参数多达40亿的解码器专用Transformer，我们构建了一个跨越2013-2024年的月度模型检查点序列。在一系列常识推理和语言理解基准测试中，我们的模型接近在时间上不受限制的数据上训练的同等规模领先开源模型（如Gemma-3-4B和LLaMA-7B）的性能，尽管在若干任务上仍存在性能差距。最后，在一个严格的样本外经济评估任务中，基于时点嵌入构建的投资组合实现了稳健的正夏普比率，并且表现接近违反时间有效性的全样本对应组合，这表明时间一致的语言模型可以在不依赖前瞻性偏差的情况下提取具有经济意义的信号。我们发布了完整的流程——包括数据集构建、训练基础设施和评估代码——以实现可复现的时点语言建模，并支持需要严格时间有效性的研究应用。

【**NBER**】: NBER Working Paper No. 35247，https://www.nber.org/papers/w35247

#### 44. Complex Modern Portfolio Theory

【**Author**】: Oliver Hellum, Theis I. Jensen, Bryan T. Kelly, Semyon Malamud
...
【**摘要**】：文献长期以来一直在探讨现代投资组合理论（MPT）的实际有用性，大量证据表明其性能随着资产数量（N）的增加而迅速下降。我们提出了关于MPT的几个新的且反直觉的事实。最重要的是，一旦资产数量超过训练观测值数量（T），MPT的性能实际上会随着N的增加而提高。这一发现在多种设置下成立：结合流行的投资组合正则化方法、在各种资产类别中，以及当T较大或较小时。

【**NBER**】: NBER Working Paper No. 35246，https://www.nber.org/papers/w35246

#### 45. How Much Has Shale Gas Saved U.S. Consumers?
...
【**摘要**】：现在可能已是遥远的记忆，但截至2000年代中期，美国天然气产量已停滞十年，美国正在进口液化天然气（LNG），并计划进口更多。随后页岩气出现了。水力压裂和水平钻井技术的进步使美国天然气产量大幅增加，美国从天然气净进口国转变为全球最大的出口国。本文计算了页岩气为美国天然气消费者节省了多少钱。利用美国、欧洲和日本之间的价格差异，我们计算出美国天然气消费者在2007年至2025年间节省了3.1-4.3万亿美元，相当于每年1640-2270亿美元。在乌克兰战争等重大供应冲击期间，获得低价美国天然气的机会尤其宝贵，页岩气的好处已广泛惠及各个行业和州。

【**NBER**】: NBER Working Paper No. 35245，https://www.nber.org/papers/w35245

#### 46. Will The University Endowment Tax Slow Scientific Progress? Evidence from Elite Economics PhD Programs

【**Author**】: Joshua Angrist, Marc Diederichs, Glenn Ellison
...
【**摘要**】：2025年大学捐赠税上调及其他财务压力来源可能导致培养最多产经济学研究人员的学校减少研究生招生。这是否会影响长期研究产出？我们使用麻省理工学院经济学博士项目申请人的一个新样本，来估计八所精英学校的研究增值。我们的估计通过控制麻省理工学院招生委员会排名——这是长期研究成功的一个非常强的预测指标——以及通过申请人申请组合揭示的申请人志向，来减轻选择偏差。虽然排名控制显著缩小了精英与非精英毕业生之间的估计差距，但增值方面仍存在巨大差异。高税收及其他顶尖八所学校的毕业生比来自美国非顶尖八所学校的可比毕业生多产出60-75%的影响调整后出版物。精英学校的优势在五大顶级期刊发表方面尤为显著。然而，精英层级内部研究成功的差异相对较小。精英学校博士的优异表现似乎不能用精英项目中的编辑关系或同伴效应来解释。

【**NBER**】: NBER Working Paper No. 35244，https://www.nber.org/papers/w35244

#### 47. A Tale of Two Market Returns: The Broad Market Factor and The Idiosyncratic Financial Factor

【**Author**】: Sung Je Byun, Johnathan Loudis, Lawrence D.W. Schmidt
...
【**摘要**】：我们构建了一个广泛市场因子（BMF），它是美国经济中所有公司（上市和私营）价值加权股权回报的代理变量。BMF不同于标准的价值加权市场因子（VMF），后者反映的是上市公司的价值加权股权回报。我们将VMF与BMF之间的差异定义为特质金融因子（IFF）。IFF不承担风险溢价，并且与我们考虑的所有投资者边际效用的宏观经济代理变量均不相关。对于大多数投资组合，相对于BMF，使用VMF测量的CAPM贝塔值以及相应的贴现率被低估。当在标准因子模型中将VMF替换为BMF时，规模因子变得冗余，规模异象得以解决。当用BMF替换VMF时，跨期风险-回报关系显著增强。这些结果的统一解释是，IFF向VMF添加了未定价的风险，从而扭曲了对定价市场风险暴露的横截面和时间序列估计。

【**NBER**】: NBER Working Paper No. 35243，https://www.nber.org/papers/w35243

#### 48. Comparative Advantage and Openness under Global Fragmentation: Lessons from the Past 65 Years

【**Author**】: Joshua Aizenman, Hiro Ito, Jamel Saadaoui
...
【**摘要**】：本文探讨了为什么开放一直是某些地区或国家追赶增长的强大催化剂，而在其他地区，开放之后却出现了趋同停滞、分化或停滞。我们得出结论，在当今地缘经济碎片化的世界中，“开放”远不止是贸易强度或贸易一体化。在贸易网络中的定位、贸易基本面、人力资本、制度能力和稳定性对于贸易驱动生产率增长的潜力至关重要。我们探讨了1960年至2024年间各大洲的全球异质性，使用了每年最多145个经济体的非平衡面板数据，并采用动态方法估计了国家和年份的增长方程。我们构建了一个将实际GDP增长与滞后收入和增长联系起来的基线方程。我们通过引入世界经济中的定位变量来补充传统的增长驱动因素：衡量每个经济体批准的区域贸易安排数量的经济一体化代理变量、商品依赖指标；与出口网络地缘经济脆弱性（GeoV）相关的指标，衡量国家与地缘政治距离较远的伙伴的出口地位；地缘经济连通性（GeoC），衡量贸易关系跨越更广泛地缘政治光谱的程度。GeoC衡量外部“连接者”的定位，这些定位可能通过确保获得更多样化的市场和资源来抵消地缘经济碎片化的成本。值得注意的是，地缘经济联系增加了一个重要的“定位”元素，表明一个国家在地缘政治上联系越紧密，投资-增长联系就越强。国家经济更多样化的定位提高了它们在更多元化的环境中将投资转化为产出的能力。这也表明国家经济增长对“势头”的依赖程度降低，指向更强的冲击吸收能力，证实了面对碎片化压力时，多样化结构对投资增长的好处。

【**NBER**】: NBER Working Paper No. 35242，https://www.nber.org/papers/w35242

#### 49. From People’s War to People’s Rule: Rebel Governance and the Foundations of Inclusive Democracy

【**Author**】: Bhishma Bhusal, Michael Callen, Rohini Pande, Soledad A. Prillaman, Deepak Singhania, Apurva Subedi
...
【**摘要**】：战时叛乱治理如何塑造冲突后的制度？我们在尼泊尔研究这一问题，该国毛主义人民战争（1996-2006年）推翻了延续240年的种姓制君主制，并以毛主义者进入民主政治而告终。冲突期间，毛主义者建立了地方性的“人民政府”，负责司法、征税和提供本地服务。利用空间断点回归设计，我们表明，接触人民政府提高了政治知识和参与度，尤其是在历史上被边缘化的原住民群体（Janajatis）中。接触还重塑了政党制度和政党间竞争：在接触程度更高的地区，候选人遴选委员会中Janajati成员的比例高出26%，这些成员基于新颖的内隐态度数据，表现出更少的亲上层种姓偏见。在完全接触地区，非毛主义政党的Janajati提名率几乎翻倍，这与争夺新动员的选民相一致。近二十年后，接触地区的地方政府在国家能力指数上得分高出0.2-0.3个标准差，并获得13%更多的有条件联邦拨款。这些发现表明，当叛乱团体进入竞争性民主政治时，战时治理制度可以通过公民动员、政党把关和跨党派竞争，促成更具包容性和能力的战后国家。

【**NBER**】: NBER Working Paper No. 35241，https://www.nber.org/papers/w35241

#### 50. Preference for Explainable AI
...
【**摘要**】：参与者扮演贷款官员，利用人工智能的违约风险预测，决定是否批准由一家美国私人贷款机构发放的1万美元真实贷款。当解释显示人工智能惩罚了非白人或女性借款人时，参与者更有可能推翻人工智能的利润最大化建议。然而，当他们的奖金取决于还款情况时，他们寻求预测但避免解释，这与故意无知一致；当解释被框定为纯粹财务性的或人口统计信息被隐藏时，这种效应消失。一项辅助实验揭示了一种新的偏见：参与者未能进行条件推理，并且低估了解释的价值，即使这些解释补充了私人信息并提高了决策准确性。

【**NBER**】: NBER Working Paper No. 35240，https://www.nber.org/papers/w35240

#### 51. The Heterogeneous Bank Lending Channel of Monetary Policy

【**Author**】: Jorge Abad, Saki Bigio, Salomon Garcia-Villegas, Joël Marbet, Galo Nuño
...
【**摘要**】：银行利率风险暴露的异质性如何塑造货币政策传导？我们构建了一个异质性银行的定量宏观经济模型来回答这个问题。我们建立了一个无关性结果：固定利率和浮动利率银行体系之间利率风险暴露的差异，仅当银行偿付能力问题变得相关时才影响传导。将模型校准至欧元区，我们表明，特质性违约风险将相当大比例的银行推向偿付能力阈值，使得异质性在数量上变得重要。当政策利率上升时，固定利率银行遭受净息差压缩——融资成本增加而存量贷款收入保持不变——侵蚀资本并引发更剧烈的去杠杆化。固定利率经济体中，贷款对货币政策的弹性高出三分之一。这种影响延伸到金融稳定：紧缩政策提高了固定利率体系中的银行破产率，同时降低了浮动利率体系中的破产率。这些结果为宏观审慎与货币政策协调以及货币政策渐进主义提供了理由。

【**NBER**】: NBER Working Paper No. 35239，https://www.nber.org/papers/w35239

#### 52. The Human Capital Production Function: New Estimates and Implications for Labor Supply and Taxes

【**Author**】: Han Gao, Michael P. Keane, Kaja Kierulf, Alan Woodland
...
【**摘要**】：本文估计了一个干中学的人力资本生产函数，其中工作时间同时影响当前生产率和未来人力资本。我们表明，标准的Ben-Porath设定是弱识别的：其目标函数在参数空间的一条脊线上近乎平坦，削弱了传统推断。我们开发了一个灵活且良好识别的筛子替代方法，并使用PSID数据估计了一个凹的工作时间技术。将此技术嵌入生命周期模型后，我们发现壮年劳动力对临时工资冲击的劳动供给反应非常小。尽管这些弹性很低，最优劳动所得税却是平坦的，因为它们同时扭曲了当前劳动供给和未来人力资本积累。

【**NBER**】: NBER Working Paper No. 35238，https://www.nber.org/papers/w35238

#### 53. Unlocking Mortgage Lock-In: Equilibrium Effects in a Spatial Housing Ladder Model

【**Author**】: Julia Fonseca, Lu Liu, Pierre Mabille

【**Abstract**】: Mortgage borrowers are "locked in": forgoing moves to hold on to low rates. Lock-in reduces both housing supply, through households who do not sell, and demand, through households who do not buy elsewhere, evidenced by a 40% drop in U.S. existing home sales between 2022 and 2024. We show that mortgage lock-in raises net housing demand: missing downsizers stay in larger homes, particularly in expensive areas, demanding more housing and offsetting a third of the aggregate house price decline caused by higher rates. Using individual-level mortgage data, we provide causal evidence that lock-in disproportionately reduces moves down the housing ladder. We design a spatial housing ladder model with long-term mortgages, which generates a distribution of locked-in rates and a causal effect on mobility consistent with the data, and use it to study the equilibrium effects of lock-in. A temporary rate hike causes lock-in, increasing aggregate house prices by 4.4% and rents by 1.5% relative to a counterfactual without lock-in, while mortgage borrowers' mobility falls by 25%. A $\$10$k tax credit to starter-home sellers modestly increases mobility but raises trade-up home prices. We estimate a cost of $\$650$k per marginal move, indicating that demand-based housing policies are poorly targeted responses to lock-in in our model.

【**摘要**】：抵押贷款借款人被“锁定”：放弃搬家以维持低利率。锁定效应通过不出售的住户减少住房供给，并通过不在其他地方购买的住户减少需求，这由2022年至2024年间美国现有房屋销售下降40%所证明。我们表明，抵押贷款锁定提高了净住房需求：未搬家的换小房者留在更大的房屋中，尤其是在昂贵地区，从而需求更多住房，抵消了因利率上升导致的总体房价下跌的三分之一。利用个人层面的抵押贷款数据，我们提供了因果证据，表明锁定效应不成比例地减少了沿住房阶梯向下的搬家。我们设计了一个包含长期抵押贷款的空间住房阶梯模型，该模型生成了锁定利率的分布以及对流动性的因果效应，与数据一致，并用于研究锁定效应的均衡效应。临时加息导致锁定效应，相对于无锁定的反事实，总体房价上涨4.4%，租金上涨1.5%，而抵押贷款借款人的流动性下降25%。向首次购房者卖家提供1万美元税收抵免，适度提高了流动性，但推高了换大房价格。我们估计每增加一次搬家的成本为65万美元，这表明在我们的模型中，基于需求的住房政策对锁定效应的应对目标不精准。

【**NBER**】: NBER Working Paper No. 35237，https://www.nber.org/papers/w35237

#### 54. Firm-Worker Matches: Experience or Inspection Goods?

【**Author**】: Victoria Gregory, Guido Menzio, Giovanni M. Topa
...
【**摘要**】：我们提出了一种新颖的实证策略，以推断企业-工人匹配在多大程度上是检验品或体验品。我们认为，在建立雇佣关系之前，企业和工人收到的关于匹配生产率的信号的信息含量，可以从失业者、低任期工作就业者和高任期工作就业者中雇用的工人的离职率差距中推断出来。我们使用德国行政数据实施该策略。我们发现，在建立雇佣关系之前，企业和工人收到一个信号，该信号将他们对匹配生产率的信念方差减少了67%。信号的信息含量因工人的性别和教育程度而异，并且随着时间的推移而增加。如果匹配是纯检验品，劳动生产率将提高1.5%，产出将提高2%。如果匹配是纯体验品，劳动生产率将降低2%，产出将降低4%。

【**NBER**】: NBER Working Paper No. 35236，https://www.nber.org/papers/w35236

#### 55. Cheapflation Cycles

【**Author**】: Kunal Sangani
...
【**摘要**】：我们记录了通胀不平等波动的一个新来源。当上游投入成本上升时，产品类别内的品种往往有相似的绝对价格上涨。然而，相同的绝对价格上涨对低价产品构成更大的百分比变化，导致低端产品出现超额通胀（“廉价通胀”）。由于低收入家庭倾向于购买较低价格的品种，他们面临的通胀率对上游成本不成比例地敏感。利用家庭食品购买数据，我们表明，这一机制产生了通胀不平等的周期，以及低收入家庭相对于高收入家庭通胀的过度波动。这一渠道简洁地解释了通胀不平等随时间观察到的波动，包括在大衰退和2021-2023年疫情后通胀期间廉价通胀和通胀不平等的激增。官方统计掩盖了这些类别内的通胀差异，因此将低收入和高收入家庭经历的通胀差异低估了70-90%。我们提供证据表明，这一机制适用于除家庭食品之外的一系列消费类别。同样的机制还导致，在应对全国性和全球性成本冲击时，不同城市之间的通胀以及不同国家的进口价格通胀出现系统性差异。

【**NBER**】: NBER Working Paper No. 35235，https://www.nber.org/papers/w35235

#### 56. Attorney Value-Added and Racial Disparities in the Criminal Justice System

【**Author**】: Maya Mikdash, Mark Hoekstra, Suhyeon Oh
...
【**摘要**】：种族差异渗透到刑事司法系统中，然而尽管公设辩护律师代表了80%的被告，他们仍未得到充分研究。利用德克萨斯州一个大县准随机法院指定的律师，我们表明，更高质量的律师经验较少，且毕业于质量较低的法学院。低质量代理对黑人被告的伤害不成比例：质量每提高一个标准差，黑人被告的驳回率提高幅度几乎是白人的两倍（7.1%对3.9%），而前10%质量的代理使驳回率提高12-17%，监禁率降低13-22%，相对于白人而言。粗略计算表明，如果一半的法院指定律师具有前10%的质量，监禁判决中的种族差距将下降11%。

【**NBER**】: NBER Working Paper No. 35234，https://www.nber.org/papers/w35234

#### 57. The Educational Impacts of School Phone Bans: Evidence from Brazil

【**Author**】: Guilherme Lichand, Luca Moreno-Louzada, Thiago da Costa, Matthew Gentzkow
...
【**摘要**】：通过在加拿大两所主要大学进行的四项大规模实验，我们实验性地评估了成长心态和社会归属感干预对学生结果的影响。在近12,000名学生的样本中，我们发现这些干预对学生成绩没有即时或动态影响，对大学持续就读也没有影响。我们进一步结合调查数据和行政数据与机器学习方法探索处理效应异质性，发现没有证据表明学生子群体之间存在有意义的处理效应变异。尽管这些轻触式干预近期展现出前景，但我们的发现表明，需要进一步研究以确定其益处能够推广的情境。

【**NBER**】: NBER Working Paper No. 35230，https://www.nber.org/papers/w35230

#### 61. The Limits of Targeted Hiring Subsidies: Evidence from the Work Opportunity Tax Credit

【**Author**】: Manisha Jain, Corina Mommaerts, Jeffrey Weaver
...
【**摘要**】：雇主方工资补贴被广泛用于促进弱势工人的就业。我们利用联邦工作机会税收抵免来研究此类补贴如何转化为企业的雇佣行为，该补贴最高可补贴第一年工资的40%，每年覆盖超过200万次雇佣。通过使用威斯康星州的关联行政数据和多种准实验设计，我们发现，在不同设计和企业类型中，对雇佣、收入、留任及相关结果的影响一致且精确地为零。关于企业雇佣实践的原始数据表明，限制雇主方补贴有效性的两种机制是：感知的法律风险阻碍了资格筛查，以及组织摩擦削弱了决策者的响应能力。

【**NBER**】: NBER Working Paper No. 35229，https://www.nber.org/papers/w35229

#### 62. Industrial Concentration, Property Values, and Municipal Bond Spreads
...
【**摘要**】：本文表明，城市地方经济的产业构成会影响其市政借款成本。在2005年至2022年1,177个美国城市的面板数据中，更大的部门集中度放大了违约风险并提高了债券利差，尤其是在以低房产价值行业为主导的城市。利用国家部门就业趋势和区域房价变动的工具变量支持了因果解释。一个校准的城市违约模型表明，观察到的利差效应低估了集中度产生的总风险，因为更高的集中度可以产生集聚效益从而降低利差，特别是对于高房产价值城市而言。

【**NBER**】: NBER Working Paper No. 35228，https://www.nber.org/papers/w35228

#### 63. The Optimal Use of AI in Financial Regulation

【**Author**】: Christopher Clayton, Antonio Coppola
...
【**摘要**】：我们研究将人工智能方法应用于大规模投资组合持有数据是否能改善宏观审慎金融监管。我们构建了一个基于图的深度学习模型，专门针对金融中介机构持有的证券级数据。该架构融入了经济先验知识，并从投资组合头寸的网络结构中学习资产和投资者的潜在表征。将该模型应用于覆盖近40万亿美元财富的非银行金融中介机构整体，其在预测中介交易行为（包括危机时期）的样本外表现上大幅优于现有方法。在压力事件期间，该模型对资产回报横截面变异的解释力是传统方法的十倍以上，并且在机构层面优于现有的系统性风险指标。其学习到的表征表明，持有网络编码了关于火线抛售脆弱性的丰富且具有经济可解释性的信息。该架构是完全归纳式的，即使整个资产类别或投资者被排除在训练之外，也能产生信息丰富的估计。我们将实证方法嵌入宏观审慎最优政策框架，以正式说明这些对象为何对政策和福利至关重要。我们证明，即使在受卢卡斯批判影响的均衡环境中，模型的预测信息通过增强政策干预的横截面针对性来改善福利，并且我们展示了预测与结构性知识之间的互补性。

【**NBER**】: NBER Working Paper No. 35227，https://www.nber.org/papers/w35227

#### 64. A Promise Worth Keeping? Impacts of Free Community College on Degrees and Earnings

【**Author**】: Paige Schoonover, Jonathon Attridge, Celeste K. Carruthers, Jilleah G. Welch

【**Abstract**】: We study Tennessee Promise, Tennessee’s tuition-free community college program, which preceded similar programs in over twenty states and multiple federal proposals. We examine how Promise affected college enrollment and early adult outcomes as the program expanded from a single-county pilot to statewide eligibility. Promise increased college enrollment by 5.4 percentage points among 19-year-olds, increased transfers from two-year to four-year schools, increased associate’s degree attainment by 2.9 percentage points among 21-year-olds, imprecisely increased bachelor’s degree attainment by age 24, and weakly increased income from age 21. We estimate that the program pays for itself under reasonable assumptions about returns to college.

【**摘要**】：我们研究了田纳西承诺计划，即田纳西州的免学费社区大学项目，该项目先于二十多个州的类似项目和多项联邦提案。我们考察了该计划如何影响大学入学和早期成人结果，因为该计划从单一县的试点扩展到全州范围的资格。承诺计划使19岁青年的大学入学率提高了5.4个百分点，增加了从两年制学校向四年制学校的转学，使21岁青年的副学士学位获得率提高了2.9个百分点，对24岁前的学士学位获得率有不精确的提高，并微弱地提高了21岁起的收入。我们估计，在关于大学回报的合理假设下，该计划能够收回成本。

【**NBER**】: NBER Working Paper No. 35226，https://www.nber.org/papers/w35226

#### 65. States as Financiers: International Lending in War and Peace
...
【**摘要**】：国家是重要的国际金融家，但其作用尚不为人所充分理解。我们利用一个新数据库研究两个世纪以来由国家驱动的跨境贷款，该数据库涵盖了自1790年以来134个政府和70个多边机构提供的120万笔官方贷款和赠款。我们记录了国际信贷的一种双重、依国家状态而定的结构。在正常时期，私人债权人主导跨境贷款。在世界处于不利状态时，例如战争和金融危机，官方债权人会介入，有时规模巨大。这些官方资金流动由大国驱动，获得高度补贴，并且在国际宏观经济学的经典模型中基本被忽略。

【**NBER**】: NBER Working Paper No. 35225，https://www.nber.org/papers/w35225

#### 66. Credit Supply, Firms, and Earnings Inequality

【**Author**】: Christian Moser, Farzad Saidi, Benjamin Wirth, Stefanie Wolter
...
【**摘要**】：我们研究了货币政策引发的信贷供给在德国劳动力市场中的分配效应。与那些更易受到2014年引入负利率影响的银行有业务往来的企业，经历了信贷供给的相对收缩，这伴随着平均工资的下降。在企业内部，最初收入较低的工人更有可能离开工作岗位，而最初收入较高的工人则经历了工资的相对下降。在企业之间，工资在最初支付较高的雇主那里下降得更多。我们的结果表明，信贷同时影响企业内和企业间的工资与就业分布。

【**NBER**】: NBER Working Paper No. 35224，https://www.nber.org/papers/w35224

#### 67. Management of Health Care Facilities and Patient Attendance during Major Disruptions: Evidence from Kenya

【**Author**】: Kathryn Andrews, Fabiano Dal-Ri, Roberta Gatti, Renata Lemos, Mario Macis, Lydia Nakhone
...
【**摘要**】：本文利用一项全国代表性调查和关联的行政数据，衡量并分析了肯尼亚医疗部门的管理实践。本文改编了世界管理调查，以衡量初级医疗设施和医院的管理质量，调查了429个初级医疗设施和73家医院。初级医疗设施是大多数患者的主要接触点，提供常见传染病和慢性病的治疗，以及与母婴健康相关的服务。管理质量平均较低，且分布高度集中。该分析利用行政数据，在包括COVID-19大流行和公共卫生工作者罢工的干扰期间，检验了初级医疗设施的管理质量与其绩效（以门诊就诊率衡量）之间的关联。在此期间，总体就诊率下降。私营设施的下滑幅度小于公共设施，这与罢工期间的替代效应一致。在私营部门内，管理较好的设施表现出更强的韧性，这主要由运营管理驱动。这些结果强调了管理质量在加强设施层面韧性中的作用，以及公共和私营部门在吸收医疗冲击方面的互补性。

【**NBER**】: NBER Working Paper No. 35223，https://www.nber.org/papers/w35223

#### 68. Explaining Movements in Government Debt

【**Author**】: Tatiana Kirsanova, Eric M. Leeper, Campbell B. Leith, Ding Liu
...
【**摘要**】：具有时间一致性政策的标准新凯恩斯模型预测，债务对常规冲击的反应极小，因为债务稳定偏差压倒了税收平滑动机。我们表明，两种机制可以产生数据中观察到的债务变动幅度：政策制定者短视程度的增加和实际利率的下降（例如在避险时期）。其他潜在驱动因素——加成率、债务期限、政府转移支付的变化或严重衰退——无法解释此类波动。

【**NBER**】: NBER Working Paper No. 35222，https://www.nber.org/papers/w35222

#### 69. Proposed Mergers Where Efficiencies Are Needed Most Might Be the Least Likely to Deliver Them

【**Author**】: Robert D. Metcalfe, Alexandre B. Sollaci, Chad Syverson
...
【**摘要**】：合并通常通过权衡其预期的市场势力效应与所产生的效率收益来评估。拟议合并的市场势力效应越大，其提高社会福利所需的效率就必须越大。我们表明，合并提案的选择扭曲了观察到的市场势力与效率效应之间的关系。即使市场势力与效率收益在所有潜在合并中是独立的（甚至正相关），它们在拟议合并中通常也会呈负相关。这是因为各方只有在合并的预期盈利能力超过阈值时才提议合并，因此盈利能力的潜在组成部分在跨越该门槛时成为替代品。这并不依赖于管理偏见、行为摩擦或策略性误报。我们证明，当这两个效应在所有合并中不相关时，这种负相关在非常一般的条件下存在。我们还描述了即使在存在正的基础相关性以及企业对其自身合并盈利能力存在不确定性的情况下，这种负相关仍然成立的条件。可能提高拟议合并选择门槛的政策并不会缓解这种负相关；实际上，它们会加剧这种负相关。我们的分析对解释实证合并回顾以及评估反垄断政策中的效率抗辩具有直接意义。

【**NBER**】: NBER Working Paper No. 35221，https://www.nber.org/papers/w35221

#### 70. Trust, Financial Literacy, and Financial Behaviors: Shaping Retirement Security

【**Author**】: Maya Haran Rosen, Annamaria Lusardi, Olivia S. Mitchell
...
【**摘要**】：我们通过考察与退休保障相关的信任、金融素养和金融行为，拓展了关于信任对金融行为重要性的文献。利用健康与退休研究，我们表明对金融机构的信任与支持退休保障的行为一致，而对政府项目的信任则不然。我们进一步记录了种族/族裔差异：对于白人受访者，对金融机构的信任与退休结果正相关，但对黑人或西班牙裔受访者则不然。此外，少数族裔家庭对政府项目的信任与股票持有减少和财富积累降低相关。这些发现为加强退休保障的努力提供了信息。

【**NBER**】: NBER Working Paper No. 35220，https://www.nber.org/papers/w35220

#### 71. Lands of Opportunity: Differences in the Geography of Wealth and Income Mobility in the United States
...
【**摘要**】：我们提供了新的县级代际流动性估计，涵盖多个经济概念：总收入、劳动收入、房屋所有权、住房财富和总财富。这通过小区域估计技术以及覆盖数百万1978年至1986年间出生的美国儿童的关联调查和行政数据得以实现。我们发现，财富概念的相对流动性比收入概念的相对流动性表现出更少的空间聚集和更多的空间变异。许多城市及其郊区在财富概念上的相对流动性（即更高的代际持续性）低于收入概念。接下来，我们表明各种地方特征与某些经济流动性概念相关，但与其他概念无关。例如，我们估计大衰退的地方严重程度与儿童收入之间存在强烈的负相关，无论父母在收入分配中的位置如何。然而，衰退严重程度与财富之间的负相关仅存在于来自较贫困家庭的儿童中。我们提供了一个公共使用的数据包以促进进一步研究。

【**NBER**】: NBER Working Paper No. 35219，https://www.nber.org/papers/w35219

#### 72. California Billionaires: Wealth, Taxes, and Wealth Tax Revenue Estimates

【**Author**】: Jasper Boll, Emmanuel Saez, Gabriel Zucman
...
【**摘要**】：本文记录了加州亿万富翁的财富及其缴纳的税款。如今，加州亿万富翁的财富超过2万亿美元，相当于加州GDP的50%。受人工智能热潮推动，其财富从2023年到2025年增长了144%。从更长期来看，加州亿万富翁阶层——最富有的0.0002%家庭——的实际财富从1982年到2025年增长了30倍，而加州实际平均家庭收入大约翻了一番。加州亿万富翁缴纳的加州所得税约占其财富的0.2%（每年32亿美元），在2023-2025年间平均占加州所得税总收入的2.4%。利用自2004年以来来自Alphabet、Meta、Oracle和Nvidia的美国证券交易委员会数据，我们估算了前四位加州亿万富翁——佩奇、布林、扎克伯格、埃里森（截至2020年）和黄仁勋（自2021年起）——的财富、收入和缴纳税款的轨迹，重点关注其商业财富。仅这一群体就持有近1万亿美元的商业财富，几乎占加州亿万富翁总财富的一半。对于这一群体，财富增长（2023-2025年间增长322%）和低税率（每年缴纳的加州所得税占财富的0.04%）更为显著。拟议的一次性加州亿万富翁税（税率为5%，分五年缴纳）相对于加州亿万富翁的财富增长而言较小，但相对于他们目前缴纳的税款而言则较大。我们估计，该税可能筹集约1000亿美元，对所得税收入的影响相对较小。利用对财富税流动性反应的实证估计，我们发现，即使在考虑因流动性导致的所得税损失后，对加州亿万富翁征收年度财富税仍可筹集大量额外收入。

【**NBER**】: NBER Working Paper No. 35218，https://www.nber.org/papers/w35218

#### 73. The Limits of Political Representation: Evidence from India

【**Author**】: Veda Narasimhan, Jeffrey Weaver
...
【**摘要**】：政治包容被广泛认为能够改善治理，这推动了为高度地方化的选区设立民选代表。本文研究了印度农村15万个地方政府中的120万名“超地方”代表。利用决定这些代表人数和身份的不连续性，我们评估了扩大代表性对治理结果的影响。我们发现，在核心职能方面，包括公共项目管理、福利项目获取的中介服务、政策与公民偏好的一致性、福利分配的公平性以及公共财政监督，均存在精确估计的零效应。这些发现凸显了在代表能力薄弱的情况下扩大政治代表性的局限性。

【**NBER**】: NBER Working Paper No. 35217，https://www.nber.org/papers/w35217

#### 74. Divergence in Climate Change Communication: LLM-Based Evidence from the IPCC and the Press

【**Author**】: Sebastian Galiani, Franco Mettola La Giglia, Raul A. Sosa
...
【**摘要**】：IPCC气候评估的公开摘要倾向于技术证据中更严重的一端。这种模式出现在两个阶段：IPCC的主要作者和成员国政府从技术摘要中生成决策者摘要，随后报纸对决策者摘要进行报道。我们使用大语言模型对所有六次评估报告（1990年至2023年）以及美国与英国十家主要媒体的约11.4万对匹配声明进行评分。两个阶段都系统性地向来源中更严重的一端偏移，同时保持在IPCC认可的科学范围内。这种偏移主要源于在报告范围内强调更高影响幅度，较少来自不确定性压缩，几乎不来自选择最坏情景的排放路径。左倾和右倾媒体表现出相似的模式。

【**NBER**】: NBER Working Paper No. 35216，https://www.nber.org/papers/w35216

#### 75. Valuing Disaster Prevention: Desert Locust Monitoring and Control

【**Author**】: Joséphine Gantois, Anouch Missirian, Evelina Linnros, Anna Tompsett, Amir Jina, Gordon C. McCord, Eyal G. Frank
...
【**摘要**】：灾害预防监测系统成本高昂，而当监测努力具有内生性时，衡量其效益十分困难。我们利用三十年的沙漠蝗虫监测数据，首次提供了此类系统影响的因果估计。我们记录了冲突导致的偏远繁殖区监测中断，重建了虫害如何蔓延至人口稠密地区，并表明出生前后暴露于蝗虫群会降低儿童年龄别身高，使发育迟缓风险增加超过7个百分点。取消蝗虫监测系统将导致每年250亿美元的损失，仅从儿童营养效益来看，效益成本比就在160:1至680:1之间。

【**NBER**】: NBER Working Paper No. 35215，https://www.nber.org/papers/w35215

#### 76. The Psychology of Macroeconomic Expectations

【**Author**】: Pedro Bordalo, Nicola Gennaioli, Florencio Lopez-de-Silanes, Simon G. Schröder, Andrei Shleifer, Maarten van Rooij
...
【**摘要**】：我们提出了一个“动物精神”模型，其中情境和情绪通过塑造人们回忆哪些经历来模拟相似的未来总体状态，从而影响宏观经济信念。我们通过启动荷兰国家银行调查的受访者回忆个人财务或健康困境，然后引出通胀和房价预期，来检验这一机制。这种处理导致信念和推理的不稳定性，这与被启动经历与不同宏观状态之间测量的相似性相关。这种相似性结构也解释了基于我们测量的其他个人经历在信念和推理上的异质性。该模型为宏观经济信念的若干特征（包括叙事）提供了微观基础，并产生了一个“信心乘数”：部分主体的支出为其他主体提示了乐观情境，从而提高了他们的支出。

【**NBER**】: NBER Working Paper No. 35214，https://www.nber.org/papers/w35214

#### 77. Sophisticated Borrowing Constraints and Macroeconomic Dynamics

【**Author**】: Al-Mahdi Ebsim, Chen Lian, Yueran Ma, Pablo Ottonello, Diego J. Perez
...
【**摘要**】：在传统的宏观金融模型中，企业的债务合同施加了硬性借贷约束，当不利冲击收紧这些限制时，要求不加区分地减少借贷和投资，从而产生金融加速器效应。我们研究了类似于美国大型非金融企业财务契约的“复杂借贷约束”的宏观经济含义，这些约束通常基于企业债务相对于营业利润来设定。我们将这些约束建模为债务阈值，当违反时触发控制权向债权人转移，此时债权人影响企业决策以最大化其价值，而不是无条件地削减信贷以遵守固定比率。在微观层面，我们的模型在数量上与违反契约时投资和盈利的经验模式一致。在宏观层面，复杂的借贷约束不会产生金融加速器效应，因为约束收紧和违反不会导致债权人不加区分地缩减企业规模。

【**NBER**】: NBER Working Paper No. 35213，https://www.nber.org/papers/w35213

#### 78. Old Space, New Space: A Commercial Revolution in Innovation?

【**Author**】: Ruben Gaetani, Alexander T. Whalley
...
【**摘要**】：像SpaceX和蓝色起源这样的公司的出现，使太空成为私营企业推动创新的主要例子，标志着许多人认为的旧太空与新太空之间的明显断裂。然而，很少有系统性证据记录向这一新阶段太空创新的过渡何时发生，以及哪些公司推动了这一过渡。我们使用专利数据来提供这一衡量，并发现太空创新的最大激增发生在20世纪90年代，与需求侧市场创造相吻合，并早于2005年后备受瞩目的初创企业的进入。在整个这一时期及之后，老牌航空航天公司占据了大部分与太空相关的专利，新进入者贡献了不断增长但仍是少数的份额。在后阿波罗时代主导太空创新的相同地理区域至今仍占主导地位。这些模式与定向技术变革一致：老牌公司将研发导向政策创造且现有能力可及的市场，而新进入者则将基于科学的见解引入需要新范式的领域。我们的发现表明，新太空与旧太空的联系比主流叙事所暗示的更为紧密，并且政府在太空创新中最具影响力的作用可能在于构建可获取的市场。我们为未来研究提供了与太空技术相关的专利数据。

【**NBER**】: NBER Working Paper No. 35212，https://www.nber.org/papers/w35212

#### 79. Endogenous Task Bundling, Skills and Automation
...
【**摘要**】：关于人工智能工资效应的实证测量通常将工人所获报酬的任务组合固定在其人工智能前的形态。我们认为这一假设掩盖了大部分作用机制。当自动化将一个工作分解时，企业决定如何重新组合幸存的活动；无论它们是将这些活动重新捆绑成一个宽泛的岗位，还是拆分成专业岗位，都会改变劳动力市场实际奖励哪些幸存技能。一个在人工智能前工资中不起作用的技能可能成为人工智能后工资的主导组成部分，而一个在人工智能前工资中起锚定作用的技能可能从工资表中消失。我们开发了一个分配模型，其中定价的人力组合是内生的，并利用该模型表明，固定组合的工资回归可能会错误地指示人工智能暴露的影响。一般而言，遗漏的重新设计偏差没有无条件符号：它是暴露与特定岗位重新设计项之间的残差协方差。在明确的充分条件下，与暴露相关的去捆绑将专业比较优势溢价加载到暴露系数上，而与暴露相关的重新捆绑则加载了一个不同的、通常是相反的遗漏项。因此，必须根据局部的人工智能后岗位划分变化来测量符号，而不是仅根据暴露来假设。

【**NBER**】: NBER Working Paper No. 35211，https://www.nber.org/papers/w35211

#### 80. Medical Innovation and Racial Health Disparities: Evidence from a Breakthrough Treatment
...
【**摘要**】：医学创新是加剧还是缩小种族健康差异仍是一个悬而未决的问题。我们研究了表面活性剂替代疗法，这是一种针对患有呼吸系统疾病的早产儿的救命干预措施。在1989年获得美国食品药品监督管理局批准之前，早产黑人婴儿因呼吸相关原因死亡的可能性远低于白人婴儿。在FDA批准后的几年内，呼吸相关新生儿死亡率的黑白差距基本消失。利用1980-2000年的人口统计数据，并以非呼吸相关死亡率作为反事实结果，我们发现黑人和白人都受益于表面活性剂替代疗法的引入，但白人新生儿经历了更大且更即时的死亡率下降。我们估计，到1993年，表面活性剂替代疗法使白人新生儿的呼吸相关死亡率降低了46%，而黑人新生儿仅降低了30%。这些结果无法用医疗保健可及性的差异来解释，如社会经济地位或到最近新生儿重症监护病房的距离。我们得出结论，胎儿肺成熟的种族差异，而非获取障碍，可能导致了表面活性剂替代疗法对新生儿死亡率的不均衡影响。

【**NBER**】: NBER Working Paper No. 35210，https://www.nber.org/papers/w35210

#### 81. State Dependence of Monetary Policy During Global Supply Chain Disruptions

【**Author**】: Xiwen Bai, Jesús Fernández-Villaverde, Yiliang Li, Francesco Zanetti
...
【**摘要**】：我们研究了全球供应链中断如何影响货币政策的传导。疫情后的证据表明，运输成本飙升、商品市场失衡以及物价上涨。我们构建了一个模型，其中物流瓶颈（上游闲置与下游短缺并存）使总供给曲线变得陡峭。这种凸性放大了价格对货币政策的反应，同时抑制了产出效应。阈值向量自回归（VAR）和局部投影（Local Projection）的估计结果与这一机制一致：在供应链中断期间，紧缩性政策以较小的产出成本更有效地降低价格，从而缓解了稳定目标的权衡困境。

【**NBER**】: NBER Working Paper No. 35209，https://www.nber.org/papers/w35209

#### 82. Estimating the Present Value of R&D Tax Benefits in the United States

【**Author**】: Brandon Pecoraro, Nicholas C. Hoffman, Martin Lopez-Daneri, Elena C. Derby, Rachel Moore, Shannon E. Sledz
...
【**摘要**】：利用一组保密的公司纳税申报表面板数据，我们首次直接估算了美国企业因研发税收抵免和扣除而实际获得的税收优惠现值。实际税收优惠可能与法定税收优惠存在偏差，因为处于亏损状态的企业通常无法完全利用抵免和扣除来抵消当年税款，而必须将这些税收属性结转至以后年度。我们开发了一种新颖的方法来追踪企业研发支出所产生的税收属性在时间维度上的企业层面利用情况，并发现研发税收优惠的现值因企业的亏损状态、年龄和规模而存在显著差异。老牌大型企业通常能迅速利用研发税收优惠，而年轻企业——尤其是小型企业——经常处于亏损状态，利用税收属性的速度较慢。从2012年到2016年，平均每投入1美元研发支出，企业产生0.41美元的法定税收优惠，实际现值为0.36美元。处于亏损状态的年轻小型企业每投入1美元仅实现0.23美元的实际优惠，相比法定基准下降了44%。

【**NBER**】: NBER Working Paper No. 35208，https://www.nber.org/papers/w35208

#### 83. More Paths or More Contrast? A Theory of Experimentation Breadth

【**Author**】: Joshua S. Gans, Luca Gius
...
【**摘要**】：一个组织应如何选择其实验组合的广度？广度有两个不同的维度——保持存活的路径数量以及这些路径之间的对比程度——而先前的研究大多将它们孤立地研究。我们将它们纳入一个统一的框架，并表明它们不必同步变动。在固定的实验预算下，增加路径创造了更多找到强有力方向的机会，但也稀释了跨路径的学习，并削弱了可行的最强对比。当任务主要是在已有可行方案中进行排序时，随着预算增加，更广泛的组合变得更具吸引力。然而，当路径共享共同的可行性不确定性，且实验信号追踪收益相关性时，额外的路径部分地重复了相同的可行性测试，而非提供独立信息。我们识别出了一些条件，在这些条件下，测试恰好两条形成鲜明对比的路径是最优的，这优于单一的深度测试和更广泛的组合。该框架通过阐明每种策略的适用条件，调和了相互冲突的建议——即“多路并行”与“少数尖锐对比”——并解释了为什么对广度的实证衡量不应将选项数量及其相关性视为可分离的维度。

【**NBER**】: NBER Working Paper No. 35207，https://www.nber.org/papers/w35207

#### 84. The Cost of Intermediary Market Power for Distressed Borrowers

【**Author**】: Winston Wei Dou, Wei Wang, Wenyu Wang
...
【**摘要**】：陷入困境的企业需要紧急融资以维持运营并避免低效清算，但它们在由现有债权人阻挠力量和一小群专业贷款机构塑造的集中市场中借款。我们表明，即使在剔除了信用风险、流动性风险和非风险贷款成本的补偿后，这些借款人仍支付异常高的贷款利差。为了量化并分解贷款机构的市场势力，我们开发并估计了一个动态博弈论模型，该模型包含潜在需求异质性、内生贷款机构参与、债权人阻挠力量以及通过重复银团贷款维持的默契合谋。利用关于占有债务人（DIP）贷款和高投机性贷款的细粒度设施层面数据，我们发现，贷款机构的市场势力解释了DIP贷款市场风险调整利差中的533个基点，以及高投机性贷款市场中的300个基点，其中包括每个市场中约140个基点来自默契合谋。因此，贷款机构的市场势力是财务困境成本的一个主要来源，它将关乎生存的关键流动性减少了16-20%，从而加剧了资产价值的破坏。

【**NBER**】: NBER Working Paper No. 35206，https://www.nber.org/papers/w35206

#### 85. Tatonnement and Price Setting in General Equilibrium

【**Author**】: Guido Lorenzoni, Iván Werning
...
【**摘要**】：一般均衡理论中的一个基础性问题——均衡何时是稳定的？——尽管已有重要贡献，但在超过150年的时间里仍未得到根本解决。本文提出了一种解决方案。

【**NBER**】: NBER Working Paper No. 35205，https://www.nber.org/papers/w35205

#### 86. Flood Risk, Insurance, and Housing in the United States

【**Author**】: Suvy Qin, John L. Voorheis
...
【**摘要**】：洪水是美国家庭面临的最显著的自然灾害之一。大量证据记录了洪泛区中不成比例的社会脆弱性模式。然而，关于家庭层面洪水风险暴露如何分布的证据却很少。我们通过将地块层面的洪水风险与美国人口普查局持有的保密的关联调查和行政数据相结合来填补这一空白。尽管近年来净迁入洪泛区人口普查区块的人数有所增加，但基本上没有净迁入存在洪水风险的地块，且居住在洪泛区的家庭总体比例也没有变化。在家庭层面，洪水风险的收入梯度高度非线性，收入分布底部90个百分位数的收入梯度略微为负，但被收入最高十分位数的过度暴露所掩盖，尤其是在考虑多套房产所有权时。这种非线性主要由狭窄收入群体内建筑类型和房屋所有权的差异驱动。与使用汇总数据的文献结论相反，我们的家庭层面分析表明，洪泛区中的家庭处境不那么不利，并且越来越受到保护免受洪水影响，尽管仍存在一个由低收入、未投保的房主组成的脆弱亚群体。

【**NBER**】: NBER Working Paper No. 35204，https://www.nber.org/papers/w35204

#### 87. The Geography of Lifecycle Human Capital Accumulation

【**Author**】: Ben Sprung-Keyser, Sonya Porter
...
【**摘要**】：我们研究了地方如何在整个生命周期中塑造人力资本的生产。我们提出疑问：那些在童年时期最有效地生产人力资本的地方，是否也拥有在成年期做到这一点的本地劳动力市场？我们考虑了工资在各地之间的以下决定因素：1）特定地点的工资溢价，2）因本地劳动力市场暴露而产生的成年期人力资本积累，以及3）童年期人力资本积累。我们利用美国通勤区之间流动人口的AKM风格估计值构建了地点工资溢价的估计值，并利用卡特里娜飓风后新奥尔良居民看似外生的迁出证据验证了这些估计值。接下来，我们考察了流动人口之间不同的收入轨迹，以构建因劳动力市场暴露而产生的人力资本积累估计值。我们利用多次流动人口的工资变化验证了这些估计值。最后，我们利用童年时期迁移的年龄差异来估计地方对童年期人力资本生产的影响。至关重要的是，我们对地点工资溢价和成年期人力资本积累的估计使我们能够构建童年期地方因果效应的估计值，这些估计值不受相关的劳动力市场暴露的混淆影响。利用这些估计值，我们表明，在那些最有效地生产童年期人力资本的地方与那些在成年期做到这一点的本地劳动力市场之间存在一种权衡。我们发现，因成年期劳动力市场暴露导致的收入每增加1个百分位排名，就会与因本地童年期环境导致的收入减少0.5个百分位排名相权衡。这种模式与城市规模密切相关，因为成年期人力资本积累通常随城市规模增加而增加，而童年期人力资本积累则下降。这些不同的轨迹与城市的物理结构以及其中社会互动的性质差异有关。

【**NBER**】: NBER Working Paper No. 35203，https://www.nber.org/papers/w35203

#### 88. Fiscal Policy and Transition Risk

【**Author**】: Stefano Carattini, Garth Heutel, Givi Melkadze, Inès Mourelon
...
【**摘要**】：我们研究了气候政策如何与扭曲性财政政策相互作用，并可能引发转型风险。利用一个包含金融摩擦和预先存在的劳动与资本税的环境动态随机一般均衡模型，我们在不同的碳税收入返还或补贴融资情景下模拟了碳税和减排补贴。我们发现了新颖的政策含义以及碳税与补贴之间的重要差异。在这两种政策下，转型动态可能与长期结果存在显著差异。对于碳税而言，转型动态既取决于金融摩擦，也取决于收入循环利用方式的选择。对于减排补贴而言，由于金融摩擦，扭曲性融资可能产生收缩性的转型动态。宏观审慎政策可以在碳税下缓解转型风险，但在补贴下效果甚微。

【**NBER**】: NBER Working Paper No. 35202，https://www.nber.org/papers/w35202

#### 89. Intertemporal Arbitrage and Optimal Operation of Pumped Hydro Energy Storage

【**Author**】: Isabel Figuerola-Ferretti, Eduardo S. Schwartz
...
【**摘要**】：水电是一种可再生且灵活的能源，可提供必要的储能容量并增强电网稳定性。在储能技术中，抽水蓄能（PHES）仍然是长时储能最具成本效益的解决方案，并在可再生能源渗透率日益提高的电力系统中发挥关键作用。随着能源转型下电价变得愈发重要，从金融角度理解PHES资产的最优运营和估值也日益关键。本文构建了一个基于市场的框架，将PHES设施建模为在自由化电力市场中追求利润最大化的资产。通过使用基于La Muela抽水蓄能电站真实技术和运营参数校准的最优控制方法，并结合西班牙批发市场的观测电价，该模型推导出一个经济直觉上合理的触发（切换）价格，该价格在考虑水库水量动态和电价不确定性的同时，支配最优抽水和发电决策。结果表明，水量动态和电价季节性对PHES估值和最优运营至关重要。

【**NBER**】: NBER Working Paper No. 35201，https://www.nber.org/papers/w35201

#### 90. Credibility and Precommitment in Socialist Constitutionalism
...
【**摘要**】：本文考察了智利1972年在萨尔瓦多·阿连德总统领导下起草新宪法的倡议。我分析了该项目产生的政治和经济背景，以及该草案试图通过以生产资料公有制和中央计划为核心的社会主义经济和政治计划来推进的制度机制。我将智利的提案与德意志民主共和国和捷克斯洛伐克的社会主义宪法进行了比较。该草案从未像阿连德设想的那样提交全民公决，随后便消失无踪，近二十年无法获取。值得注意的是，该提案吸引的学术关注非常有限。

【**NBER**】: NBER Working Paper No. 35200，https://www.nber.org/papers/w35200

#### 91. How do Workers Learn? Theory and Evidence on the Roots of Lifecycle Human Capital Accumulation

【**Author**】: Xiao Ma, Alejandro Nakab, Daniela Vidart
...
【**摘要**】：工人学习的来源如何随生命周期变化，这又如何影响人力资本和工资？利用德国和美国的数据，我们记录了内部学习（来自同事）随经验增加而减少，而外部学习（在职培训）则呈倒U型。我们构建了一个包含多种学习来源的搜索模型，这些来源的回报会随着工人年龄增长和人力资本积累而演变。定量结果表明，来源之间的相互作用是生命周期工资动态以及远程工作影响的关键，远程工作会破坏内部学习和早期职业工资增长，尽管外部学习部分抵消了这些损失。

【**NBER**】: NBER Working Paper No. 35199，https://www.nber.org/papers/w35199

#### 92. The Effects of GLP-1 Use on Mental Health, Self-rated Health, Employment and Marriage

【**Author**】: Robert Kaestner, Cuiping Schiman
...
【**摘要**】：在本文中，我们利用GLP-1药物在糖尿病患者中近期快速普及的现象，来衡量使用这些药物对心理健康、自评健康、就业和婚姻的影响。GLP-1使用所导致的显著体重减轻可能会影响这些结果，而评估GLP-1使用的这些更广泛影响的证据对于评估其全部价值是必要的。我们使用纵向（个体内）回归方法获得估计值。结果表明，GLP-1使用与心理健康、自评健康、就业和婚姻没有显著关联。总体而言，我们的分析为GLP-1使用如何影响糖尿病患者的生活增添了新的证据。

【**NBER**】: NBER Working Paper No. 35198，https://www.nber.org/papers/w35198

#### 93. Global Policy Spillovers: How Environmental Policies Propagate through Product Attributes

【**Author**】: Koichiro Ito, James M. Sallee, Jonathan (Andrew) Smith
...
【**摘要**】：当企业为全球市场设计产品时，政策制定者应如何评估政策影响？标准的经济分析通常侧重于国内结果，隐含地假设政策仅影响其实施的司法管辖区。然而，跨国公司通常会在不同市场间协调产品设计，这导致一国实施的政策可能通过产品属性的变化产生全球溢出效应。我们将这种现象称为“属性传播”，并构建了一个框架来衡量和评估其定量重要性。将该框架应用于一项影响汽车的环境政策，我们发现日本的燃油经济性补贴显著改善了在美国销售的车辆的燃油经济性。随后，我们构建了一个以跨市场成本互补性作为驱动属性传播关键机制的跨国汽车市场模型。利用估计的模型，我们进行了反事实模拟，以量化考虑政策全球溢出效应后的环境效益。我们发现全球溢出效应是一阶重要的——日本政策所导致的二氧化碳减排量大部分是通过其对美国汽车市场的影响实现的。这些发现表明，忽略属性传播的标准经济分析可能会严重低估政策的全部影响。更广泛地说，属性传播为评估全球经济中的环境、安全、反垄断和技术政策提供了新的视角。

【**NBER**】: NBER Working Paper No. 35197，https://www.nber.org/papers/w35197

#### 94. Making Sense of Labor Market Indicators Amid Data Imperfections

【**Author**】: Scott A. Brave, Erin E. Crust, Stefano Eusepi, Bart Hobijn, Ayşegül Şahin

【**Abstract**】: Interpreting real-time labor market conditions is challenging because commonly used indicators are noisy, revised over time, and often send conflicting signals. In practice, policymakers and market participants describe labor market developments using a shared narrative language centered on labor demand, labor supply, and matching frictions. In this paper, we show that empirical measures of these narrative concepts can be recovered from latent factors that summarize the joint movements of a broad set of high-frequency U.S. labor-market indicators. We use ninety-four labor-market indicators, over the period from 1960 to 2026, and construct measures for labor demand, long-run labor supply, short-run labor supply, and matching efficiency by selecting the factors that satisfy a limited set of restrictions on how underlying forces map into observed data. We find that labor demand and short-run labor supply account for most of the common variation in labor-market indicators. Our results also show that assigning narrow interpretations to individual indicators can lead to misleading conclusions about underlying labor market conditions. Applying the framework to the post-pandemic period reveals that although labor demand recovered briskly after the acute phase of the pandemic, it cannot account for the large rise in vacancies and quits. Instead, movements in short-run labor supply and matching efficiency play a central role. We also show that the “soft-landing” episode from 2023 through 2025 was characterized by a joint decline in labor demand and short-run labor supply, which slowed payroll growth while generating only a moderate increase in the unemployment rate.

【**摘要**】：解读实时劳动力市场状况颇具挑战性，因为常用指标存在噪音、会随时间修正，且常常发出相互矛盾的信号。在实践中，政策制定者和市场参与者使用围绕劳动力需求、劳动力供给和匹配摩擦的共同叙事语言来描述劳动力市场发展。在本文中，我们表明这些叙事概念的经验度量可以从总结美国大量高频劳动力市场指标共同变动的潜在因子中恢复。我们使用1960年至2026年期间的94个劳动力市场指标，通过选择满足一组关于潜在力量如何映射到观测数据的有限限制的因子，构建了劳动力需求、长期劳动力供给、短期劳动力供给和匹配效率的度量。我们发现劳动力需求和短期劳动力供给解释了劳动力市场指标中大部分的共同变动。我们的结果还表明，对单个指标进行狭隘解读可能导致对潜在劳动力市场状况的误导性结论。将该框架应用于疫情后时期，发现尽管劳动力需求在疫情急性期后迅速恢复，但它无法解释职位空缺和离职率的大幅上升。相反，短期劳动力供给和匹配效率的变动起着核心作用。我们还表明，2023年至2025年的“软着陆”阶段的特点是劳动力需求和短期劳动力供给同时下降，这减缓了薪资增长，同时仅导致失业率温和上升。

【**NBER**】: NBER Working Paper No. 35196，https://www.nber.org/papers/w35196

#### 95. AlphaPortfolio: Goal-Oriented Investment Management Through Deep Reinforcement Learning

【**Author**】: Lin William Cong, Ke Tang, Jingyuan Wang
...
【**摘要**】：我们采用基于注意力的神经网络和强化学习来指导投资组合构建，允许更广泛的投资组合管理目标（包括非时间可加可分的目标），并以数据驱动的方式，在比低维参数规则或人为指定策略更丰富的策略/策略空间中进行搜索。作为金融领域可以说是第一个非文本基础的“大型”生成式AI模型，AlphaPortfolio能够处理公司和市场状态中的长期和短期路径依赖性（例如，使用Transformer编码器）、跨资产信息以及灵活（路径依赖的）目标（包括夏普比率，它在各期间不可加可分），以实现端到端（而非逐步）优化。在美国股票中，AlphaPortfolio产生了卓越的样本外表现（例如，月度再平衡下夏普比率超过2，风险调整后阿尔法超过13%），在各种市场条件和经济限制（例如，排除小盘股/非流动性股票）下以及随时间推移都表现稳健。收益来自直接构建、有效的序列建模和跨资产注意力网络。我们进一步展示了AlphaPortfolio在纳入交易成本、状态交互和替代目标方面的灵活性，随后开发了一种多项式特征敏感性分析，以揭示绩效的关键驱动因素，包括其轮动和非线性。

【**NBER**】: NBER Working Paper No. 35195，https://www.nber.org/papers/w35195

#### 96. Data Centers and Local Economies in the Age of AI: A Shift--Share Approach

【**Author**】: Fernando E. Alvarez, David Argente, Joyce Chow, Diana Van Patten
...
【**摘要**】：数据中心是云计算、人工智能和企业软件背后的物理基础设施。人工智能的快速普及正在加剧对算力的需求，加速数据中心投资，并引发对这些设施当地经济和环境足迹的担忧。它们的扩张造成了地方政策权衡。数据中心可以带来资本投资、建筑活动和专业就业，但也会增加对电力、土地和电网容量的需求。本文在美国县级层面研究了这些影响。我们收集了一个全球数据中心的设施级面板数据，包含精确坐标、规模指标和年化收入。我们将设施映射到美国各县，并将其与县商业模式、县级IRS收入、县级房价和电价相结合。为了解决内生选址问题，我们使用两个偏移-份额工具变量来工具化数据中心增长，这两个工具利用预先存在的与InterTubes长途光纤节点的邻近性和1980年美国城市大学人口的县级份额作为份额，并以中国和世界其他地区的数据中心收入增长作为偏移。IV估计显示，在数据中心增长后的不同时间跨度内，对总就业、数据处理就业、建筑就业、企业数量、房价和电价有正向影响。我们还发现对纳税申报单、调整后总收入（AGI）和工资有正向影响，而年度薪资总额的反应则不那么稳健。结果表明，数据中心创造了可衡量的地方经济活动，提高了房价，并通过更高的价格影响了当地电力市场。

【**NBER**】: NBER Working Paper No. 35194，https://www.nber.org/papers/w35194

#### 97. Mortality Rates by Race and Ethnicity Among People with Disabilities

【**Author**】: Madeline S. Helfer, Becky Staiger, Jessica Van Parys
...
【**摘要**】：本文利用2017-2021年的医疗补助索赔数据，衡量了领取补充保障收入（SSI）的低收入残疾成年人中，中年死亡率的种族/族裔差异。我们发现，美洲印第安人和阿拉斯加原住民以及白人SSI受助者的年龄调整后中年死亡率最高（分别为2.9%和2.6%），其次是黑人和西班牙裔受助者（分别为2.3%和1.9%），然后是亚裔受助者（1.6%）。我们还发现，不同种族/族裔群体在确诊的慢性病、“绝望相关”疾病、物质使用障碍和致残状况方面存在差异。控制这些差异后，白人与西班牙裔、白人与亚裔以及美洲印第安人与阿拉斯加原住民与白人之间的死亡率差距有所缩小；然而，种族间临床诊断的差异并未影响白人与黑人之间的死亡率差距。我们的结果表明，在社会经济弱势群体中，黑人成年人的寿命比白人更长。

【**NBER**】: NBER Working Paper No. 35193，https://www.nber.org/papers/w35193

#### 98. Algorithmic Credentialism

【**Author**】: Peter Q. Blair, Rui Guo
...
【**摘要**】：本文构建了一个框架，用于评估现行民权法下基于证书编码的算法筛选。基于历史数据训练的AI招聘工具，通常将学士学位要求编码并自动化，作为工人技能的代理指标，这产生了本文所称的“算法证书主义”。借鉴关于“通过替代途径获得技能”（STARs）工人的劳动经济学研究、残疾理论对医学模型的批判，以及从Griggs诉杜克电力公司案到1991年《民权法案》的差别影响原则，本文认为此类筛选错误地识别了招聘排斥的根源，将其归咎于工人而非选拔系统的设计。这一制度设计问题适用于现行差别影响原则下的评估。根据本文提出的框架，产生差别影响的证书编码筛选，会触发一项法律义务，即验证该筛选是否与工作相关且符合业务必要性，而基于技能的招聘则提供了歧视性更小的替代方案。本文进一步认为，历史上为学位筛选提供的效率理由，因AI而削弱而非增强。同样能够大规模自动化证书主义的计算能力，反而可以根据多维技能画像将求职者与职位匹配，使得学士学位作为代理指标的必要性（以及法律上的可辩护性）低于前AI劳动力市场。

【**NBER**】: NBER Working Paper No. 35192，https://www.nber.org/papers/w35192

#### 99. Organization Capital, Large Startups, and the Dearth of IPOs

【**Author**】: Rüdiger Fahlenbrach, Leandro Sanz, René M. Stulz
...
【**摘要**】：21世纪的许多初创企业在获得高估值后仍保持私有状态，这一模式仅凭融资可得性无法解释。我们提出，那些严重依赖组织资本，通过数字技术实现规模经济和网络效应的初创企业，更有可能成为大型私有企业，而非通过IPO或收购提前退出。利用领英数据，我们为初创企业构建了一个新颖的组织资本密集度衡量指标。利用一项加强组织资本保护的法律冲击，我们提供了因果证据，表明组织资本密集型初创企业更倾向于保持私有并发展壮大，而非提前退出。

【**NBER**】: NBER Working Paper No. 35191，https://www.nber.org/papers/w35191

#### 100. The Long-Run Effects of the Affordable Care Act: Evidence from a Partially Pre-Committed Research Design Over the COVID-19 Recession and Recovery

【**Author**】: Jeffrey Clemens, Anwita Mahajan, Joseph J. Sabia
...
【**摘要**】：调整摩擦可能导致社会保险改革的长期效应与其短期效应不同。利用先前用于短期分析的事件研究设定的预先承诺扩展，我们检验了这样一个假设：《平价医疗法案》（ACA）对保险覆盖和就业的影响，会因COVID-19疫情带来的大量人员流动而增强。与假设相反，ACA的影响在整个疫情期间保持稳定。对就业和雇主保险的长期影响是适度的，且远小于最初的预测。我们的研究说明了部分预先承诺的设计如何能够在限制规范搜索的同时，产生信息量丰富的长期估计。

【**NBER**】: NBER Working Paper No. 35190，https://www.nber.org/papers/w35190

#### 101. Crimes Against Campbell-Shiller

【**Author**】: Itzhak Ben-David, Alex Chinco

【**Abstract**】: The Campbell and Shiller (1988) log-linear approximation is widely viewed as a model-free accounting identity that always holds: in sample, in expectation, and under arbitrary subjective beliefs. None of these claims is true. The formula is far from automatic even in realized data. Many companies do not pay dividends, making the calculation ill-defined. For dividend payers, the results are not always what they seem. The formula registers buybacks and new issuance as phantom cash-flow shocks. Taking expectations comes with its own complications. Researchers see the forward-looking version of Campbell-Shiller as a dynamic Gordon model, but this interpretation requires investors to consistently think in present-value terms and to know the cap rate with basis-point precision. Both are strong assumptions that do not always hold in the data. Finally, the formula generically fails under arbitrary subjective beliefs. The exceptions represent knife-edge cases where forecast errors obey a precise adding-up condition. Insisting that Campbell-Shiller always holds makes it harder to learn about the true pricing model in the many cases where it does not.

【**摘要**】：Campbell和Shiller（1988）的对数线性近似被广泛视为一个无模型的会计恒等式，在样本内、期望值下以及任意主观信念下都始终成立。这些说法没有一个是正确的。即使在已实现的数据中，该公式也远非自动成立。许多公司不支付股息，使得计算无法定义。对于支付股息的公司，结果也并非总是表面看起来那样。该公式将股票回购和新股发行登记为虚幻的现金流冲击。引入期望值会带来其自身的复杂性。研究者将坎贝尔-席勒的前瞻性版本视为动态戈登模型，但这种解释要求投资者始终以现值思维进行思考，并且以基点精度知道资本化率。两者都是强有力的假设，在数据中并不总是成立。最后，该公式在任意主观信念下通常失效。例外情况代表的是临界情形，其中预测误差满足一个精确的加总条件。坚持认为坎贝尔-席勒恒等式始终成立，会使得在许多它并不成立的情况下，更难了解真实的定价模型。

【**NBER**】: NBER Working Paper No. 35189，https://www.nber.org/papers/w35189

#### 102. Deep Research on a Loop: Using AI Agents to Construct Economic Datasets

【**Author**】: Santiago Afonso, Sebastian Galiani, Ramiro H. Gálvez, Raul A. Sosa
...
【**摘要**】：从原始来源构建数据集是实证经济学中成本最高的任务之一。我们提出了“循环深度研究”（DRIL）方法，该方法使用AI代理从公开来源汇编数据集。DRIL在映射的单位空间（例如，按年份划分的国家）上应用固定的研究工具，采用将设计与实施分离的两阶段架构。该工具规定了变量和编码规则，证据政策管理来源和引用，数据质量机制明确追踪差距和不确定性。我们在2025年更新的八个拉丁美洲和加勒比国家全球税收支出数据库上对DRIL进行了实践。此次运行产生了129个来源和136条证据记录，完全覆盖了22个定性字段，并记录了6种定量估计类型的差距，其成本相当于标准LLM订阅费用，与几小时的研究助理工作相当。我们认为，即使是数据集构建的部分自动化，也能改变实证经济学的生产函数。

【**NBER**】: NBER Working Paper No. 35188，https://www.nber.org/papers/w35188

#### 103. Anti-Harassment Policy and the Startup Labor Market

【**Author**】: Jun Chen, Song Ma, Feng Zhang
...
【**摘要**】：本文研究了在工作场所性骚扰案件中削弱保密协议（NDA）的反骚扰法律改革，如何影响初创企业的招聘和组织决策。利用交错双重差分设计以及2014-2022年间超过5万家美国风险投资支持初创企业的领英数据，我们发现，尽管NDA改革旨在保护员工，但它使女性招聘减少了约8%，这种影响集中在初级女性员工（她们在统计上更容易遭受性骚扰）以及小型或男性主导的初创企业中。该结果适用于女性招聘的集约边际和广延边际。受影响的创业企业还观察到更多男性管理者的离职，提拔了更多女性，并且获得的VC资金减少。这些结果表明，虽然削弱NDA的法律增加了企业感知的法律风险并减少了女性招聘，但它们也引发了内部重组，促进了女性晋升至领导岗位，并且随着时间的推移，可能培育出更负责任和更具包容性的组织文化。

【**NBER**】: NBER Working Paper No. 35187，https://www.nber.org/papers/w35187

#### 104. AlphaGlass: Interpretable Characteristic-Based Portfolio Choice

【**Author**】: Sebastian Bell, Ali Kakhbod, Martin Lettau, Abdolreza Nazemi
...
【**摘要**】：我们提出了AlphaGlass，一个本质上可解释的机器学习框架，用于构建直接优化投资目标的投资组合。AlphaGlass将股票特征映射为具有稀疏交互的加性信号，并通过一个可微分的排序与掩码层将这些信号转化为多空投资组合。这种端到端设计允许模型优化诸如夏普比率或均值-方差效用等目标，同时保持投资组合权重可解释，并可追溯到特定的特征和交互。我们从理论上证明，样本内目标最大化一致地估计了总体目标，并且可微分的排序与掩码层是相应传统多空分位数投资组合的忠实平滑代理。在美国股票市场中，AlphaGlass提供了强劲的样本外表现，并揭示了多头和空头头寸的经济可解释驱动因素。

【**NBER**】: NBER Working Paper No. 35186，https://www.nber.org/papers/w35186

#### 105. Revealing Life Preferences Through LLMs

【**Author**】: Omar Abdel Haq, Amitabh Chandra, Tomáš Jagelka, Erzo F.P. Luttmer, Joshua Schwartzstein
...
【**摘要**】：大语言模型（LLMs）在大量人类写作语料上进行训练，可能揭示人类对生活历程特征（如收入、寿命和工作条件）的偏好。我们向OpenAI的GPT-5.4和一个具有广泛代表性的美国样本提供成对的生活故事，并要求他们选择自己更偏好的生活。对于同一个人，其选择被LLM的选择预测得比另一个人的选择更准确，并且LLM对几种生活属性的估值与从人类反应中得出的估值相似。我们的结果表明，LLM的反应为研究人类偏好的现有方法提供了一种可扩展且成本效益高的补充。

【**NBER**】: NBER Working Paper No. 35185，https://www.nber.org/papers/w35185

#### 106. Breaking the Early Bell: Lessons from the First Statewide Mandate on School Start Times

【**Author**】: Jialu (Gloria) Dou, Rania Gihleb, Osea Giuntella, Jakub Lonsky

【**Abstract**】: We examine the impact of California's Senate Bill 328 (SB 328), the first statewide mandate requiring later school start times for middle and high schools, on adolescent sleep, mental health, and academic outcomes. Using difference-in-differences and event- study designs across five data sources, we find that SB 328 increased the share of students sleeping at least 8 hours per night by 13%, meeting the CDC-recommended minimum for this age group. Average mental health effects are imprecisely estimated, but boys show significant reductions in sadness, hopelessness, and suicidal ideation, and Hispanic students, who experienced the largest sleep-timing shifts, show parallel reductions in difficulty concentrating; together these patterns are consistent with a dose-response relationship between sleep improvement and mental well-being. Math and English scores in grade 8 improved by approximately 0.08-0.10 standard deviations, with the largest gains among Hispanic and economically disadvantaged students. A within-state analysis using teachers' commute arrival times as a proxy for pre-policy school start times corroborates these findings, and shows academic gains accumulating over 2023-2025 alongside a suggestive decline in high school dropout rates.

【**摘要**】：我们研究了加利福尼亚州参议院第328号法案（SB 328）的影响，这是首个要求中学和高中推迟上学时间的全州范围强制令，对青少年睡眠、心理健康和学业成果的影响。使用跨五个数据来源的双重差分和事件研究设计，我们发现SB 328使每晚至少睡8小时的学生比例增加了13%，达到了CDC推荐的该年龄段最低睡眠时长。平均心理健康效应的估计不精确，但男孩在悲伤、绝望和自杀意念方面显示出显著减少，而西班牙裔学生（经历了最大的睡眠时间变化）在注意力集中困难方面也显示出平行减少；这些模式共同表明睡眠改善与心理健康之间存在剂量反应关系。八年级的数学和英语成绩提高了约0.08-0.10个标准差，其中西班牙裔和经济弱势学生的进步最大。一项使用教师通勤到达时间作为政策前上学时间代理变量的州内分析证实了这些发现，并显示学业收益在2023-2025年间持续累积，同时高中辍学率呈下降趋势。

【**NBER**】: NBER Working Paper No. 35184，https://www.nber.org/papers/w35184

#### 107. What Does A Grade Mean? Informativeness and Strategic Manipulation of Grading Systems

【**Author**】: Joshua S. Gans, Scott Duke Kominers
...
【**摘要**】：大学成绩何时允许跨课程进行信息性比较，成绩单调整如何影响学生和教师的激励？原始成绩混合了学生表现与课程特定条件，因此当课程效应大到足以在成绩截止点逆转能力排名时，仅基于成绩的比较就会失败。我们表明，完整成绩单可以通过我们称之为特征成绩（eigengrades）的方式恢复可比较的学生信号：即使用共同或外部锚定的评分标准和选课重叠来识别中心化学生效应的课程调整报告。在标量加性基准中，行均值、亲和谱和图拉普拉斯方法恢复相同的对象。因此，特征成绩不是独立的识别来源；它们是固定效应调整的一种表示。该框架也明确了局限性：具有未锚定课程特定截止点的普通字母成绩无法区分课程难度与评分标准，而多维成绩单识别的是技能匹配子空间，而非唯一的通用排名，除非机构指定一个基准。最后，精确的难度调整消除了由直接报告中介的选择更容易课程的激励，并消除了成绩膨胀背后的竞争性选课渠道，同时保留了其他策略和治理方面的余地。

【**NBER**】: NBER Working Paper No. 35183，https://www.nber.org/papers/w35183

#### 108. Growth is Getting Harder to Find, Not Ideas

【**Author**】: Teresa C. Fort, Nathan Goldschlag, Jack Liang, Peter K. Schott, Nikolas Zolas
...
【**摘要**】：相对平稳的美国生产率增长与不断上升的研发支出，通常被解释为创意越来越难找到的证据。我们构建了一个新的45年面板数据，追踪美国公司专利活动的全貌，以研究这一结论的微观基础，分别考察研究投入与创意（专利）之间以及创意与增长之间的关系。我们发现，每单位研发投入的平均专利数正在增加，专利对研发投入的弹性持平或上升，并且在控制研究投入后，没有系统性证据表明专利数量出现长期下降。然后，我们记录了公司专利增长率与劳动生产率增长率之间正向、显著且相当稳定的关系。然而，在控制专利增长后，平均公司增长率下降。综合来看，这些结果表明，公司的创新努力在维持增长方面发挥着关键作用，而这种作用在过去四十年中并未减弱。

【**NBER**】: NBER Working Paper No. 35182，https://www.nber.org/papers/w35182

#### 109. Youth Mental Health and School Smartphone Bans: Early Evidence
...
【**摘要**】：本文首次考察了学校智能手机禁令对美国青少年心理健康的因果效应。时间序列数据显示，过去十年青少年心理健康状况持续下降。一些研究人员认为，智能手机提供的社交媒体和其他互联网网站的便捷访问是罪魁祸首。为了提供这些禁令效应的因果证据，我依赖于合成双重差分模型和2016年至2024年的全国儿童健康调查（NSCH）。目前，只有一个州拥有两个禁令后时期的数据，两个州拥有一个禁令后时期的数据，这使得结果仅为初步证据。结果变量是屏幕时间和心理健康指标。总体而言，这些初步结果没有提供明确证据表明学校禁令政策减少了屏幕时间或改善了心理健康。未来需要更多年份的数据（当数据可用时）进行研究，以增加统计效力并估计学校禁令对青少年心理健康的长期影响。

【**NBER**】: NBER Working Paper No. 35181，https://www.nber.org/papers/w35181

#### 110. The Persistence of Power: How Family Origins Shape Political Representation and Policy

【**Author**】: Eric Chyn, Katherine Cohen, Kareem Haggag, Bryan A. Stuart
...
【**摘要**】：在美国这个长期被誉为机遇之地的国家，进入政治职位的途径是否真正向社会各阶层开放，还是最特权的子女不成比例地崛起进入政治生活？这个问题涉及一个长期存在的担忧，即精英家庭可能固守权力职位，在民主制度内复制一种世袭特权形式。我们研究了19世纪末20世纪初美国政治家的家庭背景，并表明来自富裕和特权家庭的子女在民选职位中一直占据显著过高的比例。这种不平衡随着时间的推移变化甚微，并且在最高级别的职位中，不同政党之间差异很小。为了检验政治准入是否取决于家庭资源，我们利用了奴隶制终结造成的突然经济冲击。尽管财富顶层遭受了巨大且集中的损失，但奴隶主的子女继续以高比例进入政府。最后，我们通过构建一个新的与美国家庭背景详细信息相关联的众议院候选人紧密选举样本，检验了政治家的社会经济出身是否塑造政策。比较那些来自高社会经济地位家庭的候选人以微弱优势获胜而非失败的原本相似的选区，我们发现由地位较高候选人代表的选区在唱名投票中支持支持税收立场的可能性较低。综合来看，我们分析中的证据表明，家庭背景强烈预测进入政治职位，并对政策选择产生可衡量的影响。

【**NBER**】: NBER Working Paper No. 35180，https://www.nber.org/papers/w35180

#### 111. Bachelors Without Bachelor's: Gender Gaps in Education and Declining Marriage Rates
...
【**摘要**】：在过去的半个世纪里，美国四年制大学从主要招收男性转变为主要招收女性，而非大学男性的经济地位显著削弱。我们考察了这些变化如何与跨代际和跨地区的婚姻市场结构演变相对应。随着大学男性变得越来越稀缺，大学女性通过嫁给高收入的非大学男性保持了稳定的结婚率。这种转变——加上非大学男性更广泛的经济衰退——急剧减少了非大学女性可获得的经济稳定伴侣的储备：收入高于全国中位数且未与大学女性结婚的非大学男性比例下降了超过50%。跨地区证据表明，在非大学男性失业率和监禁率较低的地区，教育方面的结婚率差距较小。综合来看，证据表明，男性日益恶化的结果主要削弱了非大学女性的婚姻前景。

【**NBER**】: NBER Working Paper No. 35179，https://www.nber.org/papers/w35179

#### 112. Earnings Management and Price Informativeness

【**Author**】: Zhiguo He, Wenxi Jiang, Wei Xiong
...
【**摘要**】：我们研究了中国A股市场中股票价格与未来盈余之间的关系。在横截面上，市场估值较高的公司在未来一至五年内报告更高的盈余，这表明股票价格包含关于未来基本面的信息。然而，在时间序列上，我们发现了盈余反转的证据：较高的股票价格预测三至五年后较弱的盈余增长，这与股票价格压力导致的短期盈余管理一致。我们进一步通过非经常性损益（NRGLs）记录了这种盈余管理，并利用2020年退市规则改革作为自然实验来检验这些机制。

【**NBER**】: NBER Working Paper No. 35178，https://www.nber.org/papers/w35178

#### 113. Separations Revisited: Do Layoffs or Quits Drive Lower Separation Rates in High-Quality Firms?

【**Author**】: Cauê Dobbin, Daniel Fernandez, Tom Zohar
...
【**摘要**】：一个广为人知的经验规律是，高生产率企业的员工离职率较低，但尚不清楚这一模式反映的是辞职还是解雇。利用巴西区分每次离职原因的雇主-雇员匹配数据，我们表明生产率-离职梯度主要由解雇而非辞职驱动。随后，我们提出并检验了一个机制：向下工资刚性阻止企业根据不利冲击调整工资，导致这些冲击转化为解雇。高生产率企业受影响较小，因为它们较大的加价幅度在生产率与工资之间提供了缓冲。与该机制一致，我们发现加价幅度较高的企业解雇率较低，而工资刚性较强的市场既表现出更高的解雇率，也表现出更陡峭的生产率-解雇梯度。这些发现表明，企业间的生产率差异不仅影响工资，也影响工人面临失业的风险。

【**NBER**】: NBER Working Paper No. 35177，https://www.nber.org/papers/w35177

#### 114. Measuring Water Misallocation in California
...
【**摘要**】：本文提出并应用新方法来评估水权价值以及衡量全球第四大经济体加利福尼亚州竞争性用途之间的水资源错配。该实证策略结合了关于农场、蒸散发、历史水权以及水文流动网络的详细微观数据，以隔离水文网络内部的低效来源，评估当前产权下水资源获取的分配影响，并评估水资源重新分配的替代机制。

【**NBER**】: NBER Working Paper No. 35176，https://www.nber.org/papers/w35176

#### 115. The Causal Effects of Expected Depreciations

【**Author**】: Martha Elena Delgado Rojas, Juan Herreño, Marc Hofstetter, Mathieu Pedemonte
...
【**摘要**】：我们为非金融企业构建了一种新颖的一年期汇率预测和现时预测的衡量指标。随后，我们研究了一项随机信息干预，该干预向一部分企业提供公开可用的汇率预测。这种信息处理持续地改变了汇率预期和认知，对非出口企业的影响更强。我们将调查回复与行政海关数据联系起来，并估计了进口需求对预期未来汇率外生变化的跨期弹性为正。我们的发现强调了在预期贸易成本变化后跨期替代的作用。

【**NBER**】: NBER Working Paper No. 35175，https://www.nber.org/papers/w35175

#### 116. Authority Figures and the Polarization of Gender Norms

【**Author**】: Ali Abboud, Samuel Bazzi, Serena Canaan, Antoine Deeb, Pierre Mouganie
...
【**摘要**】：本文研究了高等教育中的权威人物如何长期塑造性别规范。我们利用中东一所精英大学一年级学生随机分配至教师导师的情况，并将行政记录与一项衡量性别态度的校友调查（时间跨度长达24年）相结合。被分配给女性导师的女性学生形成了关于政治和工作的更平等主义观点，而男性则变得更加保守。这些效应在宗教学生和男性主导的STEM领域（女性权威尤其反刻板印象）中最为强烈。这些效应可能通过强化而持续，因为被分配给女性导师的女性学生后来会更多地选择女性教师和更多性别主题的课程。我们的结果似乎并非由普遍接触成功女性所驱动。相反，它们指出了权威在传递性别规范中的独特作用：随机接触高成就女性同龄人几乎没有影响，而最大的影响来自资深和高附加值的女性导师。一个结合信念更新和基于身份的地位威胁的简单框架有助于解释这些女性赋权和男性反弹的模式。更广泛地说，我们的发现揭示了一个进步悖论：精英权威中女性代表性的增加在扩大女性机会的同时，也加剧了男性的反弹，从而加深了性别两极分化。

【**NBER**】: NBER Working Paper No. 35174，https://www.nber.org/papers/w35174

#### 117. How does Medicare Eligibility affect Choice and Utilization? Evidence from Veterans

【**Author**】: Marion Aouad, Liam Rose, Todd Wagner
...
【**摘要**】：我们通过研究加入退伍军人健康管理局（VA）的退伍军人，考察了医疗保险如何影响那些拥有更狭窄健康保险网络的人群的医疗保健利用。鉴于VA医院的地理密度有限，我们假设医疗保险扩大了VA参保者的保险网络。使用断点回归方法，我们发现退伍军人的住院率在65岁时增加了约3.3%。此外，不同健康保险支付方之间存在大规模的重新分配。一旦医疗保险可用，个人越来越多地使用它来支付住院费用，而VA、商业和其他联邦保险计划的使用则减少。我们还发现，在能够获得离家更近的医院的人群中，以及因更可推迟的医疗程序而就医的人群中，存在显著的重新分配。然而，我们没有发现证据表明在65岁时所选医院的平均质量评级发生变化，也没有发现VA医院等待时间影响转向医疗保险的证据；相反，个人选择相对更近的医院。最后，我们的结果表明，医疗保险可能与其他联邦计划竞争，为特定人群（如退伍军人）提供医疗保健。

【**NBER**】: NBER Working Paper No. 35173，https://www.nber.org/papers/w35173

#### 118. Competitive Exposure and Entrepreneurial Experimentation
...
【**摘要**】：企业家通过实验来学习，但实验选择往往是公开的。封闭测试、私人试点或公开发布不仅产生证据；它还揭示了什么样的企业家会选择该行动。我们开发了一个动态模型，其中创始人在隐秘实验和公开实验之间进行选择，而潜在进入者则从行动和结果中进行推断。公开结果被建模为创始人私人实验证据的加噪版本，因此公开泄露告知了外部人士，但并未给创始人提供超出已观察到的私人信号之外的信息。关键状态变量是竞争暴露：即进入变得有吸引力之前的公开跑道。暴露被两种力量消耗：来自公开结果的泄露消耗，以及来自关于实验选择的公开推断的行动消耗。这种区别意味着竞争可以扭曲实验设计而不强制更早的规模化：信心较低的创始人选择更隐秘的测试，而信心较高的创始人则通过更多公开测试消耗暴露以获取更快的私人学习。只有当暴露降低等待价值的幅度大于降低规模化价值的幅度时，规模化才会加速。最后，外生融资门槛使可观察的规模化更具选择性，因此对进入者更具信息量。分析表明，创业实验不仅仅是不确定性下的私人学习；它是在竞争性推断下的公开行动。

【**NBER**】: NBER Working Paper No. 35172，https://www.nber.org/papers/w35172

#### 119. Labor Market Effects of California’s $\$20$ Fast-Food Minimum Wage
...
【**摘要**】：加利福尼亚州的AB 1228法案于2024年4月将大型快餐连锁店的最低工资提高到每小时20美元——约占该州中位数小时工资的77%，是美国快餐工人最高的工资下限。使用截至2025年第三季度的QCEW数据，我估计该政策使快餐工资提高了约7%。传统的双重差分法得出的就业自身工资弹性（OWE）为-0.19；合成双重差分法（重新加权控制组以匹配加州处理前轨迹）将OWE缩小至-0.04。新获得的截至2024年第四季度的QWI数据得出的估计平均更为正向。在32个QCEW和QWI规格中，OWE的范围从-0.29到+0.26，尽管AB 1228的冲击力度大得多，但该范围包含了我在27个2010年后的州最低工资事件中计算出的中位数OWE（-0.02）。QWI还揭示了离职率的急剧下降，自身工资弹性在-1.7到-4.2之间——是Dube等人（2016）中餐饮业基准的几倍，并且与垄断性离职减少渠道一致。工资和离职率效应集中在受AB 1228覆盖的大型雇主中，溢出效应有限。离职率的下降也有助于调和略显更负面的QCEW就业估计。

【**NBER**】: NBER Working Paper No. 35171，https://www.nber.org/papers/w35171

#### 120. Extreme Equilibria: The Benefits of Correlation

【**Author**】: Kirill Rudov, Fedor Sandomirskiy, Leeat Yariv
...
【**摘要**】：当代理人进行沟通或依赖推荐系统等中介时，相关均衡自然会出现。我们研究对于一般目标，何时可以在相关均衡集合内改进给定的纳什均衡。我们的关键见解是一个无需细节的标准：任何具有三个或更多随机化代理人的纳什均衡在一般情况下都是可改进的。我们将这一见解细化到特定类别的博弈和目标，包括帕累托和功利主义福利，并提供了获得改进的构造性方法。我们的发现强调了可改进纳什均衡的普遍性以及相关性在增强战略结果中的关键作用。

【**NBER**】: NBER Working Paper No. 35170，https://www.nber.org/papers/w35170

#### 121. Opt In? Opt Out?

【**Author**】: Alex Chan, Ayush Gupta, Yetong Xu
...
【**摘要**】：遗体器官短缺每年导致数千人无法获得挽救生命的移植。各国在器官捐献登记中采用选择加入（知情同意）或选择退出（推定同意）制度。本文利用新构建的跨国面板数据和事件研究设计，提供证据表明：推定同意法律仅在严格执法且家庭否决权受限时才能增加器官捐献；宽松的选择退出制度效果微乎其微，甚至产生负面影响。一个理论信号模型解释了选择加入或选择退出何时能带来更多捐献的合理机制，强调了捐献倾向、信号成本以及家庭推翻默认选择的能力。一项大型实验室实验进一步检验了这些机制，结果表明：除非信号成本高昂且家庭否决权极小，否则选择加入通常能产生相等或更高的捐献率。研究结果强调，除非与强有力的制度执行相结合，否则仅靠默认选择很少能增加捐献。

【**NBER**】: NBER Working Paper No. 35169，https://www.nber.org/papers/w35169

#### 122. The Postpandemic U.S. Immigration Surge: New Facts and Inflationary Implications

【**Author**】: Anton Cheremukhin, Sewon Hur, Ronald R. Mau, Karel Mertens, Alexander W. Richter, Xiaoqing Zhou
...
【**摘要**】：美国在2021年至2024年间经历了异常庞大的移民潮，引发了关于其宏观经济影响（尤其是对通胀影响）的广泛讨论。为确定移民潮的影响，我们首先记录了这些新移民的显著特征：相对于现有劳动力，他们主要是低技能者，且更可能是月光族消费者。随后，我们将这些特征纳入一个具有资本-技能互补性的异质性主体模型中。我们发现，移民潮的供给和需求效应大致相互抵消，导致通胀反应微乎其微。

【**NBER**】: NBER Working Paper No. 35168，https://www.nber.org/papers/w35168

#### 123. On the Negative Consequences of Low-Wage Offshoring for Innovation

【**Author**】: Wulong Gu, Alla Lileeva, Daniel Trefler
...
【**摘要**】：传统观点认为，将中间品离岸外包到中国会刺激创新。但这并非完全令人信服。一方面，(a)离岸外包降低了边际成本并扩大了销售，从而增加了创新的回报，尤其对大型企业而言。另一方面，(b)离岸外包低质量的中间品降低了老一代产品的成本，从而降低了创新进入新一代产品的回报。我们考察了2002-2011年间这些对立力量对6024家加拿大企业的影响。我们的实证策略是将创新指标（如研发支出）对中间品进口进行回归。为解决内生性问题，我们构建了一个与模型一致的转移份额工具变量，其冲击来自中国HS6中间品质量通常显著的提升。我们发现，更多的离岸外包使2002-2011年间的研发支出减少了15%，原因是：(1) 2002年从事研发的企业减少了支出，以及(2) 最初未从事研发的企业被抑制，不再启动新的研发项目。我们的模型解释了这些发现：中国中间品质量的提升是一个正向供给冲击（而非负向中国冲击），它提高了所有离岸外包企业的利润，提高了最大离岸外包企业的创新（上述渠道a），并降低了所有其他离岸外包企业的创新（渠道b）。这些预测在数据中得到了证实。

【**NBER**】: NBER Working Paper No. 35167，https://www.nber.org/papers/w35167

#### 124. Interest Rate Caps, Competition, and Strategic Borrowing: Evidence from Kenya

【**Author**】: Aroon Narayanan, Tavneet Suri, Prashant Bharadwaj
...
【**摘要**】：我们研究了肯尼亚2016年的利率监管，该监管设定了银行贷款利率上限，但豁免了一个名为M-Shwari的数字平台在贷款端的限制，同时对市场上所有贷款机构设定了存款利率下限。利用借款人层面的行政数据、调查数据以及围绕实施日期的断点回归，我们展示了三个主要结果。首先，被豁免平台上的贷款增加了，但最安全的借款人转向更便宜的受上限约束的信贷。其次，风险较高的借款人增加储蓄以提高其信用额度。第三，在供给方面，M-Shwari提高了最安全借款人的额度以试图留住他们。我们构建并估计了一个简单的筛选和信用额度设定模型来解释这些重新配置并计算福利。观察到的对M-Shwari的豁免保留了高风险借款人的信贷获取，但与政策前相比，总体福利略有下降。然而，一个统一的（适用于所有贷款机构）利率上限反事实情景，通过完全消除高风险借款人的信贷，产生了更大的福利损失。

【**NBER**】: NBER Working Paper No. 35166，https://www.nber.org/papers/w35166

#### 125. Health Inequalities Among Danish Retirees 2004-2022

【**Author**】: Paul Bingley, Nabanita Datta Gupta, Malene Kallestrup-Lamb, Alexander O.K. Marin
...
【**摘要**】：利用2004-2022年的丹麦SHARE数据，我们考察了60-79岁退休人员在功能、诊断、综合、心理和认知健康领域的收入梯度。高收入退休人员在所有维度上都更健康，但不平等的演变因衡量指标而异。功能健康和综合健康的差距随时间缩小，因为低收入退休人员有所改善，而心理健康差距仍然很大且持续存在。诊断健康和认知健康的梯度较小且不稳定。总体而言，老年时期的健康不平等是显著的，但并不统一：身体健康差距在缩小，而心理健康差距没有收敛的迹象。

【**NBER**】: NBER Working Paper No. 35165，https://www.nber.org/papers/w35165

#### 126. How Should Central Banks Respond to Commodity Price Shocks? Optimal Monetary and Exchange Rate Frameworks for Commodity-Exposed Economies

【**Author**】: Thomas Drechsel, Michael McLeay, Silvana Tenreyro, Enrico D. Turri
...
【**摘要**】：我们表明，最优货币政策和汇率框架关键取决于经济体的大宗商品暴露程度。我们开发了一个灵活但易于处理的经济模型，包含大宗商品出口和进口，其中国际金融条件可能随大宗商品周期而变化，并在存在价格和工资刚性的情况下计算福利最优政策。对于大宗商品出口国而言，稳定国内价格是福利最优的，这与标准的开放经济政策处方一致。但对于将大宗商品用作生产投入的经济体，最优政策在很大程度上“看穿”了大宗商品冲击对国内价格的直接和间接影响；这与先前的一些发现和政策实践（仅“看穿”直接影响）形成对比。汇率盯住制增加了大宗商品进口国的福利，因为它稳定了工资和就业，尽管这并非一个稳健的最优政策。在新兴和发展中经济体，金融条件与大宗商品周期的联系更为紧密，权衡取舍更为严峻，实施最优政策可能具有挑战性，因为这需要足够的可信度来在部分名义变量波动性加大的情况下锚定通胀预期。

【**NBER**】: NBER Working Paper No. 35164，https://www.nber.org/papers/w35164

#### 127. Building Opportunity: The Intergenerational Effects of Chilean School Construction

【**Author**】: Adrienne Lucas, Patrick McEwan
...
【**摘要**】：在1965-1966年间，智利在供给受限的社区新建并配备了数千间小学教室。利用准实验设计和大规模人口普查样本，我们表明，童年时期接触学校建设显著改善了成年人的教育和劳动力市场成果，并消除了女性在教育程度上的长期劣势。女性接触该政策对其子女的按时升学率和完成学业产生了巨大的代际溢出效应。公共资金的边际价值为13，这包括了成年人的直接效应和代际溢出效应。

【**NBER**】: NBER Working Paper No. 35042，https://www.nber.org/papers/w35042
