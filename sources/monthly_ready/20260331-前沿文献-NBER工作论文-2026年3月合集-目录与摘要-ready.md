# 【前沿文献】NBER工作论文 2026年3月合集 目录与摘要

> 2026 年 3 月 NBER 更新 100 篇工作论文，其中与中国研究相关的有 4 篇（5、36、40、87）。
> 其中，中国相关研究包括：#35013（第 5 篇，对贸易冲击的动态调整）；#34982（第 36 篇，家庭迁移与抵押品约束：中国的现金化住房安置）；#34977（第 40 篇，从搭便车者到创新者：中国药物开发的崛起）；#34930（第 87 篇，金融摩擦何时对资源错配重要？）。

## 一、目录速览

1. **Trade, Labor Market Concentration, and Wages {#35018}**  
   贸易、劳动力市场集中度与工资  
   <font color=grey>Mayara Felix</font>

2. **Real Effects of Academic Research Revisited {#35017}**  
   学术研究的实际效应再探  
   <font color=grey>Adam B. Jaffe, Laura B. Shupp, Valentina Tartari</font>

3. **In the Fed’s Mind {#35016}**  
   美联储的想法  
   <font color=grey>Ali Kakhbod, Amir Kermani, Bernardo Maciel</font>

4. **The Economics of Postdoctoral Researcher Positions {#35014}**  
   博士后研究人员职位的经济学  
   <font color=grey>Donna K. Ginther, Joshua L. Rosenbloom</font>

5. **Dynamic Adjustment to Trade Shocks {#35013}**  
   对贸易冲击的动态调整  
   <font color=grey>Junyuan Chen, Carlos Góes, Marc-Andreas Muendler, Fabian Trottner</font>

6. **Planning under Diagnostic Uncertainty: Question-Driven Learning in the Age of AI {#35012}**  
   诊断不确定性下的规划：人工智能时代由问题驱动的学习  
   <font color=grey>Andrew Caplin</font>

7. **Knowledge Spillovers and Local Outcomes: An Existence Proof from the Establishment of the National Labs {#35011}**  
   知识溢出与地方成果：来自国家实验室建立的实证证据  
   <font color=grey>Susan Helper, Resem Makan, Daniel W. Shoag</font>

8. **Adaptive Enforcement with AI-Augmented Monitoring {#35010}**  
   利用人工智能增强监控的自适应执法  
   <font color=grey>Ginger Zhe Jin, D. Daniel Sokol, Liad Wagman</font>

9. **The Effects of Fiscal News on Household Expectations and Spending: New Causal Evidence {#35009}**  
   财政新闻对家庭预期和支出的影响：新的因果证据  
   <font color=grey>Myungkyu Shim, Kwang Hwan Kim, Myunghwan Andrew Lee, Sangyup Choi, Siye Bae, Olivier Coibion, Yuriy Gorodnichenko</font>

10. **The Cold War and the U.S. Labor Market {#35008}**  
   冷战与美国劳动力市场  
   <font color=grey>Ilyana Kuziemko, Donato A. Onorato, Suresh Naidu</font>

11. **The Hidden Cost of Stock Market Concentration: When Funds Hit Regulatory Limits {#35007}**  
   股市集中度的隐性成本：当基金触及监管限制时  
   <font color=grey>Lubos Pastor, Taisiya Sikorskaya, Jinrui Wang</font>

12. **Cash Transfers and Productive Inclusion: Evidence from Bolsa Familia {#35006}**  
   现金转移与生产性包容：来自家庭补助金的证据  
   <font color=grey>Michael C. Best, Felipe Lobel, Valdemar Pinho Neto</font>

13. **Early-Life Sugar Restrictions Reduce Genetic Disparities in Adult Adiposity {#35005}**  
   生命早期糖分限制减少了成年肥胖的遗传差异  
   <font color=grey>Tadeja Gracner, Claire Boone, Patrick Turley, Paul Gertler</font>

14. **Using Global Shocks to Understand the Level and Structure of Executive Compensation {#35004}**  
   利用全球冲击理解高管薪酬的水平与结构  
   <font color=grey>David Hummels, Jakob Munch, Huilin Zhang</font>

15. **Salience and (Non-)Buyer's Remorse: Optimal Nonlinear Pricing with Cognitively Constrained Consumers {#35003}**  
   显著性与（非）买家懊悔：面向认知受限消费者的最优非线性定价  
   <font color=grey>Aaron L. Bodoh-Creed, Brent R. Hickman, John A. List, Ian Muir, Gregory K. Sun</font>

16. **Networked Information and Industrial Output: Evidence from Chile’s 1972 Truckers’ Strike {#35002}**  
   网络化信息与工业产出：来自1972年智利卡车司机罢工的证据  
   <font color=grey>Sebastian Edwards</font>

17. **Screening with Cash Deposits in Digital Credit Markets {#35001}**  
   数字信贷市场中的现金存款筛选机制  
   <font color=grey>Paul Gertler, Brett Green, Catherine Wolfram</font>

18. **Decoupling Dollar and Treasury Privilege {#35000}**  
   美元与国债便利收益的解耦  
   <font color=grey>Wenxin Du, Ritt Keerati, Jesse Schreger</font>

19. **The Impact of Virtual Instruction on the Transition to College: Evidence from COVID-19 {#34999}**  
   虚拟教学对大学入学过渡的影响：来自COVID-19的证据  
   <font color=grey>Nolan G. Pope, Yu Hung Yaow</font>

20. **Special Education Substantially Improves Learning: Evidence from Three States {#34998}**  
   特殊教育显著改善学习：来自三个州的证据  
   <font color=grey>Stephanie G. Coffey, Joshua Goodman, Amy Ellen Schwartz, Leanna Stiefel, Marcus A. Winters, Yunee H. Yoon</font>

21. **Paid Caregiving Leave Policies and an Update on Paid Parental Leave {#34997}**  
   带薪照护假政策与带薪育儿假政策更新  
   <font color=grey>Priyanka Anand, Tamar Matiashvili, Maya Rossin-Slater</font>

22. **Supporting Student Engagement During Remote Learning: Three Randomized Controlled Trials in Chicago Public Schools {#34996}**  
   远程学习期间支持学生参与：芝加哥公立学校的三项随机对照试验  
   <font color=grey>Monica P. Bhatt, Jonathan Guryan, Fatemeh Momeni, Philip Oreopoulos, Eleni Packis</font>

23. **Mind the Gap: AI Adoption in Europe and the U.S. {#34995}**  
   关注差距：欧洲与美国的AI采纳  
   <font color=grey>Alexander Bick, Adam Blandin, David J. Deming, Nicola Fuchs-Schündeln, Jonas Jessen</font>

24. **Steering Technological Progress {#34994}**  
   引导技术进步  
   <font color=grey>Anton Korinek, Joseph E. Stiglitz</font>

25. **Bank Fees and Household Financial Well-Being {#34993}**  
   银行费用与家庭财务福祉  
   <font color=grey>Michaela Pagel, Sharada Sridhar, Emily Williams</font>

26. **Preferences for Warning Signal Quality: Experimental Evidence {#34992}**  
   对预警信号质量的偏好：实验证据  
   <font color=grey>Alexander Ugarov, Arya Gaduh, Peter McGee</font>

27. **Private Credit, Balance Sheets and Financial Stability {#34991}**  
   私人信贷、资产负债表与金融稳定  
   <font color=grey>Gregor Matvos, Tomasz Piskorski, Amit Seru</font>

28. **The Effects of California's $\$20$ Fast Food Minimum Wage on Prices {#34990}**  
   加州20美元快餐最低工资对价格的影响  
   <font color=grey>Jeffrey Clemens, Olivia Edwards, Jonathan Meer, Joshua D. Nguyen</font>

29. **The Precarious Financial Lives of College Students in Sub-Saharan Africa {#34989}**  
   撒哈拉以南非洲大学生岌岌可危的财务状况  
   <font color=grey>Natalie Bau, Corinne Low, Simona Simona, Bryce Steinberg</font>

30. **Lender of Last Resort and Local Economic Outcomes {#34988}**  
   最后贷款人与地方经济结果  
   <font color=grey>Pawel Janas</font>

31. **Substitution and Income Effects of Labor Income Taxation {#34987}**  
   劳动所得税的替代效应与收入效应  
   <font color=grey>Michael Graber, Morten Håvarstein, Magne Mogstad, Gaute Torsvik, Ola L. Vestad</font>

32. **What Makes New Work Different from More Work? {#34986}**  
   是什么让新工作不同于更多的工作？  
   <font color=grey>David Autor, Caroline Chin, Anna M. Salomons, Bryan Seegmiller</font>

33. **Contract Enforcement and Young Firm Capital Structure: A Global Perspective {#34985}**  
   合同执行与年轻企业资本结构：全球视角  
   <font color=grey>Gonzalo E. Basante Pereira, Ina Simonovska</font>

34. **Artificial Intelligence, Productivity, and the Workforce: Evidence from Corporate Executives {#34984}**  
   人工智能、生产力与劳动力：来自企业高管的证据  
   <font color=grey>Salomé Baslandze, Zachary Edwards, John Graham, Ty McClure, Brent H. Meyer, Michael Sparks, Sonya R. Waddell, Daniel Weitz</font>

35. **An 'Austrian' Model of International Specialization {#34983}**  
   一个“奥地利学派”的国际专业化模型  
   <font color=grey>Pol Antràs, Adrian Kulesza</font>

36. **Household Migration and Collateral Constraint: Cash-based Housing Resettlement in China {#34982}**  
   家庭迁移与抵押品约束：中国的现金化住房安置  
   <font color=grey>Zhiguo He, Zehao Liu, Xinle Pang, Yang Su, Kunru Zou</font>

37. **The Long-Term Decline of the U.S. Job Ladder {#34981}**  
   美国职业阶梯的长期衰退  
   <font color=grey>Niklas Engbom, Aniket Baksy, Daniele Caratelli</font>

38. **Does Employment Shift Mothers' Voting Behavior and Political Identity? {#34980}**  
   就业是否会改变母亲的投票行为和政治认同？  
   <font color=grey>Jacob Bastian</font>

39. **Climate Fairness and Growth: Allocating the Remaining Carbon Budget {#34978}**  
   气候公平与增长：分配剩余碳预算  
   <font color=grey>Galina Hale, Michael Halling, Nora Alice. Paulus, Han H.G. Pham</font>

40. **From Free Rider to Innovator: The Rise of China's Drug Development {#34977}**  
   从搭便车者到创新者：中国药物开发的崛起  
   <font color=grey>Panle Jia Barwick, Hongyuan Xia, Tianli Xia</font>

41. **The Rise of the Modern Hospital and Early-Life Health: Evidence from the Hill-Burton Act {#34976}**  
   现代医院的兴起与早期健康：来自希尔-伯顿法案的证据  
   <font color=grey>Owen Thompson, Jason Fletcher, Karin Wu</font>

42. **Standardized Test Scores and Academic Performance at a Public University System {#34975}**  
   标准化考试成绩与公立大学系统的学业表现  
   <font color=grey>Theodore J. Joyce, Mina Afrouzi Khosroshahi, Sarah Truelsch, Kerstin Gentsch, Kyle Du</font>

43. **Financial Conditions Targeting in a Multi-Asset Open Economy {#34974}**  
   多资产开放经济中的金融状况目标制  
   <font color=grey>Ricardo J. Caballero, Alp Simsek</font>

44. **Identifying Uncertainty, Learning about Productivity, and Human Capital Acquisition: A Reassessment of Labor Market Sorting and Firm Monopsony Power {#34973}**  
   识别不确定性、学习生产率和人力资本获取：对劳动力市场分类和企业买方垄断势力的重新评估  
   <font color=grey>Cristina Gualdani, Elena Pastorino, Áureo de Paula, Sergio Salgado</font>

45. **Reserve Demand Estimation with Minimal Theory {#34972}**  
   基于最小化理论的准备金需求估计  
   <font color=grey>Ricardo Lagos, Gastón Navarro</font>

46. **The max EPS Paradigm for Corporate Finance {#34971}**  
   公司金融的最大每股收益范式  
   <font color=grey>Itzhak Ben-David, Alex Chinco</font>

47. **Loaded Chambers: Organized Interests, Public Opinion, and Policy Responsiveness in the American States {#34970}**  
   上膛的议院：美国各州中的组织利益、公众意见与政策回应性  
   <font color=grey>Takuma Iwasaki, Eric A. Baldwin, John J. Donohue, Tai Markman</font>

48. **Household Preferences for Women’s Employment: A Field Experiment in Bangladesh {#34969}**  
   家庭对女性就业的偏好：孟加拉国的一项实地实验  
   <font color=grey>Yueh-ya Hsu, Reshmaan N. Hussam, Erin M. Kelley, Gregory Lane</font>

49. **The Global Incumbency Advantage {#34968}**  
   全球在位者优势  
   <font color=grey>Raphaël Descamps, Benjamin Marx, Vincent Pons, Vincent Rollet</font>

50. **Mutual Party Extremism {#34967}**  
   相互的政党极端主义  
   <font color=grey>Ivo Welch</font>

51. **Life Cycle Portfolio Choice with Human Capital and Social Security {#34966}**  
   考虑人力资本与社会保障的生命周期投资组合选择  
   <font color=grey>Jason Scott, John B. Shoven, Sita Slavov, John G. Watson</font>

52. **Out of the Black Box: Uncertainty Quantification for LLMs via Conditional Probabilities {#34965}**  
   走出黑箱：基于条件概率的大语言模型不确定性量化  
   <font color=grey>Hui Chen, Antoine Didisheim, Luciano A. Somoza</font>

53. **Attention (And Money) Is All You Need: Why Universities Are Struggling to Keep AI Talent {#34964}**  
   注意力（和金钱）就是一切：为什么大学难以留住人工智能人才  
   <font color=grey>Ufuk Akcigit, Craig A. Chikis, Emin Dinlersoz, Nathan Goldschlag</font>

54. **Work from Home and Fertility {#34963}**  
   居家办公与生育率  
   <font color=grey>Steven J. Davis, Cevat Giray Aksoy, Jose Maria Barrero, Nicholas Bloom, Katelyn Cranney, Mathias Dolls, Pablo Zarate</font>

55. **The Universal Pursuit of Safety and the Demand for (Lethal, Non-Lethal or No) Guns {#34962}**  
   对安全的普遍追求与对（致命、非致命或没有）枪支的需求  
   <font color=grey>Marcella Alsan, Joshua Schwartzstein, Stefanie Stantcheva</font>

56. **Cutting Costs or Cutting Corners: Asset Reallocation in Oil and Gas Production {#34961}**  
   削减成本还是偷工减料：油气生产中的资产重新配置  
   <font color=grey>Sarah C. Armitage, Judson Boomhower, Catherine Hausman</font>

57. **max EPS Payout Policy {#34960}**  
   最大化每股收益的股利政策  
   <font color=grey>Itzhak Ben-David, Alex Chinco</font>

58. **Blockchain Technology for Traditional Finance {#34959}**  
   面向传统金融的区块链技术  
   <font color=grey>Eric Budish, Adi Sunderam</font>

59. **The Emergence of Regional Cultures in the United States {#34958}**  
   美国区域文化的出现  
   <font color=grey>Taylor Jaworski, Erik O. Kimbrough</font>

60. **School Choice and Segregation: Evidence from the Oakland Unified School District {#34957}**  
   学校选择与隔离：来自奥克兰联合学区的证据  
   <font color=grey>Jesse Rothstein, Ini Umosen, Christopher R. Walters</font>

61. **International Comparison of Physician Incomes {#34956}**  
   医生收入的国际比较  
   <font color=grey>Aidan Buehler, Joshua D. Gottlieb, Jeffrey Hicks, Lisa Laun, Mårten Palme, Maria Polyakova, Victoria Udalova, Maria Ventura</font>

62. **Physician Competition: Entry and Substitution {#34955}**  
   医生竞争：进入与替代  
   <font color=grey>Joshua D. Gottlieb, Sean Nicholson</font>

63. **Stimulating Auto Markets {#34954}**  
   刺激汽车市场  
   <font color=grey>David W. Berger, Geoffrey Gee, Nick Turner, Eric Zwick</font>

64. **AI in Science {#34953}**  
   科学中的人工智能  
   <font color=grey>Ajay K. Agrawal, John McHale, Alexander Oettl</font>

65. **Easy A’s, Less Pay: The Long-Term Effects of Grade Inflation {#34952}**  
   轻松得A，收入更低：成绩膨胀的长期影响  
   <font color=grey>Jeffrey T. Denning, Rachel L. Nesbit, Nolan G. Pope, Merrill Warnick</font>

66. **Targeting, Personalization, and Engagement in an Agricultural Advisory Service {#34951}**  
   农业咨询服务中的目标定位、个性化与参与度  
   <font color=grey>Susan Athey, Shawn Cole, Shanjukta Nath, Jessica Zhu</font>

67. **The Economics of Algorithmic Personalization: Evidence from an Educational Technology Platform {#34950}**  
   算法个性化推荐的经济学：来自教育科技平台的证据  
   <font color=grey>Keshav Agrawal, Susan Athey, Ayush Kanodia, Shanjukta Nath, Emil Palikot</font>

68. **Medicaid Coverage for Obesity Medications: Utilization and Net-of-Rebate Spending {#34949}**  
   肥胖药物的医疗补助覆盖：使用与净回扣支出  
   <font color=grey>Coady Wing, Wei-Lun Lo, Maddie Potter, Tarik Yuce, Alberto Ortega, John Cawley, Thuy D. Nguyen, Kosali I. Simon</font>

69. **We've Got You Covered: Firms' Political Stances on Abortion and Labor Market Sorting {#34948}**  
   我们为你兜底：企业在堕胎问题上的政治立场与劳动力市场分类  
   <font color=grey>Pawel Adrjan, Svenja Gudell, Emily E. Nix, Allison Shrivastava, Jason Sockin, Evan P. Starr</font>

70. **Deep Learning Projects Jurisdiction of New and Proposed Clean Water Act Regulation {#34947}**  
   深度学习预测新拟议《清洁水法》法规的管辖范围  
   <font color=grey>Simon Greenhill, Brant J. Walker, Joseph S. Shapiro</font>

71. **The Heterogeneous Earnings Impact of Job Loss Across Workers, Establishments, and Markets {#34946}**  
   失业对工人、企业和市场的异质性收入影响  
   <font color=grey>Susan Athey, Lisa K. Simon, Oskar Nordström Skans, Johan Vikström, Yaroslav Yakymovych</font>

72. **The Elasticity of Corporate Taxable Income Across Countries {#34945}**  
   跨国企业应税收入弹性  
   <font color=grey>Claudio Agostini, Zareh Asatryan, Laurent Bach, Govindadeva Bernier, Marinho Bertanha, Katarzyna A. Bilicka, Anne Brockmeyer, Jaroslav Bukovina, Guillermo Falcone, Pablo Garriga, Yuxuan He, Petr Janský, Evangelos Koumanakos, Tomáš Lichard, Tomás Martins, Ján Palguta, Elena Patel, João Pereira dos Santos, Louis Perrault, Thomas Schwab, Nathan Seegert, Oliver Škultéty, Kristina Strohmaier, Maximilian Todtenhaupt, Guillermo Vuletin, Branislav Žúdel</font>

73. **Feel as a Determinant of College Choice: Evidence from Campus Tour Weather {#34944}**  
   感觉作为大学选择的决定因素：来自校园参观天气的证据  
   <font color=grey>Olivia Feldman, Joshua M. Hyman, Matthew L. McGann</font>

74. **The Changing Landscape of International Development: An Introduction {#34943}**  
   国际发展格局的变迁：导论  
   <font color=grey>Pascaline Dupas, Pinelopi Koujianou Goldberg, Rohini Pande</font>

75. **Dollarization Waves: New Evidence From a Comprehensive International Bond Database {#34942}**  
   美元化浪潮：来自一个全面国际债券数据库的新证据  
   <font color=grey>Swapan-Kumar Pradhan, Eswar S. Prasad, Előd Takáts, Judit Temesvary</font>

76. **Institutional Shocks and Migration Adjustment: Evidence from the Syrian Crisis and Brexit’s Referendum and Implementation {#34941}**  
   制度冲击与移民调整：来自叙利亚危机以及英国脱欧公投与实施的证据  
   <font color=grey>Assaf Razin</font>

77. **Market Feedback about Emerging Technologies {#34940}**  
   关于新兴技术的市场反馈  
   <font color=grey>Sean S. Cao, Itay Goldstein, Jie He, Yabo Zhao</font>

78. **The Skill Premium in Times of Rapid Technological Change {#34939}**  
   技术快速变革时期的技能溢价  
   <font color=grey>Tarek Alexander Hassan, Aakash Kalyani, Pascual Restrepo</font>

79. **Reducing Waste through Anti-Fraud Enforcement: Evidence from Hospital Admission Cases {#34938}**  
   通过反欺诈执法减少浪费：来自医院入院案例的证据  
   <font color=grey>David H. Howard, Jetson Leder-Luis</font>

80. **General Social Agents {#34937}**  
   通用社会智能体  
   <font color=grey>Benjamin S. Manning, John J. Horton</font>

81. **Who Gets What in Education: Can School Matching Improve Student Achievement? {#34936}**  
   教育中的谁得到什么：学校匹配能否提高学生成绩？  
   <font color=grey>Atila Abdulkadiroglu, Parag A. Pathak, Christopher R. Walters</font>

82. **Tariffs, Automation, and Business Dynamism {#34935}**  
   关税、自动化与商业活力  
   <font color=grey>Stéphane Auray, Michael B. Devereux, Aurélien Eyquem</font>

83. **From Complaint to Action: Technology-Enabled Quality Improvement from Consumer Reviews {#34934}**  
   从投诉到行动：基于消费者评论的技术赋能质量改进  
   <font color=grey>Guangyu Cao, Shenghao He, Ginger Zhe Jin</font>

84. **Alternatives to 911 {#34933}**  
   911的替代方案  
   <font color=grey>Bocar A. Ba</font>

85. **Personnel is Policy: Delegation and Political Misalignment in the Rulemaking Process {#34932}**  
   人事即政策：规则制定过程中的授权与政治错位  
   <font color=grey>Luca Bellodi, Massimo Morelli, Jörg L. Spenkuch, Edoardo Teso, Matia Vannoni, Guo Xu</font>

86. **When Teachers Break the Rules: Imitation, Reciprocity, and Community Structure in the Transmission of Ethical Behavior {#34931}**  
   当教师违反规则时：道德行为传播中的模仿、互惠与社区结构  
   <font color=grey>Victor Lavy, Moses Shayo</font>

87. **When Do Financial Frictions Matter for Misallocation? {#34930}**  
   金融摩擦何时对资源错配重要？  
   <font color=grey>Yan Bai, Dan Lu, Xu Tian, Yajie Wang</font>

88. **Restoring Nature, Creating Wealth: Evidence from Rural Households in Africa {#34929}**  
   恢复自然，创造财富：来自非洲农村家庭的证据  
   <font color=grey>Geoffrey Heal, Claudio Rizzi, Simon Xu</font>

89. **Competition in Health Insurance Markets {#34928}**  
   健康保险市场的竞争  
   <font color=grey>Martin Gaynor, Amanda Starc</font>

90. **The Effects of a Sudden Stop in Low-Skilled Immigration: Evidence from Korea’s Guest Worker Program {#34927}**  
   低技能移民突然停止的影响：来自韩国客工计划的证据  
   <font color=grey>Jongkwan Lee, Giovanni Peri, Hee-Seung Yang</font>

91. **Repression {#34926}**  
   压制  
   <font color=grey>Gerard Padró I Miquel, Nancy Qian</font>

92. **The Micro-Geography of Persuasion: Randomized Peer Exposure and Legislative Outcomes {#34925}**  
   说服的微观地理学：随机同伴暴露与立法结果  
   <font color=grey>Lauren Cohen, Bo Li</font>

93. **Measuring Payroll Employment: A Note on the Current Employment Statistics {#34924}**  
   衡量薪资就业：关于当前就业统计的说明  
   <font color=grey>Ryan A. Decker</font>

94. **Why People Disagree About What Drives Stock Prices {#34923}**  
   为什么人们对股票价格的驱动因素存在分歧  
   <font color=grey>Andrew Atkeson, Fabrizio Perri, Jonathan Heathcote</font>

95. **The Labor Market Consequences of Rapid Sectoral Shifts {#34922}**  
   快速部门转移的劳动力市场后果  
   <font color=grey>John R. Grigsby, Nathan Zorzi</font>

96. **The Market Value of Reproductive Rights: Evidence from U.S. Housing Markets {#34921}**  
   生育权的市场价值：来自美国住房市场的证据  
   <font color=grey>Daniel L. Dench, Kelly Lifchez, Jason M. Lindo, Jancy Ling Liu</font>

97. **Mergers and Non-contractible Benefits: The Employees' Perspective {#34920}**  
   并购与非契约性利益：员工视角  
   <font color=grey>Wei Cai, Andrea Prat, Jiehang Yu</font>

98. **How does AI Distribute the pie? Large Language Models and the Ultimatum Game. {#34919}**  
   人工智能如何分配蛋糕？大语言模型与最后通牒博弈  
   <font color=grey>Douglas K.G. Araujo, Harald Uhlig</font>

99. **Pay Now, Buy Never: The Economics of Consumer Prepayment Schemes {#34918}**  
   现在付款，永不消费：消费者预付计划的经济学  
   <font color=grey>Yixuan Liu, Hua Zhang, Eric Zou</font>

100. **When Incentives Aren't Enough: Evidence on Inattention and Imperfect Memory from HIV Medication Adherence {#34917}**  
   当激励不足时：来自HIV药物依从性的关于注意力不集中和记忆不完美的证据  
   <font color=grey>Hang Yu, Jared Stolove, Dean Yang, James Riddell IV, Arlete Mahumane</font>
...
【**摘要**】：我利用雇主-雇员关联数据以及巴西贸易自由化带来的关税冲击，估计了贸易对当地劳动力市场集中度的影响及其对工资的启示。贸易使集中度提高了7%，这一效应是由企业退出以及工人流向幸存下来的进口竞争企业所驱动的。集中度的提高降低了工资的实得份额——在冲击前估计为每美元50美分——这足以抵消因重新配置带来的微小工资增长，但并未在净额上显著降低工资。归因于巴西贸易自由化的工资下降，大部分反而是由劳动力边际收入产品的减少所导致的。将非正规部门纳入考量后，揭示了显著的地区异质性。

【**NBER**】: NBER Working Paper No. 35018，https://www.nber.org/papers/w35018

#### 2. Real Effects of Academic Research Revisited {#35017}

【**Author**】: Adam B. Jaffe, Laura B. Shupp, Valentina Tartari
...
【**摘要**】：本章综述了社会科学关于大学对创新和经济增长（无论是在本地/区域层面还是全球层面）贡献的研究发现。在过去几十年里，研究已经证明了大学通过知识创造、学生教育与培训以及技术转移/创业这些机制所产生的因果效应。本章总结了文献如何研究这些机制中的每一个，以及这些发现如何探讨了不同学科和经济部门之间的差异。新的微观数据、连接发明、科学家和机构的新方法，以及网络科学方法的应用，都推动了理解的深度和广度。我们强调，研究已经证明了这些效应在平均水平上的重要性，但迄今为止，对于不同情境下成功或失败的决定因素，研究能提供的见解较少。这些发现对于旨在促进区域和全球创新的公共政策具有启示意义。

【**NBER**】: NBER Working Paper No. 35017，https://www.nber.org/papers/w35017

#### 3. In the Fed’s Mind {#35016}

【**Author**】: Ali Kakhbod, Amir Kermani, Bernardo Maciel
...
【**摘要**】：美联储是否对所有通胀都做出同等反应？我们系统地分析了1937年至2025年的联邦公开市场委员会会议记录，构建了会议层面的衡量指标，用以反映美联储实时将通胀归因于需求压力和供给压力的叙事。我们记录了这些叙事随时间推移的显著变化，并表明，自沃尔克时代以来，美联储对感知到的需求驱动型通胀反应更为激进。与这种不对称性一致，供给压力对已实现通胀的影响更为持久，而需求压力的影响则迅速消散。金融市场也反映了这种区别：需求失衡主要影响风险中性收益率，而供给失衡则提高了期限溢价和股权风险溢价。

【**NBER**】: NBER Working Paper No. 35016，https://www.nber.org/papers/w35016

#### 4. The Economics of Postdoctoral Researcher Positions {#35014}

【**Author**】: Donna K. Ginther, Joshua L. Rosenbloom
...
【**摘要**】：本章考察了1979年至2023年间美国科学劳动力中博士后研究人员数量的急剧增长和角色演变，强调了博士后人数增长了四倍，其增速超过了研究生和教职人员的增长。我们认为，这种扩张反映了科学资助的碎片化性质，特别是21世纪初美国国立卫生研究院预算翻倍的影响，这既增加了博士后的供给也增加了需求，但最终恶化了就业条件。本章还探讨了博士后的职业成果，指出在学术界之外的经济回报有限，并且向教职岗位的转变在减少。鉴于近期博士后数量的下降、移民政策的收紧以及薪酬的上升，美国似乎可能已经达到了“博士后峰值”，这可能导致未来研究产出的减少。本章最后呼吁改进数据并进行进一步研究，以更好地理解博士后在科学生产和职业发展中的作用。

【**NBER**】: NBER Working Paper No. 35014，https://www.nber.org/papers/w35014

#### 5. Dynamic Adjustment to Trade Shocks {#35013}

【**Author**】: Junyuan Chen, Carlos Góes, Marc-Andreas Muendler, Fabian Trottner
...
【**摘要**】：全球贸易流动和供应链是逐步调整的。短期贸易弹性的实证估计值仅为长期贸易弹性的一小部分，这表明贸易受到显著的动态摩擦影响。我们开发了一个易于处理的框架，为贸易调整提供了微观基础，并合理化了时变贸易弹性的估计。该模型以面临粘性采购选择的前瞻性企业为特征，并将伊顿-科图姆模型的一个版本作为极限长期情况嵌套其中。我们对模型进行了校准，并量化了两个事件的影响：2004年欧盟东扩（一个预期到的变化）和2018年中美贸易战（一个可以说是未预期到的变化）。我们的研究结果表明，采购摩擦和预期效应改变了专业化的时间模式，可能导致短期福利损失但长期收益，并且可以在预期冲击发生之前推动显著的贸易调整。

【**NBER**】: NBER Working Paper No. 35013，https://www.nber.org/papers/w35013
...
【**摘要**】：许多重要的经济决策不仅依赖于获取信息，还依赖于在承诺采取行动之前确定哪些问题值得提出。个人和组织必须组织探究：他们选择问题，解读答案，并以决定是否识别出或错过关键区分的方式更新信念。尽管其重要性，探究的组织在很大程度上缺席于正式的经济分析。
本文研究在“诊断不确定性”下的决策制定，在这种不确定性下，行动者不仅需要了解与收益相关的状态，还需要了解哪些问题具有信息量。我们开发了一个模型，在该模型中，行动者在承诺行动之前顺序地选择问题，同时面临一个潜在诊断结构的不确定性，该结构支配着问题如何产生答案。在每个探究步骤之前，行动者可能会承担认知成本来完善关于这个诊断结构的信念。由此产生的问题是一个关于探究的有限期动态规划，其中昂贵的注意力被分配给对诊断结构的信念转换，而不是直接分配给与收益相关的状态。
两种典型的诊断几何结构隔离了不同的规划边际。在一种中，价值取决于定位一个决定性问题；在另一种中，价值取决于维持一个正确的问题序列。两种环境都产生闭式解，并得出一个共同的表示，其中最优探究相对于无信息搜索提高了成功的概率。
该框架识别出经济行为的一个独特边际——诊断不确定性下的规划——这在答案丰富但探究组织仍然稀缺的环境中变得越来越重要。

【**NBER**】: NBER Working Paper No. 35012，https://www.nber.org/papers/w35012

#### 7. Knowledge Spillovers and Local Outcomes: An Existence Proof from the Establishment of the National Labs {#35011}

【**Author**】: Susan Helper, Resem Makan, Daniel W. Shoag
...
【**摘要**】：我们研究了20世纪40至50年代美国国家实验室的建立，以估计公共研究基础设施带来的地方溢出效应。这一设定使我们能够因果地识别此类溢出效应，原因有二：1）实验室选址在很大程度上是基于安全和政治原因，而非现有或潜在的创新能力；2）我们利用档案资料确定了备选地点。我们发现了多种类型的知识溢出效应：与对照县相比，实验室所在县的非实验室发明人的专利申请量出现了大幅且持久的增长；同一县内非实验室专利的研究领域向实验室的研究领域转变，并且更频繁地引用实验室的专利。利用1936年至1970年间新数字化的县级数据，我们发现零售额和家庭收入持续增长。1940年至1950年的关联人口普查记录显示，留在实验室县的原有居民获得了工资增长，对受过大学教育的工人的影响更大。我们发现，在学龄期暴露于实验室建立的队列获得了更多的教育，这与人力资本渠道一致。尽管早期核研究存在广泛的保密性，但溢出效应仍然出现，这表明即使在信息流动受限的情况下，与公共研发机构共处一地也能产生可观的地方收益。

【**NBER**】: NBER Working Paper No. 35011，https://www.nber.org/papers/w35011

#### 8. Adaptive Enforcement with AI-Augmented Monitoring {#35010}

【**Author**】: Ginger Zhe Jin, D. Daniel Sokol, Liad Wagman
...
【**摘要**】：我们研究了一个新颖的动态检查博弈，其中监管者承诺使用一种检测技术，而被监管的企业则选择是否从事有害行为，并且在被检测到并受到制裁后，选择是否承担重新设计成本以产生一个需要重新检测的修改后的违规行为。在这个自适应环境中，有界制裁产生了三个马尔可夫完美均衡：完全合规、直到被识别才停止危害、以及持续重新设计。我们表明，人工智能增强的监控可以将均衡从持续重新设计转变为直到被识别才停止危害，但这仅在监管投资跨越一个制度转换阈值时才能实现。低于这个阈值，更高的监控强度可能会增加执法工作量而不减少总危害，因为监管者反复检测到适应性的违规行为，而企业则继续进行重新设计。因此，对人工智能监控的部分投资可能产生拥堵而非威慑。当企业也可以采用人工智能来降低其重新设计成本时，监管者的威慑阈值会上升，从而强化了执法与规避技术之间的战略互动。此外，当人工智能标记的违规行为需要人工审查且监管审查能力有限时，拥堵问题变得尤为突出。在这种情况下，人工智能分流（triage）的精确度——尤其是其误报率——与检测强度同等重要。因此，执法有效性不仅取决于扩大检测范围，还取决于有效分配稀缺的人工审查资源。

【**NBER**】: NBER Working Paper No. 35010，https://www.nber.org/papers/w35010

#### 9. The Effects of Fiscal News on Household Expectations and Spending: New Causal Evidence {#35009}

【**Author**】: Myungkyu Shim, Kwang Hwan Kim, Myunghwan Andrew Lee, Sangyup Choi, Siye Bae, Olivier Coibion, Yuriy Gorodnichenko
...
【**摘要**】：我们提供了关于财政新闻如何塑造家庭预期和支出行为的实验证据。利用一项针对约11,000名韩国个体的新调查，该调查与自动收集的高频支出数据相关联，我们引出了受访者的财政和宏观经济信念，并随机向他们提供五条信息中的一条，内容涉及当前公共债务水平、财政赤字以及政府减少赤字的计划。预期未来公共债务的外生性增加会提高预期通胀率并增加消费者支出。另一方面，预期财政平衡的外生性增加会提高预期产出增长，但对消费者支出没有显著影响。

【**NBER**】: NBER Working Paper No. 35009，https://www.nber.org/papers/w35009

#### 10. The Cold War and the U.S. Labor Market {#35008}

【**Author**】: Ilyana Kuziemko, Donato A. Onorato, Suresh Naidu
...
【**摘要**】：我们认为冷战对战后几十年的包容性增长做出了贡献。在劳动力需求方面，我们分离了各州和企业间军事采购的外生性变化。我们表明，军事采购增加了制造业就业并减少了不平等。总体而言，1950年代至1990年代国防生产的下降解释了制造业就业下降的大约四分之一，以及前10%收入份额上升的近十分之一。在劳动力供给方面，冷战时期的征兵制使数百万年轻男性退出劳动力队伍，显著降低了年轻男性平民失业率。军事采购还增加了选民对鹰派外交政策的支持。

【**NBER**】: NBER Working Paper No. 35008，https://www.nber.org/papers/w35008

#### 11. The Hidden Cost of Stock Market Concentration: When Funds Hit Regulatory Limits {#35007}

【**Author**】: Lubos Pastor, Taisiya Sikorskaya, Jinrui Wang
...
【**摘要**】：随着股市集中度的上升，对基金投资组合集中度的监管限制变得越来越具有约束力，尤其是对于大盘成长型基金。当基金接近这些限制时，它们会减持其最大持仓并降低股票敞口。基金在受到约束时表现更差。一种基于约束的持股度量指标可以预测股票回报，尤其是在最大的公司中。这些发现表明，高市场集中度会通过限制乐观投资者扩大其头寸的能力来扭曲股票价格。正如卖空限制可以通过限制悲观投资者的观点导致定价过高一样，对多头头寸的限制可以通过压制乐观投资者的观点导致定价过低。

【**NBER**】: NBER Working Paper No. 35007，https://www.nber.org/papers/w35007

#### 12. Cash Transfers and Productive Inclusion: Evidence from Bolsa Familia {#35006}

【**Author**】: Michael C. Best, Felipe Lobel, Valdemar Pinho Neto
...
【**摘要**】：我们研究现金转移如何影响工作和健康。利用世界上最大的针对极端贫困人口的现金转移计划慷慨度的增加，我们表明这项改革使就业率提高了5%，同时显著改善了健康状况：住院率下降了8%，死亡率下降了14%，挽救了大约1000条生命。这些发现挑战了转移支付会减少工作的观点。相反，转移支付可以放松具有约束力的生存和健康约束，提高生产力，并扩大劳动力供给。我们在一个生产性包容模型中形式化了这一机制，并用它来评估福利，为低收入环境下的反贫困政策设计提供了经验教训。

【**NBER**】: NBER Working Paper No. 35006，https://www.nber.org/papers/w35006

#### 13. Early-Life Sugar Restrictions Reduce Genetic Disparities in Adult Adiposity {#35005}

【**Author**】: Tadeja Gracner, Claire Boone, Patrick Turley, Paul Gertler
...
【**摘要**】：遗传学通过影响食欲和新陈代谢的遗传机制赋予2-3倍更高的肥胖风险，这些途径在生命最初的1000天内尤其可改变。我们利用1953年9月英国糖配给制的结束——这是一个根据受孕日期划分的生命早期糖分暴露的急剧不连续性——来检验糖分限制是否能减轻由基因决定的肥胖风险，使用英国生物银行数据将肥胖多基因指数与肥胖表型联系起来。在没有配给制的情况下，高遗传风险个体的肥胖患病率是低风险个体的三倍。通过两岁前的限制，这一差异缩小了40%，其作用机制是通过内脏肥胖而非全身性肥胖，并且集中在肥胖水平高于中位数的高风险成年人中。早期的营养环境可以改变遗传的肥胖轨迹，这指向了有针对性的生命早期干预措施，以减少由基因决定的健康不平等。

【**NBER**】: NBER Working Paper No. 35005，https://www.nber.org/papers/w35005

#### 14. Using Global Shocks to Understand the Level and Structure of Executive Compensation {#35004}

【**Author**】: David Hummels, Jakob Munch, Huilin Zhang
...
【**摘要**】：我们构建了一个CEO薪酬模型，该模型在面对与CEO努力相互作用的贸易冲击时，统一了委托-代理模型和分配模型。该模型预测，贸易冲击通过规模、波动性和能力放大渠道改变CEO薪酬。利用丹麦匹配的工人-企业数据，我们找到了支持这些渠道的经验证据：(1) 对贸易的外生冲击增加了企业的规模和价值以及CEO薪酬；(2) 支付给CEO的企业价值份额随着企业的规模和价值的增加而增加，并且随着全球冲击引发的波动性增加而增加；(3) 能力更高的CEO通过结合减少损失和最大化正向冲击回报的方式，使企业价值的增长超过其薪酬的100倍以上。

【**NBER**】: NBER Working Paper No. 35004，https://www.nber.org/papers/w35004
...
【**摘要**】：非线性定价理论预测，企业可以通过诱导异质性消费者在事后对他们来说最优的价格合同要约中进行自我选择来提取剩余。我们研究了当无摩擦分类假设不成立时的订阅定价。利用Lyft进行的大规模订阅实验，我们记录了与最优自我选择的系统性偏离：许多高需求消费者拒绝了本可以为他们省钱的订阅，而一些订阅者未能实现收支平衡。我们开发了一个集约边际需求的结构模型，在该模型中，消费者可能表现出显著性失败、对未来需求的预测错误或冲动性。我们表明，订阅的采用可以被重新解释为二元工具变量框架中的单侧不依从，这使我们能够利用局部平均处理效应方法来识别反事实结果分布，以及一个新颖的“采用函数”，将基线结果与依从行为联系起来。将实验性价格变化与这种识别策略相结合，我们恢复了效用基础、需求异质性和行为参数。显著性失败和预测错误起着数量上重要的作用。反事实分析表明，最优订阅定价相对于线性定价产生了可观的收益，但这些收益对消费者偏离事后最优选择的行为高度敏感。因此，实施非线性定价不仅需要针对消费者筛选的最优合同设计，还需要协调努力以减轻行为摩擦。

【**NBER**】: NBER Working Paper No. 35003，https://www.nber.org/papers/w35003
...
【**摘要**】：本文考察了1972年10月全国卡车司机罢工期间的Cybersyn——萨尔瓦多·阿连德领导下的智利网络化协调系统，该罢工使工业总产出减少了大约9%。利用二十个行业的月度数据和一个校准的CES-列昂惕夫模型，我为卡车运输冲击构建了特定行业的反事实。四个政府指定的优先行业的表现平均比其结构性预测高出17个指数点；优先-非优先差异位于排列零分布的第90百分位（p = 0.100）。缓解是有选择性的：集中在具有国有企业所有权、简单供应链和军事配送支持的行业。在协调需求最大的地方——食品和饮料——优先指定没有提供可衡量的保护。Cybersyn在保护最容易保护的行业方面比保护最需要保护的行业更有效：这是一种部分证实及其局限性的现实评估。

【**NBER**】: NBER Working Paper No. 35002，https://www.nber.org/papers/w35002
...
【**摘要**】：我们研究了一种贷款合同，该合同要求借款人在放款前存入一笔临时现金存款，该存款将全额退还且不会改变还款激励。在与一家数字贷款机构进行的随机对照试验中，申请人被提供除有无存款要求外完全相同的贷款。存款要求降低了贷款接受率，但显著改善了还款情况和贷款机构的盈利能力。结果表明，存款机制能够根据借款人的可观测和不可观测特征进行筛选。高风险借款人接受存款贷款的可能性较低；而在具有相同可观测风险特征的借款人中，接受存款贷款的借款人还款率更高，其中低风险借款人之间的差异最大。这些发现表明，简单的合同特征可以通过增加额外的筛选维度来补充数据驱动的信贷模型。

【**NBER**】: NBER Working Paper No. 35001，https://www.nber.org/papers/w35001

#### 18. Decoupling Dollar and Treasury Privilege {#35000}

【**Author**】: Wenxin Du, Ritt Keerati, Jesse Schreger
...
【**摘要**】：我们记录了美元与美国国债的便利收益之间存在显著解耦。我们使用无风险银行利率（例如基准改革后的有担保隔夜利率）之间的抛补利率平价（CIP）偏差来衡量美元的便利性。同时，我们通过政府债券收益率之间的CIP偏差来衡量美国国债的便利性。我们发现，近年来这两种便利性指标出现了显著分化：尽管美元在全球金融危机后表现出强劲的便利性，但美国国债的便利性不仅大幅下降，而且转为负值，在中长期期限上尤为明显。我们认为，美国与其他发达市场之间政府债券的相对供给，是决定美国国债相对于其他政府债券便利性的关键驱动因素。最后，我们提出了一个包含受约束的全球金融中介机构的简单框架，以将美元便利性与国债便利性联系起来。

【**NBER**】: NBER Working Paper No. 35000，https://www.nber.org/papers/w35000

#### 19. The Impact of Virtual Instruction on the Transition to College: Evidence from COVID-19 {#34999}

【**Author**】: Nolan G. Pope, Yu Hung Yaow
...
【**摘要**】：在COVID-19疫情期间，虚拟教学减少了可能帮助高中生过渡到大学的线下支持。利用关于FAFSA提交、ACT参与和大学一年级入学的全国性学校层面数据，我们估计了一个双重差分模型，该模型利用了2020/2021学年各学校在虚拟教学方面的差异。一个完全虚拟的学年使FAFSA提交率降低了4.2个百分点，ACT参与率降低了4.8个百分点，大学一年级入学率降低了2.5个百分点。FAFSA提交率在重新开放后部分回升，但ACT参与率和大学入学率并未恢复。在弱势学校中，这些影响要大得多。

【**NBER**】: NBER Working Paper No. 34999，https://www.nber.org/papers/w34999

#### 20. Special Education Substantially Improves Learning: Evidence from Three States {#34998}

【**Author**】: Stephanie G. Coffey, Joshua Goodman, Amy Ellen Schwartz, Leanna Stiefel, Marcus A. Winters, Yunee H. Yoon
...
【**摘要**】：特殊教育服务于超过七分之一的美国学生，但其因果影响仍未得到充分研究。利用来自马萨诸塞州、印第安纳州和康涅狄格州的纵向数据，我们采用事件研究设计，追踪学生初始分类前后的学业成绩，来估计个性化支持的效果。学生的分数在安置前下降，之后急剧上升，形成一致的V形模式。三年内，学业成绩比反事实趋势所暗示的高出0.2-0.4个标准差。不同残疾类别和子群体之间的收益相似，并非由考试便利措施驱动，并且在保守假设下依然稳健。个性化支持显著提高了学习生产力。

【**NBER**】: NBER Working Paper No. 34998，https://www.nber.org/papers/w34998

#### 21. Paid Caregiving Leave Policies and an Update on Paid Parental Leave {#34997}

【**Author**】: Priyanka Anand, Tamar Matiashvili, Maya Rossin-Slater
...
【**摘要**】：带薪休假政策旨在帮助工人平衡工作与照护责任，然而研究主要集中在育儿假上，关于非育儿照护假的文献仍处于起步阶段。本章回顾了带薪家事假（PFL）和带薪病假（PSL）政策影响的证据，重点关注与分娩无关的照护。我们首先概述了美国及国际上非正式照护的普遍性和挑战，随后描述了当前带薪照护假政策的格局。接着，我们回顾了这些政策对休假使用、劳动力市场结果、照护者健康与福祉、雇主结果以及正式照护利用的影响证据。我们发现，带薪休假政策成功提高了休假使用率，并且PFL改善了有照护责任的工人的劳动力市场结果，同时未对雇主产生不利影响。还有一些提示性证据表明照护者的心理健康有所改善。此外，我们自Rossin-Slater（2018）上次综述以来，对带薪育儿假文献进行了更新，描述了关于孕产妇健康、儿童健康与发展、父母劳动力市场结果和雇主结果的最新证据。最后，我们指出了文献中的关键空白，包括缺乏对（非子女）照护接受者结果的研究、关于雇主反应的证据有限，以及PSL在支持照护需求方面未被充分探索的作用。

【**NBER**】: NBER Working Paper No. 34997，https://www.nber.org/papers/w34997

#### 22. Supporting Student Engagement During Remote Learning: Three Randomized Controlled Trials in Chicago Public Schools {#34996}

【**Author**】: Monica P. Bhatt, Jonathan Guryan, Fatemeh Momeni, Philip Oreopoulos, Eleni Packis
...
【**摘要**】：本文介绍了三项现场实验的结果，这些实验测试了旨在提高远程教育期间学生参与度和改善学习的干预措施。自COVID-19大流行以来，当学校教育中断时使用远程学习变得更加普遍，这促使教育工作者提出疑问：我们如何在远程教学中更好地吸引学生？这一点尤为重要，因为我们对学生参与的大部分了解都基于线下教学，而非虚拟教学。在第一项实验中，我们发现个性化电话提高了家庭注册芝加哥公立学校虚拟暑期学校项目的可能性，这是预先指定的主要结果。在第二项实验中，我们发现发送每周短信对学生的暑期缺课天数和可汗学院使用情况（主要结果）没有影响；在对次要结果的分析中，我们发现每周短信提高了学生通过暑期数学课程的可能性。在第三项实验中，我们发现增加一名教学助理来补充课堂教师对暑期缺课天数和可汗学院使用情况（主要结果）没有影响；在对次要结果的分析中，我们发现对下一学年学生的数学成绩和通过率产生了有益影响。

【**NBER**】: NBER Working Paper No. 34996，https://www.nber.org/papers/w34996

#### 23. Mind the Gap: AI Adoption in Europe and the U.S. {#34995}

【**Author**】: Alexander Bick, Adam Blandin, David J. Deming, Nicola Fuchs-Schündeln, Jonas Jessen
...
【**摘要**】：本文结合2025年和2026年进行的工人和企业调查的国际证据，记录了AI采纳方面的巨大差距，既存在于美国与欧洲之间，也存在于欧洲各国之间。工人人口统计特征和企业构成的跨国差异解释了这些差距的很大一部分。在各国国内和跨国之间，AI采纳也与企业人事管理实践以及企业是否积极鼓励工人使用AI密切相关。微观层面的证据表明，AI为许多工人带来了有意义的节省时间的效果。在宏观层面，近年来AI采纳率较高的行业经历了更快的生产率增长。虽然我们未建立因果关系，但这种关系在统计上显著，且在欧洲和美国的规模相似。我们没有发现明确的证据表明行业层面的AI采纳与就业变化相关。我们讨论了现有数据的局限性，并概述了未来数据收集的优先事项，以便更好地评估AI的生产率和劳动力市场效应。

【**NBER**】: NBER Working Paper No. 34995，https://www.nber.org/papers/w34995
...
【**摘要**】：人工智能等新技术的快速进步引发了人们对劳动力市场负面影响的广泛焦虑。本文探讨如何引导创新努力，以增加劳动力需求并创造薪酬更高的就业岗位，同时评估这种方法的局限性。我们构建了一个理论框架，以确定从工人角度看一项创新应具备的理想属性，包括其与劳动的技术互补性、受影响工人的相对收入，以及劳动在生产相关商品中的要素份额。应用包括机器人税、要素偏向性进步和任务自动化。在我们的框架中，社会保障网络效率越低，引导技术的福利收益就越大。随着技术进步使劳动贬值，引导的福利收益起初会增加，但超过某个临界阈值后会下降，最优政策转向更大的再分配。此外，随着劳动的经济价值下降，引导进步的重点日益转向提升人类福祉而非劳动生产率。

【**NBER**】: NBER Working Paper No. 34994，https://www.nber.org/papers/w34994

#### 25. Bank Fees and Household Financial Well-Being {#34993}

【**Author**】: Michaela Pagel, Sharada Sridhar, Emily Williams
...
【**摘要**】：在本研究中，我们考察了2017年至2022年间美国大型银行的政策变化，这些变化取消了资金不足（NSF）费用并放宽了透支政策。利用个人交易层面的数据，我们发现，不出所料，取消NSF费用导致各收入阶层的NSF收费立即减少。然而，放宽透支政策仅在收入和流动性维度上减少了较富裕家庭的透支费用，并且只有这些家庭随后在滞纳金、利息支付、账户维护费以及替代性金融服务（如发薪日贷款）的使用方面有所减少。因此，我们的结果表明，这些政策变化不足以显著减轻更脆弱家庭的财务压力。由于我们的研究设定包含多种处理方式以及处理强度的变化，我们从理论上进行论证，并实证实施了一种新的堆叠事件研究估计量，该估计量与de Chaisemartin等人（2024）的方法密切相关，以解决交错双重差分设定中产生的偏差。

【**NBER**】: NBER Working Paper No. 34993，https://www.nber.org/papers/w34993

#### 26. Preferences for Warning Signal Quality: Experimental Evidence {#34992}

【**Author**】: Alexander Ugarov, Arya Gaduh, Peter McGee
...
【**摘要**】：我们通过一个实验室实验来研究在已知先验概率下，对不良事件的预警信号的假阳性率和假阴性率的偏好。我们发现，受试者随着信号质量的提高而降低其需求，但降低幅度小于我们理论的预测。存在由先验概率导致的非对称反应不足：对于低（高）先验概率，他们的支付意愿未能完全针对假阳性（假阴性）成本的增加进行调整。我们表明，风险偏好和贝叶斯更新技能都无法完全解释我们的结果。我们的结果与一种决策启发式最为一致，在这种启发式中，受试者不区分假阳性错误和假阴性错误。

【**NBER**】: NBER Working Paper No. 34992，https://www.nber.org/papers/w34992

#### 27. Private Credit, Balance Sheets and Financial Stability {#34991}

【**Author**】: Gregor Matvos, Tomasz Piskorski, Amit Seru
...
【**摘要**】：我们利用覆盖该行业大部分领域的综合性基金和资产层面数据，记录了关于私人信贷基金资本化、融资结构和业绩的新证据。私人信贷基金资本化程度很高，股权通常占总资产的65-80%——是美国银行资本化水平的六倍多，后者的股权约占10%。债务使用适度，且主要反映用于流动性管理的银行信贷额度。基金存续期平均为10-12年，而基础贷款期限通常更短，这意味着几乎没有或根本没有期限错配——这与银行不同，银行用短期可随时提取的存款为长期资产融资。私人信贷组合在行业、地域和信贷策略上实现了多元化，减少了对相关冲击的风险敞口。业绩数据显示，平均年化净回报率为正，且债权人的下行风险有限，因为损失主要由股权投资者承担。总体而言，私人信贷基金的结构似乎较为保守，在其当前的资产负债表配置下，不太可能产生与传统银行相当的系统性风险。最后，我们讨论了随着该行业增长可能出现的潜在脆弱性，包括治理和披露摩擦、压力时期动态、银行与非银行关联，以及通过有限合伙人资产负债表和零售投资工具传导的损失。

【**NBER**】: NBER Working Paper No. 34991，https://www.nber.org/papers/w34991

#### 28. The Effects of California's $\$20$ Fast Food Minimum Wage on Prices {#34990}

【**Author**】: Jeffrey Clemens, Olivia Edwards, Jonathan Meer, Joshua D. Nguyen
...
【**摘要**】：我们利用美国劳工统计局21个大都市统计区的在外就餐消费者价格指数，分析了加州20美元快餐最低工资（第1228号议会法案，于2023年9月颁布，2024年4月实施）对消费价格的影响。截至2024年12月，加州四个样本内MSA的在外就餐价格相对于17个控制组MSA上涨了3.3%至3.6%。我们的估计值在多种设定下保持稳定。对未受该政策影响的商品和服务（包括在家食品）价格指数进行的安慰剂检验显示，加州的MSA没有出现差异性的上涨。我们估计的价格上涨可能部分源于对全服务餐饮业的溢出效应，以及有限服务餐厅生产函数和产品质量选择的改变。

【**NBER**】: NBER Working Paper No. 34990，https://www.nber.org/papers/w34990

#### 29. The Precarious Financial Lives of College Students in Sub-Saharan Africa {#34989}

【**Author**】: Natalie Bau, Corinne Low, Simona Simona, Bryce Steinberg
...
【**摘要**】：与较富裕地区不同，非洲的高等教育投资常被认为既不公平又低效。然而，尽管非洲将贡献世界未来的大部分劳动力，但关于大学生财务约束的信息却很少。来自赞比亚一所旗舰大学的新数据显示，学生的财务脆弱性和粮食不安全程度非常高，与“极端贫困”人群相当。由于大学通常位于城市，现金匮乏的农村学生难以应对高昂的城市生活成本。被分配校内宿舍能降低财务脆弱性并带来更好的学业成果。为非洲大学生提供财务支持可能同时促进公平和效率。

【**NBER**】: NBER Working Paper No. 34989，https://www.nber.org/papers/w34989
...
【**摘要**】：本文研究了大萧条时期最后贷款人（LLR）干预对劳动力市场的长期后果。我利用联邦储备区边界创造的一个自然实验，该边界分隔了亚特兰大和圣路易斯联邦储备银行管辖下的县。在1930年的银行恐慌期间，亚特兰大联储积极向陷入困境的银行提供流动性，而圣路易斯联储则基本不进行干预。利用新数字化的县级制造业数据以及1930年和1940年关联的个人层面人口普查记录，我考察了这种流动性支持对地方经济活动和工人结果的影响。亚特兰大区内的县在1930年代初期经历了更少的银行倒闭和更强的制造业表现。这些差异转化为持续的劳动力市场效应：到1940年，受处理县的个人更有可能留在制造业就业，并且更不可能跨州迁移。结果表明，金融稳定政策可以塑造劳动力在区域和部门间的长期配置。

【**NBER**】: NBER Working Paper No. 34988，https://www.nber.org/papers/w34988

#### 31. Substitution and Income Effects of Labor Income Taxation {#34987}

【**Author**】: Michael Graber, Morten Håvarstein, Magne Mogstad, Gaute Torsvik, Ola L. Vestad
...
【**摘要**】：应税收入弹性（ETI）参数是税收政策和劳动供给实证分析中的一个关键量。我们考察了何时可以使用一类常用的ETI估计量来了解个人的ETI参数及其（非）补偿劳动供给弹性。我们首先为这些估计量能够被解释为异质性ETI参数的正加权平均值提供了必要和充分条件。然后，我们将这些结果应用于实证分析挪威税制的一项改革，该改革降低了中等收入和高收入的边际税率。估计的ETI参数随收入稳步增加，这意味着高收入个体对税收变化的反应比中等收入个体更大。接下来，我们展示了如何直接从ETI估计量中界定（非）补偿劳动供给弹性，或者通过将这些估计量与对彩票中奖收入反应的估计相结合来点识别这些弹性。结果表明，中等收入个体的（非）补偿弹性为0.1（0.0）。对于高收入个体，（非）补偿弹性估计值稳步上升至约0.45（0.3）。这些发现意味着税收存在巨大的超额负担，并且降低高收入税率将增加税收收入。我们的发现也有助于了解跨期替代弹性和弗里希弹性如何随收入分布变化。

【**NBER**】: NBER Working Paper No. 34987，https://www.nber.org/papers/w34987

#### 32. What Makes New Work Different from More Work? {#34986}

【**Author**】: David Autor, Caroline Chin, Anna M. Salomons, Bryan Seegmiller
...
【**摘要**】：我们利用新近可获取的1940年和1950年人口普查完整计数文件以及2011-2023年保密的美国社区调查数据，研究了专业知识在新工作（即随着技术和经济条件演变而出现的新职业角色）中的作用。我们表明，新工作与现有职业中单纯更多的工作在四个方面存在系统性差异。第一，它吸引了具有独特特征的工人：即使在详细的职业-行业单元内，新工作也由更年轻、受教育程度更高的工人不成比例地承担。第二，新工作带来了经济上显著的工资溢价，并且这种溢价在工人最初进入新工作之后仍然持续存在，这与稀缺、专业化专业知识的回报一致，而非暂时的市场失衡。第三，随着专业知识的扩散，这些溢价在不同“代际”间下降，“更新”的新工作比“较旧”的新工作享有更大的溢价。第四，新工作的出现可以追溯到特定地点和时期的特定需求冲击，这表明专业知识的形成是对经济机会的系统性反应。这些发现表明，新工作作为自动化导致的工作岗位流失的抵消力量，不仅通过创造额外的就业机会，而且还通过产生新的、能获得市场溢价的人类专业知识领域来发挥作用。这种基于专业知识的机制有助于解释几十年来工作活动种类的不断扩展以及劳动份额在历史上的韧性。

【**NBER**】: NBER Working Paper No. 34986，https://www.nber.org/papers/w34986

#### 33. Contract Enforcement and Young Firm Capital Structure: A Global Perspective {#34985}

【**Author**】: Gonzalo E. Basante Pereira, Ina Simonovska
...
【**摘要**】：我们构建了一个框架来衡量各国年轻企业面临的融资约束严重程度。利用23个经济体的ORBIS资产负债表数据，我们表明，在企业生命周期的早期，短期杠杆率上升而长期杠杆率下降，这种模式在合同执行较弱的国家持续更久。我们建立了一个在有限执行条件下的最优融资模型，该模型包含内生债务期限和蓝图产能，能够匹配这些模式，并实现对融资约束的结构性测量。该框架将资金缺口分解为企业内部随还款历史而缓解的借贷约束，以及可通过跨国比较识别的规模扭曲。

【**NBER**】: NBER Working Paper No. 34985，https://www.nber.org/papers/w34985

#### 34. Artificial Intelligence, Productivity, and the Workforce: Evidence from Corporate Executives {#34984}

【**Author**】: Salomé Baslandze, Zachary Edwards, John Graham, Ty McClure, Brent H. Meyer, Michael Sparks, Sonya R. Waddell, Daniel Weitz
...
【**摘要**】：我们利用一项对近750名企业高管进行的新调查数据，研究人工智能对生产力和劳动力的影响。我们记录了企业在人工智能采用方面的显著异质性，超过一半的企业已经进行了投资，尽管许多小企业才刚刚开始。劳动生产率提升是正向的，在不同行业间存在差异，并预计在2026年将进一步加强，其中最大的影响集中在高技能服务业和金融业。这些提升并非主要由企业的资本深化驱动，而是反映了基于收入的全要素生产率的增长，这与创新导向和需求导向的渠道密切相关。我们记录了一个生产力悖论，即感知到的生产力提升大于测量到的生产力提升，这很可能反映了收入实现的延迟。在劳动力市场，我们几乎没有发现人工智能导致近期总体就业下降的证据，尽管大公司预期会出现人工智能驱动的劳动力减少，而小公司则预期会有适度增长。我们还发现了劳动力在企业内部和企业之间进行构成性重新配置的证据，常规文职岗位减少，而对熟练技术岗位的相对需求增加。我们构建了一个指数，对受人工智能负面影响最大的工作职能进行排序。

【**NBER**】: NBER Working Paper No. 34984，https://www.nber.org/papers/w34984

#### 35. An 'Austrian' Model of International Specialization {#34983}

【**Author**】: Pol Antràs, Adrian Kulesza
...
【**摘要**】：我们建立了一个国际贸易的一般均衡模型，其中生产的时间结构是比较优势的关键决定因素。基于庞巴维克的资本理论，该模型形式化了这样一个观点：由于投入支付与收入实现之间存在时间差，平均生产周期较长的生产过程会带来更高的融资成本。我们将这一见解嵌入到一个具有内生利率的多部门李嘉图框架中。在自给自足状态下，拥有更耐心消费者或更发达金融市场的国家表现出更低的均衡利率和更高的工资率。在存在国际贸易的情况下，这些国家通常在平均生产周期较长的部门获得比较优势，尽管该模型也可能产生多重均衡和非常规的专业化模式。我们将该框架扩展到包括贸易成本（含运输延误）、全球价值链和国际资本市场一体化。在实证方面，我们提供的证据表明，即使控制了比较优势的标准新古典和制度决定因素，金融体系更发达的国家在平均生产周期较长的部门出口比例也更高。

【**NBER**】: NBER Working Paper No. 34983，https://www.nber.org/papers/w34983

#### 36. Household Migration and Collateral Constraint: Cash-based Housing Resettlement in China {#34982}

【**Author**】: Zhiguo He, Zehao Liu, Xinle Pang, Yang Su, Kunru Zou
...
【**摘要**】：抵押品约束通过限制购房融资，限制了家庭向昂贵地区的迁移。这种内生的区位选择放大了放松家庭借贷约束的影响。利用中国的现金化棚户区改造项目（2015-2018年）作为自然实验，我们提供的证据表明，现金安置——通过将非流动性的棚户区房屋转换为现金——促进了家庭区位升级，并推高了更昂贵地区的房价。一个包含抵押品约束的动态空间模型证实了家庭对现金转移的迁移反应。在定量分析中，内生迁移将家庭住房支出反应放大了约40%，并且能够解释2016-2020年房价增长的20%以上。

【**NBER**】: NBER Working Paper No. 34982，https://www.nber.org/papers/w34982

#### 37. The Long-Term Decline of the U.S. Job Ladder {#34981}

【**Author**】: Niklas Engbom, Aniket Baksy, Daniele Caratelli
...
【**摘要**】：我们量化了美国劳动力市场的结构性变化在过去四十年中如何通过削弱职业阶梯而导致工资停滞。利用1982-2023年的当前人口调查微观数据和一个局部均衡的职业阶梯模型，我们估计，如今在职员工获得更高薪酬外部工作机会的可能性大约是1980年代的一半。这种下降不太可能反映匹配效率降低、劳动力需求减弱或工人接受行为的变化。相反，跨州的变化与雇主集中度上升以及竞业禁止协议使用的增加相一致，这些因素限制了跳槽机会。在该模型的一般均衡版本中，我们发现这些变化使实际工资年增长率降低了0.68个百分点——约占1980年后工资增长放缓的三分之一——其中约三分之二的影响是通过均衡工资设定而非机械性重新配置发挥作用的。

【**NBER**】: NBER Working Paper No. 34981，https://www.nber.org/papers/w34981

#### 38. Does Employment Shift Mothers' Voting Behavior and Political Identity? {#34980}

【**Author**】: Jacob Bastian
...
【**摘要**】：尽管工作与投票之间的相关性是正的，但我提供了第一个因果证据表明这种关系是负的。利用五十年的劳动所得税抵免政策扩张和1990年代的福利改革作为就业的工具变量，我发现工作会降低低收入母亲的选民投票率并增加其保守主义倾向。选民登记、政治知识和公民参与度下降，而对保守政策的偏好上升。这些影响在未婚、年轻和受教育程度较低的母亲中最大，并且在非大都市地区显著更强。值得注意的是，政治转变主要集中在白人女性中，尽管非白人女性的就业增长更大，这部分是由于白人女性进入了更保守的同事环境。先前的工作经历也很重要：母亲没有工作经历的女性经历了更大的意识形态转变。尽管近几十年来有更多女性投票给民主党，但如果不是因为几十年来针对低收入母亲的亲就业公共政策，投票给民主党的女性会更多。

【**NBER**】: NBER Working Paper No. 34980，https://www.nber.org/papers/w34980

#### 39. Climate Fairness and Growth: Allocating the Remaining Carbon Budget {#34978}

【**Author**】: Galina Hale, Michael Halling, Nora Alice. Paulus, Han H.G. Pham
...
【**摘要**】：将全球变暖限制在1.5度以内，要求累计二氧化碳排放量保持在有限的剩余碳预算之内。如何在不同国家之间分配这一预算引发了关于公平和发展的问题。本文评估了基于公平的碳分配是否与新兴和发展中经济体的持续经济增长兼容。我们根据人均累计平等原则计算了各国在剩余碳预算中的公平份额。利用1950年至2023年间162个国家的数据，我们随后估计了不同收入群体间收入与人均二氧化碳排放量的历史关系，并使用这些弹性来模拟直至2050年的累计排放量。我们的结果表明，人均累计平等原则意味着大多数发达经济体的剩余碳预算为强负值，而低收入国家则保留了正值但受限的分配。在历史上观察到的收入-排放弹性下，许多发展中国家在向发达经济体收入水平趋同的过程中将超过其公平份额。在总体层面，未使用的分配仅抵消了由各国超出其分配和历史责任导致的负公平份额所共同造成的碳预算缺口的17%。在一个我们假设发达经济体的技术被转移到所有国家的情景中，碳预算覆盖率增加到38%。

【**NBER**】: NBER Working Paper No. 34978，https://www.nber.org/papers/w34978

#### 40. From Free Rider to Innovator: The Rise of China's Drug Development {#34977}

【**Author**】: Panle Jia Barwick, Hongyuan Xia, Tianli Xia
...
【**摘要**】：本文考察了过去十年中国从制药“搭便车者”向全球创新者的转型。2010年，中国占全球临床试验的比例不到8%；到2020年，其在年度注册临床试验数量上已超过美国。为了研究这一转变，我们编制了一个全面的、同步的数据库，涵盖药物开发供应链，包括同一时期中国、美国和欧洲的科学出版物、临床试验、药物开发里程碑，以及药品销售和政府政策。我们提供了强有力的证据，表明中国的崛起主要由国家医保目录改革驱动，该改革极大地扩大了创新药物的有效市场规模。我们记录了改革后药物试验数量（增长86%）和新颖性的急剧上升，增长集中在受改革影响的疾病类别、首创或同类最佳药物以及国内企业中。一项分解分析显示，国家医保目录改革占肿瘤学试验活动增长的43%，几乎是上游知识积累和人才流动总贡献（24%）的两倍，而其他政府政策的作用较小。最后，诱导创新的动态收益是改革在消费者获得创新药物方面静态收益的三倍，这强调了在考虑改革对药物可负担性的近期改善之外，还需考虑其对创新激励的长期影响。

【**NBER**】: NBER Working Paper No. 34977，https://www.nber.org/papers/w34977

#### 41. The Rise of the Modern Hospital and Early-Life Health: Evidence from the Hill-Burton Act {#34976}

【**Author**】: Owen Thompson, Jason Fletcher, Karin Wu
...
【**摘要**】：美国医院部门在1950年代和1960年代迅速扩张，这主要归功于联邦立法《希尔-伯顿法案》提供的建设补贴。本文研究了希尔-伯顿拨款对产科护理可及性和婴儿健康的影响。我们发现，对公立医院的拨款显著降低了非医院分娩率和婴儿死亡率，尤其是在非白人口群体中。相比之下，对私立非营利医院的拨款对非医院分娩率或婴儿死亡率没有可测量的影响。

【**NBER**】: NBER Working Paper No. 34976，https://www.nber.org/papers/w34976

#### 42. Standardized Test Scores and Academic Performance at a Public University System {#34975}

【**Author**】: Theodore J. Joyce, Mina Afrouzi Khosroshahi, Sarah Truelsch, Kerstin Gentsch, Kyle Du
...
【**摘要**】：近期对常春藤联盟及同类精英院校的研究表明，标准化考试成绩（SAT/ACT）预测大学成功的准确性远高于高中平均绩点（HS-GPA），这促使精英大学重新要求提交考试成绩作为录取条件。我们探究了在一所大型城市公立大学系统中重新设立SAT录取要求是否会提高学业成果的可预测性。利用2010-2019年新生队列的行政数据，我们更新了早期关于公立大学学生HSGPA和SAT分数对第一年学业成果及毕业率相对预测能力的研究。与精英私立院校的发现相反，我们发现HSGPA是该公立系统中学业成功的主要预测指标。HSGPA每增加一个标准差，对六年毕业率的预测能力是SAT分数同等增幅的四到六倍。对后疫情时期（2020-2024年）的样本外预测证实，与包含考试成绩的模型相比，仅依赖HSGPA的考试可选模型在预测准确性上的损失相对较小。我们得出结论，在宽准入的公立大学中，HSGPA仍然是学位完成最可靠的信号。

【**NBER**】: NBER Working Paper No. 34975，https://www.nber.org/papers/w34975
...
【**摘要**】：我们分析了在一个汇率和国内资产价格影响总需求的开放经济中，货币政策对嘈杂金融状况的反应。噪音交易者在两个市场中运作，而专业套利者的风险承担能力有限。货币政策会产生跨市场溢出效应：通过调整利率来稳定一个市场，中央银行会影响另一个市场的波动性。我们表明，以金融状况指数（FCI）——汇率和国内资产价格的加权平均值——为目标能带来显著的宏观经济收益。FCI目标制迫使中央银行对金融状况的意外变动做出超出相机抉择货币政策所隐含的反应。这些更强的反应改善了跨市场的多样化：每个市场对外部冲击变得更加敏感，但对其自身冲击的敏感性降低。这减少了两市场的波动性，并在每个市场中激活了Caballero等人（2025b）的招募效应——较低的方差促使套利者与噪音进行反向交易，从而进一步抑制波动。当汇率是噪音的主要来源时，外汇（FX）目标制也可能有效，其收益随着经济更加开放而增加。在这种情况下，外汇目标制招募套利者来稳定外汇市场，降低波动性并抑制噪音对宏观经济的影响。然而，外汇目标制也通过反招募效应提高了非目标市场的波动性，这限制了其相对于FCI目标制的有效性，尤其是当国内资产市场对金融状况也很重要且噪音水平相当时。

【**NBER**】: NBER Working Paper No. 34974，https://www.nber.org/papers/w34974

#### 44. Identifying Uncertainty, Learning about Productivity, and Human Capital Acquisition: A Reassessment of Labor Market Sorting and Firm Monopsony Power {#34973}

【**Author**】: Cristina Gualdani, Elena Pastorino, Áureo de Paula, Sergio Salgado
...
【**摘要**】：我们考察了一大类动态劳动力市场匹配模型的经验内容，这些模型包含事前异质性的企业和工人、关于工人生产率的对称不确定性和学习，以及企业的买方垄断势力。我们允许工人在进入劳动力市场之前和之后获得的人力资本在不同企业间具有不同程度的通用性。这样的框架嵌套并扩展了已知的关于工人跨企业流动、职业选择、工资增长、跨职业/企业/行业的工资差异以及工人间和生命周期内工资离散度的模型。我们建立了直观的条件，在这些条件下，尽管这些模型的动态性导致了基于工人和企业内生时变可观测与不可观测特征的复杂选择模式，但模型的基本参数仅凭工人工资和工作数据即可进行半参数识别。基于这一识别论证，我们开发了一个模型基本参数的构造性估计量，该估计量建立在混合模型和极值分位数回归模型的常用方法之上，并展现出标准性质。通过这个框架的视角，我们研究了典型的匹配分类度和企业工资设定权的经验工资度量分别能在多大程度上检测劳动力市场中的分类程度和买方垄断势力。我们表明，通常的分类度量严重低估了其重要性，因为它们忽略了工人人力资本的选择价值以及通过就业获得的关于工人生产率的信息——这些信息体现在更高的未来工资和改善的未来分类上，并被定价到当前工资中，从而压低了当前工资。我们还证明了，工资相对于产出的折扣在很大程度上夸大了企业的劳动力市场势力，因为它忽略了这种选择价值（它捕捉了从已获得的人力资本和信息中获得的未来回报）通常会降低工资。我们在美国数据中发现了这两个特征的证据，记录了在适当衡量后存在强烈的劳动力市场分类程度，以及相应地，企业买方垄断势力程度低于通常记录的水平。

【**NBER**】: NBER Working Paper No. 34973，https://www.nber.org/papers/w34973
...
【**摘要**】：我们提出了一种新的准备金需求估计策略——介于非理论的简化形式计量经济学方法与完全结构化的定量理论方法之间的中间地带。该策略由一个计量经济学规范组成，该规范满足理论所隐含的核心约束，并控制管理利率利差的变化，这些变化会引起准备金需求的旋转和移动。由此产生的方法与现有的简化形式计量经济学方法一样易于使用，但通过纳入任何准备金需求都必须满足的最小理论约束集而对其进行了改进。我们将此方法应用于美国数据，获得了与Lagos和Navarro（2023）的结构性估计大致一致的回准备金需求估计值。

【**NBER**】: NBER Working Paper No. 34972，https://www.nber.org/papers/w34972
...
【**摘要**】：公司金融中有三个经典问题：资本结构、实际投资和股利政策。在三篇配套论文中，我们分别描述了每个问题的最大EPS解决方案。最大EPS方法即使在无摩擦的情况下也能提供最优杠杆率，一个基于比较收益率而非使用风险调整贴现率的投资规则，以及一个偏好增值性股票回购而非中性股息的股利政策。我们的最大EPS模型在成长股和价值股之间划出了一条清晰的界限。成长股的盈利收益率低于无风险利率；价值股的盈利收益率高于无风险利率。这一单一比较导致这两类公司追求不同的EPS最大化政策组合。该模型还产生了易于遵循的计算方法，与从业者的实际做法非常接近。这篇综述文章将这些结果联系起来，为公司金融研究形成了一个新的最大EPS范式。

【**NBER**】: NBER Working Paper No. 34971，https://www.nber.org/papers/w34971

#### 47. Loaded Chambers: Organized Interests, Public Opinion, and Policy Responsiveness in the American States {#34970}

【**Author**】: Takuma Iwasaki, Eric A. Baldwin, John J. Donohue, Tai Markman
...
【**摘要**】：人们认为组织利益会影响政策，但利益集团资金何时以及是否会凌驾于公众意见之上，这一点仍知之甚少。我们研究了枪支利益集团资金和公众意见如何塑造各州的枪支法律。为了检验哪种力量驱动政策，我们将25年的竞选财务记录与一个新的枪支法律指数以及2000-2024年选民情绪的原始估计值联系起来。我们表明，在共和党一党控制州政府的情况下，支持枪支的捐款会产生放松管制的变革，而枪支安全捐款在民主党一党控制州政府的情况下会产生加强管制的变革。使用工具变量设计，我们发现，在共和党或民主党一党控制州政府的情况下，选民情绪并不能因果性地预测政策变化。我们记录了美利坚共和国历史上民主回应性最显著的失败之一：虽然普遍背景调查获得至少90%支持的12个州已经采纳了该政策，但在支持率在80-90%之间的36个州中，只有8个其他州也这样做了，同时，攻击性武器禁令和隐蔽携带限制在36个州也享有持久的多数支持，然而这两项措施出现的放松管制远远多于加强管制。这些模式提供了明确的证据，表明在美国，是组织利益而非选民偏好驱动了枪支政策。

【**NBER**】: NBER Working Paper No. 34970，https://www.nber.org/papers/w34970

#### 48. Household Preferences for Women’s Employment: A Field Experiment in Bangladesh {#34969}

【**Author**】: Yueh-ya Hsu, Reshmaan N. Hussam, Erin M. Kelley, Gregory Lane
...
【**摘要**】：本文研究了家庭对谁应该工作的偏好，以及这些偏好是否具有可塑性。我们记录了男性和女性都更偏好丈夫工作而非妻子工作。为了理解原因，我们随机将一份为期六周的工作分配给丈夫或妻子，并记录了不对称性：女性的工作改善了她们自身的福祉，但没有改善其丈夫的福祉；而男性的工作则改善了伴侣双方的福祉。一年后，我们给这些家庭一个意外的工作机会。在女性之前有工作的家庭中，女性和男性都更倾向于让女性接受这份工作，并且对女性就业总体上表达了更少的担忧。

【**NBER**】: NBER Working Paper No. 34969，https://www.nber.org/papers/w34969

#### 49. The Global Incumbency Advantage {#34968}

【**Author**】: Raphaël Descamps, Benjamin Marx, Vincent Pons, Vincent Rollet
...
【**摘要**】：本文探讨了全球范围内的在位者优势。我们首先表明，现有的次国家级在位者优势估计值与各国的人均GDP和民主质量呈正相关，与腐败呈负相关。基于这项元分析，我们随后考察了自1945年以来举行的所有总统和议会选举，以估计全国性选举胜利如何影响获胜政党和候选人在其当选任期之后继续掌权的概率。平均而言，全国选举的获胜者受益于在位者优势，但这种效应是短暂的，并且在不同情境下存在显著差异：在非洲、北美和西欧，这种效应很大，但在其他地区则较弱甚至逆转。我们探讨了标准的在位者效应和选举操纵如何促成这些结果。在成熟的民主国家，全国性的在位者优势反映了选举获胜者在后续选举表现中的收益。在民主程度较低的政体中，这种优势主要源于对选举公平性和选举时机的操纵。总体而言，由于截然不同的均衡类型，这种优势在民主程度最高和最低的国家中都是最大的。

【**NBER**】: NBER Working Paper No. 34968，https://www.nber.org/papers/w34968
...
【**摘要**】：当四位政治候选人首先在两场初选、随后在大选中竞争时，即使是适度两极分化的选民群体也能（在均衡中）维持更为极端的候选人。然而，一个政党只有在另一方也极端的情况下才能维持极端主义。一方选民群体的轻微温和化，可能引发双方候选人极端主义的非连续性崩溃——即一种“温和输出”效应。反之亦然：较温和一方选民两极分化的微小增加，可能引发双方候选人激进的极端主义。有原则的候选人可能摧毁政党的可选性。与距离相关的选民弃权有利于极端主义。

【**NBER**】: NBER Working Paper No. 34967，https://www.nber.org/papers/w34967

#### 51. Life Cycle Portfolio Choice with Human Capital and Social Security {#34966}

【**Author**】: Jason Scott, John B. Shoven, Sita Slavov, John G. Watson
...
【**摘要**】：目标日期基金——最初将退休储蓄的很大一部分投资于股票，并在生命周期中逐渐转向债券——旨在为退休投资提供“一站式服务”。这种模式的原理在于，在工作者职业生涯初期最高的人力资本是“类债券”的。因此，当金融财富最初主要投资于股票，并且随着未来劳动收入现值的下降而转向债券时，效用达到最大化。我们在一个动态模型中重新审视这一逻辑，在该模型中，劳动收入的冲击与股票市场相关，并且社会保障为低收入个体替代了更高比例的收入。与经验证据一致，模型中的低收入个体经历了劳动收入增长与股票回报之间更高程度的相关性。我们发现，效用最大化的退休投资组合在不同个体之间可能存在巨大差异，对于低收入个体而言，会大幅偏离目标日期基金的模式。

【**NBER**】: NBER Working Paper No. 34966，https://www.nber.org/papers/w34966

#### 52. Out of the Black Box: Uncertainty Quantification for LLMs via Conditional Probabilities {#34965}

【**Author**】: Hui Chen, Antoine Didisheim, Luciano A. Somoza
...
【**摘要**】：自回归大语言模型通过从基于先前上下文条件估计的下一个词元概率分布中进行采样来生成文本。我们利用这些概率构建了一个基于熵的预测不确定性度量，称为内部置信度。在新闻分类中，具有更高内部置信度的大语言模型预测在系统上更为准确。为了评估该度量的经济相关性，我们基于大语言模型预测构建了多空投资组合。基于高置信度预测的投资组合实现了比无条件基准高出约20%的夏普比率，而基于低置信度预测的投资组合则未产生超额收益。相比之下，自我声明的置信度表现出显著的解码偏差，并且没有提供可比的绩效提升。

【**NBER**】: NBER Working Paper No. 34965，https://www.nber.org/papers/w34965

#### 53. Attention (And Money) Is All You Need: Why Universities Are Struggling to Keep AI Talent {#34964}

【**Author**】: Ufuk Akcigit, Craig A. Chikis, Emin Dinlersoz, Nathan Goldschlag
...
【**摘要**】：我们构建了一个新颖的数据集，将学术发表记录与美国人口普查局的雇主-雇员数据相链接，以追踪42,000名人工智能研究人员长达二十年的动态。我们记录了人工智能人才配置的系统性变化。产业界日益吸引更年轻和外国出生的研究人员，而学术界在性别代表性方面改善更多。顶尖1%的产业界发表科学家的年收入现在比同类学术人员高出150万美元，自2001年以来增长了五倍。不断上升的工资溢价与向大型在位企业更大程度的分类效应同时发生。转向产业界的研究人员发表论文减少但专利增加，这与从开放科学向专有创新的转变相一致。

【**NBER**】: NBER Working Paper No. 34964，https://www.nber.org/papers/w34964

#### 54. Work from Home and Fertility {#34963}

【**Author**】: Steven J. Davis, Cevat Giray Aksoy, Jose Maria Barrero, Nicholas Bloom, Katelyn Cranney, Mathias Dolls, Pablo Zarate
...
【**摘要**】：我们利用来自我们的全球工作安排调查和美国工作安排与态度调查的原始数据，研究了在后疫情时代生育率与居家办公之间的关系。在每周至少居家办公一天的成年人中，以及对于伴侣双方都如此做的夫妇而言，2023年至2025年的已实现生育率和未来的计划生育率都更高。与双方都不居家办公的情况相比，当伴侣双方每周居家办公一天或以上时，估计的终身生育率每名女性高出0.32个孩子。对各国国家生育率的影响有所不同，这主要是由于居家办公率的巨大差异。在一项使用疫情前后其他美国数据的补充分析中，一年的生育率随着个人自身职业中的居家办公机会以及（对于夫妇而言）伴侣职业中的居家办公机会而上升。

【**NBER**】: NBER Working Paper No. 34963，https://www.nber.org/papers/w34963

#### 55. The Universal Pursuit of Safety and the Demand for (Lethal, Non-Lethal or No) Guns {#34962}

【**Author**】: Marcella Alsan, Joshua Schwartzstein, Stefanie Stantcheva
...
【**摘要**】：致命枪支拥有权在美国是深度两极分化的。我们表明，在这种两极分化之下，拥有者和非拥有者共享一个共同目标——安全——但在致命枪支能否实现这一目标上存在严重分歧。利用一项包含5,400多名受访者的原始调查并结合随机实验，我们记录了拥有者使用枪支感到安全自信，而非拥有者总体上感觉不太安全，并感知到巨大的私人成本和社会危害。然而，对致命枪支的需求可能很大且在增长：三分之一的非拥有者表示有兴趣获得一支——这些人报告了最低的日常安全感——而很少有拥有者会考虑减少其持有量。说服拥有者放弃枪支而不提供任何替代品似乎不现实；更易处理的边际可能是安全储存和为额外购买提供非致命替代品。我们通过一个以感知安全可能性边界（SPF）为中心的框架来组织这些模式——该边界描述了一个家庭认为通过不同致命和非致命工具组合可以实现的安全结果。家庭可能因面临不同的风险环境、对保护性收益与危害的权衡不同，或对该边界持有不同信念，而在枪支需求上存在差异。我们的描述性证据指出，异质性信念是重要的驱动因素，表明信息等杠杆可能改变感知的边界。这些模式激发了三个实验处理：一个关于致命枪支拥有的私人法律/医疗成本，两个关于非致命枪支（NLFA），分别有和没有一位保守派权威人士的背书。私人成本处理增加了所有受访者对危害的担忧和对安全储存政策的支持，并适度提高了将致命枪支锁起来的陈述意愿。非致命枪支处理提高了对非致命枪支的支付意愿、将致命枪支锁起来的意愿、对非致命性而非致命性枪支的支持，以及对鼓励非致命枪支政策的支持。这些效应在很大程度上是持久的。重要的是，非致命枪支信息并未增加减少致命枪支拥有的意愿，但确实增加了安全储存致命枪支的意愿。我们的结果表明，许多拥有者与非拥有者对安全可能性边界的感知不同，忽视了危害或非致命替代方案，但仍然对这些工具持开放态度。总体而言，个体共享一个共同目标——安全——但对实现手段存在分歧。尽管这些分歧看似根深蒂固，但人们仍然愿意接受可能获得更广泛共识的替代方案。

【**NBER**】: NBER Working Paper No. 34962，https://www.nber.org/papers/w34962

#### 56. Cutting Costs or Cutting Corners: Asset Reallocation in Oil and Gas Production {#34961}

【**Author**】: Sarah C. Armitage, Judson Boomhower, Catherine Hausman
...
【**摘要**】：资产在企业间的重新配置可以带来效率提升，但也可能通过寻租导致扭曲。我们研究了资产重新配置与由环境负债预期成本差异所促成的寻租之间的联系。聚焦于美国石油和天然气行业，我们构建了一个概念框架，该框架同时包含了企业在油井类型上的专业化以及“判决难题”——即资本不足的企业可以逃避环境责任。随后，我们构建了一个包含1992年至2023年间数十万次油井转让的新颖数据集，表明油气井被频繁转让，尤其是在它们老化且收入下降时。此外，低价值油井尤其可能被转让给低价值企业。被转让的油井在后续年份产量相似，但被堵塞的可能性更低——因此构成了更大的环境风险。最后，我们得出了与油井堵塞、保证金要求和脱碳相关的政策启示。

【**NBER**】: NBER Working Paper No. 34961，https://www.nber.org/papers/w34961
...
【**摘要**】：持有现金是有成本的。对于一个追求每股收益最大化的CEO而言，该成本等于其公司的盈利收益率。追求每股收益最大化的CEO会在通过投资能获得更高收益率时保留现金。否则，他们会将现金返还给股东。这就是最大化每股收益的股利政策。成长型股票（盈利收益率 < 无风险利率）从不返还现金，因为它们可以通过投资于无风险债券来跨越其较低的盈利收益率门槛。价值型股票（盈利收益率 > 无风险利率）面临更高的门槛，这使得现金成为其最廉价的资本来源，但也提高了留存现金的机会成本。当价值型股票无法投资于足够多的高收益项目以弥补更高成本时，它们会返还现金。矛盾的是，最有可能分配现金的公司——深度价值型股票（盈利收益率 >> 无风险利率）——恰恰也是那些内部现金相对于外部融资最便宜的公司。股息和股票回购都为股东带来相同的价值，但只有股票回购能提升每股收益。因此，追求每股收益最大化的CEO更倾向于通过回购进行分配。一些公司出于我们模型之外的原因支付股息。这种偏离应集中在边际价值型股票（盈利收益率 ≈ 无风险利率 + ε）中，因为在这些股票中，回购对每股收益的提升作用最弱。从实证角度看，这一逻辑解释了哪些公司返还现金、它们如何分配资金以及时间序列趋势。

【**NBER**】: NBER Working Paper No. 34960，https://www.nber.org/papers/w34960

#### 58. Blockchain Technology for Traditional Finance {#34959}

【**Author**】: Eric Budish, Adi Sunderam
...
【**摘要**】：以比特币和以太坊等加密货币为代表的区块链技术，同时包含（a）一种新颖的数据结构和（b）一种新颖的信任模型。本文分析了在信任仍锚定于法治、声誉、关系和抵押品等传统来源的情况下，仅采用理想化的新颖数据结构本身能为传统金融带来的潜在收益。我们的框架包含两个部分。首先，我们分析了对于已经发生的金融交易可能带来的改进。我们识别出三类改进：（i）降低实际资源成本，（ii）改善资产负债表效率，以及（iii）减少中介租金。虽然这些改进的价值难以精确量化，但我们估计潜在收益可能相当可观，尤其是租金的减少。其次，我们分析了该技术促进新交易的潜力。我们识别出三个渠道：（i）在技术上使欺诈更加困难，（ii）在静态意义上更容易惩罚欺诈的交易对手方，以及（iii）在动态意义上更容易惩罚欺诈的交易对手方。我们的关键见解是，当且仅当存在一个长尾的、相对低盈余、相对不频繁的、传统信任形式不足以支撑的交易时，潜在收益才是巨大的。最后，我们将我们的框架应用于稳定币。我们得出结论，如果稳定币能为合法参与者带来巨大收益，那么这些收益最有可能来自稳定币对中介租金或低效监管施加的压力，或者来自稳定币的可编程性促进了大量原本因缺乏信任而无法进行的小额交易。

【**NBER**】: NBER Working Paper No. 34959，https://www.nber.org/papers/w34959

#### 59. The Emergence of Regional Cultures in the United States {#34958}

【**Author**】: Taylor Jaworski, Erik O. Kimbrough
...
【**摘要**】：本文利用1850年至1930年人口普查数据中的名字模式，复原了美国的文化地理。通过对县级名字分布进行无监督聚类，我们识别出空间上连贯的文化区域，这些区域与历史上公认的定居模式相符，并且在跨越八十年经济与制度变迁的时期内保持稳定。最深的划分将北方与南方分开，但更精细的分组（新英格兰、中大西洋地区、阿巴拉契亚地区、深南部）作为嵌套的子区域出现。正式检验证实，所恢复的聚类在空间上是连续的，在时间上是持久的，并且对重抽样具有稳健性。这些发现关系到：自由制度是否需要文化同质性；文化多元主义是韧性的来源还是脆弱的根源；以及早期定居的印记如何塑造自治实践。

【**NBER**】: NBER Working Paper No. 34958，https://www.nber.org/papers/w34958

#### 60. School Choice and Segregation: Evidence from the Oakland Unified School District {#34957}

【**Author**】: Jesse Rothstein, Ini Umosen, Christopher R. Walters
...
【**摘要**】：我们研究了在集中式学校分配的背景下，改变学校优先权以减少收入隔离的前景，并考虑了学生对学校录取通知的行为反应。促进融合是美国大型城市学区的一个核心目标，而改革学校分配优先权是实现这一目标的重要手段。然而，此类努力可能会受到学生因收到不太喜欢的学校录取通知而选择退出公立学校系统的限制。利用奥克兰联合学区（OUSD）幼儿园申请者的数据，我们表明，获得第一志愿学校的录取通知会增加申请者留在OUSD的可能性。尽管如此，模拟显示，给予低收入学生在高收入学校优先权的政策改革，可以在对学区保留率影响最小的情况下，大幅减少隔离。

【**NBER**】: NBER Working Paper No. 34957，https://www.nber.org/papers/w34957

#### 61. International Comparison of Physician Incomes {#34956}

【**Author**】: Aidan Buehler, Joshua D. Gottlieb, Jeffrey Hicks, Lisa Laun, Mårten Palme, Maria Polyakova, Victoria Udalova, Maria Ventura
...
【**摘要**】：我们使用来自美国、加拿大、瑞典和荷兰的税收数据比较医生收入。在所有四个国家，医生都集中在收入分布的顶端百分位数，尤其是在美国和某些专业领域。美国的医生收入最高，一项分解表明，这主要反映了整体收入分布的差异，而非医生在这些分布中所处位置的差异。这表明，更广泛的劳动力市场差异，以及由此产生的医生的外部选择，决定了绝对收入水平。将美国医生的收入调整为与其他国家分布中相对位置相匹配的水平，只会略微减少医疗支出。

【**NBER**】: NBER Working Paper No. 34956，https://www.nber.org/papers/w34956

#### 62. Physician Competition: Entry and Substitution {#34955}

【**Author**】: Joshua D. Gottlieb, Sean Nicholson
...
【**摘要**】：我们描述了医生市场的竞争，重点关注近几十年来进入壁垒和替代可能性的变化。对医学院名额和住院医师职位（尤其是高薪专业）的监管上限，持续限制着进入，为获得这些职位的人带来高回报，并将学业成就最高的受训者引向利润丰厚的领域。但是，受过培训的医生在患者市场上越来越多地与执业护士、医师助理和其他中级从业人员竞争。这些替代者的培训增长速度远快于医生的供给。我们介绍了关于医生培养管道的关键事实，一个将专业收入与进入壁垒联系起来的框架，并描述了中级医疗服务提供者的崛起。这些事实意味着，有效的医生市场竞争政策必须超越传统的集中度衡量指标，并聚焦于决定谁可以提供医疗服务的机构和法律。

【**NBER**】: NBER Working Paper No. 34955，https://www.nber.org/papers/w34955

#### 63. Stimulating Auto Markets {#34954}

【**Author**】: David W. Berger, Geoffrey Gee, Nick Turner, Eric Zwick
...
【**摘要**】：财政刺激如何影响耐用品销售？刺激在多大程度上推动通胀？我们在大流行期间前所未有的财政刺激如何影响家庭购车和汽车价格的背景下研究这一问题。利用车辆登记的行政数据，我们利用近9000亿美元刺激款项的发放时机以及项目暴露程度的地理差异来识别对销售的因果效应。我们发现，刺激措施在2020-2022年间增加了550万辆（3.2%）的购买量，这意味着汽车的中期（3年）边际支出倾向（MPX）为0.19，总边际消费倾向（MPC）为0.47。尽管需求反应如此显著，但财政转移支付仅占汽车价格飙升的不到20%。在一个包含新车和二手车市场的一般均衡模型中，我们展示了二手车市场的互动如何抑制通胀。当转移支付将家庭推向新车购买决策时，以旧换新增加了二手车的供给，从而限制了价格上涨。当供应紧张或政策针对借贷约束时，这一渠道会减弱，此时刺激措施更多地表现为通胀而非产出增长。非财政因素，包括供应限制、信贷条件放宽和偏好转变，解释了所观察到的大部分通胀。

【**NBER**】: NBER Working Paper No. 34954，https://www.nber.org/papers/w34954
...
【**摘要**】：我们探讨了人工智能（AI）对知识生产函数的影响。我们将AI描述为一种工具，不是用于完全自动化，而是通过增强对组合空间的搜索来进行增强。这导致了科学生产力的提高。我们将知识生产分解为一个多阶段过程，以揭示AI在科学中的“锯齿状前沿”，揭示了不同工具在不同领域（例如，数据丰富的生物学与异常稀疏的物理学）和工作流程阶段（例如，像AlphaFold这样的强大设计辅助工具与更微妙的提问生成工具）的差异化回报。我们认为，在涉及溯因推理、情境细微差别和权衡取舍的任务中，尤其是在数据稀疏的环境中，人类判断是不可或缺的。基于一个区分“普通”科学家和AI专家科学家的任务模型，我们描述了外生的AI改进如何产生非线性的生产力增长，这种增长被AI专家科学家所占的比例放大，从而强调了AI互补品（如技能培训和组织设计）的作用。

【**NBER**】: NBER Working Paper No. 34953，https://www.nber.org/papers/w34953

#### 65. Easy A’s, Less Pay: The Long-Term Effects of Grade Inflation {#34952}

【**Author**】: Jeffrey T. Denning, Rachel L. Nesbit, Nolan G. Pope, Merrill Warnick
...
【**摘要**】：美国的平均成绩持续上升，这引发了成绩膨胀如何影响学生的问题。我们提供了关于教师评分实践如何影响学生长期成功的全面证据。利用来自洛杉矶和马里兰州的高中行政数据，这些数据与高等教育和收入记录相关联，我们开发并验证了两个教师层面的成绩膨胀衡量指标：一个衡量平均成绩膨胀，另一个衡量教师给予及格成绩的倾向。这些成绩膨胀指标与教师增值效应不同，成绩膨胀型教师的认知增值效应中等偏低，而非认知增值效应略高。这两个指标对学生长期结果的影响也不同。被分配给平均成绩膨胀程度更高的教师，会降低学生未来的考试成绩、高中毕业的可能性、大学入学率以及最终的收入。相比之下，及格成绩膨胀降低了留级的可能性，提高了高中毕业率，但长期影响有限。累积影响在经济上意义重大：平均成绩膨胀程度高出一个标准差的教师，会使其学生终身收入的现值每年减少213,872美元。

【**NBER**】: NBER Working Paper No. 34952，https://www.nber.org/papers/w34952

#### 66. Targeting, Personalization, and Engagement in an Agricultural Advisory Service {#34951}

【**Author**】: Susan Athey, Shawn Cole, Shanjukta Nath, Jessica Zhu
...
【**摘要**】：我们进行了一系列迭代实验，以评估为一项服务于印度农村超过一百万农民的农业咨询服务优化电话呼叫目标定位的方法。我们利用随机呼叫分配的数据，通过“离策略”评估来估计替代性目标定位策略的价值。当我们使用与设计目标定位策略相同时间段内的保留数据进行离策略评估时，我们发现目标定位策略最多可将参与度提高8%。然而，当我们使用当前数据设计一项策略，然后在随后几周内对随机选择的用户实施该策略时，我们的“在策略”评估估计显示，实际收益要小得多。我们开发了诊断这种表现不佳原因的工具，并采用了一种迁移学习方法进行策略学习和离策略评估，该方法考虑了农民行为的时序变化，从而显著改进了对后续几周表现的离策略估计。我们进一步开发了新颖的目标定位策略设计方法，以响应组织目标和资源约束，包括分配目标（例如，覆盖女性农民）以及优先考虑那些最有可能从下游结果（例如，产量）信息中受益的农民。我们提出了一种方法，供组织量化不同目标之间的权衡，并展示了目标定位在缓解这些权衡方面的价值。

【**NBER**】: NBER Working Paper No. 34951，https://www.nber.org/papers/w34951

#### 67. The Economics of Algorithmic Personalization: Evidence from an Educational Technology Platform {#34950}

【**Author**】: Keshav Agrawal, Susan Athey, Ayush Kanodia, Shanjukta Nath, Emil Palikot
...
【**摘要**】：个性化推荐能否提高教育科技的参与度？我们为Freadom（一款面向印度儿童的英语学习应用）设计、测试并扩展了一个协同过滤系统。一项包含7,750名学生的随机对照试验表明，在单个内容板块部署个性化推荐，使该板块的参与度提高了60%，整个应用的参与度提高了14%。然后，我们利用断点回归设计中的一个资格阈值，来追踪部署期间超过五个月的效果。对于在部署期间接受个性化推荐的用户群组，断点回归设计的估计值比随机对照试验基准高出2.5倍，这与政策推广中通常观察到的“电压降”现象相反。这提供了证据表明，对于算法干预而言，随机对照试验的估计值可能是规模化影响的低界而非高界。然而，个性化推荐的好处是前期集中的。收益集中在用户使用的头几周，之后边际收益递减。这种模式，加上随着用户耗尽最佳内容匹配而导致的预测匹配质量急剧下降，表明内容可用性而非算法复杂性成为了约束条件。

【**NBER**】: NBER Working Paper No. 34950，https://www.nber.org/papers/w34950

#### 68. Medicaid Coverage for Obesity Medications: Utilization and Net-of-Rebate Spending {#34949}

【**Author**】: Coady Wing, Wei-Lun Lo, Maddie Potter, Tarik Yuce, Alberto Ortega, John Cawley, Thuy D. Nguyen, Kosali I. Simon
...
【**摘要**】：我们记录了各州医疗补助计划对用于肥胖适应症的GLP-1药物覆盖范围随时间的变化，并使用堆叠双重差分设计来估计覆盖范围对使用量和净回扣支出的影响。九个季度后，覆盖范围使每100个参保人-月中用于肥胖适应症的GLP-1药物处方增加了0.82份（标准误=0.10）。覆盖范围对用于糖尿病或心血管适应症的GLP-1处方没有影响，这表明在医疗补助计划中，将糖尿病制剂超说明书用于肥胖的情况并不常见。这些扩展似乎没有影响主要在线GLP-1复方制药公司的消费者支出，这表明我们主要分析中的使用量反应反映了新的使用量而非挤出效应。我们发现，覆盖范围使每100个参保人-月的净回扣医疗补助支出增加了751.6美元（标准误=92.0美元），而总报销额为986.9美元——制造商回扣使州的净支出减少了约24%。在截至2025年中期曾覆盖用于肥胖适应症的GLP-1药物的17个州中，覆盖范围使医疗补助净支出每年增加约26.8亿美元。在其余州扩大医疗补助覆盖范围将每年再产生36.3亿美元的净支出。

【**NBER**】: NBER Working Paper No. 34949，https://www.nber.org/papers/w34949

#### 69. We've Got You Covered: Firms' Political Stances on Abortion and Labor Market Sorting {#34948}

【**Author**】: Pawel Adrjan, Svenja Gudell, Emily E. Nix, Allison Shrivastava, Jason Sockin, Evan P. Starr
...
【**摘要**】：在政治两极分化日益加剧的背景下，企业通过公开声明和政策更频繁地介入政治议题。本文研究了企业在两极分化问题上的立场如何影响工人分类，利用了数百家雇主在最高法院对多布斯诉杰克逊妇女健康组织案作出裁决（推翻联邦堕胎权）后发布的公告。我们引入了一种方法，基于求职者的显示性偏好来揭示每个公告企业的劳动力市场竞争者。虽然公告企业收到了更多求职者的申请，尤其是在堕胎被定为非法的民主党倾向州和女性主导的工作岗位，但现有员工开始在其他地方寻找工作，因为员工满意度下降，尤其是在男性主导的工作岗位。声誉较不稳固的小公司受到的影响最大。在决定是否采取社会政治立场时，企业面临着一个复杂的权衡：吸引文化上一致的工人，代价是疏远现有员工。

【**NBER**】: NBER Working Paper No. 34948，https://www.nber.org/papers/w34948

#### 70. Deep Learning Projects Jurisdiction of New and Proposed Clean Water Act Regulation {#34947}

【**Author**】: Simon Greenhill, Brant J. Walker, Joseph S. Shapiro
...
【**摘要**】：预测拟议政策改革的效果具有挑战性，因为对于政府尚未实施的法规，不存在结果数据。我们提出了一个事前深度学习框架，该框架可以通过将过去法规下观察到的结果映射到拟议未来政策的法律标准上（即通过“重新标记”），来预测拟议改革的效果。我们将此框架应用于研究美国《清洁水法》管辖范围的变化。我们将我们的事前深度学习预测（针对最高法院Sackett案判决后的管辖范围）与领域专家广泛使用的预测进行了比较。事前机器学习比美国环境保护署目前使用的领先领域专家模型产生了显著的性能提升，对管辖地点的识别准确率提高了65倍。我们还开发了一个事后深度学习模型，该模型使用政策实施后的数据进行训练。事后深度学习表现最佳。Sackett案判决解除了对所有先前受监管的美国水域中三分之一水域的监管，特别是洪泛区和原始鱼类栖息地，总计70,000英里的溪流和1,700万英亩的湿地被解除监管。深度学习可以在影响深远且最不确定但又最有用的监管改革实施之前，有效地预测其后果。

【**NBER**】: NBER Working Paper No. 34947，https://www.nber.org/papers/w34947

#### 71. The Heterogeneous Earnings Impact of Job Loss Across Workers, Establishments, and Markets {#34946}

【**Author**】: Susan Athey, Lisa K. Simon, Oskar Nordström Skans, Johan Vikström, Yaroslav Yakymovych
...
【**摘要**】：利用丰富的瑞典行政数据，我们应用因果机器学习方法研究失业后收入损失如何随可观察特征变化，这些特征可能与针对工人的政策干预目标定位相关。效应的异质性在按年龄和受教育程度划分的工人群体内部与群体之间一样大，在企业内部与企业之间也一样大。跨企业异质性的很大一部分可以由行业和当地劳动力市场特征来解释，这表明基于地点和行业的定位策略可以发挥作用。最大的损失集中在已经脆弱的工人身上，这表明设计良好的定位政策可以提高效率和公平性。

【**NBER**】: NBER Working Paper No. 34946，https://www.nber.org/papers/w34946

#### 72. The Elasticity of Corporate Taxable Income Across Countries {#34945}

【**Author**】: Claudio Agostini, Zareh Asatryan, Laurent Bach, Govindadeva Bernier, Marinho Bertanha, Katarzyna A. Bilicka, Anne Brockmeyer, Jaroslav Bukovina, Guillermo Falcone, Pablo Garriga, Yuxuan He, Petr Janský, Evangelos Koumanakos, Tomáš Lichard, Tomás Martins, Ján Palguta, Elena Patel, João Pereira dos Santos, Louis Perrault, Thomas Schwab, Nathan Seegert, Oliver Škultéty, Kristina Strohmaier, Maximilian Todtenhaupt, Guillermo Vuletin, Branislav Žúdel
...
【**摘要**】：企业是否对不同国家的企业所得税激励措施做出相似的反应？我们利用来自十六个国家的行政纳税申报数据和一个统一的实证框架，提供了具有全球可比性的企业应税收入弹性估计。利用在共同拐点（零应税收入）处的聚集现象，我们估计出的弹性范围从0.08到1.9，平均值为0.79。为了解释这种异质性，我们将弹性与税收政策、企业特征和国家基本面因素联系起来。这些差异意味着，相同的企业所得税改革在不同国家可能产生截然不同的收入效应，从而导致企业所得税效率成本的巨大异质性。

【**NBER**】: NBER Working Paper No. 34945，https://www.nber.org/papers/w34945

#### 73. Feel as a Determinant of College Choice: Evidence from Campus Tour Weather {#34944}

【**Author**】: Olivia Feldman, Joshua M. Hyman, Matthew L. McGann
...
【**摘要**】：学生在就读某所特定大学时获得的感觉或印象，可能是其大学申请决策的重要决定因素。结合过去十年大学校园参观参与者的机构记录与逐时天气信息，我们将参观天气作为对学生就读所参观大学“感觉”的一个外生冲击。我们发现，糟糕的参观天气会降低参与者申请的可能性。例如，当参观天气炎热时，参与者申请的可能性降低10%；当参观期间出现降水时，申请可能性降低8%。利用记录所有参观参与者最终就读大学情况的行政数据，我们发现参观天气对参与者最终就读大学的质量或类型几乎没有影响。尽管如此，我们的结果表明，学生对就读某所大学的“感觉”在大学申请决策中可能扮演重要角色。

【**NBER**】: NBER Working Paper No. 34944，https://www.nber.org/papers/w34944

#### 74. The Changing Landscape of International Development: An Introduction {#34943}

【**Author**】: Pascaline Dupas, Pinelopi Koujianou Goldberg, Rohini Pande
...
【**摘要**】：自20世纪80年代末以来，极端贫困大幅下降，预期寿命和受教育年限有所增加，选举民主得以扩展。然而，近年来减贫速度放缓，尤其是在新冠疫情之后，同时伴随着冲突加剧、脆弱性、气候风险、民主倒退以及曾支撑增长的全球趋势（包括贸易一体化和地缘政治稳定）的侵蚀。这些动态引发了三个相互关联的问题：哪些障碍阻碍了进一步进展；低收入国家未来的增长将从何而来；以及增长如何能被广泛共享。基于对即将出版的《发展经济学手册》第6卷中15个章节的总结，我们讨论了外部条件、国家能力和政策选择如何塑造发展；分析了包括贸易、技术和服务业崛起在内的增长驱动因素的转变；讨论了持续存在的不平等和分配紧张局势；并推测投资于制度和人力资本会带来回报。

【**NBER**】: NBER Working Paper No. 34943，https://www.nber.org/papers/w34943

#### 75. Dollarization Waves: New Evidence From a Comprehensive International Bond Database {#34942}

【**Author**】: Swapan-Kumar Pradhan, Eswar S. Prasad, Előd Takáts, Judit Temesvary
...
【**摘要**】：我们利用一个覆盖范围远超以往文献所用数据集的全面全球数据集，研究了美元在国际债务证券计价中的主导地位近几十年来如何演变。我们没有发现单调的美元化或去美元化趋势；相反，美元的份额呈现出波浪状模式。我们记录了自20世纪60年代以来的三次美元化浪潮。最近一次浪潮，即全球金融危机之后，将美元的份额几乎推回到了2000年欧元启动时的水平。我们表明，一国本币与储备货币（例如美元）的挂钩程度越紧密，与该国以该货币发行的债券份额越高相关。我们的发现对于构成效应、货币估值效应以及替代性数据定义都是稳健的。

【**NBER**】: NBER Working Paper No. 34942，https://www.nber.org/papers/w34942

#### 76. Institutional Shocks and Migration Adjustment: Evidence from the Syrian Crisis and Brexit’s Referendum and Implementation {#34941}

【**Author**】: Assaf Razin

【**Abstract**】: This paper interprets Brexit as a two-stage institutional rupture that reshaped migration through expectations, exposure, and stress channels. Using a UK–Germany Difference-in-Differences framework, I show that the 2016 referendum generated a sharp decline in UK net migration relative to Germany, driven primarily by a contraction in immigration rather than simple outward flight. The 2021 termination of EU free movement reinforced this adjustment on the gross inflow margin, completing the structural reallocation of mobility flows. Migration responses were not uniform: countries more deeply integrated into EU mobility networks prior to 2016 experienced significantly stronger contractions, confirming that Brexit propagated along pre-existing exposure channels.

【**摘要**】：本文将英国脱欧解释为一个两阶段的制度断裂，通过预期、暴露和压力渠道重塑了移民格局。利用英国-德国双重差分框架，我表明，与德国相比，2016年公投导致英国净移民急剧下降，这主要是由移民流入的收缩而非简单的向外逃离所驱动。2021年欧盟自由流动的终止在总流入维度上强化了这一调整，完成了流动性流动的结构性重新配置。移民反应并非一致：在2016年之前更深地融入欧盟流动性网络的国家经历了显著更强的收缩，这证实了英国脱欧是沿着既有的暴露渠道传播的。

【**NBER**】: NBER Working Paper No. 34941，https://www.nber.org/papers/w34941

#### 77. Market Feedback about Emerging Technologies {#34940}

【**Author**】: Sean S. Cao, Itay Goldstein, Jie He, Yabo Zhao
...
【**摘要**】：企业如何做出关于新兴技术投资的决策？我们发现，企业会根据市场对其宣布此类新兴技术投资计划的反应来调整人工智能/绿色投资。通过一系列检验，我们表明，这种模式更可能是由于管理者主动从市场学习，而非其他解释，例如被动反映同时驱动市场反应和企业行为的潜在基本面。与对其他投资相比，企业更有可能根据关于新兴技术的反馈采取行动，尤其是在市场参与者对这些领域拥有更多专业知识以及企业面临更大不确定性的时候。

【**NBER**】: NBER Working Paper No. 34940，https://www.nber.org/papers/w34940

#### 78. The Skill Premium in Times of Rapid Technological Change {#34939}

【**Author**】: Tarek Alexander Hassan, Aakash Kalyani, Pascual Restrepo
...
【**摘要**】：本文表明，技术创造的速度是技能溢价的一个关键驱动因素。它构建了一个模型，其中技能型工人在学习新技术方面具有比较优势。随着技术老化，它们变得标准化，其他工人也能掌握。技能溢价由技术创造和标准化的速度之间的相互作用决定。快速的技术创造速度导致技能溢价的持续上升。我们利用基于文本的新技术数据以及这些技术随年龄增长对技能需求的变化来校准模型。这些数据表明，新技术最初是技能密集型的，但随着时间推移会变得不那么技能密集。数据还指出，新技术创造的速度从20世纪70年代开始加快，在21世纪初逐渐放缓。作为对这种快速技术创造速度的回应，该模型产生了32%的大学溢价的增长，这一增长在2010年代开始逆转。我们的框架还解释了为什么大学溢价在人口密集的城市更高，为什么其增长主要发生在城市，以及为什么它首先在年轻工人中上升，后来才在年长工人中上升。

【**NBER**】: NBER Working Paper No. 34939，https://www.nber.org/papers/w34939

#### 79. Reducing Waste through Anti-Fraud Enforcement: Evidence from Hospital Admission Cases {#34938}

【**Author**】: David H. Howard, Jetson Leder-Luis
...
【**摘要**】：利用联邦反欺诈法律来解决不必要的医疗护理问题是有争议的。被针对的医疗服务提供者经常辩称，根据他们的判断，所涉治疗是适当的。我们利用2005-2019年100%的医疗保险索赔数据，并基于这些诉讼交错推出的设计，研究了针对医院从急诊科过度收治患者的反欺诈诉讼的影响。我们发现，反欺诈诉讼使入院率降低了3.6个百分点，同时并未增加死亡率。我们估计，这为医疗保险在五年内节省了13亿美元。我们的结果表明，反欺诈执法可以成功地减少昂贵且不必要的护理。

【**NBER**】: NBER Working Paper No. 34938，https://www.nber.org/papers/w34938

#### 80. General Social Agents {#34937}

【**Author**】: Benjamin S. Manning, John J. Horton
...
【**摘要**】：有用的社会科学理论能够跨情境预测行为。然而，应用一个理论在新情境中进行预测是具有挑战性的：几乎总是需要针对情境特定因素进行临时修改才能做到。我们认为，置于这些新情境模拟中的人工智能智能体提供了一种应用理论的替代方案，只需最少或无需修改。我们提出了一种构建此类“通用”智能体的方法，该方法使用基于理论的自然语言指令、现有的经验数据以及底层人工智能在训练期间获取的知识。为了在不存在该数据生成过程数据的情境中（这在应用预测问题中经常出现）演示该方法，我们设计了一个包含883,320个新颖游戏的异质性群体。人工智能智能体是利用来自一小部分概念相关但结构不同的“种子”游戏的人类数据构建的。在预注册的实验中，平均而言，这些智能体对来自该群体中随机抽取的1,500个游戏的初始人类行为的预测，优于（i）认知层级模型、（ii）博弈论均衡以及（iii）开箱即用的智能体。对于一小部分独立的新颖游戏，这些模拟对来自新一批人类受试者的反应的预测，甚至优于最可能相关的已发表人类数据。

【**NBER**】: NBER Working Paper No. 34937，https://www.nber.org/papers/w34937

#### 81. Who Gets What in Education: Can School Matching Improve Student Achievement? {#34936}

【**Author**】: Atila Abdulkadiroglu, Parag A. Pathak, Christopher R. Walters
...
【**摘要**】：我们研究了改善城市学校系统的两种方法：改变谁可以去现有的学校（重新分配），以及通过关闭和重组来调整学校组合（资源扩充）。利用纽约市高中的数据，我们估计了允许存在纵向学校质量差异和横向学生特定匹配效应的学校效应模型。虽然优化学生-学校匹配的复杂重新分配政策可以产生适度的教育收益，但它们受到高效学校名额有限的制约。针对替换表现不佳学校的简单资源扩充政策，在系统性干扰较小的情况下实现了类似的改进。对纽约市学校关闭的分析表明，基本的毕业率指标能有效识别陷入困境的学校，这表明复杂的增值模型可能并非针对关闭决策所必需。我们的研究结果表明，教育不平等的主要驱动因素是容量限制，而非糟糕的学校匹配。

【**NBER**】: NBER Working Paper No. 34936，https://www.nber.org/papers/w34936
...
【**摘要**】：保护主义能否重振国内生产、减缓自动化并帮助从事常规工作的工人？我们在一个包含异质性企业、内生进入和基于任务的生产的动态开放经济模型中探讨这个问题，其中常规任务可以由工人或机器人完成。进口关税将需求重新分配给国内商品，重塑了加成率和进入激励，并产生了返还给家庭部门的财政收入。因此，关税提高了按市场价格衡量的GDP和消费，并暂时减缓了自动化，尽管按要素价格计算的中间产出和贸易量下降了。收益分配不均：常规工人通过转移支付和减少培训而强劲受益，非常规工人面临相反的工资和返还效应，而企业主总体上获益，因为更高的国内需求和进入扩大了总利润，尽管每家企业价值下降。总体福利收益关键取决于关键假设（自动化、培训、内生进入）以及关税收入如何返还。在统一转移支付的基准情况下，福利最大化的关税低于经典的垄断公式，而替代性的返还方案可能使其大幅变动。总体而言，研究结果警示不应将关税视为再工业化的简单工具，并强调了技术采用和财政归宿在评估保护主义政策中的作用。

【**NBER**】: NBER Working Paper No. 34935，https://www.nber.org/papers/w34935

#### 83. From Complaint to Action: Technology-Enabled Quality Improvement from Consumer Reviews {#34934}

【**Author**】: Guangyu Cao, Shenghao He, Ginger Zhe Jin
...
【**摘要**】：本文研究了采用自动化评论监控系统（ARMS）如何使餐厅将消费者反馈转化为运营质量改进。ARMS为负面评论提供自动提醒，并促进后台工作单管理，降低了识别、优先处理和解决客户反馈所揭示问题的成本。利用关于ARMS采用和消费者评论的餐厅层面数据，我们发现采用ARMS提高了平均星级评分，降低了负面评论的比例，并提高了评论文本的积极性。这些改进并非由策略性操纵驱动；对于初始评分较低的餐厅以及消费者先前指出存在问题的维度，改进幅度更大，这与ARMS增强了餐厅对负面评论的回应能力相一致。我们还表明，采用ARMS部分挤出了前端的经理回应，表明运营补救与公开回复之间存在替代关系，当员工对负面评论采取反思性方法时，这种效应最强。最后，采用ARMS与更高的消费者参与度相关，这体现在更长、更详细的评论中。总体而言，我们的结果表明，在线评论系统与运营技术相结合时，可以推动超越单纯声誉管理的实质性质量改进。

【**NBER**】: NBER Working Paper No. 34934，https://www.nber.org/papers/w34934
...
【**摘要**】：美国每年有近2.5亿个电话拨打给911。其中很大一部分涉及社会问题，而非犯罪或紧急情况——然而警察却被派遣响应。这篇综述追溯了911应急系统的制度设计如何塑造了对警察的需求，谁被排除在这个系统之外或服务不足，以及存在哪些替代方案，包括非紧急热线（由警察响应）、政府热线（211、311、988）、民事危机应对团队和社区资源。在2020年至少拥有100名宣誓警官的市政警察部门（覆盖1.07亿美国居民）中，警察已经吸收了广泛的社会服务职能，而正式替代方案的可用性仅限于最大的城市。证据表明，警察的首要地位更多地反映了制度再生产，而非公共需求。我提出了未来研究的优先事项。

【**NBER**】: NBER Working Paper No. 34933，https://www.nber.org/papers/w34933

#### 85. Personnel is Policy: Delegation and Political Misalignment in the Rulemaking Process {#34932}

【**Author**】: Luca Bellodi, Massimo Morelli, Jörg L. Spenkuch, Edoardo Teso, Matia Vannoni, Guo Xu
...
【**摘要**】：我们将美国联邦政府规则制定活动的综合数据与个人层面的人事和选民登记记录相结合，研究新法规制定过程中的授权和委托-代理摩擦。我们提出三个主要结果。首先，即使是重要的新法规，也经常被授权给与总统政治立场不一致的职业官僚。其次，由错位的监管者监督的规则，其完成时间系统性更长，措辞更冗长，产生的公众负面反馈更多，并且更有可能在法庭上受到挑战。第三，在将监管者分配到规则时，机构领导经常面临政治立场与专业知识之间的尖锐权衡。尽管存在机构摩擦，他们倾向于以有利于专业知识的方式解决这一权衡。

【**NBER**】: NBER Working Paper No. 34932，https://www.nber.org/papers/w34932

#### 86. When Teachers Break the Rules: Imitation, Reciprocity, and Community Structure in the Transmission of Ethical Behavior {#34931}

【**Author**】: Victor Lavy, Moses Shayo
...
【**摘要**】：我们研究教师在评分中的违规行为如何影响学生的道德行为。利用高风险考试的管理数据，结合教师评定的内部分数与外部评分的国家考试分数，我们追踪教师的评分违规行为以及随后的学生作弊行为。我们探讨了三种潜在机制：模仿（了解到规则可以被打破）、正向互惠（对有利待遇做出积极回应）和负向互惠（对不利待遇进行报复）。利用学生接触不同教师的内部差异，我们发现当教师以对学生不利的方式违反规则（系统性低分）时，学生作弊的可能性显著增加，这与模仿和负向互惠均一致。然而，当教师系统性给高分时，学生的反应因社区结构而异。在异质性社区中，给高分增加了学生作弊，表明模仿占主导地位。在同质性社区中，学生通过减少作弊来回应，这与正向互惠占主导地位一致。这一模式在多种同质性衡量指标（包括姓氏集中度和居住聚类）中均成立。关于学生与教师之间相互尊重和支持的调查测量证实了这一模式。

【**NBER**】: NBER Working Paper No. 34931，https://www.nber.org/papers/w34931

#### 87. When Do Financial Frictions Matter for Misallocation? {#34930}

【**Author**】: Yan Bai, Dan Lu, Xu Tian, Yajie Wang
...
【**摘要**】：本文通过一个由企业层面借贷成本和资本平均收入产品（ARPK）共同约束的模型，重新评估了金融摩擦在资本错配中的作用。利用中国制造业数据，我们记录了ARPK的巨大离散性，以及ARPK与企业面临的借贷成本之间的强正相关关系——这些模式在美国数据中不存在。我们开发了一个异质性企业模型，其中包含内生的企业特定借贷成本以及建模为外生楔子的额外资本扭曲。在该模型中，消除金融摩擦使全要素生产率（TFP）提高了25个百分点。相比之下，在没有其他资本扭曲的情况下，消除金融摩擦使TFP提高了不到2个百分点。这种显著差异源于金融摩擦与永久性企业层面扭曲之间的相互作用，后者产生了内生的金融异质性和选择效应，使得高生产率企业受到最大的约束。我们的研究结果表明，当存在其他错配来源时，金融摩擦可能具有高度的扭曲性。

【**NBER**】: NBER Working Paper No. 34930，https://www.nber.org/papers/w34930

#### 88. Restoring Nature, Creating Wealth: Evidence from Rural Households in Africa {#34929}

【**Author**】: Geoffrey Heal, Claudio Rizzi, Simon Xu
...
【**摘要**】：人类驱动的生态系统退化威胁着全球生物多样性以及依赖自然系统进行生产和创收的社区生计。然而，关于恢复自然的经济回报的实证证据仍然稀缺。我们研究了增强自然的干预措施是否能在环境效益之外，为家庭财富带来可衡量的改善。我们研究了由“树木未来”（TREES）组织在撒哈拉以南非洲的农场实施的大规模农业生态干预措施，结合了详细的家庭调查和高分辨率卫星图像。我们表明，自然资本的准外生增长导致家庭财富（以牲畜拥有量为代理指标）大幅增加，到干预的第三年增长约75%。在考虑积极的健康影响和碳封存之前，每投入一美元干预措施，参与农户可获得约2.28美元的直接财富收益。我们进一步记录了树木覆盖率和作物多样性的显著增加，粮食安全和膳食多样性的显著改善，以及从太空测量的植被指数的可检测提升。这些结果共同表明，恢复自然资本既能产生生态回报，也能产生经济回报，为生物多样性仍是关键生产性资产的农村经济提供了一条可扩展的自然积极发展路径。

【**NBER**】: NBER Working Paper No. 34929，https://www.nber.org/papers/w34929

#### 89. Competition in Health Insurance Markets {#34928}

【**Author**】: Martin Gaynor, Amanda Starc
...
【**摘要**】：美国主要依赖私人健康保险市场，然而这些市场高度集中，并且随着时间的推移集中度越来越高。我们记录了商业、医疗保险优势计划和医疗补助市场的集中度。然后，我们研究了信息不对称——特别是逆向选择——如何与市场势力相互作用，从而影响保费、计划设计和消费者福利。实证证据证实，保险公司的整合会提高保费。我们讨论了反垄断执法、风险调整、监管和信息干预如何在这些市场中塑造竞争和消费者福利。

【**NBER**】: NBER Working Paper No. 34928，https://www.nber.org/papers/w34928

#### 90. The Effects of a Sudden Stop in Low-Skilled Immigration: Evidence from Korea’s Guest Worker Program {#34927}

【**Author**】: Jongkwan Lee, Giovanni Peri, Hee-Seung Yang
...
【**摘要**】：随着高收入国家的劳动力队伍老龄化和萎缩，移民越来越多地填补入门级、低技能的工作岗位。我们研究了当这种劳动力供给突然减少时会发生什么，利用了韩国在2020年新冠疫情边境关闭后突然暂停其低技能客工计划的情况。利用企业在疫情前对移民劳动力依赖程度的政策驱动差异，我们表明，流入量的骤降导致企业退出显著增加。在幸存企业中，疫情前对移民工人依赖程度更高导致了生产中断和运营延误。企业并未通过扩大国内招聘来填补缺失的客工。相反，它们通过将现有的韩国员工重新分配到技能要求更低的任务来进行调整，这导致了职业降级和显著的工资下降。这些发现表明，低技能移民工人在短期内不易被替代，并且更严格的移民限制可能会给企业和本土工人带来巨大的调整成本。

【**NBER**】: NBER Working Paper No. 34927，https://www.nber.org/papers/w34927

#### 91. Repression {#34926}

【**Author**】: Gerard Padró I Miquel, Nancy Qian

【**Abstract**】: Removed at the request of the authors. An updated version will be posted shortly.

【**摘要**】：应作者要求移除。更新版本将很快发布。

【**NBER**】: NBER Working Paper No. 34926，https://www.nber.org/papers/w34926

#### 92. The Micro-Geography of Persuasion: Randomized Peer Exposure and Legislative Outcomes {#34925}

【**Author**】: Lauren Cohen, Bo Li
...
【**摘要**】：我们发现，随机分配的同伴在塑造政治经济学方面发挥着巨大且独特的作用。座位相邻且外生分配的美国参议院同伴对国会投票产生了显著影响，使投票偏移了11.9个百分点（t=7.34）。在影响投票行为的任何特征中，除了党派或州之外，物理距离是影响最大且最一致的因素。距离效应集中在最近的同伴身上，在参议院会场内最远可达19.6英尺，之后便消散。近距离同伴还增加了跨党派投票（与对立党派一起投票）的可能性，在法案的最终投票中，跨党派投票的影响大约是其八倍。然后，我们利用了一个基于CSPAN视频数据、每10秒间隔捕捉国会成员间实时互动的、最先进的人工智能增强计算机视觉模型。通过这些观察到的互动，我们发现面对面互动对即将表决的投票产生了显著影响。这些互动很大程度上是由距离驱动的，来自两党的靠过道就座的参议员是最有可能进行跨党派面对面互动的群体之一。通过随机安排参议院座次进行反事实模拟，在我们的30年样本期内，有59项重要法案的结果会发生改变。

【**NBER**】: NBER Working Paper No. 34925，https://www.nber.org/papers/w34925

#### 93. Measuring Payroll Employment: A Note on the Current Employment Statistics {#34924}

【**Author**】: Ryan A. Decker
...
【**摘要**】：劳工统计局当前就业统计（CES）是一个高质量、备受关注的劳动力市场健康状况和商业周期指标。近期对CES数据的修订引起了广泛关注。我提供了CES方法的入门介绍，并分析了近期的调查响应和数据修订模式。实际上，CES的修订往往很小，但近年来有所增加。我讨论了改进CES的潜在想法，包括利用内部或外部数据扩大数据样本、更频繁地使用基准数据调整估计值，以及改进对机构成立和倒闭的估算。

【**NBER**】: NBER Working Paper No. 34924，https://www.nber.org/papers/w34924

#### 94. Why People Disagree About What Drives Stock Prices {#34923}

【**Author**】: Andrew Atkeson, Fabrizio Perri, Jonathan Heathcote
...
【**摘要**】：我们表明，在一阶近似下，对席勒基础价格相对于观察价格波动的估计，主要取决于对长期预期收益的预测。使用不同现金流和估值指标的研究人员可能会得出关于价值相对于基本面过度波动程度的不同结论，但这仅仅是因为基于不同现金流-价值比率的收益预测会有所不同。利用美国股票数据，我们证明了预期收益的持续性程度，而非短期收益可预测性的程度，是隐含过度波动性的关键决定因素。因此，关于股票市场估值的分歧归结为对长期预期收益的分歧。

【**NBER**】: NBER Working Paper No. 34923，https://www.nber.org/papers/w34923

#### 95. The Labor Market Consequences of Rapid Sectoral Shifts {#34922}

【**Author**】: John R. Grigsby, Nathan Zorzi
...
【**摘要**】：部门转移要求工人进行代价高昂的劳动力重新配置，这加剧了人们对转移发生速度的担忧。我们研究了这种部门转移的速度如何影响面临失业风险的工人。我们开发了一个具有技能异质性和工作阶梯的生命周期模型，其中劳动力需求在一个部门逐渐上升，在另一个部门逐渐下降。该模型揭示了三个新颖的见解。首先，工人的终生收入在转型展开的时间跨度上呈现出强烈的非线性，甚至是非单调性。其次，随着转型加速，越来越多的工人在广延边际上受益，但在集约边际上损失的尾部变得更厚。第三，劳动力市场摩擦对于量化这些非线性至关重要。我们将模型应用于气候转型，发现到2060年结束的转型会导致可观的收入损失。提前十年完成转型会降低平均损失，但会使尾部损失增加五分之一。

【**NBER**】: NBER Working Paper No. 34922，https://www.nber.org/papers/w34922
...
【**摘要**】：我们估算了生育权资本化到美国住房市场中的市场价值。我们采用合成双重差分设计来评估2022年多布斯案判决后全面堕胎禁令的影响，并利用了Zillow的住房市场指数和美国人口普查局住房空置调查的空置率数据。结果表明，从2022年7月到2025年6月，全面堕胎禁令使租金平均降低了2.2%，在最近一年内影响达到4.0%。在同一时期，禁令使租赁空置率平均增加了1.1个百分点，在最近一年内影响达到1.8个百分点。对房屋价值和业主空置率的估计在幅度上相似，但精确度较低。

【**NBER**】: NBER Working Paper No. 34921，https://www.nber.org/papers/w34921
...
【**摘要**】：不完全契约理论（并有轶事证据支持）表明，当一家公司被收购时，员工在工作体验的非契约性方面可能会受到不利影响。本文通过结合 Refinitiv 数据库中的并购事件和网络爬取的 Glassdoor 评论数据，对这一预测进行了实证研究。我们发现：(a) 在控制事前趋势的情况下，并购导致员工满意度下降，尤其是在员工体验的非契约性维度上（约 0.06 个标准差）；(b) 这种效应在目标公司中比在收购公司中更强；(c) 对员工评论的文本分析表明，满意度的下降主要与感知到的隐性契约被违背有关。我们的研究结果表明，并购可能通过非货币渠道降低员工的工作效用。

【**NBER**】: NBER Working Paper No. 34920，https://www.nber.org/papers/w34920

#### 98. How does AI Distribute the pie? Large Language Models and the Ultimatum Game. {#34919}

【**Author**】: Douglas K.G. Araujo, Harald Uhlig
...
【**摘要**】：随着大语言模型越来越多地承担自主决策任务，理解它们在战略环境中的行为至关重要。我们研究了各种大语言模型在最后通牒博弈中的选择，这是一个人类行为显著偏离理论理性的场景。我们通过实验改变了赌注大小和对手的性质（人类 vs. 人工智能），并涵盖了提议者和回应者两种角色。出现了三个关键结果。首先，大语言模型的行为是异质性的，但在以赌注大小和玩家类型为条件时是可预测的。其次，虽然一些模型接近理性基准，另一些模型模仿人类的社会偏好，但出现了一种独特的“利他”模式，即大语言模型提出超公平分配方案（大于 50%）。第三，作为提议者的大语言模型放弃了总收益的很大一部分，当回应者是人类时，放弃的份额甚至更大。这些发现强调了在将人工智能代理部署到经济环境中之前进行仔细测试的必要性。

【**NBER**】: NBER Working Paper No. 34919，https://www.nber.org/papers/w34919

#### 99. Pay Now, Buy Never: The Economics of Consumer Prepayment Schemes {#34918}

【**Author**】: Yixuan Liu, Hua Zhang, Eric Zou
...
【**摘要**】：预付消费是现代消费市场的一个常见特征，通常被描述为一种互利的安排：消费者获得预付折扣，企业确保未来销售。我们分析了一个大规模的“现在付款，以后消费”计划，在该计划中，消费者预付资金以获取餐厅消费积分和奖励，并在之后使用余额。利用超过 400 万消费者的详细交易数据，我们记录了广泛的余额破损现象：大约 40% 的预付价值从未被使用。由于许多消费者未充分利用其余额，商家收回的资金远超奖励成本。中位数企业每发放 1 美元的奖励积分，就能获得大约 5.5 美元的破损利润。虽然参与“现在付款，以后消费”计划确实会导致消费者支出随时间适度增加，但企业从破损中获得的收益远大于任何由忠诚度驱动的收入。这些发现挑战了普遍的双赢叙事：“现在付款，以后消费”计划通常导致从消费者到企业的显著财富转移。我们开发了一个简约的契约模型来说明企业面临的激励错位，并通过反事实分析表明，一项简单的、包含适当存款要求的托管政策可以重新调整企业激励，并产生更有利于消费者的结果。

【**NBER**】: NBER Working Paper No. 34918，https://www.nber.org/papers/w34918

#### 100. When Incentives Aren't Enough: Evidence on Inattention and Imperfect Memory from HIV Medication Adherence {#34917}

【**Author**】: Hang Yu, Jared Stolove, Dean Yang, James Riddell IV, Arlete Mahumane
...
【**摘要**】：经济激励被广泛用于鼓励有益行为，但其有效性可能受到注意力不集中和记忆不完美的限制。我们在莫桑比克进行的一项关于HIV药物依从性的随机试验中研究了这一点。仅提供经济激励使依从性提高了 10.6 个百分点，而将激励与提醒相结合则使依从性提高了 24.3 个百分点。我们开发了一个模型，其中对每日服药依从性的注意力不集中和对付款资格的记忆不完美降低了激励的有效性，并表明提醒可以缓解这两种摩擦。详细的药物补充数据支持了该模型的预测。结果表明，将激励与提醒相结合可以显著提高项目的有效性。

【**NBER**】: NBER Working Paper No. 34917，https://www.nber.org/papers/w34917
