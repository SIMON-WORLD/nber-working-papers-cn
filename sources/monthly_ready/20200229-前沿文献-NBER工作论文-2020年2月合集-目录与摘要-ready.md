# 【前沿文献】NBER工作论文 2020年2月合集 目录与摘要

> 2020 年 2 月 NBER 更新 87 篇工作论文，其中与中国研究相关的有 3 篇（22、54、83）。
> 其中，中国相关研究包括：#26792（第 22 篇，货币政策的抵押品渠道：来自中国的证据）；#26760（第 54 篇，为什么欧元的表现低于其应有水平？）；#26731（第 83 篇，全球机器人与发展：当制造业无就业且服务业可贸易时）。

## 一、目录速览

1. **Early Childhood Care and Cognitive Development {#26813}**  
   早期儿童照护与认知发展  
   <font color=grey>Juan Chaparro, Aaron Sojourner, Matthew J. Wiswall</font>

2. **Prices and Federal Policies in Opioid Markets {#26812}**  
   阿片类药物市场的价格与联邦政策  
   <font color=grey>Casey B. Mulligan</font>

3. **Intended and Unintended Effects of Banning Menthol Cigarettes {#26811}**  
   禁止薄荷醇香烟的预期与非预期效应  
   <font color=grey>Christopher Carpenter, Hai V. Nguyen</font>

4. **Human Capital as Engine of Growth – The Role of Knowledge Transfers in Promoting Balanced Growth Within and Across Countries {#26810}**  
   人力资本作为增长引擎——知识转移在促进国家内部和国家间平衡增长中的作用  
   <font color=grey>Isaac Ehrlich, Yun Pei</font>

5. **Trust and Saving in Financial Institutions by the Poor {#26809}**  
   贫困人群对金融机构的信任与储蓄  
   <font color=grey>Sebastian Galiani, Paul Gertler, Camila Navajas Ahumada</font>

6. **What Determines Consumer Financial Distress? Place- and Person-Based Factors {#26808}**  
   什么决定了消费者财务困境？——基于地点和基于个人的因素  
   <font color=grey>Benjamin J. Keys, Neale Mahoney, Hanbin Yang</font>

7. **Does Information About Climate Risk Affect Property Values? {#26807}**  
   关于气候风险的信息会影响房产价值吗？  
   <font color=grey>Miyuki Hino, Marshall Burke</font>

8. **Network-Based Hiring: Local Benefits; Global Costs {#26806}**  
   基于网络的招聘：局部收益；全局成本  
   <font color=grey>Arun G. Chandrasekhar, Melanie Morten, Alessandra Peter</font>

9. **Housing Discrimination and the Toxics Exposure Gap in the United States: Evidence from the Rental Market {#26805}**  
   美国住房歧视与有毒物质暴露差距：来自租赁市场的证据  
   <font color=grey>Peter Christensen, Ignacio Sarmiento-Barbieri, Christopher Timmins</font>

10. **The Electric Vehicle Transition and the Economics of Banning Gasoline Vehicles {#26804}**  
   电动汽车转型与禁止汽油车的经济学分析  
   <font color=grey>Stephen P. Holland, Erin T. Mansur, Andrew J. Yates</font>

11. **Utilization-Adjusted TFP Across Countries: Measurement and Implications for International Comovement {#26803}**  
   跨国调整利用率的全要素生产率：测量及其对国际联动的影响  
   <font color=grey>Zhen Huo, Andrei A. Levchenko, Nitya Pandalai-Nayar</font>

12. **Dynamic Banking and the Value of Deposits {#26802}**  
   动态银行业务与存款价值  
   <font color=grey>Patrick Bolton, Ye Li, Neng Wang, Jinqiang Yang</font>

13. **A New Mechanism to Alleviate the Crises of Confidence in Science-With An Application to the Public Goods Game {#26801}**  
   缓解科学信任危机的新机制——以公共品博弈为例  
   <font color=grey>Luigi Butera, Philip J. Grossman, Daniel Houser, John A. List, Marie-Claire Villeval</font>

14. **Markups, Labor Market Inequality and the Nature of Work {#26800}**  
   加成率、劳动力市场不平等与工作性质  
   <font color=grey>Greg Kaplan, Piotr Zoch</font>

15. **The Secured Credit Premium and the Issuance of Secured Debt {#26799}**  
   担保债务溢价与担保债务发行  
   <font color=grey>Efraim Benmelech, Nitish Kumar, Raghuram Rajan</font>

16. **Global Macro-Financial Cycles and Spillovers {#26798}**  
   全球宏观金融周期与溢出效应  
   <font color=grey>Jongrim Ha, M. Ayhan Kose, Christopher Otrok, Eswar S. Prasad</font>

17. **Uncovered Interest Parity, Forward Guidance, and the Exchange Rate {#26797}**  
   未抛补利率平价、前瞻指引与汇率  
   <font color=grey>Jordi Galí</font>

18. **Monetary Policy and Bubbles in a New Keynesian Model with Overlapping Generations {#26796}**  
   具有世代交叠的新凯恩斯模型中的货币政策与泡沫  
   <font color=grey>Jordi Galí</font>

19. **Random-Coefficients Logit Demand Estimation with Zero-Valued Market Shares {#26795}**  
   零市场份额下的随机系数Logit需求估计  
   <font color=grey>Jean-Pierre H. Dubé, Ali Hortaçsu, Joonhwi Joo</font>

20. **Intertemporal Price Discrimination in Sequential Quantity-Price Games {#26794}**  
   序贯数量-价格博弈中的跨期价格歧视  
   <font color=grey>James D. Dana Jr., Kevin R. Williams</font>

21. **The Financial Center Leverage Cycle: Does it Spread Around the World? {#26793}**  
   金融中心杠杆周期：它是否在全球蔓延？  
   <font color=grey>Graciela L. Kaminsky, Leandro Medina, Shiyi Wang</font>

22. **The Collateral Channel of Monetary Policy: Evidence from China {#26792}**  
   货币政策的抵押品渠道：来自中国的证据  
   <font color=grey>Hanming Fang, Yongqin Wang, Xian Wu</font>

23. **21st Century Macro {#26791}**  
   21世纪宏观经济学  
   <font color=grey>Narayana R. Kocherlakota</font>

24. **How do U.S. Visa Policies Affect Unauthorized Immigration? {#26790}**  
   美国签证政策如何影响非法移民？  
   <font color=grey>Brian K. Kovak, Rebecca Lessem</font>

25. **Take the Q Train: Value Capture of Public Infrastructure Projects {#26789}**  
   乘坐Q线：公共交通基础设施项目的价值捕获  
   <font color=grey>Arpit Gupta, Stijn Van Nieuwerburgh, Constantine Kontokosta</font>

26. **Across-Country Wage Compression in Multinationals {#26788}**  
   跨国公司的跨国工资压缩  
   <font color=grey>Jonas Hjort, Xuan Li, Heather Sarsons</font>

27. **Does Student Loan Forgiveness Drive Disability Application? {#26787}**  
   学生贷款减免是否会推动残疾申请？  
   <font color=grey>Philip Armour, Melanie A. Zaber</font>

28. **Between Firm Changes in Earnings Inequality: The Dominant Role of Industry Effects {#26786}**  
   企业间收入不平等的变化：行业效应的主导作用  
   <font color=grey>John C. Haltiwanger, James R. Spletzer</font>

29. **The Role of Heterogeneous Risk Preferences, Discount Rates, and Earnings Expectations in College Major Choice {#26785}**  
   异质性风险偏好、贴现率和收入预期在大学专业选择中的作用  
   <font color=grey>Arpita Patnaik, Joanna Venator, Matthew Wiswall, Basit Zafar</font>

30. **Can Low Retirement Savings Be Rationalized? {#26784}**  
   低退休储蓄能否被合理化？  
   <font color=grey>Jason S. Scott, John B. Shoven, Sita N. Slavov, John G. Watson</font>

31. **The Cost of Convenience: Ridehailing and Traffic Fatalities {#26783}**  
   便利的代价：网约车与交通死亡事故  
   <font color=grey>John M. Barrios, Yael Hochberg, Hanyi Yi</font>

32. **Media Competition and News Diets {#26782}**  
   媒体竞争与新闻消费结构  
   <font color=grey>Charles Angelucci, Julia Cagé, Michael Sinkinson</font>

33. **Votes For Women: An Economic Perspective on Women’s Enfranchisement {#26781}**  
   女性投票权：女性选举权的经济学视角  
   <font color=grey>Carolyn Moehling, Melissa A. Thomasson</font>

34. **Cigarette Taxes and Teen Marijuana Use {#26780}**  
   香烟税与青少年大麻使用  
   <font color=grey>D. Mark Anderson, Kyutaro Matsuzawa, Joseph J. Sabia</font>

35. **Drinking and Driving {#26779}**  
   酒后驾驶  
   <font color=grey>Frank A. Sloan</font>

36. **Forward Guidance and Household Expectations {#26778}**  
   前瞻指引与家庭预期  
   <font color=grey>Olivier Coibion, Dimitris Georgarakos, Yuriy Gorodnichenko, Michael Weber</font>

37. **Anti-Bullying Laws and Suicidal Behaviors among Teenagers {#26777}**  
   反欺凌法与青少年自杀行为  
   <font color=grey>Daniel I. Rees, Joseph J. Sabia, Gokhan Kumpas</font>

38. **Digitization and Pre-Purchase Information: The Causal and Welfare Impacts of Reviews and Crowd Ratings {#26776}**  
   数字化与购买前信息：评论和大众评级的因果及福利影响  
   <font color=grey>Imke C. Reimers, Joel Waldfogel</font>

39. **Advance Market Commitments: Insights from Theory and Experience {#26775}**  
   预先市场承诺：来自理论与经验的见解  
   <font color=grey>Michael Kremer, Jonathan D. Levin, Christopher M. Snyder</font>

40. **Does Race Matter for Police Use of Force? Evidence from 911 Calls {#26774}**  
   种族对警察使用武力有影响吗？来自911电话的证据  
   <font color=grey>Mark Hoekstra, CarlyWill Sloan</font>

41. **Beyond Basis Basics: Liquidity Demand and Deviations from the Law of One Price {#26773}**  
   超越基差基础：流动性需求与一价定律的偏离  
   <font color=grey>Todd M. Hazelkorn, Tobias J. Moskowitz, Kaushik Vasudevan</font>

42. **Confirmatory Bias in Health Decisions: Evidence from the MMR-Autism Controversy {#26772}**  
   健康决策中的确认偏误：来自MMR-自闭症争议的证据  
   <font color=grey>Mengcen Qian, Shin-Yi Chou, Ernest K. Lai</font>

43. **Information Acquisition, Efficiency, and Non-Fundamental Volatility {#26771}**  
   信息获取、效率与非基本面波动  
   <font color=grey>Benjamin M. Hébert, Jennifer La'O</font>

44. **A Method to Construct Geographical Crosswalks with an Application to US Counties since 1790 {#26770}**  
   一种构建地理交叉对照表的方法：以1790年以来美国县级数据为例  
   <font color=grey>Fabian Eckert, Andrés Gvirtz, Jack Liang, Michael Peters</font>

45. **Medicaid Physician Fees and Access to Care among Children with Special Health Care Needs {#26769}**  
   医疗补助医生费用与特殊医疗需求儿童的医疗可及性  
   <font color=grey>Pinka Chatterji, Sandra Decker, Jason U. Huh</font>

46. **Uncertainty Shocks and Business Cycle Research {#26768}**  
   不确定性冲击与商业周期研究  
   <font color=grey>Jesús Fernández-Villaverde, Pablo A. Guerrón-Quintana</font>

47. **Immigration Lottery Design: Engineered and Coincidental Consequences of H-1B Reforms {#26767}**  
   移民抽签设计：H-1B改革的工程性与偶然性后果  
   <font color=grey>Parag A. Pathak, Alex Rees-Jones, Tayfun Sönmez</font>

48. **When and How to Use Public-Private Partnerships in Infrastructure: Lessons From the International Experience {#26766}**  
   何时以及如何使用公私合作伙伴关系提供基础设施：来自国际经验的经验教训  
   <font color=grey>Eduardo Engel, Ronald D. Fischer, Alexander Galetovic</font>

49. **Estimating Dynamic Games of Oligopolistic Competition: An Experimental Investigation {#26765}**  
   寡头竞争动态博弈的估计：一项实验研究  
   <font color=grey>Tobias Salz, Emanuel Vespa</font>

50. **Long-run Trends in the U.S. SES-Achievement Gap {#26764}**  
   美国社会经济地位-成就差距的长期趋势  
   <font color=grey>Eric A. Hanushek, Jacob D. Light, Paul E. Peterson, Laura M. Talpey, Ludger Woessmann</font>

51. **Were Jews in Interwar Poland More Educated? {#26763}**  
   两次世界大战期间的波兰犹太人是否受教育程度更高？  
   <font color=grey>Ran Abramitzky, Hanna Halaburda</font>

52. **The Corporate Finance of Multinational Firms {#26762}**  
   跨国公司的公司金融  
   <font color=grey>Isil Erel, Yeejin Jang, Michael S. Weisbach</font>

53. **Partial Identification and Inference for Dynamic Models and Counterfactuals {#26761}**  
   动态模型与反事实的部分识别与推断  
   <font color=grey>Myrto Kalouptsidi, Yuichi Kitamura, Lucas Lima, Eduardo A. Souza-Rodrigues</font>

54. **Why Is the Euro Punching Below Its Weight? {#26760}**  
   为什么欧元的表现低于其应有水平？  
   <font color=grey>Ethan Ilzetzki, Carmen M. Reinhart, Kenneth S. Rogoff</font>

55. **School Effects on Socio-emotional Development, School-Based Arrests, and Educational Attainment {#26759}**  
   学校对社会情感发展、校内逮捕和教育成就的影响  
   <font color=grey>C. Kirabo Jackson, Shanette C. Porter, John Q. Easton, Alyssa Blanchard, Sebastián Kiguel</font>

56. **Effects of Scaling Up Private School Choice Programs on Public School Students {#26758}**  
   扩大私立学校选择项目对公立学校学生的影响  
   <font color=grey>David N. Figlio, Cassandra M.D. Hart, Krzysztof Karbownik</font>

57. **Social Groups and the Effectiveness of Protests {#26757}**  
   社会群体与抗议的有效性  
   <font color=grey>Marco Battaglini, Rebecca B. Morton, Eleonora Patacchini</font>

58. **The Limits of onetary Economics: On Money as a Latent Medium of Exchange {#26756}**  
   货币经济学的局限：论货币作为潜在交换媒介  
   <font color=grey>Ricardo Lagos, Shengxing Zhang</font>

59. **Can Investors Time Their Exposure to Private Equity? {#26755}**  
   投资者能否把握私募股权投资的时机？  
   <font color=grey>Gregory Brown, Robert S. Harris, Wendy Hu, Tim Jenkinson, Steven N. Kaplan, David T. Robinson</font>

60. **Historical Natural Experiments: Bridging Economics and Economic History {#26754}**  
   历史自然实验：连接经济学与经济史  
   <font color=grey>Davide Cantoni, Noam Yuchtman</font>

61. **Central Bank Digital Currency: Central Banking For All? {#26753}**  
   央行数字货币：面向所有人的中央银行？  
   <font color=grey>Jesús Fernández-Villaverde, Daniel Sanches, Linda Schilling, Harald Uhlig</font>

62. **Stagnation and Scientific Incentives {#26752}**  
   停滞与科学激励  
   <font color=grey>Jay Bhattacharya, Mikko Packalen</font>

63. **Drug Firms' Payments and Physicians' Prescribing Behavior in Medicare Part D {#26751}**  
   药品公司支付与医生在医疗保险D部分的处方行为  
   <font color=grey>Colleen Carey, Ethan M.J. Lieber, Sarah Miller</font>

64. **An Exploration of Trend-Cycle Decomposition Methodologies in Simulated Data {#26750}**  
   模拟数据中趋势-周期分解方法的探索  
   <font color=grey>Robert J. Hodrick</font>

65. **Effect of Prescription Opioids and Prescription Opioid Control Policies on Infant Health {#26749}**  
   处方阿片类药物及处方阿片类药物管控政策对婴儿健康的影响  
   <font color=grey>Engy Ziedan, Robert Kaestner</font>

66. **The Determinants of Income Segregation and Intergenerational Mobility: Using Test Scores to Measure Undermatching {#26748}**  
   收入隔离与代际流动的决定因素：利用考试成绩衡量匹配不足  
   <font color=grey>Raj Chetty, John N. Friedman, Emmanuel Saez, Nicholas Turner, Danny Yagan</font>

67. **College Attainment, Income Inequality, and Economic Security: A Simulation Exercise {#26747}**  
   大学学历获得、收入不平等与经济安全：一项模拟练习  
   <font color=grey>Brad Hershbein, Melissa Schettini Kearney, Luke W. Pardue</font>

68. **The Economic Consequences of Increasing Sleep Among the Urban Poor {#26746}**  
   增加城市贫困人口睡眠的经济后果  
   <font color=grey>Pedro Bessone, Gautam Rao, Frank Schilbach, Heather Schofield, Mattie Toma</font>

69. **A Fiscal Theory of Monetary Policy with Partially-Repaid Long-Term Debt {#26745}**  
   带有部分偿还长期债务的货币政策的财政理论  
   <font color=grey>John H. Cochrane</font>

70. **Identity Verification Standards in Welfare Programs: Experimental Evidence from India {#26744}**  
   福利项目中的身份验证标准：来自印度的实验证据  
   <font color=grey>Karthik Muralidharan, Paul Niehaus, Sandip Sukhtankar</font>

71. **Neighborhood-Based Information Costs {#26743}**  
   基于邻域的信息成本  
   <font color=grey>Benjamin M. Hébert, Michael Woodford</font>

72. **Ethnic Attrition, Assimilation, and the Measured Health Outcomes of Mexican Americans {#26742}**  
   民族流失、同化与墨西哥裔美国人的测量健康结果  
   <font color=grey>Francisca M. Antman, Brian Duncan, Stephen J. Trejo</font>

73. **Gains from Trade: Does Sectoral Heterogeneity Matter? {#26741}**  
   贸易收益：部门异质性重要吗？  
   <font color=grey>Rahul Giri, Kei-Mu Yi, Hakan Yilmazkuday</font>

74. **Inflation and the Price of Real Assets {#26740}**  
   通货膨胀与实物资产价格  
   <font color=grey>Matteo Leombroni, Monika Piazzesi, Martin Schneider, Ciaran Rogers</font>

75. **Technological Innovation and Discrimination in Household Finance {#26739}**  
   技术创新与家庭金融中的歧视  
   <font color=grey>Adair Morse, Karen Pence</font>

76. **Competing with Robots: Firm-Level Evidence from France {#26738}**  
   与机器人竞争：来自法国的企业层面证据  
   <font color=grey>Daron Acemoglu, Claire LeLarge, Pascual Restrepo</font>

77. **The Effects of Prize Structures on Innovative Performance {#26737}**  
   奖金结构对创新绩效的影响  
   <font color=grey>Joshua Graff Zivin, Elizabeth Lyons</font>

78. **Simplifying and Improving the Performance of Risk Adjustment Systems {#26736}**  
   简化并改进风险调整系统的绩效  
   <font color=grey>Thomas G. McGuire, Anna L. Zink, Sherri Rose</font>

79. **Physician Health Management Skills and Patient Outcomes {#26735}**  
   医生的健康管理技能与患者结果  
   <font color=grey>Emilia Simeonova, Niels Skipper, Peter R. Thingholm</font>

80. **Correlation Neglect in Student-to-School Matching {#26734}**  
   学生-学校匹配中的相关性忽视  
   <font color=grey>Alex Rees-Jones, Ran Shorrer, Chloe J. Tergiman</font>

81. **The Allocation of Authority in Organizations: A Field Experiment with Bureaucrats {#26733}**  
   组织中的权力分配：一项针对官僚的实地实验  
   <font color=grey>Oriana Bandiera, Michael Carlos Best, Adnan Qadir Khan, Andrea Prat</font>

82. **Not Playing Favorites: An Experiment on Parental Fairness Preferences {#26732}**  
   不偏不倚：一项关于父母公平偏好的实验  
   <font color=grey>James Berry, Rebecca Dizon-Ross, Maulik Jagnani</font>

83. **Globotics and Development: When Manufacturing is Jobless and Services are Tradable {#26731}**  
   全球机器人与发展：当制造业无就业且服务业可贸易时  
   <font color=grey>Richard Baldwin, Rikard Forslid</font>

84. **Decentralized Targeting of Agricultural Credit Programs: Private versus Political Intermediaries {#26730}**  
   农业信贷项目的分散化目标定位：私人中介与政治中介的比较  
   <font color=grey>Pushkar Maitra, Sandip Mitra, Dilip Mookherjee, Sujata Visaria</font>

85. **The Demand for Interns {#26729}**  
   实习生需求  
   <font color=grey>David A. Jaeger, John M. Nunley, Alan Seals, Eric J. Wilbrandt</font>

86. **Not All School Shootings are the Same and the Differences Matter {#26728}**  
   并非所有校园枪击案都相同，差异至关重要  
   <font color=grey>Phillip B. Levine, Robin McKnight</font>

87. **Are Large Deficits and Debt Dangerous? {#26727}**  
   巨额赤字和债务危险吗？  
   <font color=grey>Michael J. Boskin</font>
...
【**Author**】: Juan Chaparro, Aaron Sojourner, Matthew J. Wiswall
...
【**摘要**】：本文将关于早期儿童发展的多种信息来源整合到一个统一模型中，用于分析广泛的早期儿童政策干预。我们构建了一个儿童照护模型，其中家庭同时决定母亲照护与非母亲照护的数量和质量，以及母亲的劳动供给。该模型引入了一个新颖的育儿努力渠道，即允许减少育儿时间的儿童照护补贴，反而可能促成更好的育儿质量。为估计该模型，我们将观察数据与来自“婴儿健康与发展项目”（IHDP）的实验数据相结合，该项目在儿童1岁和2岁时随机提供免费儿童照护。我们估计了认知技能生产函数和家庭偏好，从而深入理解驱动IHDP干预事后异质性效应的机制，并考虑了对照组可获得的替代照护选择以及儿童照护提供对家庭决策的溢出效应。我们还估计了反事实政策的事前效应，例如提供低质量照护、要求对补贴照护进行共付、提高母亲工资或提供现金转移。最后，我们利用该模型来解释美国以外关于普及儿童照护项目效果的现有证据。

【**NBER**】: NBER Working Paper No. 26813，https://www.nber.org/papers/w26813
...
【**摘要**】：消费者理论被扩展，以纳入处方阿片类药物和非法制造阿片类药物市场中常见的一价定律偏离。这一扩展有助于解决文献中的“令人费解”的发现，例如死亡率中的种族和年龄差距，以及处方阿片类药物全价上涨未能减少阿片类药物致死人数。该理论还识别了预测消费者行为从而预测人口预期寿命所必需的公共政策特征。最令人惊讶的是，鉴于海洛因和芬太尼近期相对便宜，任何处方阿片类药物政策在2013年之后可能（而且很可能确实）产生与之前相反的总消费效应，尤其是当更昂贵的处方阿片类药物产品受到差异化影响时。该理论框架还指导了联邦阿片类药物政策数据集的构建，以及对非法市场中技术变革和执法作用的评估。

【**NBER**】: NBER Working Paper No. 26812，https://www.nber.org/papers/w26812

#### 3. Intended and Unintended Effects of Banning Menthol Cigarettes {#26811}

【**Author**】: Christopher Carpenter, Hai V. Nguyen
...
【**摘要**】：世界卫生组织已建议禁止薄荷醇香烟，欧盟已全面采纳，美国食品药品监督管理局也已提出此建议，主要原因是担心薄荷醇香烟助长青少年吸烟。然而，利用现实世界政策变化获得的直接证据几乎为零。我们通过研究加拿大（在2018年全国性薄荷醇禁令之前，已有七个省份实施了禁令）来提供对这一政策的首次全面评估。利用省级销售数据，我们显示薄荷醇禁令后薄荷醇香烟销量立即降至零，而对非薄荷醇香烟销量没有显著影响。调查数据证实，省级薄荷醇禁令显著减少了青少年和成年人的薄荷醇香烟吸食。然而，我们也发现了强烈的替代证据：省级薄荷醇禁令显著增加了青少年的非薄荷醇香烟吸食，导致青少年吸烟率总体净变化为零。我们还记录了规避行为的证据：省级薄荷醇禁令将吸烟者的香烟购买从杂货店和加油站转移到了原住民保留地（薄荷醇禁令在那里不适用）。我们的结果证明了在设计更严格的烟草法规时考虑替代和规避反应的重要性。

【**NBER**】: NBER Working Paper No. 26811，https://www.nber.org/papers/w26811
...
【**摘要**】：与物质资本不同，人力资本具有体现性和非体现性两个维度。它既可以被视为技能和习得知识，也可以被视为代际之间以及国家内部和国家间不同技能群体之间的知识溢出效应。我们阐述了这些特征在经济发展过程中的作用；收入增长与收入和生育率分布之间的关系；以及在平衡增长的全球均衡环境中，人力资本在决定移民技能分布方面的相关性。在所有三个阐述中，知识溢出效应都发挥着关键作用。该分析为理解许多发达国家生育率降至人口更替水平以下、发展中国家和发达国家之间收入和生育率分布的演变，以及内生移民流动及其技能构成对来源国和目的地国本土居民长期净收益的通常不对称影响，提供了新的见解。

【**NBER**】: NBER Working Paper No. 26810，https://www.nber.org/papers/w26810

#### 5. Trust and Saving in Financial Institutions by the Poor {#26809}

【**Author**】: Sebastian Galiani, Paul Gertler, Camila Navajas Ahumada
...
【**摘要**】：我们随机分配秘鲁有条件现金转移项目的受益者参加一个为期3小时的培训课程，该课程旨在建立他们对金融机构的信任。我们发现该干预措施：（a）增加了对银行的信任，但对金融素养没有影响，以及（b）在十个月期间增加了储蓄。储蓄的增加意味着现金转移存款的储蓄率提高了1.4个百分点，家庭收入的储蓄率提高了0.4个百分点。

【**NBER**】: NBER Working Paper No. 26809，https://www.nber.org/papers/w26809
...
【**摘要**】：我们利用信用报告数据研究美国消费者的财务困境。我们显示不同地区之间存在巨大且持续的财务困境差异。为了理解这些模式，我们进行了一项“迁移者”分析。对于催收和违约，迁移后仅出现微弱的趋同，这表明这些类型的困境并非主要由基于地点的因素（例如，当地经济状况和州法律）引起，而是反映了基于个人的特征（例如，金融素养和风险偏好）。相比之下，对于个人破产，我们发现了相当大的基于地点的效应，这与关于当地法律因素如何影响个人破产的轶事证据一致。

【**NBER**】: NBER Working Paper No. 26808，https://www.nber.org/papers/w26808

#### 7. Does Information About Climate Risk Affect Property Values? {#26807}

【**Author**】: Miyuki Hino, Marshall Burke

【**Abstract**】: Floods and other climate hazards pose a widespread and growing threat to housing and infrastructure around the world. By incorporating climate risk into asset prices, markets can discourage excessive development in hazardous areas. However, the extent to which markets actually price these risks remains poorly understood. Here we measure the effect of information about flood risk on residential property values in the United States. Using multiple empirical approaches and two decades of sales data covering the universe of homes in the US, we find little evidence that housing markets fully price information about flood risk in aggregate. However, the price penalty for flood risk is larger for commercial buyers and in states where sellers must disclose information about flood risk to potential buyers, suggesting that policies to improve risk communication could influence market outcomes. Our findings indicate that floodplain homes in the US are currently overvalued by a total of $\$34$B, raising concerns about the stability of real estate markets as climate risks become more salient and severe.

【**摘要**】：洪水和其他气候灾害对世界各地的住房和基础设施构成了广泛且日益严重的威胁。通过将气候风险纳入资产价格，市场可以阻止在危险区域的过度开发。然而，市场实际定价这些风险的程度仍然知之甚少。在此，我们衡量了关于洪水风险的信息对美国住宅房产价值的影响。使用多种实证方法和涵盖美国所有房屋的二十年销售数据，我们发现几乎没有证据表明住房市场在总体上完全定价了关于洪水风险的信息。然而，对于商业买家以及卖方必须向潜在买家披露洪水风险信息的州，洪水风险的价格惩罚更大，这表明改善风险沟通的政策可能会影响市场结果。我们的研究结果表明，美国洪泛区房屋目前被高估了总计340亿美元，这引发了人们对随着气候风险变得更加显著和严重，房地产市场稳定性的担忧。

【**NBER**】: NBER Working Paper No. 26807，https://www.nber.org/papers/w26807

#### 8. Network-Based Hiring: Local Benefits; Global Costs {#26806}

【**Author**】: Arun G. Chandrasekhar, Melanie Morten, Alessandra Peter
...
【**摘要**】：企业家，尤其是在发展中国家，通常从他们的网络中招聘：朋友、家人以及由此产生的推荐。网络招聘有两个在实证文献中得到广泛记录的好处：企业家更了解其网络成员的能力（事实上，他们通常是被正向选择的），并且网络成员可能不太容易发生道德风险。我们从理论上研究了网络招聘如何影响企业的规模和构成（即，是招聘朋友还是陌生人）。我们的主要结果是，网络招聘虽然局部有益，但可能全局无效率。由于网络的存在，企业家设定的工资过低，企业规模过小，过度依赖网络进行招聘，由此产生的福利损失随着网络质量的提高而增加。此外，如果企业家对外部劳动力市场的真实质量不确定，经济可能会陷入信息贫困陷阱，即使是前瞻性的企业家，或者处于具有社会学习的市场中的企业家，也永远无法了解陌生人能力的正确分布，从而加剧福利损失。我们表明，当网络推荐的质量更高时，贫困陷阱可能会恶化。

【**NBER**】: NBER Working Paper No. 26806，https://www.nber.org/papers/w26806

#### 9. Housing Discrimination and the Toxics Exposure Gap in the United States: Evidence from the Rental Market {#26805}

【**Author**】: Peter Christensen, Ignacio Sarmiento-Barbieri, Christopher Timmins
...
【**摘要**】：局部污染暴露对少数族裔家庭的影响尤为严重，但其根本原因尚不明确。本研究在一个主要在线住房平台上进行通信实验，以检验住房歧视是否限制了少数族裔在存在显著空气化学有毒物质来源的市场中获得住房选择。我们发现，与非裔美国人或西班牙裔/拉丁裔名字的租房者相比，白人名字的租房者在低暴露地点获得房产回复的可能性高出41%。在高暴露地点，我们没有发现歧视性限制的证据，这表明歧视增加了在暴露风险较高的情况下获得住房选择的相对机会。

【**NBER**】: NBER Working Paper No. 26805，https://www.nber.org/papers/w26805

#### 10. The Electric Vehicle Transition and the Economics of Banning Gasoline Vehicles {#26804}

【**Author**】: Stephen P. Holland, Erin T. Mansur, Andrew J. Yates
...
【**摘要**】：电动汽车在改变个人交通方式方面具有独特潜力。我们通过一个动态模型分析向电动汽车的转型，该模型捕捉了电动汽车生产成本下降、发电污染减少、电动汽车对汽油车替代性增强以及车辆存量的耐用性。由于污染的外部成本，在常规经营模式下，效率低下源于车辆组合以及转型时机，其严重程度取决于替代性。我们将模型校准到美国市场，发现效率低下的程度相当温和：不到总外部成本的5%。电动汽车的最优购买补贴和汽油车生产的最优禁令都带来了大致相同的效率提升，但后者导致禁令前汽油车产量急剧增加。通过可交易的产量配额逐步淘汰汽油车，其无谓损失减少幅度远大于其他政策，但如果设置不当，可能导致非常大的无谓损失。

【**NBER**】: NBER Working Paper No. 26804，https://www.nber.org/papers/w26804

#### 11. Utilization-Adjusted TFP Across Countries: Measurement and Implications for International Comovement {#26803}

【**Author**】: Zhen Huo, Andrei A. Levchenko, Nitya Pandalai-Nayar
...
【**摘要**】：本文为29个国家（时间跨度长达37年）的面板数据，开发了经未观测到的要素利用率变动调整后的全要素生产率增长估计。当要素利用率变化未被观测到时，常用的索洛残差会错误衡量全要素生产率的实际变化。我们使用一个一般均衡动态多国多部门模型，推导出一个生产函数估计方程，该方程纠正了未观测到的要素使用情况。我们将调整利用率后的全要素生产率序列与标准索洛残差进行比较，并量化全要素生产率和利用率在国际商业周期联动中的作用。调整利用率后的全要素生产率在国家间几乎不相关，并且通过其传导不会产生显著的GDP联动。要素利用率冲击能更成功地解释国际联动。

【**NBER**】: NBER Working Paper No. 26803，https://www.nber.org/papers/w26803
...
【**摘要**】：我们提出一个银行理论，其中银行无法完全控制存款流动。面对不可保险的贷款和存款冲击，银行动态管理贷款、批发融资、存款和股权。存款通过降低融资成本创造价值。然而，当银行资本不足且面临违反杠杆要求的风险时，存款的边际价值可能转为负值，因为存款流入通过提高杠杆，增加了昂贵股权发行的可能性。银行无法完全控制杠杆，这使其区别于非存款中介机构。我们的模型建议重新评估杠杆监管，并为低利率环境下的银行业提供新视角。

【**NBER**】: NBER Working Paper No. 26802，https://www.nber.org/papers/w26802

#### 13. A New Mechanism to Alleviate the Crises of Confidence in Science-With An Application to the Public Goods Game {#26801}

【**Author**】: Luigi Butera, Philip J. Grossman, Daniel Houser, John A. List, Marie-Claire Villeval
...
【**摘要**】：经济学中经验知识的创造在过去几十年发生了戏剧性转变。新研究格局的一个特征是学者生成数据的性质和程度。如今，几乎在每个领域，实验方法在检验理论和指导组织决策方面都发挥着越来越关键的作用。尽管这场革命有很多值得赞赏之处，但最近社会科学领域出现了一场可信度危机，认为费希尔（1935）三脚架的一个重要组成部分尚未被完全接受：复制。事实上，虽然复制的重要性在科学上无可争议，但从个体研究者的角度来看，当前的激励不足以鼓励复制。我们分析了一种新机制，该机制通过利用学者和编辑之间的互利共赢来促进复制。我们开发了一个模型，捕捉在向期刊提交论文之前寻求独立复制所涉及的权衡。我们通过研究奈特不确定性对公共品博弈中合作率的影响来展示该方法的运作，这是文献中一个普遍但很大程度上未被探索的特征。

【**NBER**】: NBER Working Paper No. 26801，https://www.nber.org/papers/w26801

#### 14. Markups, Labor Market Inequality and the Nature of Work {#26800}

【**Author**】: Greg Kaplan, Piotr Zoch
...
【**摘要**】：我们证明了区分劳动的传统生产用途与劳动在管理费用、营销和其他扩张活动中的替代用途，对于研究要素收入和劳动收入的分配至关重要。我们利用我们的框架评估加成率变化对总体劳动份额以及跨职业劳动收入不平等的影响。我们根据职业收入份额与加成率引起的劳动份额变化的共同变动，识别不同职业的生产和扩张内容。我们发现，美国劳动收入中约五分之一用于补偿扩张活动，并且自1980年以来，扩张内容较大的职业经历了最快的工资和就业增长。我们的框架可以在存在价格粘性的情况下合理化反周期的劳动份额，并可用于研究需求冲击、货币政策和竞争长期变化对分配的影响。

【**NBER**】: NBER Working Paper No. 26800，https://www.nber.org/papers/w26800
...
【**摘要**】：担保债务的信用利差低于无担保债务，尤其是在公司信用质量恶化、经济放缓或平均信用利差扩大时。然而，投资级公司往往在任何时候都不愿发行担保债务。相反，我们发现，对于评级低于投资级的公司，随着公司信用质量恶化、经济放缓或平均信用利差扩大，发行担保债务的可能性增加。这种发行行为的差异模式与高评级公司将未抵押的抵押品视为一种保险形式，仅在极端情况下使用是一致的。

【**NBER**】: NBER Working Paper No. 26799，https://www.nber.org/papers/w26799

#### 16. Global Macro-Financial Cycles and Spillovers {#26798}

【**Author**】: Jongrim Ha, M. Ayhan Kose, Christopher Otrok, Eswar S. Prasad
...
【**摘要**】：我们开发了一个新的动态因子模型，使我们能够共同刻画全球宏观经济和金融周期以及它们之间的溢出效应。该模型将宏观经济周期分解为由全球和国家特定宏观因子驱动的部分，以及由金融变量溢出驱动的部分。我们考虑宏观经济总量（产出、消费和投资）和金融变量（股票和房价以及利率）的周期。我们发现，全球宏观因子在解释七国集团商业周期中起着主要作用，但也存在股票和房价冲击对宏观经济总量的溢出效应。这些溢出效应主要通过全球宏观因子而非国家特定宏观因子运作（即这些溢出效应影响所有七国集团经济体的商业周期），并且在全球金融危机前后时期更为强烈。我们几乎没有发现宏观经济周期向金融周期溢出的证据。

【**NBER**】: NBER Working Paper No. 26798，https://www.nber.org/papers/w26798
...
【**摘要**】：根据未抛补利率平价（UIP），实际利率差预期变化对实际汇率的影响大小，与预期变化发生的期限无关。使用美国、欧元区和英国数据的实证证据表明，该不变性预测存在显著偏离：近期（远期）利率差预期对实际汇率的影响远大于（小于）UIP所隐含的程度。本文讨论了一些可能的解释。

【**NBER**】: NBER Working Paper No. 26797，https://www.nber.org/papers/w26797
...
【**摘要**】：我分析了一个新凯恩斯模型的扩展版本，该模型包含有限生命代理人的世代交叠以及（随机的）非活跃状态转换。与标准模型相比，所提出的框架允许存在具有资产价格泡沫的理性预期均衡。我研究了泡沫驱动波动可能出现的条件，以及可能防止此类波动的货币政策规则类型。最后，我讨论了该模型的一些福利含义。

【**NBER**】: NBER Working Paper No. 26796，https://www.nber.org/papers/w26796

#### 19. Random-Coefficients Logit Demand Estimation with Zero-Valued Market Shares {#26795}

【**Author**】: Jean-Pierre H. Dubé, Ali Hortaçsu, Joonhwi Joo
...
【**摘要**】：尽管通常被忽视，许多购买数据集显示出产品零销售的高发生率。我们针对具有零市场份额的购买数据集，提出了一种新的随机系数Logit需求系统估计量。需求参数的识别基于一种成对差分方法，该方法根据产品对之间的需求差异构建矩条件。相应的估计量以非参数方式校正了零发生率在需求未观测方面可能存在的选择偏差。该估计量还校正了营销变量在需求和选择倾向性中可能存在的内生性。蒙特卡洛模拟表明，我们提出的估计量在存在和不存在未观测因素选择的情况下，都能提供可靠的小样本推断。在一个实证案例研究中，所提出的估计量不仅产生了与忽略零份额发生率选择的方法不同的需求估计，而且在样本外对观测到的零售贡献利润率的拟合效果更好。

【**NBER**】: NBER Working Paper No. 26795，https://www.nber.org/papers/w26795

#### 20. Intertemporal Price Discrimination in Sequential Quantity-Price Games {#26794}

【**Author**】: James D. Dana Jr., Kevin R. Williams
...
【**摘要**】：本文构建了一个寡头垄断模型，其中企业首先选择产能，然后在一系列预售市场中展开价格竞争。我们表明，当需求弹性随时间下降时，强大的竞争力量阻止了企业利用跨期价格歧视。然后，我们通过允许企业使用库存控制（即分配给单个价格的销售限额）来丰富模型。我们表明，竞争企业可以有利可图地使用库存控制。因此，尽管库存控制通常被视为管理需求不确定性的工具，但我们表明，它在寡头垄断中也能促进价格歧视。

【**NBER**】: NBER Working Paper No. 26794，https://www.nber.org/papers/w26794

#### 21. The Financial Center Leverage Cycle: Does it Spread Around the World? {#26793}

【**Author**】: Graciela L. Kaminsky, Leandro Medina, Shiyi Wang
...
【**摘要**】：利用一个新颖的数据库，我们考察了自20世纪70年代初布雷顿森林体系崩溃以来资本流向外围经济体的演变。我们将资本流动分解为全球因素、区域因素和特质因素。与先前主要使用2000年代数据的发现相反，我们发现资本流动的繁荣与衰退主要由区域因素而非全球因素解释。然后我们追问，是什么驱动了这些区域因素？是金融中心的杠杆周期吗？是什么触发了金融中心的杠杆周期？是全球投资者风险偏好的变化，还是外围经济体资本需求的变化？我们将金融中心的杠杆与区域资本流动以及国际资本市场的借贷成本联系起来，以回答这些问题。我们的估计表明，区域资本流动是由供给冲击驱动的。有趣的是，我们发现金融中心的杠杆具有时变行为，从20世纪70年代至90年代向新兴外围经济体的贷款，转向了21世纪向发达外围经济体的贷款。

【**NBER**】: NBER Working Paper No. 26793，https://www.nber.org/papers/w26793

#### 22. The Collateral Channel of Monetary Policy: Evidence from China {#26792}

【**Author**】: Hanming Fang, Yongqin Wang, Xian Wu
...
【**摘要**】：基于抵押品的货币政策工具已被各大央行广泛使用。然而，缺乏适当的政策反事实，使得难以通过实证识别其对金融市场和实体经济的因果效应。我们利用中国的一个准自然实验，其中双重上市债券在两个基本分割的市场交易：由中央银行监管的银行间市场，以及由证券监管机构监管的交易所市场。在我们研究期间的一次政策转变中，中国央行将一类此前在银行间市场不合格的债券纳入合格抵押品范围，允许金融机构从中期借贷便利（MLF）借款。这一政策转变使我们能够采用三重差分策略来估计基于抵押品的非常规货币政策的因果影响。我们发现，在二级市场，该政策使处理市场（银行间市场）中新成为合格抵押品的债券的利差降低了42-62个基点。我们还发现存在从二级市场到一级市场的传导效应：在银行间市场新发行的处理债券的利差降低了54个基点。

【**NBER**】: NBER Working Paper No. 26792，https://www.nber.org/papers/w26792
...
【**摘要**】：在21世纪，发达世界的许多关键宏观经济变量持续低迷，包括通胀、产出、增长、利率（实际和名义）以及劳动份额。我考虑了一类标准的代表性代理人理性预期模型，其中基本面是确定性的且随时间恒定。我表明，对于任何名义摩擦程度（无论多小）和任何货币政策规则（无论多积极），都存在一个大的随机均衡集合，这些均衡表现出持续的低通胀、低产出、低劳动份额和低名义利率。如果菲利普斯曲线足够平坦，那么这些均衡还表现出低增长和低实际利率。

【**NBER**】: NBER Working Paper No. 26791，https://www.nber.org/papers/w26791

#### 24. How do U.S. Visa Policies Affect Unauthorized Immigration? {#26790}

【**Author**】: Brian K. Kovak, Rebecca Lessem
...
【**摘要**】：我们研究了增加潜在移民可获得的签证数量将如何影响从墨西哥到美国的非法移民。美国现行政策禁止被驱逐出境的人在一段时间内获得合法身份。该政策旨在作为对非法移民的额外威慑，但可能无效，因为大多数潜在的墨西哥移民能够合法移居美国的概率极低。我们开发了一个动态离散区位选择模型，并使用墨西哥移民项目的数据进行估计，然后考虑了各种改变执法力度和工作签证获取途径的反事实政策。我们发现，在当前的合法移民率下，对被驱逐者的入境禁令无效，但提高合法化率会放大驱逐的威慑效果。我们还表明，临时工作签证计划会产生与增加永久合法化类似的威慑效果，而不会导致居住在美国的移民总存量大幅增加。这些发现对未来移民改革的结构设计具有重要意义。

【**NBER**】: NBER Working Paper No. 26790，https://www.nber.org/papers/w26790

#### 25. Take the Q Train: Value Capture of Public Infrastructure Projects {#26789}

【**Author**】: Arpit Gupta, Stijn Van Nieuwerburgh, Constantine Kontokosta
...
【**摘要**】：交通基础设施是经济活动的重要资产，但在密集的城市环境中建设成本高昂。我们通过分析当地房地产价格（这些价格资本化了交通溢出效应的收益）来衡量纽约市第二大道地铁延伸线的效益，这是近期最昂贵的城市交通基础设施项目。我们发现房价上涨了8%，创造了60亿美元的新房产价值。利用手机定位数据，我们记录了通勤时间的大幅减少，尤其是地铁用户，这为价格上涨提供了一个合理的机制。价格上涨既反映了更高的租金，也反映了更低的风险。基础设施改善降低了房地产投资的风险。地铁创造的私人价值中，只有30%通过更高的房产税收入被捕获，不足以覆盖地铁的成本。有针对性的房产税增加可能有助于政府捕获更多创造的价值，并作为一种有用的融资工具。

【**NBER**】: NBER Working Paper No. 26789，https://www.nber.org/papers/w26789

#### 26. Across-Country Wage Compression in Multinationals {#26788}

【**Author**】: Jonas Hjort, Xuan Li, Heather Sarsons

【**Abstract**】: Many employers link wages at establishments outside of the home region to the level at headquarters. We show this using new data on 1,200 multinationals’ establishments across the world and linked employee-level data on their establishments in Brazil. Headquarters wage changes arising from minimum wage and exchange rate shocks are partially transmitted to workers employed in the same position abroad. Wage change transmission appears to be direct and results from firm-wide wage-setting procedures rather than associated technology or employment changes. “Anchored” wage-setting is somewhat associated with particular characteristics of the job×employer×headquarter-establishment country-pair.

【**摘要**】：许多雇主将总部以外分支机构的工资与总部水平挂钩。我们利用全球1200家跨国公司分支机构的新数据以及其在巴西分支机构的关联员工层面数据证明了这一点。由最低工资和汇率冲击引起的总部工资变化会部分传导给在国外同一职位工作的员工。工资变化的传导似乎是直接的，并且源于公司范围内的工资制定程序，而非相关的技术或就业变化。“锚定”工资制定在一定程度上与特定工作×雇主×总部-分支机构国家对的特定特征相关。

【**NBER**】: NBER Working Paper No. 26788，https://www.nber.org/papers/w26788

#### 27. Does Student Loan Forgiveness Drive Disability Application? {#26787}

【**Author**】: Philip Armour, Melanie A. Zaber
...
【**摘要**】：美国的学生贷款债务超过1.3万亿美元，与信用卡和医疗债务不同，通常不能通过破产免除。此外，这种债务一直在增加：离校时联邦学生债务超过5万美元的借款人比例从1992年的2%增加到2014年的17%。然而，残疾个人可以通过教育部的完全和永久性残疾解除机制，在证明完全和永久性残疾后获得联邦学生贷款债务的免除。2013年7月，TPDD扩大到包括领取社会保障残疾保险或补充保障收入作为符合条件的免除类别，前提是预计不会出现医疗改善。利用与SSI和SSDI申请相匹配的收入与项目参与调查数据，我们发现，与没有学生贷款的受访者相比，有学生贷款的受访者的SSDI和SSI申请率有所上升。我们的估计表明，这项政策变化使学生贷款持有者在特定季度申请SSDI或SSI的概率提高了50%（每季度基线率约为0.3%），总体上增加了SSI和SSDI的授予。然而，这些被诱导的福利领取者不太可能获得获得学生贷款免除所需的残疾认定。鉴于学生贷款负债的地理分布与历史SSDI/SSI项目参与率不同，这对SSDI和SSI受益人的规模和地点都有重要影响。此外，这些发现强调了从与SSDI和SSI相互作用的项目政策变化中学习的重要性，以更好地理解残疾项目参与的驱动因素。

【**NBER**】: NBER Working Paper No. 26787，https://www.nber.org/papers/w26787

#### 28. Between Firm Changes in Earnings Inequality: The Dominant Role of Industry Effects {#26786}

【**Author**】: John C. Haltiwanger, James R. Spletzer
...
【**摘要**】：我们发现，在美国总体不平等加剧中占主导地位的、不断上升的企业间收入不平等，大部分是由行业效应造成的。这些行业效应源于不断上升的行业间收入差异，而非就业在行业间分布的变化。我们还发现，不断上升的行业间收入差异几乎完全由职业效应解释。这些结果将近期文献中不同组成部分的关键发现联系起来：一个关注企业效应，另一个关注职业效应。通过行业效应建立的这种联系挑战了传统观点。

【**NBER**】: NBER Working Paper No. 26786，https://www.nber.org/papers/w26786

#### 29. The Role of Heterogeneous Risk Preferences, Discount Rates, and Earnings Expectations in College Major Choice {#26785}

【**Author**】: Arpita Patnaik, Joanna Venator, Matthew Wiswall, Basit Zafar
...
【**摘要**】：在本文中，我们利用一组通过实验得出的面板数据估计了一个丰富的大学专业选择模型。我们的估计策略结合了两种类型的数据：关于潜在人力资本决策未来收入的自报信念数据，以及基于调查的风险和时间偏好度量。我们展示了如何利用这些数据来识别一个一般生命周期模型，允许丰富的异质性信念和偏好模式。我们的数据使我们能够将个人对风险或当前与未来回报的感知，与个人的风险偏好和耐心分离开来。将我们对一般模型的估计与忽略风险和时间偏好异质性的模型估计进行比较，我们发现这些受限模型可能夸大了收入对专业选择的重要性。此外，我们表明，虽然男性比女性更不厌恶风险且更缺乏耐心，但男性和女性在自身收入预期、风险厌恶和耐心方面的差异无法解释专业选择中的性别差距。

【**NBER**】: NBER Working Paper No. 26785，https://www.nber.org/papers/w26785

#### 30. Can Low Retirement Savings Be Rationalized? {#26784}

【**Author**】: Jason S. Scott, John B. Shoven, Sita N. Slavov, John G. Watson
...
【**摘要**】：生命周期模型的简单表述通常建议退休后实际消费水平保持不变。同样，理财规划师通常建议人们为退休储蓄，以便能够维持与工作时相同水平的退休生活标准。然而，消费随年龄保持不变只有在主观时间偏好率等于实际利率这一精确且不太可能的条件下才是最优的。大多数人表现出正的时间偏好率，并且还会因死亡率和发病率风险而对未来进行额外贴现。相比之下，实际利率大约为零，利率期限结构表明这种情况可能持续。这些考虑表明，生命周期模型中的最优消费随年龄增长而下降。这一发现对最优退休储蓄具有重大影响。例如，我们发现，对于许多（也许是大多数）处于终生收入分配下半部分的人来说，最优选择是在去世前花光退休财富，之后仅靠社会保障生活。收入非常低的人可能会发现完全不进行退休储蓄是最优的。

【**NBER**】: NBER Working Paper No. 26784，https://www.nber.org/papers/w26784

#### 31. The Cost of Convenience: Ridehailing and Traffic Fatalities {#26783}

【**Author**】: John M. Barrios, Yael Hochberg, Hanyi Yi

【**Abstract**】: We examine the effect of the introduction of ridehailing in U.S. cities on fatal traffic accidents. The arrival of ridehailing is associated with an increase of approximately 3% in the number of fatalities and fatal accidents, for both vehicle occupants and pedestrians. The effects persist when controlling for proxies for smartphone adoption patterns. Consistent with ridehailing increasing congestion and road usage, we find that introduction is associated with an increase in arterial vehicle miles traveled, excess gas consumption, and annual hours of delay in traffic. On the extensive margin, ridehailing’s arrival is also associated with an increase in new car registrations. These effects are higher in cities with prior higher use of public transportation and carpools, consistent with a substitution effect, and in larger cities. These effects persist over time. Back-of-the-envelope estimates of the annual cost in human lives range from $\$5.33$B to $\$13.24$B.

【**摘要**】：我们研究了美国城市引入网约车对致命交通事故的影响。网约车的出现与死亡人数和致命事故数量（包括车辆乘员和行人）增加约3%相关。在控制智能手机采用模式的代理变量后，这些影响仍然存在。与网约车增加拥堵和道路使用一致，我们发现网约车的引入与主干道车辆行驶里程增加、额外汽油消耗以及交通延误年小时数增加相关。在广泛边际上，网约车的出现也与新车注册量增加相关。这些影响在之前公共交通和拼车使用率较高的城市以及较大的城市中更高，这与替代效应一致。这些影响随时间持续存在。粗略估计的年度人类生命成本范围在53.3亿美元到132.4亿美元之间。

【**NBER**】: NBER Working Paper No. 26783，https://www.nber.org/papers/w26783

#### 32. Media Competition and News Diets {#26782}

【**Author**】: Charles Angelucci, Julia Cagé, Michael Sinkinson
...
【**摘要**】：内容分发方面的技术创新，例如广播电视或互联网的出现，威胁到地方报纸将其原创本地内容与第三方内容（如通讯社全国新闻）捆绑销售的能力。我们研究了电视的进入（最初侧重于全国新闻）如何影响美国的地方报纸以及消费者的新闻消费结构。我们建立了一个地方媒体模型，并表明全国电视新闻的进入可能会减少地方新闻的提供。我们构建了一个1944年至1964年美国报纸经济表现和内容选择的新数据集，并利用电视推广中的准随机变化来表明，这种新技术对报纸的读者市场和广告市场都造成了负面冲击。报纸的回应是提供更少的内容，尤其是地方新闻。我们将这种向日益全国化新闻消费结构的转变与国会和总统选举中分裂选票的减少联系起来。

【**NBER**】: NBER Working Paper No. 26782，https://www.nber.org/papers/w26782

#### 33. Votes For Women: An Economic Perspective on Women’s Enfranchisement {#26781}

【**Author**】: Carolyn Moehling, Melissa A. Thomasson
...
【**摘要**】：1920年批准的第十九修正案正式赋予美国女性投票权。然而，在联邦修正案之前，许多州已向女性授予了全部或部分选举权。本文从经济学视角探讨女性选举权的历史。我们考察需求侧，讨论女性运动的兴起及其与其他社会运动的联盟，并描述女权主义者如何向立法者施压。在供给侧，我们借鉴选举权扩展的理论模型来解释为何男性与女性分享投票权。最后，我们回顾了试图区分竞争性解释的实证研究。我们发现，没有单一理论能够解释美国的女性选举权，并指出尽管第十九修正案将选举权扩展至女性，但州级投票障碍限制了黑人女性行使该权利的能力，直到1965年《投票权法案》的通过。

【**NBER**】: NBER Working Paper No. 26781，https://www.nber.org/papers/w26781

#### 34. Cigarette Taxes and Teen Marijuana Use {#26780}

【**Author**】: D. Mark Anderson, Kyutaro Matsuzawa, Joseph J. Sabia
...
【**摘要**】：香烟税对青少年大麻使用的溢出效应一直是公众激烈辩论的主题。香烟税的反对者警告说，增税会导致青少年转向大麻。另一方面，公共卫生专家经常声称，由于烟草是一种“入门”毒品，更高的香烟税将阻止青少年使用大麻。利用1991-2017年期间全国和州级青少年风险行为调查的数据，我们探讨了州级香烟消费税与青少年大麻使用之间的关系。总体而言，我们的结果未能支持上述任何一种假设。相反，我们几乎没有发现证据表明青少年大麻使用对州香烟税的变化敏感。这一零结果在观察到香烟税对青少年吸烟影响最大的样本期内以及数据中的多个人口群体中均成立。最后，我们初步发现，近期州级电子烟税的采用与青少年大麻使用的减少有关。

【**NBER**】: NBER Working Paper No. 26780，https://www.nber.org/papers/w26780
...
【**摘要**】：酒后驾驶导致许多交通事故和死亡。两个密切相关的决策是：是否进行重度饮酒，以及在重度饮酒后是否驾驶。本文回顾了关于重度饮酒、成瘾以及酒后驾驶的广泛文献。相关的公共政策涉及威慑、限制能力和治疗的组合。虽然理性成瘾模型应用于重度饮酒得到了实证支持，但饮酒驾驶者的一些属性与其他人群不同（例如，在酒精消费以外的领域存在冲动性、双曲线贴现）。在减少酒后驾驶方面最有效的政策是酒精消费税、最低饮酒年龄和针对未成年人的零容忍法律、酒类销售场所和社会招待责任，以及整体刑事制裁。实证研究尚未确定哪些具体的刑事制裁最为有效。刑事制裁作为威慑的一个主要障碍是，酒后驾驶时被拦截/逮捕的概率极低，最多低于0.01至0.02，并且由于拦截/逮捕后的定罪/判刑概率远低于1，这一概率进一步降低。监禁期限往往过短，无法有效限制人们酒后驾驶。酒精治疗的有效性受到适合治疗人群低治疗率的限制。

【**NBER**】: NBER Working Paper No. 26779，https://www.nber.org/papers/w26779

#### 36. Forward Guidance and Household Expectations {#26778}

【**Author**】: Olivier Coibion, Dimitris Georgarakos, Yuriy Gorodnichenko, Michael Weber
...
【**摘要**】：我们在一项随机对照试验中，利用Nielsen Homescan面板中超过25,000名美国个体，比较了关于未来利率的前瞻指引沟通与关于未来通胀的沟通对家庭通胀、抵押贷款利率和失业预期的因果效应。我们引出个体的预期，然后提供22种关于过去、当前和/或未来通胀及利率的不同信息形式。关于当前和明年利率的信息处理对家庭预期有强烈影响，但超过一年的处理对预测没有任何额外影响。通胀预期的外生变化会传导至其他预期。我们调查的丰富性使我们能够更好地理解个体如何共同形成对宏观经济变量的预期，以及对长期前瞻指引的无反应与代理人收集和处理信息能力受限的模型一致。

【**NBER**】: NBER Working Paper No. 26778，https://www.nber.org/papers/w26778

#### 37. Anti-Bullying Laws and Suicidal Behaviors among Teenagers {#26777}

【**Author**】: Daniel I. Rees, Joseph J. Sabia, Gokhan Kumpas
...
【**摘要**】：美国疾病控制与预防中心报告称，欺凌与青少年自杀之间的关联已引发“担忧，甚至恐慌”，但旨在打击欺凌的政策很少受到研究者的关注。使用双重差分估计策略，我们发现州级反欺凌法减少了欺凌受害、抑郁和自杀意念，对女性青少年以及自认为是女同性恋、男同性恋、双性恋或性取向不确定的青少年估计效应最大。此外，反欺凌法与14至18岁女性青少年自杀率降低13-16%相关。事件研究分析和安慰剂检验提供了证据，表明这些估计可以解释为因果关系。

【**NBER**】: NBER Working Paper No. 26777，https://www.nber.org/papers/w26777
...
【**摘要**】：数字化导致了产品激增，给传统的产品发现机制带来了压力；但数字化也催生了基于大众的评级系统。我们比较了专业评论家和基于大众的亚马逊星级评分对图书出版中消费者福利的相对影响。我们收集了2018年数千本书的每日亚马逊销售排名、星级评分和价格数据，以及它们在几个主要媒体上的专业评论信息。使用各种固定效应和基于断点的实证策略，我们估计《纽约时报》的评论在评论发布后的前五天内使估计销售额增加78%；而销售对亚马逊星级的弹性约为0.75。我们利用这些因果估计来校准需求的结构模型，以衡量购买前信息对福利的影响，同时尊重事前和事后效用之间的区别。星级评分对消费者剩余的总影响大约是传统评论渠道影响的15倍。基于大众的信息现在占购买前信息的绝大部分，但专业评论的绝对影响并未随时间下降。

【**NBER**】: NBER Working Paper No. 26776，https://www.nber.org/papers/w26776
...
【**摘要**】：十年前，捐助者承诺投入15亿美元用于一项试点预先市场承诺，以帮助为低收入国家购买肺炎球菌疫苗。该预先市场承诺旨在鼓励此类疫苗的开发，确保向低收入国家儿童分发疫苗，并为未来可能的使用试点预先市场承诺机制。已有三种疫苗被开发出来，超过1.5亿儿童接种了疫苗，估计挽救了70万人的生命。本文回顾了预先市场承诺背后的经济逻辑、试点的经验以及未来预先市场承诺的关键问题。

【**NBER**】: NBER Working Paper No. 26775，https://www.nber.org/papers/w26775

#### 40. Does Race Matter for Police Use of Force? Evidence from 911 Calls {#26774}

【**Author**】: Mark Hoekstra, CarlyWill Sloan
...
【**摘要**】：尽管人们非常关注种族在警察使用武力中的作用，但识别因果效应是困难的。这部分是由于选择性问题，部分是由于研究者通常只观察到以使用武力告终的互动，这需要非平凡的基准假设。本文通过使用两个城市超过200万个911电话中派遣警员的数据来解决这些问题，这两个城市的派遣过程都不允许自由裁量权。使用地点-时间固定效应方法，该方法隔离了警员种族的随机变异，我们显示白人警员使用武力的频率比黑人警员高60%，使用枪支武力的频率高一倍。为了考察平民种族如何影响武力使用，我们比较了白人警员在派遣到更多少数族裔社区时武力使用的增加情况，与少数族裔警员相比。也许最引人注目的是，我们显示，虽然白人警员和黑人警员在白人和种族混合社区使用枪支武力的比率相似，但在以黑人为主的社区，白人警员使用枪支武力的可能性是前者的五倍。同样，当派遣到更多少数族裔社区时，白人警员使用任何武力的增加幅度远大于少数族裔警员。因此，来自个体警员固定效应模型的双重差分估计表明，与少数族裔警员以类似方式增加武力相比，黑人（西班牙裔）平民经历任何武力使用的可能性高出30-60%（75-120%），经历枪支武力使用的可能性高出五倍。这些发现突显了种族是警察使用武力的重要决定因素，包括尤其是致命武力。

【**NBER**】: NBER Working Paper No. 26774，https://www.nber.org/papers/w26774

#### 41. Beyond Basis Basics: Liquidity Demand and Deviations from the Law of One Price {#26773}

【**Author**】: Todd M. Hazelkorn, Tobias J. Moskowitz, Kaushik Vasudevan
...
【**摘要**】：我们认为，期货与现货价格之间的一价定律偏离（即基差）捕捉了全球股指期货市场中股票市场敞口流动性需求的重要信息。我们证明基差：(1) 与交易商和投资者的期货头寸共同变动；(2) 与现货和期货市场同期正相关且符号一致；(3) 负向预测期货和现货市场回报且符号一致。这些发现与我们的流动性需求模型唯一一致，并区别于其他对基差的解释，例如套利机会或中介资产负债表成本。我们显示，基差反映了对股指敞口的持续供需失衡，其中满足该敞口流动性需求的补偿是巨大的（年化溢价5-6%）。

【**NBER**】: NBER Working Paper No. 26773，https://www.nber.org/papers/w26773

#### 42. Confirmatory Bias in Health Decisions: Evidence from the MMR-Autism Controversy {#26772}

【**Author**】: Mengcen Qian, Shin-Yi Chou, Ernest K. Lai
...
【**摘要**】：自Wakefield等人（1998年）以来，公众接触到了关于麻疹-腮腺炎-风疹疫苗导致自闭症这一说法的混杂信息。1998年至2011年间，美国延迟接种疫苗的持续趋势主要由受过大学教育的母亲的孩子驱动，这表明这些母亲受到了早期无根据说法的影响，对疫苗持有偏见。与确认偏误一致，接触疫苗的负面信息强化了她们的偏见，其程度超过了正面信息削弱偏见的效果。然而，正面的在线信息对接种决策产生了强烈影响，这表明在线传播疫苗安全信息可能有助于应对顽固的错误信息。

【**NBER**】: NBER Working Paper No. 26772，https://www.nber.org/papers/w26772

#### 43. Information Acquisition, Efficiency, and Non-Fundamental Volatility {#26771}

【**Author**】: Benjamin M. Hébert, Jennifer La'O

【**Abstract**】: We analyze non-fundamental volatility and efficiency in large games featuring strategic interaction and endogenous information acquisition. We adopt the rational inattention approach to information acquisition but generalize to a large class of information costs. Agents can learn about exogenous states as well as endogenous aggregate actions. We study how properties of information costs relate to properties of equilibria. We provide necessary and sufficient conditions to guarantee zero non-fundamental volatility in equilibrium and another set of necessary and sufficient conditions to guarantee constrained efficient equilibria. Mutual information, the cost typically assumed in rational inattention models, precludes non-fundamental volatility and imposes efficiency.

【**摘要**】：我们分析了具有战略互动和内生化信息获取的大型博弈中的非基本面波动和效率。我们采用理性疏忽方法进行信息获取，但将其推广到一大类信息成本。代理人可以学习外生状态以及内生的总体行动。我们研究信息成本的性质如何与均衡的性质相关联。我们提供了保证均衡中非基本面波动为零的充分必要条件，以及另一组保证约束有效均衡的充分必要条件。互信息（理性疏忽模型中通常假设的成本）排除了非基本面波动并施加了效率。

【**NBER**】: NBER Working Paper No. 26771，https://www.nber.org/papers/w26771

#### 44. A Method to Construct Geographical Crosswalks with an Application to US Counties since 1790 {#26770}

【**Author**】: Fabian Eckert, Andrés Gvirtz, Jack Liang, Michael Peters
...
【**摘要**】：实证研究人员经常需要将按“报告”空间单元（例如1900年的县）提供的数据映射到“参考”空间单元（例如2010年的县）。我们讨论了一种创建此类交叉对照表的通用方法：计算每个报告单元嵌套在给定参考单元中的面积份额。利用这些份额，数据可以从报告单元重新汇总到参考单元。我们将该方法应用于构建自1790年以来美国县级数据到现今县或通勤区的交叉对照表。我们还提供了代码，以便在给定报告和参考单元地图的情况下生成其他交叉对照表。

【**NBER**】: NBER Working Paper No. 26770，https://www.nber.org/papers/w26770

#### 45. Medicaid Physician Fees and Access to Care among Children with Special Health Care Needs {#26769}

【**Author**】: Pinka Chatterji, Sandra Decker, Jason U. Huh
...
【**摘要**】：本研究的目的是利用全国特殊医疗需求儿童调查数据，检验医疗补助医生费用是否与特殊医疗需求儿童获得医疗服务的可及性及保险覆盖的充分性相关。我们采用双重差分方法，比较提高医生费用的州与未提高的州中公共保险儿童的结果。我们还使用私人保险儿童作为对照组，采用三重差分设定。我们的发现表明，将医疗补助初级保健费用水平提高到至少接近医疗保险水平的90%，可将公共保险特殊医疗需求儿童缺乏医生办公室常规护理来源的可能性降低约15%。费用增加还与公共保险特殊医疗需求儿童获得专科医生护理的可及性改善，以及护理人员对健康保险覆盖充分性满意度的显著提高相关。对于其他一些可及性指标，例如获得服务困难和延迟的总体指标，结果则不一。

【**NBER**】: NBER Working Paper No. 26769，https://www.nber.org/papers/w26769
...
【**摘要**】：我们回顾了关于不确定性冲击与商业周期研究的文献。首先，我们通过记录宏观经济时间序列波动性的时变性来激励对不确定性冲击的研究。其次，我们列举了研究者提出的将不确定性冲击与商业周期联系起来的机制。第三，我们概述了如何设定不确定性冲击。第四，我们提出了一个用金融摩擦和不确定性冲击增强的真实商业周期模型。第五，我们使用该模型来说明我们之前的讨论，并展示不确定性冲击如何具有扩张性。

【**NBER**】: NBER Working Paper No. 26768，https://www.nber.org/papers/w26768
...
【**摘要**】：2004年的《H-1B签证改革法案》规定每年分配85,000个签证，其中20,000个预留给高级学位申请人。我们将该立法的主要要求表示为形式化公理，并刻画了符合这些公理的签证分配规则。尽管预留了精确的数字，我们表明，满足这些公理的实施范围在平均每年可将高级学位签证的分配改变多达14,000个。在所有满足这些公理的规则中，2019年通过行政命令实施的规则对高级学位持有者最为有利。然而，两次更早的修改导致了更大的变化，这可能是无意的。

【**NBER**】: NBER Working Paper No. 26767，https://www.nber.org/papers/w26767
...
【**摘要**】：在过去30年中，公私合作伙伴关系已成为提供公共基础设施的一种新的组织形式。政府发现它们具有吸引力，因为PPP可用于规避财政制衡并增加支出。同时，PPP可以带来重要的效率提升，尤其是对于交通基础设施。这些提升包括更好的维护、降低官僚成本以及过滤白象项目。为了实现这些收益，有必要处理PPP的治理问题，这比公共提供基础设施的要求更高。通过使用具有适当风险分配的合同以及避免普遍存在的机会主义重新谈判，可以改善治理。好消息是，基于过去三十年PPP的经验，我们已经学会了如何应对这些挑战。

【**NBER**】: NBER Working Paper No. 26766，https://www.nber.org/papers/w26766

#### 49. Estimating Dynamic Games of Oligopolistic Competition: An Experimental Investigation {#26765}

【**Author**】: Tobias Salz, Emanuel Vespa
...
【**摘要**】：我们利用实验室数据评估动态寡头估计量。通过一个简化的进入/退出博弈，我们在假设数据由马尔可夫完美均衡（MPE）生成的前提下估计结构参数，并利用这些估计预测反事实行为。担忧在于，如果马尔可夫假设被违反，反事实结果将被错误预测。实验方法使我们能够将反事实的预测行为与作为处理实施的真实反事实进行比较。我们的主要发现是，在大多数情况下，由合谋导致的反事实预测误差规模仅属适度。

【**NBER**】: NBER Working Paper No. 26765，https://www.nber.org/papers/w26765

#### 50. Long-run Trends in the U.S. SES-Achievement Gap {#26764}

【**Author**】: Eric A. Hanushek, Jacob D. Light, Paul E. Peterson, Laura M. Talpey, Ludger Woessmann
...
【**摘要**】：美国日益加剧的不平等引发了人们对社会经济地位（SES）造成的教育成就差距可能扩大的担忧。利用心理测量学上随时间关联的LTT-NAEP、Main-NAEP、TIMSS和PISA评估数据，我们追踪了1961年至2001年间出生的美国学生群体在成就上的SES差距趋势。在此期间，SES分布顶部和底部四分位数之间在数学、阅读和科学成就上的差距每十年缩小了0.05个标准差。这一发现与SES的替代衡量指标和可用测试子集的结果一致，并且在近期仍然成立。按照目前的缩小速度，成就差距要到22世纪下半叶才能消除。

【**NBER**】: NBER Working Paper No. 26764，https://www.nber.org/papers/w26764

#### 51. Were Jews in Interwar Poland More Educated? {#26763}

【**Author**】: Ran Abramitzky, Hanna Halaburda
...
【**摘要**】：在两次世界大战期间波兰的背景下，我们发现犹太人往往比非犹太人识字率更高，但表明这一发现是由构成效应驱动的。具体而言，大多数犹太人居住在城市，而大多数非犹太人居住在农村地区，无论其宗教信仰如何，城市居民的教育程度都高于乡村居民。两次世界大战期间波兰的案例说明，犹太人的相对教育优势取决于历史和制度背景。

【**NBER**】: NBER Working Paper No. 26763，https://www.nber.org/papers/w26763
...
【**摘要**】：全球越来越多的公司在多个国家运营。我们研究了跨国公司在其公司财务决策中的成本与收益，并综述了相关学术证据。我们记录到，在美国上市公司中，使用基于收入和基于销售额的分类标准，跨国公司的普遍程度与国内公司大致相同。在美国以外，这一比例较低但一直在增长。跨国公司面临超出国内公司所面临的额外风险，这些风险来自政治因素和汇率。然而，它们可能受益于现金流多样化和资本来源的灵活性。我们表明，跨国公司确实比其他方面相同的国内公司拥有更好的外国资本市场准入和更低的债务成本，但关于股权成本的证据则好坏参半。

【**NBER**】: NBER Working Paper No. 26762，https://www.nber.org/papers/w26762

#### 53. Partial Identification and Inference for Dynamic Models and Counterfactuals {#26761}

【**Author**】: Myrto Kalouptsidi, Yuichi Kitamura, Lucas Lima, Eduardo A. Souza-Rodrigues
...
【**摘要**】：我们提供了一个通用框架，用于研究结构动态离散选择模型及其反事实的部分识别，以及一致有效的推断程序。在此过程中，我们推导出模型参数、反事实行为以及感兴趣的低维结果（例如假设政策干预的平均福利效应）的尖锐边界。我们分析性地刻画了这些集合的性质，并表明当感兴趣的目标结果是标量时，其识别集是一个区间，其端点可以通过标准算法求解良好约束的优化问题来计算。我们通过适当应用子抽样获得一致有效的推断程序。为了说明该方法的性能和计算可行性，我们考虑了企业进入/退出的蒙特卡洛研究，以及一个应用于哥伦比亚制造业工厂层面数据的出口决策实证模型。在这些应用中，我们展示了随着纳入替代模型约束，识别集如何收缩，从而提供了关于识别来源和强度的直觉。

【**NBER**】: NBER Working Paper No. 26761，https://www.nber.org/papers/w26761
...
【**摘要**】：在其诞生二十周年之际，欧元尚未扩大其作为国际货币的作用。我们通过一系列指标记录了这一事实，包括其在汇率安排中作为锚定或参考的作用——我们认为这是一个综合衡量指标——以及作为贸易和资产计价货币的作用。在所有维度上，欧元的份额都远低于美元。此外，自1999年以来，这一份额大致保持不变。根据某些衡量标准，欧元的作用并不比它所取代的德国马克和法国法郎更大。我们探讨了这种表现不佳的原因。虽然领先的锚定货币可能具有自然垄断地位，但许多额外因素限制了欧元的覆盖范围，包括缺乏金融中心、有限的地缘政治影响力以及美国和中国在技术研究中的主导地位。我们认为，最重要的是（安全）欧元计价资产的相对稀缺供应，我们对此进行了记录。欧洲央行缺乏政策清晰度也可能起到了一定作用。我们表明，欧元时代可以分为“德国央行+”时期和“不惜一切代价”时期。第一个时期显示了从欧洲汇率机制的平稳过渡，并继续稳定了德国的通货膨胀。第二个时期的特点是欧洲央行向欧洲银行和主权国家提供的信贷便利工具不断扩展。

【**NBER**】: NBER Working Paper No. 26760，https://www.nber.org/papers/w26760

#### 55. School Effects on Socio-emotional Development, School-Based Arrests, and Educational Attainment {#26759}

【**Author**】: C. Kirabo Jackson, Shanette C. Porter, John Q. Easton, Alyssa Blanchard, Sebastián Kiguel
...
【**摘要**】：使用增值模型，我们发现高中通过增强社会福祉和促进勤奋工作来影响学生自我报告的社会情感发展（SED）。在控制学校的考试成绩影响后，改善SED的学校减少了校内逮捕，并提高了高中毕业率、大学入学率和大学持续就读率。改善社会福祉的学校对高中阶段的出勤率和行为违规有更大的影响，而促进勤奋工作的学校对GPA有更大的影响。重要的是，学校SED增值比学校考试成绩增值更能预测学校对长期结果的影响。因此，对于长期结果，同时使用SED和考试成绩增值所解释的学校效应方差是仅使用考试成绩增值的两倍以上。结果表明，青春期可以成为社会情感成长的形成期，高中对SED的影响可以通过自我报告调查来捕捉，并且学校可以培养SED以改善长期结果。这些发现对于合理形式的选择性检验是稳健的。

【**NBER**】: NBER Working Paper No. 26759，https://www.nber.org/papers/w26759

#### 56. Effects of Scaling Up Private School Choice Programs on Public School Students {#26758}

【**Author**】: David N. Figlio, Cassandra M.D. Hart, Krzysztof Karbownik
...
【**摘要**】：利用一个将学生层面的学校记录与出生记录相结合、并采用学生固定效应设计的丰富数据集，我们探讨了佛罗里达州一个私立学校选择项目的大规模推广如何影响公立学校学生的结果。该项目的扩展为那些在引入代金券项目之前初始私立学校选择程度较大（以该指标衡量）的公立学校的学生带来了适度更大的益处。这些益处包括更高的标准化考试成绩以及更低的缺勤率和停学率。对于低收入学生，影响尤为显著，但对较富裕的学生也有积极结果。

【**NBER**】: NBER Working Paper No. 26758，https://www.nber.org/papers/w26758

#### 57. Social Groups and the Effectiveness of Protests {#26757}

【**Author**】: Marco Battaglini, Rebecca B. Morton, Eleonora Patacchini
...
【**摘要**】：我们提出了一个关于公众抗议的信息理论，根据该理论，公众抗议允许公民汇总私下分散的信息，并将其信号传递给政策制定者。该模型预测，当社会群体足够大时，群体内部的信息共享可以促进信息汇总，即使个体信号无法实现这一点。我们通过实验室实验和亚马逊土耳其机器人实验来检验这些预测。我们发现，社会群体中的信息共享显著影响公民的抗议决策，并因此缓解了高度冲突的影响，从而提高了政策制定者选择的效率。我们的实验强调，社交媒体在抗议中可能发挥重要作用，而不仅仅是公民协调行动的一种方式；事实上，公众抗议背后的信息汇总和协调动机是紧密相连的，在概念上无法分离。

【**NBER**】: NBER Working Paper No. 26757，https://www.nber.org/papers/w26757

#### 58. The Limits of onetary Economics: On Money as a Latent Medium of Exchange {#26756}

【**Author**】: Ricardo Lagos, Shengxing Zhang

【**Abstract**】: We formulate a generalization of the traditional medium-of-exchange function of money in contexts where there is imperfect competition in the intermediation of credit, settlement, or payment services used to conduct transactions. We ﬁnd that the option to settle transactions with money strengthens the stance of sellers of goods and services vis-à-vis intermediaries, and show this mechanism is operative even for sellers who never exercise the option to sell for cash. These latent money demand considerations imply that in general, in contrast to current conventional wisdom in policy-oriented research in monetary economics, monetary policy remains eﬀective through medium-of-exchange transmission channels—even in highly developed credit economies where the share of monetary transactions is negligible.

【**摘要**】：我们在信贷、结算或支付服务中介存在不完全竞争的交易环境中，对货币的传统交换媒介功能进行了概括。我们发现，用货币结算交易的选择增强了商品和服务卖方相对于中介机构的地位，并表明即使对于从未行使过现金销售选择权的卖方，这一机制也起作用。这些潜在的货币需求考虑意味着，总体而言，与当前货币政策导向研究中货币经济学的传统观点相反，货币政策通过交换媒介传导渠道仍然有效——即使在货币交易份额微不足道的高度发达的信用经济中也是如此。

【**NBER**】: NBER Working Paper No. 26756，https://www.nber.org/papers/w26756

#### 59. Can Investors Time Their Exposure to Private Equity? {#26755}

【**Author**】: Gregory Brown, Robert S. Harris, Wendy Hu, Tim Jenkinson, Steven N. Kaplan, David T. Robinson
...
【**摘要**】：私募股权（包括收购和风险投资）的业绩具有高度周期性：高募资期之后往往伴随着低业绩期。尽管存在这种看似可预测的波动，我们发现，追求现实且可投资的策略来把握私募股权资本承诺的时机，最多只能带来适度的收益。这在一定程度上是因为投资者只能把握对基金的承诺时机；他们无法把握资本被调用或投资退出的时机。即使在不同时期以截然不同的方式配置资本的承诺策略之间，净现金流也存在高度的时间序列相关性。

【**NBER**】: NBER Working Paper No. 26755，https://www.nber.org/papers/w26755

#### 60. Historical Natural Experiments: Bridging Economics and Economic History {#26754}

【**Author**】: Davide Cantoni, Noam Yuchtman
...
【**摘要**】：历史自然实验的分析深刻影响了经济学各领域的研究。我们追溯了该方法的发展及其日益广泛的应用，既从经济史学家的角度，也从其他子学科经济学家的角度。我们认为，历史自然实验代表了经济史与其他领域之间的方法论桥梁：历史学家能够利用应用微观经济学家强调的前沿识别策略；各领域的经济学家能够从历史中寻找有用的识别变异；发展经济学家和增长经济学家能够追溯当代结果的历史根源。领域的差异表明学者研究历史自然实验的目的不同。我们提出了一个分类法，包含反映不同领域优先级的三种主要动机：历史学家旨在理解特定背景下的因果过程。各领域的经济学家旨在识别“干净的”历史事件（无论何种背景），以检验理论感兴趣的假设或估计因果参数。增长和发展经济学家旨在识别能够与感兴趣的当代结果建立因果联系的过去变异。我们总结了每一类研究的重要贡献。最后，我们简要讨论了每类工作面临的挑战。

【**NBER**】: NBER Working Paper No. 26754，https://www.nber.org/papers/w26754

#### 61. Central Bank Digital Currency: Central Banking For All? {#26753}

【**Author**】: Jesús Fernández-Villaverde, Daniel Sanches, Linda Schilling, Harald Uhlig
...
【**摘要**】：引入央行数字货币允许中央银行通过与私人金融中介机构竞争存款来从事大规模中介活动。然而，由于中央银行并非投资专家，它本身无法投资于长期项目，而是依赖投资银行来这样做。我们推导出一个等价性结果，表明在没有银行恐慌的情况下，通过私人金融中介实现的配置集合也将通过央行数字货币实现。然而，在恐慌期间，我们表明中央银行与投资银行合同的刚性有能力阻止挤兑。因此，中央银行比商业银行部门更稳定。存款人事前内化了这一特征，中央银行成为存款垄断者，从商业银行部门吸引所有存款。这种垄断可能危及期限转换。

【**NBER**】: NBER Working Paper No. 26753，https://www.nber.org/papers/w26753

#### 62. Stagnation and Scientific Incentives {#26752}

【**Author**】: Jay Bhattacharya, Mikko Packalen
...
【**摘要**】：新思想不再像过去那样推动经济增长。对停滞的一种流行解释是，好想法更难找到，使得放缓不可避免。我们提出了一个科学思想生命周期的简单模型，指出科学家激励的变化是科学停滞的原因。在过去的五十年里，引用已成为评估科学贡献和科学家的主要方式。这种在衡量科学生产力时对引用的强调，在边际上改变了科学家的奖励和行为，使其转向渐进式科学，远离那些更可能失败但却是未来突破动力的探索性项目。随着对新思想的关注减少，科学停滞了。我们还探讨了如何拓宽衡量和奖励科学生产力的方式，涉及学术搜索引擎（如谷歌学术）衡量哪些贡献探索了更新颖的思想，以及大学管理人员和资助机构在研究评估中利用这些新指标。我们实证表明，新颖性度量与科学影响力度量相关但不同，这表明如果在科学家评估中也使用新颖性指标，科学家可能会追求更具创新性、风险更高的项目。

【**NBER**】: NBER Working Paper No. 26752，https://www.nber.org/papers/w26752

#### 63. Drug Firms' Payments and Physicians' Prescribing Behavior in Medicare Part D {#26751}

【**Author**】: Colleen Carey, Ethan M.J. Lieber, Sarah Miller
...
【**摘要**】：在一个普遍但有争议的实践中，药品公司在推广处方药时经常向医生进行金钱或实物支付。我们使用一个联邦数据库，该数据库包含2013年至2015年间此类支付的全部记录，并与医疗保险D部分的处方行为相关联。我们通过每个医生-药物组合的固定效应来解释支付的目标定位。在一项事件研究中，我们表明，医生在收到支付后的几个月内，会增加对其收到支付的药物的处方量，而在支付之前，受支付和未受支付的医生之间没有差异趋势的证据。接下来，我们考察了五种主要药物专利到期的案例研究。经历专利到期的公司向医生支付款项，这些医生将患者转向仿制药的速度与未收到此类支付的医生一样快。此外，利用手工收集的三个主要治疗类别的疗效数据，我们表明药物质量基本上不受收到支付的影响。

【**NBER**】: NBER Working Paper No. 26751，https://www.nber.org/papers/w26751
...
【**摘要**】：本文使用模拟来探索Hodrick和Prescott（1997）的HP滤波器、Baxter和King（1999）的BK滤波器以及Hamilton（2018）的H滤波器的性质，这些滤波器旨在将单变量时间序列分解为趋势和周期成分。每个模拟时间序列近似于美国实际GDP的自然对数，它们分别是随机游走、ARIMA模型、两个不可观测成分模型，以及具有缓慢变化的非平稳随机趋势和明确周期成分的模型。在基本时间序列中，H滤波器在更准确地刻画基础框架方面优于HP和BK滤波器，但在更复杂的模型中，情况则相反。

【**NBER**】: NBER Working Paper No. 26750，https://www.nber.org/papers/w26750

#### 65. Effect of Prescription Opioids and Prescription Opioid Control Policies on Infant Health {#26749}

【**Author**】: Engy Ziedan, Robert Kaestner
...
【**摘要**】：育龄女性和孕妇使用处方阿片类药物的情况相对普遍。本文考察了各州阿片类药物管控政策是否影响了处方阿片类药物的使用，进而影响了婴儿健康和母亲行为。我们进行了多种类型的分析，包括州政策对婴儿健康和母亲行为影响的简化形式分析，以及处方阿片类药物使用对婴儿健康和母亲行为影响的工具变量分析。分析结果表明，由于各州处方阿片类药物管控政策导致的处方阿片类药物使用减少，在人口层面上适度改善了婴儿健康，而在个体层面上则暗示了更大的影响。

【**NBER**】: NBER Working Paper No. 26749，https://www.nber.org/papers/w26749
...
【**摘要**】：我们分析了学生大学分配方式的变化将如何影响美国大学间按父母收入划分的隔离程度以及代际流动性。为此，我们将来自税务记录的每所大学学生父母收入和学生收入结果的数据，与学生的SAT和ACT成绩数据进行了关联。我们发现，在控制考试成绩的条件下，使不同父母收入群体的申请、录取和入学率均等化，将大幅减少隔离，这主要通过增加中产阶级学生在更具选择性的大学中的代表性来实现。然而，这对精英私立大学中低收入学生的比例影响甚微，因为来自低收入家庭且拥有足够高SAT/ACT分数的学生相对较少。大学间父母收入分布的差异可以通过在申请和录取过程中给予中低收入学生类似于精英私立大学隐性给予校友子女的滑动比例偏好来消除。假设学生收入结果中80%的观测差异（在控制考试成绩、种族和父母收入后）归因于大学的因果效应——这是一个强有力的假设，但与先前研究一致——那么此类变化可使大学生中的代际收入持续性降低约25%。我们得出结论，即使不改变大学的教育项目，改变学生进入大学的分配方式也能大幅减少隔离并增加代际流动性。

【**NBER**】: NBER Working Paper No. 26748，https://www.nber.org/papers/w26748

#### 67. College Attainment, Income Inequality, and Economic Security: A Simulation Exercise {#26747}

【**Author**】: Brad Hershbein, Melissa Schettini Kearney, Luke W. Pardue
...
【**摘要**】：我们进行了一项实证模拟练习，评估提高大学学历获得率对各种收入不平等和经济不安全指标的可能影响。使用两种不同的方法论——分布法和因果参数法——我们发现，提高学士和副学士学位的获得率将显著增加低收入个体的经济安全，减少贫困和接近贫困的状况，并缩小收入分布第90百分位数与较低百分位数之间的差距。然而，大学学历获得的增加不会显著减少收入分布最顶端的极端不平等。

【**NBER**】: NBER Working Paper No. 26747，https://www.nber.org/papers/w26747

#### 68. The Economic Consequences of Increasing Sleep Among the Urban Poor {#26746}

【**Author**】: Pedro Bessone, Gautam Rao, Frank Schilbach, Heather Schofield, Mattie Toma
...
【**摘要**】：发展中国家的城市贫困人口面临充满挑战的生活环境，这可能会干扰良好的睡眠。通过使用体动记录仪客观测量睡眠，我们发现印度金奈的低收入成年人尽管在床上度过8小时，但平均每晚仅睡5.5小时。他们的睡眠高度中断，睡眠效率（即卧床时间中的实际睡眠时间）与患有睡眠呼吸暂停或失眠等疾病的人相当。一项为期三周的随机干预提供了信息、鼓励以及对家庭睡眠环境的改善，通过促使人们增加卧床时间，使每晚睡眠时长增加了27分钟。与专家预测和大量睡眠研究相反，增加夜间睡眠对认知、生产力、决策或幸福感没有可检测到的影响，并导致劳动力供给小幅下降。相比之下，工作场所的短暂午间小睡使结果总体指数提高了0.12个标准差，生产力、心理健康和认知能力显著提高，但工作时间有所减少。

【**NBER**】: NBER Working Paper No. 26746，https://www.nber.org/papers/w26746
...
【**摘要**】：我构建了一个具有粘性价格和利率目标的简单模型，该模型通过包含长期债务以及财政和货币政策规则的物价水平财政理论来闭合。财政盈余在赤字之后增加，以偿还累积的债务，但盈余并不对所有意外通胀和通缩的值做出反应。这种设定避免了常见的难题，并对财政和货币政策冲击产生了合理的反应。它允许对任何新凯恩斯模型进行简单转换，并允许在积极财政政策下研究整个样本。

【**NBER**】: NBER Working Paper No. 26745，https://www.nber.org/papers/w26745

#### 70. Identity Verification Standards in Welfare Programs: Experimental Evidence from India {#26744}

【**Author**】: Karthik Muralidharan, Paul Niehaus, Sandip Sukhtankar

【**Abstract**】: We evaluate reforms that integrated more stringent, biometric ID requirements into India’s largest social protection program, using large-scale randomized and natural experiments. Corruption fell but with substantial costs to legitimate beneﬁciaries, 1.5-2 million of whom lost access to beneﬁts at some point during the reforms. Adverse eﬀects appear to have been driven primarily by decisions about the way the transition was managed, illustrating both the risks of rapid reforms, and how the impacts of promising new technologies can be highly sensitive to the protocols governing their use.

【**摘要**】：我们利用大规模随机和自然实验，评估了将更严格、基于生物识别的身份识别要求整合到印度最大的社会保障项目中的改革。腐败有所减少，但合法受益人付出了巨大代价，其中150万至200万人在改革期间的某个时间点失去了福利获取权。不利影响似乎主要是由过渡管理方式决策所驱动的，这既说明了快速改革的风险，也说明了有前景的新技术的影响如何高度依赖于管理其使用的协议。

【**NBER**】: NBER Working Paper No. 26744，https://www.nber.org/papers/w26744

#### 71. Neighborhood-Based Information Costs {#26743}

【**Author**】: Benjamin M. Hébert, Michael Woodford
...
【**摘要**】：我们从理性疏忽问题中推导出一种新的信息成本，即基于邻域的成本函数，其出发点是观察到许多设定涉及具有拓扑结构的外生状态。这些成本函数是均匀后验可分的，并捕捉了感知距离的概念。这第二个性质确保了基于邻域的成本（与互信息不同）能在感知实验中做出关于行为的准确预测。我们在一系列应用中比较了基于邻域的成本函数与互信息的含义：感知判断；一般二元选择环境；政权更迭博弈；以及线性二次高斯设定。

【**NBER**】: NBER Working Paper No. 26743，https://www.nber.org/papers/w26743
...
【**摘要**】：关于移民同化和代际进步的文献有时会得出令人惊讶的结论，例如移民优势之谜，该谜题发现西班牙裔移民有时比美国出生的西班牙裔人更健康。尽管许多研究试图解释这些模式，但几乎所有研究都依赖主观的民族自我认同指标来识别移民的后代。这可能导致因“民族流失”而产生的偏差，即每当美国出生的西班牙裔移民后代未能自我认同为西班牙裔时就会发生。在本文中，我们利用父母和祖父母出生地的信息表明，通过通婚起作用的墨西哥民族流失规模可观且对健康具有选择性，这使得后续几代墨西哥移民看起来比实际更不健康。因此，关于墨西哥裔美国人与非西班牙裔白人之间，以及墨西哥裔美国人与近期墨西哥移民之间健康差异的传统估计被显著夸大了。

【**NBER**】: NBER Working Paper No. 26742，https://www.nber.org/papers/w26742

#### 73. Gains from Trade: Does Sectoral Heterogeneity Matter? {#26741}

【**Author**】: Rahul Giri, Kei-Mu Yi, Hakan Yilmazkuday
...
【**摘要**】：本文评估了在计算贸易收益时纳入部门异质性的定量重要性。我们的框架借鉴了Caliendo和Parro（2015）的研究，并在五个维度上引入了部门异质性，包括贸易成本对贸易的弹性。我们使用Simonovska和Waugh（2014）的模拟矩估计方法和微观价格数据来估计部门贸易弹性。我们的估计值范围从2.97到8.94。我们的基准模型校准了21个OECD国家和20个部门。我们每次移除一个或两个部门异质性来源，并将贸易收益与基准模型进行比较。我们还将具有单一弹性的加总模型与基准模型进行比较。这些反事实实验的主要结果是，部门异质性并不总是导致贸易收益的增加，这与理论一致。

【**NBER**】: NBER Working Paper No. 26741，https://www.nber.org/papers/w26741

#### 74. Inflation and the Price of Real Assets {#26740}

【**Author**】: Matteo Leombroni, Monika Piazzesi, Martin Schneider, Ciaran Rogers
...
【**摘要**】：在20世纪70年代，美国资产市场经历了（i）家庭总财富与GDP之比下降25%，以及（ii）房屋和股票价格的负向联动，导致投资组合从股票向房地产转移了20%。本研究使用一个包含不可保险名义风险的世代交叠模型，来量化结构性变化在这些事件中的作用。我们将财富下降归因于婴儿潮一代进入资产市场，以及意外通货膨胀侵蚀了债券投资组合，这两者都降低了总体储蓄倾向。我们还表明，大通胀通过使住房比股票更具吸引力，导致了投资组合的转移。不同年龄组之间对通货膨胀的分歧，对税收效应的大小、名义信贷的规模以及住房作为抵押品的价格都有重要影响。

【**NBER**】: NBER Working Paper No. 26740，https://www.nber.org/papers/w26740

#### 75. Technological Innovation and Discrimination in Household Finance {#26739}

【**Author**】: Adair Morse, Karen Pence
...
【**摘要**】：技术改变了歧视在金融服务中的表现形式。在决策角色中用算法取代人类判断，减少了基于偏好的歧视，而新的建模技术扩大了此前被排除在这些市场之外的家庭获得金融服务的机会。然而，算法可能因人类参与开发过程而表现出偏见，并且其不透明性和复杂性可能在金融服务的多个方面（包括广告、定价和信用风险评估）促进与反歧视法律不一致的统计歧视。在本章中，我们对这些发展进行了新的整合与分析，识别出技术导致歧视渗入金融服务的五个途径。我们还考虑了金融领域的这些技术变革如何与现有的歧视和数据隐私法律相交织，从而提出了四个监管前沿。我们的分析得出结论，技术金融创新对歧视的净效应是不确定的，取决于政策制定者、法院和公司未来的选择。

【**NBER**】: NBER Working Paper No. 26739，https://www.nber.org/papers/w26739

#### 76. Competing with Robots: Firm-Level Evidence from France {#26738}

【**Author**】: Daron Acemoglu, Claire LeLarge, Pascual Restrepo
...
【**摘要**】：利用多个来源，我们构建了一个法国制造业企业购买机器人的数据集，并研究了机器人采用的企业层面影响。在我们的样本中，55,390家企业中有598家在2010年至2015年间采用了机器人，但这些企业占制造业就业和增加值的20%。与理论一致，机器人采用者的劳动份额和就业中生产工人的份额显著下降，而增加值和生产率则有所提高。它们的总体就业也扩大了。然而，这种扩张是以牺牲其竞争对手为代价的（因为自动化降低了它们的相对成本）。我们表明，机器人采用对行业就业的总体影响是负面的。我们进一步证明，机器人对总体劳动份额的影响大于其企业层面的效应，因为机器人采用者比其竞争对手规模更大且增长更快。

【**NBER**】: NBER Working Paper No. 26738，https://www.nber.org/papers/w26738

#### 77. The Effects of Prize Structures on Innovative Performance {#26737}

【**Author**】: Joshua Graff Zivin, Elizabeth Lyons
...
【**摘要**】：成功的创新对于组织的生存和增长至关重要，但如何最好地激励创新却知之甚少。我们在一家大型生命科学公司合作的现场实验中，比较了两种常见的激励方案如何影响创新绩效。我们发现，与提供相同总报酬但分配给前十名最佳创新的报酬方案相比，赢家通吃的报酬方案能产生显著更多的新颖创新。此外，我们发现，对于团队创新者而言，创造力对报酬方案的弹性远大于个人创新者。

【**NBER**】: NBER Working Paper No. 26737，https://www.nber.org/papers/w26737

#### 78. Simplifying and Improving the Performance of Risk Adjustment Systems {#26736}

【**Author**】: Thomas G. McGuire, Anna L. Zink, Sherri Rose
...
【**摘要**】：用于支付个人健康保险市场中健康计划的风险调整系统，已朝着在个人和群体层面更好地“拟合”支付与计划支出的方向发展，这通常通过增加用于风险调整的变量来实现。增加变量需要计划和提供者提供更多数据。在更复杂的系统中要求的一些数据可能容易被提供者操纵，导致无意的“向上编码”或不必要的服务利用。虽然这些缺点已被认识到，但它们难以量化，并且难以与通过向公式中添加变量可能获得的具体、可衡量的拟合改进相平衡。本文采用了一种不同的方法来改进健康计划支付系统的绩效。以市场中的HHS-HHC V0519计划支付模型为起点，我们在减少模型所需变量数量的同时，将个人和群体层面的拟合约束为与当前支付模型一样好或更好。通过引入计划支付设计中的三个要素，创造了简化的机会：再保险（基于高支出或计划损失）、约束回归以及用于变量选择的强大机器学习方法。我们首先删除所有依赖药品索赔的变量。通过将机器学习与我们的约束回归相结合，可以进一步大幅减少基于诊断的风险调整因子的数量。我们更简单替代方案的拟合绩效与当前的HHS-HHC V0519公式一样好或更好。

【**NBER**】: NBER Working Paper No. 26736，https://www.nber.org/papers/w26736

#### 79. Physician Health Management Skills and Patient Outcomes {#26735}

【**Author**】: Emilia Simeonova, Niels Skipper, Peter R. Thingholm
...
【**摘要**】：影响健康和寿命的因素多种多样，从基因禀赋到公共政策。医生对患者的健康和健康相关成本有重大影响，但除了充分诊断和治疗等临床决策之外，我们对这种影响的程度知之甚少。本文证明，初级保健医生的健康管理风格显著影响其患者的健康结果。利用丹麦他汀类药物使用者的总体数据，并将患者与其初级保健医生进行匹配，我们表明，即使在控制了可观察和不可观察的患者特征之后，医生促进患者遵守处方药物的能力对患者结果和健康成本也有显著的积极影响。旨在改善医生健康管理风格这一方面的政策干预，对患者结果和医疗保健成本具有重要影响。

【**NBER**】: NBER Working Paper No. 26735，https://www.nber.org/papers/w26735

#### 80. Correlation Neglect in Student-to-School Matching {#26734}

【**Author**】: Alex Rees-Jones, Ran Shorrer, Chloe J. Tergiman

【**Abstract**】: We present results from experiments containing incentivized school-choice scenarios. In these scenarios, we vary whether schools’ assessments of students are based on a common priority (inducing correlation in admissions decisions) or are based on independent assessments (eliminating correlation in admissions decisions). The quality of students’ application strategies declines in the presence of correlated admissions: application strategies become substantially more aggressive and fail to include attractive “safety” options. We provide a battery of tests suggesting that this phenomenon is at least partially driven by correlation neglect, and we discuss implications for the design and deployment of student-to-school matching mechanisms.

【**摘要**】：我们展示了包含激励性择校情景的实验结果。在这些情景中，我们改变了学校对学生评估的依据：是基于共同优先级（导致录取决策中的相关性）还是基于独立评估（消除录取决策中的相关性）。在存在相关录取的情况下，学生申请策略的质量会下降：申请策略变得明显更具攻击性，并且未能包含有吸引力的“安全”选项。我们提供了一系列检验，表明这种现象至少部分是由相关性忽视驱动的，并讨论了这对学生-学校匹配机制的设计和部署的启示。

【**NBER**】: NBER Working Paper No. 26734，https://www.nber.org/papers/w26734

#### 81. The Allocation of Authority in Organizations: A Field Experiment with Bureaucrats {#26733}

【**Author**】: Oriana Bandiera, Michael Carlos Best, Adnan Qadir Khan, Andrea Prat
...
【**摘要**】：我们设计了一项实地实验，研究一线采购官员与其监督者之间的权力分配如何直接影响绩效，以及如何通过激励响应间接影响绩效。我们与巴基斯坦旁遮普省政府合作，在26个地区的600名采购官员样本中，将权力从监督者转移给采购官员，并引入财务激励。我们发现，仅自主权一项就能在不降低质量的情况下将价格降低9%，并且当监督者倾向于将采购审批延迟到财政年度末时，这种效应更强。相比之下，绩效薪酬的效果较弱，除非代理人面对的是不延迟审批的监督者。时间使用数据显示，代理人的反应在同一维度上有所不同：自主权增加了用于采购的时间，而这仅在监督者造成延迟时才导致价格降低。相反，当监督者不造成延迟时，激励措施才有效。这些结果表明，组织设计和反腐败政策必须平衡不同层级中的代理问题。

【**NBER**】: NBER Working Paper No. 26733，https://www.nber.org/papers/w26733

#### 82. Not Playing Favorites: An Experiment on Parental Fairness Preferences {#26732}

【**Author**】: James Berry, Rebecca Dizon-Ross, Maulik Jagnani
...
【**摘要**】：我们进行了一项实验室实地实验，以识别父母在投资子女方面的偏好。该实验外生地改变了教育投资的短期回报，以确定父母在多大程度上关心最大化家庭总收入、最小化兄弟姐妹间“结果”（子女层面的收入）的不平等，以及最小化兄弟姐妹间“投入”（子女层面的投资）的不平等。我们发现，虽然父母在一定程度上重视收入最大化，但他们也表现出对投入平等的强烈偏好，愿意放弃大约40%的潜在收入或一天工资的90%来实现投入平等。我们没有发现证据表明父母关心结果平等化。

【**NBER**】: NBER Working Paper No. 26732，https://www.nber.org/papers/w26732
...
【**摘要**】：全球化和机器人技术（全球机器人）正以爆炸性的速度改变世界经济。虽然大部分文献关注富裕国家，但这些变化很可能以重要方式影响发展中国家。本文的前提——应被视为一篇思想性文章——基于一个极端的思维实验。当数字技术使制造业无就业且许多服务可自由贸易时，发展会是什么样子？我们的结论是，服务主导的发展路径可能成为常态而非例外；想想印度，而不是中国。由于服务业的成功基于与制造业截然不同的因素，发展战略和思维方式可能必须改变。这是一个乐观的结论，因为它表明发展中国家可以直接出口其比较优势的来源——低成本劳动力——而无需先用这些劳动力制造商品。

【**NBER**】: NBER Working Paper No. 26731，https://www.nber.org/papers/w26731

#### 84. Decentralized Targeting of Agricultural Credit Programs: Private versus Political Intermediaries {#26730}

【**Author**】: Pushkar Maitra, Sandip Mitra, Dilip Mookherjee, Sujata Visaria
...
【**摘要**】：我们比较了两种任命当地佣金代理人作为信贷项目中介的不同方法。在“贸易商-代理中介贷款计划”（TRAIL）中，代理人是随机选择的、已建立的私人贸易商；而在“村务委员会-代理中介贷款计划”（GRAIL）中，代理人是从当选村务委员会提名的候选人中随机选择的。TRAIL贷款被更多地采用，但还款率相似，且TRAIL贷款对借款人农业收入的平均影响更大。这种影响差异的大部分是由于在给定农民生产率条件下的处理效应差异，而非借款人选择模式的差异。这些发现可以通过一个模型来解释：在该模型中，TRAIL代理人通过帮助更有能力的处理组借款人降低单位成本并增加产出，从而增加了他们的中间商利润。相比之下，出于政治原因，GRAIL代理人监督了能力较弱的处理组借款人，并降低了他们的违约风险。

【**NBER**】: NBER Working Paper No. 26730，https://www.nber.org/papers/w26730

#### 85. The Demand for Interns {#26729}

【**Author**】: David A. Jaeger, John M. Nunley, Alan Seals, Eric J. Wilbrandt
...
【**摘要**】：我们利用一个专门针对实习的网站上的广告来描述美国对实习生的需求。我们发现，当实习与特定职业关联更紧密、当地劳动力市场失业率更低、以及当地最低工资与联邦最低工资相同时，实习更有可能是有薪的。一项涉及超过11,500份申请的简历审计研究表明，当实习申请人有先前实习经验时，雇主更有可能做出积极回应。雇主也不太可能回应名字听起来像黑人的申请人，以及当申请人距离公司较远时。

【**NBER**】: NBER Working Paper No. 26729，https://www.nber.org/papers/w26729
...
【**摘要**】：本文考察了自1999年科伦拜恩高中枪击事件以来，美国学生暴露于校园枪击案的情况。我们分析了发生在上学日上课时间并导致死亡的枪击事件。这些枪击事件很可能被统一报道，并且对在校学生造成直接或间接伤害的可能性更大。我们衡量了暴露于这些事件中的儿童的数量和特征，以及这些枪击事件发生的经济和社会环境指标。我们区分了无差别枪击、自杀、人身攻击和与犯罪相关的枪击。我们分析的主要发现是区分这些类型枪击事件的重要性。无差别枪击和自杀更常影响白人学生、位于更偏远地区的学校以及收入较高地区的学校。对于人身攻击和与犯罪相关的枪击，则呈现出相反的地理和社会经济模式。忽视这些区别或只关注特定类型的分析可能会对校园枪击的性质产生误导性印象。关于减少校园枪击方法的政策讨论应考虑这些区别。

【**NBER**】: NBER Working Paper No. 26728，https://www.nber.org/papers/w26728
...
【**摘要**】：关于巨额赤字和债务的传统观点是，它们具有巨大的经济成本，除了在经济衰退和早期复苏期间，因为它们会挤出投资并降低未来收入，并且在极端情况下可能导致通货膨胀甚至金融危机。传统观点受到了挑战，最根本的是在Olivier Blanchard 2019年美国经济学会主席演讲中，这是对Peter Diamond世代交叠模型的一个优雅扩展，在期望效用框架中考虑了风险。他得出结论，它们可能没有财政成本并增加福利。我提供了即将出现的巨额赤字和债务/GDP比率上升的证据，以及它们对经济衰退复苏、利率和长期增长的影响。我讨论了“无财政成本”观点的几个实质性问题，这些限制了其适用性，包括未考虑债务增加对利率和增长的影响，也未考虑已有的基本赤字、债务及其预期演变；对数据的解读存在争议；驱动结果的强假设和参数值；以及赤字和债务的政治经济学可能导致更高的债务比率。承认不确定性，证据仍然表明，债务比率的大幅上升可能导致更高的税收、更低的未来收入和代际不公平。

【**NBER**】: NBER Working Paper No. 26727，https://www.nber.org/papers/w26727
