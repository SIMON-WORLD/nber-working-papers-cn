# 【前沿文献】NBER工作论文 2024年4月合集 目录与摘要

> 2024 年 4 月 NBER 更新 97 篇工作论文，其中与中国研究相关的有 2 篇（15、16）。
> 其中，中国相关研究包括：#32377（第 15 篇，城市、异质性企业与贸易）；#32376（第 16 篇，消费者融资的财政刺激：来自中国数字消费券的证据）。

## 一、目录速览

1. **Upward Mobility in Developing Countries {#32391}**  
   发展中国家的向上流动性  
   <font color=grey>Garance Genicot, Debraj Ray, Carolina Concha-Arriagada</font>

2. **Loopholes and the Incidence of Public Services: Evidence from Funding Career & Technical Education {#32390}**  
   漏洞与公共服务的归宿：来自职业与技术教育资助的证据  
   <font color=grey>Thomas Goldring, Brian Jacob, Daniel Kreisman, Michael Ricks</font>

3. **Immigration's Effect on US Wages and Employment Redux {#32389}**  
   移民对美国工资和就业影响的再探讨  
   <font color=grey>Alessandro Caiumi, Giovanni Peri</font>

4. **Teaching Teachers To Use Computer Assisted Learning Effectively: Experimental and Quasi-Experimental Evidence {#32388}**  
   有效教授教师使用计算机辅助学习：实验与准实验证据  
   <font color=grey>Philip Oreopoulos, Chloe Gibbs, Michael Jensen, Joseph Price</font>

5. **The Dollar versus the Euro as International Reserve Currencies {#32387}**  
   美元与欧元作为国际储备货币的比较  
   <font color=grey>Menzie D. Chinn, Jeffrey A. Frankel, Hiro Ito</font>

6. **The Rise and Fall of the Teaching Profession: Prestige, Interest, Preparation, and Satisfaction over the Last Half Century {#32386}**  
   教师职业的兴衰：过去半个世纪的声望、兴趣、准备与满意度  
   <font color=grey>Matthew A. Kraft, Melissa Arnold Lyon</font>

7. **Ethics and Illusions: How Ethical Declarations Shape Market Behavior {#32385}**  
   伦理与幻觉：伦理声明如何塑造市场行为  
   <font color=grey>John M. Barrios, Jeremy Bertomeu, Radhika Lunawat, Ibrahima Sall</font>

8. **Gaining Steam: Incumbent Lock-in and Entrant Leapfrogging {#32384}**  
   获得蒸汽动力：在位者锁定与进入者跨越  
   <font color=grey>Richard Hornbeck, Shanon Hsuan-Ming Hsu, Anders Humlum, Martin Rotemberg</font>

9. **Do Female–Owned Employment Agencies Mitigate Discrimination and Expand Opportunity for Women? {#32383}**  
   女性拥有的就业中介能否减少歧视并为女性扩大机会？  
   <font color=grey>Jennifer Hunt, Carolyn Moehling</font>

10. **Social Protection in the Developing World {#32382}**  
   发展中国家的社会保护  
   <font color=grey>Abhijit Banerjee, Rema Hanna, Benjamin A. Olken, Diana Sverdlin Lisker</font>

11. **Automated Social Science: Language Models as Scientist and Subjects {#32381}**  
   自动化社会科学：作为科学家和主体的大语言模型  
   <font color=grey>Benjamin S. Manning, Kehang Zhu, John J. Horton</font>

12. **The Impact of Lump-Sum Retirement Withdrawals on Labor Supply: Evidence from Peru {#32380}**  
   一次性退休取款对劳动供给的影响：来自秘鲁的证据  
   <font color=grey>Carla Moreno, Sita Slavov</font>

13. **Inflation Preferences {#32379}**  
   通胀偏好  
   <font color=grey>Hassan Afrouzi, Alexander Dietrich, Kristian Myrseth, Romanos Priftis, Raphael Schoenle</font>

14. **The Provision of Information and Incentives in School Assignment Mechanisms {#32378}**  
   学校分配机制中的信息与激励提供  
   <font color=grey>Derek Neal, Joseph Root</font>

15. **Cities, Heterogeneous Firms, and Trade {#32377}**  
   城市、异质性企业与贸易  
   <font color=grey>Jan David Bakker, Alvaro Garcia Marin, Andrei V. Potlogea, Nico Voigtländer, Yang Yang</font>

16. **Consumer-Financed Fiscal Stimulus: Evidence from Digital Coupons in China {#32376}**  
   消费者融资的财政刺激：来自中国数字消费券的证据  
   <font color=grey>Jing Ding, Lei Jiang, Lucy Msall, Matthew J. Notowidigdo</font>

17. **Meritocracy across Countries {#32375}**  
   各国精英体制的比较研究  
   <font color=grey>Oriana Bandiera, Ananya Kotia, Ilse Lindenlaub, Christian Moser, Andrea Prat</font>

18. **Why Does Working from Home Vary Across Countries and People? {#32374}**  
   为何居家办公在不同国家和人群间存在差异？  
   <font color=grey>Pablo Zarate, Mathias Dolls, Steven J. Davis, Nicholas Bloom, Jose Maria Barrero, Cevat Giray Aksoy</font>

19. **Estimating Racial Disparities When Race is Not Observed {#32373}**  
   当种族信息未被观测时如何估计种族差异  
   <font color=grey>Cory McCartan, Robin Fisher, Jacob Goldin, Daniel E. Ho, Kosuke Imai</font>

20. **Transparency and Percent Plans {#32372}**  
   透明度与百分比计划  
   <font color=grey>Adam Kapor</font>

21. **Labor Market Externalities of Pre-retirement Employment Protection {#32371}**  
   退休前就业保护对劳动力市场的外部性  
   <font color=grey>Paweł Chrostek, Krzysztof Karbownik, Michał Myck</font>

22. **The Evolution of Black-White Differences in Occupational Mobility Across Post-Civil War America {#32370}**  
   内战后美国黑人与白人职业流动性差异的演变  
   <font color=grey>Steven N. Durlauf, Gueyon Kim, Dohyeon Lee, Xi Song</font>

23. **Reforming Rotations {#32369}**  
   改革轮岗制度  
   <font color=grey>E. Jason Baron, Richard Lombardo, Joseph P. Ryan, Jeongsoo Suh, Quitze Valenzuela-Stookey</font>

24. **New Gig Work or Changes in Reporting? Understanding Self-Employment Trends in Tax Data {#32368}**  
   新零工经济还是报告方式的变化？理解税收数据中的自雇趋势  
   <font color=grey>Andrew Garin, Emilie Jackson, Dmitri K. Koustas</font>

25. **Toward an Understanding of the Economics of Misinformation: Evidence from a Demand Side Field Experiment on Critical Thinking {#32367}**  
   迈向对错误信息经济学的理解：来自批判性思维需求方田野实验的证据  
   <font color=grey>John A. List, Lina M. Ramírez, Julia Seither, Jaime Unda, Beatriz Vallejo</font>

26. **Shocking Offers: Gender, Wage Inequality, and Recessions in Online Labor Markets {#32366}**  
   令人震惊的报价：在线劳动力市场中的性别、工资不平等与经济衰退  
   <font color=grey>Belinda Archibong, Peter Blair Henry</font>

27. **One Factor to Bind the Cross-Section of Returns {#32365}**  
   一个因子绑定横截面收益  
   <font color=grey>Nicola Borri, Denis Chetverikov, Yukun Liu, Aleh Tsyvinski</font>

28. **Does Inflation Affect Earnings Relevance? A Century-Long Analysis {#32364}**  
   通货膨胀会影响盈余相关性吗？一个长达一个世纪的分析  
   <font color=grey>Oliver Binz, John Graham, Matthew Kubic</font>

29. **The Big Shift in Working Arrangements: Eight Ways Unusual {#32363}**  
   工作安排的重大转变：八个方面的不同寻常之处  
   <font color=grey>Steven J. Davis</font>

30. **Education and Adult Cognition in a Low-income Setting: Differences among Adult Siblings {#32362}**  
   低收入环境中的教育与成人认知：成年兄弟姐妹之间的差异  
   <font color=grey>Yuan S. Zhang, Elizabeth Frankenberg, Duncan Thomas</font>

31. **After 40 Years, How Representative Are Labor Market Outcomes in the NLSY79? {#32361}**  
   40年后，NLSY79中的劳动力市场结果代表性如何？  
   <font color=grey>Alexander Bick, Adam Blandin, Richard Rogerson</font>

32. **Bargaining and Dynamic Competition {#32360}**  
   讨价还价与动态竞争  
   <font color=grey>Shanglyu Deng, Dun Jia, Mario Leccese, Andrew Sweeting</font>

33. **Technological Progress and Rent Seeking {#32359}**  
   技术进步与寻租行为  
   <font color=grey>Vincent Glode, Guillermo Ordoñez</font>

34. **Slow Learning {#32358}**  
   缓慢学习  
   <font color=grey>Lawrence Christiano, Martin S. Eichenbaum, Benjamin K. Johannsen</font>

35. **Assessing the Costs of Balancing College and Work Activities: The Gig Economy Meets Online Education {#32357}**  
   评估平衡大学学习与工作活动的成本：零工经济遇上在线教育  
   <font color=grey>Esteban M. Aucejo, A. Spencer Perry, Basit Zafar</font>

36. **Private Adoption of Public Good Technologies: The Case of PurpleAir {#32356}**  
   公共物品技术的私人采用：以PurpleAir为例  
   <font color=grey>Joshua S. Graff Zivin, Benjamin Krebs, Matthew J. Neidell</font>

37. **Financial Literacy and Financial Education: An Overview {#32355}**  
   金融素养与金融教育：概述  
   <font color=grey>Tim Kaiser, Annamaria Lusardi</font>

38. **Macroeconomics of Mental Health {#32354}**  
   心理健康宏观经济学  
   <font color=grey>Boaz Abramson, Job Boerma, Aleh Tsyvinski</font>

39. **The Benefits and Costs of Secured Debt {#32353}**  
   担保债务的收益与成本  
   <font color=grey>Efraim Benmelech</font>

40. **Return Migration and Human Capital Flows {#32352}**  
   回流移民与人力资本流动  
   <font color=grey>Naser Amanzadeh, Amir Kermani, Timothy McQuade</font>

41. **Balancing Federalism: The Impact of Decentralizing School Accountability {#32351}**  
   平衡联邦制：分散学校问责制的影响  
   <font color=grey>Eric A. Hanushek, Patricia Saenz-Armstrong, Alejandra Salazar</font>

42. **The Gender Concealment Gap {#32350}**  
   性别隐藏差距  
   <font color=grey>Christine L. Exley, Raymond Fisman, Judd B. Kessler, Louis-Pierre Lepage, Xiaomeng Li, Corinne Low, Xiaoyue Shan, Mattie Toma, Basit Zafar</font>

43. **Mask Mandate Costs {#32349}**  
   口罩强制令的成本  
   <font color=grey>Patrick Carlin, Shyam Raman, Kosali I. Simon, Ryan Sullivan, Coady Wing</font>

44. **Examiner and Judge Designs in Economics: A Practitioner's Guide {#32348}**  
   经济学中的审查员与法官设计：实践者指南  
   <font color=grey>Eric Chyn, Brigham Frandsen, Emily C. Leslie</font>

45. **A Field Experiment on Antitrust Compliance {#32347}**  
   反垄断合规的实地实验  
   <font color=grey>Kei Kawai, Jun Nakabayashi</font>

46. **Human Capital Spillovers and Health: Does Living Around College Graduates Lengthen Life? {#32346}**  
   人力资本溢出与健康：生活在大学毕业生周围能延长寿命吗？  
   <font color=grey>Jacob H. Bor, David M. Cutler, Edward L. Glaeser, Ljubica Ristovska</font>

47. **Bank Failures and Economic Activity: Evidence from the Progressive Era {#32345}**  
   银行倒闭与经济活动：来自进步时代的证据  
   <font color=grey>Gary Richardson, Marco Del Angel, Michael Gou</font>

48. **Weighted Noise: Discretion in Regulation {#32344}**  
   加权噪声：监管中的自由裁量权  
   <font color=grey>Sumit Agarwal, Bernardo C. Morais, Amit Seru, Kelly Shue</font>

49. **Work Requirements and Child Tax Benefits {#32343}**  
   工作要求与儿童税收优惠  
   <font color=grey>Jacob Goldin, Tatiana Homonoff, Neel A. Lal, Ithai Lurie, Katherine Michelmore, Matthew Unrath</font>

50. **The Limited Effects of U.S. Protests {#32342}**  
   美国抗议活动的有限影响  
   <font color=grey>Amory Gethin, Vincent Pons</font>

51. **Bank Runs, Fragility, and Regulation {#32341}**  
   银行挤兑、脆弱性与监管  
   <font color=grey>Manuel Amador, Javier Bianchi</font>

52. **Countries for Old Men: An Analysis of the Age Pay Gap {#32340}**  
   老男人的国度：年龄收入差距分析  
   <font color=grey>Nicola Bianchi, Matteo Paradisi</font>

53. **Three Things about Mobile App Commissions {#32339}**  
   关于移动应用佣金的三个要点  
   <font color=grey>Joshua S. Gans</font>

54. **Heterogeneity and Endogenous Compliance: Implications for Scaling Class Size Interventions {#32338}**  
   异质性与内生合规性：对扩大班级规模干预措施的启示  
   <font color=grey>Karun Adusumilli, Francesco Agostinelli, Emilio Borghesan</font>

55. **The Declining Mental Health Of The Young And The Global Disappearance Of The Hump Shape In Age In Unhappiness {#32337}**  
   年轻人心理健康的下降与全球年龄-不幸福驼峰形状的消失  
   <font color=grey>David G. Blanchflower, Alex Bryson, Xiaowei Xu</font>

56. **Nothing for Something: Marketing Cancer Drugs to Physicians Increases Prescribing Without Improving Mortality {#32336}**  
   无谓的付出：向医生营销抗癌药物增加处方量但未改善死亡率  
   <font color=grey>Colleen Carey, Michael Daly, Jing Li</font>

57. **The Global Life-Cycle Optimizer – Analyzing Fiscal Policy's Potential to Dramatically Distort Labor Supply and Saving {#32335}**  
   全球生命周期优化器——分析财政政策大幅扭曲劳动供给与储蓄的潜力  
   <font color=grey>Johannes Brumm, Laurence J. Kotlikoff, Christopher Krause, Joshua Zanger</font>

58. **Religious Worship Attendance in America: Evidence from Cellphone Data {#32334}**  
   美国的宗教礼拜出席率：来自手机数据的证据  
   <font color=grey>Devin G. Pope</font>

59. **Neighborhood Effects: Evidence from Wartime Destruction in London {#32333}**  
   邻里效应：来自伦敦战时破坏的证据  
   <font color=grey>Stephen J. Redding, Daniel M. Sturm</font>

60. **To Pay or Autopay? Fintech Innovation and Credit Card Payments {#32332}**  
   支付还是自动支付？金融科技创新与信用卡支付  
   <font color=grey>Jialan Wang</font>

61. **How You Pay Drives What You Choose: Health Savings Accounts versus Cash in Health Insurance Plan Choice {#32331}**  
   支付方式决定选择：健康储蓄账户与现金在健康保险计划选择中的作用  
   <font color=grey>Jonathan Gruber, Mengyun M. Lin, Haoming Liu, Junjian Yi</font>

62. **Global Spillovers from FED Hikes and a Strong Dollar: The Risk Channel {#32330}**  
   美联储加息与强势美元的全球溢出效应：风险渠道  
   <font color=grey>José Cristi, Ṣebnem Kalemli-Özcan, Mariana Sans, Filiz D. Unsal</font>

63. **Global Transmission of FED Hikes: The Role of Policy Credibility and Balance Sheets {#32329}**  
   美联储加息的全球传导：政策可信度与资产负债表的作用  
   <font color=grey>Ṣebnem Kalemli-Özcan, Filiz D. Unsal</font>

64. **Smoke from Factory Chimneys: The Applied Economics of Air Pollution in the Progressive Era {#32328}**  
   工厂烟囱的烟雾：进步时代空气污染的应用经济学  
   <font color=grey>H. Spencer Banzhaf, Randall Walsh</font>

65. **Recovering Overlooked Information in Categorical Variables with LLMs: An Application to Labor Market Mismatch {#32327}**  
   利用大语言模型恢复分类变量中被忽视的信息：劳动力市场错配的应用  
   <font color=grey>Yi Chen, Hanming Fang, Yi Zhao, Zibo Zhao</font>

66. **After the Storm: How Emergency Liquidity Helps Small Businesses Following Natural Disasters {#32326}**  
   风暴过后：紧急流动性如何帮助小企业应对自然灾害  
   <font color=grey>Benjamin L. Collier, Sabrina T. Howell, Lea Rendell</font>

67. **Interdependent Values in Matching Markets: Evidence from Medical School Programs in Denmark {#32325}**  
   匹配市场中的相互依赖价值：来自丹麦医学院项目的证据  
   <font color=grey>Benjamin Friedrich, Martin B. Hackmann, Adam Kapor, Sofia J. Moroni, Anne Brink Nandrup</font>

68. **Monetary Policy, Segmentation, and the Term Structure {#32324}**  
   货币政策、分割与期限结构  
   <font color=grey>Rohan Kekre, Moritz Lenel, Federico Mainardi</font>

69. **Homelessness and the Persistence of Deprivation: Income, Employment, and Safety Net Participation {#32323}**  
   无家可归与贫困的持续性：收入、就业与安全网参与  
   <font color=grey>Bruce D. Meyer, Angela Wyse, Gillian Meyer, Alexa Grunwaldt, Derek Wu</font>

70. **The Dominant Role of Expectations and Broad-Based Supply Shocks in Driving Inflation {#32322}**  
   预期和广泛供给冲击在推动通胀中的主导作用  
   <font color=grey>Paul Beaudry, Chenyu Hou, Franck Portier</font>

71. **Quantitative Tightening Around the Globe: What Have We Learned? {#32321}**  
   全球量化紧缩：我们学到了什么？  
   <font color=grey>Wenxin Du, Kristin Forbes, Matthew N. Luzzetti</font>

72. **Application Flows {#32320}**  
   申请流  
   <font color=grey>Steven J. Davis, Brenda Samaniego de la Parra</font>

73. **Tracking Firm Use of AI in Real Time: A Snapshot from the Business Trends and Outlook Survey {#32319}**  
   实时追踪企业人工智能使用情况：来自商业趋势与展望调查的快照  
   <font color=grey>Kathryn Bonney, Cory Breaux, Cathy Buffington, Emin Dinlersoz, Lucia S. Foster, Nathan Goldschlag, John C. Haltiwanger, Zachary Kroff, Keith Savage</font>

74. **Theory-Driven Entrepreneurial Search {#32318}**  
   理论驱动的创业搜索  
   <font color=grey>Ankur Chavda, Joshua S. Gans, Scott Stern</font>

75. **The Impact of Green Investors on Stock Prices {#32317}**  
   绿色投资者对股票价格的影响  
   <font color=grey>Gong Cheng, Eric Jondeau, Benoit Mojon, Dimitri Vayanos</font>

76. **Where Do Banks End and NBFIs Begin? {#32316}**  
   银行与非银行金融中介的界限在哪里？  
   <font color=grey>Viral V. Acharya, Nicola Cetorelli, Bruce Tuckman</font>

77. **The Effects of Medical Debt Relief: Evidence from Two Randomized Experiments {#32315}**  
   医疗债务减免的影响：来自两项随机实验的证据  
   <font color=grey>Raymond Kluender, Neale Mahoney, Francis Wong, Wesley Yin</font>

78. **Inequality and Racial Backlash: Evidence from the Reconstruction Era and the Freedmen’s Bureau {#32314}**  
   不平等与种族反弹：来自重建时期和自由民局的证据  
   <font color=grey>Eric Chyn, Kareem Haggag, Bryan A. Stuart</font>

79. **A Discrimination Report Card {#32313}**  
   歧视报告卡  
   <font color=grey>Patrick M. Kline, Evan K. Rose, Christopher R. Walters</font>

80. **Quantifying the Uncertainty of Imputed Demographic Disparity Estimates: The Dual-Bootstrap {#32312}**  
   量化估算的人口统计差异估计的不确定性：双重自助法  
   <font color=grey>Benjamin Lu, Jia Wan, Derek Ouyang, Jacob Goldin, Daniel E. Ho</font>

81. **Ideology, Incidence and the Political Economy of Fuel Taxes: Evidence from the California 2018 Proposition 6 {#32311}**  
   意识形态、负担与燃油税的政治经济学：来自2018年加州第6号提案的证据  
   <font color=grey>Lucas Epstein, Erich Muehlegger</font>

82. **Effects of Income on Infant Health: Evidence from the Expanded Child Tax Credit and Pandemic Stimulus Checks {#32310}**  
   收入对婴儿健康的影响：来自扩大的儿童税收抵免和疫情刺激支票的证据  
   <font color=grey>Wei Lyu, George Wehby, Robert Kaestner</font>

83. **Identification of Marginal Treatment Effects using Subjective Expectations {#32309}**  
   利用主观预期识别边际处理效应  
   <font color=grey>Joseph S. Briggs, Andrew Caplin, Søren Leth-Petersen, Christopher Tonetti</font>

84. **Changing Central Bank Pressures and Inflation {#32308}**  
   变化的央行压力与通货膨胀  
   <font color=grey>Hassan Afrouzi, Marina Halac, Kenneth S. Rogoff, Pierre Yared</font>

85. **Mortality Burden From Wildfire Smoke Under Climate Change {#32307}**  
   气候变化下野火烟雾的死亡率负担  
   <font color=grey>Minghao Qiu, Jessica Li, Carlos F. Gould, Renzhi Jing, Makoto Kelp, Marissa Childs, Mathew Kiang, Sam Heft-Neal, Noah Diffenbaugh, Marshall Burke</font>

86. **Taxation of Capital: Capital Levies and Commitment {#32306}**  
   资本课税：资本税与承诺  
   <font color=grey>Robert J. Barro, Varadarajan V. Chari</font>

87. **Beyond Bad Luck: Macroeconomic Implications of Persistent Heterogeneity In Optimism {#32305}**  
   超越坏运气：乐观主义中持久异质性的宏观经济含义  
   <font color=grey>Oliver Pfäuti, Fabian Seyrich, Jonathan Zinman</font>

88. **Location Sorting and Endogenous Amenities: Evidence from Amsterdam {#32304}**  
   区位选择与内生便利设施：来自阿姆斯特丹的证据  
   <font color=grey>Milena Almagro, Tomás Domínguez-Iino</font>

89. **The Performance of Emerging Markets During the Fed’s Easing and Tightening Cycles: A Cross-Country Resilience Analysis {#32303}**  
   美联储宽松与紧缩周期中新兴市场的表现：跨国韧性分析  
   <font color=grey>Joshua Aizenman, Donghyun Park, Irfan A. Qureshi, Gazi Salah Uddin, Jamel Saadaoui</font>

90. **The Effect of E-cigarette Taxes on Substance Use {#32302}**  
   电子烟税对物质使用的影响  
   <font color=grey>Dhaval M. Dave, Yang Liang, Johanna Catherine Maclean, Caterina Muratori, Joseph J. Sabia</font>

91. **What Hundreds of Economic News Events Say About Belief Overreaction in the Stock Market {#32301}**  
   数百条经济新闻事件揭示的股市信念过度反应  
   <font color=grey>Francesco Bianchi, Sydney C. Ludvigson, Sai Ma</font>

92. **Why Do We Dislike Inflation? {#32300}**  
   我们为何厌恶通货膨胀？  
   <font color=grey>Stefanie Stantcheva</font>

93. **Amazon Self-preferencing in the Shadow of the Digital Markets Act {#32299}**  
   《数字市场法案》阴影下的亚马逊自我优待  
   <font color=grey>Joel Waldfogel</font>

94. **Consumption Dynamics and Welfare Under Non-Gaussian Earnings Risk {#32298}**  
   非高斯收入风险下的消费动态与福利  
   <font color=grey>Fatih Guvenen, Serdar Ozkan, Rocio Madera</font>

95. **Does nothing stop a bullet like a job? The effects of income on crime {#32297}**  
   工作能否阻挡子弹？收入对犯罪的影响  
   <font color=grey>Jens Ludwig, Kevin Schnepel</font>

96. **Marginal Returns to Public Universities {#32296}**  
   公立大学的边际回报  
   <font color=grey>Jack Mountjoy</font>

97. **Beliefs that Entertain {#32295}**  
   令人愉悦的信念  
   <font color=grey>Ashvin Gandhi, Paola Giuliano, Eric Guan, Quinn Keefer, Chase McDonald, Michaela Pagel, Joshua Tasoff</font>
...
【**Author**】: Garance Genicot, Debraj Ray, Carolina Concha-Arriagada
...
【**摘要**】：本文综述了关于发展中国家流动性的文献。我们明确区分了方向性与非方向性指标、绝对与相对指标及其组合。我们注意到，面板数据的匮乏阻碍了许多国家流动性的测量。我们特别关注近期发展的无面板流动性指标，这使得我们能够衡量122个国家的向上流动性。在整个综述中，我们讨论了文献中的一些核心主题。

【**NBER**】: NBER Working Paper No. 32391，https://www.nber.org/papers/w32391

#### 2. Loopholes and the Incidence of Public Services: Evidence from Funding Career & Technical Education {#32390}

【**Author**】: Thomas Goldring, Brian Jacob, Daniel Kreisman, Michael Ricks
...
【**摘要**】：2015年，密歇根州增加了职业与技术教育（CTE）资助，并改变了资助公式，根据学生完成课程大纲的进度来报销项目。尽管这一变化使项目完成率几乎翻倍，但学生入学率和持续学习率并未受到影响；相反，管理人员通过围绕新资助公式中的节点重组课程大纲，加速了学生进度。由于反应的异质性，30%的资助增加额从高贫困学区转移到了更富裕的学区，这突显了供给侧对漏洞的反应如何塑造公共服务的归宿。

【**NBER**】: NBER Working Paper No. 32390，https://www.nber.org/papers/w32390
...
【**摘要**】：在本文中，我们复兴、扩展并改进了2000年代一系列有影响力的论文中使用的方法，以估计移民工人供给变化如何影响美国本土工人的工资。我们首先将分析扩展到包括最近的2000-2022年。此外，我们引入了三项重要改进。第一，我们引入了一个工具变量，该变量使用基于移民的新技能份额转移和本土人口演变，我们证明其通过了有效性检验并具有相当强的解释力。第二，我们提供了移民对本土工人就业人口比影响的估计，以检验国家层面的挤出效应。第三，我们分析了本土工人为应对移民而进行的职业升级。利用这些估计，我们计算出，由于本土与移民的互补性以及移民的大学技能含量，在2000-2019年期间，移民对受教育程度较低的本土工人工资产生了显著的正向影响，幅度在+1.7%至+2.6%之间，而对受过大学教育的本土工人没有显著的工资影响。我们还计算出对大多数本土工人有正的就业率效应。即使对最近的2019-2022年期间的模拟也表明，移民对非大学学历本土工人的工资有小的正向影响，且没有显著的就业挤出效应。

【**NBER**】: NBER Working Paper No. 32389，https://www.nber.org/papers/w32389

#### 4. Teaching Teachers To Use Computer Assisted Learning Effectively: Experimental and Quasi-Experimental Evidence {#32388}

【**Author**】: Philip Oreopoulos, Chloe Gibbs, Michael Jensen, Joseph Price
...
【**摘要**】：掌握学习——即学生必须在进入下一个主题之前证明对单个主题的熟练程度——被公认为最有效的学习方式之一，然而许多教师仍难以或不确定如何在课堂环境中实施它。本研究评估了一个通过技术和主动持续教师支持来鼓励更多掌握学习的项目。聚焦于中小学数学，教师每周接受辅导，学习如何使用计算机辅助学习（CAL）帮助学生遵循定制的渐进进步路线图。来自两个现场实验的结果表明，对数学成绩的意向治疗效应显著，为0.12至0.22个标准差。进一步分析表明，这些收益来自每周平均至少进行35分钟练习的课堂中的学生。能够实现高剂量练习的教师具有高度的初始认同感、明确的练习实施策略，以及密切监控进度并跟进困难学生的意愿。

【**NBER**】: NBER Working Paper No. 32388，https://www.nber.org/papers/w32388
...
【**摘要**】：我们首先考察中央银行外汇储备总量的决定因素（发行国经济和金融市场的规模、货币保值能力以及惯性）。但理解储备持有的决定可能还需要超越总量数字，转而观察单个中央银行的行为，包括持有国的特征（与发行国的双边贸易、双边货币挂钩以及双边制裁暴露的代理变量），以及储备货币发行国的特征。在逐个货币的基础上，美元持有量在一定程度上可以由几个发行国特征较好地解释；但其他货币的解释效果较差。这可能是因为逐个货币估计的结果因样本量不足而受损。这一考虑为将主要货币的数据合并并施加约束（即每种货币的储备持有以相同方式决定）提供了动机。在这种设定下，大多数经济决定因素具有显著性：以GDP衡量的经济规模、以外汇交易量衡量的金融市场规模、双边货币挂钩以及双边贸易份额。然而，地缘政治变量（双边联盟、双边制裁）通常不显著。

【**NBER**】: NBER Working Paper No. 32387，https://www.nber.org/papers/w32387

#### 6. The Rise and Fall of the Teaching Profession: Prestige, Interest, Preparation, and Satisfaction over the Last Half Century {#32386}

【**Author**】: Matthew A. Kraft, Melissa Arnold Lyon
...
【**摘要**】：我们通过汇编具有全国代表性的时间序列数据，考察了过去半个世纪美国K-12教师职业的状况，这些数据涉及四个相互关联的构念：职业声望、学生兴趣、准备入职的人数以及在职满意度。我们发现每个指标都呈现出一致且动态的模式：1970年代迅速下降，1980年代迅速上升并持续到1990年代中期，随后相对稳定，然后从2010年左右开始持续下降。教师职业的当前状态处于或接近50年来的最低水平。我们识别并探讨了一系列可能解释这些历史模式的假设，包括经济和社会政治因素、教育政策以及学校环境。

【**NBER**】: NBER Working Paper No. 32386，https://www.nber.org/papers/w32386

#### 7. Ethics and Illusions: How Ethical Declarations Shape Market Behavior {#32385}

【**Author**】: John M. Barrios, Jeremy Bertomeu, Radhika Lunawat, Ibrahima Sall
...
【**摘要**】：我们通过一个受控的实验室实验，考察伦理声明对市场交易的影响，其中拥有私人信息的卖方在首价拍卖前发布公开报告。我们发现，虽然签署伦理声明并未减少卖方的虚假报告，但它显著增加了买方的信任，往往使交易条件向卖方倾斜。与理性预期相反，买方始终难以纠正这种偏差。在我们的结构分析的反事实情景中，我们发现当买方理性处理关于卖方伦理偏好的不确定性时，价格效率会提高，但即使买方对卖方的伦理标准有更准确的认知，偏差仍然存在。总体而言，我们的结果表明，旨在增强市场环境中伦理行为的披露干预措施，不一定能带来更有效的定价或减少偏差，在某些情况下，甚至可能使某些市场参与者处于不利地位。

【**NBER**】: NBER Working Paper No. 32385，https://www.nber.org/papers/w32385

#### 8. Gaining Steam: Incumbent Lock-in and Entrant Leapfrogging {#32384}

【**Author**】: Richard Hornbeck, Shanon Hsuan-Ming Hsu, Anders Humlum, Martin Rotemberg
...
【**摘要**】：我们考察了美国制造业从水动力到蒸汽动力的长期转型，重点关注机械动力的早期使用者：木材厂和面粉厂。通过数字化1850年至1880年制造业普查手稿，我们表明，随着蒸汽成本下降，制造业活动在水力潜力较低的县增长更快。这种增长是由蒸汽动力进入者和集聚效应驱动的，而水动力在位者面临主要来自沉没成本的转换障碍。通过估计企业进入和蒸汽采用的动态模型，我们发现转换障碍与高固定成本的相互作用，对技术采用产生了数量上重要且社会效率低下的拖累。尽管存在大量的进入和退出，转换障碍在整个19世纪对总体蒸汽采用仍然具有影响力，因为水动力需要较低的固定成本，因此对生产率相对较低的进入者具有吸引力。这些进入者随后成为在位者，即使其生产率增长，也被锁定在水动力中。

【**NBER**】: NBER Working Paper No. 32384，https://www.nber.org/papers/w32384

#### 9. Do Female–Owned Employment Agencies Mitigate Discrimination and Expand Opportunity for Women? {#32383}

【**Author**】: Jennifer Hunt, Carolyn Moehling
...
【**摘要**】：我们创建了一个数据集，包含1950年和1960年美国就业中介发布的14000条招聘广告（当时招聘广告会注明性别），并收集了中介所有权的信息。女性拥有的中介专注于为女性提供职位空缺，扩大了女性求职者获得中介服务的机会。与男性拥有的中介相比，它们还向女性宣传更多技能型职业，导致女性工资高出5%。但它们向男性宣传更多文职工作，导致男性工资降低17%。然而，在中介内部，女性和男性拥有的中介的性别工资差距相同，这表明歧视并未得到缓解。

【**NBER**】: NBER Working Paper No. 32383，https://www.nber.org/papers/w32383

#### 10. Social Protection in the Developing World {#32382}

【**Author**】: Abhijit Banerjee, Rema Hanna, Benjamin A. Olken, Diana Sverdlin Lisker
...
【**摘要**】：社会保护项目在低收入和中等收入国家变得越来越普遍，并具有与其运行环境相匹配的独特特征。本文回顾了关于这些项目设计和影响的日益增长的文献。我们探讨了在存在大量非正规部门的情况下如何识别潜在受益者、再分配和收入支持项目的设计与实施，以及社会保险面临的挑战和潜力。我们利用我们的框架作为指南来整合和组织现有文献，同时也强调未来研究的领域和问题。

【**NBER**】: NBER Working Paper No. 32382，https://www.nber.org/papers/w32382

#### 11. Automated Social Science: Language Models as Scientist and Subjects {#32381}

【**Author**】: Benjamin S. Manning, Kehang Zhu, John J. Horton
...
【**摘要**】：我们提出了一种在计算机中自动生成和检验社会科学假设的方法。这种自动化得益于大语言模型的最新进展，但该方法的关键特征是使用结构因果模型。结构因果模型提供了一种陈述假设的语言、构建基于大语言模型主体的蓝图、实验设计以及数据分析计划。拟合后的结构因果模型成为一个可用于预测或规划后续实验的对象。我们通过几个场景演示了该方法：谈判、保释听证会、求职面试和拍卖。在每种情况下，因果关系都由系统提出并检验，发现了一些证据，而另一些则没有。我们提供的证据表明，这些社会互动模拟的见解无法通过直接引出纯粹从大语言模型中获得。当给定其为每个场景提出的结构因果模型时，大语言模型善于预测估计效应的符号，但无法可靠地预测这些估计值的大小。在拍卖实验中，计算机模拟结果与拍卖理论的预测非常吻合，但从大语言模型中引出的清算价格预测却不准确。然而，如果模型能够以拟合的结构因果模型为条件，那么大语言模型的预测会得到显著改善。简而言之，大语言模型知道的比它（立即）能说出来的要多。

【**NBER**】: NBER Working Paper No. 32381，https://www.nber.org/papers/w32381

#### 12. The Impact of Lump-Sum Retirement Withdrawals on Labor Supply: Evidence from Peru {#32380}

【**Author**】: Carla Moreno, Sita Slavov
...
【**摘要**】：我们研究了2016年一项政策对劳动供给的影响，该政策允许秘鲁私人养老金体系覆盖的符合退休条件的个人以一次性付款而非年金的形式领取退休福利。我们提出了一个理论模型，预测对于面临流动性约束的工人来说，一次性付款选项使正规就业（需要参与养老金）相对于非正规就业（不需要参与养老金）更具吸引力；同时它也鼓励提前退休。利用家庭面板数据，我们估计了2016年政策对私人养老金体系覆盖工人劳动供给的影响，并与受替代的现收现付制固定收益养老金（不受该政策影响）覆盖的工人进行比较。该政策与50岁（女性提前退休年龄）、55岁（男性提前退休年龄）和65岁（所有工人正常退休年龄）退休概率的增加相关。我们还发现，在40多岁女性和50岁出头男性中，正规部门就业有所增加，这与为获得提前退休资格（需要近期缴纳养老金）而增加的努力相一致。该政策的影响集中在受教育程度较低的工人中，他们更可能面临流动性约束。

【**NBER**】: NBER Working Paper No. 32380，https://www.nber.org/papers/w32380

#### 13. Inflation Preferences {#32379}

【**Author**】: Hassan Afrouzi, Alexander Dietrich, Kristian Myrseth, Romanos Priftis, Raphael Schoenle
...
【**摘要**】：我们记录了基于调查的美国消费者对长期通胀率偏好的新颖事实。消费者平均偏好0.20%的年通胀率，远低于美联储2%的目标。通胀偏好不仅与人口和社会经济特征相关，还与经济推理相关。一项随机对照试验表明，两种基于经济模型的叙述——描述通胀如何降低工资和货币持有的实际价值——会影响通胀偏好。虽然我们的结果可以为央行关于通胀目标的沟通设计提供信息，但它们也引发了关于此类目标与消费者偏好之间一致性的问题。

【**NBER**】: NBER Working Paper No. 32379，https://www.nber.org/papers/w32379

#### 14. The Provision of Information and Incentives in School Assignment Mechanisms {#32378}

【**Author**】: Derek Neal, Joseph Root
...
【**摘要**】：关于集中式学校分配机制的研究通常关注参与特定机制的家长是否可能真实报告其偏好，或从事各种代价高昂的策略行为。然而，越来越多的文献表明，家长可能对其可选择的学校了解不足，无法形成完整的偏好排序。我们开发了一个简单模型，解释了为什么许多学校分配机制的参与者对所提供学校的信息有限并不令人惊讶。然后，我们讨论了可以改善参与者带入学校分配机制的信息以及其选择集中学校质量的政策。

【**NBER**】: NBER Working Paper No. 32378，https://www.nber.org/papers/w32378

#### 15. Cities, Heterogeneous Firms, and Trade {#32377}

【**Author**】: Jan David Bakker, Alvaro Garcia Marin, Andrei V. Potlogea, Nico Voigtländer, Yang Yang

【**Abstract**】: Does international trade affect the growth of cities, and vice versa? Assembling disaggregate data for four countries, we document a novel stylized fact: Export activity is disproportionately concentrated in larger cities – even more so than overall economic activity. We rationalize this fact by marrying a standard quantitative spatial economics model with a heterogeneous firm model that features selection into the domestic and the export market. Our model delivers novel predictions for the bi-directional interactions between trade and urban dynamics: On the one hand, trade liberalization shifts employment towards larger cities, and on the other hand, liberalizing land use raises exports. We structurally estimate the model using Chinese and French firm-level data. We find that trade policies have quantitatively meaningful impacts on urban outcomes and vice versa, and that the aggregate effects of trade and urban policies differ from standard models that do not account for the interaction between trade and cities. In addition, a distinguishing prediction of our model – which we confirm in the data – is that local trade elasticities vary systematically with city size, so that a country’s aggregate trade elasticity depends on the spatial distribution of production within its borders.

【**摘要**】：国际贸易是否影响城市增长，反之亦然？通过汇总四个国家的微观数据，我们记录了一个新颖的典型事实：出口活动不成比例地集中在较大的城市——甚至比整体经济活动更为集中。我们通过将一个标准的定量空间经济学模型与一个具有进入国内和出口市场选择特征的异质性企业模型相结合，来解释这一事实。我们的模型为贸易与城市动态之间的双向互动提供了新颖的预测：一方面，贸易自由化将就业转向更大的城市；另一方面，放松土地管制会提高出口。我们利用中国和法国的企业层面数据对模型进行了结构估计。我们发现，贸易政策对城市结果具有数量上显著的影响，反之亦然，并且贸易和城市政策的总体效应与不考虑贸易与城市之间相互作用的标准模型不同。此外，我们模型的一个显著预测——我们在数据中证实了这一点——是地方贸易弹性随城市规模系统性地变化，因此一个国家的总体贸易弹性取决于其境内生产的空间分布。

【**NBER**】: NBER Working Paper No. 32377，https://www.nber.org/papers/w32377

#### 16. Consumer-Financed Fiscal Stimulus: Evidence from Digital Coupons in China {#32376}

【**Author**】: Jing Ding, Lei Jiang, Lucy Msall, Matthew J. Notowidigdo
...
【**摘要**】：2020年，中国地方政府开始发放数字消费券，以刺激餐饮和超市等目标类别的支出。利用来自大型电子商务平台的数据和聚束估计方法，我们发现消费券导致支出大幅增加，每花费政府1元人民币，支出增加3.1-3.3元人民币。巨大的支出反应并非来自非目标支出类别的替代，也非来自短期的跨期替代。为了合理化这些结果，我们开发了一个动态消费模型，展示了消费券的最低消费门槛如何创造临时的缺口，从而导致巨大的支出反应。

【**NBER**】: NBER Working Paper No. 32376，https://www.nber.org/papers/w32376

#### 17. Meritocracy across Countries {#32375}

【**Author**】: Oriana Bandiera, Ananya Kotia, Ilse Lindenlaub, Christian Moser, Andrea Prat
...
【**摘要**】：高收入国家的劳动力市场是否更具精英体制特征，即工人与工作的匹配基于技能而非与生产力无关的特殊属性？如果是，原因何在？其总体经济后果又是什么？利用涵盖28个国家超过12万人的国际可比工人技能与工作技能要求数据，我们记录到：在高收入国家，工人的技能与其工作的技能要求匹配度更高。为量化工人-工作匹配在发展核算中的作用，我们构建了一个均衡匹配模型，该模型允许各国在三个基本要素上存在差异：（i）多维工人技能与工作技能要求的禀赋，这决定了匹配的可行性；（ii）技术，它决定了匹配的回报；（iii）特殊匹配摩擦，它捕捉了非生产性工人与工作特征在匹配过程中的作用。估计模型得出了两个关键见解。首先，因匹配摩擦减少而带来的工人-工作匹配改善，仅能解释跨国收入差异的一小部分。其次，然而，改善工人-工作匹配对于释放由采用前沿禀赋和技术所带来的经济发展收益至关重要。

【**NBER**】: NBER Working Paper No. 32375，https://www.nber.org/papers/w32375

#### 18. Why Does Working from Home Vary Across Countries and People? {#32374}

【**Author**】: Pablo Zarate, Mathias Dolls, Steven J. Davis, Nicholas Bloom, Jose Maria Barrero, Cevat Giray Aksoy
...
【**摘要**】：我们利用两项调查来评估为何居家办公（WFH）在不同国家和人群间差异如此之大。一项衡量文化个人主义的指标解释了约三分之一的跨国WFH率差异。澳大利亚、加拿大、英国和美国在个人主义和WFH率上得分较高，而亚洲国家在这两方面得分均较低。其他因素，如累计封锁严格程度、人口密度、行业结构和人均GDP，也很重要，但它们解释的差异较少。在考察美国个体工人时，我们发现行业结构、人口密度和封锁严重程度有助于解释当前的WFH率，工人所在县的党派倾向也是如此。我们得出结论：多种因素影响WFH率，技术可行性只是其中之一。

【**NBER**】: NBER Working Paper No. 32374，https://www.nber.org/papers/w32374

#### 19. Estimating Racial Disparities When Race is Not Observed {#32373}

【**Author**】: Cory McCartan, Robin Fisher, Jacob Goldin, Daniel E. Ho, Kosuke Imai
...
【**摘要**】：在各个领域中，种族差异的估计常常因缺乏个体层面的种族信息而受阻。在许多情况下，法律禁止收集此类信息以防止直接的种族歧视。因此，分析人员经常采用贝叶斯改进姓氏地理编码（BISG）及其变体，该方法将个人姓名和地址与人口普查数据相结合来预测种族。不幸的是，BISG的残差通常与感兴趣的结果相关，这通常会减弱种族差异的估计值。为纠正此偏差，我们提出了一种替代识别策略，其假设是：在给定（未观测的）种族、居住地点和其他观测特征的情况下，姓氏与结果条件独立。我们引入了一类新模型，即用于差异估计的贝叶斯工具回归（BIRDiE），该模型以BISG概率为输入，通过使用姓氏作为种族的工具变量来产生种族差异估计。我们的估计方法具有可扩展性，使得分析大规模行政数据成为可能。我们还展示了如何处理关键识别假设的潜在违反。基于北卡罗来纳州选民档案的验证研究表明，在估计政党登记的种族差异时，BISG+BIRDiE将误差减少了高达84%。最后，我们应用所提出的方法，利用美国国税局的个体层面税收数据，估计了谁从住房抵押贷款利息扣除中受益的种族差异。提供开源软件以实现所提出的方法。

【**NBER**】: NBER Working Paper No. 32373，https://www.nber.org/papers/w32373
...
【**摘要**】：透明度与不透明性是大学录取政策的一个重要维度。大学可能通过对申请者材料进行全面审查来获取有用信息，但这样做可能会增加不确定性，从而阻碍信息匮乏的潜在申请者。本文利用德克萨斯州的调查和行政数据，以及一个涵盖大学申请、录取、入学、成绩和持续就读的模型，研究了在德克萨斯州前百分之十计划的背景下，录取透明度的影响。我估计，该计划对前十分之一学生进入旗舰大学概率产生的9.1个百分点影响中，有三分之二是由信息效应而非机械效应造成的。被诱导入学的学生更有可能来自低收入高中，并且他们在学业上优于被他们取代的学生。如果辅以经济援助信息，这些效应会更大，并且这些效应是由透明度驱动的，而非自动录取与酌情录取规则之间的错位。

【**NBER**】: NBER Working Paper No. 32372，https://www.nber.org/papers/w32372

#### 21. Labor Market Externalities of Pre-retirement Employment Protection {#32371}

【**Author**】: Paweł Chrostek, Krzysztof Karbownik, Michał Myck
...
【**摘要**】：利用人口层面的行政数据，我们研究了针对老年工人的特定年龄就业保护立法（EPL）所产生的劳动力市场外部性。我们的结果显示，该就业保护立法对即将符合资格条件的男性和女性的就业或收入均未产生具有经济意义的总体影响。分别考虑在职员工和非雇员时，我们发现前者有微小的正向就业效应，后者则有微小的负向就业效应。

【**NBER**】: NBER Working Paper No. 32371，https://www.nber.org/papers/w32371

#### 22. The Evolution of Black-White Differences in Occupational Mobility Across Post-Civil War America {#32370}

【**Author**】: Steven N. Durlauf, Gueyon Kim, Dohyeon Lee, Xi Song
...
【**摘要**】：本文研究了美国黑人与白人之间代际职业流动性的长期差异。通过结合关联的历史人口普查数据和当代大规模调查数据，我们基于马尔可夫链提供了一套全面的流动性衡量指标，用以追溯职业差异的短期和长期动态。我们的发现强调了1940-1950年出生队列所经历的流动性变化在塑造当前职业分布和缩小种族职业差距方面的独特重要性。我们进一步探讨了持续存在的职业不平等的特性，并认为这些差异最好被理解为缺乏交换流动性，而非结构性流动性。因此，根据历史上看到的职业动态，不能期望当代的职业差异会消失。

【**NBER**】: NBER Working Paper No. 32370，https://www.nber.org/papers/w32370

#### 23. Reforming Rotations {#32369}

【**Author**】: E. Jason Baron, Richard Lombardo, Joseph P. Ryan, Jeongsoo Suh, Quitze Valenzuela-Stookey
...
【**摘要**】：在许多情境中，任务通过轮岗分配给代理人。这种准随机分配忽略了代理人在绩效和偏好上的异质性。我们研究设计者如何利用这种异质性来改善总体绩效，同时确保没有代理人的境况相对于现状系统变得更差。关键挑战在于，虽然设计者可能能够估计代理人的绩效，但他们的偏好本质上是不可观测的。我们开发了一个机制设计框架来研究这个问题，并在静态和动态环境中刻画了最优机制。最优机制可以解释为竞争均衡，其中代理人面对个性化的、有拐点的预算集来交易任务。作为示例，我们将我们的结果应用于儿童保护服务调查员对虐待案件的分配。模拟显示，该机制将误报（不必要的寄养安置）减少了高达14%，同时降低了漏报（遗漏的虐待案件）和总体安置数量。

【**NBER**】: NBER Working Paper No. 32369，https://www.nber.org/papers/w32369

#### 24. New Gig Work or Changes in Reporting? Understanding Self-Employment Trends in Tax Data {#32368}

【**Author**】: Andrew Garin, Emilie Jackson, Dmitri K. Koustas
...
【**摘要**】：美国税收数据中自雇率的上升（而调查数据中并未出现）引发了猜测，即税务记录捕捉到了调查所遗漏的新型“零工”工作的增长。利用美国国税局（IRS）的全部纳税申报表数据，我们表明，企业向“零工”及其他合同工报告的付款趋势并不能解释向IRS报告的自雇收入增长；相反，这一增长是由处于劳动所得税抵免（EITC）收入递增区间内的个人的自报收入所驱动的。我们通过考察工人第一个孩子出生时间（围绕一个年末截止日期，该截止日期用于确定信贷资格，从而在劳动供给决策已成定局后，在纳税年度末产生外生的税率变化）来分离纯粹的报告反应与真实的劳动供给反应。我们发现，让劳动供给已成定局的工人面临负的边际税率，会大幅增加他们自报自雇收入的倾向——其中只有极小部分导致了在拐点处的聚集。与纯粹的策略性报告行为一致，我们发现，对于没有动机报告额外收入的纳税人，报告行为没有影响，并且对企业报告的任何类型的付款也没有影响。此外，我们发现这些报告反应随着时间的推移而增长，因为对税收激励的了解已变得普遍。量化分析表明，纳税人报告行为的变化是自报数据与第三方报告数据中自雇趋势差异的主要驱动因素。我们的发现表明，在衡量劳动力市场趋势时，在依赖自报税收数据而非其他数据来源之前应保持谨慎。

【**NBER**】: NBER Working Paper No. 32368，https://www.nber.org/papers/w32368

#### 25. Toward an Understanding of the Economics of Misinformation: Evidence from a Demand Side Field Experiment on Critical Thinking {#32367}

【**Author**】: John A. List, Lina M. Ramírez, Julia Seither, Jaime Unda, Beatriz Vallejo
...
【**摘要**】：错误信息对现代经济的社会结构构成了重大威胁。尽管错误信息市场的供给方已开始受到更多关注，但需求方却鲜有研究。我们通过2022年哥伦比亚总统选举期间的一项田野实验，从增强批判性思维技能的角度探讨了对错误信息的需求。来自约2000名个体的数据表明，我们的干预措施增强了批判性思维，使受试者更仔细地考虑潜在错误信息的真实性。此外，我们提供了证据表明，减少假新闻需求可以通过鼓励举报错误信息来实现减少假新闻传播的双重目标。

【**NBER**】: NBER Working Paper No. 32367，https://www.nber.org/papers/w32367

#### 26. Shocking Offers: Gender, Wage Inequality, and Recessions in Online Labor Markets {#32366}

【**Author**】: Belinda Archibong, Peter Blair Henry
...
【**摘要**】：利用尼日利亚最大在线求职门户网站的数据，我们记录了：(a) 工作薪资报价中的性别差异，以及 (b) (a) 对经济衰退的反应。在求职者性别比例偏向女性的行业中，工作起薪低于求职者性别比例偏向男性的行业。在尼日利亚2016年经济衰退期间，总体求职申请数量上升，但偏向男性行业的求职申请增长幅度大于偏向女性行业的求职申请。与偏向女性行业相比，偏向男性行业的薪资报价大幅下降。根据这种求职申请的相对变化，2016年薪资报价的性别差距几乎消失。

【**NBER**】: NBER Working Paper No. 32366，https://www.nber.org/papers/w32366

#### 27. One Factor to Bind the Cross-Section of Returns {#32365}

【**Author**】: Nicola Borri, Denis Chetverikov, Yukun Liu, Aleh Tsyvinski
...
【**摘要**】：我们提出了一种新的非线性单因子资产定价模型。尽管模型简洁，但它能精确表示任意具有任意数量因子和载荷的非线性模型——这是科尔莫戈罗夫-阿诺德表示定理的结果。该模型仅包含一个定价成分，由一个依赖于时变因子和因子载荷的非参数连接函数组成，我们使用基于筛子的估计器联合估计该函数。利用主要资产类别中的171种资产，我们的模型通过连接函数的低维近似实现了优越的横截面表现。在控制我们的单因子后，大多数已知的金融和宏观因子变得不显著。

【**NBER**】: NBER Working Paper No. 32365，https://www.nber.org/papers/w32365

#### 28. Does Inflation Affect Earnings Relevance? A Century-Long Analysis {#32364}

【**Author**】: Oliver Binz, John Graham, Matthew Kubic
...
【**摘要**】：财务报告以名义基础（未根据通货膨胀调整）列报资产、负债和盈余。利用近一个世纪财务报告的新数据集，本文考察了通货膨胀是否以及如何影响会计盈余与股票市场价值之间的关系，即盈余相关性。一方面，通货膨胀可能降低盈余相关性，因为历史成本会计依赖于历史交易价格，当通货膨胀改变价格水平时，这些价格的相关性降低。另一方面，通货膨胀可能通过提高企业的贴现率，从而将代理人的关注点转向更短期的收益，来增加盈余相关性。与后一种假设一致，我们记录了盈余相关性与通货膨胀之间的强正相关关系。横截面检验表明，这种关系对于对贴现率变化更敏感的企业更为强烈。我们发现，相对于先前文献中探讨的盈余相关性决定因素，通货膨胀具有一阶重要性。

【**NBER**】: NBER Working Paper No. 32364，https://www.nber.org/papers/w32364
...
【**摘要**】：COVID-19大流行引发了工作安排的重大转变。我首先根据工作安排与态度调查及其他来源，描述了美国这一转变的规模。然后，我回顾了大约2023年不同行业、人口群体和国家之间居家办公率的差异。这一重大转变对生产率产生了出人意料的良性（甚至积极）影响，这也是其得以持续的原因之一。与冲击现代经济的其他冲击相比，这一重大转变在其他方面也不同寻常：它放松了时间预算约束，改善了时间使用的灵活性，增强了个体自主性，放松了地点约束，推动了工人与工作和雇主之间的重大重新匹配，并改变了工资结构。这一重大转变还在向新工作安排和生活方式过渡期间降低了工资增长压力。平均而言，这一转变使工人受益，即使它降低了企业的非劳动成本和实际产品工资。

【**NBER**】: NBER Working Paper No. 32363，https://www.nber.org/papers/w32363

#### 30. Education and Adult Cognition in a Low-income Setting: Differences among Adult Siblings {#32362}

【**Author**】: Yuan S. Zhang, Elizabeth Frankenberg, Duncan Thomas
...
【**摘要**】：利用印度尼西亚家庭生活调查的数据，研究了完成的教育与成人认知之间的关系。我们比较了成年兄弟姐妹，以考虑可能影响这种关系的共同且难以衡量的特征，包括遗传因素以及父母的偏好和投资。在确定了共同家庭背景因素的重要性后，我们在包含兄弟姐妹固定效应的模型中记录了教育对认知的实质性且显著的影响。相比之下，教育与成人身高之间的强正相关在包含兄弟姐妹固定效应的模型中降至零，这表明除了兄弟姐妹共同的因素外，教育-身高关联中几乎没有污染。

【**NBER**】: NBER Working Paper No. 32362，https://www.nber.org/papers/w32362
...
【**摘要**】：1979年，全国青年纵向调查1979（NLSY79）开始追踪一组出生于1957年至1964年间的美国居民。四十多年来，它持续对这些相同个体进行重新访谈。尽管抽样期很长，但样本流失仍然较小。本文表明，经过40年的数据收集，剩余的NLSY79样本在关键劳动力市场结果方面仍然广泛代表其全国同龄群体。对于NLSY79的年龄队列，就业、工作小时数和收入的生命周期曲线与当前人口调查中的曲线相当。此外，25至55岁年龄段的平均终身收入与社会保障管理局数据中的相同指标高度一致。我们的结果表明，NLSY79可以继续为经济学家和其他社会科学家研究生命周期和终身劳动力市场结果（包括收入不平等）提供有用的数据。

【**NBER**】: NBER Working Paper No. 32361，https://www.nber.org/papers/w32361

#### 32. Bargaining and Dynamic Competition {#32360}

【**Author**】: Shanglyu Deng, Dun Jia, Mario Leccese, Andrew Sweeting
...
【**摘要**】：具有显著规模经济或干中学效应的行业可能最终由单一企业主导。经济学家使用买方是价格接受者或数量接受者的模型研究了这种情况发生的可能性及其效率，尽管这些行业通常也以买卖双方谈判为特征。我们扩展了Besanko、Doraszelski、Kryukov和Satterthwaite（2010）的动态“干中学与遗忘”模型，以允许纳什-纳什讨价还价定价。价格接受和社会计划者解决方案作为特例被纳入。我们表明，随着偏离价格接受假设，卖方的动态激励、市场集中度和福利可能发生剧烈且非单调的变化。我们研究了买方议价能力对多重均衡存在性、补贴政策设计以及旨在增加竞争的政策的福利效应的影响。

【**NBER**】: NBER Working Paper No. 32360，https://www.nber.org/papers/w32360

#### 33. Technological Progress and Rent Seeking {#32359}

【**Author**】: Vincent Glode, Guillermo Ordoñez
...
【**摘要**】：我们构建了一个模型，分析企业在创造剩余（即生产性）活动与获取剩余（即寻租性）活动之间的资源配置。模型预测，行业层面的技术进步——例如近期在数据收集与处理方面的进展——会促使资源不成比例地、且在社会效率低下的情况下向获取剩余的活动重新配置。随着技术改进，企业更加依赖寻租行为来获取利润，这内生地削弱了技术进步对经济进步的影响，并抬高了用于两类活动的资源价格。我们运用理论洞见来阐释高频交易的兴起。

【**NBER**】: NBER Working Paper No. 32359，https://www.nber.org/papers/w32359

#### 34. Slow Learning {#32358}

【**Author**】: Lawrence Christiano, Martin S. Eichenbaum, Benjamin K. Johannsen

【**Abstract**】: This paper analytically characterizes the speed of convergence under learning to a rational expectations equilibrium (REE) for a large class of multivariate models in which people’s beliefs about model outcomes are central determinants of those outcomes. The paper then investigates what features of an economy determine whether convergence under learning is fast or slow. We do so by applying our analytic results to the New Keynesian model and studying the impact of the Zero Lower Bound (ZLB) on the speed of convergence to a REE. Under certain circumstances, convergence of a learning equilibrium to the REE equilibrium can be so slow that policy analysis based on rational expectations is very misleading.

【**摘要**】：本文对一大类多元模型在学习过程中向理性预期均衡收敛的速度进行了分析性刻画。在这类模型中，人们对模型结果的信念是这些结果的核心决定因素。随后，本文探究了经济体的哪些特征决定了学习收敛是快速还是缓慢。我们通过将分析结果应用于新凯恩斯模型，并研究零下限对收敛至理性预期均衡速度的影响来展开分析。在某些情况下，学习均衡向理性预期均衡的收敛可能极其缓慢，以至于基于理性预期的政策分析会产生严重误导。

【**NBER**】: NBER Working Paper No. 32358，https://www.nber.org/papers/w32358

#### 35. Assessing the Costs of Balancing College and Work Activities: The Gig Economy Meets Online Education {#32357}

【**Author**】: Esteban M. Aucejo, A. Spencer Perry, Basit Zafar
...
【**摘要**】：对于越来越多需要自费上大学的学生以及希望提升技能的劳动者而言，平衡工作与学业需求是一项艰巨的任务。然而，灵活的学习和工作环境可能在缓解同时进行这两项活动所带来的诸多摩擦方面发挥重要作用。利用亚利桑那州立大学与优步合作（允许符合条件的司机免费注册在线大学课程）提供的详细（工作和学习努力）数据，我们分析了劳动力供给和学习努力如何响应劳动力市场状况及大学活动/任务的变化。我们的研究结果表明，平均每周在线大学活动增加10%，会导致每周在优步平台上花费的时间减少约1%，这表明工作时学习的“短期”机会成本较低。我们还发现，学习时间对劳动力市场状况的变化并不特别敏感，平均每周薪酬增加10%仅使学习时间减少2%。与这些结果一致，我们发现劳动者会利用其灵活的工作安排，在大学课程要求更高时改变通常的工作时间。在此背景下，我们未发现工作时间对学业成绩有不利影响，也未发现学习时间对工作表现（以司机评分或小费衡量）有不利影响。最后，在我们的样本学生中，他们对灵活工作和教育模式所赋予的（经诱导得出的）价值很高，他们将在线教育视为增加预期未来收入的重要途径。总体而言，这项研究强调，结合灵活的工作和学习模式，可能为许多通过工作来支付日益昂贵的大学费用的（低社会经济地位）学生以及旨在提升技能的劳动者提供一条合适的路径。

【**NBER**】: NBER Working Paper No. 32357，https://www.nber.org/papers/w32357

#### 36. Private Adoption of Public Good Technologies: The Case of PurpleAir {#32356}

【**Author**】: Joshua S. Graff Zivin, Benjamin Krebs, Matthew J. Neidell
...
【**摘要**】：我们研究了一种提供地方公共物品的技术——PurpleAir污染监测仪——的私人采用与扩散。从纯粹的信息角度来看，这些监测仪的理想间距应反映污染的空间相关程度。然而，与此形成鲜明对比的是，我们发现监测仪的采用在空间上高度集中于污染较轻的地区，这表明边际上被采用的监测仪所提供的额外公共信息微乎其微。此外，监测仪的采用主要发生在富裕且以白人为主的社区，这凸显了私人提供这种公共物品可能引发的环境正义问题。

【**NBER**】: NBER Working Paper No. 32356，https://www.nber.org/papers/w32356

#### 37. Financial Literacy and Financial Education: An Overview {#32355}

【**Author**】: Tim Kaiser, Annamaria Lusardi
...
【**摘要**】：本文对快速增长的关于金融素养与金融教育的实证文献进行了简洁的叙述性概述。我们首先讨论了关于金融素养人口统计学相关性的典型事实。接着，我们涵盖了关于金融素养对金融行为和结果影响的证据。最后，我们回顾了关于金融教育项目因果效应的证据，重点关注随机对照试验评估。文章最后对金融素养和金融教育未来的研究重点提出了展望。

【**NBER**】: NBER Working Paper No. 32355，https://www.nber.org/papers/w32355

#### 38. Macroeconomics of Mental Health {#32354}

【**Author**】: Boaz Abramson, Job Boerma, Aleh Tsyvinski
...
【**摘要**】：我们构建了一个关于心理健康的经济学理论。该理论植根于经典和现代精神病学文献，通过微观数据进行校准，并在生命周期异质性主体框架中形式化。在我们的模型中，经历精神疾病的个体持有悲观预期，并因反刍思维而损失时间。因此，他们工作更少、消费更少、对风险资产的投资更少，并且放弃治疗，这反过来又加剧了精神疾病。我们量化了精神疾病的社会负担，并评估了主要政策提案的有效性。我们表明，扩大治疗服务的可及性以及改善青少年晚期精神疾病的治疗，能够显著改善心理健康和福利。

【**NBER**】: NBER Working Paper No. 32354，https://www.nber.org/papers/w32354
...
【**摘要**】：担保债务——一种以抵押资产形式向债权人提供担保的债务合约——自古以来就是大多数社会信贷市场的基石。扣押和出售抵押品的能力减少了债务人违约未支付款项时债权人的预期损失。此外，当一家公司向具有不同优先级的多个债权人借款时，以资产担保的债务相对于其他债权人具有更高的优先级，并在公司破产时优先获得偿付。尽管理论和实证文献都已证明了担保债务的收益，但关于担保借款相关成本的认识仍然不足。本文调查了关于担保债务的新兴实证文献，并对担保债务的成本与收益进行了评估。

【**NBER**】: NBER Working Paper No. 32353，https://www.nber.org/papers/w32353

#### 40. Return Migration and Human Capital Flows {#32352}

【**Author**】: Naser Amanzadeh, Amir Kermani, Timothy McQuade
...
【**摘要**】：我们利用一个涵盖来自180个国家约4.5亿人就业历史的新数据集，研究回流移民以及技能型国际移民对各国人力资本存量的影响。回流移民是一种常见现象，38%的技能型移民在10年内返回其原籍国。回流移民与原籍国和目的国的行业增长显著相关，并且不对称地暴露于负面的企业就业增长。使用AKM风格模型，我们识别了工人和国家-企业固定效应，以及按地点和当前工作场所划分的经验和教育回报。对于新兴经济体的工人而言，在美国一年经验的回报比在原籍国一年经验的回报高出59-204%。移民到发达经济体的人在能力上相对于留守者呈正向选择，而在此移民群体内部，回流移民表现出较低的能力。模拟表明，消除技能型国际移民将对各国产生高度异质性的影响，使总（平均）人力资本存量在-60%至40%（-3%至4%）的范围内调整。

【**NBER**】: NBER Working Paper No. 32352，https://www.nber.org/papers/w32352

#### 41. Balancing Federalism: The Impact of Decentralizing School Accountability {#32351}

【**Author**】: Eric A. Hanushek, Patricia Saenz-Armstrong, Alejandra Salazar
...
【**摘要**】：教育政策虽然主要由州政府负责，但涉及地方、州和联邦层面的复杂决策。随着2001年《不让一个孩子掉队法案》引入基于考试的问责制，联邦政府的参与度大幅增加。然而，由于对该法案各部分的抵制，当国会于2015年通过《每个学生成功法案》时，联邦政策制定的参与度显著降低。这一政策变化使得我们能够评估联邦制调整的影响。通过观察各州如何应对其增强的决策角色，我们发现各州在针对教师的政策上从基于产出的方式后退，而这种后退与显著较低的学生成绩增长相关。因此，这种将联邦制调整为更低层级决策的做法似乎降低了全国范围内的学业成就。这里呈现的联邦制影响快照是影响的下限，因为更多州很可能会对ESSA的灵活性做出反应，并且更多学区会改变其教师队伍。

【**NBER**】: NBER Working Paper No. 32351，https://www.nber.org/papers/w32351

#### 42. The Gender Concealment Gap {#32350}

【**Author**】: Christine L. Exley, Raymond Fisman, Judd B. Kessler, Louis-Pierre Lepage, Xiaomeng Li, Corinne Low, Xiaoyue Shan, Mattie Toma, Basit Zafar

【**Abstract**】: We identify and explore a gender concealment gap when individuals have the opportunity to hide information about their performance from others. In data from two universities that allowed students to replace letter grades with “credit” on their transcripts, we find that men are substantially more likely than women to conceal grades that will harm their GPAs. The gender concealment gap persists across student traits and course features and generates inequity: the option to conceal leads to GPA gains that are 50% larger for men than for women. University data and complementary experimental evidence suggests that women may conceal less because they expect others will make worse inferences about their concealed grades.

【**摘要**】：我们识别并探讨了当个体有机会向他人隐藏其表现信息时存在的性别隐藏差距。来自两所大学的数据显示，学生可以用“学分”替代成绩单上的字母等级，我们发现男性比女性更倾向于隐藏会损害其GPA的成绩。这种性别隐藏差距在不同学生特征和课程特征中持续存在，并导致了不平等：隐藏选项带来的GPA提升，男性比女性高出50%。大学数据和补充实验证据表明，女性隐藏较少可能是因为她们预期他人会对其隐藏的成绩做出更差的推断。

【**NBER**】: NBER Working Paper No. 32350，https://www.nber.org/papers/w32350

#### 43. Mask Mandate Costs {#32349}

【**Author**】: Patrick Carlin, Shyam Raman, Kosali I. Simon, Ryan Sullivan, Coady Wing
...
【**摘要**】：本文展示了2022年初对超过4000名全国代表性样本参与者进行的一组关于口罩佩戴行为和意见的假设性问题的调查结果。口罩强制令在公共讨论中备受争议，尽管关于口罩益处的研究很多，但迄今为止尚无关于合规感知成本分布的研究。与旨在评估非市场活动社会价值的经济学研究常见做法一样，我们使用调查估值方法，询问参与者愿意支付多少费用以豁免于社区强制口罩规定。调查特别询问了三个月的豁免期。我们发现，大多数受访者（56%）不愿意为豁免强制口罩而付费。然而，平均每人愿意支付525美元，一小部分人群（0.9%）表示愿意支付超过5000美元以豁免于该强制令。年轻受访者比年长受访者表示愿意支付更高的金额以避免强制令。结合我们的结果与统计生命价值的标准衡量标准，我们估计，只有当该政策至少挽救13,333条生命时，三个月的口罩强制令才通过意愿支付问题被视为具有成本效益。

【**NBER**】: NBER Working Paper No. 32349，https://www.nber.org/papers/w32349

#### 44. Examiner and Judge Designs in Economics: A Practitioner's Guide {#32348}

【**Author**】: Eric Chyn, Brigham Frandsen, Emily C. Leslie
...
【**摘要**】：本文为实证研究人员提供了基于法官和审查员在实施处理或其他干预措施方面倾向性差异的研究设计的介绍和指南。我们回顾了该研究设计背后的基本理论，概述了该设计识别因果效应的假设条件，描述了这些假设的实证检验方法，并讨论了研究人员在估计过程中必须做出的选择所涉及的权衡。我们通过一个实证案例研究具体展示了概念和最佳实践，该案例使用审查员倾向性研究设计来研究审前拘留的影响。

【**NBER**】: NBER Working Paper No. 32348，https://www.nber.org/papers/w32348

#### 45. A Field Experiment on Antitrust Compliance {#32347}

【**Author**】: Kei Kawai, Jun Nakabayashi
...
【**摘要**】：我们通过进行一项实地实验来研究企业合规计划的有效性，在该实验中，我们向一部分日本企业披露，该企业可能正在从事非法的串通投标行为。我们发现，我们披露的信息影响了受处理企业的投标行为：在干预后，当应用于受处理企业的投标数据时，我们的串通投标检验更难以拒绝竞争的零假设。然而，我们发现有证据表明，这种变化并非企业停止合谋的结果。证据表明，即使在我们干预之后，企业仍在继续合谋，并且我们所记录的投标行为变化是合谋企业积极隐藏证据的结果。

【**NBER**】: NBER Working Paper No. 32347，https://www.nber.org/papers/w32347

#### 46. Human Capital Spillovers and Health: Does Living Around College Graduates Lengthen Life? {#32346}

【**Author**】: Jacob H. Bor, David M. Cutler, Edward L. Glaeser, Ljubica Ristovska
...
【**摘要**】：同等教育水平的人如果生活在受教育程度更高的地方，会更健康。在控制个人教育水平、人口统计特征和地区特征后，一个地区拥有大学学位的成年人比例每提高10个百分点，全因死亡率就会下降7%。地区人力资本也与较低的疾病患病率和自评健康状况的改善相关。地区教育与健康之间的关联在1990年至2010年间大幅增加。空间分类并不能驱动这些外部性；几乎没有证据表明病人会不成比例地迁移到受教育程度较低的地区。从医院质量到污染等健康相关便利设施的差异，最多只能解释地区人力资本对健康溢出效应的17%。地区人力资本与健康之间超过一半的相关性是由地区人力资本与吸烟和肥胖之间的相关性造成的。受教育程度更高的地区对吸烟有更严格的规定，并且对吸烟有更负面的看法。随着时间的推移，这些因素导致这些地区的人口吸烟率显著降低，肥胖率也较低，从而导致按地区教育程度划分的健康结果差异不断扩大。

【**NBER**】: NBER Working Paper No. 32346，https://www.nber.org/papers/w32346
...
【**摘要**】：美国许多安全网项目将福利资格与工作挂钩。取消工作要求可以更好地将福利瞄准最需要帮助的家庭，但会削弱促进工作的激励。利用行政记录，我们研究了将加州儿童税收抵免扩大到非工作者对母亲劳动供给的影响。我们依赖于准随机的生育时机以及一种使用安慰剂分析来最大化估计精度的新方法。取消工作要求导致极少数母亲退出劳动力市场；我们的95%置信区间排除了超过三分之一百分点的减少。我们的结果表明，将税收优惠扩大到最低收入家庭未必会显著降低劳动力参与率。

【**NBER**】: NBER Working Paper No. 32343，https://www.nber.org/papers/w32343

#### 50. The Limited Effects of U.S. Protests {#32342}

【**Author**】: Amory Gethin, Vincent Pons

【**Abstract**】: We provide systematic evidence on the effects of protests on public opinion, political behavior, and legislative policymaking. Drawing on a database covering the quasi-universe of protests held in the United States from 2017 to 2022, we identify 14 protest waves that covered topics related to environmental protection, gender equality, racial issues, gun control, immigration, and national and international politics. We use Twitter data, Google search volumes, high-frequency surveys, official election results, and data on politician behavior to track the evolution of online interest, policy views, vote intentions, and policies proposed and adopted before and after the onset of each protest wave. Combining national-level event studies with difference-in-differences designs that exploit variation in local protest intensity, we find that protests generate substantial internet activity but have minimal effects on other outcomes. The Black Lives Matter protests following George Floyd’s death are a notable exception. They increased both support for the Democratic Party and legislative activity on racial issues, suggesting that transgressive contention is more impactful than contained demonstrations. Finally, protests generally do not generate political backlash unless they become violent.

【**摘要**】：我们提供了关于抗议活动对公众舆论、政治行为和立法政策制定影响的系统性证据。基于一个涵盖2017年至2022年美国近乎所有抗议活动的数据库，我们识别出14次涉及环境保护、性别平等、种族问题、枪支管制、移民以及国内和国际政治议题的抗议浪潮。我们利用推特数据、谷歌搜索量、高频调查、官方选举结果以及政治家行为数据，追踪每次抗议浪潮爆发前后网络关注度、政策观点、投票意向以及提议和通过政策的演变。结合国家级事件研究与利用地方抗议强度差异的双重差分设计，我们发现抗议活动能产生大量互联网活动，但对其他结果的影响微乎其微。乔治·弗洛伊德去世后的“黑人的命也是命”抗议活动是一个显著的例外。它们增加了对民主党的支持以及种族问题上的立法活动，这表明越轨性抗争比受控示威更具影响力。最后，除非抗议活动演变为暴力，否则通常不会引发政治反弹。

【**NBER**】: NBER Working Paper No. 32342，https://www.nber.org/papers/w32342
...
【**摘要**】：我们在一个包含银行挤兑的宏观经济模型中考察银行监管。我们构建了一个一般均衡模型，其中银行可能因基本面原因或自我实现的挤兑而违约。当仅存在基本面违约时，我们证明竞争性均衡是约束有效的。然而，当银行容易受到挤兑时，银行的杠杆决策并非事前最优：单个银行没有内化更高的杠杆会使其他银行更加脆弱这一事实。该理论要求引入最低资本要求，即使在没有救助的情况下也是如此。

【**NBER**】: NBER Working Paper No. 32341，https://www.nber.org/papers/w32341

#### 52. Countries for Old Men: An Analysis of the Age Pay Gap {#32340}

【**Author**】: Nicola Bianchi, Matteo Paradisi
...
【**摘要**】：本研究探讨了高收入国家中老年工人与年轻工人之间日益扩大的工资差距。我们提出了一个劳动力市场的概念框架，其中企业无法改变老年员工的合同，也不能随意在其组织中增加更高层级的职位。在这个模型中，老年工人供给的增加以及经济增长的放缓限制了年轻工人获得高薪职位的机会，并扩大了有利于老年工人的年龄收入差距。利用广泛的行政和调查数据，我们记录了这些对年轻工人职业生涯的负面溢出效应的特征与模型的预测一致。随着老年工人职业生涯更加成功，年轻工人担任更高层级职位的可能性降低，并滑向工资分布的底部。在增长较慢、规模较大、历史较久以及平均工资较高的企业中，年轻工人与老年工人之间的收入差距增加更大，因为这些企业对年轻工人的负面溢出效应幅度更大。此外，年轻员工为高薪企业工作的可能性降低，而这些企业中老年工人的比例随着时间的推移不成比例地增加。最后，我们表明这些发现的其他替代解释几乎得不到实证支持。

【**NBER**】: NBER Working Paper No. 32340，https://www.nber.org/papers/w32340
...
【**摘要**】：本文考察了应用开发者向垄断设备制造商/应用商店运营商支付的移动应用佣金。我们证明了三个结果。第一，未受监管的应用佣金设定在最大化消费者剩余的水平。第二，取消应用佣金将导致设备价格上涨。第三，要求为消费者提供关于设备制造商如何从应用开发者处获得补贴的选项菜单，会以一种在消费者与应用开发者利益之间提供更均衡平衡的方式约束应用佣金。

【**NBER**】: NBER Working Paper No. 32339，https://www.nber.org/papers/w32339

#### 54. Heterogeneity and Endogenous Compliance: Implications for Scaling Class Size Interventions {#32338}

【**Author**】: Karun Adusumilli, Francesco Agostinelli, Emilio Borghesan
...
【**摘要**】：本文考察了田纳西州学生/教师成就比率（STAR）项目这一著名教育实验结果的可扩展性。我们探讨了实验设计与计量模型之间的错位如何影响研究者了解干预措施可扩展性的能力。我们记录了在缩减班级规模方面的合规性异质性，其程度比先前认识到的更为广泛，并讨论了这对实验评估的后果。在此发现的指导下，我们实施了一个新的计量经济学框架，该框架纳入了异质性处理效应和内生的班级规模决定。我们发现，班级规模对考试成绩的影响在不同学校之间存在显著差异，只有一小部分学校从缩减班级规模中获得了显著益处。我们讨论了这对干预措施可扩展性带来的挑战，并最后分析了有针对性的班级规模干预措施。

【**NBER**】: NBER Working Paper No. 32338，https://www.nber.org/papers/w32338

#### 55. The Declining Mental Health Of The Young And The Global Disappearance Of The Hump Shape In Age In Unhappiness {#32337}

【**Author**】: David G. Blanchflower, Alex Bryson, Xiaowei Xu
...
【**摘要**】：在众多研究中，主观幸福感随年龄呈U形分布，在人们步入中年之前下降，随后反弹。不幸福感则呈现镜像的驼峰形状。但这一经验规律已被不幸福感随年龄单调递减所取代。变化的原因是年轻人心理健康的恶化，无论是绝对水平还是相对于老年人而言。我们利用美国和英国的微观数据重新审视了不幸福感与年龄之间这种根本性变化的证据。大约从2011年开始，幸福感与年龄之间出现了单调递减的横截面关联。在英国，最近的COVID-19大流行加剧了这一趋势，对年轻人的幸福感影响最为严重，但在美国情况并非如此。我们使用2020-2024年期间的五个不幸福感指标，在包括美国和英国在内的34个国家中复制了不幸福感随年龄递减的现象，并确认了这些发现。

【**NBER**】: NBER Working Paper No. 32337，https://www.nber.org/papers/w32337

#### 56. Nothing for Something: Marketing Cancer Drugs to Physicians Increases Prescribing Without Improving Mortality {#32336}

【**Author**】: Colleen Carey, Michael Daly, Jing Li
...
【**摘要**】：医生通常从制药公司获得与营销相关的转移支付。我们研究了这些关系对医疗保险中医生处方抗癌药物行为的影响。我们发现，在收到付款后的十二个月内，相关药物的处方量增加了4%，这种增加在付款当月急剧开始，并在一年内逐渐消退。营销付款还导致医生开始治疗预期死亡率较低的癌症患者。虽然付款导致抗癌药物支出增加，但患者死亡率并未得到相应改善。

【**NBER**】: NBER Working Paper No. 32336，https://www.nber.org/papers/w32336

#### 57. The Global Life-Cycle Optimizer – Analyzing Fiscal Policy's Potential to Dramatically Distort Labor Supply and Saving {#32335}

【**Author**】: Johannes Brumm, Laurence J. Kotlikoff, Christopher Krause, Joshua Zanger
...
【**摘要**】：美国及其他国家的财政政策使得跨期预算变得不可微、非凸且不连续。因此，评估政策对工作和储蓄的反应需要全局优化。本文开发了全球生命周期优化器（GLO），它能够在高度复杂的财政环境中稳健且精确地定位全局最优解。我们使用GLO来研究一个典型化的美国财政体系如何扭曲工人的劳动供给和储蓄。该体系包含了联邦所得税级距、社会保障的FICA税以及低于门槛提供基本收入所导致的断点。GLO在非常广泛的工资率范围内重现了理论预测的收入聚集和翻转现象。储蓄扭曲及其相关的超额负担是巨大的。包含离散劳动供给、夫妻联合征税、社会保障和劳动收入风险的扩展应用展示了GLO的多功能性。GLO优于值函数迭代法，并能轻松解决值函数迭代法不可行的情况。

【**NBER**】: NBER Working Paper No. 32335，https://www.nber.org/papers/w32335

#### 58. Religious Worship Attendance in America: Evidence from Cellphone Data {#32334}

【**Author**】: Devin G. Pope

【**Abstract**】: WP 32334 is currently unavailable; please check back at a later date.

【**摘要**】：工作论文32334目前不可用；请稍后再查看。

【**NBER**】: NBER Working Paper No. 32334，https://www.nber.org/papers/w32334

#### 59. Neighborhood Effects: Evidence from Wartime Destruction in London {#32333}

【**Author**】: Stephen J. Redding, Daniel M. Sturm
...
【**摘要**】：我们利用二战期间德国对伦敦的轰炸作为外生变异来源，为邻里效应提供证据。我们构建了一个新数字化的数据集，涵盖二战前后伦敦单个建筑层面的战时破坏、房产价值和社会经济构成。我们开发了一个定量城市模型，在该模型中，异质性群体根据自然优势、战时破坏和邻里效应的差异，内生地在不同地点进行分类。我们发现存在强烈且局部的邻里效应，这些效应放大了战时破坏的直接影响，并对观察到的不同地点社会经济结果的差异做出了实质性贡献。

【**NBER**】: NBER Working Paper No. 32333，https://www.nber.org/papers/w32333
...
【**摘要**】：近年来，数字技术和金融科技公司迅速重塑了消费者金融格局，并有可能帮助消费者做出更好的决策并改善其财务健康状况。现有的技术如自动支付，其采用率也在增加，这一趋势可能因开放银行等创新而加速。我研究了自动支付如何影响一家金融科技公司服务的信用卡客户的支付行为。利用公司实践中的急剧变化，采用断点回归设计，我发现一个小小的推动就解释了样本期间一半的自动支付注册，并且在开户时的注册具有持续性。自动支付将进行最低还款的可能性提高了20到29个百分点，使基准率翻了一倍以上。结果表明，看似微不足道的技术默认设置可能对消费者信贷结果产生经济上显著的影响。

【**NBER**】: NBER Working Paper No. 32332，https://www.nber.org/papers/w32332

#### 61. How You Pay Drives What You Choose: Health Savings Accounts versus Cash in Health Insurance Plan Choice {#32331}

【**Author**】: Jonathan Gruber, Mengyun M. Lin, Haoming Liu, Junjian Yi
...
【**摘要**】：健康保险计划选择的一个显著特征是通过过度重视保费相对于自付支出来做出不一致的选择。我们表明，当两种类型的支出来自同一指定资金来源时，这种不一致的来源就会消失。我们专注于新加坡的保健储蓄计划，居民可以用现金或保健储蓄基金支付健康保险保费，但受到因年龄和时间而变化的限额约束。通过利用这些限额的变化，我们一致地发现，当个人能够用保健储蓄基金支付健康保险保费时，他们对价格不那么敏感，更愿意加入更慷慨的计划——这导致了更低的支出水平和方差，以及市场中更低程度的逆向选择。结果表明，心理账户在保险决策中扮演着重要角色。

【**NBER**】: NBER Working Paper No. 32331，https://www.nber.org/papers/w32331

#### 62. Global Spillovers from FED Hikes and a Strong Dollar: The Risk Channel {#32330}

【**Author**】: José Cristi, Ṣebnem Kalemli-Özcan, Mariana Sans, Filiz D. Unsal
...
【**摘要**】：我们研究了美国货币政策（美联储加息）和强势美元的国际传导。这两个变量都是内生的，因此我们遵循文献的最新发展，从世界其他国家的角度衡量各自的 exogenous 成分。我们表明，虽然美国货币政策冲击作为金融冲击，增加了新兴市场的风险溢价，但美元冲击并不会产生同样的效果。

【**NBER**】: NBER Working Paper No. 32330，https://www.nber.org/papers/w32330

#### 63. Global Transmission of FED Hikes: The Role of Policy Credibility and Balance Sheets {#32329}

【**Author**】: Ṣebnem Kalemli-Özcan, Filiz D. Unsal
...
【**摘要**】：与历史事件相反，2022-2023年美国货币政策的紧缩尚未在新兴市场引发金融危机。为什么这次不同？为了回答这个问题，我们通过历史证据的视角来分析当前形势。在新兴市场，基于金融渠道的美国政策传导历史上导致了比发达经济体更不利的结果，而在发达经济体中，贸易渠道无法平滑这些负面影响。当美联储加息时，全球投资者倾向于因全球金融状况收紧而抛售风险资产，由于新兴市场信用评级较低且风险状况较高，其受到的影响更为严重。这一次，逃离新兴市场资产和风险利差上升的情况有限。我们记录到，历史上较高的风险利差和资本外流在很大程度上可以解释为缺乏可信的货币政策和美元计价债务。货币政策框架的改善，加上美元计价债务水平的降低，帮助新兴市场抵御了最近的美联储加息。

【**NBER**】: NBER Working Paper No. 32329，https://www.nber.org/papers/w32329

#### 64. Smoke from Factory Chimneys: The Applied Economics of Air Pollution in the Progressive Era {#32328}

【**Author**】: H. Spencer Banzhaf, Randall Walsh
...
【**摘要**】：与今天一样，一百年前，空气污染是世界上污染最严重的城市中一个严重关切的问题。在其著名的1908-9年社会调查之后，匹兹堡市委托匹兹堡大学著名制度经济学家约翰·T·霍尔兹沃思进行了一项“匹兹堡经济调查”。尽管范围广泛，但该报告开篇即指出：“匹兹堡的首要基本需求是消除烟雾。”这份报告之后进行了一系列烟雾调查，令人惊讶的是，调查中将罐子放置在城市的各个地方，并每月称量其中的灰烬。在一项应用中，霍尔兹沃思的助手约翰·J·奥康纳估计了烟雾的经济成本。奥康纳的工作可以说是第一项损害成本研究，它挑战了我们对进步时代什么是“经济”的理解。

【**NBER**】: NBER Working Paper No. 32328，https://www.nber.org/papers/w32328
...
【**摘要**】：分类变量没有内在排序，研究者通常在实证分析中采用固定效应方法。然而，这种方法有两个显著局限：它忽略了与分类变量相关的文本标签；并且当某个类别中观测值有限时，会产生不稳定的结果。本文提出一种新方法，利用大语言模型的最新进展来恢复分类变量中被忽视的信息。我们将该方法应用于研究劳动力市场错配。具体而言，我们让大语言模型模拟人力资源专家的角色，评估具有特定特征的求职者是否适合某个给定职位。主要发现可概括为三部分。第一，利用来自在线职位发布平台的综合行政数据，我们表明新的匹配质量度量与文献中若干传统度量正相关，同时，我们强调大语言模型在传统度量条件下提供额外信息的能力。第二，我们通过一项包含信息远少于行政数据的调查数据，展示了新方法的广泛适用性，而传统匹配质量度量大多无法基于该调查数据计算。利用易于获取的调查数据，我们的大语言模型度量成功复制了在难以获取的行政数据集中观察到的大部分显著模式。第三，我们研究了匹配质量中的性别差距，并探讨招聘过程中是否存在性别刻板印象。我们模拟了一项审计研究，考察向大语言模型透露性别信息是否会影响其评估。我们发现，当性别信息被披露给GPT时，该模型认为女性更适合传统上由女性主导的职位。

【**NBER**】: NBER Working Paper No. 32327，https://www.nber.org/papers/w32327

#### 66. After the Storm: How Emergency Liquidity Helps Small Businesses Following Natural Disasters {#32326}

【**Author**】: Benjamin L. Collier, Sabrina T. Howell, Lea Rendell
...
【**摘要**】：紧急信贷能否防止长期财务困境？我们研究了自然灾害后政府向小企业提供的复苏贷款的因果效应。快速的资金注入可能使有生存能力的企业得以存活并增长，也可能使脆弱的企业背负更多风险和利息负担而陷入困境。我们发现，这些贷款降低了企业退出和破产率，增加了就业和收入，释放了私人信贷，并减少了拖欠。这些效应，尤其是对私人信贷的挤入效应，似乎反映了对修复不确定性的消除。我们没有发现资本从邻近企业重新配置的证据，并且看到了一些对本地新进入企业的正向溢出效应。

【**NBER**】: NBER Working Paper No. 32326，https://www.nber.org/papers/w32326

#### 67. Interdependent Values in Matching Markets: Evidence from Medical School Programs in Denmark {#32325}

【**Author**】: Benjamin Friedrich, Martin B. Hackmann, Adam Kapor, Sofia J. Moroni, Anne Brink Nandrup
...
【**摘要**】：本文提供了双边匹配市场中相互依赖价值和市场参与者战略反应的首次实证证据。我们考虑丹麦医学院项目的市场，该市场使用集中分配机制。利用独特的行政数据和一项信息实验，我们表明学生和竞争项目持有与收益相关的信息，每个项目可利用这些信息录取具有更高坚持率的学生。项目通过表现出对本地申请者的“本地偏好”，来应对这两种相互依赖价值的来源——学生自我选择和相互依赖的项目价值。我们构建并估计了一个反映这一证据的新颖均衡模型，发现完全共享信息可以显著提高学生坚持率和项目收益，但允许学生沟通第一志愿则不会改变结果。一个假设独立私人价值的替代模型与实证证据相矛盾，突显了在理解和设计匹配市场时考虑相互依赖价值的重要性。

【**NBER**】: NBER Working Paper No. 32325，https://www.nber.org/papers/w32325

#### 68. Monetary Policy, Segmentation, and the Term Structure {#32324}

【**Author**】: Rohan Kekre, Moritz Lenel, Federico Mainardi

【**Abstract**】: We develop a segmented markets model which rationalizes the effects of monetary policy on the term structure of interest rates. When arbitrageurs’ portfolio features positive duration, an unexpected rise in the short rate lowers their wealth and raises term premia. A calibration to the U.S. economy accounts for much of the transmission of monetary shocks to long rates. We discuss the additional implications of our framework for state-dependence in policy transmission, the volatility and slope of the yield curve, and trends in term premia accompanying trends in the natural rate.

【**摘要**】：我们构建了一个分割市场模型，该模型解释了货币政策对利率期限结构的影响。当套利者的投资组合具有正久期时，短期利率的意外上升会降低其财富并提高期限溢价。对美国经济的校准解释了货币政策冲击向长期利率传导的很大一部分。我们讨论了我们的框架对政策传导的状态依赖性、收益率曲线的波动性和斜率，以及伴随自然利率趋势的期限溢价趋势的额外含义。

【**NBER**】: NBER Working Paper No. 32324，https://www.nber.org/papers/w32324

#### 69. Homelessness and the Persistence of Deprivation: Income, Employment, and Safety Net Participation {#32323}

【**Author**】: Bruce D. Meyer, Angela Wyse, Gillian Meyer, Alexa Grunwaldt, Derek Wu
...
【**摘要**】：无家可归可以说是美国与贫困相关的最极端困难，然而经历无家可归的人群被排除在官方贫困统计和大部分极端贫困文献之外。本文提供了迄今为止关于该人群所面临物质劣势水平和持续性的最详细、最准确的描述，包括基于行政数据的首个全国性收入、就业和安全网参与估计。从2010年人口普查中首次获取的、具有全国代表性的、记录为收容所和无家可归的成年人大型样本出发，我们链接了受限使用的纵向税务记录以及关于补充营养援助计划、医疗保险、医疗补助、残疾保险、补充保障收入、退伍军人福利、住房援助和死亡率的行政数据。这些成年人中近一半在被观察到无家可归的年份有正式工作，几乎所有人在至少一个安全网项目中工作或得到覆盖。尽管如此，在观察到无家可归时期前后的十年间，他们的收入仍然很低，这表明无家可归往往发生在长期严重贫困的背景下，而非收入大幅突然损失。人们之所以经历无家可归，是因为尽管与劳动力市场和安全网有联系，但他们仍然非常贫困，低持久性收入使他们即使在生活状况发生微小干扰时也容易失去住房。

【**NBER**】: NBER Working Paper No. 32323，https://www.nber.org/papers/w32323

#### 70. The Dominant Role of Expectations and Broad-Based Supply Shocks in Driving Inflation {#32322}

【**Author**】: Paul Beaudry, Chenyu Hou, Franck Portier
...
【**摘要**】：本文旨在评估供给冲击、劳动力市场紧张程度和预期形成在解释通胀爆发中的作用。我们首先表明，在疫情前流行的准平坦菲利普斯曲线仍然很好地拟合了2020年后的美国数据，并且由供给冲击引起的短期通胀预期变化可能在近期通胀事件中发挥了主要作用。然后，我们记录了通胀和通胀预期联合动态的特征。鉴于在理性预期下难以重现这些动态，我们提出并评估了一个具有不完全信息和有限理性的模型。在我们的模型中，主体认为部门通胀是由经济所有部门共有的一个组成部分和部门特定冲击驱动的。当供给冲击影响许多部门（我们称之为广泛供给冲击）时，主体推断通胀的共同组成部分已经上升，这通过其对预期的影响驱动了持续的通胀动态。我们表明，与完全理性的偏离是微小的，但这足以使广泛供给冲击以解释数据所需的方式随时间被放大和传播。

【**NBER**】: NBER Working Paper No. 32322，https://www.nber.org/papers/w32322

#### 71. Quantitative Tightening Around the Globe: What Have We Learned? {#32321}

【**Author**】: Wenxin Du, Kristin Forbes, Matthew N. Luzzetti
...
【**摘要**】：本文利用近期各国量化紧缩的经验来评估央行缩表的影响。我们分析了七个发达经济体（澳大利亚、加拿大、欧元区、新西兰、瑞典、英国和美国）的经验——记录了不同的策略以及已经发生的央行资产负债表实质性缩减。然后，我们评估了量化紧缩公告对收益率和一系列其他市场价格产生的宏观经济和金融影响。量化紧缩公告提高了政府债券收益率，使收益率曲线陡峭化，并可能预示着提高政策利率的更大承诺，但对大多数其他金融市场指标的影响较为有限。主动量化紧缩比被动量化紧缩影响更大，尤其是在较长期限上。量化紧缩的实施与隔夜融资利差的温和上升和政府债券“便利收益率”的下降有关，但量化紧缩交易并未显著影响政府债务证券的定价和市场流动性。最后，我们评估了央行缩表时谁在购买资产，如果央行继续减少其证券持有量而政府债务发行仍处于高位，这一问题将变得越来越重要。我们发现，国内非银行机构需求的增加在很大程度上弥补了央行债券持有量的减少。这一系列跨国结果表明，量化紧缩的影响比“看油漆干”更大，但远非简单地逆转在市场压力时期启动的量化宽松计划的效果。展望未来，尽管迄今为止量化紧缩进展顺利，但摩擦可能会在未来增加，从而使量化紧缩迅速演变为更像“看水烧开”。

【**NBER**】: NBER Working Paper No. 32321，https://www.nber.org/papers/w32321

#### 72. Application Flows {#32320}

【**Author**】: Steven J. Davis, Brenda Samaniego de la Parra

【**Abstract**】: We build and analyze a new U.S. database that links 125 million applications to job vacancies and employer-side clients on Dice.com, an online platform for jobs and workers in software design, computer systems, engineering, financial analysis, management consulting, and other occupations that require technical skills. We find, first, that posting durations are quite short, often only two or three days, with a median of seven days. Second, unlike vacancy durations, posting durations do not lengthen with market tightness. Third, job seekers display a striking propensity to target new postings, with almost half of applications flowing to openings posted in the past 48 hours. Fourth, applications per posting are much too uneven to reflect random search, even within narrow market segments and job categories. Moreover, posted offer wages play no role in explaining the deviations from a random-search benchmark. Fifth, intermediaries play a huge role on both sides of the platform: Recruitment and staffing firms account for two-thirds of all postings and attract most of the applications. We relate these and other findings to theories of labor market search.

【**摘要**】：我们构建并分析了一个新的美国数据库，该数据库将1.25亿份求职申请与Dice.com上的职位空缺和雇主端客户联系起来。Dice.com是一个面向软件设计、计算机系统、工程、财务分析、管理咨询以及其他需要技术技能的职业的求职者和雇主的在线平台。我们首先发现，职位发布持续时间相当短，通常只有两三天，中位数为七天。其次，与职位空缺持续时间不同，发布持续时间不会随市场紧张程度而延长。第三，求职者表现出惊人的倾向，即瞄准新发布的职位，近一半的申请流向过去48小时内发布的空缺。第四，每个职位的申请数量极不均匀，无法反映随机搜索，即使在狭窄的市场细分和职位类别内也是如此。此外，公布的报价工资在解释与随机搜索基准的偏离方面不起任何作用。第五，中介在平台双方都发挥着巨大作用：招聘和人员配置公司占所有职位发布的三分之二，并吸引了大部分申请。我们将这些发现及其他发现与劳动力市场搜索理论联系起来。

【**NBER**】: NBER Working Paper No. 32320，https://www.nber.org/papers/w32320

#### 73. Tracking Firm Use of AI in Real Time: A Snapshot from the Business Trends and Outlook Survey {#32319}

【**Author**】: Kathryn Bonney, Cory Breaux, Cathy Buffington, Emin Dinlersoz, Lucia S. Foster, Nathan Goldschlag, John C. Haltiwanger, Zachary Kroff, Keith Savage
...
【**摘要**】：及时且准确地衡量企业对人工智能的使用，对于理解人工智能对美国经济的影响既充满挑战又至关重要。我们基于2023年9月至2024年2月的商业趋势与展望调查，提供了当前及预期未来企业将人工智能用于商业目的的新实时估计。在此期间，人工智能使用率的双周估计值从3.7%上升至5.4%，预计到2024年初秋将达到约6.6%。在使用人工智能的企业中，员工占比更高，尤其是在大型企业和信息行业。人工智能在大型企业中使用率更高，但人工智能使用率与企业规模之间的关系是非单调的。相比之下，人工智能在年轻企业中使用率更高，尽管按就业加权计算，其与企业年龄呈U型关系。人工智能的常见用途包括营销自动化、虚拟代理以及数据/文本分析。人工智能用户通常利用人工智能来替代工人任务和设备/软件，但很少有人报告因使用人工智能而导致就业减少。许多企业为了适应人工智能而进行组织变革，特别是通过培训员工、开发新工作流程以及购买云服务/存储。与其他企业相比，人工智能用户还表现出更好的整体绩效和更高的就业扩张发生率。不采用人工智能的最常见原因是人工智能不适用于该业务。

【**NBER**】: NBER Working Paper No. 32319，https://www.nber.org/papers/w32319

#### 74. Theory-Driven Entrepreneurial Search {#32318}

【**Author**】: Ankur Chavda, Joshua S. Gans, Scott Stern
...
【**摘要**】：基于理论的创业者应如何搜索策略来实施他们的想法？基于理论的战略观认为，决策者持有关于其环境的理论，这些理论基于应被积极检验的信念。这种构成基于理论观基础的因果框架，对创业搜索（即创业者发现实施其想法策略的过程）也具有启示意义。在本文中，我们开发了一个贝叶斯模型，其中创业者在进行创业搜索时会更新他们的信念。我们为基于理论的创业者找到了几种最优行为，例如在发现相对较差的策略后恢复到先前的策略，以及在发现相对较好的策略后继续搜索，而当创业者缺乏这种基于理论的方法时，这些行为是缺失的。由于这些预测与成功创业者的案例相符，我们的发现既提供了一种实证识别熟练创业者的方法，也展示了将基于理论的观点更普遍地应用于创业行为的有用性。

【**NBER**】: NBER Working Paper No. 32318，https://www.nber.org/papers/w32318

#### 75. The Impact of Green Investors on Stock Prices {#32317}

【**Author**】: Gong Cheng, Eric Jondeau, Benoit Mojon, Dimitri Vayanos
...
【**摘要**】：我们在一个动态均衡模型中研究绿色投资者对股票价格的影响，其中投资者分为绿色投资者、被动投资者和主动投资者。绿色投资者追踪一个逐步排除最棕色公司股票的指数；被动投资者持有所有股票的价值加权指数；主动投资者持有所有股票的均值-方差有效投资组合。与文献相反，我们发现最棕色公司的股票价格大幅下跌，而绿色公司的股票价格温和上涨。这些效应主要发生在绿色指数形成的公告期间，并在排除阶段持续存在。公告效应意味着早期采用脱碳战略者具有先发优势。

【**NBER**】: NBER Working Paper No. 32317，https://www.nber.org/papers/w32317
...
【**摘要**】：近年来，非银行金融中介的资产相对于银行显著增长。这两个部门通常被视为要么并行运作、从事不同活动，要么作为替代品、从事实质上相似的活动，其中银行处于银行监管范围内，而非银行金融中介则处于监管范围之外。相反，我们认为非银行金融中介与银行的业务和风险如此交织，以至于它们最好被描述为随时间发生了转变，而非从银行迁移到了非银行金融中介。这些转变至少部分是对监管的回应，并且使得银行作为非银行金融中介的常规和紧急流动性提供者仍然具有特殊性。我们通过以下方式支持这一观点：（i）美国新的和增强的金融账户数据（“从谁到谁”）显示，银行和非银行金融中介相互融资，非银行金融中介尤其依赖银行；（ii）案例研究和监管数据显示，银行仍然面临信用和融资风险（这些风险乍看之下似乎已转移至非银行金融中介），以及因向非银行金融中介提供信贷额度而产生的或有流动性风险；（iii）实证工作通过其异常股票收益与基于市场的系统性风险度量的相关性，确认了银行与非银行金融中介之间的关联。我们讨论了一些潜在的监管应对措施，包括整体对待这两个部门；认识到对风险传播和放大的影响；以及探索将系统性风险成本内部化的新方法。

【**NBER**】: NBER Working Paper No. 32316，https://www.nber.org/papers/w32316

#### 77. The Effects of Medical Debt Relief: Evidence from Two Randomized Experiments {#32315}

【**Author**】: Raymond Kluender, Neale Mahoney, Francis Wong, Wesley Yin
...
【**摘要**】：五分之二的美国人负有医疗债务，其中近一半人至少欠款2500美元。出于对这种负担的担忧，政府和私人捐助者已采取大规模、高知名度的努力来减免医疗债务。我们与RIP医疗债务（现为Undue医疗债务）合作，在2018年至2020年间进行了两项随机实验，为83,401人减免了面值1.69亿美元的医疗债务。我们的实验聚焦于已出售给收债机构的下游医疗债务，其中一项实验恰逢行业范围内向征信机构报告医疗债务的普遍撤回，这使我们能够估计在有和没有反事实报告情况下的债务减免效应。我们使用信用报告、催收账户数据和多模式调查来追踪结果。有三组结果。首先，当存在反事实信用报告时，我们发现信用获取略有改善，但在没有反事实信用报告时，对信用报告结果没有影响。其次，我们估计债务减免导致现有医疗账单支付适度但统计上显著的减少。第三，我们发现对心理健康和身体健康、医疗保健利用以及财务健康的调查指标没有影响。综合来看，我们的结果表明，先前研究中记录的高度相关性并未转化为下游医疗债务减免的因果效应。

【**NBER**】: NBER Working Paper No. 32315，https://www.nber.org/papers/w32315

#### 78. Inequality and Racial Backlash: Evidence from the Reconstruction Era and the Freedmen’s Bureau {#32314}

【**Author**】: Eric Chyn, Kareem Haggag, Bryan A. Stuart
...
【**摘要**】：在种族极化环境中，多数群体如何应对不平等的缩小？我们通过研究自由民局（美国内战后创建的一个机构，旨在为前奴隶提供援助并在南方启动制度改革）的影响来探讨这个问题。我们使用新的历史记录和事件研究方法，估计该局对南方政治经济的影响。在战后十年内，设有自由民局外地办事处的县，民主党（在内战期间曾倡导奴隶制并在重建时期反对黑人公民权利的主要政党）的得票率下降。从长期来看，我们发现了反弹的证据，表现为民主党得票率上升以及多种形式的种族暴力（包括私刑和对黑人学校的袭击）增加。这种反弹持续到二十世纪，我们发现曾经设有自由民局外地办事处的县，第二波和第三波三K党活动率更高，代际经济流动性更低。总体而言，我们的结果表明，自由民局的初始影响刺激了白人多数群体的对抗性反应，他们试图抵消美国黑人的社会进步。

【**NBER**】: NBER Working Paper No. 32314，https://www.nber.org/papers/w32314
...
【**摘要**】：我们开发了一种经验贝叶斯排序程序，为有噪声的测量值分配顺序等级，在分配等级的信息内容与预期排序错误频率之间取得平衡。将该方法应用于一项大规模通信实验，我们对97家美国雇主的种族和性别联系差距进行评级，并首次披露这些雇主的身份。这些等级与每个公司联系差距的不确定性度量一起，呈现在一份易于理解的报告卡中，该报告卡可轻松适用于其他对等级和水平同时感兴趣的场合。

【**NBER**】: NBER Working Paper No. 32313，https://www.nber.org/papers/w32313

#### 80. Quantifying the Uncertainty of Imputed Demographic Disparity Estimates: The Dual-Bootstrap {#32312}

【**Author**】: Benjamin Lu, Jia Wan, Derek Ouyang, Jacob Goldin, Daniel E. Ho
...
【**摘要**】：衡量结果在种族或民族群体间的平均差异是公平评估的关键第一步，但研究人员通常缺乏获取个人种族和民族数据来计算这些差异的途径。一个常见的解决方案是使用代理变量来估算缺失的种族或民族标签，然后使用这些估算值来估计差异。传统的标准误错误地描述了由此产生的估计值的不确定性，因为它们将估算模型视为已知和固定的，而不是一个必须带有不确定性进行估计的未知对象。我们提出了一种双重自助法，明确考虑了测量不确定性，从而能够进行更准确的统计推断，我们通过模拟证明了这一点。此外，我们将我们的方法应用于常用的贝叶斯改进姓氏地理编码（BISG）估算算法，在该算法中，由于底层人口普查局数据不可用，直接自助法不可行。在模拟中，我们发现除了特定情况外，测量不确定性对BISG通常不显著；偏差（而非方差）很可能是误差的主要来源。我们将我们的方法应用于使用美国家庭队列数据，按种族量化常见健康状况患病率估计的不确定性。

【**NBER**】: NBER Working Paper No. 32312，https://www.nber.org/papers/w32312

#### 81. Ideology, Incidence and the Political Economy of Fuel Taxes: Evidence from the California 2018 Proposition 6 {#32311}

【**Author**】: Lucas Epstein, Erich Muehlegger
...
【**摘要**】：2018年，加州选民否决了第6号提案，该投票倡议旨在废除作为2017年《道路修复与责任法案》一部分而颁布的州汽油税和车辆费。我们研究了对该提案的支持、政治意识形态以及该法案所施加的经济负担之间的关系。对于每户每年一百美元的强加成本，我们估计对该提案的支持率上升了3到9个百分点。值得注意的是，我们发现，在最保守的地区，投票与政策经济负担之间的关系比在最自由的地区要强七倍。由于加州及其他地区的保守地区往往比自由地区承受更高的交通和能源税负担，对经济负担反应的异质性对环保税的民众支持度以及关于如何为未来道路基础设施融资的持续政策辩论具有重要意义。

【**NBER**】: NBER Working Paper No. 32311，https://www.nber.org/papers/w32311

#### 82. Effects of Income on Infant Health: Evidence from the Expanded Child Tax Credit and Pandemic Stimulus Checks {#32310}

【**Author**】: Wei Lyu, George Wehby, Robert Kaestner
...
【**摘要**】：在COVID-19疫情期间，联邦政府发放了刺激支票并扩大了儿童税收抵免。这些疫情支付因婚姻状况和家庭中儿童数量而异，且数额可观，一些家庭收到了数千美元。我们利用这种看似外生的收入变化来估计收入对婴儿健康的影响。我们衡量了怀孕期间或出生前一年收到的疫情支付总额，并检验了这笔额外收入如何影响出生体重、低出生体重发生率、孕周和胎儿生长。数据来自出生证明，分析按母亲婚姻状况和教育程度（高中以下或高中）分别进行，以仅隔离因子女数量（胎次）差异导致的疫情支付变化。估计结果表明，这些疫情现金支付对婴儿健康没有统计学上显著、或临床或经济上有意义的影响。总体而言，研究结果表明，怀孕期间的收入转移对婴儿健康的社会经济差异影响甚微。

【**NBER**】: NBER Working Paper No. 32310，https://www.nber.org/papers/w32310

#### 83. Identification of Marginal Treatment Effects using Subjective Expectations {#32309}

【**Author**】: Joseph S. Briggs, Andrew Caplin, Søren Leth-Petersen, Christopher Tonetti
...
【**摘要**】：我们开发了一种方法来识别个体进入处理的潜在倾向以及边际处理效应。该识别通过关于个体对其处理倾向和处理条件结果的预期的主观预期调查数据实现。我们使用该方法研究生育如何影响丹麦的女性劳动力供给。我们发现有限的潜在异质性以及巨大的短期效应，这些效应在产后18个月消失。我们通过使用行政数据表明，使用我们的方法计算的处理组的平均处理效应与传统事件研究方法的计算结果几乎相等，从而支持了该背景下识别假设的有效性。最后，我们研究了儿童保育成本和质量的假设性变化对女性劳动力供给的影响。

【**NBER**】: NBER Working Paper No. 32309，https://www.nber.org/papers/w32309
...
【**摘要**】：我们提出了一个简单的长期总需求和总供给框架来评估长期通胀。该框架说明了外生的经济和政经因素如何产生央行压力，这些压力可以影响长期通胀以及稳态之间的转换。我们利用这一分析为过去四十年推动全球通胀下行的力量提供了一个新的视角。我们认为，为了使通胀在未来保持低位和稳定，政经因素，例如加强央行独立性或更可信的公共债务政策，将需要抵消目前推动平均长期通胀上行的全球经济压力。

【**NBER**】: NBER Working Paper No. 32308，https://www.nber.org/papers/w32308

#### 85. Mortality Burden From Wildfire Smoke Under Climate Change {#32307}

【**Author**】: Minghao Qiu, Jessica Li, Carlos F. Gould, Renzhi Jing, Makoto Kelp, Marissa Childs, Mathew Kiang, Sam Heft-Neal, Noah Diffenbaugh, Marshall Burke
...
【**摘要**】：美国的野火活动有所增加，并预计在未来气候变化下会加速。然而，我们对气候变化对野火烟雾和健康影响的理解仍然高度不确定。我们量化了美国过去和未来因野火烟雾细颗粒物（PM2.5）导致的死亡率负担。我们构建了一个统计和机器学习模型的集成，将气候变异与野火烟雾PM2.5联系起来，并使用2006年至2019年美国所有记录死亡的地理参考数据，实证估计了烟雾PM2.5与死亡率之间的关系。我们预测，在高变暖情景下，到2050年，气候驱动的未来烟雾PM2.5增加可能导致每年27,800例超额死亡，比2011-2020年的估计平均值增加76%。2025年至2055年间，野火烟雾PM2.5导致的累计超额死亡可能超过700,000例。当货币化时，到本世纪中叶，气候导致的烟雾死亡每年造成2440亿美元的损失，与先前分析中美国所有其他损失的总和估计值相当。我们的研究表明，气候驱动的野火烟雾的健康成本可能是美国气候变暖最重要且代价最高的后果之一。

【**NBER**】: NBER Working Paper No. 32307，https://www.nber.org/papers/w32307

#### 86. Taxation of Capital: Capital Levies and Commitment {#32306}

【**Author**】: Robert J. Barro, Varadarajan V. Chari
...
【**摘要**】：Chamley和Judd认为最优税收规定资本收入的长期税率应为零，但Straub和Werning发现即使在稳态下税率也可能为正。这些模型在基础的拉姆齐公式中存在一个“第零期问题”，该公式忽略了过去的承诺但包含了未来的承诺。然后，第零期的政策制定者对初始资产征收资本税——直接地或间接地通过对未来资产收入征收正税率和对消费征收非常数税率。Chari、Nicolini和Teles通过第零期政策制定者对以效用单位计量的家庭初始财富的承诺来增加承诺。在这种情况下，第零期可能适用非零的资本税，未来资产收入的税率为零，且消费税率是常数。如果未来的政策制定者不受约束，则时间一致性失败；但如果每个时期对以效用单位计量的初始财富的承诺足够严格，以激励每个政策制定者选择零直接资本税，则时间一致性成立。在这种情况下，适用一种永恒视角，其中第零期并不特殊，资产收入的税率始终为零，且消费税率是常数。引入不确定性会产生状态依存的资产税和类似随机游走的消费税率变化。

【**NBER**】: NBER Working Paper No. 32306，https://www.nber.org/papers/w32306

#### 87. Beyond Bad Luck: Macroeconomic Implications of Persistent Heterogeneity In Optimism {#32305}

【**Author**】: Oliver Pfäuti, Fabian Seyrich, Jonathan Zinman
...
【**摘要**】：家庭储蓄行为和财务状况对宏观经济波动和政策具有重要影响。它们在经验上在家庭内部具有持久性，并在家庭之间具有异质性。然而，标准建模实践假设事前相同的家庭，并且仅通过冲击实现来解释异质性。我们考虑了消费者决策的一个关键方面——关于自身未来财务状况的（有偏）信念——中的持久异质性，并表明它与实际的财务决策和状况具有很强的条件相关性。我们使用新颖的微观数据，在标准的HANK模型中定量地约束了事前乐观主义异质性。乐观偏差驱使家庭消费而不是积累缓冲库存储蓄，从而产生了更符合经验的HtM、财富和MPC分布，其中乐观家庭即使在远离借贷约束的情况下也表现出比理性家庭更高的MPC。考虑乐观主义使得定向转移支付的刺激效果减弱，并使激励自我保险的效果降低，但也意味着公共保险的扭曲性更小。

【**NBER**】: NBER Working Paper No. 32305，https://www.nber.org/papers/w32305

#### 88. Location Sorting and Endogenous Amenities: Evidence from Amsterdam {#32304}

【**Author**】: Milena Almagro, Tomás Domínguez-Iino
...
【**摘要**】：本文表明，便利设施的内生性在决定城市居民福利分布方面起着关键作用。我们通过构建一个包含异质性家庭的动态居住选择模型来量化这一机制，其中消费便利设施是非贸易品市场的均衡结果。我们利用荷兰微观数据，并利用阿姆斯特丹游客空间分布的变化作为需求转移因子来估计我们的模型，发现居民对便利设施的偏好以及便利设施供给对需求构成变化的反应存在显著的异质性。这种双向异质性决定了社区间的水平差异化程度、居住分选和不平等。最后，我们表明大众旅游的分配效应取决于这种异质性：由于游客对住房的需求增长导致租金上涨，年轻居民——其便利设施偏好与游客最接近——因便利设施向有利于他们的方向倾斜而得到补偿，而老年居民的损失则被放大。

【**NBER**】: NBER Working Paper No. 32304，https://www.nber.org/papers/w32304

#### 89. The Performance of Emerging Markets During the Fed’s Easing and Tightening Cycles: A Cross-Country Resilience Analysis {#32303}

【**Author**】: Joshua Aizenman, Donghyun Park, Irfan A. Qureshi, Gazi Salah Uddin, Jamel Saadaoui
...
【**摘要**】：我们研究了2004年至2023年期间，在美国联邦储备系统五次货币紧缩与宽松周期中，新兴市场表现的决定因素。我们探讨了周期开始时新兴市场的宏观经济和制度条件如何解释其在该周期中的韧性。具体而言，我们的基准横截面回归分析了这些条件如何影响三种韧性指标：对美元的双边汇率、汇率市场压力以及特定国家的摩根士丹利资本国际指数。随后，我们将五个横截面数据堆叠构建面板数据库，以研究紧缩周期与宽松周期之间可能存在的非对称性。我们的证据表明，宏观经济和制度变量与新兴市场表现相关，韧性决定因素在紧缩与宽松周期中存在差异，且制度在困难时期更为重要。我们的具体发现与经济直觉基本一致。例如，我们发现经常账户余额、国际储备和通货膨胀都是新兴市场韧性的重要决定因素。

【**NBER**】: NBER Working Paper No. 32303，https://www.nber.org/papers/w32303

#### 90. The Effect of E-cigarette Taxes on Substance Use {#32302}

【**Author**】: Dhaval M. Dave, Yang Liang, Johanna Catherine Maclean, Caterina Muratori, Joseph J. Sabia
...
【**摘要**】：公共卫生倡导者警告称，电子尼古丁输送系统合法市场的快速增长可能为青少年吸食大麻和更烈性毒品创造“门户”。本研究探讨了电子烟税对物质使用的影响。我们发现，电子烟税每增加1美元（按2023年美元计算），青少年大麻使用以及电子烟与大麻共同使用的比例下降1.0至1.5个百分点。这一结果与电子烟和大麻是经济互补品的结论一致。我们还发现，青少年对电子烟税的反应，即其电子烟使用及向大麻使用的溢出效应，似乎在长期内趋于缓和。我们没有发现证据表明电子烟税会影响药物滥用治疗入院率或除大麻以外的非法药物（如可卡因、甲基苯丙胺或阿片类药物）的消费。

【**NBER**】: NBER Working Paper No. 32302，https://www.nber.org/papers/w32302
...
【**摘要**】：我们通过估计一个结合算法机器学习来量化偏差的结构性资产定价模型，衡量了市场对数百条经济新闻事件反应中各种信念扭曲的性质和严重程度。我们发现，投资者系统性地对多种基本面冲击的感知做出过度反应，我们表明这种现象可以通过冲击构成效应抑制而非放大市场波动。这种冲击构成效应可能导致市场对新闻反应不足，即使投资者对所有冲击都过度反应。

【**NBER**】: NBER Working Paper No. 32301，https://www.nber.org/papers/w32301
...
【**摘要**】：本文为Shiller（1997）提出的一个长期问题提供了新证据：我们为何厌恶通货膨胀？我对美国人口的代表性样本进行了两项调查，以了解人们对通货膨胀影响的看法及其反应。人们厌恶通货膨胀的主要原因在于普遍认为通胀削弱了购买力，因为个人工资和整体工资的增长似乎都跟不上物价上涨的步伐。因此，受访者表示不得不在预算和行为上做出代价高昂的调整，尤其是在低收入群体中。通货膨胀还会引发压力、情绪反应和不公平感，因为高收入者的工资被认为在通胀期间增长更快。许多受访者认为，企业在设定工资方面拥有相当大的自由裁量权，它们选择不提高工资以增加利润，而非受市场动态所迫。通货膨胀的潜在积极关联，例如与失业率下降或经济活动增强的关系，通常未被受访者认识到。在各种经济和社会问题中，通货膨胀的优先级很高，受访者将其归咎于政府和企业。我还强调了在通货膨胀态度上存在显著的党派分歧以及收入群体间的两极分化。

【**NBER**】: NBER Working Paper No. 32300，https://www.nber.org/papers/w32300
...
【**摘要**】：全球监管机构正在讨论或采取行动限制大型平台的自我优待行为。本文探讨了在欧盟《数字市场法案》即将生效之际，亚马逊对其自有产品的搜索排名情况。利用来自美国、欧洲及其他地区22个亚马逊域名的超过800万条亚马逊搜索结果数据，我记录了三点发现。首先，在控制基本产品特征后，在整个样本期内，亚马逊自有产品的搜索排名平均高出24个位次。其次，与其他142个流行品牌相比，亚马逊的排名差异较大。第三，在2023年9月欧盟将亚马逊指定为“守门人”平台后不久，亚马逊的排名优势从30个位次降至20个位次，而其他主要品牌的排名位置未受影响。亚马逊搜索排名的变化在欧洲和其他司法管辖区均有出现。

【**NBER**】: NBER Working Paper No. 32299，https://www.nber.org/papers/w32299

#### 94. Consumption Dynamics and Welfare Under Non-Gaussian Earnings Risk {#32298}

【**Author**】: Fatih Guvenen, Serdar Ozkan, Rocio Madera
...
【**摘要**】：近期的实证研究记录显示，收入变化的分布显著偏离对数正态分布：具体而言，收入变化呈负偏态且具有极高的峰度（长尾和厚尾），这些非高斯特征在生命周期内以及随个人收入水平的不同而显著变化。此外，收入变化表现出非线性（非对称）均值回归。在本文中，我们将一个捕捉了这些非高斯和非线性特征的非常丰富的“基准收入过程”嵌入到生命周期消费-储蓄模型中，并研究其对消费动态、消费保险和福利的影响。我们展示了四个主要结果。首先，基准过程基本匹配了经验性的终生收入不平等——这是消费不平等的一阶代理变量——而典型的高斯（持久加暂时）过程将其低估了五到十倍。其次，基准过程隐含的异质性风险福利成本是典型高斯过程的两到四倍。第三，文献中用于衡量收入冲击向消费传导的标准方法，可能显著高估了在非高斯冲击下可能实现的消费平滑程度。第四，在非高斯收入风险下，来自暂时性收入（例如刺激支票）的边际消费倾向更高。

【**NBER**】: NBER Working Paper No. 32298，https://www.nber.org/papers/w32298

#### 95. Does nothing stop a bullet like a job? The effects of income on crime {#32297}

【**Author**】: Jens Ludwig, Kevin Schnepel
...
【**摘要**】：工作和收入转移项目会影响犯罪吗？答案取决于提问的目的，这决定了“犯罪”的含义。许多研究侧重于理解为什么总体犯罪率在不同人群、地点和时间之间存在差异；由于80%的犯罪是财产犯罪，这类研究通常解释的就是这一点。但如果目标是理解如何解决犯罪问题，那么重点将转向严重暴力犯罪，这些犯罪占犯罪社会成本的大部分。现有最佳证据表明，减少经济绝望的政策会减少财产犯罪（从而降低总体犯罪率），但与暴力犯罪几乎没有系统性关联。这种影响差异很大程度上源于大多数暴力犯罪（包括谋杀）并非牟利犯罪，而是激情犯罪——包括愤怒。缓解物质匮乏的政策，尽管对改善人们的生活和福祉重要且有用，但本身并不足以大幅减轻犯罪对社会的负担。

【**NBER**】: NBER Working Paper No. 32297，https://www.nber.org/papers/w32297
...
【**摘要**】：本文通过比较勉强被录取与勉强被拒绝的申请者的长期结果，研究了就读美国公立大学的回报。我使用了涵盖德克萨斯州所有35所公立大学的行政录取记录（这些大学共招收美国所有公立大学学生的10%），系统地识别并利用了SAT/ACT分数中的分散截止点，这些截止点在录取和入学中产生了不连续性。典型的边际录取学生多获得一年的四年制大学教育，获得学士学位的可能性提高12个百分点，最终收入比勉强被拒绝但其他方面相同的对应者高出8%。得益于抵消性的助学金，边际录取学生无需支付额外的学费；成本效益计算显示，边际学生自身的内部收益率为26%，社会（必须为额外教育付费）为16%，政府预算为7%。不同选择性的录取院校的收入增长相似，但来自低收入家庭的学生收入增长较小，他们入学时间更长但完成学位更少，且主修收入较低的领域。最后，我开发了一种方法，分别识别对是否上大学的广延边际学生与对选择更具选择性大学的质量边际学生的影响，揭示了广延边际上的效应更大。

【**NBER**】: NBER Working Paper No. 32296，https://www.nber.org/papers/w32296

#### 97. Beliefs that Entertain {#32295}

【**Author**】: Ashvin Gandhi, Paola Giuliano, Eric Guan, Quinn Keefer, Chase McDonald, Michaela Pagel, Joshua Tasoff
...
【**摘要**】：尽管娱乐活动在时间使用中占据很大份额，但关于娱乐的经济学研究却很少。我们运用行为经济理论的见解，分析信念在玩家参与电子游戏中的作用。利用热门电子游戏《英雄联盟》中280万场比赛的详细逐分钟数据，我们估计了一个玩家参与度模型，该模型以玩家在比赛过程中信念路径的函数形式呈现。与参照依赖和损失厌恶一致，但与某些预期效用模型相反，在整场比赛中落后于对手会增加参与度。无论玩家是赢是输，这一结论都成立，但对输家的影响要大得多。当玩家在整场比赛中处于悬念状态时，他们参与度更高，并且不喜欢意外实际发生。赢家偏好意外在整场比赛中平滑分布，而输家则偏好意外集中出现。我们还发现了支持心流理论的证据：当玩家面临挑战时参与度更高，但比赛太难或太容易时则不然。随后，我们利用估计出的模型为游戏设计提供信息。我们发现，优化信息揭示过程可以显著提高玩家参与度：平均效果相当于让输家感觉像赢家这一效果的43%。

【**NBER**】: NBER Working Paper No. 32295，https://www.nber.org/papers/w32295
