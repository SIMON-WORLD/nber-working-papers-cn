# 【前沿文献】NBER工作论文 2023年2月合集 目录与摘要

> 2023 年 2 月 NBER 更新 87 篇工作论文，其中与中国研究相关的有 3 篇（4、10、46）。
> 其中，中国相关研究包括：#30990（第 4 篇，迁移限制可能造成性别不平等：中国留守儿童的故事）；#30984（第 10 篇，流动性、债务计价与货币主导地位）；#30947（第 46 篇，思想动员人民：共产主义意识形态在中国的传播）。

## 一、目录速览

1. **Endogenous Production Networks with Fixed Costs {#30993}**  
   具有固定成本的内生生产网络  
   <font color=grey>Emmanuel Dhyne, Ken Kikkawa, Xianglong Kong, Magne Mogstad, Felix Tintelnot</font>

2. **Fighting Poverty One Family at a Time: Experimental Evidence from an Intervention with Holistic, Individualized, Wrap-Around Services {#30992}**  
   逐户扶贫：一项提供整体性、个性化、全方位服务干预的实验证据  
   <font color=grey>William N. Evans, Shawna Kolka, James X. Sullivan, Patrick S. Turner</font>

3. **Organizing for Collective Action: Olson Revisited {#30991}**  
   为集体行动而组织：重访奥尔森  
   <font color=grey>Marco Battaglini, Thomas R. Palfrey</font>

4. **Migration Restrictions Can Create Gender Inequality: The Story of China's Left-Behind Children {#30990}**  
   迁移限制可能造成性别不平等：中国留守儿童的故事  
   <font color=grey>Xuwen Gao, Wenquan Liang, Ahmed Mushfiq Mobarak, Ran Song</font>

5. **Does the US have an Infrastructure Cost Problem? Evidence from the Interstate Highway System {#30989}**  
   美国存在基础设施成本问题吗？来自州际公路系统的证据  
   <font color=grey>Matthew Turner, Neil Mehrotra, Juan Pablo Uribe</font>

6. **Long Covid in the United States {#30988}**  
   美国的长期新冠  
   <font color=grey>David G. Blanchflower, Alex Bryson</font>

7. **The Welfare Effect of Gender-Inclusive Intellectual Property Creation: Evidence from Books {#30987}**  
   性别包容性知识产权创造的福利效应：来自图书的证据  
   <font color=grey>Joel Waldfogel</font>

8. **Obstetric Unit Closures and Racial/Ethnic Disparity in Health {#30986}**  
   产科病房关闭与种族/民族健康差异  
   <font color=grey>Pinka Chatterji, Chun-Yu Ho, Xue Wu</font>

9. **Distortions, Producer Dynamics, and Aggregate Productivity: A General Equilibrium Analysis {#30985}**  
   扭曲、生产者动态与全要素生产率：一般均衡分析  
   <font color=grey>Stephen Ayerst, Loren Brandt, Diego Restuccia</font>

10. **Liquidity, Debt Denomination, and Currency Dominance {#30984}**  
   流动性、债务计价与货币主导地位  
   <font color=grey>Antonio Coppola, Arvind Krishnamurthy, Chenzi Xu</font>

11. **The Impacts of Same and Opposite Gender Alumni Speakers on Interest in Economics {#30983}**  
   同性与异性校友演讲者对经济学兴趣的影响  
   <font color=grey>Arpita Patnaik, Gwyn C. Pauley, Joanna Venator, Matthew J. Wiswall</font>

12. **Automating Automaticity: How the Context of Human Choice Affects the Extent of Algorithmic Bias {#30981}**  
   自动化自动性：人类选择背景如何影响算法偏见的程度  
   <font color=grey>Amanda Y. Agan, Diag Davenport, Jens Ludwig, Sendhil Mullainathan</font>

13. **Mutual Fund Flows and the Supply of Capital in Municipal Financing {#30980}**  
   共同基金流动与市政融资中的资本供给  
   <font color=grey>Manuel Adelino, Sophia Chiyoung Cheong, Jaewon Choi, Ji Yeol Jimmy Oh</font>

14. **The Nature of Long-Term Unemployment: Predictability, Heterogeneity and Selection {#30979}**  
   长期失业的本质：可预测性、异质性与选择效应  
   <font color=grey>Andreas I. Mueller, Johannes Spinnewijn</font>

15. **Relational Contracts: Recent Empirical Advancements and Open Questions {#30978}**  
   关系契约：近期实证进展与未解问题  
   <font color=grey>Rocco Macchiavello, Ameet Morjaria</font>

16. **The Slow Diffusion of Earnings Inequality {#30977}**  
   收入不平等的缓慢扩散  
   <font color=grey>Isaac Sorkin, Melanie Wallskog</font>

17. **Similarities and Differences in the Adoption of General Purpose Technologies {#30976}**  
   通用目的技术采纳中的相似性与差异性  
   <font color=grey>Ajay K. Agrawal, Joshua S. Gans, Avi Goldfarb</font>

18. **Government Audits {#30975}**  
   政府审计  
   <font color=grey>Martina Cuneo, Jetson Leder-Luis, Silvia Vannutelli</font>

19. **Effects of Enhanced Legal Aid in Child Welfare: Evidence from a Randomized Trial of Mi Abogado {#30974}**  
   增强儿童福利领域法律援助的效果：来自Mi Abogado随机试验的证据  
   <font color=grey>Ryan Cooper, Joseph J. Doyle Jr., Andrés P. Hojman</font>

20. **Behavioral Economics in Education Market Design: A Forward-Looking Review {#30973}**  
   教育市场设计中的行为经济学：前瞻性综述  
   <font color=grey>Alex Rees-Jones, Ran Shorrer</font>

21. **Cross-State Strategic Voting {#30972}**  
   跨州策略性投票  
   <font color=grey>Gordon B. Dahl, Joseph Engelberg, Runjing Lu, William Mullins</font>

22. **State-Dependent Local Projections: Understanding Impulse Response Heterogeneity {#30971}**  
   状态依赖的局部投影：理解脉冲响应异质性  
   <font color=grey>James Cloyne, Òscar Jordà, Alan M. Taylor</font>

23. **Lottery-Based Evaluations of Early Education Programs: Opportunities and Challenges for Building the Next Generation of Evidence {#30970}**  
   基于抽签的早期教育项目评估：构建下一代证据的机遇与挑战  
   <font color=grey>Christina Weiland, Rebecca Unterman, Susan Dynarski, Rachel Abenavoli, Howard Bloom, Breno Braga, Ann-Marie Faria, Erica H. Greenberg, Brian Jacob, Jane Arnold Lincove, Karen Manship, Meghan McCormick, Luke Miratrix, Tomás E. Monarrez, Pamela Morris-Perez, Anna Shapiro, Jon Valant, Lindsay Weixler</font>

24. **Behavior Mediates the Health Effects of Extreme Wildfire Smoke Events {#30969}**  
   行为调节极端野火烟雾事件的健康影响  
   <font color=grey>Sam Heft-Neal, Carlos F. Gould, Marissa Childs, Mathew V. Kiang, Kari Nadeau, Mark Duggan, Eran Bendavid, Marshall Burke</font>

25. **Pediatric Drug Adherence and Parental Attention: Evidence from Comprehensive Claims Data {#30968}**  
   儿科药物依从性与父母关注：来自综合索赔数据的证据  
   <font color=grey>Josh Feng, Matthew J. Higgins, Elena Patel</font>

26. **RIM-Based Value Premium and Factor Pricing Using Value-Price Divergence {#30967}**  
   基于剩余收益模型的价值溢价与使用价值-价格偏离的因子定价  
   <font color=grey>Lin William Cong, Nathan Darden George, Guojun Wang</font>

27. **Cooling Externality of Large-Scale Irrigation {#30966}**  
   大规模灌溉的降温外部性  
   <font color=grey>Thomas Braun, Wolfram Schlenker</font>

28. **Unconditional Cash Transfers for Families with Children in the U.S.: A Scoping Review {#30965}**  
   美国对有子女家庭的无条件现金转移支付：一项范围综述  
   <font color=grey>Hema Shah, Lisa A. Gennetian</font>

29. **Parental Education and Invention: The Finnish Enigma {#30964}**  
   父母教育与发明：芬兰之谜  
   <font color=grey>Philippe Aghion, Ufuk Akcigit, Ari Hyytinen, Otto Toivanen</font>

30. **Beware the Side Effects: Capital Controls, Trade and Misallocation {#30963}**  
   当心副作用：资本管制、贸易与资源错配  
   <font color=grey>Eugenia Andreasen, Sofía Bauducco, Evangelina Dardati, Enrique G. Mendoza</font>

31. **A Mother’s Voice: Impacts of Spousal Communication Training on Child Health Investments {#30962}**  
   母亲的声音：配偶沟通培训对儿童健康投资的影响  
   <font color=grey>Martina Bjorkman-Nyqvist, Seema Jayachandran, Celine P. Zipfel</font>

32. **Optimal Monetary Policy with Heterogeneous Agents: Discretion, Commitment, and Timeless Policy {#30961}**  
   异质性代理人下的最优货币政策：相机抉择、承诺与永恒政策  
   <font color=grey>Eduardo Dávila, Andreas Schaab</font>

33. **Immigration, The Long-Term Care Workforce, and Elder Outcomes in the U.S. {#30960}**  
   移民、长期护理劳动力与美国老年人护理结果  
   <font color=grey>David C. Grabowski, Jonathan Gruber, Brian McGarry</font>

34. **A Tractable Income Process for Business Cycle Analysis {#30959}**  
   适用于商业周期分析的可处理收入过程  
   <font color=grey>Fatih Guvenen, Alisdair McKay, Conor B. Ryan</font>

35. **Loose Monetary Policy and Financial Instability {#30958}**  
   宽松货币政策与金融不稳定  
   <font color=grey>Maximilian Grimm, Òscar Jordà, Moritz Schularick, Alan M. Taylor</font>

36. **Language Models and Cognitive Automation for Economic Research {#30957}**  
   语言模型与经济学研究的认知自动化  
   <font color=grey>Anton Korinek</font>

37. **The Economic Opportunity Cost of Green Recovery Plans {#30956}**  
   绿色复苏计划的经济机会成本  
   <font color=grey>Timothy Fitzgerald, Casey B. Mulligan</font>

38. **Estimating Causal Effects of Fertility on Life Course Outcomes: Evidence Using A Dyadic Genetic Instrumental Variable Approach {#30955}**  
   估计生育对生命历程结果的因果效应：基于二元遗传工具变量方法的证据  
   <font color=grey>Boyan Zheng, Qiongshi Lu, Jason Fletcher</font>

39. **Production Network Formation, Trade, and Welfare {#30954}**  
   生产网络形成、贸易与福利  
   <font color=grey>Costas Arkolakis, Federico Huneeus, Yuhei Miyauchi</font>

40. **Measuring Domestic Factor Content in Bilateral and Sectoral-Level Trade Flows {#30953}**  
   衡量双边和部门层面贸易流中的国内要素含量  
   <font color=grey>Zhi Wang, Shang-Jin Wei, Kunfu Zhu</font>

41. **Dynamic Pricing Regulation and Welfare in Insurance Markets {#30952}**  
   保险市场中的动态定价监管与福利  
   <font color=grey>Naoki Aizawa, Ami Ko</font>

42. **Direct and Spillover Effects of Provider Vaccination Facilitation {#30951}**  
   医疗服务提供者促进疫苗接种的直接效应与溢出效应  
   <font color=grey>Julie Berry Cullen, Maria K. Humlum, Agne Suziedelyte, Peter Rønø Thingholm</font>

43. **The Effect of R&D on Quality, Productivity, and Welfare {#30950}**  
   研发对质量、生产率和福利的影响  
   <font color=grey>Mons Chan, Amil Petrin, Frederic Warzynski</font>

44. **Inclusion and Democratization Through Web3 and DeFi? Initial Evidence from the Ethereum Ecosystem {#30949}**  
   通过Web3和DeFi实现包容性与民主化？来自以太坊生态系统的初步证据  
   <font color=grey>Lin William Cong, Ke Tang, Yanxin Wang, Xi Zhao</font>

45. **Donor Contracting Conditions and Public Procurement: Causal Evidence from Kenyan Electrification {#30948}**  
   捐助者合同条件与公共采购：来自肯尼亚电气化的因果证据  
   <font color=grey>Catherine Wolfram, Edward Miguel, Eric Hsu, Susanna B. Berkouwer</font>

46. **Ideas Mobilize People: The Diffusion of Communist Ideology in China {#30947}**  
   思想动员人民：共产主义意识形态在中国的传播  
   <font color=grey>Ying Bai, Ruixue Jia, Runnan Wang</font>

47. **Unsupervised Machine Learning for Explainable Health Care Fraud Detection {#30946}**  
   用于可解释医疗欺诈检测的无监督机器学习  
   <font color=grey>Shubhranshu Shekhar, Jetson Leder-Luis, Leman Akoglu</font>

48. **Hobbesian Wars and Separation of Powers {#30945}**  
   霍布斯式战争与权力分立  
   <font color=grey>Weijia Li, Gérard Roland, Yang Xie</font>

49. **Catching Up by ‘Deglobalizing’: Capital Account Policy and Economic Growth {#30944}**  
   通过“去全球化”实现赶超：资本账户政策与经济增长  
   <font color=grey>Paul Bergin, Woo Jin Choi, Ju H. Pyun</font>

50. **The Economics of Digital Privacy {#30943}**  
   数字隐私的经济学  
   <font color=grey>Avi Goldfarb, Verina F. Que</font>

51. **To Starve or to Stoke? Understanding Whether Divestment vs. Investment Can Steer (Green) Innovation {#30942}**  
   是扼杀还是激励？理解撤资与投资能否引导（绿色）创新  
   <font color=grey>Jacquelyn Pless</font>

52. **The Impact of COVID-19 on Workers’ Expectations and Preferences for Remote Work {#30941}**  
   COVID-19对工人远程工作期望和偏好的影响  
   <font color=grey>Yuting Chen, Patricia Cortés, Gizem Koşar, Jessica Pan, Basit Zafar</font>

53. **Varying Impacts of Letters of Recommendation on College Admissions {#30940}**  
   推荐信对大学录取的不同影响  
   <font color=grey>Eli Ben-Michael, Avi Feller, Jesse Rothstein</font>

54. **How the Internet Changed the Market for Print Media {#30939}**  
   互联网如何改变了印刷媒体市场  
   <font color=grey>Manudeep Bhuller, Tarjei Havnes, Jeremy McCauley, Magne Mogstad</font>

55. **Frames, Incentives, and Education: Effectiveness of Interventions to Delay Public Pension Claiming {#30938}**  
   框架、激励与教育：延迟公共养老金申领的干预措施效果  
   <font color=grey>Franca Glenzer, Pierre-Carl Michaud, Stefan Staubli</font>

56. **The Cyclicality of Births and Babies’ Health, Revisited: Evidence from Unemployment Insurance {#30937}**  
   出生率的周期性与婴儿健康再探：来自失业保险的证据  
   <font color=grey>Lisa J. Dettling, Melissa Schettini Kearney</font>

57. **Does School Choice Increase Crime? {#30936}**  
   择校会增加犯罪吗？  
   <font color=grey>Andrew Bibler, Stephen B. Billings, Stephen Ross</font>

58. **On the Effectiveness of Foreign Exchange Reserves During the 2021-22 U.S. Monetary Tightening Cycle {#30935}**  
   2021-2022年美国货币紧缩周期中外汇储备的有效性  
   <font color=grey>Rashad Ahmed, Joshua Aizenman, Jamel Saadaoui, Gazi Salah Uddin</font>

59. **Preferences for Firearms and Their Implications for Regulation {#30934}**  
   对枪支的偏好及其对监管的启示  
   <font color=grey>Sarah Moshary, Bradley Shapiro, Sara Drango</font>

60. **Life After Death: A Field Experiment with Small Businesses on Information Frictions, Stigma, and Bankruptcy {#30933}**  
   死后余生：关于信息摩擦、污名化与破产的小企业实地实验  
   <font color=grey>Shai Bernstein, Emanuele Colonnelli, Mitchell Hoffman, Benjamin Iverson</font>

61. **The Benefits of Revealing Race: Evidence from Minority-owned Local Businesses {#30932}**  
   揭示种族的益处：来自少数族裔本地企业的证据  
   <font color=grey>Abhay Aneja, Michael Luca, Oren Reshef</font>

62. **Paying Moms to Stay Home: Short and Long Run Effects on Parents and Children {#30931}**  
   付钱让妈妈待在家里：对父母和孩子的短期与长期影响  
   <font color=grey>Jonathan Gruber, Tuomas Kosonen, Kristiina Huttunen</font>

63. **Structuring Cash Transfers: Cash Flow Preferences, Seasonality, and Financial Decisions in Rural Kenya {#30930}**  
   结构化现金转移：肯尼亚农村地区的现金流偏好、季节性与财务决策  
   <font color=grey>Carolina Kansikas, Anandi Mani, Paul Niehaus</font>

64. **Crowding in Private Quality: The Equilibrium Effects of Public Spending in Education {#30929}**  
   挤入私立质量：教育公共支出的均衡效应  
   <font color=grey>Tahir Andrabi, Natalie Bau, Jishnu Das, Naureen Karachiwalla, Asim Ijaz Khwaja</font>

65. **The Impact of Vertical Integration on Physician Behavior and Healthcare Delivery: Evidence from Gastroenterology Practices {#30928}**  
   纵向整合对医生行为与医疗服务的影响：来自胃肠病学实践的证据  
   <font color=grey>Soroush Saghafian, Lina D. Song, Joseph P. Newhouse, Mary Beth Landrum, John Hsu</font>

66. **Do Conflict of Interests Disclosures Work? Evidence from Citations in Medical Journals {#30927}**  
   利益冲突披露有效吗？来自医学期刊引用的证据  
   <font color=grey>Christian Leuz, Anup Malani, Maximilian Muhn, Laszlo Jakab</font>

67. **Harm Reduction: When Does It Improve Health, and When Does it Backfire? {#30926}**  
   减害：何时改善健康，何时适得其反？  
   <font color=grey>John Cawley, Davide Dragone</font>

68. **Which Firms Gain from Digital Advertising? Evidence from a Field Experiment {#30925}**  
   哪些企业从数字广告中获益？来自实地实验的证据  
   <font color=grey>Weijia Dai, Hyunjin Kim, Michael Luca</font>

69. **New Institutional Economics and Cliometrics {#30924}**  
   新制度经济学与计量史学  
   <font color=grey>Eric C. Alston, Lee J. Alston, Bernardo Mueller</font>

70. **Bitcoin Mining Meets Wall Street: A Study of Publicly Traded Crypto Mining Companies {#30923}**  
   比特币挖矿遇上华尔街：对上市加密矿企的研究  
   <font color=grey>Hanna Halaburda, David Yermack</font>

71. **Distorted Innovation: Does the Market Get the Direction of Technology Right? {#30922}**  
   扭曲的创新：市场能否正确引导技术方向？  
   <font color=grey>Daron Acemoglu</font>

72. **Back to the 1980s or Not? The Drivers of Inflation and Real Risks in Treasury Bonds {#30921}**  
   回到1980年代还是并非如此？国债通胀风险与真实风险的驱动因素  
   <font color=grey>Carolin Pflueger</font>

73. **Digital Hermits {#30920}**  
   数字隐士  
   <font color=grey>Jeanine Miklós-Thal, Avi Goldfarb, Avery M. Haviv, Catherine Tucker</font>

74. **Task Mismatch and Salary Penalties: Evidence from the Biomedical PhD Labor Market {#30919}**  
   任务错配与薪资惩罚：来自生物医学博士劳动力市场的证据  
   <font color=grey>Holden A. Diethorn, Gerald R. Marschke</font>

75. **Financial Crisis in a Socialist Setting: Impact on Political Behavior, Social Trust, and Economic Values {#30918}**  
   社会主义背景下的金融危机：对政治行为、社会信任和经济价值观的影响  
   <font color=grey>Ran Abramitzky, Netanel Ben-Porath, Victor Lavy, Michal Palgi</font>

76. **Reversals and the Returns to Liquidity Provision {#30917}**  
   反转与流动性供给的回报  
   <font color=grey>Wei Dai, Mamdouh Medhat, Robert Novy-Marx, Savina Rizova</font>

77. **Missing Discussions: Institutional Constraints in the Islamic Political Tradition {#30916}**  
   缺失的讨论：伊斯兰政治传统中的制度约束  
   <font color=grey>A. Arda Gitmez, James A. Robinson, Mehdi Shadmehr</font>

78. **Growth and Risk: A View from International Trade {#30915}**  
   增长与风险：来自国际贸易的视角  
   <font color=grey>Pravin Krishna, Andrei A. Levchenko, Lin Ma, William F. Maloney</font>

79. **Florida (Un)Chained {#30914}**  
   佛罗里达（未）被束缚  
   <font color=grey>Charles W. Calomiris, Matthew S. Jaremski</font>

80. **Blockchain for Timely Transfer of Intellectual Property {#30913}**  
   用于知识产权及时转让的区块链  
   <font color=grey>Dongling Cai, Yi Qian, Ning Nan</font>

81. **Scaling Smart Contracts via Layer-2 Technologies: Some Empirical Evidence {#30912}**  
   通过二层技术扩展智能合约：一些实证证据  
   <font color=grey>Lin William Cong, Xiang Hui, Catherine Tucker, Luofeng Zhou</font>

82. **The Internet, Search Frictions and Aggregate Unemployment {#30911}**  
   互联网、搜索摩擦与总体失业  
   <font color=grey>Manudeep Bhuller, Domenico Ferraro, Andreas R. Kostøl, Trond C. Vigtel</font>

83. **Dynamic Inconsistency in Risky Choice: Evidence from the Lab and Field {#30910}**  
   风险选择中的动态不一致性：来自实验室和实地证据  
   <font color=grey>Rawley Z. Heimer, Zwetelina Iliewa, Alex Imas, Martin Weber</font>

84. **Societal Disruptions And Child Mental Health: Evidence From ADHD Diagnosis During The COVID-19 Pandemic {#30909}**  
   社会动荡与儿童心理健康：来自COVID-19疫情期间ADHD诊断的证据  
   <font color=grey>Seth M. Freedman, Kelli R. Marquardt, Dario Salcedo, Kosali I. Simon, Coady Wing</font>

85. **Child Labor Standards in Regional Trade Agreements: Theory and Evidence {#30908}**  
   区域贸易协定中的童工标准：理论与证据  
   <font color=grey>Ryan M. Abman, Clark C. Lundberg, John McLaren, Michele Ruta</font>

86. **Bank Funding Risk, Reference Rates, and Credit Supply {#30907}**  
   银行融资风险、参考利率与信贷供给  
   <font color=grey>Harry R. Cooperman, Darrell Duffie, Stephan Luck, Zachry Z. Wang, Yilin Yang</font>

87. **Ride-Sharing Markets Re-Equilibrate {#30883}**  
   网约车市场重新均衡  
   <font color=grey>Jonathan V. Hall, John J. Horton, Daniel T. Knoepfle</font>
...
【**Author**】: Emmanuel Dhyne, Ken Kikkawa, Xianglong Kong, Magne Mogstad, Felix Tintelnot
...
【**摘要**】：本文提出了一个具有固定成本的内生生产网络的可处理模型，该固定成本与企业间链接的形成相关。该模型由有限数量的企业类型组成，这些企业生产差异化产品。每个企业都由描述其CES生产函数的企业特定参数、企业特定的国内和国外需求转移因子，以及企业特定的潜在供应商和买家集合来刻画。我们考虑了模型的几个版本：其中买方或供应商发起链接形成的版本，以及生产网络可以是循环或无环的版本。我们的主要理论结果是，如果可行网络集合仅包含无环网络，并且买方在发起链接形成的同时在与供应商的价格谈判中拥有完全的议价能力，那么封闭经济均衡是唯一的。我们提供了多重均衡的例子：如果供应商在循环和无环可行网络中发起链接形成，或者如果买方在循环生产网络中发起链接形成。我们将无环生产网络模型应用于比利时企业间生产网络的数据，并表明它很好地近似了网络的显著特征。内生网络模型在应对贸易冲击时，国内企业间链接产生了大量的更替。然而，与具有固定链接的模型相比，内生网络模型产生的福利变化仅存在适度差异，这表明外生生产网络可以相当好地近似福利对贸易冲击的反应。

【**NBER**】: NBER Working Paper No. 30993，https://www.nber.org/papers/w30993

#### 2. Fighting Poverty One Family at a Time: Experimental Evidence from an Intervention with Holistic, Individualized, Wrap-Around Services {#30992}

【**Author**】: William N. Evans, Shawna Kolka, James X. Sullivan, Patrick S. Turner
...
【**摘要**】：贫困家庭在建立稳定的经济基础方面面临众多障碍。本文考察了一项整体性、个性化的全方位服务干预对低收入个体结果的影响。该干预包括详细评估、个性化服务计划、由两人团队管理且个案量较小的强化个案管理，以及用于克服自给自足障碍和激励行为的临时经济援助。我们通过一项随机对照试验来评估该干预措施，试验对象是在当地社会服务提供者处寻求帮助的参与者。结果表明，该计划在注册两年后改善了劳动力市场和住房结果。鉴于服务的定制化性质，总体计划效果可能掩盖重要的异质性。探索性分析表明，该计划帮助了缺乏就业但有稳定住房的参与者找到工作，而那些没有稳定住房的参与者则在获得住房方面得到了帮助。

【**NBER**】: NBER Working Paper No. 30992，https://www.nber.org/papers/w30992
...
【**摘要**】：我们研究一个标准的集体行动问题，其中成功实现群体利益需要其部分成员付出高昂的参与成本。当关于成员偏好的信息不对称时，我们应该如何对这些群体的内部组织进行建模？随着群体规模n的增加，我们应预期其有效性如何？我们将其建模为一个最优的诚实且服从的沟通机制，并证明对于较大的n，它可以通过一个我们称之为自愿型组织的非常简单的机制来实现。从这个分析中得出两个新结果。无论对基础技术做何假设，在最优诚实且服从的机制下成功的极限概率与无组织群体中的相同，如果忽略服从性，这一结果通常不成立。然而，一个最优组织提供了一个关键优势：当成功概率趋近于零时，它是以比无组织群体慢得多的速度趋近的。因此，即使在非常大的群体中，通过简单的诚实且服从的组织也能实现显著的成功概率。

【**NBER**】: NBER Working Paper No. 30991，https://www.nber.org/papers/w30991

#### 4. Migration Restrictions Can Create Gender Inequality: The Story of China's Left-Behind Children {#30990}

【**Author**】: Xuwen Gao, Wenquan Liang, Ahmed Mushfiq Mobarak, Ran Song
...
【**摘要**】：大约11%的中国人口是城乡移民，他们持有严重限制其子女进入城市学校的农村户口。结果，6900万儿童被留在农村地区。我们利用两个断点回归设计——基于入学年龄截止点和2014年一项更严格限制移民子女入学机会的政策变化——来证明，当教育变得昂贵且受限时，移民父母恰好更有可能将中学年龄的女儿（而非儿子）留在贫困的农村地区，且父母双方均不在身边。当女儿有兄弟时，这种效应更大。移民父母寄给女儿的生活费显著少于儿子。尽管中国的户口迁移限制在意图上并非针对特定性别，但它们对女孩产生了更大的不利影响。在中国加入世贸组织后，邻近城市的农村居民在经历劳动力需求冲击时，更有可能与子女分离，以利用城市的新机会。这些工人收入更高，经济状况得到改善，但纵向数据显示，他们的子女完成的受教育年限更少，仍然贫困，并且在以后的生活中身心健康状况更差。

【**NBER**】: NBER Working Paper No. 30990，https://www.nber.org/papers/w30990

#### 5. Does the US have an Infrastructure Cost Problem? Evidence from the Interstate Highway System {#30989}

【**Author**】: Matthew Turner, Neil Mehrotra, Juan Pablo Uribe
...
【**摘要**】：我们将州际公路的管理问题视为一个最优资本存量问题，并将用户成本定义为每车辆英里行驶里程的收费，该收费使得观察到的车道里程和路面质量投资合理化。我们发现用户成本是车道里程机会成本、路面质量成本和折旧的总和。每一项都取决于车道里程和路面质量的价格。我们估计了这些价格并评估了用户成本。尽管车道里程和路面质量的价格大幅上涨，但由于利率降低和使用量增加，用户成本从1992年到2008年下降了近50%。材料成本的增加在很大程度上解释了路面质量价格的上涨，我们否定了关于车道里程价格上涨的几种常见假设。

【**NBER**】: NBER Working Paper No. 30989，https://www.nber.org/papers/w30989
...
【**摘要**】：尽管长期新冠作为一种临床病症尚未被明确识别，但其对健康和福祉的后果引起了极大关注。利用美国人口普查局家庭脉搏调查（HPS）在2022年6月至2022年12月期间从近50万美国人收集的数据，我们发现14%的人报告曾患有长期新冠，其中一半在调查时仍报告有此症状。它在中年时期达到顶峰，与负面情绪类似。曾患长期新冠与负面情绪（焦虑、抑郁、担忧和对事物缺乏兴趣）密切相关。这种效应在目前报告患有长期新冠的人群中更大，尤其是那些报告有严重症状的人。相比之下，报告曾患短期新冠的人比报告从未患过新冠的人幸福感更高。长期新冠还与身体活动能力问题以及穿衣和洗澡问题密切相关。它还与记忆和理解困难等心理问题相关。同样，这些关联在目前报告患有长期新冠的人群中最强，而报告曾患短期新冠的人比报告从未患过新冠的人身体和心理问题更少。疫苗接种与较低的负面情绪相关，包括在报告曾患长期新冠的人群中也是如此。

【**NBER**】: NBER Working Paper No. 30988，https://www.nber.org/papers/w30988
...
【**摘要**】：传统上，女性在知识产权创造中的参与率低于男性。图书创作现在是一个例外。1970年，女性出版的图书数量是男性的三分之一。到2020年，女性创作了大部分图书。增加新产品可以带来显著的福利收益，尤其是在产品质量不可预测的情况下。利用2018-2021年亚马逊890万种图书的销售数据，以及80万Goodreads用户对180万种图书的2亿条评分信息，我开发了衡量男性和女性作者新书供应量以及不同消费者使用量的指标。我表明，女性作者图书的增长使得女性作者在消费份额、图书奖项和其他成功指标中的占比大致成比例地增加，这表明新增的女性作者图书对消费者有用，并且产品质量不可预测。我校准了一个具有不可预测产品质量的简单需求结构模型，以量化新增女性作者图书带来的福利收益。虽然女性作者的收入增长部分是以男性作者为代价的，但包容性创新带来的消费者收益则由广泛的消费者群体所享有。

【**NBER**】: NBER Working Paper No. 30987，https://www.nber.org/papers/w30987
...
【**摘要**】：本文考察了当地可及的医院产科服务丧失是否会影响美国农村地区在产时护理可及性和出生结果方面的种族/民族差异。为了进行因果推断，我们结合了双重差分法和倾向得分匹配法，以控制各县之间可观测和不可观测的时间不变异质性。利用2005-2018年美国本土农村县的生命统计出生证明记录数据，我们的实证分析得出了若干发现。与匹配县的妇女相比，失去产科服务的县的妇女更有可能在其居住县之外接受产时护理，并在城市县分娩。尽管如此，在全样本中，产科病房关闭对孕产妇和婴儿健康没有一致的影响。然而，在黑人母亲中，产科病房关闭与在城市县分娩无关，并且存在更一致的关闭对婴儿健康产生负面影响的模式。重要的是，针对认证护士助产士的执业范围法律、远程医疗支付平价法律的通过，以及ACA医疗补助扩展，对于缩小因产科病房关闭而产生的种族/民族健康差异具有意义。

【**NBER**】: NBER Working Paper No. 30986，https://www.nber.org/papers/w30986

#### 9. Distortions, Producer Dynamics, and Aggregate Productivity: A General Equilibrium Analysis {#30985}

【**Author**】: Stephen Ayerst, Loren Brandt, Diego Restuccia
...
【**摘要**】：在欠发达经济体中，生产要素向更高生产率农场的配置常常受到阻碍。为了分析要素重新配置的扭曲如何影响农场动态和农业生产力，我们构建了一个异质性农场模型，这些农场进行作物选择并投资于生产率改进。我们利用越南详细的农场层面面板数据对模型进行校准，并利用各地区农业制度和产出的差异。我们重点关注越南南方，并量化北方地区较高的测量扭曲对农场选择和农业生产力的影响。我们发现，越南北部较高的扭曲使农业生产力降低了41%，这解释了观察到的地区间2.5倍差异的61%。此外，三分之二的生产力损失源于农场选择较低生产率的作物以及减少提升生产率的投资，这使静态错配造成的生产力损失增加了一倍以上。

【**NBER**】: NBER Working Paper No. 30985，https://www.nber.org/papers/w30985
...
【**摘要**】：过去四个世纪的国际货币体系经历了特定货币作为全球债务合约主导计价单位的兴起、持续和衰落。我们认为，基于流动性的理论对于解释这一模式是必要的。企业发行债务，这些债务可以通过将其收入交易为相同计价单位的金融资产来清偿。当资产市场在流动性方面存在差异时（通过内生搜索摩擦建模），企业会最优地选择以流动性最强的资产单位来计价债务。单一主导货币的均衡源于一个正反馈循环：以流动性更强的计价单位发行债务会内生地提高该计价单位的收益。从历史上看，这种反馈机制是由致力于提供最大规模同计价单位流动性资产的政府所催化的。一旦主导货币出现，该货币所在国政府会内生地增加对其金融市场流动性的投资，从而导致该均衡的进一步巩固。我们的理论解释了荷兰盾、英镑、美元的历史经验以及它们之间的转换。我们为当前美元主导的国际金融架构提供了合理解释，并对人民币的潜在崛起做出了预测。

【**NBER**】: NBER Working Paper No. 30984，https://www.nber.org/papers/w30984

#### 11. The Impacts of Same and Opposite Gender Alumni Speakers on Interest in Economics {#30983}

【**Author**】: Arpita Patnaik, Gwyn C. Pauley, Joanna Venator, Matthew J. Wiswall
...
【**摘要**】：在经济学导论课程中，男性和女性校友演讲者干预对学生经济学兴趣有何影响？利用学生层面的成绩单数据，我们以未接受演讲者干预的课堂作为对照组，在包含教授和学期固定效应以及学生层面协变量的模型中，估计了演讲者对后续课程选择的影响。校友演讲者使中级经济学课程的选修率提高了2.1个百分点（11%）。学生对同性别的演讲者反应更强烈：男性演讲者使男性的课程选修率提高了36%，而女性演讲者使女性的课程选修率提高了40%，这表明校友演讲者的影响具有强烈的性别差异。

【**NBER**】: NBER Working Paper No. 30983，https://www.nber.org/papers/w30983

#### 12. Automating Automaticity: How the Context of Human Choice Affects the Extent of Algorithmic Bias {#30981}

【**Author**】: Amanda Y. Agan, Diag Davenport, Jens Ludwig, Sendhil Mullainathan
...
【**摘要**】：消费者选择越来越多地由算法中介，这些算法利用过去选择的数据来推断消费者偏好，然后策划未来的选择集。行为经济学指出了这些算法经常失败的一个原因：选择可能系统性地偏离偏好。例如，研究表明偏见不仅源于偏好和信念，还源于人们做出选择时的背景。当人们自动行事时，偏见就会潜入；仓促的决定通常比缓慢、深思熟虑的决定更具偏见，并可能导致用户自身并未有意识想要或意图的行为。因此，基于自动行为训练的算法可能会误解用户的偏见：行为越自动，错误就越大。我们在实验室实验中实证检验了这些想法，发现更自动的行为确实似乎会导致更具偏见的算法。然后，我们通过对其两个最大市场（美国和印度）的Facebook进行算法审计，探讨了这一想法的大规模后果，重点关注用户参与方式不同的两种算法：新闻推送（人们相当自动地与朋友的帖子互动）和“你可能认识的人”（人们相当审慎地选择朋友）。我们在新闻推送算法中发现了显著的群体外偏见（例如，白人不太可能看到黑人朋友的帖子，穆斯林不太可能看到印度教朋友的帖子），但在PYMK算法中没有发现可检测到的偏见。这些结果共同表明，需要重新思考大规模算法如何使用人类行为数据，尤其是在线上环境中，因为其中大量被测量的行为可能相当自动。

【**NBER**】: NBER Working Paper No. 30981，https://www.nber.org/papers/w30981

#### 13. Mutual Fund Flows and the Supply of Capital in Municipal Financing {#30980}

【**Author**】: Manuel Adelino, Sophia Chiyoung Cheong, Jaewon Choi, Ji Yeol Jimmy Oh
...
【**摘要**】：本文识别了共同基金资本供给波动对市政债券融资的影响，并对文献做出了三项贡献。首先，我们基于晨星评级方法在基金运营满5年时的特点，开发了一种识别策略。该方法分离出与基金和发行人基本面均正交的供给侧效应，并可广泛应用于多种场景。其次，我们表明，外生的基金流动会导致更多的市政债券发行并推高债券价格，但这仅当基金、发行人和承销商通过现有关系连接时才成立。这一结果突显了关系贷款在市政债券融资背景下的作用。第三，我们的结果表明，市政债券发行人利用有利的融资条件，发行延迟更短、交易成本更低的债券，例如无需选民批准的非一般义务债券和非绿色债券。这些摩擦可能限制资本供给冲击对市政融资的影响。

【**NBER**】: NBER Working Paper No. 30980，https://www.nber.org/papers/w30980

#### 14. The Nature of Long-Term Unemployment: Predictability, Heterogeneity and Selection {#30979}

【**Author**】: Andreas I. Mueller, Johannes Spinnewijn
...
【**摘要**】：本文利用瑞典丰富的行政数据研究长期失业的可预测性。我们通过分别使用广泛的可观测预测因子和多次失业结局，来考虑观测和未观测的异质性，从而确立了不同个体之间长期失业风险的显著异质性。我们应用预测算法来研究失业期间和工作周期中工作寻找的动态变化。选择效应可以解释失业期间平均工作寻找率下降的大部分原因，但对其周期性变化解释甚少。我们还发现，在失业期间的工作寻找率轨迹上存在相当大的异质性，但在工作周期中则不然。

【**NBER**】: NBER Working Paper No. 30979，https://www.nber.org/papers/w30979
...
【**摘要**】：关系契约——由重复互动维持的非正式自我执行协议——在组织边界内外无处不在。本综述重点介绍了选定领域的最新实证贡献。我们首先回顾了一些近期工作，这些工作明确地将支撑关系契约模型的动态激励相容约束应用于数据。然后，我们讨论了关系契约与企业绩效之间的关系。最后，我们指出了我们认为特别适合未来研究的方向。

【**NBER**】: NBER Working Paper No. 30978，https://www.nber.org/papers/w30978

#### 16. The Slow Diffusion of Earnings Inequality {#30977}

【**Author**】: Isaac Sorkin, Melanie Wallskog
...
【**摘要**】：在过去的几十年里，美国收入不平等急剧上升，其中企业间薪酬差异的扩大是主要原因。本文表明，一种独特的跨队列模式驱动了这一上升：较新的企业队列在进入时更加分散，并且在其整个生命周期中保持更加分散。类似的队列模式还驱动了其他一系列密切相关的事实：基于薪酬、教育和年龄的工人跨企业分类增加，以及企业间生产率差异的扩大。我们讨论了两个重要含义。首先，这些队列模式表明，与商业活力下降相关的企业进入变化与收入不平等加剧之间存在联系。其次，队列效应意味着不平等的缓慢扩散：我们预计不平等将继续上升，因为更老、更平等的企业队列将被更年轻、更不平等的企业队列所取代。粗略计算表明，这种势头可能相当大，未来二十年企业间不平等的增幅几乎与过去二十年一样大。

【**NBER**】: NBER Working Paper No. 30977，https://www.nber.org/papers/w30977
...
【**摘要**】：经济模型对于下一个重大创意及其带来的生产率红利何时出现几乎无法提供洞见。然而，一旦某种通用目的技术（GPT）被识别出来，经济学工具箱确实能够帮助理解企业何时以及为何采纳新技术。现有文献的焦点在于各类GPT之间的共性。鉴于该领域的目标是识别跨技术的可推广洞见，这种聚焦是自然的。总体而言，这些文献强调企业间共同发明成本的异质性。然而，每种GPT都提供了独特的益处：蒸汽提供了新的动力源，互联网促进了沟通。GPT之间的差异对于理解采纳模式至关重要。以互联网和人工智能为例，我们讨论了共同发明成本和独特益处如何共同决定技术的采纳。对于这两种技术，我们论证了关于GPT对生产率和增长影响的讨论需要同时强调收益与成本。因此，本文的目标是将关于共同发明成本的文献与对每种GPT独特益处的理解联系起来。

【**NBER**】: NBER Working Paper No. 30976，https://www.nber.org/papers/w30976

#### 18. Government Audits {#30975}

【**Author**】: Martina Cuneo, Jetson Leder-Luis, Silvia Vannutelli
...
【**摘要**】：审计是政府用于监督公共支出的常见机制。在本文中，我们结合理论与实证研究讨论审计的有效性。在我们的模型中，审计的价值既取决于滥用行为的潜在存在程度，也取决于政府观察滥用行为并执行惩罚的能力，这使得审计在中等国家能力环境中最为有效。与这一理论一致，我们调查了所有现有的可信因果研究，并表明政府审计似乎在中等国家能力环境（如巴西）中大多产生积极效果。我们提供了来自美国城市政府（一个高能力、低不当行为的环境）的新实证证据。利用联邦审计规则中一个此前未被探索的阈值以及动态断点回归框架，我们估计了这些审计对美国城市财政的影响，并发现审计没有边际效应。

【**NBER**】: NBER Working Paper No. 30975，https://www.nber.org/papers/w30975

#### 19. Effects of Enhanced Legal Aid in Child Welfare: Evidence from a Randomized Trial of Mi Abogado {#30974}

【**Author**】: Ryan Cooper, Joseph J. Doyle Jr., Andrés P. Hojman
...
【**摘要**】：儿童在寄养机构中度过数年，人们担忧官僚障碍导致不必要的长期寄养。智利政府采用一种新颖的政策制定方法，随机引入一项旨在减少这些延迟的项目，以评估其对儿童福祉的影响。Mi Abogado（我的律师）为生活在机构中的寄养儿童提供法律援助和社会服务。利用跨政府登记册关联的行政数据，我们发现该项目缩短了寄养时长，且未增加后续安置，节省的成本远超项目支出。该项目还导致刑事司法介入减少，并改善了学校出勤率。结果表明，投资于寄养服务质量可以改善儿童福祉。

【**NBER**】: NBER Working Paper No. 30974，https://www.nber.org/papers/w30974

#### 20. Behavioral Economics in Education Market Design: A Forward-Looking Review {#30973}

【**Author**】: Alex Rees-Jones, Ran Shorrer
...
【**摘要**】：用于建模匹配市场的理性选择框架在指导学校分配系统设计方面极为有用。尽管取得了这一成功，大量研究记录了与该框架预测的偏离，这些偏离似乎受到行为经济学现象的影响。我们回顾了这些发现以及作为可能解释提出的行为理论体系。受此文献启发，我们提出了行为经济学家直接助力教育市场设计的路径。

【**NBER**】: NBER Working Paper No. 30973，https://www.nber.org/papers/w30973

#### 21. Cross-State Strategic Voting {#30972}

【**Author**】: Gordon B. Dahl, Joseph Engelberg, Runjing Lu, William Mullins

【**Abstract**】: We estimate that 3.1% of US voters, or 6.1 million individuals, were registered to vote in two states in 2020, opening up the possibility for them to choose where to vote. Double registrants are concentrated in the wealthiest zipcodes and respond to both incentives and costs, disproportionately choosing to vote in swing states (higher incentive) and states which automatically send out mail-in ballots (lower cost). We call this behavior Cross-State Strategic Voting. While others have documented strategic incentives on who to vote for, this paper is the first to consider strategic incentives on where to vote.

【**摘要**】：我们估计，2020年有3.1%的美国选民（即610万人）在两个州注册投票，这为他们选择投票地点提供了可能性。双重注册者集中在最富裕的邮政编码区，并对激励和成本均做出反应，他们不成比例地选择在摇摆州（更高激励）和自动邮寄选票的州（更低成本）投票。我们将这种行为称为跨州策略性投票。虽然已有文献记录了关于投票给谁的战略激励，但本文首次考虑了关于投票地点的战略激励。

【**NBER**】: NBER Working Paper No. 30972，https://www.nber.org/papers/w30972

#### 22. State-Dependent Local Projections: Understanding Impulse Response Heterogeneity {#30971}

【**Author**】: James Cloyne, Òscar Jordà, Alan M. Taylor
...
【**摘要**】：脉冲响应是干预在不同时间跨度上的动态平均效应。我们利用著名的Kitagawa-Blinder-Oaxaca分解来探索响应随时间和经济状态的异质性。这可以通过对通常的局部投影设定进行简单扩展来实现，同时保持模型在参数上的线性。利用我们基于分解的新方法，我们展示了如何解析财政乘数的异质性——该乘数在任何时点都可能取决于多个潜在相关因素，包括现有经济状况和货币响应。在我们的应用中，财政乘数随货币政策显著变化：根据货币抵消程度的不同，它可能小至零，也可能大至2。

【**NBER**】: NBER Working Paper No. 30971，https://www.nber.org/papers/w30971

#### 23. Lottery-Based Evaluations of Early Education Programs: Opportunities and Challenges for Building the Next Generation of Evidence {#30970}

【**Author**】: Christina Weiland, Rebecca Unterman, Susan Dynarski, Rachel Abenavoli, Howard Bloom, Breno Braga, Ann-Marie Faria, Erica H. Greenberg, Brian Jacob, Jane Arnold Lincove, Karen Manship, Meghan McCormick, Luke Miratrix, Tomás E. Monarrez, Pamela Morris-Perez, Anna Shapiro, Jon Valant, Lindsay Weixler
...
【**摘要**】：基于抽签的识别策略为生成美国早期教育项目的下一代证据提供了潜力。我们由五个应用该设计的研究团队和方法专家组成的合作网络，识别出在此新背景下需要仔细考虑的六个挑战：1）可用的基线协变量可能不够丰富；2）反事实数据有限；3）结果数据有限且不一致；4）因损耗导致内部有效性减弱；5）因谁竞争超额订阅项目导致外部有效性受限；6）用儿童层面的随机化回答项目层面问题的困难。我们为这六个挑战提供了潜在解决方案，并为未来基于抽签的早期教育研究设计提出了具体建议。

【**NBER**】: NBER Working Paper No. 30970，https://www.nber.org/papers/w30970

#### 24. Behavior Mediates the Health Effects of Extreme Wildfire Smoke Events {#30969}

【**Author**】: Sam Heft-Neal, Carlos F. Gould, Marissa Childs, Mathew V. Kiang, Kari Nadeau, Mark Duggan, Eran Bendavid, Marshall Burke
...
【**摘要**】：已知空气污染对一系列健康结果产生负面影响。野火烟雾是空气污染日益重要的来源，然而极端烟雾事件高度显著，可能引发改变健康影响的行为反应。我们结合覆盖加州近1.27亿次急诊就诊的地理定位数据与每日地表野火烟雾PM2.5浓度估计值，量化日益严重的野火烟雾事件如何影响急诊就诊。低或中等水平的烟雾暴露在暴露后一周内使总就诊量增加1-1.5%，但极端烟雾日相对于无烟日使总就诊量减少6-9%。这种减少持续至少一个月。极端暴露期间的下降主要由被认为不受污染急性影响的诊断（包括意外伤害）驱动，且不成比例地来自保险覆盖较少的人群。相比之下，与短期空气污染生理联系最强的健康结果急剧增加：一次极端烟雾日后一周内，哮喘、慢性阻塞性肺病和咳嗽的急诊就诊量均增加30-110%。由于在我们的样本中低和中等烟雾日远超极端烟雾日，我们估计2006-2017年间，烟雾暴露每年在加州导致约3000次额外急诊就诊。

【**NBER**】: NBER Working Paper No. 30969，https://www.nber.org/papers/w30969

#### 25. Pediatric Drug Adherence and Parental Attention: Evidence from Comprehensive Claims Data {#30968}

【**Author**】: Josh Feng, Matthew J. Higgins, Elena Patel
...
【**摘要**】：利用美国全面的药物索赔数据，我们显示在COVID-19大流行期间，哮喘控制药物的依从性有所下降。我们发现，到2020年底，幼儿的依从性下降了40%。年龄较大儿童的反应负面程度较小，而成年人的反应则为正面。基于大流行前邮购使用情况和父母处方数量的异质性，我们提供了额外证据表明父母关注在推动这一下降中发挥了作用。本文讨论了改善儿科药物依从性的政策含义。

【**NBER**】: NBER Working Paper No. 30968，https://www.nber.org/papers/w30968

#### 26. RIM-Based Value Premium and Factor Pricing Using Value-Price Divergence {#30967}

【**Author**】: Lin William Cong, Nathan Darden George, Guojun Wang
...
【**摘要**】：我们证明，价值-价格比（基于剩余收益模型的估值与市场价格之比）在预测股票收益方面吸收了账面市值比以及许多其他价值或质量指标的能力。多空价值-价格投资组合对冲了动量效应，重振了过去几十年看似缺失的价值溢价，并在调整常见因子后产生了显著收益。由这些投资组合在小型和大型股票中的平均收益构建的价值-价格偏离（VPD）因子并未被这些已知因子所涵盖。最大夏普比率和约束R平方检验表明，VPD是传统价值因子的更好替代品，而使用VPD、市场、动量与规模因子的四因子模型在解释预期股票收益的横截面方面优于大多数现有基准。在股权资本成本的不同设定下，这些发现依然稳健。

【**NBER**】: NBER Working Paper No. 30967，https://www.nber.org/papers/w30967

#### 27. Cooling Externality of Large-Scale Irrigation {#30966}

【**Author**】: Thomas Braun, Wolfram Schlenker
...
【**摘要**】：我们提供了新的证据，表明大规模灌溉在生长季节的月份相对于一年中其他时间，异质性地将温度分布向更凉爽的温度偏移。我们采用三重差分估计量，使用了59年的天气记录面板数据，并结合奥加拉拉含水层上393个县中每个县的灌溉面积比例。灌溉导致的降温向下风方向传播，并在八月份将温度分布的上尾降低多达3°C（5°F），这对下风方向的作物产量（每年1.2亿美元）和温度诱发的超额死亡率（每年2.4亿美元）产生了正外部性，其规模与通过增强耐热性带来的灌溉直接效益（每年4.4亿美元）相当。观察到的降温有助于解释为什么美国经历的变暖，特别是极端高温的变暖，少于气候模型的预测。我们的发现强调，高度灌溉地区的天气冲击并非外生，而是受到人类以灌溉形式做出的反应的影响。

【**NBER**】: NBER Working Paper No. 30966，https://www.nber.org/papers/w30966

#### 28. Unconditional Cash Transfers for Families with Children in the U.S.: A Scoping Review {#30965}

【**Author**】: Hema Shah, Lisa A. Gennetian
...
【**摘要**】：儿童是美国社会福利体系中最大的间接受益者。然而，关于现金援助对儿童的直接益处仍有许多问题。目前对美国现金援助影响的理解主要来自对实物福利、税收抵免和有条件现金援助项目的研究。相应的经济学文献侧重于父母的劳动供给反应，以及收入、育儿技能和早期教育作为减少儿童福祉社会经济不平等的家庭投资机制的作用。与美国相反，数十个中低收入国家将直接现金援助（有条件或无条件）作为核心政策策略，并在众多经济和健康指标以及儿童健康和教育的特定方面显示出积极效果。本文回顾了关于美国安全网项目和对有子女家庭现金援助的经济学研究，以及现有研究揭示了这些项目对家庭投资机制和儿童结果的影响。我们特别强调了在理解无条件现金援助对儿童影响方面的空白。然后，我们回顾了九个当代的无条件现金转移支付项目，并讨论了它们在填补美国关于现金援助对儿童发展影响的经济证据空白方面的前景和局限性。

【**NBER**】: NBER Working Paper No. 30965，https://www.nber.org/papers/w30965

#### 29. Parental Education and Invention: The Finnish Enigma {#30964}

【**Author**】: Philippe Aghion, Ufuk Akcigit, Ari Hyytinen, Otto Toivanen
...
【**摘要**】：为什么发明与父母收入呈强烈正相关，不仅在美国如此，在收入不平等程度低且社会流动性高的芬兰也是如此？利用145万芬兰个体及其父母的数据，我们发现：（i）在控制父母教育后，父母收入与子女发明概率之间的正相关关系大幅减弱；（ii）利用到最近大学的距离作为父母拥有硕士学位的工具变量，揭示了父母教育对子女发明概率的巨大因果效应；（iii）20世纪70年代初引入的综合学校教育改革显著削弱了父母教育的因果效应。

【**NBER**】: NBER Working Paper No. 30964，https://www.nber.org/papers/w30964

#### 30. Beware the Side Effects: Capital Controls, Trade and Misallocation {#30963}

【**Author**】: Eugenia Andreasen, Sofía Bauducco, Evangelina Dardati, Enrique G. Mendoza

【**Abstract**】: Capital controls are an effective credit-management tool but they have serious side effects. Analyzing a dynamic Melitz-OLG model in which firms face credit constraints, we find that capital controls worsen misallocation and hurt exports. Misallocation worsens through static effects that lower capital-labor ratios and raise firm prices. In addition, changes in saving incentives induce dynamic effects and changes in wages, aggregate demand and the real exchange rate cause general equilibrium effects. A quantitative analysis calibrated to Chile’s capital controls of the 1990s yields a sizable worsening in misallocation, with stronger effects on firms that are exporters, more productive, or far from their optimal scales. Exports and the share of exporting firms fall sharply. Rebating the revenue that capital controls may generate or using loan-to-value regulation instead of capital controls results in sharply weaker effects, but slightly tighter capital controls strengthens them significantly. A set of empirical tests applied to Chilean firm-level data provide robust support for the model’s key predictions.

【**摘要**】：资本管制是一种有效的信贷管理工具，但具有严重的副作用。通过分析一个企业面临信贷约束的动态Melitz-OLG模型，我们发现资本管制加剧了资源错配并损害了出口。资源错配通过降低资本劳动比和提高企业价格的静态效应而恶化。此外，储蓄激励的变化引发动态效应，而工资、总需求和实际汇率的变动则产生一般均衡效应。基于20世纪90年代智利资本管制校准的定量分析显示，资源错配显著恶化，对出口企业、生产率较高企业或远离最优规模的企业影响更强。出口和出口企业份额大幅下降。将资本管制可能产生的收入返还给企业，或使用贷款价值比监管替代资本管制，会导致影响显著减弱，但略微收紧资本管制则会显著增强这些影响。一系列应用于智利企业层面数据的实证检验为模型的关键预测提供了有力支持。

【**NBER**】: NBER Working Paper No. 30963，https://www.nber.org/papers/w30963

#### 31. A Mother’s Voice: Impacts of Spousal Communication Training on Child Health Investments {#30962}

【**Author**】: Martina Bjorkman-Nyqvist, Seema Jayachandran, Celine P. Zipfel
...
【**摘要**】：基于先前关于母亲通常比父亲更偏好于为孩子支出的证据，我们利用一项随机实验评估了乌干达一项针对母亲的沟通培训项目对儿童健康的影响。假设是，该培训将使女性能够更好地向丈夫传达她们的知识和偏好，从而增加对儿童健康的投资。我们发现，该项目增加了配偶之间关于家庭健康、营养和财务状况的讨论。然而，这并未提高健康促进行为的总体采纳率，也未改善儿童的人体测量指标。一个例外是，沟通培训增加了女性和儿童对富含蛋白质食物的摄入量，以及家庭在这些食物上的支出。

【**NBER**】: NBER Working Paper No. 30962，https://www.nber.org/papers/w30962
...
【**摘要**】：本文在一个具有工资刚性的经典异质性代理人新凯恩斯（HANK）模型中刻画了最优货币政策。在相机抉择下，功利主义规划者面临向负债、高边际效用家庭进行再分配的激励，这是一种新的通胀偏差来源。在承诺下，（i）零通胀是最优长期政策，（ii）时间一致的政策需要同时包含通胀惩罚和分配惩罚，（iii）规划者在总体稳定与分配考量之间进行权衡，因此神圣巧合不再成立。我们使用序列空间方法计算了应对生产率、需求和成本推动冲击的最优稳定政策，并将该方法扩展到了拉姆齐问题和福利分析。

【**NBER**】: NBER Working Paper No. 30961，https://www.nber.org/papers/w30961

#### 33. Immigration, The Long-Term Care Workforce, and Elder Outcomes in the U.S. {#30960}

【**Author**】: David C. Grabowski, Jonathan Gruber, Brian McGarry
...
【**摘要**】：尽管关于移民的争论仍然存在争议，但一个严重依赖移民的重要行业正面临严重的劳动力短缺：养老院。我们整合了关于移民和养老院的多个数据集，并使用偏移-份额工具变量分析来评估移民增加对养老院人员配置和护理质量的影响。我们表明，移民增加显著提高了美国养老院的人员配置水平，尤其是在全职岗位上。然后我们证明，这对患者结果产生了非常积极的影响，特别是对于在养老院短期居住的患者，并且尤其体现在西班牙裔员工的移民方面。

【**NBER**】: NBER Working Paper No. 30960，https://www.nber.org/papers/w30960

#### 34. A Tractable Income Process for Business Cycle Analysis {#30959}

【**Author**】: Fatih Guvenen, Alisdair McKay, Conor B. Ryan
...
【**摘要**】：我们估计了一个收入过程，该过程与关于个人收入风险及其在商业周期中变化的关键事实一致。具体来说，估计的过程产生的收入波动表现出：(i) 平坦且非周期性的方差，(ii) 波动且顺周期的偏度，(iii) 非常高的峰度，以及 (iv) 生命周期内横截面不平等程度的适度上升，所有这些都与美国数据一致。此外，该收入过程捕捉了商业周期收入风险的可预测性质：商业周期事件期间的收入变化部分可由该事件之前的收入水平预测。估计的过程具有时变的创新分布以及商业周期暴露的因子结构。将估计的过程纳入商业周期模型仅增加一个状态变量——如同常用的持久加暂时收入过程——使其成为建模者一个可处理的选择。

【**NBER**】: NBER Working Paper No. 30959，https://www.nber.org/papers/w30959

#### 35. Loose Monetary Policy and Financial Instability {#30958}

【**Author**】: Maximilian Grimm, Òscar Jordà, Moritz Schularick, Alan M. Taylor
...
【**摘要**】：持续宽松的货币政策时期是否会增加金融脆弱性和金融危机的可能性？这是政策制定者面临的一个核心问题，然而文献并未在总体层面提供关于这种联系的系统性经验证据。在本文中，我们通过分析长期历史数据来填补这一空白。我们发现，当货币政策立场在较长时期内保持宽松时，未来发生金融动荡的可能性会显著增加。我们研究了导致这一结果的因果路径，并认为信贷创造和资产价格过热是重要的中介渠道。

【**NBER**】: NBER Working Paper No. 30958，https://www.nber.org/papers/w30958
...
【**摘要**】：大型语言模型（如ChatGPT）有潜力彻底改变经济学及其他学科的研究。我描述了六个领域的25个用例，在这些领域中，大型语言模型作为研究助手和导师开始变得有用：构思、写作、背景研究、数据分析、编码和数学推导。我提供了通用指令，并展示了如何利用每个用例的具体示例，将大型语言模型的能力从实验性分类到高度有用。我假设持续的进步将提高大型语言模型在所有领域的表现，并且利用大型语言模型自动化微观任务的经济学研究者将变得显著更高效。最后，我推测了通过大型语言模型实现认知自动化对经济学研究的长期影响。

【**NBER**】: NBER Working Paper No. 30957，https://www.nber.org/papers/w30957

#### 37. The Economic Opportunity Cost of Green Recovery Plans {#30956}

【**Author**】: Timothy Fitzgerald, Casey B. Mulligan
...
【**摘要**】：多个国家的倡导者推动从疫情中进行“绿色复苏”，重点在于应对气候目标的措施。我们评估了美国的提案，发现按照所述，进一步削减交通和电力排放的雄心勃勃计划将需要更多投入来生产相同产出，导致每年高达4830亿美元的经常性成本。我们预测，如果政策按所述实施，长期内实际GDP和消费将减少2-3%，这突显了当资源可能被更有效配置时实现绿色目标的机会成本。

【**NBER**】: NBER Working Paper No. 30956，https://www.nber.org/papers/w30956

#### 38. Estimating Causal Effects of Fertility on Life Course Outcomes: Evidence Using A Dyadic Genetic Instrumental Variable Approach {#30955}

【**Author**】: Boyan Zheng, Qiongshi Lu, Jason Fletcher
...
【**摘要**】：生育的因果效应是社会科学的焦点，但分析因生育选择的内生性而面临挑战。早期研究提出了几种来自双胞胎出生或先前出生性别构成的“自然实验”，以评估生育更多孩子是否影响成人结果，尽管使用罕见（双胞胎）和弱（性别构成）的工具变量来研究生育存在局限性。本文提出了一种新的“自然实验”方法，通过测量夫妻基因组合来预测生育——一种二元遗传工具变量，其关键思想（排除限制）是，夫妻基因相互作用改变生育可能性的情况对夫妻而言是未知的。我们使用一个全国代表性的夫妻样本来考察生育对老年人生活结果的长期影响，包括劳动力市场结果、人格特质和主观幸福感。我们发现，生育降低了女性的外向性和工作年限，一些证据表明生育减少了男性和女性一生中从事的工作数量。

【**NBER**】: NBER Working Paper No. 30955，https://www.nber.org/papers/w30955

#### 39. Production Network Formation, Trade, and Welfare {#30954}

【**Author**】: Costas Arkolakis, Federico Huneeus, Yuhei Miyauchi

【**Abstract**】: We study the aggregate implications of endogenous production network formation in a multi-location general equilibrium trade model. Firms form supplier and buyer linkages under matching frictions, generating a gravity structure of production networks. We analytically characterize the welfare gains from trade cost reductions relative to a benchmark model with fixed production networks. We calibrate the model to Chilean firm-to-firm data and show that it matches observed domestic and international network responses to tariff reductions. We find that endogenous networks substantially increase the welfare gains from trade, due to inefficiently low equilibrium networks and amplification effects through relationship-formation costs.

【**摘要**】：我们研究了多区位一般均衡贸易模型中内生生产网络形成的总体影响。企业在匹配摩擦下形成供应商和买家联系，产生生产网络的引力结构。我们相对于一个固定生产网络的基准模型，分析性地刻画了贸易成本降低带来的福利收益。我们将模型校准到智利企业间数据，并表明它匹配了观察到的国内和国际网络对关税削减的反应。我们发现，由于均衡网络效率低下以及通过关系形成成本的放大效应，内生网络显著增加了贸易带来的福利收益。

【**NBER**】: NBER Working Paper No. 30954，https://www.nber.org/papers/w30954

#### 40. Measuring Domestic Factor Content in Bilateral and Sectoral-Level Trade Flows {#30953}

【**Author**】: Zhi Wang, Shang-Jin Wei, Kunfu Zhu
...
【**摘要**】：衡量双边或部门层面出口中要素含量的国家来源，对于理解区域和全球价值链的演变以及单个国家-部门在这些链条中的作用至关重要。本文提出了一种方法，以区分基于后向联系和前向联系的衡量指标，以及净要素含量和总要素含量。该方法与国民账户体系标准一致，并具有可加性。相比之下，这些性质对于Los等人（2016）提出的“假设提取法”并不成立。我们展示了涉及细分贸易的几个例子，其中两种方法存在差异。

【**NBER**】: NBER Working Paper No. 30953，https://www.nber.org/papers/w30953

#### 41. Dynamic Pricing Regulation and Welfare in Insurance Markets {#30952}

【**Author**】: Naoki Aizawa, Ami Ko
...
【**摘要**】：虽然保险公司的传统角色是为个人特有的风险提供保障，但保险公司自身也面临着由总体冲击带来的巨大不确定性。为了防止保险公司将这些总体风险转嫁给消费者，政府越来越多地采用动态定价监管，限制保险公司随时间调整保费的能力。我们利用一个美国长期护理保险市场的均衡模型来评估动态定价监管，该模型考虑了保险公司缺乏承诺以及内生市场结构的特点。我们发现，更严格的动态定价监管对改善消费者福利的影响有限，同时会降低保险公司利润并增加市场集中度。

【**NBER**】: NBER Working Paper No. 30952，https://www.nber.org/papers/w30952

#### 42. Direct and Spillover Effects of Provider Vaccination Facilitation {#30951}

【**Author**】: Julie Berry Cullen, Maria K. Humlum, Agne Suziedelyte, Peter Rønø Thingholm

【**Abstract**】: We explore physicians’ role in moderating compliance with recommended vaccinations. Using administrative data on the universe of Danish children and their healthcare providers, we first construct and validate a measure of providers’ propensities to facilitate recommended vaccinations from birth to age 6 based on a two-way fixed effects model. We then show that the measure meaningfully affects uptake of the human papillomavirus (HPV) vaccine among adolescent patients and speeds recovery from a media-induced crisis to perceived HPV vaccine safety. Providers affect decisions beyond those of their own patients, influencing the uptake of patients’ younger cousins by one-fifth as much as own patients’ uptake.

【**摘要**】：我们探讨了医生在调节推荐疫苗接种依从性方面的作用。利用涵盖所有丹麦儿童及其医疗保健提供者的行政数据，我们首先基于一个双向固定效应模型，构建并验证了一个衡量医疗服务提供者从出生到6岁期间促进推荐疫苗接种倾向的指标。然后，我们表明该指标显著影响了青少年患者对人乳头瘤病毒（HPV）疫苗的接种率，并加速了因媒体引发的对HPV疫苗安全性信任危机后的恢复。医疗服务提供者的影响超出了其自身患者的范围，他们对患者表亲接种率的影响程度相当于对自身患者接种率影响程度的五分之一。

【**NBER**】: NBER Working Paper No. 30951，https://www.nber.org/papers/w30951

#### 43. The Effect of R&D on Quality, Productivity, and Welfare {#30950}

【**Author**】: Mons Chan, Amil Petrin, Frederic Warzynski
...
【**摘要**】：在本文中，我们提供了一种方法论，利用来自丹麦的详细企业-产品层面数据，联合研究多产品企业的生产与需求。我们通过将生产函数估计与允许准固定投入的成本函数相结合来估计边际成本。我们使用一个离散选择需求模型，该模型扩展了Berry、Levinsohn和Pakes（1995）的见解，以获得需求冲击（质量）的度量。我们估计了产品（过程）研发与质量（效率）之间的关系，并发现强有力的证据表明过程创新与更高的效率相关，而产品创新则与更高的产品质量相关。我们讨论了这两种不同创新活动的福利含义。

【**NBER**】: NBER Working Paper No. 30950，https://www.nber.org/papers/w30950

#### 44. Inclusion and Democratization Through Web3 and DeFi? Initial Evidence from the Ethereum Ecosystem {#30949}

【**Author**】: Lin William Cong, Ke Tang, Yanxin Wang, Xi Zhao
...
【**摘要**】：Web3和DeFi被广泛倡导为促进金融包容性和民主化的创新。我们汇集了迄今为止关于最大Web3生态系统的最全面数据集，并使用大规模计算进行了初步调查。我们描述了以太坊的网络结构、时间趋势以及交易、挖矿和所有权的分布。挖矿收入和以太币所有权集中在交易所和少数个体节点。网络活动从点对点演变为用户与DApps/DeFi的交互，大型参与者的交易显著增多。此外，高比例的交易费用、拥堵导致的Gas价格波动、次优的储备设置以及代币收益的大幅波动，对小型、贫困、缺乏经验和新的节点构成了特殊挑战，更不用说高失败率对所有用户造成的损害。最后，我们提出了提示性因果证据，表明基础费用燃烧机制（例如EIP-1559）和空投计划（例如OmiseGo空投）通过代币货币再分配促进了包容性。

【**NBER**】: NBER Working Paper No. 30949，https://www.nber.org/papers/w30949

#### 45. Donor Contracting Conditions and Public Procurement: Causal Evidence from Kenyan Electrification {#30948}

【**Author**】: Catherine Wolfram, Edward Miguel, Eric Hsu, Susanna B. Berkouwer
...
【**摘要**】：关于不同的公共采购法规对由国家政府和外国援助捐助者资助的项目质量和性价比的影响，目前因果证据有限。本文利用政策变化和实验变异，研究两个关键的合同特征——即合同捆绑和监控——如何影响一个大型经济发展项目的结果。我们利用了肯尼亚全国电气化计划的一个不寻常特点：多边资金来源在邻近村庄之间的准随机分配。非洲开发银行（AfDB）的项目使用捆绑合同，而世界银行（WB）则采用非捆绑合同并加强检查。为了衡量影响，我们收集了实地工程评估、电能质量数据、家庭调查，并分析了原始合同。分析表明存在明显的权衡：与AfDB项目点相比，世界银行的程序使建设完工延迟了16个月，但将建设质量提高了0.6个标准差，幅度相当大。为了区分合同捆绑与监控的影响，我们进行了随机审计以加强监控。审计提高了AfDB项目点的家庭连接率、网络规模和电压，但对世界银行项目点没有影响，这表明监控与非捆绑合同可能是替代品。鉴于这种明显的权衡，我们研究了净收益如何取决于政策制定者的时间偏好和基础设施的寿命。

【**NBER**】: NBER Working Paper No. 30948，https://www.nber.org/papers/w30948

#### 46. Ideas Mobilize People: The Diffusion of Communist Ideology in China {#30947}

【**Author**】: Ying Bai, Ruixue Jia, Runnan Wang
...
【**摘要**】：思想能否动员人们参与集体行动？我们通过研究接触共产主义意识形态如何影响个人在党的形成阶段选择加入中国共产党（CCP），为这个问题提供了肯定答案。我们关注的个体是黄埔军校的学员，他们随后参加了20世纪中国最重要的战争。我们的识别策略利用了《新青年》杂志（1919年凡尔赛条约后推广共产主义的主要平台）发行量在地区、时间和内容上的变化，以及个体随时间所处地点的变化。通过比较生活在有1919年后《新青年》可获取地区的黄埔学员与曾生活在同一地区但错过了这一渠道的学员，我们证明前者加入中国共产党的可能性显著更高。在未来的政治斗争中，那些政党选择受此意识形态渠道影响更大的个体，更不可能退出中国共产党，并且更有可能牺牲生命。此外，我们记录到家庭背景无法预测这些政治先驱的政党选择，但社会网络可以补充意识形态接触的影响。

【**NBER**】: NBER Working Paper No. 30947，https://www.nber.org/papers/w30947

#### 47. Unsupervised Machine Learning for Explainable Health Care Fraud Detection {#30946}

【**Author**】: Shubhranshu Shekhar, Jetson Leder-Luis, Leman Akoglu
...
【**摘要**】：美国每年在医疗保健上的支出超过4万亿美元，主要由私人提供者执行并由保险公司报销。该系统的一个主要问题是提供者存在过度收费、浪费和欺诈行为，因为他们有动机在索赔中虚报以获取更高的赔付。在这项工作中，我们开发了新颖的机器学习工具来识别向保险公司过度收费的提供者。利用来自美国联邦医疗保险（Medicare，为老年人和残疾人提供的联邦健康保险计划）的大规模索赔数据，我们识别出住院治疗中与欺诈或过度收费一致的模式。我们提出的欺诈检测方法完全是无监督的，不依赖于任何标记的训练数据，并且对最终用户是可解释的，为被标记提供者的潜在可疑行为提供推理和可解释的见解。来自司法部关于面临反欺诈诉讼的提供者的数据以及对可疑提供者的案例研究验证了我们的方法和发现。我们还进行了事后分析，以了解医院特征——那些未用于检测但与高可疑评分相关的特征。我们的方法相比随机定位提供了8倍的提升，可用于指导公共和私人医疗保险系统对可疑提供者的调查和审计。

【**NBER**】: NBER Working Paper No. 30946，https://www.nber.org/papers/w30946

#### 48. Hobbesian Wars and Separation of Powers {#30945}

【**Author**】: Weijia Li, Gérard Roland, Yang Xie
...
【**摘要**】：本文形式化了这样一个原则：政府的迫害权力可能引发围绕该权力的暴力争夺。我们表明，这一原则产生了大量关于不同权力分立制度的理论见解，这些制度有助于在不同的社会经济条件下预防此类争夺。当社会经济凝聚力较低时，只有通过个人对迫害的否决权才能消除争夺的风险。此外，这种全体一致规则只有在行政首脑不控制立法议程时才能抵御专制冲击，即行政和立法部门是分离的。当社会经济凝聚力较高时，无需个人否决权即可消除暴力争夺的风险，但只能通过一个其成员未来不能加入行政部门的迫害审查司法机构来实现，即行政和司法部门是分离的。我们的研究结果揭示了欧洲历史上权力分立的演变。

【**NBER**】: NBER Working Paper No. 30945，https://www.nber.org/papers/w30945

#### 49. Catching Up by ‘Deglobalizing’: Capital Account Policy and Economic Growth {#30944}

【**Author**】: Paul Bergin, Woo Jin Choi, Ju H. Pyun
...
【**摘要**】：尽管大量实证研究评估了资本账户开放是否促进经济增长，本文发现了相反情况的实证证据——即资本管制政策与储备积累政策相结合时，可以促进经济增长。利用1985年至2019年45个国家的面板数据，我们发现资本管制与储备积累相结合（即战略性资本账户政策）有助于实际GDP和全要素生产率的增长。这种效应在新兴市场以及全球金融危机之前更为显著。我们表明，该政策与制造业规模和生产率的大幅提升密切相关，并且与通过出口实现“干中学”的理论相一致。

【**NBER**】: NBER Working Paper No. 30944，https://www.nber.org/papers/w30944

#### 50. The Economics of Digital Privacy {#30943}

【**Author**】: Avi Goldfarb, Verina F. Que
...
【**摘要**】：媒体和监管讨论中对隐私的关注日益增加。这是数字数据实用性增强的结果。文献强调了数字数据流对消费者和企业的收益与成本。收益以数据驱动的创新、更符合消费者需求的高质量产品和服务以及利润增长的形式出现。成本则与隐私的内在价值和工具性价值相关。在标准经济假设下，这种成本收益权衡的框架可能表明，除了在稳健的竞争环境中确保消费者得到充分知情外，监管的作用微乎其微。迄今为止的实证文献主要关注这种直接的成本收益评估，考察隐私法规如何影响各种市场结果。然而，越来越多的理论工作强调了与数据流相关的外部性。这些外部性，无论是正面的还是负面的，都表明对数字隐私进行有针对性的监管是有益的。

【**NBER**】: NBER Working Paper No. 30943，https://www.nber.org/papers/w30943
...
【**摘要**】：超过1500家组织和投资者，代表超过40万亿美元的资产，已承诺进行化石燃料撤资以应对气候变化。这会奏效吗？本章探讨撤资是否可能引发绿色创新，这是向更清洁经济转型的关键组成部分。理论上，撤资可以通过提高“污染企业”的资本成本来引导创新，但目前尚不清楚其效果是否足以显著减少投资机会。我认为，如果投资者具有社会意识并通过“发声”进行治理，那么继续投资于污染行业反而可能推动绿色创新。然而，这取决于理解哪些企业战略实际上促进了绿色创新，而常用的ESG指标存在若干局限性。我展示了如何分解这些指标以及使用替代方法来衡量环境绩效，从而改进投资、战略、管理决策和政策设计。我考察了16个污染密集型行业中的大型企业，分析了14项具体实践与其是否符合《巴黎协定》排放目标（即“碳绩效”）之间的关系。我发现，碳绩效与最基本实践（如披露排放量）之间没有相关性，但与五项更明确的策略呈正相关：设定长期量化排放目标、由第三方验证排放数据、将环境绩效纳入高管薪酬政策、支持政府气候变化努力以及设定内部碳价格。基于这些结果，我构建了一个新的最佳实践评分，并发现该评分与碳绩效的相关性远高于其他一些综合指标。

【**NBER**】: NBER Working Paper No. 30942，https://www.nber.org/papers/w30942

#### 52. The Impact of COVID-19 on Workers’ Expectations and Preferences for Remote Work {#30941}

【**Author**】: Yuting Chen, Patricia Cortés, Gizem Koşar, Jessica Pan, Basit Zafar
...
【**摘要**】：我们利用专门设计的调查，研究了COVID-19如何影响远程工作的普及程度、期望和态度。远程工作的发生率仍高于疫情前水平，男性和女性都预计这种情况将在疫情后持续。工人还报告称，由于疫情，他们对远程工作的偏好有所增加。这些变化与个人因疫情引发的居家办公冲击的暴露程度密切相关，表明疫情期间的远程工作经历可能塑造了对WFH的期望和偏好。偏好和期望的影响程度在性别、婚姻状况以及是否有孩子方面相似。

【**NBER**】: NBER Working Paper No. 30941，https://www.nber.org/papers/w30941
...
【**摘要**】：在2016-17学年招生周期的一项试点项目中，加州大学伯克利分校邀请了许多新生申请者提交推荐信。这在大学内部引发了争议，有人担心这一变化会进一步使来自弱势群体的申请者处于不利地位。为了给这场辩论提供信息，我们以此试点为基础，进行了一项关于提交推荐信对后续录取影响的观察性研究，旨在估计影响如何在预定义的子群体间变化。在观察性研究中理解这种变化具有挑战性，因为估计的影响既反映了实际处理效应的差异，也反映了各组间协变量平衡的差异。为了解决这个问题，我们开发了平衡权重，该权重直接优化子组内的“局部平衡”，同时保持处理组和对照组之间的全局协变量平衡。将这种方法应用于加州大学伯克利分校的试点研究，取得了出色的局部和全局平衡，而传统的加权方法则无法在子组内平衡协变量。我们发现，推荐信的影响随着申请者实力的增强而增加。然而，我们发现来自弱势群体的申请者平均差异很小，尽管这一结果更为复杂。最终，我们得出结论，向更广泛的申请者征集推荐信不会显著改变被录取本科生的构成。

【**NBER**】: NBER Working Paper No. 30940，https://www.nber.org/papers/w30940

#### 54. How the Internet Changed the Market for Print Media {#30939}

【**Author**】: Manudeep Bhuller, Tarjei Havnes, Jeremy McCauley, Magne Mogstad
...
【**摘要**】：本文结合挪威媒体市场中关于报纸发行量、读者数量、收入、要素投入和产品特征的全面数据，以及宽带互联网可用性和普及率中看似外生的变化，提供了关于互联网如何影响传统印刷媒体市场的因果证据。家庭采用宽带互联网引发了印刷版读者数量和发行量的大幅下降，以及在线新闻读者数量的同等大幅增长。尽管从印刷新闻消费到在线新闻消费存在强烈的替代效应，报纸公司的收入却下降了近30%。报纸公司通过大幅削减成本来应对，要么裁减劳动力投入，要么减少报纸的物理版面尺寸，从而避免了利润的重大损失。提供给客户的印刷报纸产品也发生了变化，因为报纸将内容从小报转向了更严肃的新闻。本文提供了一个案例研究，说明不利的技术冲击如何通过拥有多种调整手段的企业进行传导，并为报纸的经济韧性提供了解释。

【**NBER**】: NBER Working Paper No. 30939，https://www.nber.org/papers/w30939

#### 55. Frames, Incentives, and Education: Effectiveness of Interventions to Delay Public Pension Claiming {#30938}

【**Author**】: Franca Glenzer, Pierre-Carl Michaud, Stefan Staubli
...
【**摘要**】：在许多退休收入体系中，人们因提前申领而放弃了更高额的公共养老金收入。我们提供了调查实验和准实验证据，表明公共养老金申领时间对财务激励变化的弹性相对较小。通过调查实验，我们评估了两种不同的教育干预措施以及不同的决策框架方式对参与者预期养老金支付现值的影响。虽然所有三种类型的干预措施都导致了延迟，但这些干预措施产生了不同的财务后果。教育参与者导致了具有更高养老金财富的申领年龄。相比之下，框架和财务激励并未改善，甚至恶化了财务结果。理解各种政策工具对预期养老金财富的影响，对于设计延迟申领的政策至关重要。

【**NBER**】: NBER Working Paper No. 30938，https://www.nber.org/papers/w30938

#### 56. The Cyclicality of Births and Babies’ Health, Revisited: Evidence from Unemployment Insurance {#30937}

【**Author**】: Lisa J. Dettling, Melissa Schettini Kearney
...
【**摘要**】：我们重新审视了出生率和婴儿健康的周期性特征，并研究了失业保险提供的收入平滑援助在多大程度上缓解了总体劳动力市场状况与生育结果之间的关系。我们引入了一种新颖的实证检验方法，用于检验标准新古典主义生育模型，该方法通过考察总体失业率与失业保险潜在收入替代率衡量指标之间的交互作用，直接检验了商业周期中收入效应和跨期替代效应符号相反的预测。我们的结果表明，当失业保险福利慷慨程度达到100%的收入替代率时，失业率对生育率没有影响。这意味着，有充分证据表明的生育率周期性特征与流动性获取有关。我们还提供了新的证据，表明基于受孕时间，婴儿健康是逆周期的，但基于子宫内时间，则是顺周期的。当潜在的失业保险替代率达到100%时，子宫内总体失业率与婴儿健康之间的负相关关系也消失了。我们的结果表明，失业保险提供的社会保险具有促进生育的效果，并改善了婴儿的健康状况。

【**NBER**】: NBER Working Paper No. 30937，https://www.nber.org/papers/w30937

#### 57. Does School Choice Increase Crime? {#30936}

【**Author**】: Andrew Bibler, Stephen B. Billings, Stephen Ross
...
【**摘要**】：尽管先前的证据表明，通过择校抽签获得入学资格的学生成年后犯罪率较低，但关于择校抽签如何影响非申请者的证据却很少。我们利用实际抽签中签者的变化（在控制预期中签者的条件下），将初中同学的流失与成年后的犯罪结果联系起来。研究发现，当来自同一社区的中签者未就读其被分配的初中时，那些非申请者中风险较低的男孩在成年后更有可能被捕。我们估计，中签者离开对留守学生的影响程度，与中签者自身获得的积极效应在量级上相似。

【**NBER**】: NBER Working Paper No. 30936，https://www.nber.org/papers/w30936

#### 58. On the Effectiveness of Foreign Exchange Reserves During the 2021-22 U.S. Monetary Tightening Cycle {#30935}

【**Author**】: Rashad Ahmed, Joshua Aizenman, Jamel Saadaoui, Gazi Salah Uddin

【**Abstract**】: This paper examines whether the size of foreign exchange (FX) reserves can explain cross-country differences in foreign currency depreciation observed over the 2021-22 Federal Reserve monetary policy tightening that led to a sharp appreciation of the US dollar. Across a broad sample of countries, we document that an additional 10 percentage points of FX reserves/GDP held ex-ante were associated with 1.5 to 2 percent less exchange rate depreciation and this buffer effect was larger among less financially developed economies. Effects were more pronounced for large-reserve countries that sold reserves to intervene than for large-reserve countries that did not intervene, lending support to the presence of both balance sheet and intervention channels. Higher ex-ante policy rates were also associated with less depreciation especially among financially open economies. An analysis of daily currency movements following the June 2021 FOMC meeting corroborates these results. These findings suggest that FX reserves may promote monetary policy independence in the presence of global spillovers.

【**摘要**】：本文考察了在2021-2022年美联储货币政策紧缩（导致美元大幅升值）期间，外汇储备规模能否解释各国本币贬值幅度的差异。在涵盖广泛国家的样本中，我们发现，事前持有的外汇储备占GDP比重每增加10个百分点，与汇率贬值幅度减少1.5%至2%相关，且这一缓冲效应在金融欠发达经济体中更为显著。对于拥有大量储备并出售储备进行干预的国家，其效应比拥有大量储备但未干预的国家更为明显，这支持了资产负债表渠道和干预渠道同时存在的观点。事前较高的政策利率也与较小的贬值幅度相关，尤其是在金融开放的经济体中。对2021年6月联邦公开市场委员会会议后每日汇率变动的分析进一步证实了这些结果。这些发现表明，在全球溢出效应存在的情况下，外汇储备可能有助于促进货币政策独立性。

【**NBER**】: NBER Working Paper No. 30935，https://www.nber.org/papers/w30935

#### 59. Preferences for Firearms and Their Implications for Regulation {#30934}

【**Author**】: Sarah Moshary, Bradley Shapiro, Sara Drango
...
【**摘要**】：本文估计了消费者对枪支的需求，旨在预测枪支法规对流通中枪支数量和类型的可能影响。我们首先进行了一项基于陈述选择的联合分析，并估计了个人层面的枪支需求模型。我们利用观测数据中的总体矩对估计结果进行了验证。接着，我们利用估计结果模拟了在不同法规下流通中枪支数量和类型的变化。重要的是，我们发现，专门针对“攻击性武器”的禁令或限制会增加对手枪的需求，而手枪与绝大多数枪支相关暴力事件有关。我们提供了反事实情境下消费者剩余的分布，并讨论了这些分布如何有助于政策制定。

【**NBER**】: NBER Working Paper No. 30934，https://www.nber.org/papers/w30934

#### 60. Life After Death: A Field Experiment with Small Businesses on Information Frictions, Stigma, and Bankruptcy {#30933}

【**Author**】: Shai Bernstein, Emanuele Colonnelli, Mitchell Hoffman, Benjamin Iverson
...
【**摘要**】：在一项针对美国小企业的随机对照试验中，我们发现很大一部分企业对破产了解不足。许多人认为破产必然意味着企业死亡，并且不了解第11章破产（即通过债务重组使企业得以继续运营）。企业还表现出与破产相关的污名化，认为破产令人尴尬、是失败的标志，并向员工和客户传递负面信号。针对信息或污名化的简短教育视频能够立即且持久地（超过4个月）提高知识水平并减少污名化。这些视频增加了受访者对使用第11章破产的兴趣，并提高了预期的债务和投资水平。然而，我们并未观察到长期的实质性影响。对破产律师和法官的调查表明，企业家的过度自信，以及在较小程度上过高的法律费用感知，是解释仅针对信息和污名化的处理措施产生有限实际影响的首要摩擦因素。

【**NBER**】: NBER Working Paper No. 30933，https://www.nber.org/papers/w30933

#### 61. The Benefits of Revealing Race: Evidence from Minority-owned Local Businesses {#30932}

【**Author**】: Abhay Aneja, Michael Luca, Oren Reshef
...
【**摘要**】：是否存在支持黑人拥有的企业的潜在需求？为了探究这一点，我们分析了一个大型在线平台上的新功能，该功能使得识别黑人拥有的餐厅变得更加容易。我们发现，将餐厅标记为“黑人拥有”增加了客户参与度和企业绩效，具体表现为在线流量、电话、订单和到店访问量的增加。这些效应在左倾地区最为显著，这些地区的特点是（根据投票模式和内隐联想测验分数的地区差异衡量）对少数族裔的偏见较低。获得该标签的餐厅还发现，白人顾客留下的评论比例有所增加。

【**NBER**】: NBER Working Paper No. 30932，https://www.nber.org/papers/w30932

#### 62. Paying Moms to Stay Home: Short and Long Run Effects on Parents and Children {#30931}

【**Author**】: Jonathan Gruber, Tuomas Kosonen, Kristiina Huttunen
...
【**摘要**】：我们研究了一项旨在奖励在孩子三岁以下时待在家里而非加入劳动力市场的母亲的政策的影响。我们利用地区和时间上的差异表明，芬兰的家庭护理津贴在短期和长期内都降低了母亲的就业率。其影响足够大，以至于家庭护理福利制度的存在可以解释芬兰比同类国家更高的短期育儿惩罚。家庭护理福利还对儿童的早期认知测试结果产生负面影响，降低了选择学术型高中的可能性，并增加了青少年犯罪。通过研究一项日托费用改革（该改革产生了提高工作激励的相反效果，并对母亲和孩子产生了与家庭护理津贴相反的效应），我们确认了其作用机制是改变工作/家庭护理安排。我们的研究结果表明，将儿童保育从家庭转移到市场可以提高劳动力参与率并改善儿童发展结果。

【**NBER**】: NBER Working Paper No. 30931，https://www.nber.org/papers/w30931

#### 63. Structuring Cash Transfers: Cash Flow Preferences, Seasonality, and Financial Decisions in Rural Kenya {#30930}

【**Author**】: Carolina Kansikas, Anandi Mani, Paul Niehaus
...
【**摘要**】：我们考察了肯尼亚低收入家庭对无条件现金转移支付结构形式的偏好。大多数人偏好一次性大额转移，有些人偏好延迟领取——这与安全网项目的典型结构形成对比，但与关于贫困财务挑战的证据一致。转向后果方面，在一年中较晚时间收到转移支付，使一年半后的收入有所增加——但延迟领取的意愿对决策时点附近现金流的微小变化很敏感。综合来看，这些结果说明了如何根据贫困人口的决策环境调整现金转移支付设计，以改善财务选择和结果。

【**NBER**】: NBER Working Paper No. 30930，https://www.nber.org/papers/w30930

#### 64. Crowding in Private Quality: The Equilibrium Effects of Public Spending in Education {#30929}

【**Author**】: Tahir Andrabi, Natalie Bau, Jishnu Das, Naureen Karachiwalla, Asim Ijaz Khwaja
...
【**摘要**】：我们估计了一项通过学校委员会在巴基斯坦村庄实施的公立学校补助金项目的均衡效应，这些村庄拥有多所公立和私立学校，并有明确的招生区域边界。该项目在村庄层面进行了随机化，使我们能够估计其对市场的因果影响。项目启动四年后，公立学校的考试成绩提高了0.2个标准差。我们发现了教育乘数的证据：在受处理的市场中，私立学校的考试成绩也提高了0.2个标准差。与标准的产品差异化模型一致，对于那些面临更大市场势力威胁的私立学校，教育乘数更大。考虑私营部门的反应，使该项目的成本效益提高了85%，并影响了政策制定者如何确定支出目标。鉴于拥有多所公立和私立学校的市场在中低收入国家已普遍存在，审慎的政策要求我们在设计和评估公共政策时，必须考虑私营部门的反应。

【**NBER**】: NBER Working Paper No. 30929，https://www.nber.org/papers/w30929

#### 65. The Impact of Vertical Integration on Physician Behavior and Healthcare Delivery: Evidence from Gastroenterology Practices {#30928}

【**Author**】: Soroush Saghafian, Lina D. Song, Joseph P. Newhouse, Mary Beth Landrum, John Hsu
...
【**摘要**】：美国医疗体系正经历重大变革，许多医院与医生诊所进行纵向整合。这种整合可能通过促进护理协调来提高质量，但也可能通过影响医疗服务提供而降低质量。关于医生如何因财务所有权变化及整合组织的激励结构而改变其行为的证据很少。我们研究了由胃肠病医生治疗的Medicare患者，该专科近期纵向整合有所增加。利用包含5488名医生、260万次患者就诊的全国性患者层面面板数据，并采用因果模型，我们考察了医疗服务提供各项指标的变化。我们发现，医生在纵向整合后显著改变了护理流程（例如，在深度镇静麻醉的使用上），且患者术后并发症显著增加。我们提供的证据表明，整合诊所的财务激励结构是医生行为变化的主要原因，因为它阻碍整合诊所将昂贵资源分配给相对不盈利的诊疗项目。尽管整合提高了以医生吞吐量衡量的运营效率，但它对质量和总体支出产生了负面影响。我们指出了一些潜在的政策杠杆，政策制定者可通过这些杠杆减轻纵向整合的负面后果。

【**NBER**】: NBER Working Paper No. 30928，https://www.nber.org/papers/w30928

#### 66. Do Conflict of Interests Disclosures Work? Evidence from Citations in Medical Journals {#30927}

【**Author**】: Christian Leuz, Anup Malani, Maximilian Muhn, Laszlo Jakab
...
【**摘要**】：制药公司与医学研究人员之间的财务关系被认为会偏倚医学期刊发表的研究。为使读者能够考虑这种偏倚，大多数医学期刊要求作者披露潜在的利益冲突。我们考察披露是否会减少文章引用，从而表明存在折扣。估计这一效应的挑战在于选择性问题，因为制药公司可能寻求更高质量的作者。我们的分析证实了这种正相关关系。纳入文章和作者质量的可观测控制变量会减弱但不会消除这种关系。我们进行了三项检验。首先，我们表明，对于更容易受偏倚影响的综述文章，这种正相关关系较弱。其次，我们在先验质量更同质的文章中，考察了向家庭医生推荐的文章。我们发现，披露与专家推荐之间存在显著的负相关关系，这与折扣效应一致。第三，我们在作者和文章内部进行分析，利用导致作者披露利益冲突的期刊政策变化。我们考察了这种披露对同一作者先前发表文章引用的影响。该分析揭示了负面的引用效应。总体而言，我们的证据与其他研究者对披露冲突的文章打折扣的观点一致。

【**NBER**】: NBER Working Paper No. 30927，https://www.nber.org/papers/w30927

#### 67. Harm Reduction: When Does It Improve Health, and When Does it Backfire? {#30926}

【**Author**】: John Cawley, Davide Dragone
...
【**摘要**】：一些减害策略鼓励个体从有害成瘾品转向危害较小的成瘾品；例如电子烟（可燃香烟的替代品）以及美沙酮和丁丙诺啡（阿片类药物的替代品）。这些策略已被证明存在争议。支持者认为，挣扎于成瘾问题的人可以转而使用危害较小的物质而受益，但反对者认为，这可能会鼓励原本不使用者开始使用减害方法，甚至最终使用原始成瘾品。本文基于成瘾理论，对减害方法的引入进行建模，并论证了每一方观点成立的条件。

【**NBER**】: NBER Working Paper No. 30926，https://www.nber.org/papers/w30926

#### 68. Which Firms Gain from Digital Advertising? Evidence from a Field Experiment {#30925}

【**Author**】: Weijia Dai, Hyunjin Kim, Michael Luca
...
【**摘要**】：衡量广告机会的回报对许多企业来说仍然是一个挑战。我们与Yelp合作，在餐饮行业的18294家企业中设计并开展了一项实地实验，以了解哪些类型的企业从数字广告中获益更多。我们随机分配7209家餐厅免费获得Yelp的标准广告套餐三个月。实验的规模为我们评估广告效果在不同企业属性间的异质性提供了独特机会。我们发现，在Yelp上投放广告的餐厅，在一系列购买意愿指标上平均增长了7-19%，同时客户评论数量增加了5%。我们发现，收益在企业间存在异质性，独立经营和评分较高的企业收益更大，评论数量较多以及实验前自然流量较高的企业也是如此。

【**NBER**】: NBER Working Paper No. 30925，https://www.nber.org/papers/w30925

#### 69. New Institutional Economics and Cliometrics {#30924}

【**Author**】: Eric C. Alston, Lee J. Alston, Bernardo Mueller
...
【**摘要**】：新制度经济学（NIE）的早期根源在于计量史学。计量史学最初侧重于运用新古典理论来提出和检验经济史中的假说。但若不考虑制度背景，对国内及跨国经济与政治发展的实证研究就会受到限制。应用于经济史的NIE首先关注交易成本和产权的作用。从这种微观制度视角出发，NIE将其关注点扩展到制度与规范对经济发展的作用，以及经济力量与政治制度差异如何共同影响国内及跨国结果。这涉及考虑阻碍和促进各国经济与政治趋同的力量，以及决定向全新经济或政治轨迹转型的力量。检验经济与政治发展的决定因素受到遗漏变量和内生性问题的困扰，这一限制近期促使学者们借鉴复杂性理论，以进一步补充NIE和计量史学。

【**NBER**】: NBER Working Paper No. 30924，https://www.nber.org/papers/w30924

#### 70. Bitcoin Mining Meets Wall Street: A Study of Publicly Traded Crypto Mining Companies {#30923}

【**Author**】: Hanna Halaburda, David Yermack
...
【**摘要**】：本文研究了13家在纳斯达克上市且设施位于北美的加密货币挖矿公司的运营和财务估值。我们发现，使用德克萨斯州风电的矿工比其他矿工离线时间更长，且模式更不稳定。然而，尽管活动水平相对较低，这些德克萨斯州的矿工比使用水电或太阳能等更稳定能源的矿工更盈利，这体现在显著更高的企业价值上。我们的模型表明，使用可持续能源的矿工可能比使用传统能源的矿工更盈利，尽管存在停机，因为他们受益于可持续能源（如强风）供应过剩时的极低价格。该模型还表明，当能源供应不足（如无风）时，电力公司向矿工提供补偿以削减其活动可能是有益的，我们在样本中也观察到了这一点。这种补偿进一步增加了矿工的利润。我们发现加密挖矿股票与电力公用事业指数之间存在显著负贝塔值，这表明持有加密挖矿公司的股份可能为电力行业提供有用的风险管理渠道。

【**NBER**】: NBER Working Paper No. 30923，https://www.nber.org/papers/w30923
...
【**摘要**】：在存在加价差异、外部性及其他社会考量的情况下，创新的均衡方向可能被系统性扭曲。本文构建了一个简单的内生技术模型，该模型概括了现有的比较静态结果，并刻画了创新方向上的潜在扭曲。我表明，多个不同领域的实证发现与该框架的预测一致，并利用多项研究的数据估计了其关键参数。将这些数字与差异外部性和加价的粗略估计相结合，我提供了提示性证据，表明在工业自动化、医疗保健和能源领域，技术方向的均衡扭曲可能相当严重，而纠正这些扭曲可能带来可观的福利收益。

【**NBER**】: NBER Working Paper No. 30922，https://www.nber.org/papers/w30922
...
【**摘要**】：我使用名义和真实债券风险作为新的矩条件来约束一个新凯恩斯主义资产定价模型，其中供给冲击、需求冲击和货币政策是通胀的基本驱动因素。内生时变的风险溢价意味着名义债券风险——以其股票市场贝塔值衡量——是滞胀风险的前瞻性指标。分别针对1980年代和2000年代校准模型后，我表明，1980年代的正名义债券贝塔值是由供给冲击和反应性货币政策规则的“完美风暴”共同导致的，而非供给冲击或货币政策单独作用的结果。

【**NBER**】: NBER Working Paper No. 30921，https://www.nber.org/papers/w30921

#### 73. Digital Hermits {#30920}

【**Author**】: Jeanine Miklós-Thal, Avi Goldfarb, Avery M. Haviv, Catherine Tucker
...
【**摘要**】：当用户向企业分享关于自身的多维数据时，企业会学习用户数据不同维度之间的相关性。我们将这种学习行为纳入一个数据市场模型，在该模型中，企业从有隐私担忧的用户那里获取数据。用户数据是多维的，每个用户可以选择不分享任何数据、仅分享非敏感数据或分享全部数据给企业。随着企业收集更多数据并更擅长从用户的非敏感数据推断其隐私敏感数据，不分享任何数据的新用户（“数字隐士”）比例会增长。同时，分享全部数据的新用户比例也会增长。因此，该模型预测用户的数据分享选择会出现两极分化，从分享非敏感数据转向不分享和分享全部数据。

【**NBER**】: NBER Working Paper No. 30920，https://www.nber.org/papers/w30920

#### 74. Task Mismatch and Salary Penalties: Evidence from the Biomedical PhD Labor Market {#30919}

【**Author**】: Holden A. Diethorn, Gerald R. Marschke
...
【**摘要**】：我们以生物医学科学博士的劳动力市场（其中职业错位很常见）作为技能-任务错配及其后果的案例研究。利用生物医学博士的纵向个体层面数据，我们研究错配作为博士后培训负货币回报的解释。我们的数据包含独特的个体层面工作任务信息，使我们能够比较毕业几年后获得的技能与后续就业中所需的任务。我们的发现揭示了当任务错配程度高时（这种情况很常见）存在博士后薪资惩罚，而当技能与任务匹配时则存在薪资溢价。累积的任务特定人力资本差异解释了博士后培训回报的部门间异质性，包括产业界博士后培训带来的巨大且持久的薪资惩罚以及总体上的惩罚。任务错配作为追求科学及其他需要大量前期投资于任务特定人力资本的冒险职业的成本，在实证劳动文献中很少受到关注。

【**NBER**】: NBER Working Paper No. 30919，https://www.nber.org/papers/w30919
...
【**摘要**】：关于金融危机政治和社会影响的研究主要集中于自由市场经济，这阻碍了我们对其他背景下其影响的理解。我们利用一场袭击以色列基布兹的金融危机事件，研究其在社会主义背景下的影响。与资本主义经济中的发现相反，这场危机导致对自由化劳动力市场的支持增加，并减少了对左翼政党的支持。这些影响在长期内持续存在，尤其是在年轻人中。危机还降低了对领导层的信任，但在签署债务清偿协议以缓解危机严重性后不久，信任得以恢复。我们的发现表明，经济冲击在自由市场和社会主义体系中可能产生不同影响，在两种情况下都会导致个体质疑他们当前的体系。

【**NBER**】: NBER Working Paper No. 30918，https://www.nber.org/papers/w30918

#### 76. Reversals and the Returns to Liquidity Provision {#30917}

【**Author**】: Wei Dai, Mamdouh Medhat, Robert Novy-Marx, Savina Rizova
...
【**摘要**】：本文通过国际贸易的视角研究各国风险创新与增长的跨国模式。我们使用一个简单的理论框架，描述企业在不同金融发展水平下进行风险质量升级的行为，从而得出两个预测。首先，一个国家质量增长的平均率与相应的质量增长横截面方差呈正相关。其次，质量变化的均值和方差都与该国的金融发展水平呈正相关。然后，我们利用美国分产品（HS10）双边出口数据检验这两个假设。数据中的模式与理论一致。质量增长的均值和方差彼此强烈正相关。金融深度更大的国家在产品质量增长方面系统性地表现出更高的均值和更高的方差。我们的发现表明，在发展路径上，产品质量改进存在均值-方差权衡。金融深度的增加并不意味着产品空间变化波动性的降低。

【**NBER**】: NBER Working Paper No. 30915，https://www.nber.org/papers/w30915
...
【**摘要**】：基于区块链的智能合约有可能通过去中心化执行和降低交易成本来取代某些传统合约。然而，可扩展性是阻碍其更广泛应用和采纳的关键瓶颈，常常导致网络集中或排他。为了避免偏离该技术的原始承诺，企业积极探索用于扩展的“二层”方法。我们提供了一些关于二层扩展方案经济影响的初步证据，该方案将信息聚合从链上转移到链下的点对点网络。一个平行系统实验允许清晰的识别，因为我们同时观察了处理系统和对照系统中的同一单位。我们发现，这种扩展方案将运营成本降低了76%，并且重要的是，它导致了去中心化，表现为更低的市场集中度和更高的参与度，这反过来又提高了数据准确性。这些发现提供了关于区块链和智能合约技术如何朝着实现去中心化和可扩展信任演进的初步证据。

【**NBER**】: NBER Working Paper No. 30912，https://www.nber.org/papers/w30912

#### 82. The Internet, Search Frictions and Aggregate Unemployment {#30911}

【**Author**】: Manudeep Bhuller, Domenico Ferraro, Andreas R. Kostøl, Trond C. Vigtel
...
【**摘要**】：互联网如何影响了搜索和招聘，以及对总体失业有何影响？由于互联网使用中的选择性问题以及难以衡量劳动力市场双方的搜索活动，对这些问题的实证研究一直很困难。本文通过将挪威高速互联网可用性的看似外生变化与关于招聘企业、求职者和职位空缺的大规模调查和行政数据相结合，克服了这些挑战。我们的实证分析表明，互联网扩张导致更多企业进行在线招聘，并使职位空缺持续时间缩短了9%，招聘失败尝试减少了13%。虽然扩张使失业者的工作找到率提高了2.4%，起薪提高了6%，但我们没有发现证据表明员工的工作转换或工资增长发生了变化。为了解释这些发现，我们开发并校准了一个具有内生工作创造和破坏的均衡搜索模型，在该模型中，工人决定在在职和离职状态下投入多少搜索努力。通过校准模型的视角，我们发现更好的搜索技术是我们准实验证据背后的主要驱动力。我们的计算表明，由于宽带互联网的扩张，稳态失业率下降了多达14%。

【**NBER**】: NBER Working Paper No. 30911，https://www.nber.org/papers/w30911

#### 83. Dynamic Inconsistency in Risky Choice: Evidence from the Lab and Field {#30910}

【**Author**】: Rawley Z. Heimer, Zwetelina Iliewa, Alex Imas, Martin Weber
...
【**摘要**】：我们记录了一种稳健的风险选择动态不一致性。利用一个独特的经纪数据集和一系列实验，我们比较了人们最初的风险承担计划与其后续决策。在不同情境下，人们将风险承担作为“损失退出”策略的一部分——计划在盈利后继续承担风险，在亏损后停止。实际行为偏离了初始策略，表现为过早了结盈利并追逐亏损。当被提供承诺执行初始策略时，更多人接受风险。我们的结果有助于调和关于静态与动态情境下风险承担看似矛盾的发现。我们探讨了对理论和福利的启示。

【**NBER**】: NBER Working Paper No. 30910，https://www.nber.org/papers/w30910

#### 84. Societal Disruptions And Child Mental Health: Evidence From ADHD Diagnosis During The COVID-19 Pandemic {#30909}

【**Author**】: Seth M. Freedman, Kelli R. Marquardt, Dario Salcedo, Kosali I. Simon, Coady Wing
...
【**摘要**】：我们研究了COVID-19大流行的社会动荡如何影响一种普遍的儿童心理健康状况——注意力缺陷多动障碍（ADHD）的诊断。利用全国性的私人健康保险索赔数据和一个州的综合电子健康记录，我们将暴露于大流行期间的儿童与大流行前同龄儿童进行比较。我们发现，截至2021年2月，大流行使全国范围内男孩的新ADHD诊断减少了8.6%，女孩减少了11.0%。我们进一步表明，2020年秋季更高水平的线下教学减弱了女孩诊断下降的趋势，但对男孩没有调节作用。

【**NBER**】: NBER Working Paper No. 30909，https://www.nber.org/papers/w30909

#### 85. Child Labor Standards in Regional Trade Agreements: Theory and Evidence {#30908}

【**Author**】: Ryan M. Abman, Clark C. Lundberg, John McLaren, Michele Ruta
...
【**摘要**】：我们研究了区域贸易协定（RTA）中的童工标准对一系列童工市场结果的影响，包括就业、教育和家庭不平等。我们构建了一个对国际贸易开放的经济体中童工的简约一般均衡模型，并考虑了有和没有童工禁令的RTA的影响。我们利用协调的调查微观数据，在包含101个发展中国家的广泛国际面板数据中，实证研究了这些贸易协定条款的影响。通过使用准实验方法获得看似因果的估计，我们发现没有童工禁令的RTA导致儿童就业减少和入学率增加，特别是对于14-17岁的较大儿童。RTA中的童工禁令反而增加了14-17岁儿童的就业，并降低了年幼和较大儿童的入学率。这些效应似乎通过增加儿童收入来降低家庭间收入不平等。我们的发现与我们的模型以及关于童工禁令文献的理论预测一致。

【**NBER**】: NBER Working Paper No. 30908，https://www.nber.org/papers/w30908

#### 86. Bank Funding Risk, Reference Rates, and Credit Supply {#30907}

【**Author**】: Harry R. Cooperman, Darrell Duffie, Stephan Luck, Zachry Z. Wang, Yilin Yang
...
【**摘要**】：企业信贷额度在融资市场压力更大时被更多地提取。这种协方差提高了银行的预期融资成本。我们表明，信贷供给因相关的银行股东债务积压成本而受到抑制。直到2022年，通过将额度支付的利息与信用敏感型参考利率（如LIBOR）挂钩，这种影响得以减轻。我们表明，向无风险参考利率的过渡可能会加剧这种摩擦。如果预期提取的资金会存放在同一家银行（这在COVID-19衰退期间一些最大的银行中发生过），那么对信贷供给的不利影响将被抵消。

【**NBER**】: NBER Working Paper No. 30907，https://www.nber.org/papers/w30907

#### 87. Ride-Sharing Markets Re-Equilibrate {#30883}

【**Author**】: Jonathan V. Hall, John J. Horton, Daniel T. Knoepfle
...
【**摘要**】：在优步（Uber）引发的价格上涨之后，司机每趟行程赚得更多，并且最初每小时工作收入也更高。司机开始工作更长时间。然而，工作时间的增加——加上更高价格导致的需求减少——产生了业务窃取效应，司机用于运送乘客的工作时间比例下降。这种市场调整使小时收入率在大约两个月内回落到价格上涨前的水平。乘客通过更短的等待时间部分补偿了更高的价格，但在我们数据覆盖的时期内，价格上涨可能降低了乘客福利。

【**NBER**】: NBER Working Paper No. 30883，https://www.nber.org/papers/w30883
