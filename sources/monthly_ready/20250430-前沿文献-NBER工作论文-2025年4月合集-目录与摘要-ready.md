# 【前沿文献】NBER工作论文 2025年4月合集 目录与摘要

> 2025 年 4 月 NBER 更新 91 篇工作论文，其中与中国研究相关的有 5 篇（4、10、20、33、90）。
> 其中，中国相关研究包括：#33725（第 4 篇，国家与市场：中国的基础设施投资）；#33718（第 10 篇，驾驭周期：中国的增长目标与宏观经济管理）；#33708（第 20 篇，律师的法律经济学：来自中国司法系统旋转门的证据）；#33695（第 33 篇，一般均衡中的配额）；#33636（第 90 篇，碳抵消市场中的企业选择与增长：来自清洁发展机制的证据）。

## 一、目录速览

1. **Field Choice, Skill Specificity, and Labor Market Disruptions {#33728}**  
   专业选择、技能专用性与劳动力市场冲击  
   <font color=grey>Valerie Smeets, Lin Tian, Sharon Traiberman</font>

2. **Regulating Out-of-Network Hospital Payments: Disagreement Payoffs, Negotiated Prices, and Access {#33727}**  
   监管网络外医院支付：分歧收益、谈判价格与可及性  
   <font color=grey>Elena Prager, Nicholas Tilipman</font>

3. **The Macroeconomics of Tariff Shocks {#33726}**  
   关税冲击的宏观经济学  
   <font color=grey>Adrien Auclert, Matthew Rognlie, Ludwig Straub</font>

4. **State versus Market: China's Infrastructure Investment {#33725}**  
   国家与市场：中国的基础设施投资  
   <font color=grey>Shuoge Qian, Hong Ru, Wei Xiong</font>

5. **An Anatomy of U.S. Establishments' Trade Linkages in Global Value Chains {#33724}**  
   美国企业在全球价值链中贸易关联的剖析  
   <font color=grey>Aaron B. Flaaen, Fariha Kamal, Eunhee Lee, Kei-Mu Yi</font>

6. **The Global Effects of Carbon Border Adjustment Mechanisms {#33723}**  
   碳边境调节机制的全球效应  
   <font color=grey>Kimberly A. Clausing, Jonathan M. Colmer, Allan Hsiao, Catherine Wolfram</font>

7. **Screening Through Soft Spending Limits: Evidence from the Medicare Therapy Cap {#33722}**  
   通过软性支出上限进行筛选：来自医疗保险治疗费用上限的证据  
   <font color=grey>Ashvin Gandhi, Maggie Shi</font>

8. **Local Energy Access and Industry Specialization: Evidence from World War II Emergency Pipelines {#33721}**  
   本地能源获取与产业专业化：来自二战应急管道的证据  
   <font color=grey>Jacob Greenspon, Gordon H. Hanson</font>

9. **Protection for Whom? The Political Economy of Protective Labor Laws for Women {#33720}**  
   为谁保护？女性劳动保护法的政治经济学  
   <font color=grey>Matthias Doepke, Hanno Foerster, Anne Hannusch, Michèle Tertilt</font>

10. **Taming Cycles: China’s Growth Targets and Macroeconomic Management {#33718}**  
   驾驭周期：中国的增长目标与宏观经济管理  
   <font color=grey>Jeffery (Jinfan) Chang, Yuheng Wang, Wei Xiong</font>

11. **Opioids and Post-COVID Labor-Force Participation {#33717}**  
   阿片类药物与疫情后劳动力参与率  
   <font color=grey>Francesco Chiocchio, Jeremy Greenwood, Nezih Guner, Karen Kopecky</font>

12. **Using Multiple Outcomes to Adjust Standard Errors for Spatial Correlation {#33716}**  
   利用多个结果变量调整空间相关性的标准误  
   <font color=grey>Stefano DellaVigna, Guido Imbens, Woojin Kim, David M. Ritzwoller</font>

13. **Optimal Second-best Menu Design: Evidence from Residential Electricity Plans {#33715}**  
   最优次优菜单设计：来自居民用电计划的证据  
   <font color=grey>Maria Garcia-Osipenko, Nicolai V. Kuminoff, Spencer Perry, Nicholas Vreugdenhil</font>

14. **The Global Macro Database: A New International Macroeconomic Dataset {#33714}**  
   全球宏观数据库：一个新的国际宏观经济数据集  
   <font color=grey>Karsten Müller, Chenzi Xu, Mohamed Lehbib, Ziliang Chen</font>

15. **The Rise of Absorptive Research in Corporate America: 1945-1980 {#33713}**  
   美国企业吸收性研究的兴起：1945-1980  
   <font color=grey>Ashish Arora, Sharon Belenzon, Jungkyu Suh, Hansen Zhang</font>

16. **The Political Economy of Firm Networks: CEO Ideology and Global Trade {#33712}**  
   企业网络的政治经济学：CEO意识形态与全球贸易  
   <font color=grey>Elisabeth Kempf, Mancy Luo, Margarita Tsoutsoura</font>

17. **A Theory of Supply Function Choice and Aggregate Supply {#33711}**  
   供给函数选择与总供给理论  
   <font color=grey>Joel P. Flynn, Georgios Nikolakoudis, Karthik Sastry</font>

18. **The Invention of Corporate Governance {#33710}**  
   公司治理的发明  
   <font color=grey>Yueran Ma, Andrei Shleifer</font>

19. **How Tariffs Affect Trade Deficits {#33709}**  
   关税如何影响贸易逆差  
   <font color=grey>Arnaud Costinot, Iván Werning</font>

20. **The Law and Economics of Lawyers: Evidence from the Revolving Door in China’s Judicial System {#33708}**  
   律师的法律经济学：来自中国司法系统旋转门的证据  
   <font color=grey>John Zhuang Liu, Wenwei Peng, Shaoda Wang, Daniel Xu</font>

21. **Firm Presence, Pollution, and Agglomeration: Evidence from a Randomized Environmental Place-Based Policy {#33707}**  
   企业存在、污染与集聚：来自一项随机环境地点导向政策的证据  
   <font color=grey>Michael Gechter, Namrata Kala</font>

22. **Reducing Nutritional Disparities Through Targeted Pricing: Evidence from a Large Restaurant Chain {#33706}**  
   通过定向定价减少营养差异：来自大型连锁餐厅的证据  
   <font color=grey>Weijia (Daisy) Dai, Ginger Zhe Jin, Ben Zou</font>

23. **Did War Mobilization Cause Aggregate and Regional Growth? {#33705}**  
   战争动员是否导致了总量与区域增长？  
   <font color=grey>Taylor Jaworski, Dongkyu Yang</font>

24. **Option Value Neglect: Evidence from Centralized College Admission {#33704}**  
   期权价值忽视：来自集中式大学录取的证据  
   <font color=grey>Ao Wang, Shaoda Wang, Xiaoyang Ye</font>

25. **From Distraction to Dedication: Commitment and Incentives Against Phone Use in the Classroom {#33703}**  
   从分心到专注：针对课堂手机使用的承诺与激励措施  
   <font color=grey>Billur Aksoy, Lester R. Lusher, Scott E. Carrell</font>

26. **Long-Run Effects of Trade Wars {#33702}**  
   贸易战的长期影响  
   <font color=grey>David Baqaee, Hannes Malmberg</font>

27. **Skewed Fluctuations and Propagation Through Production Networks {#33701}**  
   偏态波动与通过生产网络的传导  
   <font color=grey>Sai Krishna Kamepalli, Serena Ng, Francisco Ruge-Murcia</font>

28. **Ethnographic Records, Folklore, and AI {#33700}**  
   民族志记录、民间传说与人工智能  
   <font color=grey>Stelios Michalopoulos</font>

29. **Health Impacts of Federal Pandemic Aid to State and Local Governments {#33699}**  
   联邦疫情援助对州和地方政府健康的影响  
   <font color=grey>Jeffrey Clemens, Anwita Mahajan</font>

30. **Fiscal Policy as a Stabilization Tool. The Case for Quasi-Automatic Stabilizers, With an Application to the VAT {#33698}**  
   作为稳定工具的财政政策。准自动稳定器的案例，及其在增值税上的应用  
   <font color=grey>Olivier J. Blanchard</font>

31. **The Effect of Deactivating Facebook and Instagram on Users’ Emotional State {#33697}**  
   停用Facebook和Instagram对用户情绪状态的影响  
   <font color=grey>Hunt Allcott, Matthew Gentzkow, Benjamin Wittenbrink, Juan Carlos Cisneros, Adriana Crespo-Tenorio, Drew Dimmery, Deen Freelon, Sandra González-Bailón, Andrew M. Guess, Young Mie Kim, David Lazer, Neil Malhotra, Devra Moehler, Sameer Nair-Desai, Brendan Nyhan, Jennifer Pan, Jaime Settle, Emily Thorson, Rebekah Tromble, Carlos Velasco Rivera, Arjun Wilkins, Magdalena Wojcieszak, Annie Franco, Chad Kiewiet de Jonge, Winter Mason, Natalie Jomini Stroud, Joshua A. Tucker</font>

32. **The Political Power of Firms {#33696}**  
   企业的政治权力  
   <font color=grey>Matilde Bombardini, Francesco Trebbi</font>

33. **Quotas in General Equilibrium {#33695}**  
   一般均衡中的配额  
   <font color=grey>David Baqaee, Kunal Sangani</font>

34. **Housing Supply and Housing Affordability {#33694}**  
   住房供给与住房可负担性  
   <font color=grey>Nathaniel Baum-Snow, Gilles Duranton</font>

35. **Performance Capital Flows in DC Pensions {#33693}**  
   固定缴款养老金中的业绩资本流动  
   <font color=grey>Bryan Gutierrez Cortez, Victoria Ivashina, Juliana Salomao</font>

36. **Does Homeownership Matter? The Long-Term Consequences of Losing a House during the Great Recession {#33692}**  
   住房所有权重要吗？大衰退期间失去房屋的长期后果  
   <font color=grey>Heidi Artigue, Patrick Bayer, Fernando V. Ferreira, Stephen Ross</font>

37. **Public Finance Implications of Economic Inequality {#33691}**  
   经济不平等的公共财政含义  
   <font color=grey>Alan J. Auerbach</font>

38. **The Long Road to Equality: Racial Capital and Generational Convergence {#33690}**  
   通往平等的漫漫长路：种族资本与代际趋同  
   <font color=grey>Patrick Bayer, Kerwin Kofi Charles, JoonYup Park</font>

39. **The Long-Run Impacts of Mentoring Underrepresented Minority Groups in Economics {#33689}**  
   指导经济学中代表性不足少数群体的长期影响  
   <font color=grey>Francisca M. Antman, Sheng Qu, Trevon D. Logan, Bruce A. Weinberg</font>

40. **Interventionist Preferences and the Welfare State: The Case of In-Kind Aid {#33688}**  
   干预主义偏好与福利国家：以实物援助为例  
   <font color=grey>Sandro Ambuehl, B. Douglas Bernheim, Tony Q. Fan, Zachary Freitas-Groff</font>

41. **Labor Market Polarization and Inequality: A Roy Model Perspective {#33687}**  
   劳动力市场极化与不平等：一个罗伊模型视角  
   <font color=grey>Andrés Erosa, Luisa Fuster, Gueorgui Kambourov, Richard Rogerson</font>

42. **Global Networks, Monetary Policy and Trade {#33686}**  
   全球网络、货币政策与贸易  
   <font color=grey>Ṣebnem Kalemli-Özcan, Can Soylu, Muhammed A. Yildirim</font>

43. **Taxes and Private Firms’ Capital Structure Choices {#33685}**  
   税收与私营企业的资本结构选择  
   <font color=grey>Mara Faccio, Jin Xu</font>

44. **Partisan Trust in the Federal Reserve {#33684}**  
   对美联储的党派信任  
   <font color=grey>Carola Binder, Cody Couture, Abhiprerna Smit</font>

45. **Educational Ambition, Marital Sorting, and Inequality {#33683}**  
   教育抱负、婚姻匹配与不平等  
   <font color=grey>Frederik Almar, Benjamin Friedrich, Ana Reynoso, Bastian Schulz, Rune M. Vejlin</font>

46. **If You Had One Shot: Scale and Herding in Innovation Experiments {#33682}**  
   如果你只有一次机会：创新实验中的规模与从众行为  
   <font color=grey>Ashish Arora, Sharique Hasan, William D. Miles</font>

47. **Putting Economics Back Into Geoeconomics {#33681}**  
   将经济学重新注入地缘经济学  
   <font color=grey>Christopher Clayton, Matteo Maggiori, Jesse Schreger</font>

48. **Anticipated Discrimination and Major Choice {#33680}**  
   预期歧视与专业选择  
   <font color=grey>Louis-Pierre Lepage, Xiaomeng Li, Basit Zafar</font>

49. **Do Time-Constraints Matter? How, Why, and For Whom? {#33679}**  
   时间限制重要吗？如何、为何以及对谁重要？  
   <font color=grey>Kala Krishna, Pelin Akyol, Esma Ozer</font>

50. **Measuring Income and Income Inequality {#33678}**  
   衡量收入与收入不平等  
   <font color=grey>Conor J. Clarke, Wojciech Kopczuk</font>

51. **Talk Therapy and Human Capital in Adolescence: Evidence from Nepal {#33677}**  
   谈话疗法与青少年时期的人力资本：来自尼泊尔的证据  
   <font color=grey>Eric V. Edmonds, Priya Mukherjee, Nikhilesh Prakash, Nishith Prakash, Shwetlena Sabarwal</font>

52. **The Economics of Encouragement: Can A Simple Email Shape Major Choice? {#33676}**  
   鼓励的经济学：一封简单的电子邮件能改变专业选择吗？  
   <font color=grey>Olivia Edwards, Jonathan Meer</font>

53. **Growing Awareness: Evaluating the Impact of Environmental Education on Attitudes, Knowledge, and Behavior {#33675}**  
   意识增长：评估环境教育对态度、知识和行为的影响  
   <font color=grey>Jennifer Alix-García, Christopher R. Knittel</font>

54. **The Risk Sensitivity of Global Liquidity Flows: Heterogeneity, Evolution and Drivers {#33674}**  
   全球流动性流动的风险敏感性：异质性、演变与驱动因素  
   <font color=grey>Stefan Avdjiev, Leonardo Gambacorta, Linda S. Goldberg, Stefano Schiaffi</font>

55. **Pension Reform and Labor Supply: Retention and Productivity under a Pension Cut {#33673}**  
   养老金改革与劳动力供给：养老金削减下的留任与生产率  
   <font color=grey>Andrew C. Johnston, Jonah E. Rockoff, James R. Harrington</font>

56. **Heterogeneous Beliefs, Asset Prices, and Business Cycles {#33672}**  
   异质性信念、资产价格与经济周期  
   <font color=grey>Saki Bigio, Dejanir Silva, Eduardo Zilberman</font>

57. **Paths to the Periphery {#33671}**  
   通往边缘之路  
   <font color=grey>James A. Robinson</font>

58. **Training within Firms {#33670}**  
   企业内部培训  
   <font color=grey>Brayan S. Diaz, Andrea Neyra Nazarrett, Julian Ramirez, Raffaella Sadun, Jorge A. Tamayo</font>

59. **How Good is AI at Twisting Arms? Experiments in Debt Collection {#33669}**  
   人工智能在说服他人方面有多擅长？债务催收实验  
   <font color=grey>James J. Choi, Dong Huang, Zhishu Yang, Qi Zhang</font>

60. **Scoring and Cartel Discipline in Procurement Auctions {#33668}**  
   采购拍卖中的评分与卡特尔纪律  
   <font color=grey>Juan M. Ortner, Sylvain Chassang, Kei Kawai, Jun Nakabayashi</font>

61. **The Political Consequences of Controversial Education Reform: Lessons from Wisconsin’s Act 10 {#33666}**  
   有争议的教育改革的政治后果：威斯康星州第10号法案的教训  
   <font color=grey>Barbara Biasi, Wayne Aaron Sandholtz</font>

62. **Substitution Bias and Fixed-Weight Price Indices in Time-Dependent Pricing Models {#33665}**  
   时间依赖定价模型中的替代偏差与固定权重价格指数  
   <font color=grey>Lawrence Christiano, Martin S. Eichenbaum, Benjamin K. Johannsen</font>

63. **Taxes on Lifetime Income: A Good Idea? {#33664}**  
   对终生收入征税：一个好主意？  
   <font color=grey>Dirk Krueger, Chunzan Wu</font>

64. **Forward Selection Fama-MacBeth Regression with Higher Order Asset-Pricing Factors {#33663}**  
   具有高阶资产定价因子的前向选择Fama-MacBeth回归  
   <font color=grey>Nicola Borri, Denis Chetverikov, Yukun Liu, Aleh Tsyvinski</font>

65. **Measuring Human Leadership Skills with AI Agents {#33662}**  
   用人工智能代理衡量人类领导技能  
   <font color=grey>Ben Weidmann, Yixian Xu, David J. Deming</font>

66. **Credit, Land Speculation, and Low-Interest-Rate Policy {#33661}**  
   信贷、土地投机与低利率政策  
   <font color=grey>Tomohiro Hirano, Joseph E. Stiglitz</font>

67. **Voluntary Report of Standardized Test Scores: An Experimental Study {#33660}**  
   标准化考试成绩的自愿报告：一项实验研究  
   <font color=grey>Marty Haoyuan Chen, Ginger Zhe Jin</font>

68. **The Effects of Eviction on Children {#33659}**  
   驱逐对儿童的影响  
   <font color=grey>Robert Collinson, Deniz Dutz, John Eric Humphries, Nicholas S. Mader, Daniel Tannenbaum, Winnie van Dijk</font>

69. **Information-Concealing Credit Architecture {#33658}**  
   隐藏信息的信贷架构  
   <font color=grey>Gary B. Gorton, Ye Li, Guillermo Ordoñez</font>

70. **Leaving Money on the Table {#33657}**  
   把钱留在桌上  
   <font color=grey>Mackenzie Alston, Tatyana Deryugina, Olga Shurchkov</font>

71. **Counting the Poor: The Liquidity-Adjusted Supplemental Expenditure Poverty Measure {#33656}**  
   贫困人口统计：流动性调整后的补充性支出贫困衡量指标  
   <font color=grey>Sung Ah Bahk, John Fitzgerald, Robert A. Moffitt</font>

72. **Asylum Seekers and the Rise in Homelessness {#33655}**  
   寻求庇护者与无家可归者人数的上升  
   <font color=grey>Bruce D. Meyer, Angela Wyse, Douglas Williams</font>

73. **Failures of Contingent Reasoning in Annuitization Decisions {#33654}**  
   年金化决策中的条件推理失败  
   <font color=grey>Erzo F.P. Luttmer, Priscila de Oliveira, Dmitry Taubinsky</font>

74. **Sorting to Expensive Cities {#33652}**  
   向昂贵城市的分选  
   <font color=grey>Cécile Gaubert, Frédéric Robert-Nicoud</font>

75. **Asset Embeddings {#33651}**  
   资产嵌入  
   <font color=grey>Xavier Gabaix, Ralph S. J. Koijen, Robert J. Richmond, Motohiro Yogo</font>

76. **AI as Strategist {#33650}**  
   作为战略家的人工智能  
   <font color=grey>Joshua S. Gans</font>

77. **The Memory Premium {#33649}**  
   记忆溢价  
   <font color=grey>Yuval Salant, Jorg L. Spenkuch, David Almog</font>

78. **Moral Hazard under Liquidity Constraints {#33648}**  
   流动性约束下的道德风险  
   <font color=grey>Keith Marzilli Ericson, Johannes G. Jaspersen, Justin R. Sydnor</font>

79. **Global Spillovers of Climate Policy Shocks {#33647}**  
   气候政策冲击的全球溢出效应  
   <font color=grey>Julian di Giovanni, Galina Hale, Neel Lahiri, Anirban Sanyal</font>

80. **Estimating the Footprint of Artisanal Mining in Africa {#33646}**  
   估算非洲手工采矿的足迹  
   <font color=grey>Darin Christensen, Tamma Carleton, Esther Rolf, Cullen Molitor, Shopnavo Biswas, Karena Yan, Graeme Blair</font>

81. **The Conflict-of-Interest Discount in the Marketplace of Ideas {#33645}**  
   思想市场中的利益冲突折扣  
   <font color=grey>John M. Barrios, Filippo Lancieri, Joshua Levy, Shashank Singh, Tommaso Valletti, Luigi Zingales</font>

82. **The Effects of Deleting Medical Debt from Consumer Credit Reports {#33644}**  
   从消费者信用报告中删除医疗债务的影响  
   <font color=grey>Victor Duarte, Julia Fonseca, Divij Kohli, Julian Reif</font>

83. **Non-Wage Amenities {#33643}**  
   非工资福利  
   <font color=grey>Alexandre Mas</font>

84. **Non-User Utility and Market Power: The Case of Smartphones {#33642}**  
   非用户效用与市场势力：以智能手机为例  
   <font color=grey>Leonardo Bursztyn, Rafael Jiménez-Durán, Aaron Leonard, Filip Milojević, Christopher Roth</font>

85. **The Cybernetic Teammate: A Field Experiment on Generative AI Reshaping Teamwork and Expertise {#33641}**  
   控制论队友：关于生成式人工智能重塑团队合作与专业知识的实地实验  
   <font color=grey>Fabrizio Dell'Acqua, Charles Ayoubi, Hila Lifshitz, Raffaella Sadun, Ethan Mollick, Lilach Mollick, Yi Han, Jeff Goldman, Hari Nair, Stewart Taub, Karim Lakhani</font>

86. **The Tokenomics of Staking {#33640}**  
   质押的代币经济学  
   <font color=grey>Lin William Cong, Zhiheng He, Ke Tang</font>

87. **Financial and Informational Integration Through Oracle Networks {#33639}**  
   通过预言机网络实现金融和信息整合  
   <font color=grey>Lin William Cong, Eswar S. Prasad, Daniel Rabetti</font>

88. **The Bullwhip: Time-to-Build and Sectoral Fluctuations {#33638}**  
   牛鞭效应：建设周期与行业波动  
   <font color=grey>Yan Leng, Ernest Liu, Yifei Ren, Aleh Tsyvinski</font>

89. **Interim Valuations, Predictability, and Outcomes in Private Equity {#33637}**  
   私募股权中的中期估值、可预测性与结果  
   <font color=grey>Ege Y. Ercan, Steven N. Kaplan, Ilya A. Strebulaev</font>

90. **Firm Selection and Growth in Carbon Offset Markets: Evidence from the Clean Development Mechanism {#33636}**  
   碳抵消市场中的企业选择与增长：来自清洁发展机制的证据  
   <font color=grey>Qiaoyi Chen, Nicholas Ryan, Daniel Xu</font>

91. **Instrumental Variables Methods Reveal Larger Effects of Menopausal Hormone Therapy in the Landmark Women’s Health Initiative Clinical Trial {#33635}**  
   工具变量方法揭示标志性妇女健康倡议临床试验中绝经期激素治疗的更大效应  
   <font color=grey>Joshua Angrist, Amanda E. Kowalski, Ljubica Ristovska, Marcia L. Stefanick</font>
...
【**Author**】: Valerie Smeets, Lin Tian, Sharon Traiberman
...
【**摘要**】：我们认为，大学生对所学专业的选择会显著影响经济体应对劳动力市场冲击的方式。为此，我们构建并估计了一个分析框架，该框架包含了具有前瞻性眼光的学生，他们在进入大学时选择专业，随后在毕业并进入劳动力市场后做出职业选择。不同的专业赋予劳动者不同的比较优势，以及不同的职业转换成本。通过模拟一场贸易战和人工智能的大规模应用，我们利用模型提出了三个观点。首先，相对于忽略新一届学生如何调整其专业选择的模型，我们的框架预测了更大的总体收入反应和更显著的收入分配差异。其次，提高专业选择灵活性的政策——例如放宽高需求专业的容量限制——会提高总产出。最后，这些政策通过为收入潜力较低的学生提供更多机会，也减轻了冲击对收入分配的不利影响。

【**NBER**】: NBER Working Paper No. 33728，https://www.nber.org/papers/w33728

#### 2. Regulating Out-of-Network Hospital Payments: Disagreement Payoffs, Negotiated Prices, and Access {#33727}

【**Author**】: Elena Prager, Nicholas Tilipman
...
【**摘要**】：近期的政策提案旨在监管网络外医院的价格。我们研究这种监管如何影响均衡价格、网络形成以及医院退出。我们估计了一个保险公司与医院之间讨价还价的结构模型，该模型允许非签约方之间进行网络外交易。这些交易通过使某些医院在特定监管下变得无利可图，从而产生了一种退出的概念。估计依赖于一种新的网络外价格衡量方法。我们发现，降低网络外价格也会降低谈判价格，但可能以医院网络变窄为代价。激进的监管可能导致大量医院退出，但这仅在谈判方无法预见退出的限制性假设下才会发生。

【**NBER**】: NBER Working Paper No. 33727，https://www.nber.org/papers/w33727

#### 3. The Macroeconomics of Tariff Shocks {#33726}

【**Author**】: Adrien Auclert, Matthew Rognlie, Ludwig Straub

【**Abstract**】: We study the short-run effects of import tariffs on GDP and the trade balance in an open-economy New Keynesian model with intermediate input trade. We find that temporary tariffs cause a downturn whenever the import elasticity is below an openness-weighted average of the export elasticity and the intertemporal substitution elasticity. We argue that this condition is likely satisfied in practice because durable goods generate great scope for intertemporal substitution, and because it is easier to lose competitiveness on the global market than to substitute between home and foreign goods. Unilateral tariffs tend to improve the trade balance, but when other countries retaliate the trade balance worsens and the contraction deepens. Taking into account the contractionary effect of tariffs dramatically lowers the optimal unilateral tariff derived in standard trade theory.

【**摘要**】：我们在一个包含中间投入品贸易的开放经济新凯恩斯模型中，研究了进口关税对GDP和贸易平衡的短期影响。我们发现，当进口弹性低于出口弹性和跨期替代弹性的开放度加权平均值时，临时性关税会导致经济衰退。我们认为，这一条件在实践中很可能成立，因为耐用品为跨期替代提供了巨大空间，并且在全球市场上失去竞争力比在国内和外国商品之间进行替代更容易。单边关税倾向于改善贸易平衡，但当其他国家进行报复时，贸易平衡会恶化，经济收缩会加深。考虑到关税的收缩效应，会显著降低标准贸易理论中得出的最优单边关税水平。

【**NBER**】: NBER Working Paper No. 33726，https://www.nber.org/papers/w33726

#### 4. State versus Market: China's Infrastructure Investment {#33725}

【**Author**】: Shuoge Qian, Hong Ru, Wei Xiong
...
【**摘要**】：在全球对国家干预的兴趣日益高涨的背景下，本文考察了中国的基础设施投资——一项关键的宏观经济政策工具——如何影响企业生产率。我们聚焦于一项鼓励地方政府改善私营企业市场条件的政策。我们的分析表明，更好的市场环境会放大基础设施投资的溢出效应。然而，尽管在那些市场准入条件改善的行业中获得了更大的收益，但总体影响仍然是中性或负面的。这些发现凸显了国家干预与市场力量之间复杂的相互作用，引发了对基础设施投资在维持增长方面有效性的担忧，尤其是在市场制度薄弱的地区。

【**NBER**】: NBER Working Paper No. 33725，https://www.nber.org/papers/w33725

#### 5. An Anatomy of U.S. Establishments' Trade Linkages in Global Value Chains {#33724}

【**Author**】: Aaron B. Flaaen, Fariha Kamal, Eunhee Lee, Kei-Mu Yi
...
【**摘要**】：全球价值链是现代生产的一个普遍特征，但很难衡量。利用美国人口普查局的机密微观数据，我们开发了衡量美国制造业企业进口与出口之间关联的新方法。我们记录了三种新的全球价值链模式。首先，每出口一美元，进口投入品在2002年占13美分，到2017年占20美分，这远高于总体数据所显示的水平。其次，我们发现投入品和产出市场之间存在强烈的互补性，这体现在“往返”贸易关联中，即一家企业从同一国家采购投入品并向其出口产出。第三，我们发现区域贸易协定与全球价值链贸易流量之间存在强烈的正相关关系。用于构建全球投入产出表的总体数据需要比例性假设，我们发现这些假设削弱了这些关系。最后，通过一个简单模型，我们表明“往返”结果与企业和国家特定固定成本的概念一致，这些成本至少在采购（进口）和国外销售（出口）之间是部分共通的。

【**NBER**】: NBER Working Paper No. 33724，https://www.nber.org/papers/w33724

#### 6. The Global Effects of Carbon Border Adjustment Mechanisms {#33723}

【**Author**】: Kimberly A. Clausing, Jonathan M. Colmer, Allan Hsiao, Catherine Wolfram
...
【**摘要**】：气候变化构成了一个集体行动问题：单个国家承担碳监管的成本，而收益则由全球共享。目前欧盟和英国正在实施的碳边境调节机制旨在通过提高国内竞争力、减少排放泄漏以及鼓励其他国家征收碳税来重新调整激励措施。然而，政策讨论也指出，碳边境调节机制可能不公平地使低收入贸易伙伴处于不利地位。我们利用一个量化贸易模型以及两个关键行业——钢铁和铝——的企业层面数据来评估这些问题，这两个行业是早期碳边境调节机制实施的重点。它们合计占全球排放量的14%。我们表明，碳边境调节机制可以促进集体气候行动，同时很大程度上避免给低收入国家带来不成比例的负担。

【**NBER**】: NBER Working Paper No. 33723，https://www.nber.org/papers/w33723

#### 7. Screening Through Soft Spending Limits: Evidence from the Medicare Therapy Cap {#33722}

【**Author**】: Ashvin Gandhi, Maggie Shi

【**Abstract**】: Governments and firms often use soft spending limits to curb overspending while allowing exceptions. We study a Medicare policy that capped per-patient physical therapy spending with exceptions for documented medical need. By screening out low-value care, the cap reduced spending by 8 percent without harming patient health. This screening was driven by Medicare’s exception decisions, whereas patients and providers scaled back care indiscriminately. However, the cap also generated horizontal inequities: conditional on need, lower-income and minority patients were more likely to be screened out because they were treated by smaller providers who were slower to adapt to new documentation requirements.

【**摘要**】：政府和公司经常使用软性支出上限来遏制过度支出，同时允许例外情况。我们研究了一项医疗保险政策，该政策对每位患者的物理治疗支出设置了上限，但允许因记录在案的医疗需求而例外。通过筛选出低价值护理，该上限在不损害患者健康的情况下将支出减少了8%。这种筛选是由医疗保险的例外决定驱动的，而患者和医疗服务提供者则不加区分地缩减了护理。然而，该上限也产生了横向不公平：在需求相同的情况下，低收入和少数族裔患者更有可能被筛选出去，因为他们由规模较小的医疗服务提供者治疗，而这些提供者适应新文件要求的步伐较慢。

【**NBER**】: NBER Working Paper No. 33722，https://www.nber.org/papers/w33722

#### 8. Local Energy Access and Industry Specialization: Evidence from World War II Emergency Pipelines {#33721}

【**Author**】: Jacob Greenspon, Gordon H. Hanson
...
【**摘要**】：改善能源供应可及性如何影响区域制造业专业化？我们评估了美国政府二战期间修建的、用于将石油和天然气从西南部油田输送到战时工业生产者东北部的管道所产生的长期就业影响。这些管道沿着一条旨在最大限度减少稀缺建筑材料使用的直接路径快速建成，以连接端点。战后，它们被改造为向沿途客户供应能源，这使得靠近管道的县能够获得廉价且充足的能源。在1940年至1950年间，管道天然气可及性更好的县，其能源密集型产业就业份额增长更大。尽管1970年代能源危机造成了破坏性影响，但所有能源密集型产业的这些影响一直持续到1980年代中期，而直接使用电力密集型产业的子集则持续到1990年代末。我们的发现对于理解地方经济发展模式中与能源相关的路径依赖，以及政府干预能源市场如何影响产业在短期和长期的区位选择具有重要意义。

【**NBER**】: NBER Working Paper No. 33721，https://www.nber.org/papers/w33721

#### 9. Protection for Whom? The Political Economy of Protective Labor Laws for Women {#33720}

【**Author**】: Matthias Doepke, Hanno Foerster, Anne Hannusch, Michèle Tertilt
...
【**摘要**】：在二十世纪上半叶，美国许多州颁布了限制女性劳动力市场机会的法律，包括最长工时限制、最低工资法和夜班禁令。所谓的劳动保护法时代随着民权改革在20世纪60年代结束。在本文中，我们研究了这些法律兴衰背后的政治经济学。我们认为，劳动保护法的主要驱动力是男性保护自己免受劳动力市场竞争的愿望。我们通过一个政治经济模型阐述了这一机制，在该模型中，单身人士和夫妇在不同部门工作，并对保护性立法进行投票。限制措施得到了单身男性和男性唯一养家糊口的夫妇的支持，他们与女性竞争工作。我们表明，该理论关于何时引入保护性立法的预测得到了美国州级证据的有力支持。

【**NBER**】: NBER Working Paper No. 33720，https://www.nber.org/papers/w33720
...
【**摘要**】：中国的混合经济将国家规划与市场机制相结合，利用年度经济目标指导发展，并通过宏观经济管理确保其实现。地方政府设定雄心勃勃的增长目标，以与中央指令保持一致并激励下属，导致非对称调整：目标在经济繁荣时期迅速上升，但在经济放缓时期下降缓慢。这种动态加剧了地方政府干预经济的压力，尤其是在2010年之后。我们的分析表明，当一个地区未达到其增长目标时，它会增加基础设施投资、土地出让和地方政府债务以弥补差距。值得注意的是，在相对稳定的2011-2019年期间，过于乐观的目标使地方政府债务额外增加了GDP的14.0%。虽然这些干预措施有助于平滑周期波动并缓和GDP减速的趋势，但它们也削弱了GDP增长作为经济指标的可靠性，削弱了其与企业收入、家庭需求和全要素生产率增长的关联性。

【**NBER**】: NBER Working Paper No. 33718，https://www.nber.org/papers/w33718

#### 11. Opioids and Post-COVID Labor-Force Participation {#33717}

【**Author**】: Francesco Chiocchio, Jeremy Greenwood, Nezih Guner, Karen Kopecky
...
【**摘要**】：在COVID-19疫情爆发之初，美国劳动力参与率下降了约3个百分点，并在三年后仍低于疫情前水平。各州的复苏情况各不相同，那些受疫情前阿片类药物危机影响更严重的州（以年龄调整后的阿片类药物过量死亡率衡量）复苏更慢。一项事件研究显示，疫情前阿片类药物死亡率每增加一个标准差，疫情后劳动力参与率相应下降0.9个百分点。这一结果并非由各州之间的整体健康状况差异所驱动。先前阿片类药物暴露的影响对没有大学学位的个人更为显著。在阿片类药物暴露程度较高的州，复苏缓慢的特征是由于残疾而退出劳动力市场的人数增加。

【**NBER**】: NBER Working Paper No. 33717，https://www.nber.org/papers/w33717

#### 12. Using Multiple Outcomes to Adjust Standard Errors for Spatial Correlation {#33716}

【**Author**】: Stefano DellaVigna, Guido Imbens, Woojin Kim, David M. Ritzwoller
...
【**摘要**】：经济学中的实证研究经常考察位于地理空间中的经济主体的行为。在这种情况下，统计推断因不同地点经济结果的相互依赖性而变得复杂。解释这种依赖性的常用方法是基于预定义的地理分区对标准误进行聚类。第二种策略是根据单位之间的距离来建模依赖性。然而，依赖性不一定止于边界，并且通常不仅仅由距离决定。本文介绍了一种方法，该方法利用对多个结果变量的观测来调整横截面依赖性的标准误。具体来说，研究人员在关注某个特定结果变量的同时，通常能观察到同一单位的其他几十个变量。我们表明，在横截面相关结构在各结果变量之间共享的假设下，这些结果变量可用于估计依赖性。我们开发了一个程序，称为多结果阈值法（TMO），该程序使用此估计值来调整给定回归设置中的标准误。我们表明，在校准的美国县级回归中，这种形式的调整可以导致标准误偏差的大幅减少。重新分析九篇近期论文，我们发现所提出的修正方法在实践中可以产生显著差异。

【**NBER**】: NBER Working Paper No. 33716，https://www.nber.org/papers/w33716

#### 13. Optimal Second-best Menu Design: Evidence from Residential Electricity Plans {#33715}

【**Author**】: Maria Garcia-Osipenko, Nicolai V. Kuminoff, Spencer Perry, Nicholas Vreugdenhil
...
【**摘要**】：公用事业公司越来越多地使用包含恒定电价和时变电价计划的复杂菜单来销售电力。我们研究如何设计这样一个菜单，以在次优环境中最大化社会福利，其中发电的边际私人成本和外部成本随时间变化，制度约束阻止强制实施时变定价，并且消费者行为因摩擦而扭曲。我们开发了一个包含时变边际社会成本的计划选择、消费和跨期替代模型，并使用来自一家大型公用事业公司的行政数据进行估计。我们提供了证据，表明消费者在响应时变价格激励时存在显著的跨期替代，并且基于多维异质性在不同计划之间进行选择。虽然当前菜单中的时变计划显著地将消费从高电价时段转移到低电价时段，但我们发现它们降低了社会福利。这种损失因信息摩擦而得到缓解。我们展示了如何重新设计菜单，以同时改善消费者、公用事业公司和环境的结果。

【**NBER**】: NBER Working Paper No. 33715，https://www.nber.org/papers/w33715

#### 14. The Global Macro Database: A New International Macroeconomic Dataset {#33714}

【**Author**】: Karsten Müller, Chenzi Xu, Mohamed Lehbib, Ziliang Chen
...
【**摘要**】：全球宏观数据库是一个开源、持续更新的宏观经济统计数据数据集，它统一并扩展了现有资源。通过协调和整合来自32个主要当代来源（包括国际货币基金组织、世界银行和经合组织）的数据以及来自78个额外数据集的历史记录，我们为243个国家的46个变量构建了完整的年度时间序列。该数据库涵盖了从现代数据收集起源到2030年预测估计的全球宏观经济趋势。利用这个广泛的数据库，我们研究了金融危机和全球温度冲击的长期产出损失，这是两个历史时间序列作为关键输入的实证应用。我们的研究结果表明，金融危机与未来五十年内可统计检测到的实际GDP收缩相关，其规模比先前估计的要大得多。温度冲击也能预测未来长达30年的实际GDP收缩，尤其是在新兴经济体中。

【**NBER**】: NBER Working Paper No. 33714，https://www.nber.org/papers/w33714

#### 15. The Rise of Absorptive Research in Corporate America: 1945-1980 {#33713}

【**Author**】: Ashish Arora, Sharon Belenzon, Jungkyu Suh, Hansen Zhang
...
【**摘要**】：我们使用企业研究活动的多个指标，研究了1945年至1980年二战后美国企业研究的“黄金时代”。我们使用集成学习方法将企业分类为科学领导者、吸收者或追随者。我们的分析表明，只有一小部分企业（我们称之为领导者）投资于处于科学前沿的内部研究，其目标是产生突破性发明。吸收者投资于研究主要是为了吸收外部科学发现以推动其发明活动。追随者通常利用较旧的科学知识产生增量创新。与此一致，我们发现领导者更有可能处于技术前沿，享有更大的市场力量，并从政府采购合同中受益。随着大学和初创公司开始将学术发现商业化，对“吸收性企业实验室”的需求下降了。这种转变最终改变了美国的创新格局，加深了大学、初创公司和现有企业之间的创新劳动分工，只有少数领导者企业继续投资于基础科学。

【**NBER**】: NBER Working Paper No. 33713，https://www.nber.org/papers/w33713

#### 16. The Political Economy of Firm Networks: CEO Ideology and Global Trade {#33712}

【**Author**】: Elisabeth Kempf, Mancy Luo, Margarita Tsoutsoura
...
【**摘要**】：我们研究了企业领导人的政治意识形态如何塑造跨境企业网络。利用美国企业CEO与外国政府在势均力敌的外国选举前后意识形态一致性的变化，我们表明，当外国政府领导人的意识形态与其CEO的意识形态距离变得更远时，美国企业更有可能终止与该国政府的贸易关系。这种影响集中在持有强烈政治观点的CEO身上，并且在较短的贸易关系中尤为显著，这表明意识形态一致性在更灵活和可替代的联系中更为相关。我们的发现强调了意识形态在塑造国际企业网络形成和持续性中的作用。

【**NBER**】: NBER Working Paper No. 33712，https://www.nber.org/papers/w33712

#### 17. A Theory of Supply Function Choice and Aggregate Supply {#33711}

【**Author**】: Joel P. Flynn, Georgios Nikolakoudis, Karthik Sastry
...
【**摘要**】：现代总供给理论建立在企业设定价格并承诺按市场需求生产的假设之上。我们取消了这一战略限制，允许企业选择供给函数，即描述在每个生产数量下所收取价格的映射。在理论上，我们刻画了企业在一般均衡中最优供给函数选择的特征，并研究了其对总供给的影响。在通胀不确定性较低、异质性需求不确定性较高以及需求弹性较低的情况下，总供给曲线趋于平坦。在定量上，我们的理论可以解释大缓和时期总供给曲线的平坦化以及1970年代和2020年代总供给曲线的陡峭化。

【**NBER**】: NBER Working Paper No. 33711，https://www.nber.org/papers/w33711

#### 18. The Invention of Corporate Governance {#33710}

【**Author**】: Yueran Ma, Andrei Shleifer
...
【**摘要**】：公司治理的分析始于现代资本主义的一个核心特征——大型企业中所有权与控制权的分离——这一特征首先由Berle和Means（1932）进行了实证记录。这种分离带来了若干代理问题，反映了经理人与股东之间的冲突，例如经理人的自我交易、低努力、在职消费以及过度增长和多元化。Berle和Means认为自我交易是核心代理问题，并强调法律是解决该问题的基本机制。Jensen和Meckling（1976）考虑了在职消费，并强调私人机制（如对经理人的财务激励）来对抗浪费性的额外津贴。Jensen（1986）则聚焦于过度增长和多元化，这使他依赖杠杆和收购。公共公司治理机制（主要是法律）与市场治理的结合塑造了理论与实践。

【**NBER**】: NBER Working Paper No. 33710，https://www.nber.org/papers/w33710

#### 19. How Tariffs Affect Trade Deficits {#33709}

【**Author**】: Arnaud Costinot, Iván Werning
...
【**摘要**】：我们研究永久性进口关税对贸易逆差的正面（而非规范）影响。我们考虑一个具有一般偏好和技术的两期贸易模型。我们首先发展出一个加总结果，表明可以基于对总进口和总出口的诱导偏好进行分析。我们的主要结果提供了关税中性以及关税减少逆差的条件。一个核心主题是，总进口和总出口的静态恩格尔曲线是理解这一动态问题的关键。

【**NBER**】: NBER Working Paper No. 33709，https://www.nber.org/papers/w33709

#### 20. The Law and Economics of Lawyers: Evidence from the Revolving Door in China’s Judicial System {#33708}

【**Author**】: John Zhuang Liu, Wenwei Peng, Shaoda Wang, Daniel Xu
...
【**摘要**】：本文通过研究中国司法系统中法官与律师之间的“旋转门”——即辞去法官职务转而从事律师职业的前法官——来考察权力律师如何塑造司法和经济结果。在原本相同的诉讼案件中，旋转门律师为其客户带来的胜诉率高出8-23%。他们在主场法院与客场法院的表现差异表明，这些收益既源于“懂行”也源于“识人”。我们扩展了Dewatripont和Tirole（1999）的理论框架，以表明旋转门律师在社会中创造了两种相反的力量：他们通过证据和推理提升司法决策质量，但也利用战略论证和关系使结果偏向其客户。我们估计了一个司法过程的结构模型来量化这些权衡，并发现增加权力律师的供给对均衡司法质量可能产生非单调的影响。

【**NBER**】: NBER Working Paper No. 33708，https://www.nber.org/papers/w33708

#### 21. Firm Presence, Pollution, and Agglomeration: Evidence from a Randomized Environmental Place-Based Policy {#33707}

【**Author**】: Michael Gechter, Namrata Kala
...
【**摘要**】：企业的选址决策由于竞争或集聚力量对其他企业产生外部性，并对环境产生影响。我们研究了一项环境地点导向政策，该政策随机迁移了新德里的20,000家企业。搬迁减少了污染，但企业退出增加。我们将企业向工业地块的外生分配与一个模型相结合，以估计对邻近企业的溢出效应，表明如果根据投入产出关联分配企业到地块，企业存活率本可以提高。这些结果提供了关于企业存在如何影响环境质量以及如何利用溢出效应最小化受监管企业成本的因果证据。

【**NBER**】: NBER Working Paper No. 33707，https://www.nber.org/papers/w33707

#### 22. Reducing Nutritional Disparities Through Targeted Pricing: Evidence from a Large Restaurant Chain {#33706}

【**Author**】: Weijia (Daisy) Dai, Ginger Zhe Jin, Ben Zou
...
【**摘要**】：不同社会经济群体之间的营养差异加剧了美国的健康不平等。本文考察了由企业主导的、切实可行的定价干预措施是否可以通过引导弱势消费者选择更健康的选项来减少这些差异。利用一家大型快餐连锁店的详细交易层面数据，我们表明，弱势社区的消费者不成比例地选择了热量更高、更不健康的食品。我们利用来自连锁店范围促销折扣的准实验变化来估计混合逻辑离散选择模型，并恢复不同人口群体之间的偏好异质性。我们发现，较低社会经济地位的消费者在所有营养特征上对价格都更敏感，并且在健康与不健康选项之间的替代方面表现出灵活性。反事实模拟表明，在弱势社区进行适度、有针对性的价格调整可以促进更健康的饮食，同时对收入的影响最小。

【**NBER**】: NBER Working Paper No. 33706，https://www.nber.org/papers/w33706

#### 23. Did War Mobilization Cause Aggregate and Regional Growth? {#33705}

【**Author**】: Taylor Jaworski, Dongkyu Yang
...
【**摘要**】：美国参与第二次世界大战导致国内资源大量动员，以生产用于欧洲和太平洋战场的物资。我们为战争动员对战后时期美国长期经济增长和区域发展的影响提供了新的估计。在经济地理模型的指导下，我们将我们的估计解释为动员对地方生产率的直接影响。研究结果表明，尽管存在区域差异，但最可能的总量福利影响是适度的。此外，工业动员对东北部和中西部制造业增长的贡献相对较大，而对南部和西部的贡献较小。

【**NBER**】: NBER Working Paper No. 33705，https://www.nber.org/papers/w33705

#### 24. Option Value Neglect: Evidence from Centralized College Admission {#33704}

【**Author**】: Ao Wang, Shaoda Wang, Xiaoyang Ye
...
【**摘要**】：顺序选择在日常生活中无处不在，然而在此类情境中做出最优决策——其中正确考虑期权价值至关重要——可能具有挑战性。本文提供了关于在高风险决策中忽视期权价值的现场实验证据，并量化了相关的福利后果。我们研究了一个集中式大学录取系统，学生在此系统中提交简短的偏好列表。尽管期权价值应鼓励更冒险的顶层选择，但许多学生过于谨慎，未能包含更安全的较低排名选项。我们认为，定向认知——即做出短视决策而忽略后续选项的价值——解释了这种行为。一项针对基于框架的关键预测的现场实验表明，约50%的申请者表现出这种模式，尤其是在弱势学生中。反事实分析表明，去偏干预可以显著缩小结果差距并提高整体效率。

【**NBER**】: NBER Working Paper No. 33704，https://www.nber.org/papers/w33704

#### 25. From Distraction to Dedication: Commitment and Incentives Against Phone Use in the Classroom {#33703}

【**Author**】: Billur Aksoy, Lester R. Lusher, Scott E. Carrell
...
【**摘要**】：课堂上的手机使用已被证明与学业成绩下降有关。我们展示了一项与一款被宣传为软性承诺设备的应用程序合作，在一所大型公立大学进行的实地实验结果，该应用程序通过提供激励措施来减少课堂上的手机使用。我们发现，使用该应用程序改善了课堂专注度、出勤率和整体学业满意度。对课堂外时间花费的分析表明存在潜在的替代效应：使用该应用程序的学生分配给学习的时间更少，尤其是在校园内。总体而言，尽管统计上不显著，但我们发现与使用该应用程序相关的成绩单分数有所改善。

【**NBER**】: NBER Working Paper No. 33703，https://www.nber.org/papers/w33703

#### 26. Long-Run Effects of Trade Wars {#33702}

【**Author**】: David Baqaee, Hannes Malmberg
...
【**摘要**】：在这篇手册章节中，我考察了整合民族志和民间传说记录如何塑造了21世纪关于文化与经济学的研究。文本分析技术的进步以及历史数据和卫星数据的纳入已经改变了这一领域。我探讨了乔治·彼得·默多克的民族志贡献和尤里·别列兹金开创性的民间传说母题索引如何被用来阐明比较发展的根源。最后，我提出了一种利用大型语言模型从民间传说母题中提取文化见解的方法论，展示了祖先叙事如何能够补充民族志记录，并为当今塑造经济行为的社会规范和历史力量提供有价值的视角。

【**NBER**】: NBER Working Paper No. 33700，https://www.nber.org/papers/w33700
...
【**摘要**】：COVID-19疫情导致联邦向州和地方政府的转移支付达到了前所未有的水平。这笔资金是否影响了人口健康？为了回答这个问题，我们利用了这样一个事实：在国会中享有超额代表性的美国州获得的财政援助远多于代表性相对不足的州。我们发现，由超额代表性驱动的援助对人口健康产生了实质性影响。我们估计，每增加1000美元的联邦财政援助（按州居民人均计算），各州在2020年至2022年期间每10万居民中所有原因导致的死亡人数减少38人，其中三分之二来自COVID-19死亡率的降低。我们估计，最后3310亿美元的联邦疫情援助（与我们的样本内变化相对应）通过挽救的生命年产生了5910亿美元的价值。额外的援助还降低了与COVID-19相关的住院率和急诊就诊率，但并未减少检测到的阳性病例总数。这些改善结果的合理机制包括更高的COVID-19疫苗接种率（这大概可以解释我们观察到的近一半的死亡率降低）和更高的COVID-19检测率。医疗补助注册人数和医院容量似乎并未发挥重要的中介作用。我们的稳健性分析提供的证据表明，我们估计的影响不能用已有的死亡率趋势、疫情对相对密集地区与农村地区的差异化影响，或者疫情对老年人口较多或慢性病患病率较高人群的差异化影响来解释。我们估计的死亡率影响对非西班牙裔黑人美国人的影响远大于对非西班牙裔白人美国人的影响，因此联邦资金与疫情期间人口健康差距的缩小相关。

【**NBER**】: NBER Working Paper No. 33699，https://www.nber.org/papers/w33699
...
【**摘要**】：近期稳定政策研究和实践的大部分焦点都集中在货币政策而非财政政策上。本文探讨了在货币政策存在限制的情况下，财政政策如何能够发挥更大的作用。它探讨了准自动稳定器的使用，即由某个总量变量触发的税收或转移支付的变化。它讨论了设计问题，特别是如何使此类稳定器真正实现债务中性，以及使用哪个总量变量作为触发条件。然后，它聚焦于一个特定的稳定器——可变增值税税率。它在一个极简的新凯恩斯主义模型中展示了其效果，然后讨论了该极简模型内外的一系列分析性问题，例如对通胀的影响、税基的选择、流动性约束的影响以及预期效应的影响。最后，它回顾了关于增值税变化传导以及永久性或临时性增值税变化对需求影响的实证证据。

【**NBER**】: NBER Working Paper No. 33698，https://www.nber.org/papers/w33698

#### 31. The Effect of Deactivating Facebook and Instagram on Users’ Emotional State {#33697}

【**Author**】: Hunt Allcott, Matthew Gentzkow, Benjamin Wittenbrink, Juan Carlos Cisneros, Adriana Crespo-Tenorio, Drew Dimmery, Deen Freelon, Sandra González-Bailón, Andrew M. Guess, Young Mie Kim, David Lazer, Neil Malhotra, Devra Moehler, Sameer Nair-Desai, Brendan Nyhan, Jennifer Pan, Jaime Settle, Emily Thorson, Rebekah Tromble, Carlos Velasco Rivera, Arjun Wilkins, Magdalena Wojcieszak, Annie Franco, Chad Kiewiet de Jonge, Winter Mason, Natalie Jomini Stroud, Joshua A. Tucker
...
【**摘要**】：我们在2020年美国大选前的两项大规模随机实验中估计了停用社交媒体对用户情绪状态的影响。与那些仅在六周中的第一周停用Facebook的对照组相比，在大选前六周停用Facebook的人报告称，在包含快乐、抑郁和焦虑的指数上改善了0.060个标准差。与对照组相比，在这六周内停用Instagram的人报告改善了0.041个标准差。探索性分析表明，Facebook的影响是由35岁以上人群驱动的，而Instagram的影响是由25岁以下女性驱动的。

【**NBER**】: NBER Working Paper No. 33697，https://www.nber.org/papers/w33697

#### 32. The Political Power of Firms {#33696}

【**Author**】: Matilde Bombardini, Francesco Trebbi
...
【**摘要**】：近几十年来住房可负担性的下降，激发了人们对住房供给的更多关注。本章提供了自1980年以来美国住房价格、数量和监管演变的描述性证据，表明供给约束似乎越来越具有约束力。然后，我们概述了用于在静态和动态背景下对同质和异质住房的建设和土地开发进行建模的各种方法，以理解住房供给。我们的论述贯穿始终地包含了实证实施和政策含义。最后，我们概述了关于放松各类供给约束后果的定量证据。

【**NBER**】: NBER Working Paper No. 33694，https://www.nber.org/papers/w33694

#### 35. Performance Capital Flows in DC Pensions {#33693}

【**Author**】: Bryan Gutierrez Cortez, Victoria Ivashina, Juliana Salomao
...
【**摘要**】：固定缴款（DC）养老基金的资本流动对业绩敏感吗？我们考察了来自可以更换其养老金管理人的个人账户持有人的压力。利用近1000万人的退休账户新数据，我们基于计划的风险状况分析了转换行为。在同一养老金产品内更换管理人并不罕见，而且更换管理人的倾向随时间推移而增加。资本流动对基金业绩敏感，并随业绩增长而增加。这种敏感性给管理人带来了压力，塑造了他们的激励和投资组合决策。准外生的资金流出增加导致管理人转向持有更高收益的债券。

【**NBER**】: NBER Working Paper No. 33693，https://www.nber.org/papers/w33693

#### 36. Does Homeownership Matter? The Long-Term Consequences of Losing a House during the Great Recession {#33692}

【**Author**】: Heidi Artigue, Patrick Bayer, Fernando V. Ferreira, Stephen Ross
...
【**摘要**】：我们考察了在美国拥有住房与租赁住房的长期影响。我们的研究设计比较了两组在大衰退期间经历了相似负面收入冲击的房主，但由于抵押贷款修改，他们保留房屋的概率不同。虽然这两组人表现出几乎相同的先期趋势，但在房屋保留率上相差了36个百分点。这种差异的一半以上在近十年后仍然存在，转化为平均83,000美元的住房资本收益。然而，住房所有权和住房财富并未影响信用度、消费或社区质量，部分原因是信贷约束收紧。

【**NBER**】: NBER Working Paper No. 33692，https://www.nber.org/papers/w33692
...
【**摘要**】：本文探讨了关于日益加剧的不平等对公共财政理论与实践影响的问题。它首先阐述了为何基于税前和转移支付前的年度收入或财富分布提供的信息不足的根本原因：（1）它没有告诉我们家庭实际可用于消费的资源是什么；（2）在提供特定时点上不同年龄个体可用资源的快照时，由于未控制生命周期相关差异或收入动态，它可能对潜在的不平等程度提供有误导性的估计。然后，本文考虑了高且可能日益加剧的经济不平等对政府政策设计的影响：最高边际税率、对高收入者政府政策的逐步退出、不平等的政治经济学以及其他主题。

【**NBER**】: NBER Working Paper No. 33691，https://www.nber.org/papers/w33691

#### 38. The Long Road to Equality: Racial Capital and Generational Convergence {#33690}

【**Author**】: Patrick Bayer, Kerwin Kofi Charles, JoonYup Park
...
【**摘要**】：自1870年以来，经济结果中种族差异的缓慢趋同表明，在群体层面上，社会经济地位具有高度的代际持续性。相比之下，基于微观数据的家庭层面代际流动性估计则显示出低得多的持续性。这些模型还一致发现，即使在广泛控制家庭和社区特征之后，流动性中仍存在巨大的、无法解释的种族差距——这意味着未来将继续缓慢趋同。为了调和这些模式，我们引入了种族资本的概念：儿童成长过程中所接触的种族群体的集体物质和非物质资产。我们表明，种族资本（i）解释了成人结果中种族差距的很大一部分，（ii）显著缩小并常常逆转了估计的种族流动性差距，并且（iii）在种族与白人多数群体的分离程度最大（以居住和婚姻隔离衡量）的地方，其影响最强。与标准模型不同，我们的框架预测了一个接近种族平等的长期稳态，但也强调了种族资本的影响如何显著减缓了通往该均衡的路径。

【**NBER**】: NBER Working Paper No. 33690，https://www.nber.org/papers/w33690

#### 39. The Long-Run Impacts of Mentoring Underrepresented Minority Groups in Economics {#33689}

【**Author**】: Francisca M. Antman, Sheng Qu, Trevon D. Logan, Bruce A. Weinberg
...
【**摘要**】：我们对经济学中代表性不足群体最古老的专业指导项目之一——美国经济协会指导项目（AEAMP）进行了长期评估。AEAMP旨在通过指导经济学博士生和新晋博士来解决种族/族裔少数群体代表性不足的问题。我们将受指导者的职业结果与来自同一博士年级但未参与该项目的相似个体进行了比较。虽然许多结果没有差异，但受指导者更有可能拥有终身教职轨道或已获终身教职的职位。我们的结果指出了指导项目在解决持续的种族/族裔差异方面的潜力。

【**NBER**】: NBER Working Paper No. 33689，https://www.nber.org/papers/w33689

#### 40. Interventionist Preferences and the Welfare State: The Case of In-Kind Aid {#33688}

【**Author**】: Sandro Ambuehl, B. Douglas Bernheim, Tony Q. Fan, Zachary Freitas-Groff
...
【**摘要**】：为什么实物援助是福利体系的一个突出特征？我们进行了一项涉及美国普通民众和SNAP（补充营养援助计划）受助者的实地实验。在记录到普遍存在限制受助者选择的愿望后，我们量化了以下因素的相对重要性：（i）福利主义动机，（ii）从限制他人自主权中获得的效用或产生的负效用，以及（iii）关于援助适当形式的绝对主义态度。选择主要反映了两种非福利主义动机。由于人们系统性地误解了受助者的偏好，他们的干预比其意图更为严格。干预主义偏好和非福利主义动机在政治右翼中更为明显，特别是当受助者是黑人时。

【**NBER**】: NBER Working Paper No. 33688，https://www.nber.org/papers/w33688
...
【**摘要**】：我们利用罗伊（1951）传统下的职业选择结构模型，研究了自1980年以来推动极化与更高工资不平等的力量。在我们的模型中，相对职业技能价格的变化代表了职业劳动力服务相对需求的变化。我们的分析得出三个主要发现。第一，尽管技能价格的变化对就业份额和平均工资有数量上显著的影响，但它们在解释工资不平等的急剧上升方面基本上没有作用。第二，相对工资的变化是由更高阶矩的变化驱动的，并不反映相对需求的变化。第三，特定职业内个体生产率方差的变动是不平等急剧上升背后的主导因素。

【**NBER**】: NBER Working Paper No. 33687，https://www.nber.org/papers/w33687
...
【**摘要**】：我们构建了一个包含不完全市场、投入产出关联和异质性部门价格粘性的多国、多部门新凯恩斯模型，以研究关税的宏观经济效应。关税同时作为需求冲击和供给冲击。一个由贸易条件效应和重估的净外国资产驱动的风险分担楔子，概括了一般均衡中的财富转移，并决定了征收关税的国家是获益还是受损。这个楔子与一个编码了网络结构、部门粘性以及跨国货币政策异质性的传播矩阵相互作用，后者决定了继承的实际边际成本扭曲如何传导至通胀和消费。通过投入产出关联，临时关税会产生持续的扭曲，这与标准的新凯恩斯基准模型不同。这些扭曲超出了N国货币政策所能抵消的范围，即使在浮动汇率下也是如此。在数量上，2025-2026年的关税对美国来说是滞胀的，并根据贸易转移和货币政策异质性，在国外产生通胀或通缩。仅关税威胁本身就会产生由报复预期所塑造的通胀。

【**NBER**】: NBER Working Paper No. 33686，https://www.nber.org/papers/w33686

#### 43. Taxes and Private Firms’ Capital Structure Choices {#33685}

【**Author**】: Mara Faccio, Jin Xu
...
【**摘要**】：利用全球范围内引入利息上限规则所触发的利息扣除限制，我们表明受影响的私营企业相对于未受影响的企业降低了杠杆率。为了支持税收对企业资本结构选择的因果效应，我们展示了在接近触发限制门槛的企业、在倾向得分匹配样本中，以及在需要采用利息上限规则的国家中，结果均成立。相比之下，反事实检验显示，在伪改革年份前后，受影响企业的杠杆率并未下降。此外，在一个国家内部，不可扣除利息支付比例较高的企业对税率变化的反应较小。更广泛地，在93个国家中，我们记录了私营企业倾向于在减税时降低杠杆率，并在公司税率提高时增加杠杆率。

【**NBER**】: NBER Working Paper No. 33685，https://www.nber.org/papers/w33685

#### 44. Partisan Trust in the Federal Reserve {#33684}

【**Author**】: Carola Binder, Cody Couture, Abhiprerna Smit
...
【**摘要**】：本文考察了公众对美联储看法中的党派性。在2001年至2023年的所有年份中，对美联储的信任度在那些与总统同属一个政党的受访者中最高。党派效应大于信任度方面的其他人口统计学差异，但不能解释那些年份中通胀预期的巨大党派差距。我们在2025年总统就职典礼前后进行了一项新的基于调查的信息实验，并发现了一种变化的模式：即使在一位共和党总统当选并上任后，共和党人对美联储的信任度仍然低于民主党人。然而，共和党人的通胀预期远低于民主党人。对开放式调查问题的回答指出，在消费者考虑通胀将如何演变时，关税和特朗普总统本人是最突出的因素。

【**NBER**】: NBER Working Paper No. 33684，https://www.nber.org/papers/w33684
...
【**摘要**】：本文重新审视了基于教育的婚姻市场匹配与收入不平等之间的联系。利用丹麦的行政数据，我们基于与详细教育项目相关的起薪和工资增长轨迹，开发了一种新颖的“抱负类型”分类。我们发现，随着时间的推移，基于教育抱负的选型匹配显著增加，并且自1980年以来，婚姻市场解释了超过40%的不平等加剧。相比之下，使用常用的教育水平分类时，匹配趋势是平稳的。我们得出结论，从教育到类型的映射对于关于基于教育的婚姻市场匹配如何导致收入不平等上升的结论至关重要。

【**NBER**】: NBER Working Paper No. 33683，https://www.nber.org/papers/w33683

#### 46. If You Had One Shot: Scale and Herding in Innovation Experiments {#33682}

【**Author**】: Ashish Arora, Sharique Hasan, William D. Miles
...
【**摘要**】：解决复杂问题——在医学、工程和其他技术领域——通常需要探索多种方法，尤其是在哪种方法能带来成功存在重大不确定性时。传统观点认为，让许多实验者独立决定追求哪种方法会增加多样性，从而也增加找到解决方案的机会。然而，如果实验者都从众于最有希望的方法，这种趋同可能会减少多样性，从而降低解决问题的可能性。在本文中，我们开发了一个简单模型来表明，在保持实验总数不变的情况下，由少数大规模实验者（即进行多项实验的企业）主导的市场，比拥有许多单次实验者的市场探索更多样化的方法。单次实验者倾向于集中在最有希望的方法上，而多次实验者更有可能进行多样化，以避免在同一方法内进行多项实验所固有的相关性。我们使用制药研发的数据来检验我们模型的预测。我们的分析表明，每个企业的平均实验数量增加一个单位，会使目标多样性提高超过三个标准差。反过来，目标多样性从均值增加一个标准差，会使至少一项实验进入一期临床试验的可能性提高25.9个百分点。我们的发现为如何在企业间最优分配实验以最大化方法多样性和市场层面成功的政策提供了信息。

【**NBER**】: NBER Working Paper No. 33682，https://www.nber.org/papers/w33682

#### 47. Putting Economics Back Into Geoeconomics {#33681}

【**Author**】: Christopher Clayton, Matteo Maggiori, Jesse Schreger

【**Abstract**】: Geoeconomics is the use of a country’s economic strength to exert influence on foreign entities to achieve geopolitical or economic goals. We discuss how concepts of power in the political science and economics literature can be used to guide research on geoeconomics. Economic threats as a form of coercion have seen a recent resurgence. We show how different types of threats can be modeled using simple tools and discuss what channels their potential effectiveness is based on. We discuss important open questions for the future literature to pursue.

【**摘要**】：地缘经济学是利用一个国家的经济实力对外国实体施加影响，以实现地缘政治或经济目标。我们讨论了政治科学和经济学文献中的权力概念如何用于指导地缘经济学研究。作为一种胁迫形式的经济威胁近期重新抬头。我们展示了如何使用简单工具对不同类型的威胁进行建模，并讨论了其潜在有效性所基于的渠道。我们讨论了未来文献需要研究的重要开放性问题。

【**NBER**】: NBER Working Paper No. 33681，https://www.nber.org/papers/w33681
...
【**摘要**】：我们研究了大学专业选择中的性别差异是否源于预期的劳动力市场歧视。首先，我们利用一所中西部大型大学的行政成绩单记录，记录了两个新的事实：女性学习科学、技术、工程和数学（STEM）以及商业和经济学的可能性较小，但1）那些选择这些专业的女性在能力上是正向选择的，并且2）在给定能力的情况下获得了更高的成绩。其次，我们表明这些事实与一个信号模型一致，在该模型中，女性预期在STEM、商业和经济学领域比在其他领域面临更大的劳动力市场歧视。第三，我们利用一项学生调查提供了预期歧视的直接经验证据。该调查揭示了女性预期歧视的显著模式，特别是在STEM、商业和经济学领域，这既影响了预期的经济结果（如工资），也影响了预期的工作场所条件。最后，我们表明预期歧视解释了女性的课程选择和意向专业选择，但不能解释男性的选择。

【**NBER**】: NBER Working Paper No. 33680，https://www.nber.org/papers/w33680

#### 49. Do Time-Constraints Matter? How, Why, and For Whom? {#33679}

【**Author**】: Kala Krishna, Pelin Akyol, Esma Ozer
...
【**摘要**】：考试旨在通过能力客观地对学生进行排名，其设计要素包括时间限制、题目数量和难度以及倒扣分政策。利用一项实验室实地实验的数据，我们构建并估计了一个包含时间限制影响的多项选择题考试中学生行为模型，并利用该模型进行政策分析，以设计能更有效区分学生的考试。我们发现，额外的时间对男性的益处大于女性。我们的估计模型表明，这是由于正确答案的信号生产函数存在性别差异。时间对女性的影响较小，而能力和难度则起着更大的作用。与文献中的观点相反，风险厌恶程度在性别上没有显著差异，并且自信心随着时间增加而增强。我们的政策实验发现，当排名按性别分别进行时，考试能更有效地对学生进行排序，并且时间压力、题目难度和学生能力对区分效果具有非单调的影响。

【**NBER**】: NBER Working Paper No. 33679，https://www.nber.org/papers/w33679

#### 50. Measuring Income and Income Inequality {#33678}

【**Author**】: Conor J. Clarke, Wojciech Kopczuk
...
【**摘要**】：收入不平等很重要，但衡量它的尝试得出了截然不同的结论。为什么？我们利用近期关于衡量美国收入不平等的争议，回归到关于收入概念和不平等衡量的基本原则。我们强调两个主要观点。首先，没有一种收入分配的衡量标准是真正全面的，或者试图做到全面而不做出有争议的选择。我们记录了标准理想——全面的黑格-西蒙斯收入——所引发的实际和概念性问题。其次，该领域的许多争议都源于从使用个人税收数据入手与试图匹配更广泛的收入概念之间的诸多权衡。个人税收数据仅反映了更全面收入概念中一个日益缩小的子集——但它是个人层面的数据。另一方面，更广泛的替代方案则更难分配给个人。我们记录了在分配国民收入时所需的一些最重要且最具争议的假设。

【**NBER**】: NBER Working Paper No. 33678，https://www.nber.org/papers/w33678

#### 51. Talk Therapy and Human Capital in Adolescence: Evidence from Nepal {#33677}

【**Author**】: Eric V. Edmonds, Priya Mukherjee, Nikhilesh Prakash, Nishith Prakash, Shwetlena Sabarwal
...
【**摘要**】：我们研究了一项随机化治疗干预对尼泊尔面临辍学风险的青少年的影响。我们的研究是同类研究中规模最大的（样本量 N = 1,707），其新颖之处在于参与并不需要预先存在的诊断。在提供治疗的人中，90% 参与了治疗，其中年龄较小的青少年表现出更高的依从性。在依从者中，治疗显著减轻了心理困扰，改善了情绪调节，并增强了生活视角，即使在基线没有心理健康问题的个体中也是如此。然而，这些幸福感的改善并未导致更高的出勤率或更好的认知表现，这表明在资源匮乏的环境中，可能需要额外的干预措施来增强教育参与度。

【**NBER**】: NBER Working Paper No. 33677，https://www.nber.org/papers/w33677

#### 52. The Economics of Encouragement: Can A Simple Email Shape Major Choice? {#33676}

【**Author**】: Olivia Edwards, Jonathan Meer
...
【**摘要**】：我们研究了向一所大型州立大学微观经济学原理课程中成绩优异的学生发送鼓励邮件的影响，这些邮件旨在激励他们选修更多经济学课程并考虑主修或辅修经济学。利用断点回归设计，我们发现一些证据表明，这增加了他们注册中级微观经济学的可能性，尤其是对于第一代大学生和代表性不足的少数族裔，但对转换专业或申报经济学辅修的影响有限。我们的研究结果表明，可能需要持续的干预才能产生持久的效果。

【**NBER**】: NBER Working Paper No. 33676，https://www.nber.org/papers/w33676

#### 53. Growing Awareness: Evaluating the Impact of Environmental Education on Attitudes, Knowledge, and Behavior {#33675}

【**Author**】: Jennifer Alix-García, Christopher R. Knittel
...
【**摘要**】：红树林提供重要的生态系统服务，如风暴潮防护和碳封存，但其覆盖面积正在迅速减少。本研究评估了多米尼加共和国的一项环境教育项目，该项目针对儿童对保护的态度、知识、行为和支付意愿。该项目提升了态度，尤其是在女孩中，但行为变化不大且不显著。对同伴和家长也存在积极的溢出效应，俱乐部中未接受干预的同伴表现出对红树林偏好的增加，家长的态度也发生了积极转变。

【**NBER**】: NBER Working Paper No. 33675，https://www.nber.org/papers/w33675

#### 54. The Risk Sensitivity of Global Liquidity Flows: Heterogeneity, Evolution and Drivers {#33674}

【**Author**】: Stefan Avdjiev, Leonardo Gambacorta, Linda S. Goldberg, Stefano Schiaffi
...
【**摘要**】：全球金融危机后的时期，全球流动性流动内部出现了显著的风险迁移，从跨境银行贷款转向国际债券发行。我们表明，全球金融危机后全球流动性流动风险敏感性的变化，与国际（银行和非银行）贷款人面临的资产负债表（资本和杠杆）约束的紧密度，以及借款人跨融资来源的迁移有关。我们证明，当资金由面临更大资产负债表约束的金融中介提供时，全球流动性流动的风险敏感性更高。我们还提供证据表明，全球金融危机后借款人从跨境贷款向国际债务证券的迁移，与新兴市场经济体借款人全球流动性流动风险敏感性的下降有关。

【**NBER**】: NBER Working Paper No. 33674，https://www.nber.org/papers/w33674

#### 55. Pension Reform and Labor Supply: Retention and Productivity under a Pension Cut {#33673}

【**Author**】: Andrew C. Johnston, Jonah E. Rockoff, James R. Harrington
...
【**摘要**】：我们研究了一项具有代表性的养老金改革对工人留任和生产率的影响。该改革削减了公立学校教师的养老金年金和提前退休福利，预计可节省8%的养老金收入。我们利用行政记录和改革中的断点来估计其影响。与预期相反，削减通过阻止提前退休提高了留任率。利用学校内部暴露程度的异质性，我们发现改革使学生的学业成绩提高了0.01-0.03个标准差，部分原因是人员流动减少。因此，该改革维持或提高了教师的留任率和生产率。

【**NBER**】: NBER Working Paper No. 33673，https://www.nber.org/papers/w33673

#### 56. Heterogeneous Beliefs, Asset Prices, and Business Cycles {#33672}

【**Author**】: Saki Bigio, Dejanir Silva, Eduardo Zilberman

【**Abstract**】: This paper develops a complete-market production economy with heterogeneous beliefs about TFP growth. Hiring occurs before TFP is known and is, therefore, risky (operational leverage). The firm's discount factor depends on a wealth-weighted average of investors' beliefs. Waves of optimism influence asset markets and percolate to labor hiring, tying together the equity premium, equity volatility, and labor volatility puzzles. A taxonomy of belief systems shows that only extrapolative beliefs amplify the volatility of asset prices and hours and lead to risk build up. Disciplined by survey data, the model matches asset-pricing and business-cycle moments, highlighting how heterogeneous beliefs can be a direct driver of aggregate fluctuations.

【**摘要**】：本文构建了一个具有关于全要素生产率增长异质性信念的完全市场生产经济。雇佣发生在全要素生产率已知之前，因此是有风险的（经营杠杆）。企业的贴现因子取决于投资者信念的财富加权平均值。乐观情绪浪潮影响资产市场并渗透到劳动力雇佣中，将股权溢价、股权波动率和劳动力波动率之谜联系在一起。对信念体系的分类表明，只有外推性信念会放大资产价格和工作时间的波动性，并导致风险积累。在调查数据的约束下，该模型匹配了资产定价和经济周期的矩，突显了异质性信念如何成为总量波动的直接驱动因素。

【**NBER**】: NBER Working Paper No. 33672，https://www.nber.org/papers/w33672
...
【**摘要**】：我的研究表明，世界不平等是由榨取性制度和包容性制度的发生率来解释的。但为什么有些国家会采用榨取性制度？我区分了两个主要原因：第一，权力关系；第二，“规范秩序”。规范秩序为那些可能无法带来繁荣但可能实现其他目标的制度提供了正当性和合法性。这些区分至关重要，因为它们为试图使制度更具包容性并创造繁荣带来了截然不同的挑战。我展示了国家如何通过同时改变这两者而从经济边缘地带崛起。然而，我个人的学术旅程却是朝着相反方向进行的，因此有了本文的标题：我有幸出生在英国，但我不得不摒弃自己大量的经验、社会化和训练，以便能够从其他社会自身的角度去理解它们。这对于能够帮助它们，同时也向它们学习至关重要。

【**NBER**】: NBER Working Paper No. 33671，https://www.nber.org/papers/w33671

#### 58. Training within Firms {#33670}

【**Author**】: Brayan S. Diaz, Andrea Neyra Nazarrett, Julian Ramirez, Raffaella Sadun, Jorge A. Tamayo
...
【**摘要**】：培训投资对于提高工人和企业的生产力至关重要，然而其实施常常因参与率低和员工投入不足而受阻。本研究使用了来自三家公司（一家汽车制造商、一家快餐连锁店和一家零售公司）的数据，表明员工培训参与度的差异与中层管理者的行为和实践差异密切相关。那些积极与员工互动并重视其福祉和发展的中层管理者，与显著更高的培训项目参与率相关联。这些管理上的差异显著影响了员工的绩效和缺勤率，尤其是在组织变革时期。总之，这些发现强调了中层管理者在弥合中央设计的人力资源政策与其有效实地执行之间差距的重要性。

【**NBER**】: NBER Working Paper No. 33670，https://www.nber.org/papers/w33670

#### 59. How Good is AI at Twisting Arms? Experiments in Debt Collection {#33669}

【**Author**】: James J. Choi, Dong Huang, Zhishu Yang, Qi Zhang
...
【**摘要**】：人工智能在说服人类执行有成本的行为方面有多擅长？我们研究了旨在让拖欠贷款的消费者借款人还款的电话催收。断点回归和一项随机实验表明，人工智能的效果远不如人工催收员。在逾期六天后用人工催收员取代人工智能，可以缩小大部分差距。但与始终由人工催收员联系的借款人相比，最初由人工智能联系的借款人在一年后偿还的初始逾期款项少了1%，并且更有可能错过后续还款。人工智能在提取具有约束力感觉的承诺方面能力较弱，这可能是造成绩效差距的原因之一。

【**NBER**】: NBER Working Paper No. 33669，https://www.nber.org/papers/w33669
...
【**摘要**】：怀疑投标人合谋的拍卖方往往缺乏法律追索所需的正式证据。一个实用的替代方案是设计阻碍合谋的拍卖。自Abreu等人（1986）以来，经济理论一直强调不完美监督是对合谋的一种约束，但关于以下两点的证据仍然稀缺：（i）信息摩擦是否切实限制了现实世界中的合谋；（ii）拍卖方能否有效利用这些摩擦。事实上，透明度方面的担忧阻止了在拍卖设计中引入明确的随机性。我们通过研究日本国土交通省运营的拍卖中主观评分的影响，在这一问题上取得了进展。采用评分拍卖显著降低了中标价格，其方式与竞争不一致。基于模型的推断表明，卡特尔的动态服从约束是有效的，并且因不完美监督而收紧。主观评分可以成功地利用不完美监督的摩擦来减少合谋的范围。

【**NBER**】: NBER Working Paper No. 33668，https://www.nber.org/papers/w33668

#### 61. The Political Consequences of Controversial Education Reform: Lessons from Wisconsin’s Act 10 {#33666}

【**Author**】: Barbara Biasi, Wayne Aaron Sandholtz
...
【**摘要**】：公共服务改革常常引发政治反弹。它们能否也为倡导改革的政客带来政治利益？我们研究了一项威斯康星州的法律，该法律削弱了教师工会并放开了薪酬，引发了大规模抗议。利用该法律在各学区分阶段实施的特点，我们发现这项改革削减了工会收入，提高了学生考试成绩，并增加了部分教师的薪酬。接触该法律使现任州长的得票率增加了约其胜选差额的20%，并减少了对其对手的竞选捐款。在工会原先实力更强的学区和更多选民从改革中受益的学区，收益更大。我们的发现突显了即使在政治上有风险的改革，在适当条件下也能产生选举收益。

【**NBER**】: NBER Working Paper No. 33666，https://www.nber.org/papers/w33666
...
【**摘要**】：本文比较了真实价格指数中的通胀与固定权重价格指数中的通胀。我们在时间依赖定价模型中构建了基于模型的通胀衡量指标，这些指标类似于数据中的通胀衡量指标，例如消费者价格指数。在标准的新凯恩斯模型中，当通胀快速上升时，这些指数与真实价格指数之间的通胀差异会随着价格粘性程度和商品间替代弹性的增加而增大。对于常用的参数值，对于美国2020年后出现的通胀上升幅度，这些差异是巨大且持久的。

【**NBER**】: NBER Working Paper No. 33665，https://www.nber.org/papers/w33665

#### 63. Taxes on Lifetime Income: A Good Idea? {#33664}

【**Author**】: Dirk Krueger, Chunzan Wu
...
【**摘要**】：在标准的生命周期模型中，家庭消费和福利更强烈地依赖于终生收入，但大多数国家基于当前收入征收所得税，并使用累进税来减少不平等和提供社会保险。对于寻求提供此类社会保险和再分配的政府而言，终生收入是更好的税基吗？为了回答这个问题，我们构建了一个包含异质性家庭、具有特质性工资风险和内生劳动供给的定量生命周期模型，并将其校准到美国经济。我们证明，转向终生收入税会导致工作时间在时间维度和不同世界状态下更有效的分配。在终生收入税下，这种收益随着税收累进性的提高而增加，而在年度收入税下则相反。因此，最优的终生收入税比最优的年度收入税更具累进性，并且能为一代家庭实现更大的事前福利。

【**NBER**】: NBER Working Paper No. 33664，https://www.nber.org/papers/w33664
...
【**摘要**】：我们证明，常见稀疏线性因子的高阶项及其交互项可以有效地囊括因子动物园。我们提出了一种前向选择Fama-MacBeth程序，作为估计高维随机贴现因子模型的方法，以分离出最相关的高阶因子。将这种方法应用于从六个广泛使用的因子（Fama-French五因子模型和动量因子）推导出的项，我们表明，仅包含少量选定高阶项的结果高阶模型在样本内和样本外均显著优于传统基准模型。此外，它有效地囊括了来自广泛因子动物园中的大多数因子，这表明大多数动物园因子的定价能力可归因于它们对常见线性因子高阶项的暴露。

【**NBER**】: NBER Working Paper No. 33663，https://www.nber.org/papers/w33663

#### 65. Measuring Human Leadership Skills with AI Agents {#33662}

【**Author**】: Ben Weidmann, Yixian Xu, David J. Deming
...
【**摘要**】：我们展示了，与人工智能（AI）代理合作时的领导技能能够预测与人类群体合作时的领导技能。在一个预先注册的大型实验室实验中，人类领导者与AI代理一起解决问题。他们在这一“AI领导力测试”中的表现，与他们作为人类团队领导者所产生的因果影响高度相关（ρ=0.81），我们通过反复将领导者随机分配到人类追随者小组并衡量团队绩效来估计这种因果影响。无论是人类还是AI代理的成功领导者，都会提出更多问题，并进行更多的对话轮换；他们在社会智力、流体智力和决策技能方面的得分更高，但在性别、年龄、种族或教育程度上没有差异。我们的研究结果表明，AI代理可以成为社会实验中人类参与者的有效替代品，这极大地简化了领导力和团队合作技能的衡量。

【**NBER**】: NBER Working Paper No. 33662，https://www.nber.org/papers/w33662
...
【**摘要**】：本文在一个存在信贷摩擦的两部门内生增长经济体中，分析了由抵押品价值上升或低利率政策引发的信贷扩张对长期生产率和经济增长的影响，其中增长的驱动力位于一个部门（制造业）而非另一个部门（房地产）。我们表明，对长期生产率和经济增长而言，重要的并非总信贷扩张，而是部门信贷扩张。主要与房地产融资（资本投资融资）放松相关的信贷扩张将阻碍（促进）生产率和增长。在没有金融监管的情况下，低利率和更具扩张性的货币政策可能会过度鼓励利用杠杆进行土地投机，从而减少生产性资本投资和经济增长。与标准宏观经济模型不同，在我们的模型中，即使安全利率低于产出增长率，土地的均衡价格也是有限的。

【**NBER**】: NBER Working Paper No. 33661，https://www.nber.org/papers/w33661

#### 67. Voluntary Report of Standardized Test Scores: An Experimental Study {#33660}

【**Author**】: Marty Haoyuan Chen, Ginger Zhe Jin
...
【**摘要**】：过去几年，许多大学的招生政策已从要求考试成绩转变为考试可选或考试盲审。本文通过实验室实验，考察了学生根据其申请材料以及学校对未报告标准化考试成绩的解释所做出的报告行为。我们发现，自愿披露是不完全且具有选择性的，这既支持了部分解开的激励（分数较高的学生更有可能报告），也支持了反向解开的激励（面对学校对未报告行为更有利解释的学生报告的可能性更低）。受试者表现出一定的学习能力来了解隐藏的学校解释，尽管他们的学习并不完美。利用学生报告行为的结构模型，我们模拟了学校招生群体中学术准备与多样性之间的潜在权衡。我们发现，如果学生对学校关于未报告行为的解释拥有完全信息，那么考试盲审在两个维度上都是最差的，而要求考试成绩在两个维度上都是最好的，考试可选则介于这两个极端之间。当学生没有完全信息时，一些考试可选政策可以比要求考试政策产生更多的多样性，因为一些具有更好可观察属性的学生可能低估了对其未报告行为的惩罚。这使得学校能够录取更多可观察属性较差但报告了标准化考试成绩的学生。该结果在多种扩展情况下都是稳健的，包括当学校可以获得其他学术能力信号，且标准化考试成绩是衡量学生能力的一个有噪声但信息量足够充分的指标时。

【**NBER**】: NBER Working Paper No. 33660，https://www.nber.org/papers/w33660

#### 68. The Effects of Eviction on Children {#33659}

【**Author**】: Robert Collinson, Deniz Dutz, John Eric Humphries, Nicholas S. Mader, Daniel Tannenbaum, Winnie van Dijk
...
【**摘要**】：驱逐可能是贫困代际传递的一个重要渠道，其对儿童影响的担忧常被作为租户保护政策的理由。我们通过将芝加哥和纽约的驱逐法庭记录与行政公立学校记录及受限人口普查记录相关联，构建了新的数据集，研究了驱逐如何影响儿童的家庭环境、学校参与度、学业成就和高中毕业。为了将驱逐的后果与相关经济困境来源的影响区分开来，我们采用了一种基于案件随机分配给不同宽严程度法官的研究设计。我们发现，驱逐增加了儿童的居住流动性、无家可归的可能性以及与祖父母或其他成年人合住的概率。驱逐还扰乱了学校参与度，导致缺勤增加和转学。虽然我们发现对小学和初中考试成绩影响不大，但驱逐显著减少了高中课程学分。最后，我们发现驱逐降低了高中毕业率，并使用一种新的边界方法表明，这一发现并非由差异性流失驱动。驱逐的破坏性影响对年龄较大的儿童和男孩似乎更严重。我们的证据表明，驱逐对儿童的影响是通过对家庭环境或学校参与度的破坏，而非学校或社区质量的恶化来传导的，并且可能受到家庭支持网络可及性的调节。

【**NBER**】: NBER Working Paper No. 33659，https://www.nber.org/papers/w33659

#### 69. Information-Concealing Credit Architecture {#33658}

【**Author**】: Gary B. Gorton, Ye Li, Guillermo Ordoñez
...
【**摘要**】：当可质押资产（或项目）的价值不确定时，投资者有动机去检查它。信息成本最终由资产所有者承担，从而减少了她的融资能力。一种融资优序理论由此产生。债务比股权产生更大的融资能力：与直接拥有资产的股权投资者不同，债权人仅在借款人违约时才拥有资产，因此，他们有更弱的动机去获取信息。通过在借款人和债权人之间引入中介机构，这种概率性的资产所有权可以进一步被稀释，从而产生了一种关于金融中介和信贷链的新理论。我们证明了，最优的金融架构涉及系统地安排多个具有异质性信息成本和资产相关性的中介机构，这为看似过度复杂的间接信贷流动提供了合理解释。

【**NBER**】: NBER Working Paper No. 33658，https://www.nber.org/papers/w33658

#### 70. Leaving Money on the Table {#33657}

【**Author**】: Mackenzie Alston, Tatyana Deryugina, Olga Shurchkov
...
【**摘要**】：来自住房和城市发展部的数据显示，2022年至2024年间，美国居住在无家可归者收容所的人数前所未有地增加了43%，扭转了此前十六年逐步下降的趋势。这一增长的75%集中在四个地区——纽约市、芝加哥、马萨诸塞州和丹佛——在这些地方，大量寻求庇护的新移民涌入并被安置在紧急收容所。利用来自地方政府来源的直接估计和基于人口变化的间接方法，我们估计在此期间，寻求庇护者约占收容所无家可归者两年增长量的60%，这挑战了主要将此增长归因于当地经济状况和住房可负担性的媒体和政策叙事。

【**NBER**】: NBER Working Paper No. 33655，https://www.nber.org/papers/w33655

#### 73. Failures of Contingent Reasoning in Annuitization Decisions {#33654}

【**Author**】: Erzo F.P. Luttmer, Priscila de Oliveira, Dmitry Taubinsky
...
【**摘要**】：本文通过一项基于概率样本（N = 3,038）的激励实验，研究了年金购买中的心理偏差。在实验中，选择年金在所有价格下都是收益最大化的，但购买率并不完全且具有价格弹性。将决策重新表述为针对“坏”结果的保险而非针对“长寿风险”的保险，并未提高购买率。相反，我们发现了严重的条件推理失败：参与者低估了年金化如何减轻对效率较低的退休储蓄方式的需求。提高与储蓄决策互动的显著性，或者完全消除思考这种互动的必要性，显著提高了年金的购买率。

【**NBER**】: NBER Working Paper No. 33654，https://www.nber.org/papers/w33654

#### 74. Sorting to Expensive Cities {#33652}

【**Author**】: Cécile Gaubert, Frédéric Robert-Nicoud
...
【**摘要**】：我们提出了一个空间均衡模型，其中包含对可贸易商品和住房持有一般非位似偏好的异质性家庭。在均衡状态下，理想且生产力高的地点会推高住房价格。只要住房是必需品，这些地点就会不成比例地被高收入者占据，他们受高房价的影响相对较小。我们阐明了这种分选来源如何与空间均衡模型中的其他潜在分选力量（即生产中的比较优势和对地点的异质性偏好）相互补充。我们展示了当住房是必需品时，如何以理论一致的方式衡量不同收入群体间福利不平等的变化，从而扩展了在位似偏好模型中流行的做法。我们利用我们的框架追踪了1980年至2020年间美国大学毕业生与非大学毕业生之间福利不平等的演变。我们发现，考虑到价格变化，福利不平等的上升幅度超过了名义工资不平等，即使在此期间大学毕业生越来越多地分选到住房昂贵的城市。

【**NBER**】: NBER Working Paper No. 33652，https://www.nber.org/papers/w33652

#### 75. Asset Embeddings {#33651}

【**Author**】: Xavier Gabaix, Ralph S. J. Koijen, Robert J. Richmond, Motohiro Yogo
...
【**摘要**】：基于会计和金融市场数据的公司特征，通常被用来在经济学和金融学中代表公司。然而，投资者集体使用的信息集远比公司特征丰富得多，包括研究人员不易获得的信息来源。我们从理论上证明，投资组合持有量包含了所有与资产定价相关的信息，这些信息可以在经验上现实的条件下被恢复。对于其他数据来源，如会计或文本数据，则不存在这样的保证。我们借鉴了人工智能和机器学习的最新进展，这些进展通过称为嵌入的高维潜在向量来表示非结构化数据（例如文本、音频和图像）。正如词嵌入利用文档结构来表示单词一样，资产嵌入利用投资组合持有量来表示公司。因此，本文是连接人工智能和机器学习最新进展与经济学和金融学的桥梁。我们探索了估计资产嵌入的各种方法，包括推荐系统、浅层神经网络模型（如Word2Vec）和Transformer模型（如BERT）。我们在三个可以使用单个季度数据评估的基准上评估了这些模型的性能：预测相对估值、解释股票收益的联动性以及预测机构投资组合决策。我们还估计了投资者嵌入（即投资者及其策略的表示），这对于投资者分类、绩效评估和检测拥挤交易非常有用。我们讨论了资产嵌入的其他应用，包括生成式投资组合、风险管理和压力测试。最后，我们开发了一个框架，通过将大型语言模型应用于公司层面的文本数据，为一组相似的公司提供经济叙事。

【**NBER**】: NBER Working Paper No. 33651，https://www.nber.org/papers/w33651

#### 76. AI as Strategist {#33650}

【**Author**】: Joshua S. Gans

【**Abstract**】: Can artificial intelligence (AI) function as an organisational strategist? This paper adapts the formal theory of strategy developed by van den Steen (2017, 2018a) to a two-decision framework in which the strategist may be either human or AI. The model distinguishes two channels through which strategy creates value: an expertise effect, which improves the stand-alone quality of key decisions, and a coordination effect, which aligns interdependent choices through influence or control. We compare human and AI strategists along two primitives— confidence (belief accuracy) and agreement (shared judgment)—and show how these shape the effectiveness of authority and persuasion. Our analysis reveals that credibility substitutes for control: as agreement with the strategist increases, the value of formal authority diminishes. Transparent AIs, which generate higher credibility through architectural selection, can guide effectively through influence, while opaque AIs require formal control to realise their expertise advantage. These findings highlight how AI transparency serves as a substitute for authority, yielding design implications for domain-contingent authority and progressive delegation in human–AI collaboration.

【**摘要**】：人工智能能否充当组织战略家？本文将van den Steen（2017, 2018a）发展的战略形式理论适配到一个双决策框架中，其中战略家可以是人类或人工智能。该模型区分了战略创造价值的两个渠道：专业知识效应，它提高了关键决策的独立质量；以及协调效应，它通过影响或控制来调整相互依赖的选择。我们沿着两个原始维度——信心（信念准确性）和一致性（共同判断）——比较人类和人工智能战略家，并展示这些因素如何塑造权威和说服的有效性。我们的分析揭示，可信度可以替代控制：随着与战略家一致性的增加，正式权威的价值会降低。透明的AI通过架构选择产生更高的可信度，可以通过影响有效地进行指导，而不透明的AI则需要正式控制来实现其专业知识优势。这些发现凸显了AI透明度如何作为权威的替代品，为人类与AI协作中的领域权变授权和渐进式授权提供了设计启示。

【**NBER**】: NBER Working Paper No. 33650，https://www.nber.org/papers/w33650

#### 77. The Memory Premium {#33649}

【**Author**】: Yuval Salant, Jorg L. Spenkuch, David Almog

【**Abstract**】: We explore the role of memory for choice behavior in unfamiliar environments. Drawing on a unique data set, we document that decision-makers exhibit a “memory premium.” They tend to choose in-memory alternatives over out-of-memory ones, even when the latter are objectively better. Consistent with well-established regularities regarding the inner workings of human memory, the memory premium is associative, subject to interference and repetition effects, and decays over time. Evidence from a laboratory experiment implies that the memory premium arises because individuals rely on their memory to identify alternatives that warrant careful consideration, albeit in a boundedly rational way.

【**摘要**】：我们探讨了记忆在不熟悉环境中的选择行为中的作用。利用一个独特的数据集，我们记录了决策者表现出一种“记忆溢价”。他们倾向于选择记忆中的选项而非记忆之外的选项，即使后者客观上更好。与关于人类记忆内部运作的既定规律一致，记忆溢价是联想性的，受到干扰和重复效应的影响，并且会随时间衰减。来自实验室实验的证据表明，记忆溢价之所以出现，是因为个体依赖他们的记忆来识别值得仔细考虑的选项，尽管是以一种有限理性的方式。

【**NBER**】: NBER Working Paper No. 33649，https://www.nber.org/papers/w33649

#### 78. Moral Hazard under Liquidity Constraints {#33648}

【**Author**】: Keith Marzilli Ericson, Johannes G. Jaspersen, Justin R. Sydnor

【**Abstract**】: Spending induced by health insurance is often called moral hazard and assumed to be inefficient. We adapt standard models and show that for those living “hand-to-mouth”, the financing benefits of insurance cause a portion of moral hazard to be efficient. Although insurance’s price distortions also create some inefficient spending, the net welfare impacts of moral hazard can be positive. We present an intuitive graphical framework and formal results to distinguish moral hazard’s efficient and inefficient components. Simulations show economically significant net benefits of moral hazard in many cases for those with liquidity constraints. Our framework also provides a new way of modeling the “income effect” induced by insurance, and distinguishes it from the “liquidity effect”. While both can lead to efficient moral hazard, moral-hazard benefits from the “liquidity effect” are often substantially larger. We use our framework to revisit prior estimates of Medicaid’s value from the Oregon Health Insurance Experiment. Individuals with minimal liquidity value Medicaid more than twice as much as unconstrained individuals do, and their value exceeds the net cost of providing Medicaid by more than $\$1,$ 000 per year, driven largely by a significant positive net welfare value of moral hazard. Finally, we provide simulations showing how liquidity constraints can change estimates of the optimal level of insurance and the value of insurance menus with vertical choice.

【**摘要**】：由健康保险引发的支出通常被称为道德风险，并被假定为低效的。我们调整了标准模型，并表明对于那些“手口相济”生活的人来说，保险的融资收益导致一部分道德风险是有效的。尽管保险的价格扭曲也造成了一些低效支出，但道德风险的净福利影响可能是正的。我们提出了一个直观的图形框架和正式结果，以区分道德风险的有效和无效组成部分。模拟显示，在许多情况下，对于面临流动性约束的人来说，道德风险具有经济上显著的净收益。我们的框架还提供了一种模拟保险引发的“收入效应”的新方法，并将其与“流动性效应”区分开来。虽然两者都可能导致有效的道德风险，但来自“流动性效应”的道德风险收益通常要大得多。我们利用我们的框架重新审视了俄勒冈健康保险实验中关于医疗补助价值的先前估计。流动性极低的个体对医疗补助的估值是未受约束个体的两倍多，并且他们的估值超过提供医疗补助的净成本每年1000多美元，这主要是由道德风险显著的正净福利价值驱动的。最后，我们提供了模拟，展示了流动性约束如何改变对最优保险水平以及具有垂直选择的保险菜单价值的估计。

【**NBER**】: NBER Working Paper No. 33648，https://www.nber.org/papers/w33648

#### 79. Global Spillovers of Climate Policy Shocks {#33647}

【**Author**】: Julian di Giovanni, Galina Hale, Neel Lahiri, Anirban Sanyal
...
【**摘要**】：气候变化政策采纳缓慢源于对其经济影响的担忧。欧盟通过其排放交易体系引领了全球碳定价。本研究使用线性和空间自回归模型，在国家-行业层面考察了排放交易体系政策冲击对全球股票市场回报的影响。结果显示，尽管市场对碳价上涨反应消极，但影响幅度很小。全球溢出效应仅限于通过与欧盟行业进行中间品贸易相关联的行业，在这些供应链联系之外没有显著影响。总体而言，欧盟气候政策的意外后果似乎可以忽略不计，对目标行业股票回报的影响极小，并且在供应链联系之外没有溢出效应。

【**NBER**】: NBER Working Paper No. 33647，https://www.nber.org/papers/w33647

#### 80. Estimating the Footprint of Artisanal Mining in Africa {#33646}

【**Author**】: Darin Christensen, Tamma Carleton, Esther Rolf, Cullen Molitor, Shopnavo Biswas, Karena Yan, Graeme Blair
...
【**摘要**】：手工和小规模采矿提供了生计和关键矿物，但也与冲突和环境退化有关。我们通过使用整合地理特征和卫星图像的机器学习模型，创建了非洲手工和小规模采矿足迹的高分辨率地图，从而能够监测这一很大程度上非正规的部门。我们发现手工和小规模采矿比记录的范围更广：在五个进行过实地调查的国家，我们预测超过231,000个1平方公里网格单元[±2个标准误：170,153-297,710]包含手工和小规模采矿活动——是调查人员记录数量的40多倍。通过采用空间域自适应方法，我们在总共20个国家绘制了手工和小规模采矿地图，估计4%[2-8%]的领土和17%[10-30%]的人口受到手工和小规模采矿的影响，其对定居点和生态系统的侵占程度比之前理解的要大。

【**NBER**】: NBER Working Paper No. 33646，https://www.nber.org/papers/w33646

#### 81. The Conflict-of-Interest Discount in the Marketplace of Ideas {#33645}

【**Author**】: John M. Barrios, Filippo Lancieri, Joshua Levy, Shashank Singh, Tommaso Valletti, Luigi Zingales
...
【**摘要**】：我们研究了利益冲突（CoI）——定义为作者持有的财务、专业或意识形态利益——如何影响经济学研究的感知可信度。通过对经济学家和美国公众代表性样本进行随机对照调查，我们发现，利益冲突的存在平均使人们对论文研究结果的信任度降低28%，且不同冲突类型之间存在显著的异质性。我们建立了一个模型，其中这种信任度的降低既反映了存在利益冲突的论文的普遍性，也反映了在存在冲突条件下预期的偏差。为了分离出后者，我们引入了“利益冲突折扣”：一篇存在利益冲突的论文相对于另一篇其他方面相同但无利益冲突的论文的感知价值。我们估计平均利益冲突折扣为39%，这意味着存在利益冲突的论文的价值仅为无利益冲突论文的61%。我们通过三个互补性验证来证实这些基于调查的估计：对经济学中实际引用和披露模式的实证分析、对医学文献证据的元分析，以及使用大型语言模型进行的模拟。我们的研究结果突显了一个持续的信任差距，该差距并未被当前的披露实践所消除，并表明在作者存在利益冲突的情况下，科学信任面临更广泛的挑战。

【**NBER**】: NBER Working Paper No. 33645，https://www.nber.org/papers/w33645

#### 82. The Effects of Deleting Medical Debt from Consumer Credit Reports {#33644}

【**Author**】: Victor Duarte, Julia Fonseca, Divij Kohli, Julian Reif
...
【**摘要**】：七分之一的美国人背负医疗债务，消费者信用报告中报告的医疗债务总额达880亿美元。2023年4月，三大信用报告机构停止报告低于500美元的医疗债务。我们研究了这一信息删除对消费者信用评分、信用额度及使用率、还款行为以及发薪日借贷的影响。使用机器学习模型，我们表明小额医疗债务对违约的预测能力并不显著，这表明删除这些债务对贷款决策的影响应该微乎其微。我们使用两种互补的研究设计来检验这一预测。首先，一项比较500美元阈值上下个体的断点回归分析发现，信息删除并未带来直接益处，排除了信贷准入方面的微小变化。其次，为了评估间接影响，我们根据债务被删除时其预测违约概率是增加还是减少对消费者进行分类。比较这些群体在2023年政策变化前后的双重差分分析显示，没有证据表明存在负面溢出效应。最后，我们表明，较大的医疗债务（≥500美元）对违约的预测能力同样不显著，这表明，正如消费者金融保护局2025年1月决定所计划的那样，将医疗债务完全从信用报告中删除，不太可能影响信贷结果。

【**NBER**】: NBER Working Paper No. 33644，https://www.nber.org/papers/w33644
...
【**摘要**】：本章回顾了对工作场所非工资福利的分析。竞争模型是出发点，但重点在于具有更大经验相关性的不完全竞争模型。除了用于估计对工作特征偏好的传统享乐模型外，我还回顾了在偏离完全竞争时更适用的显示性偏好方法。

【**NBER**】: NBER Working Paper No. 33643，https://www.nber.org/papers/w33643

#### 84. Non-User Utility and Market Power: The Case of Smartphones {#33642}

【**Author**】: Leonardo Bursztyn, Rafael Jiménez-Durán, Aaron Leonard, Filip Milojević, Christopher Roth
...
【**摘要**】：企业不仅可以通过提高用户效用，还可以通过降低非用户效用来增加对其产品的需求并巩固其市场势力。在本文中，我们通过考虑智能手机的案例来研究这一机制。具体而言，苹果公司因涉嫌降低安卓用户体验而受到批评，其做法是让发送给安卓设备的信息在iPhone上显示为绿色气泡——这是一个显著的信号，通常被认为反映了较低的社会经济地位。通过对美国大学生样本的研究，我们表明绿色气泡被广泛污名化，并且大多数iPhone和安卓用户都希望绿色气泡不再存在。随后，我们进行了一项激励性的停用实验，揭示出iPhone用户有显著的支付意愿，以防止他们的信息在其他iPhone上显示为绿色气泡。接下来，我们考察了非用户效用的市场影响，发现当绿色气泡被移除时，受访者选择安卓而非iPhone的可能性显著增加。最后，我们通过案例研究来说明企业如何利用产品功能来降低各种市场中的非用户效用。

【**NBER**】: NBER Working Paper No. 33642，https://www.nber.org/papers/w33642

#### 85. The Cybernetic Teammate: A Field Experiment on Generative AI Reshaping Teamwork and Expertise {#33641}

【**Author**】: Fabrizio Dell'Acqua, Charles Ayoubi, Hila Lifshitz, Raffaella Sadun, Ethan Mollick, Lilach Mollick, Yi Han, Jeff Goldman, Hari Nair, Stewart Taub, Karim Lakhani
...
【**摘要**】：我们通过一项在宝洁公司（一家全球性消费品公司）与776名专业人士进行的预先注册的实地实验，考察了人工智能如何改变协作的核心支柱——绩效、专业知识共享和社交参与。在应对真实的产品创新挑战时，专业人士被随机分配为与人工智能合作或不合作，以及单独工作或与另一位专业人士在新产品开发团队中工作。我们的研究结果表明，人工智能显著提升了绩效：配备人工智能的个人达到了没有人工智能的团队的水平，这表明人工智能可以有效地复制人类协作的某些益处。此外，人工智能打破了职能壁垒。在没有人工智能的情况下，研发专业人士倾向于提出更多技术性解决方案，而商业专业人士则倾向于提出商业导向的提案。使用人工智能的专业人士，无论其专业背景如何，都产生了平衡的解决方案。最后，人工智能基于语言的界面引发了参与者更积极的自我报告情绪反应，这表明它可以部分履行传统上由人类队友提供的社会和激励角色。我们的结果表明，在知识工作中大规模采用人工智能不仅重塑了绩效，还重塑了专业知识和社交联系在团队中的体现方式，迫使组织重新思考协作工作的基本结构。

【**NBER**】: NBER Working Paper No. 33641，https://www.nber.org/papers/w33641

#### 86. The Tokenomics of Staking {#33640}

【**Author**】: Lin William Cong, Zhiheng He, Ke Tang
...
【**摘要**】：代币在数字网络中提供便利，并在为共识生成或经济活动进行质押时获得奖励。在我们的连续时间模型中，代理人动态地将财富分配于平台内交易和质押。总质押比率关键性地塑造了平台生产力，增长了用户基础，并将质押与内生奖励率和价格动态联系起来。交易费用、代币发行和用户异质性都影响着平台生命周期。实证发现支持理论预测：(i) 质押比率与奖励率之间的相关性在横截面上为正，但在时间序列上为负；(ii) 质押比率正向预测超额收益；(iii) 便利楔子导致了无抛补利率平价的违反和显著的加密货币利差溢价。

【**NBER**】: NBER Working Paper No. 33640，https://www.nber.org/papers/w33640

#### 87. Financial and Informational Integration Through Oracle Networks {#33639}

【**Author**】: Lin William Cong, Eswar S. Prasad, Daniel Rabetti
...
【**摘要**】：预言机是软件组件，能够实现孤立的区块链与外部环境之间的数据交换，增强智能合约能力和平台互操作性。预言机在去中心化金融和中心化金融的区块链应用中扮演关键角色。我们发现，接入去中心化预言机网络与总锁仓价值等关键经济活动指标呈正相关，这是由采用和使用中的正网络效应触发的。我们的研究揭示了在特定链上的协议之间以及集成链之间，增强互操作性和网络效应所带来的共生收益。预言机集成似乎改善了风险分担并减轻了传染效应，在加密货币市场的动荡时期增强了韧性。总体而言，预言机成为在去中心化金融生态系统中实现信息和经济整合的关键组成部分。

【**NBER**】: NBER Working Paper No. 33639，https://www.nber.org/papers/w33639

#### 88. The Bullwhip: Time-to-Build and Sectoral Fluctuations {#33638}

【**Author**】: Yan Leng, Ernest Liu, Yifei Ren, Aleh Tsyvinski

【**Abstract**】: We develop a theory of sectoral fluctuations driven by the propagation of demand shocks along supply chains with heterogeneous time-to-build production. We solve the model in closed form. Downstream producers respond directly to current demand. Upstream producers, due to time-to-build delays, respond to anticipated future demand. Consequently, hump-shaped demand shocks to downstream goods propagate and amplify along the supply chain, generating pronounced volatility in upstream sectors and creating the bullwhip effect. Empirically and quantitatively, we show that the bullwhip is significant across downstream sectors that are important for final consumption.

【**摘要**】：我们发展了一个行业波动理论，该理论由需求冲击沿着具有异质性建设周期生产的供应链传播所驱动。我们以闭式解形式求解了模型。下游生产商直接对当前需求做出反应。上游生产商由于建设周期的延迟，则对未来预期需求做出反应。因此，对下游商品的驼峰形需求冲击沿着供应链传播并放大，在上游行业产生显著的波动性，并创造了牛鞭效应。在实证和定量上，我们表明，对于最终消费重要的下游行业，牛鞭效应是显著的。

【**NBER**】: NBER Working Paper No. 33638，https://www.nber.org/papers/w33638

#### 89. Interim Valuations, Predictability, and Outcomes in Private Equity {#33637}

【**Author**】: Ege Y. Ercan, Steven N. Kaplan, Ilya A. Strebulaev
...
【**摘要**】：利用一个关于美国并购和风险投资的新数据集，我们研究了基金管理人关于投资组合公司的中期估值报告对最终结果的信息含量。我们发现，当投资者评估单个投资组合公司的业绩时，他们可以做得比仅仅依赖最近报告的估值更好。报告估值的过往历史也具有信息量。过去估值更陈旧或更频繁减记的投资，其未来表现往往比其他投资更差。我们还发现，投资退出的时机是可预测的。此外，结合中期已实现和未实现回报、过去估值陈旧度和过去减记频率的知识，可以帮助预测一项投资最终会落在所有投资的左尾还是右尾。这些预测在投资的第一年就具有信息量。

【**NBER**】: NBER Working Paper No. 33637，https://www.nber.org/papers/w33637

#### 90. Firm Selection and Growth in Carbon Offset Markets: Evidence from the Clean Development Mechanism {#33636}

【**Author**】: Qiaoyi Chen, Nicholas Ryan, Daniel Xu
...
【**摘要**】：我们研究了中国企业在清洁发展机制（CDM）下出售的碳抵消。我们发现，本应削减碳排放的抵消出售企业，在启动抵消项目后，其碳排放反而增加了49%。在一个关于企业投资决策和抵消审查的模型中，我们估计CDM企业排放增加的原因既包括高增长企业被选择进入项目（35个百分点），也包括抵消项目本身促进了企业增长，从而增加了排放（14个百分点）。CDM因导致排放增加所造成的损害，是抵消市场贸易私人收益的四倍，从而减少了全球总剩余。

【**NBER**】: NBER Working Paper No. 33636，https://www.nber.org/papers/w33636

#### 91. Instrumental Variables Methods Reveal Larger Effects of Menopausal Hormone Therapy in the Landmark Women’s Health Initiative Clinical Trial {#33635}

【**Author**】: Joshua Angrist, Amanda E. Kowalski, Ljubica Ristovska, Marcia L. Stefanick
...
【**摘要**】：来自妇女健康倡议试验的标志性结果显示，随机分配接受绝经期激素治疗（MHT）会增加乳腺癌及其他不良事件的风险。近期的分析认为MHT风险很小。这些分析报告了意向治疗（ITT）效应，但忽略了以下事实：许多被分配至干预组的女性并未依从治疗，而许多被分配至对照组的女性则自行开始了治疗。工具变量（IV）方法和依从性数据使我们能够估计MHT对依从者的效应，这些依从者仅在分配至干预组时才接受MHT。IV估计显示的风险和益处，显著大于用于指导MHT指南的ITT估计值。

【**NBER**】: NBER Working Paper No. 33635，https://www.nber.org/papers/w33635
