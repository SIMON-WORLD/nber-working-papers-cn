# 【前沿文献】NBER工作论文 2026年4月合集 目录与摘要

> 2026 年 4 月 NBER 更新 143 篇工作论文，其中与中国研究相关的有 10 篇（57、68、76、85、98、106、108、109、114、139）。
> 其中，中国相关研究包括：#35106（第 57 篇，中国的全球所有权）；#35095（第 68 篇，自制的外资交易）；#35087（第 76 篇，蓝天的隐性成本：污染物替代与生物多样性丧失）；#35077（第 85 篇，双边冲突风险与贸易：军事战争、贸易战与外交噪音）；#35064（第 98 篇，2025 年的关税：对美国经济的短期影响）。

## 一、目录速览

1. **How Poverty Fell {#35163}**  
   贫困如何下降  
   <font color=grey>Vincent J. Armentano, Paul Niehaus, Tom Vogl</font>

2. **Why Bans Fail: Tipping Points and Australia's Social Media Ban {#35162}**  
   禁令为何失败：临界点与澳大利亚的社交媒体禁令  
   <font color=grey>Leonardo Bursztyn, Angela L. Duckworth, Rafael Jiménez-Durán, Aaron Leonard, Filip Milojević, Christopher Roth, Cass R. Sunstein</font>

3. **Shaping Society's Character: The Role of Schools in Developing Social and Emotional Skills {#35161}**  
   塑造社会品格：学校在发展社交与情感技能中的作用  
   <font color=grey>Sule Alan</font>

4. **Adolescent Behavior, Learning, and Knowledge Diffusion: Evidence from a Randomized Experiment {#35160}**  
   青少年行为、学习与知识扩散：来自一项随机实验的证据  
   <font color=grey>Sule Alan, Kumar Biswas, Christina S. Hauser, Shwetlena Sabarwal</font>

5. **Data Neutrality, Data Supply, and Market Competition {#35159}**  
   数据中立、数据供给与市场竞争  
   <font color=grey>Hanming Fang, Soo Jin Kim</font>

6. **Mosaics of Predictability {#35158}**  
   可预测性的马赛克  
   <font color=grey>Lin William Cong, Guanhao Feng, Jingyu He, Yuanzhi Wang</font>

7. **Automation, Learning, and Career Dynamics {#35157}**  
   自动化、学习与职业动态  
   <font color=grey>Hassan Afrouzi, Andres Blanco, Andrés Drenik, Erik Hurst</font>

8. **Trade and the End of Antiquity {#35156}**  
   贸易与古典时代晚期  
   <font color=grey>Johannes Boehm, Thomas Chaney</font>

9. **When Does Automating AI Research Produce Explosive Growth? Feedback Loops in Innovation Networks {#35155}**  
   何时自动化人工智能研究会产生爆炸性增长？创新网络中的反馈循环  
   <font color=grey>Tom Davidson, Basil Halperin, Thomas Houlden, Anton Korinek</font>

10. **Replacement and Reputation {#35154}**  
   更替与声誉  
   <font color=grey>Navin Kartik, Elliot Lipnowski, Harry Pei</font>

11. **AI Managed Household Portfolios: A Preliminary Report {#35153}**  
   人工智能管理的家庭投资组合：初步报告  
   <font color=grey>Bruce I. Carlin, Ryan D. Israelsen, Christopher F. Wazzan</font>

12. **Mothers, Schools, and the Making of American Human Capital Mobility {#35152}**  
   母亲、学校与美国人力资本流动性的形成  
   <font color=grey>Lukas Althoff, Harriet M. Brookes Gray, Hugo Reichardt</font>

13. **Retrospective Versus Prospective Meritocracy {#35151}**  
   回顾性与前瞻性精英统治  
   <font color=grey>Steven N. Durlauf</font>

14. **Beliefs, Attention, and Investments in Early Childhood {#35150}**  
   信念、注意力与早期儿童投资  
   <font color=grey>Flavio Cunha, Snejana Nihtianova, Jessica Rood, Anja-Lize van der Merwe</font>

15. **Firm Pay, Amenities, and Inequality {#35149}**  
   企业薪酬、福利与不平等  
   <font color=grey>Sydnee Caldwell, Ingrid Haegele, Jörg Heining</font>

16. **The Labor Market as an Equilibrium Newsvendor Problem {#35148}**  
   作为均衡报童问题的劳动力市场  
   <font color=grey>Alexandre Mas</font>

17. **Learning by Mail: The Impact of Correspondence Schools in Early 20th Century America {#35147}**  
   函授学习：20世纪初美国函授学校的影响  
   <font color=grey>Daniela Vidart</font>

18. **Understanding Medicaid Managed Care: The Procured Competition Model {#35146}**  
   理解医疗补助管理式医疗：采购竞争模型  
   <font color=grey>Mark Shepard, Jacob Wallace</font>

19. **The Annuity Puzzle Revisited: Barriers, Behavior, and Policy Paths to Lifetime Income {#35145}**  
   再论年金谜题：终身收入的障碍、行为与政策路径  
   <font color=grey>Hal E. Hershfield, Suzanne Shu, Jeffrey R. Brown, Abigail Hurwitz, Moshe Arye. Milevsky, Olivia S. Mitchell, Tamiko Toland</font>

20. **Characteristics of a Sufficient Statistic to Measure City Housing Prices {#35144}**  
   衡量城市住房价格的充分统计量特征  
   <font color=grey>Daniel Broxterman, William Larson, Anthony Yezer</font>

21. **How Artificial Intelligence Shapes Science: Evidence from AlphaFold {#35143}**  
   人工智能如何塑造科学：来自AlphaFold的证据  
   <font color=grey>Ryan R. Hill, Carolyn Stein</font>

22. **Seeing the Goal, Missing the Truth: Human Accountability for AI Bias {#35142}**  
   看见目标，忽视真相：人类对AI偏见应负的责任  
   <font color=grey>Sean S. Cao, Wei Jiang, Hui Xu</font>

23. **The Microstructure of AI Diffusion: Evidence from Firms, Business Functions, and Worker Tasks {#35141}**  
   AI扩散的微观结构：来自企业、业务职能和工人任务的证据  
   <font color=grey>Kathryn Bonney, Cory L. Breaux, Emin Dinlersoz, Lucia S. Foster, John C. Haltiwanger, Aditya A. Pande</font>

24. **Who Marries Whom? The Role of Segregation by Race and Class {#35140}**  
   谁与谁结婚？种族与阶级隔离的作用  
   <font color=grey>Benjamin Goldman, Jamie Gracie, Sonya Porter</font>

25. **Filling the Gaps with MICE: Addressing Missing Data in Real Estate Price Indices {#35139}**  
   用MICE填补空白：解决房地产价格指数中的缺失数据问题  
   <font color=grey>Miriam Steurer, Sabrina S. Spiegel</font>

26. **Power to the Personnel? The Impacts of Managerial Discretion vs. Worker Democracy in Employee Recognition {#35138}**  
   权力归于员工？员工表彰中管理层自由裁量权与工人民主的影响  
   <font color=grey>Namrata Kala, Madeline McKelway</font>

27. **Till the IRS Do Us Part: (Optimal) Taxation of Households {#35137}**  
   直到国税局将我们分开：（最优）家庭税收  
   <font color=grey>Hans A. Holter, Dirk Krueger, Serhiy Stepanchuk</font>

28. **The State-Contingent Debt Premium: Evidence from French Public Bonds {#35136}**  
   状态依存债务溢价：来自法国公共债券的证据  
   <font color=grey>Kris James Mitchener, Gonçalo A. Pina</font>

29. **The Value of Reliable Statistics {#35135}**  
   可靠统计数据的价值  
   <font color=grey>Nicholas Bloom, Erica L. Groshen, Duncan Hobbs, Michael R. Strain</font>

30. **Taxes and Financial Distress: Evidence from Establishment-Level Data {#35134}**  
   税收与财务困境：来自机构层面数据的证据  
   <font color=grey>Mara Faccio, Stefano Manfredonia</font>

31. **Technology Adoption and Optimal Policy {#35133}**  
   技术采纳与最优政策  
   <font color=grey>Fernando E. Alvarez, Francisco J. Buera, Nicholas Trachter</font>

32. **The Effects of School Phone Bans: National Evidence from Lockable Pouches {#35132}**  
   学校手机禁令的影响：来自可锁袋的全国性证据  
   <font color=grey>Hunt Allcott, E. Jason Baron, Thomas Dee, Angela L. Duckworth, Matthew Gentzkow, Brian Jacob</font>

33. **Wind Turbine Proximity and Health: Longitudinal Evidence from U.S. Households {#35131}**  
   风力涡轮机邻近性与健康：来自美国家庭的纵向证据  
   <font color=grey>Niklas Rott, Douglas Almond, Osea Giuntella</font>

34. **The Success of the Embedded State in England {#35130}**  
   英格兰嵌入式国家的成功  
   <font color=grey>Leander Heldring, Davis Kedrosky, James A. Robinson, Matthias Weigand</font>

35. **Labor Market Impacts of ICE Activity in Trump 2.0 {#35129}**  
   特朗普2.0时期ICE活动对劳动力市场的影响  
   <font color=grey>Elizabeth Cox, Chloe N. East</font>

36. **Complementary Climate Policies for Supply and Demand {#35128}**  
   针对供给与需求的互补性气候政策  
   <font color=grey>Geir B. Asheim, Bård Harstad</font>

37. **Monetary Policy According to Households: Perceptions, Reactions and Channels {#35127}**  
   家庭眼中的货币政策：认知、反应与传导渠道  
   <font color=grey>Francesco Grigoli, Damiano Sandri, Yuriy Gorodnichenko, Olivier Coibion</font>

38. **Industrial Policy with Development Characteristics: Fertilizer Policy in Times of Crisis {#35126}**  
   具有发展特征的产业政策：危机时期的肥料政策  
   <font color=grey>Wyatt Brooks, Kevin Donovan</font>

39. **Sticky Traditions: Origin, Persistence, and Evolution of Cultural Norms {#35125}**  
   粘性传统：文化规范的起源、持续与演变  
   <font color=grey>Paola Giuliano</font>

40. **Rental Prices and the Cost of Living in the United States, 1914–2006 {#35124}**  
   美国租金价格与生活成本，1914-2006  
   <font color=grey>Ronan C. Lyons, Allison Shertzer, Rowena Gray</font>

41. **Understanding Firms' AI Efforts and Their Economic Impact {#35123}**  
   理解企业的人工智能努力及其经济影响  
   <font color=grey>Tania Babina</font>

42. **Risky Insurance: Life-Cycle Insurance Portfolio Choice with Incomplete Markets {#35122}**  
   风险保险：不完全市场下的生命周期保险组合选择  
   <font color=grey>Joseph S. Briggs, Ciaran Rogers, Christopher Tonetti</font>

43. **Comparative Advantage and Colonial Monopoly: The Political Economy of Exclusive Trading Companies {#35121}**  
   比较优势与殖民垄断：独家贸易公司的政治经济学  
   <font color=grey>Sebastian Galiani, Ivan Lopez Cruz, Alessandra A. Palazzo, Gustavo Torrens</font>

44. **Hysteresis and Selection in the Rise of Fascism: The ‘Ordinary Men’ of the Nazi Party {#35120}**  
   法西斯主义兴起中的滞后效应与选择：纳粹党的“普通人”  
   <font color=grey>Luis Bosshart, Max Deter, Leander Heldring, Cathrin C. Mohr, Matthias Weigand</font>

45. **How Reform Happens {#35119}**  
   改革如何发生  
   <font color=grey>Simeon Djankov, Edward L. Glaeser, Andrei Shleifer</font>

46. **Gender-Specific Economic Shocks and Household Bargaining Power {#35118}**  
   性别特定的经济冲击与家庭议价能力  
   <font color=grey>Rania Gihleb, Osea Giuntella, Dor Morag</font>

47. **Does Employment Slow Cognitive Decline? Evidence from Labor Market Shocks {#35117}**  
   就业能否减缓认知衰退？来自劳动力市场冲击的证据  
   <font color=grey>Noah Arman Kouchekinia, David Neumark, Tim A. Bruckner</font>

48. **Hedging Ambiguity with Pro-Social Preferences: an Illustration from Green Finance {#35116}**  
   用亲社会偏好对冲模糊性：来自绿色金融的例证  
   <font color=grey>Geoffrey Heal, Marcella Lucchetta</font>

49. **On the Resilience of Payment Methods {#35115}**  
   论支付方式的韧性  
   <font color=grey>Fernando E. Alvarez, David Argente, Diana Van Patten</font>

50. **Intermediate Input Prices and the Labor Share {#35114}**  
   中间投入品价格与劳动份额  
   <font color=grey>Juanma Castro-Vincenzi, Benny Kleinman</font>

51. **A Blended Data Approach to Measuring Monthly Housing Starts: Satellite Imagery, Survey Data and More! {#35113}**  
   衡量月度住房开工量的混合数据方法：卫星图像、调查数据等！  
   <font color=grey>Nicole Czaplicki, Colin J. Shevlin, Hector R. Ferronato, Aidan D. Smith, Dwarakh V. Nayam, Lei Peng, Scott W. Springer, Doren Walker</font>

52. **The Effect of Choice Screens on Mobile Browser Usage: Evidence from the EU Digital Markets Act {#35112}**  
   选择屏幕对移动浏览器使用的影响：来自欧盟《数字市场法案》的证据  
   <font color=grey>Jesper Akesson, Kush Amlani, Raul Cepeda Suarez, Emily Chissell, Stefan Hunt, Michael Luca, Gemma Petrie</font>

53. **The Welfare Effects of Protecting Older Workers {#35111}**  
   保护老年工人的福利效应  
   <font color=grey>Todd Morris, Stefan Staubli, Benoit Dostie</font>

54. **Early Childcare Attendance and Cognitive skills in Adolescence {#35109}**  
   早期托幼出勤与青少年时期的认知能力  
   <font color=grey>Ingvild Almås, Nina Drange, Costas Meghir, Henrik D. Zachrisson</font>

55. **Effects of Expanding Contraceptive Choice: New Evidence from Virginia's Contraceptive Access Initiative {#35108}**  
   扩大避孕选择的影响：来自弗吉尼亚州避孕可及性倡议的新证据  
   <font color=grey>Jessica H. Kiser, Analisa Packham, Janelle Anthony, Evelyn Escobar, Emily Yeatts</font>

56. **The Domestic Political Economy of War: Evidence from Russia {#35107}**  
   战争的国内政治经济学：来自俄罗斯的证据  
   <font color=grey>Alena Gorbuntsova, Gaurav Khanna, Sultan Mehmood</font>

57. **China's Global Ownership {#35106}**  
   中国的全球所有权  
   <font color=grey>Jennie Bai, Luc Laeven, Yaojun Ke, Hong Ru</font>

58. **Trends in Health Inequalities among Spanish Retirees {#35105}**  
   西班牙退休人员健康不平等趋势  
   <font color=grey>Cristina Bellés-Obrero, Manuel Flores Mallo, Pilar García-Gómez, Sergi Jimenez-Martin, Judit Vall Castelló</font>

59. **Cross-Border Product Adoption: Individual Imports, Migrant Networks, and Domestic Retailers {#35104}**  
   跨境产品采纳：个人进口、移民网络与国内零售商  
   <font color=grey>David Argente, Esteban Méndez, Diana Van Patten</font>

60. **Nudging Parents out the Door: The Impacts of Parental Encouragement on School Choice and Test Scores {#35103}**  
   推动家长走出门外：家长鼓励对学校选择和考试成绩的影响  
   <font color=grey>Guthrie Gray-Lobe, Michael Kremer, Joost de Laat, Oluchi Mbonu, Cole Scanlon</font>

61. **The Macroeconomic Effects of Tariffs: Insights from 180 Years of U.S. Trade Policy {#35102}**  
   关税的宏观经济效应：来自美国180年贸易政策的见解  
   <font color=grey>Tamar den Besten, Regis Barnichon, Diego R. Känzig, Aayush Singh</font>

62. **The Political Economy of Financial Crises {#35101}**  
   金融危机的政治经济学  
   <font color=grey>Charles W. Calomiris, Matthew S. Jaremski</font>

63. **Measuring the Impact of Data Centers in the United States Economy: Monetary Damage from Air Pollution and Greenhouse Gas Emissions {#35100}**  
   衡量数据中心对美国经济的影响：空气污染和温室气体排放的货币损害  
   <font color=grey>Nicholas Z. Muller</font>

64. **Organizational Targets in General Equilibrium {#35099}**  
   一般均衡中的组织目标  
   <font color=grey>Joel P. Flynn, George Nikolakoudis, Karthik A. Sastry</font>

65. **Treasury Supply Shocks: Propagation Through Debt Expansion and Maturity Adjustment {#35098}**  
   国债供给冲击：通过债务扩张和期限调整的传导  
   <font color=grey>Huixin Bi, Maxime Phillot, Sarah Zubairy</font>

66. **Health Inequalities among Retirees in the Netherlands {#35097}**  
   荷兰退休人员的健康不平等  
   <font color=grey>Adriaan Kalwij, Arie Kapteyn</font>

67. **Declining Occupations and Career Outcomes in Norway {#35096}**  
   挪威的衰落职业与职业结果  
   <font color=grey>Erling Barth, Maria Forthun Hoen, Sari Pekkala Kerr, William R. Kerr</font>

68. **Homemade Foreign Trading {#35095}**  
   自制的外资交易  
   <font color=grey>Zhiguo He, Yuehan Wang, Xiaoquan Zhu</font>

69. **Changes in Health Inequalities among Older Individuals in Japan {#35094}**  
   日本老年人健康不平等的变化  
   <font color=grey>Takashi Oshio, Satoshi Shimizutani</font>

70. **The Inefficient Pricing of News {#35093}**  
   新闻的低效定价  
   <font color=grey>Antoine Didisheim, Bryan T. Kelly, Mohammad Pourmohammadi, Hanqing Tian</font>

71. **The Medical Expansion, Life Expectancy, and Endogenous Directed Technical Change {#35092}**  
   医疗扩张、预期寿命与内生定向技术变革  
   <font color=grey>Leon Huetsch, Dirk Krueger, Alexander Ludwig</font>

72. **Belief Dispersion and Entrepreneurial Entry {#35091}**  
   信念分散与创业进入  
   <font color=grey>Joshua S. Gans</font>

73. **Information Treatments, Hypotheticals, and Event Studies: Comparative Estimates {#35090}**  
   信息处理、假设情境与事件研究：比较估计  
   <font color=grey>Carola Binder, Dimitris Georgarakos, Pei Kuang, Li Tang</font>

74. **Aging at the Very Top {#35089}**  
   最高层的老龄化  
   <font color=grey>Valentin Kecht, Alessandro Lizzeri, Farzad Saidi</font>

75. **The Declining Local Bias of Entrepreneurship in the United States {#35088}**  
   美国创业精神本地偏好的下降  
   <font color=grey>Innessa Colaiacovo, Margaret G. Dalton, Sari Pekkala Kerr, William R. Kerr</font>

76. **The Unseen Costs of Blue Skies: Pollutant Substitution and Biodiversity Loss {#35087}**  
   蓝天的隐性成本：污染物替代与生物多样性丧失  
   <font color=grey>Joshua S. Graff Zivin, Siyuan Li, Huanhuan Wang, Zhiqiang Zhang</font>

77. **If You Build It, They May Not Come: Willingness to Participate in Managed EV Charging {#35086}**  
   如果你建好了，他们可能不会来：参与电动汽车管理充电的意愿  
   <font color=grey>Fiona Burlig, James B. Bushnell, David S. Rapson</font>

78. **Le Bureau des Légendes: A Dynamic Theory of Double Agents {#35085}**  
   传奇办公室：双重间谍的动态理论  
   <font color=grey>Sebastian Galiani, Franco Mettola La Giglia</font>

79. **Gender Mix and Team Performance: Evidence from Obstetrics {#35084}**  
   性别构成与团队绩效：来自产科的证据  
   <font color=grey>Ambar La Forgia, Manasvini Singh</font>

80. **The Effect of Annuities on Longevity {#35082}**  
   年金对长寿的影响  
   <font color=grey>Borja Larrain, Alessandro Previtero, Felipe Severino</font>

81. **Impact Trickles Down: A General Equilibrium Theory of Stakeholder Exit and Engagement {#35081}**  
   影响层层传递：利益相关者退出与参与的一般均衡理论  
   <font color=grey>Briana Chang, Harrison Hong</font>

82. **Hospital Billing Regulations and Financial Well-Being: Evidence from California’s Fair Pricing Law {#35080}**  
   医院收费法规与财务福祉：来自加州公平定价法的证据  
   <font color=grey>Yaa Akosa Antwi, Marion Aouad, Nathan Blascak</font>

83. **How Have Universities Survived for Nearly a Millenium {#35079}**  
   大学如何存续近千年  
   <font color=grey>David M. Cutler, Edward L. Glaeser</font>

84. **The “Peace Dividend” of International Trade: A New Empirical Approach {#35078}**  
   国际贸易的“和平红利”：一种新的实证方法  
   <font color=grey>Ling Feng, Qiuyue Huang, Zhiyuan Li, Christopher M. Meissner</font>

85. **Bilateral Conflict Risk and Trade: Military Wars, Trade Wars, and Diplomatic Noise {#35077}**  
   双边冲突风险与贸易：军事战争、贸易战与外交噪音  
   <font color=grey>Joshua Aizenman, Rodolphe Desbordes, Jamel Saadaoui</font>

86. **Tariffs and the Term Structure of Inflation Expectations {#35076}**  
   关税与通胀预期的期限结构  
   <font color=grey>Stéphane Auray, Michael B. Devereux, Anthony M. Diercks, Aurélien Eyquem, Joon Kim</font>

87. **The Impact of Maternal Education on Early Childhood Development {#35075}**  
   母亲教育对儿童早期发展的影响  
   <font color=grey>Moriam Khanam, Mohammad Hajizadeh, Casey Warman</font>

88. **When Does Acquisition Integration Succeed? Evidence from Inside the Integration Black Box {#35074}**  
   收购整合何时成功？来自整合黑箱内部的证据  
   <font color=grey>Sinan Gokkaya, Xi Liu, René M. Stulz</font>

89. **Understanding Support for Inefficient Environmental Policy Instruments {#35073}**  
   理解对低效环境政策工具的支持  
   <font color=grey>Chenxi Jiang, Maximiliano Lauletta, Ro’ee Levy, Joseph S. Shapiro, Dmitry Taubinsky</font>

90. **Risk Preferences and the Willingness to Relocate to Danger: Evidence from Wartime Ukraine {#35072}**  
   风险偏好与搬迁至危险地区的意愿：来自战时乌克兰的证据  
   <font color=grey>Yuriy Gorodnichenko, Marianna Kudlyak, Sophia Lobozynska, Iryna Skomorovych, Ulyana Vladychyn, Andriy Kovalyuk, Iryna Snovydovych</font>

91. **The Macroeconomic Effects of Bank Regulation: New Evidence from a High-Frequency Approach {#35071}**  
   银行监管的宏观经济效应：来自高频方法的新证据  
   <font color=grey>Thomas Drechsel, Ko Miura</font>

92. **Birthright Citizenship and Youth Crime {#35070}**  
   出生公民权与青少年犯罪  
   <font color=grey>Leander Andres, Stefan Bauernschuster, Gordon B. Dahl, Helmut Rainer, Simone Schüller</font>

93. **Reason for Treason {#35069}**  
   叛国缘由  
   <font color=grey>Xinyu Fan, Gary Richardson, Zhihao Xu, Sicheng Zhao</font>

94. **High Schools and the Uneven Rise in American Opportunity {#35068}**  
   高中与美国机遇的不均衡崛起  
   <font color=grey>Alison Doxey, Ezra Karger, Peter Nencka</font>

95. **Who Pays for Payments? {#35067}**  
   谁为支付买单？  
   <font color=grey>Mark L. Egan, Gregor Matvos, Amit Seru, Lulu Wang, Vincent Yao</font>

96. **Zero Energy Day: How Nationwide Blackouts Affect the Economy {#35066}**  
   零能源日：全国性停电如何影响经济  
   <font color=grey>Luis E. Gonzales, Koichiro Ito, Mar Reguant</font>

97. **Multimodal Transport Networks {#35065}**  
   多式联运网络  
   <font color=grey>Simon Fuchs, Woan Foong Wong</font>

98. **Tariffs in 2025: Short-Run Impacts on the U.S. Economy {#35064}**  
   2025 年的关税：对美国经济的短期影响  
   <font color=grey>Pablo D. Fajgelbaum, Amit Khandelwal</font>

99. **Beyond Demo Day: Sorting and Value Added in Startup Accelerators {#35063}**  
   超越演示日：创业加速器中的分类与增值  
   <font color=grey>Youn Baek, Deepak Hegde</font>

100. **Exploring Trends in Severe Maternal Morbidity in the U.S. {#35062}**  
   探索美国严重孕产妇发病率的趋势  
   <font color=grey>Pinka Chatterji, Fangning Li, Sara Markowitz</font>

101. **Human Capital Markets {#35061}**  
   人力资本市场  
   <font color=grey>Jishnu Das, Cauê Dobbin</font>

102. **The Emergence of the Poverty–Mental Health Gradient and the Great Pakistan Earthquake of 2005 {#35060}**  
   贫困与心理健康梯度的出现与 2005 年巴基斯坦大地震  
   <font color=grey>Tahir Andrabi, Benjamin Daniels, Jishnu Das</font>

103. **When Policy Shapes Perception: The 2021 Child Tax Credit and Consumer Sentiment {#35059}**  
   当政策塑造认知：2021 年儿童税收抵免与消费者情绪  
   <font color=grey>Jacob Bastian, Melody Harvey</font>

104. **Wellbeing, Youth and Survey Mode: Comparisons across 23 Countries Using Three International Datasets {#35058}**  
   福祉、青年与调查模式：使用三个国际数据集对 23 个国家的比较  
   <font color=grey>David G. Blanchflower, Alex Bryson</font>

105. **Credit Crunches and the Great Stagflation {#35057}**  
   信贷紧缩与“大滞胀”  
   <font color=grey>Itamar Drechsler, Alexi Savov, Philipp Schnabl</font>

106. **The Chinese Current Account Imbalances: Puzzles, Patterns, and Possible Causes {#35056}**  
   中国经常账户失衡：谜题、模式与可能原因  
   <font color=grey>Chang Ma, Shang-Jin Wei</font>

107. **The Impacts of Medicaid's Managed Long-Term Services and Supports on Health Outcomes in Medicare {#35055}**  
   医疗补助计划管理式长期服务与支持对 Medicare 健康结果的影响  
   <font color=grey>Ajin Lee, Maya Rossin-Slater, Becky Staiger, Amanda Su</font>

108. **A Tale of Two Countries – The Real Estate Crises in 1990s Japan and Contemporary China {#35054}**  
   两个国家的故事——1990年代日本与当代中国的房地产危机  
   <font color=grey>Kenneth S. Rogoff, Yuanchen Yang</font>

109. **Trade in AI-Related Products {#35053}**  
   人工智能相关产品的贸易  
   <font color=grey>Michael E. Waugh</font>

110. **The Economic Value of Eliminating Cancer {#35052}**  
   消除癌症的经济价值  
   <font color=grey>Tomas J. Philipson, Deyu Zhang, Shumaila Abbasi, Noah Fisher</font>

111. **Tracking the Credibility Revolution across Fields {#35051}**  
   追踪各领域的可信度革命  
   <font color=grey>Paul Goldsmith-Pinkham</font>

112. **A Model of Leveraged Bubbles {#35050}**  
   杠杆泡沫模型  
   <font color=grey>Nina Biljanovska, Jordi Galí, Lucyna Górnicka, Alexandros P. Vardoulakis</font>

113. **Disagreement of Disagreement {#35049}**  
   分歧的分歧  
   <font color=grey>Christian L. Goulding, Campbell R. Harvey, Hrvoje Kurtović</font>

114. **Consumer Tobacco Product Choices in China: The Impact of a Ban on Flavored E-cigarettes {#35048}**  
   中国消费者烟草产品选择：禁止调味电子烟的影响  
   <font color=grey>Hua Wang, Yuhan Deng, Donald S. Kenkel, Alan D. Mathios, Sen Zeng</font>

115. **Identification and Estimation of Labor Supply Elasticities from Kinked Budget Sets {#35047}**  
   基于拐点预算集的劳动供给弹性识别与估计  
   <font color=grey>Deniz Dutz, Morten Håvarstein, Magne Mogstad, Alexander Torgovitsky</font>

116. **Forecasting the Economic Effects of AI {#35046}**  
   预测人工智能的经济效应  
   <font color=grey>Ezra Karger, Otto Kuusela, Jason Abaluck, Kevin A. Bryan, Basil Halperin, Todd R. Jones, Connacher Murphy, Philip Trammell, Matt Reynolds, Dan Mayland, Ria Viswanathan, Ananaya Mittal, Rebecca Ceppas de Castro, Josh Rosenberg, Philip Tetlock</font>

117. **Bad News and Policy Views: Expectations, Disappointment, and Opposition to Affirmative Action {#35045}**  
   坏消息与政策观点：期望、失望与对平权行动的反对  
   <font color=grey>Louis-Pierre Lepage, Heather Sarsons, Michael Thaler</font>

118. **Predicted Incrementality by Experimentation (PIE) for Ad Measurement {#35044}**  
   基于实验的预测增量（PIE）用于广告测量  
   <font color=grey>Brett R. Gordon, Robert Moakler, Florian Zettelmeyer</font>

119. **Profit Regulation and Strategic Transfer Pricing by Vertically Integrated Firms: Evidence from Health Care {#35043}**  
   利润监管与纵向一体化企业的战略性转移定价：来自医疗保健的证据  
   <font color=grey>Pragya Kakani, Eric Yde, Genevieve P. Kanter, Richard G. Frank, Amelia M. Bond</font>

120. **Capital in the Capitol: Congressional Trades Resemble Uninformed Retail Trading {#35041}**  
   国会山上的资本：国会交易类似于不知情的散户交易  
   <font color=grey>Haotian Chen, Bruce Sacerdote</font>

121. **Investment-based Costs of Equity {#35040}**  
   基于投资的股权成本  
   <font color=grey>Yicheng Liu, Chen Xue, Lu Zhang</font>

122. **Measuring Organizational Capital {#35039}**  
   衡量组织资本  
   <font color=grey>Wei Cai, Andrea Prat, Jiehang Yu</font>

123. **Immigrants at the Margin: Labor Market Effects of the Minimum Wage {#35038}**  
   边缘移民：最低工资的劳动力市场效应  
   <font color=grey>Mark Borgschulte, Heepyung Cho, Darren Lubotsky</font>

124. **Amortized Inference for Correlated Discrete Choice Models via Equivariant Neural Networks {#35037}**  
   通过等变神经网络对相关离散选择模型进行摊销推断  
   <font color=grey>Easton K. Huch, Michael P. Keane</font>

125. **How AI Aggregation Affects Knowledge {#35036}**  
   人工智能聚合如何影响知识  
   <font color=grey>Daron Acemoglu, Tianyi Lin, Asuman Ozdaglar, James Siderius</font>

126. **Liquidity-Driven Growth Cycles in Small Open Economies {#35035}**  
   小型开放经济中的流动性驱动增长周期  
   <font color=grey>Jess Benhabib, Feng Dong, Pengfei Wang, Zhenyang Xu</font>

127. **Thinking versus Doing: Cognitive Capacity, Decision Making and Medical Diagnosis {#35034}**  
   思考与行动：认知能力、决策制定与医疗诊断  
   <font color=grey>Benjamin R. Handel, Louis-Jonas Heizlsperger, Jonas Knecht, Jonathan T. Kolstad, Ulrike Malmendier, Filip Matějka</font>

128. **Real Effects of Nominal Interest Rates {#35033}**  
   名义利率的实际效应  
   <font color=grey>Joshua K. Hausman, John V. Leahy, John Mondragon, Johannes Wieland</font>

129. **Skill Formation, Child Labor, and the Schooling Consequences of the World War I Agricultural Boom {#35032}**  
   技能形成、童工与一战农业繁荣的入学后果  
   <font color=grey>Taylor Jaworski, Carl T. Kitchens, Luke P. Rodgers</font>

130. **Adversarial Selection {#35031}**  
   对抗性选择  
   <font color=grey>Alma Cohen, Alon Klement, Zvika Neeman, Eilon Solan</font>

131. **A Gender Quota for Top Executives: Diversity without Disruption {#35030}**  
   高管层性别配额：无破坏的多样性  
   <font color=grey>David A. Matsa, Amalia R. Miller</font>

132. **Climate Change, Deforestation, and the Expansion of the Global Agricultural Frontier {#35029}**  
   气候变化、森林砍伐与全球农业边疆的扩张  
   <font color=grey>Allan Hsiao, Jacob Moscona, Benjamin A. Olken, Karthik A. Sastry</font>

133. **Which U.S. States Suffered a Greater Great Depression and Why? {#35028}**  
   哪些美国州遭受了更严重的大萧条及其原因？  
   <font color=grey>Dong Cheng, Mario J. Crucini, Hanjo T. Kim</font>

134. **Subjective Earnings and Employment Dynamics {#35027}**  
   主观收入与就业动态  
   <font color=grey>Manuel Arellano, Orazio Attanasio, Margherita Borella, Mariacristina De Nardi, Gonzalo Paz-Pardo</font>

135. **How Responsive are Durables Expenditures to Transitory Income Shocks? {#35026}**  
   耐用品支出对暂时性收入冲击的响应程度如何？  
   <font color=grey>Christoph E. Boehm, Changseok Ma</font>

136. **Pharmaceutical Advertising in Dynamic Equilibrium {#35025}**  
   动态均衡中的药品广告  
   <font color=grey>Pierre Dubois, Ariel Pakes</font>

137. **Learning How To Borrow in a Fintech World: Consumer Behavior When Search Costs Are (Near) Zero {#35024}**  
   在金融科技世界中学习如何借贷：搜索成本（近乎）为零时的消费者行为  
   <font color=grey>Alex Günsberg, Camelia M. Kuhnen</font>

138. **Tariffs, Global Value Chains, and the Incidence of Protection: Evidence from US Automobiles {#35023}**  
   关税、全球价值链与保护主义的影响：来自美国汽车业的证据  
   <font color=grey>Luke Heeney, Christopher R. Knittel, Jasdeep Mandia</font>

139. **AI Patents in the United States and China: Measurement, Organization, and Knowledge Flows {#35022}**  
   美国与中国的AI专利：测度、组织与知识流动  
   <font color=grey>Hanming Fang, Xian Gu, Hanyin Yan, Wu Zhu</font>

140. **The Empathy Channel in Fertility {#35021}**  
   生育中的共情渠道  
   <font color=grey>Sebastian Galiani, Raul A. Sosa</font>

141. **Why Do Americans No Longer Work So Much More Than Non-Americans? {#35020}**  
   为什么美国人不再比非美国人工作多那么多？  
   <font color=grey>Serdar Birinci, Loukas Karabarbounis, Kurt See</font>

142. **Can Personal Access to Medical Expertise Overcome Vaccine Hesitancy? {#35019}**  
   个人接触医学专业知识能否克服疫苗犹豫？  
   <font color=grey>D. Mark Anderson, Ron Diris, Raymond Montizaan, Daniel I. Rees</font>

143. **Market Power in Mortgage Pricing: the Role of Referral Lending {#35015}**  
   抵押贷款定价中的市场势力：推荐贷款的作用  
   <font color=grey>Dayin Zhang, Panle Jia Barwick, Lu Han, Jonathan Kroah</font>
...
【**摘要**】：2025年12月，澳大利亚成为第一个禁止16岁以下青少年在主要社交媒体平台持有账户的国家，这一政策目前正在十几个国家和众多州被考虑。由于社交媒体使用本质上是社会性的，一项易于规避的禁令的有效性可能取决于合规是否达到一个临界点：即合规同伴的比例足够高，以至于个人自身合规成为最优选择。我们在禁令生效四个月后调查了835名澳大利亚青少年，发现只有大约四分之一的14-15岁青少年遵守规定。围绕使用的社会环境几乎没有改变：大多数被禁青少年认为他们的同伴仍在使用的被禁平台，并引用社会原因作为继续使用的理由。维持高合规率需要两个要素：合规者的比例必须足够高，并且合规者必须发现继续合规是可取的。当前的禁令两者都未实现。青少年报告称，他们需要大约三分之二的同伴停止使用社交媒体才能让自己停止，这远高于目前合规的比例。他们还认为合规者不如不合规者受欢迎，因此更有影响力的青少年不成比例地留在平台上。综合来看，这些模式表明合规率更可能下降而非上升。要维持更高的合规率，很可能需要将禁令与直接作用于社会规范和个人激励的工具相结合。

【**NBER**】: NBER Working Paper No. 35162，https://www.nber.org/papers/w35162
...
【**摘要**】：本章考察了学校如何培养影响个人成功和更广泛社会凝聚力的社交情感技能。超越传统上对认知能力的关注，我认为教育在培养促进合作、信任和长期社会福祉的特质方面发挥着关键作用。借鉴神经科学、心理学和经济学的见解，我探讨了学校如何不仅塑造学术和劳动力市场成果，还塑造代际信念、态度以及社会资本的形成。利用实验研究的证据，我强调了基于学校的干预措施如何能够灌输毅力、增强社会学习，并创造遏制反社会倾向、促进亲社会行为的环境——最终影响社会的文化结构。这一视角将教育重新定义为建设更公平、更具凝聚力的社区的一种机制。

【**NBER**】: NBER Working Paper No. 35161，https://www.nber.org/papers/w35161

#### 4. Adolescent Behavior, Learning, and Knowledge Diffusion: Evidence from a Randomized Experiment {#35160}

【**Author**】: Sule Alan, Kumar Biswas, Christina S. Hauser, Shwetlena Sabarwal
...
【**摘要**】：改善课堂行为是资源匮乏教育系统中一个持续的挑战，在这些系统中，混乱的环境常常扰乱教学并限制学习。然而，关于行为管理是否能成为提高学业成绩的杠杆，目前缺乏严谨的证据。我们评估了一个将建立行为规范和减少课堂干扰的责任从教师转移到学生的项目。该项目覆盖了孟加拉国127所中学的7500多名青少年，显著改善了课堂社会氛围，促进了更强的合作、更好的行为规范和更具支持性的同伴网络。表现优异的学生受益最多，在项目后的数学和语文测试中显示出显著进步。一年半后的跟踪调查显示，虽然社会氛围的改善逐渐消退，但学业成绩的提升持续存在，并扩展到更广泛的学生群体，尽管这些提升仍然集中在能力较强的同伴中。一个关键机制是增强了高能力学生之间的学术支持网络，促进了该群体内的同伴学习和知识扩散。

【**NBER**】: NBER Working Paper No. 35160，https://www.nber.org/papers/w35160

#### 5. Data Neutrality, Data Supply, and Market Competition {#35159}

【**Author**】: Hanming Fang, Soo Jin Kim
...
【**摘要**】：我们分析了数据中立法规对下游市场竞争、平台生产数据的激励以及消费者福利的影响。在我们的框架中，数据中立要求寻求访问平台数据的公司无论是否与平台有关联都应受到平等对待。我们考虑了两种形式的监管。在弱数据中立下，平台必须向关联卖家和非关联卖家提供相同数量的数据；在强数据中立下，平台还必须收取相同的价格。我们表明，弱数据中立可能在很大程度上无效，因为平台可能通过歧视性定价来恢复排他性。强数据中立的影响更大，但它不一定能提高福利。尽管它扩大了访问权限并加剧了下游竞争，但它也降低了平台精炼和生产数据的激励。因此，数据中立可以减少市场上可用的数据均衡量，而这种数据减少效应可能主导其增强竞争的益处。这些发现表明，监管对平台数据的访问需要在公平竞争与激励生成有价值的数据投入之间取得平衡。

【**NBER**】: NBER Working Paper No. 35159，https://www.nber.org/papers/w35159

#### 6. Mosaics of Predictability {#35158}

【**Author**】: Lin William Cong, Guanhao Feng, Jingyu He, Yuanzhi Wang
...
【**摘要**】：我们认为，回报可预测性是一种潜在的、资产特定的且依赖于状态的特征。我们开发了一个可解释的面板树，该树将美国股票面板内生地划分为样本外且持久的“马赛克”模式，并估计了特定聚类的预测模型。可预测性集中在具有较大盈利意外、高盈利价格比和低交易量的股票中。它是逆周期的，当市场股息收益率高且流动性低时更强。考虑可预测性异质性（传统模型忽略了这一点）可以改进预测，并产生样本外夏普比率约为2的投资组合。在50年的数据中，马赛克图显示了信号出现在哪里以及噪声在哪里占主导地位。

【**NBER**】: NBER Working Paper No. 35158，https://www.nber.org/papers/w35158

#### 7. Automation, Learning, and Career Dynamics {#35157}

【**Author**】: Hassan Afrouzi, Andres Blanco, Andrés Drenik, Erik Hurst
...
【**摘要**】：我们研究了一项自动化技术如何影响一个经济体中通过执行任务获得技能的工人的职业动态、人力资本和福利。在一个连续时间的一般均衡模型中，边做边学与自动化任务份额、管理者维持的任务前沿以及工人到管理者的职业转型共同决定。具有高学习能力的经济体存在一对严格按总学习率排序的稳态均衡。更便宜的技术在这两种均衡中具有相反的影响：在高学习均衡中，它通过学习渠道本身提高福利；在低学习均衡中，它使经济陷入人力资本陷阱。计划者的最优方案是将对自动化利润征税与以共同税率补贴前沿维持支出相结合。

【**NBER**】: NBER Working Paper No. 35157，https://www.nber.org/papers/w35157

#### 8. Trade and the End of Antiquity {#35156}

【**Author**】: Johannes Boehm, Thomas Chaney
...
【**摘要**】：在古典时代晚期，当政治权力从地中海地区向北欧和中东转移时，贸易扮演了什么角色，经济活动又是如何演变的？为了回答这些问题，我们建立了一个包含从四世纪到十世纪数十万枚古代硬币的数据库，估计了一个贸易和货币的动态模型，其中硬币沿着贸易路线逐渐扩散，并恢复了细粒度的区域贸易和实际消费时间序列。我们的估计表明：地中海贸易因伊斯兰教与基督教之间新形成的边界而中断；经济活动从五世纪开始离开地中海地区；实际消费在八世纪的中东达到顶峰；到九世纪末，从伊斯兰西班牙到法兰克西北欧的大西洋地区已成为古代西方世界最富裕的地区。

【**NBER**】: NBER Working Paper No. 35156，https://www.nber.org/papers/w35156
...
【**摘要**】：人工智能实验室正越来越多地使用人工智能本身来加速人工智能研究，这创造了一个可能导致智能爆炸的反馈循环。我们构建了一个带有创新网络的一般半内生增长模型，在该模型中，一个部门的研究和自动化会提高其他部门的研究生产率，并推导出一个简洁的分析条件，在该条件下增长变为超指数增长（“爆炸性”）。我们发现，自动化研究可以通过激活两个强化渠道来抵消思想的收益递减：跨研究部门的技术反馈循环，以及更高产出为进一步研究提供资金的经济反馈循环。如果技术和经济反馈循环的综合强度克服了收益递减，增长就会变得爆炸性。在一个根据人工智能进展趋势校准的简单模拟中，完全自动化软件研究以及在其他部门实现适度（5%）的自动化，会在六年内产生一个奇点。如果任务自动化进展足够快，瓶颈不会推翻这一结果。

【**NBER**】: NBER Working Paper No. 35155，https://www.nber.org/papers/w35155

#### 10. Replacement and Reputation {#35154}

【**Author**】: Navin Kartik, Elliot Lipnowski, Harry Pei
...
【**摘要**】：选举更替是否能确保官员最终按照选民的利益行事？我们研究了一个声誉模型下的问责制。选民观察现任者的表现，并决定是否替换他们。政治家可能是始终付出努力的“好”类型，也可能是可能偷懒的机会主义者。我们发现，良好的长期结果总是可以实现的，尽管其机制和稳健性取决于经济条件。在有利于激励提供的环境中，一些均衡表现出持续的努力，而另一些均衡则表现出一些长期的偷懒。在互补的情况下，机会主义者永远不会被完全约束，但选择效应占主导地位：每个均衡最终都会稳定在一个好的政治家身上，从而产生持续的努力。

【**NBER**】: NBER Working Paper No. 35154，https://www.nber.org/papers/w35154

#### 11. AI Managed Household Portfolios: A Preliminary Report {#35153}

【**Author**】: Bruce I. Carlin, Ryan D. Israelsen, Christopher F. Wazzan
...
【**摘要**】：人工智能如何管理家庭股票投资组合？我们使用几种大型语言模型收集了一个前瞻性的、每日的股票推荐时间序列，并研究了人工智能的投资风格。人工智能推荐的投资组合多元化程度低，正向载荷于动量、大公司和低账面市值比公司。人工智能主要根据公司获得媒体关注的程度来推荐股票。通过使用多种版本的查询和请求，我们发现，基于Daniel等人（1997）的方法，买入持有和主动管理的人工智能投资组合似乎并未获得统计上显著的异常回报。

【**NBER**】: NBER Working Paper No. 35153，https://www.nber.org/papers/w35153

#### 12. Mothers, Schools, and the Making of American Human Capital Mobility {#35152}

【**Author**】: Lukas Althoff, Harriet M. Brookes Gray, Hugo Reichardt
...
【**摘要**】：美国是如何成为一个充满机遇的国度的？以往关于代际流动性的历史研究主要集中在父子收入相关性上，掩盖了母亲的作用。我们引入了一个新的流动性衡量指标，该指标纳入了父母双方的人力资本，开发了一种利用识字率作为代理变量的潜变量方法，并构建了一个包含女性的代表性关联面板。我们发现，从19世纪到20世纪，人力资本和收入方面的代际流动性都急剧上升。最初，母亲的人力资本最能预测子女的成果。然而，随着学校教育的扩展，这种依赖性下降，代际流动性上升。因此，美国对大众教育的投资是其崛起为一个流动性社会的核心。

【**NBER**】: NBER Working Paper No. 35152，https://www.nber.org/papers/w35152
...
【**摘要**】：本文提出了一种从回顾性与前瞻性角度理解精英统治的方法。回顾性精英统治是静态的或向后看的：精英地位基于个人的特征或过去的成就，作为卓越的代表或对已获得职位的应得。前瞻性精英统治是向前看的：精英地位被功能性地定义为个人对一组特定社会目标所做的比较性贡献。我使用形式化模型表明，这些不同的概念对学生分配到学校或工人分配到工作岗位的精英统治安排有着非常不同的含义，并且它们涉及政策制定者不同的信息需求。这些不同的精英统治方法展示了精英统治的不同版本可能或不可能具有社会效率。我讨论了将精英统治作为各种公共政策背景下的一个期望目标的含义。

【**NBER**】: NBER Working Paper No. 35151，https://www.nber.org/papers/w35151

#### 14. Beliefs, Attention, and Investments in Early Childhood {#35150}

【**Author**】: Flavio Cunha, Snejana Nihtianova, Jessica Rood, Anja-Lize van der Merwe
...
【**摘要**】：我们构建了一个早期儿童父母投资模型，在该模型中，带宽受限的父母对回应性互动的回报持有扭曲的信念。当能力达不到期望时，动机性推理提供了缓解：父母向下扭曲其工作信念，为低参与度提供合理化理由。扭曲的信念抑制了回应性养育，这不会产生校准证据，进而又确认了这种扭曲。该模型识别了干预措施摆脱这种自我封闭陷阱的四个渠道。一项随机对照试验证实了该模型对父母信念、回应性养育测量、行为参与度以及在对物质或安慰剂结果无影响方面的预测。

【**NBER**】: NBER Working Paper No. 35150，https://www.nber.org/papers/w35150

#### 15. Firm Pay, Amenities, and Inequality {#35149}

【**Author**】: Sydnee Caldwell, Ingrid Haegele, Jörg Heining
...
【**摘要**】：我们利用嵌入在一项与行政记录相关联的德国工人大规模调查中的离散选择实验，估计了企业特定的福利估值。工人对来自他们可能考虑加入的真实企业的假设性工作机会进行排序，随机化的工资识别出货币度量估值。估值在不同企业和人口群体之间差异很大，但一个单一指数表现得惊人地好。估值与企业工资溢价大致正交；因此，它们并未抵消企业间的工资不平等。然而，男女在福利估值上的差异解释了部分性别工资差距。

【**NBER**】: NBER Working Paper No. 35149，https://www.nber.org/papers/w35149
...
【**摘要**】：我研究了需求不确定下的雇佣行为，此时企业既可以持有永久性劳动力作为缓冲，也可以在需求实现后从现货市场雇佣。我构建了一个模型，其中现货市场是内生的，以至于当一家企业更多地依赖现货劳动力时，它也会加厚其他企业所使用的市场。单个企业并未内化这一贡献，因此竞争均衡涉及过多的缓冲。我利用来自专业护理机构的每日考勤记录全样本数据，在注册护士市场中评估该模型。数据支持该模型的总体均衡预测。在总护理工时给定的条件下，代理市场更厚的市场配给更少，并且更厚的代理市场压缩了永久性人员配置的上尾，同时提高了分布下部的总工时。通过估计一个具有异质性现货市场摩擦和配给成本的设施层面报童模型，我发现新冠疫情后护理劳动力市场效率更高，降低现货市场摩擦能带来显著的福利收益，并且一家参与现货市场而非雇佣员工作为缓冲的企业的边际外部收益平均为工资的7%。这个劳动力市场提供的灵活性不足，因为可用性的价值没有被完全定价。

【**NBER**】: NBER Working Paper No. 35148，https://www.nber.org/papers/w35148

#### 17. Learning by Mail: The Impact of Correspondence Schools in Early 20th Century America {#35147}

【**Author**】: Daniela Vidart
...
【**摘要**】：本文研究了函授教育作为20世纪初美国替代性教育途径的作用。利用新近数字化的国际函授学校（截至1940年拥有超过400万学生，是当时规模最大的此类机构）记录，并与人口普查数据相关联，我发现，在3至10年内，注册函授课程使获得技能型工作的可能性提高了6至10个百分点，这一效应在将其用作高中替代教育的年轻学生中尤为显著。我构建了一个一般均衡的Roy式模型，在该模型中，个体根据能力选择不同的教育路径。与模型一致，函授教育促进了能力较低个体的技能获取，并改善了对高中教育的筛选，从而放大了其回报。

【**NBER**】: NBER Working Paper No. 35147，https://www.nber.org/papers/w35147

#### 18. Understanding Medicaid Managed Care: The Procured Competition Model {#35146}

【**Author**】: Mark Shepard, Jacob Wallace
...
【**摘要**】：医疗补助是美国最大的公共项目之一——为超过7500万低收入美国人提供健康保险——其超过四分之三的参保者通过私营的“管理式医疗”保险公司获得医疗服务。在这篇综述文章中，我们就将医疗补助外包给私营保险公司的经济学问题提出三个核心观点。首先，关于医疗补助私有化的实证证据是混合的：外包并未显著降低公共成本或改善护理质量。其次，我们提出了一个框架，称之为“采购竞争”，用以描述医疗补助管理式医疗作为公共采购与受监管竞争的混合体的独特结构。第三，我们讨论了该模型中涉及采购、竞争和消费者选择的关键政策杠杆。在整个过程中，我们强调了尚待解决的研究问题，认为各州在设计这些项目时存在的巨大差异——加上关于何种措施有效的有限证据——代表了一个有望产生高影响力学术成果的研究领域。

【**NBER**】: NBER Working Paper No. 35146，https://www.nber.org/papers/w35146

#### 19. The Annuity Puzzle Revisited: Barriers, Behavior, and Policy Paths to Lifetime Income {#35145}

【**Author**】: Hal E. Hershfield, Suzanne Shu, Jeffrey R. Brown, Abigail Hurwitz, Moshe Arye. Milevsky, Olivia S. Mitchell, Tamiko Toland
...
【**摘要**】：财富变现决策，即如何在不确定的剩余寿命内优化消费，是人们面临的最困难决策之一。这些决策涉及跨期权衡、不确定性、复杂性和情感因素，然而许多消费者很少得到正式指导。一个核心挑战是确保终身收入并避免资源耗尽，特别是通过保证终身收入的生命年金。标准经济模型预测对年金有很高的需求，但在实践中，很少有人购买它们，这一差距被称为年金谜题。本文介绍了年金，考察了消费者和计划发起人对其采用有限的情况，回顾了主要的解释，并概述了提高采用率和改善决策质量的方法。

【**NBER**】: NBER Working Paper No. 35145，https://www.nber.org/papers/w35145

#### 20. Characteristics of a Sufficient Statistic to Measure City Housing Prices {#35144}

【**Author**】: Daniel Broxterman, William Larson, Anthony Yezer
...
【**摘要**】：描述城市住房价格的水平与变化，无论价格是用租金还是资产价值来衡量，都是许多实证问题的核心。这项任务因住房存量的异质性、住房与社区的联合消费以及可达性的差异而变得复杂。本文聚焦于城市内部区位，根据经济理论，这与住房价格存在系统性关联。最终结论是，要描述平均住房价格水平和变化的充分统计量，需要将价格从相对同质的市场区域汇总，并按住房数量（如居住单元或内部空间）进行加权。常见的重复销售指数和特征价格指数通常不采用这种加权方式，但可以进行修改以实现这一点。

【**NBER**】: NBER Working Paper No. 35144，https://www.nber.org/papers/w35144

#### 21. How Artificial Intelligence Shapes Science: Evidence from AlphaFold {#35143}

【**Author**】: Ryan R. Hill, Carolyn Stein
...
【**摘要**】：我们通过研究AlphaFold2算法的发布及其对结构生物学及相关科学领域的影响，来考察前沿AI模型如何影响科学发现。结构生物学是致力于理解蛋白质结构与功能的科学领域。该领域的研究人员历史上投入了大量时间和资源，通过实验方法解析三维蛋白质结构。AlphaFold无需进行实验即可预测这些结构。2021年7月，研究人员几乎在一夜之间获得了数十万个由AI预测的结构。然而，迄今为止，我们发现实验性结构测定的速率几乎保持不变。相反，研究人员似乎利用预测结构来促进和补充实验性结构测定。着眼于建立在蛋白质结构基础上的下游科学，我们发现，与在AlphaFold之前已有结构信息的蛋白质相比，针对此前无结构信息的蛋白质的基础研究增加了15%至40%，从而将研究方向转向了研究较少的蛋白质。然而，我们迄今未发现证据表明，更应用性的、早期的药物开发正在针对这些蛋白质，尽管这种活动未来可能会出现。

【**NBER**】: NBER Working Paper No. 35143，https://www.nber.org/papers/w35143

#### 22. Seeing the Goal, Missing the Truth: Human Accountability for AI Bias {#35142}

【**Author**】: Sean S. Cao, Wei Jiang, Hui Xu
...
【**摘要**】：本研究探讨了人类定义的目标如何通过目的条件化认知影响大型语言模型的行为。利用金融预测任务，我们表明，揭示LLM输出的下游用途（例如，预测股票收益或盈利）会导致LLM生成有偏见的情绪和竞争度量指标，尽管这些指标本应独立于下游任务。感知目标的提示将这些中间指标转向所披露的下游目标，产生了样本内过拟合。具体来说，目的泄露提高了在LLM知识截止日期之前数据上的表现，但在截止日期之后没有提供任何优势。这种偏见足够强，以至于对提示指令进行正则化也无法完全解决这种形式的过拟合。我们进一步表明，这种偏见可能源于用户无意中暗示了目的的对话上下文。总体而言，我们记录到，由于“看见目标”导致的AI偏见并非算法缺陷，而是源于研究设计中人类应负的责任。

【**NBER**】: NBER Working Paper No. 35142，https://www.nber.org/papers/w35142

#### 23. The Microstructure of AI Diffusion: Evidence from Firms, Business Functions, and Worker Tasks {#35141}

【**Author**】: Kathryn Bonney, Cory L. Breaux, Emin Dinlersoz, Lucia S. Foster, John C. Haltiwanger, Aditya A. Pande
...
【**摘要**】：利用来自2026年美国人口普查局商业趋势与展望调查AI补充模块的、具有全国代表性的新颖数据，我们在三个层面描述了AI的扩散特征：企业层面的采用、业务职能层面的部署以及工人任务层面的使用。在2025年11月至2026年1月期间，18%的企业在至少一项职能中使用了AI（按就业加权为32%），预计采用率将在六个月内达到22%。AI的使用集中在大型企业和知识密集型行业，在信息业、专业服务业和金融业的超大型企业中，采用率达到50%-60%（按就业加权为60%-70%）。在采用者中，范围仍然有限：57%的企业在三个或更少的职能中使用AI，最常见的是销售与营销（52%）、战略（45%）和信息技术（41%）。在23%（按就业加权为41%）的企业中出现了工人层面的使用，主要用于写作、文档分析和信息搜索；65%的企业将使用限制在三个或更少的任务上。证据表明存在自上而下和自下而上的扩散：工人使用可能发生在没有企业采用的情况下，反之亦然。大多数企业（66%）将AI用于任务增强，而裁员的情况很少见（2%）。回归结果显示，企业绩效与AI整合广度之间存在正相关关系。然而，一旦控制了这些因素，职能部署和运营投资与就业下降相关，而工人任务使用则不然。

【**NBER**】: NBER Working Paper No. 35141，https://www.nber.org/papers/w35141

#### 24. Who Marries Whom? The Role of Segregation by Race and Class {#35140}

【**Author**】: Benjamin Goldman, Jamie Gracie, Sonya Porter
...
【**摘要**】：美国人很少与自身种族或阶级群体之外的人结婚，这种模式对不平等和代际流动性具有充分记录的影响。有限的接触——即与其他群体成员的互动——可能部分解释了这些低水平的群体间通婚率。我们利用童年邻里间的变异，基于其他种族和阶级群体是否有更多年龄相近的异性儿童，来对接触进行工具变量估计。接触增加了跨阶级（高和低父母收入）婚姻，但对跨种族（白人和黑人）婚姻没有可检测到的影响。一个空间婚姻市场模型预测，居住隔离——接触的众多形式之一——解释了超过三分之一的阶级婚姻匹配，但仅解释了不到5%的种族婚姻匹配。

【**NBER**】: NBER Working Paper No. 35140，https://www.nber.org/papers/w35140

#### 25. Filling the Gaps with MICE: Addressing Missing Data in Real Estate Price Indices {#35139}

【**Author**】: Miriam Steurer, Sabrina S. Spiegel
...
【**摘要**】：缺失数据是用于构建特征房地产价格指数的微观层面交易数据的一个常见特征。缺失通常发生在质量调整所需的描述性特征中，而不是在交易价格中。由于这些特征是特征质量调整的核心，完整案例分析会通过样本选择和构成效应扭曲所衡量的价格动态。本文提出将多重插补作为处理指数构建中缺失特征值的一种方法。其目的不是恢复单个缺失值，而是恢复不完整的观测值并减少估计样本中的变异性。我们采用链式方程多重插补（MICE）作为一个灵活的插补框架。由于传统的多重插补聚合规则，即鲁宾规则，与价格指数的乘法链式结构不一致，我们引入了一种基于汇总增长率的替代聚合方法。来自两个应用的经验证据——一个包含维也纳公寓交易的大型数据集和一个规模较小、异质性更强的奥地利写字楼市场——表明，在大型、同质的环境中，指数估计对缺失数据相对稳健。相比之下，在更薄、异质性更强的市场中，插补会显著影响指数动态。在这两种环境中，具有丰富预测变量集的灵活MICE规范比更简单的插补方法表现更好。

【**NBER**】: NBER Working Paper No. 35139，https://www.nber.org/papers/w35139
...
【**摘要**】：工人能动性——工人对组织决策的影响力——是员工敬业度、生产力和组织文化的一个常被引用的决定因素。我们在印度进行了一项企业层面的随机对照试验，随机分配员工表彰及相关奖金的分配方式：基于工人投票（能动性处理）、由经理自由裁量（管理层自由裁量处理）、或随机分配且与绩效无关（对照组）。我们发现，工作场所民主提高了工人的出勤率，但管理层自由裁量权提高了生产力。这对公司文化和知识溢出也有影响，管理层组减少了工人之间与工作相关的讨论。管理层组的获胜者在出勤率和生产力方面是正向选择的，而民主组的获胜者在出勤率、社交互动以及为换取选票而与同事分享奖励的可能性方面是正向选择的。这些结果突显了工作场所所重视的东西如何影响工人行为和企业文化，以及工人之间的非正式合同与工作场所激励相互作用的可能性。

【**NBER**】: NBER Working Paper No. 35138，https://www.nber.org/papers/w35138

#### 27. Till the IRS Do Us Part: (Optimal) Taxation of Households {#35137}

【**Author**】: Hans A. Holter, Dirk Krueger, Serhiy Stepanchuk
...
【**摘要**】：本文认为，累进税制与已婚夫妇的个人征税相结合，可以比当前基于家庭的美国税制产生更多收入，特别是当额外收入不会通过增加的政府转移支付引发负面的劳动力供给效应时。一个对个人而非夫妇联合征税的累进税制会导致更高的劳动力参与率和更高的平均人力资本，创造更多的“财政空间”，拉弗曲线向上移动，社会福利可能上升。在我们的包含单职工和双职工家庭、人力资本和广泛边际劳动力供给决策的模型中，基于个人的累进税制下的拉弗曲线峰值比当前美国税制高出18个百分点。最大收入是在比当前制度高出100%的累进性下实现的，平均税率为42%。当对个人而非家庭征收累进税时，它降低了处于参与边际附近的潜在收入适中的个人的平均税率。同时，它通过减少这些个人中高收入配偶的净收入，并在高临时劳动生产率的情况下限制其净收入潜力，对这些个人的劳动力供给产生了正向收入效应。稳态社会福利在个人征税下更大。最优累进性高于当前美国的现状，并导致以消费等价变化衡量的福利收益为0.8%。在转型期间出生的群体也从这项改革中获得了显著的福利收益。

【**NBER**】: NBER Working Paper No. 35137，https://www.nber.org/papers/w35137

#### 28. The State-Contingent Debt Premium: Evidence from French Public Bonds {#35136}

【**Author**】: Kris James Mitchener, Gonçalo A. Pina
...
【**摘要**】：状态依存债务（SCD）工具已被提议作为主权债务市场的改进，但其发行成本尚不明确。我们采用准孪生债券策略，利用1956年发行的两种非常相似的法国政府债券——一种传统债券和一种息票与工业生产挂钩的状态依存债券——来估计发行时及此后十多年的SCD溢价。在发行时，SCD债券的预期收益率比其孪生债券高出77个基点。由于事后法国经济的强劲增长，发行时实现的SCD溢价大约是其两倍（146个基点）。然而，状态依存债券不断上涨的市场价格到1964年将这两个利差都降至零。在1968年5月一场意外的大罢工（显著降低了法国工业生产）之后，利差再次上升；然而，到1970年，SCD溢价已降至接近零的值。

【**NBER**】: NBER Working Paper No. 35136，https://www.nber.org/papers/w35136

#### 29. The Value of Reliable Statistics {#35135}

【**Author**】: Nicholas Bloom, Erica L. Groshen, Duncan Hobbs, Michael R. Strain
...
【**摘要**】：2025年8月1日，特朗普总统解雇了美国劳工统计局（BLS）局长，并声称该机构的数据被“操纵”。此后，经济政策不确定性指标急剧上升，这与对官方数据信任度降低会增加投资者、企业和家庭不确定性的观点一致。我们使用事件研究设计来估计此次解雇对政策不确定性的影响，然后将这种不确定性的增加映射为隐含的宏观经济结果。这得出了对官方统计中公众信任边际价值的粗略估计。我们的基准估计表明，维护对官方统计完整性和质量的信任所产生的经济效益约为该机构预算每花费1美元对应25美元。

【**NBER**】: NBER Working Paper No. 35135，https://www.nber.org/papers/w35135

#### 30. Taxes and Financial Distress: Evidence from Establishment-Level Data {#35134}

【**Author**】: Mara Faccio, Stefano Manfredonia
...
【**摘要**】：我们使用机构层面数据来检验公司税与财务困境之间的关系。利用边界断点设计，我们记录了较高的公司所得税税率会显著增加财务困境，特别是对于地理上集中的公司，并且在各机构之间存在显著的溢出效应。我们进一步利用2017年《减税与就业法案》引入的利息限制规则，研究了税收如何影响机构层面的财务困境。使用双重差分设计，我们发现受影响的公司经历了财务困境的下降。这是因为债务税收优势的减少促使公司去杠杆化，通过资本结构调整减少了财务困境。

【**NBER**】: NBER Working Paper No. 35134，https://www.nber.org/papers/w35134

#### 31. Technology Adoption and Optimal Policy {#35133}

【**Author**】: Fernando E. Alvarez, Francisco J. Buera, Nicholas Trachter
...
【**摘要**】：我们研究了一个动态一般均衡模型中的最优政策，在该模型中，异质性垄断竞争企业支付固定成本以采纳外生增长的前沿技术。使用平均场博弈工具，我们表明最优政策恰好由两个时不变的补贴组成：一个纠正来自市场势力的静态错配，另一个纠正动态的采纳激励不足。这在平衡增长路径之外，对于任何初始的技术差距分布都成立。我们分析了该模型的一个简化版本，当互补性很强时，该版本汇总为一个具有S形生产函数的新古典增长模型，并完全刻画了最优政策何时唯一地实现第一最优。当它不能时，会出现两个新颖的结果：有效配置规定要摆脱贫困陷阱——为大推动提供了明确的最优性基础——以及更令人惊讶的是，摆脱丰裕陷阱，在这种情况下，拆除已采纳的技术是最优的。在这两种情况下，一项临时的、无成本的补充政策可以恢复唯一的实施。

【**NBER**】: NBER Working Paper No. 35133，https://www.nber.org/papers/w35133

#### 32. The Effects of School Phone Bans: National Evidence from Lockable Pouches {#35132}

【**Author**】: Hunt Allcott, E. Jason Baron, Thomas Dee, Angela L. Duckworth, Matthew Gentzkow, Brian Jacob
...
【**摘要**】：美国各地的学校已严格限制学生在校期间使用手机。我们评估了一种限制措施——可锁手机袋——使用结合大规模调查、GPS定位、标准化考试成绩和学校行政记录的全国性数据，以及来自最大袋式供应商的销售记录。使用交错双重差分设计，我们发现采用手机袋显著减少了通过GPS定位和教师报告衡量的手机使用。在采用后的第一年，纪律事件增加，学生主观幸福感下降，这与短期干扰一致。然而，对幸福感的影响在后续年份变为正向，纪律效应逐渐消失。在学业成绩方面，对考试成绩的平均影响始终接近于零。高中看到了适度的正向效应，特别是在数学方面，而初中则看到了微小的负向效应。我们几乎没有发现对学校出勤率、自我报告的课堂注意力或感知到的网络欺凌有影响的证据。

【**NBER**】: NBER Working Paper No. 35132，https://www.nber.org/papers/w35132

#### 33. Wind Turbine Proximity and Health: Longitudinal Evidence from U.S. Households {#35131}

【**Author**】: Niklas Rott, Douglas Almond, Osea Giuntella
...
【**摘要**】：风能的快速增长在全球减少碳排放的努力中发挥着关键作用，然而公众对其潜在健康影响（尤其是通过噪音暴露）的担忧依然存在。虽然一些研究和媒体报道表明，风力涡轮机可能导致睡眠障碍、焦虑甚至自杀，但现有证据仍然有限且尚无定论。本研究将美国风力涡轮机数据库中的地理定位数据与超过12万个家庭（2011-2023年）的纵向调查数据以及消费者购买记录相结合，以评估靠近风力涡轮机是否会影响心理和身体健康。我们考察了广泛的结果，包括抑郁、焦虑、睡眠障碍、头痛以及助眠药和止痛药的使用。通过比较附近涡轮机安装前后的家庭，我们发现，在典型的暴露距离下，涡轮机暴露并未带来可检测的不良健康影响。虽然我们不能排除微小的影响，但我们的置信区间排除了中等到较大的影响，这表明对重大健康影响的担忧并未在人口层面的数据中得到证实。即使没有可测量的健康影响，噪音、阴影闪烁和视觉侵入等其他不舒适因素仍可能影响生活质量。

【**NBER**】: NBER Working Paper No. 35131，https://www.nber.org/papers/w35131

#### 34. The Success of the Embedded State in England {#35130}

【**Author**】: Leander Heldring, Davis Kedrosky, James A. Robinson, Matthias Weigand
...
【**摘要**】：许多国家在缺乏资助现代官僚机构所需财政资源的情况下，却展现出高度的国家能力。我们认为，它们通过利用其所治理社会的社会结构特征，激励个人无偿从事官僚和治理任务来实现这一点。我们利用1835年英国城市政府的一项独特调查，发展并阐释了“嵌入式国家”的概念。由于英国地方当局资源匮乏，只有三分之二的职位是有薪的。我们首先表明，无薪职位的生产力显著高于有薪职位。然后我们表明，无薪职位具有声望，是“跳板”职位，提供了不同的在职激励，并且由社会经济精英担任。我们还表明，成功的嵌入式国家存在裙带关系和腐败，并且无法完全激励无薪官僚执行繁重的任务。

【**NBER**】: NBER Working Paper No. 35130，https://www.nber.org/papers/w35130

#### 35. Labor Market Impacts of ICE Activity in Trump 2.0 {#35129}

【**Author**】: Elizabeth Cox, Chloe N. East
...
【**摘要**】：我们提供了关于特朗普第二届政府期间加强移民执法对劳动力市场影响的首次因果性、全国性实证分析。执法力度在全国范围内都有所增加，但我们利用各地区增幅不均这一事实，将地区划分为处理组和对照组，然后实施事件研究和双重差分设计。与逮捕增幅较小的地区相比，逮捕数量增幅特别大的地区，留在美国的疑似无证移民的就业率有所下降。我们没有发现对美国本土出生的工人产生正向溢出效应的证据，并且在移民密集型行业工作的美国本土出生的工人受到了损害。

【**NBER**】: NBER Working Paper No. 35129，https://www.nber.org/papers/w35129

#### 36. Complementary Climate Policies for Supply and Demand {#35128}

【**Author**】: Geir B. Asheim, Bård Harstad
...
【**摘要**】：气候政策的传统方法是监管需求侧，例如通过排放费。供给侧监管受到的关注较少。这两种工具在一阶最优情况下是完全替代品，但我们表明，在存在搭便车激励的二阶最优情况下，它们是互补品。仅靠需求侧政策会降低化石燃料的市场价格，并提高违约国家的贸易收益。为了使条约具有最大程度的稳健性、强约束力和自我执行性，它必须适当平衡供给侧和需求侧工具。这一结果在同质国家中成立，并且因异质性而得到加强。

【**NBER**】: NBER Working Paper No. 35128，https://www.nber.org/papers/w35128

#### 37. Monetary Policy According to Households: Perceptions, Reactions and Channels {#35127}

【**Author**】: Francesco Grigoli, Damiano Sandri, Yuriy Gorodnichenko, Olivier Coibion
...
【**摘要**】：本文研究家庭如何感知货币政策的传导，以及这些认知如何影响他们的决策。通过对超过25,000个美国家庭的大规模调查，并结合随机信息实验，我们衡量了家庭预期联邦基金利率变化将如何影响经济状况和他们自身的行为。家庭报告称，更高的利率导致他们减少支出，尤其是在耐用品上。然而，这种反应背后的机制与标准宏观经济模型中的机制存在显著差异。受访者预期货币紧缩会提高借贷成本和通货膨胀。反过来，利用信息实验估计的消费函数显示，家庭通过减少消费来应对更高的预期通胀。家庭通胀预期也显现为货币政策变化后投资组合重新配置的核心驱动因素。

【**NBER**】: NBER Working Paper No. 35127，https://www.nber.org/papers/w35127

#### 38. Industrial Policy with Development Characteristics: Fertilizer Policy in Times of Crisis {#35126}

【**Author**】: Wyatt Brooks, Kevin Donovan
...
【**摘要**】：我们研究了当未多元化的自营农户面临金融摩擦且政策制定者工具有限时的时间一致最优政策。我们将其应用于肥料补贴，这是发展中国家最大的特定部门政策工具之一，其价格正变得越来越不稳定。我们收集了2020年至2024年卢旺达444个农村村庄的家庭层面数据，并利用了俄罗斯入侵乌克兰后肥料价格翻倍的情况。与肥料密集度较低的村庄相比，肥料密集度较高的村庄的肥料支出低30%，收成低21%，产出价格高11%。这些模式约束了关键模型的弹性。最优反应平衡了将生产重新分配到对肥料依赖程度较低的村庄的愿望，同时减轻了对肥料依赖程度较高的村庄的消费损失。从数量上看，这些力量相互抵消，补贴在冲击前后仍保持在10%。

【**NBER**】: NBER Working Paper No. 35126，https://www.nber.org/papers/w35126
...
【**摘要**】：本章回顾了关于文化规范起源、持续和演变方面日益增长的文献。我首先考察了塑造文化规范形成的深层历史力量，特别关注地理、前工业社会特征、政治制度和历史冲击的作用。然后，我分析了文化规范持续和演变的机制，强调了垂直、水平和斜向传播的作用。接下来，我审视了文化与制度之间复杂的相互作用，并讨论了文化规范发生变化的条件。得出了几个结论。文化规范往往在相当长的时期内持续存在，尽管变化的速度在不同特征之间差异显著。植根于深层历史价值观的规范最难以改变，而与亲社会性和再分配相关的态度则适应得更快。理解文化规范的起源和持续对政策具有重要启示：未能考虑当地文化背景的政策可能无效或产生意想不到的后果，而设计良好的干预措施可以成功改变文化规范。最后，我讨论了关于文化错配（即在历史环境中具有适应性的规范在新环境中变得不适应的情形）日益增多的证据，并概述了未来研究的方向。

【**NBER**】: NBER Working Paper No. 35125，https://www.nber.org/papers/w35125

#### 40. Rental Prices and the Cost of Living in the United States, 1914–2006 {#35124}

【**Author**】: Ronan C. Lyons, Allison Shertzer, Rowena Gray
...
【**摘要**】：美国劳工统计局（BLS）构建的主要住所租金（RoPR）序列表明，从1914年到2006年，名义租金价格年均仅增长2.6%，而整体价格年均增长3.3%。我们表明，这种“实际租金下降”之谜可以通过消费者价格指数（CPI）中住房处理方式的演变来解释。在本文中，我们利用历史住房价格（HHP）项目租金指数构建了一个新的、方法上一致的住房价格序列。我们还构建了一套可追溯至1914年的修订版住房权重，并将其与价格序列相结合，创建了一个替代性CPI，该CPI在时间上一致地应用了业主等价租金（OER）的住房概念。HHP住房价格序列增长了28.4倍（而RoPR增长了10.7倍），并将CPI的平均年增长率从3.3%提升至3.6%。修订后的序列消除了CPI中实际租金的长期下降趋势，并为评估20世纪美国生活成本和实际收入的趋势提供了新的基准。

【**NBER**】: NBER Working Paper No. 35124，https://www.nber.org/papers/w35124
...
【**摘要**】：本文回顾了关于人工智能的企业层面数据以及人工智能经济影响的新兴证据。文章认为，度量是关键：不同的人工智能数据集捕捉不同的对象（包括发明与使用、内部能力建设与外包、已实现的活动与投资者的认知），因此可能导致不同的结论。本文构建了一个在这些度量方法中进行选择的框架，并调查了关于企业人工智能努力的现有数据来源。文章综合了关于人工智能对企业增长、估值、生产率、风险、劳动力、竞争、金融市场和应用影响的证据。本文最后为未来研究提出了一些建议。

【**NBER**】: NBER Working Paper No. 35123，https://www.nber.org/papers/w35123

#### 42. Risky Insurance: Life-Cycle Insurance Portfolio Choice with Incomplete Markets {#35122}

【**Author**】: Joseph S. Briggs, Ciaran Rogers, Christopher Tonetti
...
【**摘要**】：我们利用新颖的调查数据和结构性生命周期模型，研究消费者对储蓄、人寿保险、年金和长期护理保险的需求。我们记录到，个体感知到显著的保险不支付风险，并且这些信念能预测保险持有情况。将引出的信念嵌入一个不完全市场模型，并加入额外的现实世界保险特征后，我们匹配了低参与率的经验模式。与无保险基准相比，获得现有不完美保险使中位数财富减少16%，并产生0.6%的适度福利收益。消除不支付风险将大幅增加保险持有量，使中位数储蓄进一步下降11%，并额外产生1.7%的福利收益。

【**NBER**】: NBER Working Paper No. 35122，https://www.nber.org/papers/w35122

#### 43. Comparative Advantage and Colonial Monopoly: The Political Economy of Exclusive Trading Companies {#35121}

【**Author**】: Sebastian Galiani, Ivan Lopez Cruz, Alessandra A. Palazzo, Gustavo Torrens
...
【**摘要**】：本文分析了一个核心的殖民制度：通过独家贸易公司垄断对外贸易。我们将这种安排解释为一种经济制度，它在国内价格与国际价格之间制造了一个楔子——实际上是一种出口税——使得宗主国的中间商能够从殖民贸易中榨取租金。我们的主要理论贡献在于证明，这种制度形式的经济和政治后果系统地取决于宗主国与殖民地之间的比较优势结构。虽然殖民地的出口税无疑会恶化殖民地的有效贸易条件，但其对宗主国的影响是有条件的。当殖民地和宗主国是竞争者——在相同部门拥有比较优势时——殖民地的出口税可以改善宗主国的贸易条件。相反，当它们是互补者——专门从事不同部门时——同样的政策可能因提高进口投入品的成本而恶化宗主国的贸易条件。由于这些贸易条件变动产生不同的分配效应，殖民垄断重塑了宗主国内部的政治联盟，影响着独家贸易公司是持续存在还是被废除。我们在一个简约的一般均衡模型中形式化了这一机制，并通过英国、印度和东印度公司的历史经验加以说明，将东印度公司呈现为更广泛制度逻辑的一个显著实例。

【**NBER**】: NBER Working Paper No. 35121，https://www.nber.org/papers/w35121

#### 44. Hysteresis and Selection in the Rise of Fascism: The ‘Ordinary Men’ of the Nazi Party {#35120}

【**Author**】: Luis Bosshart, Max Deter, Leander Heldring, Cathrin C. Mohr, Matthias Weigand
...
【**摘要**】：我们将国家社会主义德国工人党（NSDAP）的近乎全部成员记录数字化，并将其与人口和工业普查数据关联起来。出现了四个发现。首先，随着党的扩张，其成员在职业、人口统计和宗教特征上越来越接近更广泛的人口。其次，党卫军成员的特征仍然不同：更年轻、受教育程度更高、更狂热——以成员肖像中展示纳粹标志来衡量。第三，在社区、同事和家庭内部，早期成员身份产生了滞后效应，后续加入者来自相同的群体。最后，地方党内成员的增加与随后对德国犹太人的驱逐相关联。

【**NBER**】: NBER Working Paper No. 35120，https://www.nber.org/papers/w35120

#### 45. How Reform Happens {#35119}

【**Author**】: Simeon Djankov, Edward L. Glaeser, Andrei Shleifer
...
【**摘要**】：什么决定了监管改革是否以及如何进行？我们使用一个新建的数据集，涵盖2005年至2022年间189个国家的3,590次成功和失败的监管改革，来探讨这个问题。我们记录到，在某些监管领域，法规变得对商业更友好，但在其他领域则不然。我们还表明，富裕国家的法规比贫穷国家更有利于商业，并且，在初始监管水平不变的情况下，富裕国家也进行更多改革。我们提出了一个模型，其中改革的成功通过受到审批过程中的否决点数量、改革的社会回报以及补偿改革受损者的成本的影响，然后使用我们的新数据集对其进行检验。我们发现，富裕国家既有更高的改革尝试率也有更高的成功率，但每次改革对监管的影响小于贫穷国家。如果富裕国家更擅长改革，或许是因为它们能更有效地补偿受损者，那么这些发现与模型是一致的。在全球范围内，改革尝试率与改革成功率强相关，但与改革影响水平不相关。在国家内部，与技术性改革尝试相比，行政或法律改革的成功率较低，这与否决点的重要性一致。

【**NBER**】: NBER Working Paper No. 35119，https://www.nber.org/papers/w35119

#### 46. Gender-Specific Economic Shocks and Household Bargaining Power {#35118}

【**Author**】: Rania Gihleb, Osea Giuntella, Dor Morag
...
【**摘要**】：利用机器学习以及关于单身男性和单身女性消费模式的产品层面数据，我们构建了一个量化消费品“性别化”程度的指数。我们使用该指数来研究性别特定的劳动力市场冲击如何影响异性恋家庭内部的消费模式。我们的发现表明，工业机器人的采用——这恶化了男性的相对经济地位——使家庭消费转向了主要由单身女性购买的产品。相比之下，水力压裂法的扩张——这增加了对年轻和低技能男性的需求——提供了提示性但不太稳健的证据，表明在单身男性偏好的商品上的支出有所增加。尽管这两种冲击都没有显著改变儿童产品的总支出，但接触机器人导致支出重新分配，转向更常为女儿而非儿子购买的商品。

【**NBER**】: NBER Working Paper No. 35118，https://www.nber.org/papers/w35118

#### 47. Does Employment Slow Cognitive Decline? Evidence from Labor Market Shocks {#35117}

【**Author**】: Noah Arman Kouchekinia, David Neumark, Tim A. Bruckner
...
【**摘要**】：随着预期寿命的大幅增加，因认知衰退和痴呆导致的残疾人口比例显著上升。美国的许多老年人在65岁之前就离开了劳动力队伍。相关性证据表明，在退休年龄前离开劳动力队伍可能会加速认知衰退的速度。我们利用美国健康与退休研究（HRS）数据，将当地劳动力市场中看似外生的劳动力需求变化作为巴蒂克工具变量，来衡量这些市场中就业变化的因果效应。我们发现，负面的劳动力需求冲击导致认知得分随时间显著下降。这些发现集中在51至64岁的男性中，他们的就业决策和结果可能比女性或更年长男性对当地劳动力市场状况更敏感。我们的证据扩展了以往仅关注退休年龄窗口的研究，并进一步支持了“工作到更老年龄可能延缓与年龄相关的认知衰退”这一观点。

【**NBER**】: NBER Working Paper No. 35117，https://www.nber.org/papers/w35117

#### 48. Hedging Ambiguity with Pro-Social Preferences: an Illustration from Green Finance {#35116}

【**Author**】: Geoffrey Heal, Marcella Lucchetta
...
【**摘要**】：我们探讨了亲社会偏好如何与不对称模糊性相互作用，从而影响投资决策。我们构建了一个模型，其中财务回报是模糊的（例如，由于政策不确定性），而社会影响回报是有风险的或模糊性较低。运用Gilboa-Schmeidler最大最小和Klibanoff-Marinacci-Mukerji平滑模糊性框架，我们证明亲社会动机起到对冲作用，减轻了模糊厌恶，并降低了模糊资产的有效门槛收益率。这一机制解释了影响力投资在弥补环境资金缺口方面的韧性，并为混合融资和标准化如何将模糊性转化为风险提供了政策启示。与先前关于混合融资结构的研究不同，本研究强调了社会偏好在可持续金融中的行为对冲作用，对在多危机中加速公正转型具有启示意义。

【**NBER**】: NBER Working Paper No. 35116，https://www.nber.org/papers/w35116
...
【**摘要**】：我们研究了支付系统在由自然灾害和停电造成的数字基础设施大规模中断中的韧性。虽然发达经济体已迅速转向电子支付，但这些系统严重依赖电力和信息技术，引发了对其在危机期间可靠性的担忧。我们结合了高频县级停电数据与详细的天气记录、交易级支出数据、家庭扫描仪数据以及来自美国、西班牙和瑞典的新代表性调查。事件研究证据表明，自然灾害——尤其是飓风——会产生持续性的停电，从而急剧减少支出。自然灾害本身并不会改变家庭对支付方式的选择；相反，向现金的转变通过三个渠道发生：电子支付方式变得不可用，家庭出于预防性原因增加现金持有，以及现金在可用后被花掉（“现金消耗”）。与这些机制一致，支付构成发生了显著变化：由于囤积，支出在灾害前上升，这主要通过信用卡融资，而在灾害后，数字支付下降，现金使用增加，尤其是在经历停电的地区。调查证据证实，近一半的消费者在停电期间无法使用他们偏好的电子支付，而现金则作为关键的备用手段。利用不同家庭和地点之间现金持有量的差异，我们发现，更多的现金获取渠道增加了在停电期间完成交易的可能性，并缓解了支出下降。补充性的调查证据以及对我们信息处理的即时反应表明，停电和官方指导增加了期望的现金持有量。最后，我们在NielsenIQ面板中嵌入了一项随机对照试验：大约一半的面板家庭收到了权威的备灾指导，我们跟踪他们在随后飓风季节的实际购买情况。这一设计为因果识别更大的现金储备是否能在天气冲击期间平滑消费提供了一个清晰的框架。总之，本文的观察性、调查性和实验性部分表明，现金在支付系统中断期间维持经济活动方面发挥着关键作用，并指出了在日益数字化的经济中，包括央行数字货币在内的离线支付工具的价值。

【**NBER**】: NBER Working Paper No. 35115，https://www.nber.org/papers/w35115

#### 50. Intermediate Input Prices and the Labor Share {#35114}

【**Author**】: Juanma Castro-Vincenzi, Benny Kleinman

【**Abstract**】: We argue that the relative price of materials is an important determinant of the labor share of income. When materials and primary inputs are complements and the profit share is positive, a higher price of materials lowers the labor share and raises the profit share of value added, without requiring markups or returns to scale to change. We show that materials-price fluctuations align with U.S. labor-share trends, provide causal evidence on this mechanism across industries and commuting zones, and quantify its importance in a dynamic quantitative model. Finally, we use our mechanism to rationalize differential labor-share trends across countries.

【**摘要**】：我们认为，材料的相对价格是劳动收入份额的一个重要决定因素。当材料与初级投入品是互补品且利润份额为正时，材料价格上升会降低劳动份额并提高增加值中的利润份额，这并不需要加成率或规模报酬发生变化。我们展示了材料价格波动与美国劳动份额趋势相一致，提供了关于这一机制在行业和通勤区层面的因果证据，并在一个动态定量模型中量化了其重要性。最后，我们利用我们的机制来解释各国之间不同的劳动份额趋势。

【**NBER**】: NBER Working Paper No. 35114，https://www.nber.org/papers/w35114

#### 51. A Blended Data Approach to Measuring Monthly Housing Starts: Satellite Imagery, Survey Data and More! {#35113}

【**Author**】: Nicole Czaplicki, Colin J. Shevlin, Hector R. Ferronato, Aidan D. Smith, Dwarakh V. Nayam, Lei Peng, Scott W. Springer, Doren Walker
...
【**摘要**】：作为美国人口普查局全面建筑改造计划的一部分，正在考虑使用替代数据源来补充或取代当前的数据收集方法。对于衡量新建住宅建设的建筑调查（SOC），这包括通过卫星图像观察住房开工量，以取代目前由实地代表进行的住房开工量访谈。每月为SOC样本中的一部分地点获取卫星图像。然后，将卷积神经网络模型应用于图像，以预测可能的新建住宅建设项目，当前重点是单户住宅开工量。应用了几个预测后处理步骤，包括基于与已知建筑物或道路交叉点的排除、针对云层覆盖导致的数据缺失的处理，以及针对连续图像之间时间跨度的调整，最终生成地点层面的住房开工量估计值。然后，将这些地点层面的估计值与现有的建筑许可证层面调查数据相结合，以生成西中部分区层面的住房开工量估计值，这是人口普查局的一个实验性数据产品。

【**NBER**】: NBER Working Paper No. 35113，https://www.nber.org/papers/w35113

#### 52. The Effect of Choice Screens on Mobile Browser Usage: Evidence from the EU Digital Markets Act {#35112}

【**Author**】: Jesper Akesson, Kush Amlani, Raul Cepeda Suarez, Emily Chissell, Stefan Hunt, Michael Luca, Gemma Petrie
...
【**摘要**】：主动选择能否减轻预设默认值的影响？我们围绕欧盟《数字市场法案》的推出，采用双重差分设计来研究这个问题。该法案要求iOS和Android在某些条件下显示浏览器选择屏幕。我们发现了显著的影响，且不同平台之间存在显著差异：从强制令实施15个月后起，与无强制令的反事实情况相比，iOS上的Firefox使用量高出113%，Android上则高出12%。这一差距与推广差异一致，因为Android主要在新设备上显示选择屏幕，而iOS也在现有设备上显示。

【**NBER**】: NBER Working Paper No. 35112，https://www.nber.org/papers/w35112

#### 53. The Welfare Effects of Protecting Older Workers {#35111}

【**Author**】: Todd Morris, Stefan Staubli, Benoit Dostie
...
【**摘要**】：我们利用关联的雇主-雇员税收数据，评估了加拿大2005年至2009年五项省级强制退休禁令的福利效应。这些禁令显著减少了65岁时的退休情况，存在显著的公告效应和行业异质性。65岁后的就业和收入至少增长了14%，其收益相当于养老金领取年龄提高两岁。老年工人储蓄更多，配偶推迟退休，这有利于公共财政，而对死亡率或年轻工人没有可观察到的影响。受影响较大的公司通过调整招聘来降低工资成本，同时保持工人的生产率和盈利能力。我们的结果表明，保护老年工人改善了福利。

【**NBER**】: NBER Working Paper No. 35111，https://www.nber.org/papers/w35111

#### 54. Early Childcare Attendance and Cognitive skills in Adolescence {#35109}

【**Author**】: Ingvild Almås, Nina Drange, Costas Meghir, Henrik D. Zachrisson
...
【**摘要**】：本文基于2003年的一项政策扩张，该政策为1-2岁儿童创造了准随机的托位可用性，考察了早期托幼对五年级和九年级学生学业成绩的影响。提前一年开始接受托幼服务，可使九年级的数学成绩提高9.7%的标准差。母亲没有高中文凭的儿童在九年级时受益显著，成绩提高了28%的标准差，这将他们与母亲受教育程度较高的儿童之间的数学成绩差距缩小了约三分之一。我们还提供了移民子女成绩显著提高的证据。

【**NBER**】: NBER Working Paper No. 35109，https://www.nber.org/papers/w35109

#### 55. Effects of Expanding Contraceptive Choice: New Evidence from Virginia's Contraceptive Access Initiative {#35108}

【**Author**】: Jessica H. Kiser, Analisa Packham, Janelle Anthony, Evelyn Escobar, Emily Yeatts
...
【**摘要**】：2018年，弗吉尼亚州卫生部实施了避孕可及性倡议（CAI），以增加长效可逆避孕药具（LARCs）的可及性。我们使用参与CAI诊所的避孕选择就诊层面数据以及2014-2021年的县级出生数据，来估计CAI实施前后LARC使用率和生育率的相对变化。双重差分估计表明，CAI使参与县的出生率降低了约3%，不到其他类似州级项目效果规模的一半。我们表明，这种较小的效果很可能是由于已有的高LARC使用率和避孕替代效应。

【**NBER**】: NBER Working Paper No. 35108，https://www.nber.org/papers/w35108

#### 56. The Domestic Political Economy of War: Evidence from Russia {#35107}

【**Author**】: Alena Gorbuntsova, Gaurav Khanna, Sultan Mehmood
...
【**摘要**】：战争通常被描述为对外部威胁或地区力量平衡变化的回应。然而，它们也可以服务于国内政治目的。本文研究了俄罗斯对乌克兰的升级行动如何重塑了对政权的支持，并在人口中重新分配了战争负担。结合俄罗斯族裔比例与选举和独立民调数据，我们利用两次尖锐的地缘政治冲击——2014年吞并克里米亚和2022年全面入侵——采用双重差分事件研究设计。我们发现，在这两次事件之后，俄罗斯族裔人口比例较大的省份对普京总统的支持率急剧上升。与此同时，战场伤亡不成比例地落在俄罗斯族裔比例较低的地区，而对美国和欧盟的态度急剧恶化。在乌克兰方面，俄罗斯的攻击集中在俄罗斯族裔比例较高的地区，而不是资源丰富的省份。基于物质开采、苏联象征或对外部威胁的不同暴露程度的解释并不能解释这些模式。相反，证据更符合族裔认同在战争的国内政治经济学中发挥核心作用的观点。在经欺诈调整的选举结果、使用替代族裔衡量指标、在平行趋势假设有界偏离的情况下，以及在考虑了若干基线区域差异之后，我们的结论仍然相似。

【**NBER**】: NBER Working Paper No. 35107，https://www.nber.org/papers/w35107

#### 57. China's Global Ownership {#35106}

【**Author**】: Jennie Bai, Luc Laeven, Yaojun Ke, Hong Ru
...
【**摘要**】：我们研究了中国海外企业所有权的全球足迹及其实际影响。通过汇编涵盖159个国家161,773家企业的综合微观数据集（2012-2021年），我们独立重建了多层所有权链条，以追踪资本通过离岸避税天堂直至其最终来源。这一方法揭示的全球足迹远大于官方外国直接投资统计数据。中国控制的海外资产以每年20%的速度增长，到2021年达到2.1万亿美元，约占全球企业资产的3%。中国投资者——特别是国有企业——战略性地瞄准研发密集型和供应链关联企业。在收购后，目标企业增加了资本存量和研发支出，但这些投入未能产生更高的专利产出，并伴随着盈利能力的显著下降。我们记录了一种新颖的“创新回流”机制：虽然目标企业的创新保持停滞，但中国母公司在首次收购发达经济体企业后，其授权专利数量急剧加速增长。此外，中国企业的更大存在挤出了非目标同行企业的研发，尽管行业层面的总体创新保持不变。因此，中国代表了一种独特的国家驱动的全球所有权模式，该模式接受较弱的短期业绩，以在国内内化技术能力。

【**NBER**】: NBER Working Paper No. 35106，https://www.nber.org/papers/w35106

#### 58. Trends in Health Inequalities among Spanish Retirees {#35105}

【**Author**】: Cristina Bellés-Obrero, Manuel Flores Mallo, Pilar García-Gómez, Sergi Jimenez-Martin, Judit Vall Castelló
...
【**摘要**】：西班牙拥有全球最高的预期寿命之一且人口迅速老龄化，在维持其养老金、医疗保健和长期护理体系方面面临日益严峻的挑战。本研究利用欧洲健康、老龄化和退休调查的八轮数据，考察了2004年至2022年间西班牙退休人员健康不平等的趋势。我们分析了五项健康结果——日常活动限制和工具性活动限制、慢性病数量、综合健康缺陷指数、心理健康（EURO-D量表）和认知表现——并使用线性回归评估经年龄和性别调整后的收入相关梯度。我们还计算了一个追赶时间指标——一个较贫困个体需要多少年才能达到与较富裕个体相同的健康水平——以及不良健康的集中指数。然后，我们考察了这些不平等如何随时间变化，从而得以探索在西班牙贝弗里奇式医疗体系和税收资助的长期护理提供背景下养老金改革的潜在影响。我们的结果显示，没有明确证据表明健康不平等在2004年至2022年间有所加剧。这些发现有助于理解在老龄化社会中收入差距如何与社会保护体系相互作用，并为设计公平的健康、长期护理和养老金政策提供信息。

【**NBER**】: NBER Working Paper No. 35105，https://www.nber.org/papers/w35105

#### 59. Cross-Border Product Adoption: Individual Imports, Migrant Networks, and Domestic Retailers {#35104}

【**Author**】: David Argente, Esteban Méndez, Diana Van Patten
...
【**摘要**】：本文研究新产品种类如何进入市场并成为本地可获得的商品。我们提供了需求外部性的因果证据，该外部性分两步运作。首先，关于新产品种类的信息通过消费者之间的现实社会联系直接传播。其次，早期购买对企业产生间接溢出效应：本地零售商从“先驱”消费者那里了解到哪些新产品种类最有可能成功，并相应调整其产品供应。我们在直接面向消费者的进口背景下研究这一过程。利用匹配到全人口社交网络、国际移民联系和零售商辐射范围的个人购买海关记录，我们记录了具有经济意义的需求外部性。来自国外的产品特定需求冲击通过移民网络传播，并改变了消费者购买的产品种类。利用这些冲击作为看似外生的本地需求变化来源，我们展示了强大的同伴效应：邻居、同事或朋友之前的购买增加了个人购买相同种类的可能性，尤其是对于高端和可见商品。我们利用这一结果来识别从消费者到企业的间接溢出效应：当一种产品种类在其辐射范围内的消费者中变得流行时，零售商更有可能增加该种类。结合工具变量、关联的消费者-零售商数据以及自行开展的零售商调查，我们表明这种反应反映了对尚未本地库存的产品种类潜在需求的学习。社会扩散和零售商学习共同产生了需求乘数，重塑了本地产品供应并扩大了对全球产品种类的获取。

【**NBER**】: NBER Working Paper No. 35104，https://www.nber.org/papers/w35104

#### 60. Nudging Parents out the Door: The Impacts of Parental Encouragement on School Choice and Test Scores {#35103}

【**Author**】: Guthrie Gray-Lobe, Michael Kremer, Joost de Laat, Oluchi Mbonu, Cole Scanlon
...
【**摘要**】：本研究评估了一项针对肯尼亚私立小学学生看护人的大规模短信外联项目。使用两阶段随机化设计，我们测试了两种类型的每周短信：成长型思维鼓励和个性化表现信息。我们发现两个主要效应：首先，外联使考试成绩提高了0.07个标准差，在初始成绩较低的学生中效果尤为显著。这一改善使得每花费100美元可获得12个经学习调整的学年——相对于其他教育干预措施而言，这极具成本效益。其次，外联使学生离校率提高了4.7-5.0个百分点，其影响集中在成绩较高的学生中（5.7至6.6个百分点）。我们构建了一个垂直差异化学校的理论模型，其中家长参与既影响学习产出也影响学校选择。该模型表明，当家长通过参与项目更新对教育生产的理解时，他们对感知到的学校质量差异变得更加敏感。这种增强的敏感性可能导致质量较低的学校放弃实施参与项目——即使项目是免费的——因为家长辨别力的提高加速了学生离校。我们的研究结果表明，在竞争性教育市场中，由第三方提供家长参与项目具有一定作用。

【**NBER**】: NBER Working Paper No. 35103，https://www.nber.org/papers/w35103

#### 61. The Macroeconomic Effects of Tariffs: Insights from 180 Years of U.S. Trade Policy {#35102}

【**Author**】: Tamar den Besten, Regis Barnichon, Diego R. Känzig, Aayush Singh
...
【**摘要**】：我们利用1840-2024年的美国历史数据研究关税政策的宏观经济效应。我们构建了一个看似外生的关税变化叙事序列——基于重大立法行动、多边谈判和临时附加费——并将其用作工具变量来识别结构性关税冲击。关税上调是收缩性的：进口急剧下降，出口滞后下降，产出和制造业活动持续下降。冲击通过供给和需求两个渠道传导。在全样本中价格上涨，但在二战后价格下跌，这一模式与货币政策反应的变化以及现代贸易体制中更强的国际报复和互惠性相一致。

【**NBER**】: NBER Working Paper No. 35102，https://www.nber.org/papers/w35102

#### 62. The Political Economy of Financial Crises {#35101}

【**Author**】: Charles W. Calomiris, Matthew S. Jaremski
...
【**摘要**】：尽管有证据表明许多金融危机是可预测和可预防的，但它们仍然是现代经济中反复出现的特征。本章讨论了金融不稳定如何常常反映一种政治均衡，而非纯粹的技术性缺陷。通过对比经济学和政治学对监管的看法，本章强调了政策制定者如何以有利于政治上有影响力的群体但导致金融脆弱性的方式制定金融规则。关键机制包括限制银行特许经营、安全网、信贷补贴和主权借贷。政治力量也塑造了危机管理。延迟干预、选择性支持和受限的政策反应可能加深和延长危机。这些动态共同有助于解释金融不稳定在不同时期、法律渊源、政治结构和制度背景下的持续性和可预见性。与其将金融危机视为源于对外部冲击不可避免的脆弱性，不如将其视为其所发生社会的一面镜子，反映其政治结构、竞争的利益群体、文化偏好和盲点。

【**NBER**】: NBER Working Paper No. 35101，https://www.nber.org/papers/w35101
...
【**摘要**】：本文量化了美国数据中心电力消费相关的环境外部性，重点关注本地空气污染和温室气体排放造成的损害。利用2025年约2,800个运营数据中心的设施级数据，结合电网特征和排放数据，该分析通过AP4综合评估模型估算污染影响，并应用碳的社会成本进行温室气体估值。结果表明，数据中心消耗约250太瓦时的电力——约占美国发电量的5-6%——并产生约250亿美元的总外部损害，范围在100亿至330亿美元之间。这些损害在地理上高度集中，德克萨斯州和弗吉尼亚州占全国总量的30%。虽然总外部损害约占行业GDP的5%，但这一比例在各州之间差异很大，在某些地区甚至超过GDP。计划中的数据中心扩张可能在短期内使电力需求和相关损害增加高达85%。尽管存在这些环境成本，初步比较表明，与人工智能相关的能源使用所造成的损害相对于潜在的生产率提升而言较小。

【**NBER**】: NBER Working Paper No. 35100，https://www.nber.org/papers/w35100

#### 64. Organizational Targets in General Equilibrium {#35099}

【**Author**】: Joel P. Flynn, George Nikolakoudis, Karthik A. Sastry
...
【**摘要**】：我们构建了一个一般均衡模型，其中企业内生地选择是以价格还是数量为目标。我们描述了这些组织目标的选择如何取决于企业对微观经济和宏观经济因素的不确定性。在均衡中，名义冲击和实际冲击的传导都取决于企业的组织目标。例如，在其他微观基础相同的情况下，货币在数量目标下是中性的，而在价格目标下是非中性的。我们进一步描述了目标如何塑造企业的战略互动，并证明每种目标选择所产生的宏观经济不确定性会强化选择该目标的激励。也就是说，组织目标的选择是战略互补的。因此，旨在稳定经济的货币政策可能适得其反，引发使其失效的体制转变。一个简单的量化表明，组织目标的激励可能在商业周期频率上发生显著变化，并有助于解释货币冲击对价格和产出的状态依赖传导。

【**NBER**】: NBER Working Paper No. 35099，https://www.nber.org/papers/w35099

#### 65. Treasury Supply Shocks: Propagation Through Debt Expansion and Maturity Adjustment {#35098}

【**Author**】: Huixin Bi, Maxime Phillot, Sarah Zubairy
...
【**摘要**】：美国历史高位的债务与GDP之比引发了对未来金融市场稳定性和财政可持续性的担忧。我们使用高频数据，并考虑拍卖公告发布前后狭窄窗口内的国债期货价格变化，以识别两种不同的国债供给冲击：捕捉公共债务水平变化的债务数量冲击，以及反映期限结构变化的期限调整冲击。我们发现，债务扩张冲击通过提高期限溢价来推高整个收益率曲线上的收益率，导致金融状况收紧。这些冲击通过减少投资和生产来挤出私营部门活动，尤其是在债务快速增长时期。相比之下，期限延长冲击使收益率曲线变陡，同时降低了信用风险溢价和财政不确定性。通过降低风险溢价，这些冲击刺激了短期投资和生产，即使较高的长期借贷成本对长期投资构成压力。我们还表明，国债债务管理政策可以与美联储的资产购买计划产生有意义的互动。

【**NBER**】: NBER Working Paper No. 35098，https://www.nber.org/papers/w35098

#### 66. Health Inequalities among Retirees in the Netherlands {#35097}

【**Author**】: Adriaan Kalwij, Arie Kapteyn
...
【**摘要**】：在荷兰，过去二十年预期寿命持续上升，死亡年龄的分布范围缩小，这表明健康不平等有所减少。然而，在同一时期，收入-死亡率梯度却增加了，这表明健康收益在收入分配中的分布并不均衡。我们使用欧洲健康、老龄化和退休纵向调查的荷兰数据来检验后一种观点。我们的实证研究结果显示，在过去二十年中，基于收入的身体和心理健康不平等没有显著变化。可以说，在得出确切结论之前，需要更大的样本（例如常用于分析收入-死亡率梯度的行政数据）来更详细地研究身体和心理健康不平等的演变。

【**NBER**】: NBER Working Paper No. 35097，https://www.nber.org/papers/w35097

#### 67. Declining Occupations and Career Outcomes in Norway {#35096}

【**Author**】: Erling Barth, Maria Forthun Hoen, Sari Pekkala Kerr, William R. Kerr
...
【**摘要**】：职业变化是现代劳动力市场的一个核心特征。本文研究了在挪威，最初受雇于一个随后在2007-2024年间衰落的职业所带来的职业后果。最初受雇于后来至少衰落25%的职业的工人，其未来的工作年限减少了0.4年，尽管这种就业差异主要可由其他个人特征解释。在控制其他因素后，这些工人相对于起始收入的未来累计收入减少了4.7%，相当于在2007-2024年间损失了一年的收入。

【**NBER**】: NBER Working Paper No. 35096，https://www.nber.org/papers/w35096

#### 68. Homemade Foreign Trading {#35095}

【**Author**】: Zhiguo He, Yuehan Wang, Xiaoquan Zhu
...
【**摘要**】：利用中国沪深港通所有托管机构的跨境持股数据，我们提供了证据表明中国内地内部人士通过该计划进行往返交易以规避穿透式监管。在2018年北向投资者识别码制度改革之后，北向资金流动的回报可预测性下降，其与内幕交易的相关性也随之减弱。这种减少在那些不太知名的外资托管机构和跨境经营的内地托管机构中尤为明显，内部人士更有可能在这些机构中隐藏交易。此外，该改革削弱了价格信息含量，尤其是在那些对自制外资投资者敞口较高的股票中。我们的分析强调了资本市场一体化中监管合作的作用。

【**NBER**】: NBER Working Paper No. 35095，https://www.nber.org/papers/w35095

#### 69. Changes in Health Inequalities among Older Individuals in Japan {#35094}

【**Author**】: Takashi Oshio, Satoshi Shimizutani
...
【**摘要**】：本研究考察了2001年至2022年间日本老年人中与收入相关的健康不平等如何变化。过去二十年见证了一系列公共养老金改革以及老年人劳动参与率的提高。在老年男性中，良好健康向富人集中的现象在自评健康和日常生活活动能力方面变得不那么明显。然而，男性中与收入相关的压力/焦虑不平等随时间增加，而在健康缺陷或健康状况方面没有观察到明显趋势。与男性相比，女性的结果更为复杂，在健康缺陷和健康状况方面的不平等有所扩大。

【**NBER**】: NBER Working Paper No. 35094，https://www.nber.org/papers/w35094

#### 70. The Inefficient Pricing of News {#35093}

【**Author**】: Antoine Didisheim, Bryan T. Kelly, Mohammad Pourmohammadi, Hanqing Tian

【**Abstract**】: The stock market fails to efficiently process information in news text (Chen et al., 2026). But news itself is highly predictable by prevailing stock characteristics, which complicates inferences about market efficiency. After purging news of its predictable content, the remaining “pure news” more than doubles the monthly return predictive power of raw news, and it continues to significantly predict returns up to 18 months ahead. The magnitude and longevity of the pure news anomaly is greater than those of every anomaly in the Jensen et al. (2022) universe. It derives from negative-tone and quantitative topics to which investors underreact and from high-attention and ambiguous topics to which investors overreact.

【**摘要**】：股票市场未能有效处理新闻文本中的信息（Chen et al., 2026）。但新闻本身在很大程度上可由当前的股票特征预测，这使关于市场有效性的推断变得复杂。在剔除新闻中可预测的内容后，剩余的“纯新闻”使原始新闻的月度回报预测能力提高了一倍以上，并且它能在长达18个月的时间内持续显著预测回报。纯新闻异象的幅度和持久性超过了Jensen等人（2022）研究范围内所有异象。它源于投资者反应不足的负面情绪和量化主题，以及投资者反应过度的高关注度和模糊主题。

【**NBER**】: NBER Working Paper No. 35093，https://www.nber.org/papers/w35093

#### 71. The Medical Expansion, Life Expectancy, and Endogenous Directed Technical Change {#35092}

【**Author**】: Leon Huetsch, Dirk Krueger, Alexander Ludwig
...
【**摘要**】：我们构建了一个统一的量化理论，用以解释过去两个世纪中成人预期寿命和收入增长的同时增加，以及20世纪现代健康部门的出现。我们将数据解释为动态均衡的三个阶段：最初家庭贫困，健康商品价格高得令人望而却步，预期寿命停滞不前。随着技术进步推动收入增长，家庭在19世纪上半叶开始消费基本健康商品，预期寿命上升。100年后，进一步的定向技术进步导致了现代健康部门的出现。根据该模型的视角，1940年至2020年间，经质量调整的现代健康商品相对价格每年下降约2.5%，而模型隐含的未经质量调整的相对价格则与BEA健康价格指数同步上升。反事实分析表明，1940年至2020年间成人预期寿命的增长中，近四分之一归因于现代健康的出现和扩张，而二战期间公共健康研发支出在现代健康部门的启动中发挥了重要作用。

【**NBER**】: NBER Working Paper No. 35092，https://www.nber.org/papers/w35092
...
【**摘要**】：创始人何时应该基于对某个机会的强烈信念采取行动，同时知道评估同一机会的竞争对手可能持有截然不同的观点？本文研究了当企业家对某个机会的价值持有异质性信念，且每位创始人只知道竞争对手可能持有的观点范围时的进入决策。在均衡状态下，只有当创始人的信念强度超过由预期竞争对手乐观程度设定的阈值时，他们才会进入。信念分散与进入之间的关系出人意料地丰富：取决于创始人的信念强度和进入成本，可能不存在任何支持进入的分散水平，所有水平都可能支持进入，或者只有中间范围支持进入，以至于外部观察者可能会看到在中等信念分散水平下进入最多。当创始人可以延迟进入时，阻止立即进入的高分散性并不一定会完全阻止进入：竞争对手缺乏行动逐渐揭示出竞争者并不像担心的那样乐观。最后，并非所有信念建立都是平等的。只有创始人看到的验证会完全增强进入激励，而整个市场可见的验证则会通过鼓励竞争对手而部分适得其反。本文形式化了这样一种直觉：创业价值并非仅仅来自乐观情绪，而是来自创始人预期竞争对手不会分享的乐观情绪，并推导出将信念分散与进入模式联系起来的预测。

【**NBER**】: NBER Working Paper No. 35091，https://www.nber.org/papers/w35091

#### 73. Information Treatments, Hypotheticals, and Event Studies: Comparative Estimates {#35090}

【**Author**】: Carola Binder, Dimitris Georgarakos, Pei Kuang, Li Tang
...
【**摘要**】：我们利用围绕2025年9月联邦公开市场委员会(FOMC)会议开展的两轮调查实验，研究消费者预期如何对货币政策公告做出反应。我们比较了三种常用于识别对预期因果效应的方法：假设情境（“小插曲”）场景、随机对照试验和事件研究。所有三种识别策略都产生了定性相似的结果：降息降低了短期和长期通胀预期，提高了经济活动预期，并降低了失业预期。估计的幅度在随机对照试验和事件研究方法之间相似，但基于小插曲的衡量标准相对更大。受访者内部的比较进一步表明，那些对小插曲场景预期修正幅度更大的个体，在对实际政策公告和实验性信息处理做出反应时，也表现出更大的修正幅度。

【**NBER**】: NBER Working Paper No. 35090，https://www.nber.org/papers/w35090

#### 74. Aging at the Very Top {#35089}

【**Author**】: Valentin Kecht, Alessandro Lizzeri, Farzad Saidi
...
【**摘要**】：本文记录了在过去几十年中，首席执行官被任命时的年龄急剧上升。利用新收集的涵盖广泛企业的数据，我们表明这种增长集中在最大的上市公司之外，并且主要是由首席执行官任命前更长、更多样化的外部职业路径所驱动。这些模式难以用基于人口统计、教育或任期的解释来调和，反而与一个匹配框架相一致，在该框架中，对通才型人力资本日益增长的需求导致企业在巅峰能力与积累的经验之间进行权衡。我们调查了这种转变背后的力量。利用咨询网络的差异，我们确定，随着运营环境变得越来越不确定和复杂，企业更加重视多元化的管理经验。我们还提供了供给侧反应的证据，即随着对通才技能需求的上升，潜在的首席执行官会拓宽他们的技能组合。

【**NBER**】: NBER Working Paper No. 35089，https://www.nber.org/papers/w35089

#### 75. The Declining Local Bias of Entrepreneurship in the United States {#35088}

【**Author**】: Innessa Colaiacovo, Margaret G. Dalton, Sari Pekkala Kerr, William R. Kerr
...
【**摘要**】：多项研究记录了近几十年来创业精神的本地偏好(LBE)，即自雇企业家在其出生地经营的比例系统性地高于工薪劳动者。本文记录了一个重要的新事实：自1970年以来，美国的LBE一直在下降。对于从事自雇的白人男性来说，LBE仍然存在，但对于整个美国出生的劳动力来说，它已不复存在。我们将这种下降与自雇从高启动资本行业的转型，以及本地自雇企业家相比工薪工作获得高收入的机会减少联系起来。

【**NBER**】: NBER Working Paper No. 35088，https://www.nber.org/papers/w35088

#### 76. The Unseen Costs of Blue Skies: Pollutant Substitution and Biodiversity Loss {#35087}

【**Author**】: Joshua S. Graff Zivin, Siyuan Li, Huanhuan Wang, Zhiqiang Zhang
...
【**摘要**】：不完整的绩效指标会扭曲激励。利用中国国家空气监测网络的分阶段推广，我们记录了一种污染物替代效应：PM₂.₅显著下降，但O₃却激增。我们将此归因于策略性行为：面对具有约束力的PM₂.₅目标，地方政府优先减少颗粒物前体物，而忽视了臭氧前体物。关键的是，这并非良性的权衡。尽管该政策减少了PM₂.₅导致的死亡，但政策引发的O₃激增增加了O₃导致的死亡率，并减少了生物多样性（以鸟类丰度衡量）。保守估计表明，这些成本使该政策的净收益减少了约23.8%。我们的研究结果凸显了狭隘绩效目标设定的隐性社会成本。

【**NBER**】: NBER Working Paper No. 35087，https://www.nber.org/papers/w35087

#### 77. If You Build It, They May Not Come: Willingness to Participate in Managed EV Charging {#35086}

【**Author**】: Fiona Burlig, James B. Bushnell, David S. Rapson
...
【**摘要**】：尽管项目参与对政策至关重要，但处理效应通常是在自选样本上衡量的。我们研究电动汽车(EV)管理充电，旨在通过优化分配所有电动汽车的充电来减轻电网压力。先前的研究发现，在自愿参加随机对照试验的家庭中，管理充电产生了巨大影响。相比之下，我们通过一项包含加州一家公用事业公司内所有电动汽车的实验来测试管理充电。即使提供高额激励，注册率也很低，并且我们可以拒绝管理充电对电力消费存在哪怕适度的意向性治疗效应。管理充电的效果不如先前认为的那样有效，这凸显了全人群实验的价值。

【**NBER**】: NBER Working Paper No. 35086，https://www.nber.org/papers/w35086

#### 78. Le Bureau des Légendes: A Dynamic Theory of Double Agents {#35085}

【**Author**】: Sebastian Galiani, Franco Mettola La Giglia
...
【**摘要**】：本文将双重间谍——即被胁迫同时为两个敌对情报机构服务的个人——建模为A机构、B组织和鼹鼠M之间的有限期三方博弈。双重间谍在一个生存走廊内持续存在：这是一组双边信念，在此信念下，两个委托人都继续维持关系。在线性-二次型-高斯基准下，我们获得了走廊几何形状的闭式表征、预期持续时间的解析上界以及三个主要结果：(i) 双重间谍均衡的存在性，(ii) 结构性暂时性——信念更新、终端瓦解和累积生存风险确保了不可避免的崩溃，以及 (iii) 将监控技术、惩罚严厉程度和保护成本与预期持续时间联系起来的比较静态分析。关键机制是自我毁灭性的实验：B通过努力的类型依赖性以及放大这种学习的可追溯性渠道γ来了解鼹鼠的类型。扩展分析确立了在一般设定下的存在性，并表明持续时间随着敌对机构数量的增加而呈指数衰减。预测与从金·菲尔比到冷战鼹鼠搜捕的历史模式一致。这种设定——双边胁迫、存在性参与约束以及有限期三方结构中的贝叶斯学习——定义了我们所谓的对抗性共同代理。

【**NBER**】: NBER Working Paper No. 35085，https://www.nber.org/papers/w35085

#### 79. Gender Mix and Team Performance: Evidence from Obstetrics {#35084}

【**Author**】: Ambar La Forgia, Manasvini Singh
...
【**摘要**】：我们研究了在高风险环境——分娩中，专家团队的性别构成如何影响绩效。利用250万次分娩的数据，我们利用患者被准外生地分配给两人产科医生团队（主刀-协助）这一情况，发现：(i) 全女性团队实现了最佳的母亲结局，而全男性团队则最差；(ii) 女性领导的混合性别团队表现不如男性领导的混合性别团队。具体来说，与全女性团队相比，全男性团队的严重母亲并发症高出15.8%，混合性别团队则高出7.1-10.8%。这些模式无法用患者风险、内生团队形成或医生对剖腹产等自由裁量做法的偏好来解释。相反，性别构成直接影响团队决策和绩效，很可能是通过性别规范——这一机制得到了两个发现的支持。首先，性别构成影响团队决策反映成员偏好的紧密程度，全女性团队在此过程中尤其擅长，这可能是由于更具协作性的决策制定。其次，性别构成影响团队韧性，女性领导的混合性别团队在具有挑战性的条件下（例如，有限的团队熟悉度）表现尤其糟糕，这可能是因为女性领导者颠覆了传统的性别规范。我们还记录了其他值得注意的模式：全女性团队不仅为黑人女性实现了最低的并发症率，而且是唯一在母亲结局上没有种族差异的团队类型。总体而言，这项研究为专家团队中的性别动态提供了新的见解，为管理人员在日益多元化的职场中支持有效协作提供了信息。

【**NBER**】: NBER Working Paper No. 35084，https://www.nber.org/papers/w35084

#### 80. The Effect of Annuities on Longevity {#35082}

【**Author**】: Borja Larrain, Alessandro Previtero, Felipe Severino
...
【**摘要**】：我们利用2004年至2022年约60万名智利退休人员的行政支付数据，研究年金如何影响长寿。为了解决年金化中的选择性问题，我们利用了年金销售随近期市场回报率变化这一事实，这种模式与外推信念一致。我们发现，年金化的决定——以近期市场回报率为工具变量——在五年和十年的时间跨度上显著降低了死亡率。进一步的分析表明，年金通过保护退休人员免受收入波动和投资相关压力的影响来降低死亡率。补充性的调查证据表明，年金领取者在健康方面投入更多，并且报告的残疾率更低。

【**NBER**】: NBER Working Paper No. 35082，https://www.nber.org/papers/w35082

#### 81. Impact Trickles Down: A General Equilibrium Theory of Stakeholder Exit and Engagement {#35081}

【**Author**】: Briana Chang, Harrison Hong
...
【**摘要**】：目标驱动的利益相关者如何引发改革？通过使用多边匹配均衡，我们证明了他们是退出还是参与取决于社会危害是否随生产率变化。当危害不相关时——这是大多数文献中的隐含假设——目标驱动的利益相关者会参与，补偿性差异会进行调整。但当危害随生产规模扩大时，高生产率企业会出价高于其他企业，以吸引利润驱动的利益相关者，从而避免缓解措施。目标驱动的利益相关者选择退出——这在企业层面看似无效，但其影响会沿着生产率阶梯并跨越利益相关者类型层层传递。这需要一个多边框架，解释了令人困惑的发现，并说明了为何研究低估了退出的总体影响。

【**NBER**】: NBER Working Paper No. 35081，https://www.nber.org/papers/w35081

#### 82. Hospital Billing Regulations and Financial Well-Being: Evidence from California’s Fair Pricing Law {#35080}

【**Author**】: Yaa Akosa Antwi, Marion Aouad, Nathan Blascak
...
【**摘要**】：我们研究了2007年加州公平定价法的财务后果，该法对经济脆弱个体的医院账单设置了价格上限。利用法律覆盖程度的横截面差异（以县级未参保率作为代理变量），我们估计了该法对个人财务结果的影响。我们发现，该法降低了产生非医疗催收债务的可能性以及非医疗催收账户的数量。此外，我们发现有证据表明，在受法律影响更大的县，个人信用评分有所提高，并且有提示性证据表明拖欠账户数量有所减少。我们的结果表明，医院收费法规可以改善目标个体的财务结果。

【**NBER**】: NBER Working Paper No. 35080，https://www.nber.org/papers/w35080

#### 83. How Have Universities Survived for Nearly a Millenium {#35079}

【**Author**】: David M. Cutler, Edward L. Glaeser

【**Abstract**】: How have universities managed to survive and evolve over almost 1,000 years to become wildly heterogeneous, unusually fractious, multi-product, non-profit entities? Universities began as teachers’ guilds, and they still give faculty a remarkable degree of autonomy. That structure attracts and empowers intellectuals, who are selected in part on their taste for knowledge, and those entrepreneurs and philanthropists have enabled universities to morph in ways that firms rarely do. Intellectual autonomy can also explain why universities are so often at odds with legal authorities and why faculty fight so often with each other and with their bosses. This essay presents a model of university organization and sketches the evolution of the university’s products and conflicts over the last 900 years. We also discuss the social value of university education.

【**摘要**】：大学是如何在近1000年的时间里得以存续并演变，成为高度异质、异常好争论、多产品的非营利实体的？大学最初是教师行会，如今它们仍然赋予教师非凡的自主权。这种结构吸引并赋权知识分子——这些人被选中的部分原因在于他们对知识的偏好——而这些企业家和慈善家使得大学能够以企业很少能做到的方式演变。知识自主权也可以解释为什么大学经常与法律当局发生冲突，以及为什么教师之间、教师与上司之间频繁争斗。本文提出了一个大学组织模型，并概述了过去900年里大学产品及其冲突的演变。我们还讨论了大学教育的社会价值。

【**NBER**】: NBER Working Paper No. 35079，https://www.nber.org/papers/w35079

#### 84. The “Peace Dividend” of International Trade: A New Empirical Approach {#35078}

【**Author**】: Ling Feng, Qiuyue Huang, Zhiyuan Li, Christopher M. Meissner
...
【**摘要**】：本文利用1962年至2014年的全球双边数据，研究了国际贸易对国家间军事冲突的因果影响。为了解决内生性问题，我们利用了源于航空运输相对于海运技术进步所带来的国际贸易外生时空变化。实证结果表明，国际贸易存在强大的“和平红利”：即贸易增长显著降低了国家间冲突的概率和强度。这一效应在各种设定下均保持稳健，并能经受住一系列潜在混杂因素的检验。这些发现凸显了经济相互依存如何塑造国际冲突，这一关系在地缘政治紧张局势升级以及全球转向“脱钩”、“去风险”和更多贸易保护主义的背景下尤其具有现实意义。

【**NBER**】: NBER Working Paper No. 35078，https://www.nber.org/papers/w35078

#### 85. Bilateral Conflict Risk and Trade: Military Wars, Trade Wars, and Diplomatic Noise {#35077}

【**Author**】: Joshua Aizenman, Rodolphe Desbordes, Jamel Saadaoui
...
【**摘要**】：与“军事战争”或“口水战”相比，“贸易战”的破坏性有多大？总体冲突指标无法回答这个问题，因为它们将导弹袭击、制裁和外交抗议等同对待。我们利用GDELT事件数据构建了一个月度双边指标，并针对人工整理的真实情况进行校准，该指标将敌对行动分解为四个层级：动能战斗（“军事战争”）、军事姿态、制裁背景下的紧张局势（“贸易战”）以及常规外交。分解后的面板数据揭示了一个长期趋势：在过去十年中，各国政府稳步地用经济胁迫替代军事对抗，通过制裁渠道传导的敌对行动在贸易加权中的份额几乎翻了一番。在一个引力贸易模型中，总体指标为负、数值大且统计显著，但分解结果显示只有两个层级驱动了这一结果。动能冲突和贸易背景下的敌对行动在经济上规模巨大且估计精确；而常规外交尽管在测量的敌对行动中占主导地位，却完全没有贸易效应。定向结构揭示了一个报复渠道，该渠道会在数月内加剧贸易损失。在与最接近的现有替代指标的对比中，我们的指标仍然是双边贸易的重要决定因素。相对于升级前的基线，过去十年的地缘政治恶化已使大约3340亿美元的双边贸易面临风险，其中美中贸易对占了一半。

【**NBER**】: NBER Working Paper No. 35077，https://www.nber.org/papers/w35077

#### 86. Tariffs and the Term Structure of Inflation Expectations {#35076}

【**Author**】: Stéphane Auray, Michael B. Devereux, Anthony M. Diercks, Aurélien Eyquem, Joon Kim
...
【**摘要**】：从金融市场得出的通胀预期在2025年表现出前所未有的动态：一年期通胀互换与一年后的一年期远期利率之间的相关性首次出现显著负值。我们利用经彭博新闻趋势验证的两阶段事件分类法，表明这种脱钩主要发生在关税新闻主导市场定价的日子里。标准的、关税导致一次性价格水平上升的小型开放经济体新凯恩斯主义模型意味着各期限之间存在正联动，无法解释这一模式。我们通过一个修正的小型开放经济体新凯恩斯主义模型的视角来解释这些现象。对于在关税冲击后重现观察到的即期与远期通胀之间的负条件相关性，三个要素至关重要：以同比通胀率为目标、显著的利率惯性以及持续的关税。在经验上合理的校准下，该模型在关税冲击条件下产生负相关性，同时保持正的无条件相关性，这表明2025年期限结构的扭曲反映了市场预期政策将对贸易冲击做出持续性反应。

【**NBER**】: NBER Working Paper No. 35076，https://www.nber.org/papers/w35076

#### 87. The Impact of Maternal Education on Early Childhood Development {#35075}

【**Author**】: Moriam Khanam, Mohammad Hajizadeh, Casey Warman
...
【**摘要**】：本研究利用孟加拉国农村地区一项针对女中学生的助学金项目所产生的外生变异，来估计母亲教育对儿童早期发展的因果效应。利用2019年孟加拉国多指标类集调查的数据，我们发现五年的助学金资格使母亲的受教育年限增加了大约一年。工具变量估计表明，母亲每多接受一年教育，儿童早期发展得分（0-10分制）提高0.5分，并在整体发展准备度（提高7.5个百分点）、读写-计算能力（提高7.7个百分点）和身体（提高1.9个百分点）领域取得进步。结果在各种设定下均保持稳健。我们还估计了母亲教育对潜在机制的影响，包括儿童营养、家庭学习环境、养育实践以及早期儿童教育和保育的使用。研究结果表明，母亲教育水平的提高增加了年龄别体重Z分数，减少了发育迟缓，提高了拥有商店购买玩具的概率，并增加了成年家庭成员与孩子玩耍的可能性。母亲教育对儿童发展结果的积极影响意味着，投资于提高教育程度（尤其是中低收入国家的女性）具有重要意义。

【**NBER**】: NBER Working Paper No. 35075，https://www.nber.org/papers/w35075

#### 88. When Does Acquisition Integration Succeed? Evidence from Inside the Integration Black Box {#35074}

【**Author**】: Sinan Gokkaya, Xi Liu, René M. Stulz
...
【**摘要**】：我们通过考察业务部门负责人——负责整合和运营收购目标的执行官——是否影响整合结果，来深入探究收购后整合的黑箱。利用基于自然语言处理的已实现整合结果度量和财务指标，我们发现，业务部门负责人的目标行业经验通过更好地实现交易协同效应，提高了整合成功（减少了失败）。业务部门负责人的其他属性与整合结果无关。与整合对收购成功的重要性相一致，这种经验提升了收购绩效。业务部门负责人的目标行业经验改善了整合规划及其收购后的职业结果，但与收购过程的早期阶段无关。

【**NBER**】: NBER Working Paper No. 35074，https://www.nber.org/papers/w35074

#### 89. Understanding Support for Inefficient Environmental Policy Instruments {#35073}

【**Author**】: Chenxi Jiang, Maximiliano Lauletta, Ro’ee Levy, Joseph S. Shapiro, Dmitry Taubinsky
...
【**摘要**】：许多政府使用环境标准，而非更具成本效益的市场化工具，如污染税或总量控制与交易市场。通过一项具有全国代表性的调查实验，我们研究了对经济学原理的有限理解是否以及为何有助于解释这种做法。在保持环境影响不变的情况下，受访者更偏好标准而非市场化工具，并且更偏好生产者税和总量控制与交易，而非消费者税。这些偏好反映了消费者关于这些政策将如何影响电费账单的信念。受访者还偏好针对消费者税的最弱环境目标，以及针对标准的最强目标，这表明政策制定者面临着政策严格性与成本效益之间的权衡。另一项针对环境经济学家的独立调查显示，他们对环境政策效果的信念与我们代表性调查中的受访者截然不同。例如，与环境经济学家相反，典型受访者认为环境标准对消费者能源账单的增加幅度小于市场化工具。关于政策传导和成本效益的教育视频会影响政策支持，并缩小全国代表性受访者与专家之间的一些差距，这表明经济素养是影响选民偏好的一个因素。

【**NBER**】: NBER Working Paper No. 35073，https://www.nber.org/papers/w35073

#### 90. Risk Preferences and the Willingness to Relocate to Danger: Evidence from Wartime Ukraine {#35072}

【**Author**】: Yuriy Gorodnichenko, Marianna Kudlyak, Sophia Lobozynska, Iryna Skomorovych, Ulyana Vladychyn, Andriy Kovalyuk, Iryna Snovydovych
...
【**摘要**】：我们利用2024年4月中旬至7月中旬在俄罗斯入侵乌克兰期间进行的一项家庭调查，引出了搬迁至两个乌克兰城市的保留工资溢价：高风险城市哈尔科夫（靠近前线）和中风险城市基辅。风险容忍度是搬迁至哈尔科夫意愿的有力预测指标——最厌恶风险者的几率大约是最能容忍风险者的一半——但对于基辅而言，其重要性要小得多。这种不对称性很难与风险容忍度仅仅是普遍流动偏好代理变量的假设相协调。通过分别估计跨期替代弹性（EIS≈0.04），我们发现，将其纳入模型后，风险容忍度对基辅不再显著，但对哈尔科夫仍然显著——这一模式通过Epstein-Zin对风险厌恶和EIS的分离得以阐明：风险厌恶仅在危险程度高时增加预测能力，而EIS则作为一个共同的搬迁成本渠道对两个城市同等发挥作用。极低的EIS意味着，以未来收益形式构建的搬迁激励可能效果不佳；前置补贴更有可能影响行为。

【**NBER**】: NBER Working Paper No. 35072，https://www.nber.org/papers/w35072

#### 91. The Macroeconomic Effects of Bank Regulation: New Evidence from a High-Frequency Approach {#35071}

【**Author**】: Thomas Drechsel, Ko Miura
...
【**摘要**】：银行监管支持金融稳定，但可能制约经济活动。本文使用高频识别方法估计了银行监管的宏观经济效应。我们衡量了在美联储讨论美国银行体系及其监管的演讲前后一个狭窄时间窗口内，银行股票价格指数的市场意外变动。然后，我们开发了一个符号限制程序，以引出这些市场意外变动中可被解释为银行监管新闻的部分。银行监管将比预期更严格的新闻，会缓解银行部门的风险，但通过增加银行的融资成本和收紧贷款供给来减少经济活动。由监管引起的银行风险溢价峰值降低10个基点，伴随着失业率峰值上升15个基点。与以往研究相比，这些数值表明，至少在短期内，收紧银行监管的宏观经济成本相对较高。

【**NBER**】: NBER Working Paper No. 35071，https://www.nber.org/papers/w35071

#### 92. Birthright Citizenship and Youth Crime {#35070}

【**Author**】: Leander Andres, Stefan Bauernschuster, Gordon B. Dahl, Helmut Rainer, Simone Schüller
...
【**摘要**】：本文研究了出生公民权对青少年犯罪的影响。我们利用德国的一项改革，该改革自动授予2000年1月1日之后在德国出生的符合条件的移民子女出生公民权，并使用了来自三个联邦州的行政犯罪数据。我们发现，在出生时获得公民身份的移民青少年从事犯罪活动的可能性显著降低，估计表明犯罪率降低了70%。这些结果对于美国关于废除出生公民权的持续辩论尤其具有现实意义。我们的研究结果表明，包容性的公民政策可以减少犯罪及其相关成本，这反过来又可以加强社会凝聚力。

【**NBER**】: NBER Working Paper No. 35070，https://www.nber.org/papers/w35070

#### 93. Reason for Treason {#35069}

【**Author**】: Xinyu Fan, Gary Richardson, Zhihao Xu, Sicheng Zhao
...
【**摘要**】：战争期间的叛逃是忠诚度的极端转变。是什么促使军官背叛祖国并为入侵者服务？利用第二次世界大战期间（作为二战的一部分）第二次中日战争中超过2800名高级（上校和将军）国民党（KMT）军官职业生涯路径的新数据集，我们考察了向日本傀儡政权叛逃的案例。出现了三个发现。首先，职业生涯晋升较慢的国民党高级军官更有可能叛逃；这表明内部组织认可很重要。其次，与其同学和同乡相比晋升不足的军官更有可能叛逃，这表明同侪比较很重要。第三，当叛逃的同僚在敌方阵营拥有更好的职业前景时，军官更有可能叛逃，这表明外部认可很重要。

【**NBER**】: NBER Working Paper No. 35069，https://www.nber.org/papers/w35069

#### 94. High Schools and the Uneven Rise in American Opportunity {#35068}

【**Author**】: Alison Doxey, Ezra Karger, Peter Nencka
...
【**摘要**】：在1850年至1910年间，居住在有高中城镇的美国年轻人比例从17%增加到46%——这是美国历史上入学机会扩张最快的时期。利用关于美国每所高中的新数据，我们表明这种扩张改变了许多年轻人的经济机会，但扩大了阶级和种族不平等。我们发现，与附近没有高中的城镇的儿童相比，在开设高中的城镇，高中适龄儿童的入学率急剧上升。通过将儿童与其成年后的结果联系起来，我们表明高中提高了女性的劳动力参与率和工作质量，同时降低了早婚和生育的可能性。入学机会的增加解释了1870年至1930年间女性劳动力参与率增长的三分之一。高中对来自已经富裕家庭的儿童影响最大，并且平均而言，并未使黑人儿童受益。虽然高中运动显著缩小了劳动力市场结果中的性别差距，但它也扩大了现存的基于种族和阶级的不平等。

【**NBER**】: NBER Working Paper No. 35068，https://www.nber.org/papers/w35068

#### 95. Who Pays for Payments? {#35067}

【**Author**】: Mark L. Egan, Gregor Matvos, Amit Seru, Lulu Wang, Vincent Yao
...
【**摘要**】：我们利用关于美国商户支付构成和成本的新数据来量化支付系统中的消费者再分配。信用卡向商户收取交换费，以资助消费者奖励。当商户为了应对这些成本而提高所有消费者的价格时，在同一商户购物的低成本支付方式（例如现金和借记卡）用户，就会交叉补贴高奖励信用卡用户。这种标准机制隐含地假设使用不同支付方式的消费者在同一商户购物，并且商户面临相似的费用。相反，我们表明，实际负担取决于支付选择在商户间的联合分布。我们记录了塑造再分配的两个关键力量。首先，消费者分类——即使用不同支付方式的消费者在不同商户购物——限制了现金和借记卡用户对高交换费影响的暴露程度。其次，交换费因商户而异；在使用不同支付方式的用户重叠的地方，例如大型杂货店，由于行业折扣和私下谈判，费用较低。我们将这些力量嵌入一个充分统计量框架中，该框架将观察到的异质性直接映射到再分配。我们估计，交换费每年从现金和借记卡用户向信用卡用户转移约3000亿美元。消费者分类和商户费用异质性使这种累退性转移的规模减少了25%，但并未消除它。最后，我们表明，杜宾修正案和高端信用卡的兴起都具有累退性，突显了政策和创新如何重塑平台费用的实际负担。

【**NBER**】: NBER Working Paper No. 35067，https://www.nber.org/papers/w35067

#### 96. Zero Energy Day: How Nationwide Blackouts Affect the Economy {#35066}

【**Author**】: Luis E. Gonzales, Koichiro Ito, Mar Reguant
...
【**摘要**】：电力可靠性是能源转型的核心挑战，因为不断增长的能源需求、可再生能源整合以及自然灾害增加了大规模停电的风险。然而，大规模停电的经济影响在很大程度上仍然未知。通过将电力市场数据与来自智利的高频经济交易数据相结合，我们发现，在全国停电日，经济活动下降了35%，但这一损失的一半在随后的日子里得以恢复，这突显了跨期替代的重要性。利用停电严重程度的空间差异，我们表明，在估计失负荷边际价值时，考虑内生性恢复至关重要。

【**NBER**】: NBER Working Paper No. 35066，https://www.nber.org/papers/w35066

#### 97. Multimodal Transport Networks {#35065}

【**Author**】: Simon Fuchs, Woan Foong Wong
...
【**摘要**】：美国超过一半的按距离加权的货运使用一种以上的运输方式。我们研究了多式联运网络如何塑造基础设施投资和中断的经济与环境影响。我们开发了一个易于处理的多式联运路径选择空间均衡模型，该模型考虑了多式联运枢纽处特定运输方式的拥堵。我们利用公路和铁路数据估计了运输方式替代弹性，并利用船舶定位数据估计了枢纽拥堵弹性。校准到美国货运网络后，该模型识别了关键瓶颈，并量化了多式联运枢纽改进带来的 4.6 亿至 18.5 亿美元的实际 GDP 增长，以及因减少对碳密集型公路运输的依赖而产生的额外环境效益。忽略特定运输方式的拥堵会使高速公路改进的福利收益被高估 85%，而忽略多式联运的灵活性则会使这些收益被低估 22%。据估计，失去铁路网络接入将使实际 GDP 减少 2300 亿美元。

【**NBER**】: NBER Working Paper No. 35065，https://www.nber.org/papers/w35065

#### 98. Tariffs in 2025: Short-Run Impacts on the U.S. Economy {#35064}

【**Author**】: Pablo D. Fajgelbaum, Amit Khandelwal
...
【**摘要**】：2025 年，美国将平均关税税率从 2.4% 提高到 9.6%，使保护主义达到八十年来的最高水平。我们探讨了这些关税的结构，估计了它们的短期影响，并总结了关于其影响的日益增长的文献。在贸易伙伴方面，关税与贸易逆差相关，但与地缘政治或战略性产业目标无关，除了针对中国。在我们的基线估计中，90% 的关税被转嫁给了美国进口商支付的含税价格。将估计的价格和贸易反应纳入一个静态贸易框架，我们发现总体福利影响范围从 GDP 损失 0.13% 到收益 0.10%。这些微小的净福利影响反映了相当大的消费损失被收入和财政收入收益大致抵消，其正负取决于美国的贸易条件是否调整（关于这一点数据尚无定论）。在其声明的理由中，关税在增加联邦收入和将贸易从中国转移方面是有效的。然而，它们是否能减少贸易逆差、降低外国出口商设定的价格、促进制造业就业、增加结盟国家之间的“友岸外包”，或将关键产业回流，仍不确定；来自 2018-19 年和 2025 年指标的证据表明，实现这些目标的路径狭窄。

【**NBER**】: NBER Working Paper No. 35064，https://www.nber.org/papers/w35064

#### 99. Beyond Demo Day: Sorting and Value Added in Startup Accelerators {#35063}

【**Author**】: Youn Baek, Deepak Hegde
...
【**摘要**】：我们研究了谁加入创业加速器，创始人如何在项目之间进行分类，以及哪些加速器能改善创业成果。利用一个包含约 75 万家美国初创企业（与 329 家加速器相关联）的全面样本，我们借鉴了教育经济学中的教师增值框架来估计加速器增值，同时考虑了分类效应。选择是系统性的：可观察到的更好的企业更有可能进入加速器，并分类到更高增值的项目中。然而，加速器的表现高度分散。相对于无加速器的基准，大多数加速器的增值为负，而一个小的右尾部分则产生了巨大的收益。高增值的加速器能预测更好的长期结果，包括收购、就业、收入和估值，并且也更有可能加速较弱企业的关闭。我们利用一家美国大型非股权加速器的内部申请人数据验证了加速器增值。

【**NBER**】: NBER Working Paper No. 35063，https://www.nber.org/papers/w35063

#### 100. Exploring Trends in Severe Maternal Morbidity in the U.S. {#35062}

【**Author**】: Pinka Chatterji, Fangning Li, Sara Markowitz
...
【**摘要**】：美国严重孕产妇发病率的发病率随着时间的推移在母亲中持续上升，尤其是在黑人母亲中增长更为显著。在本文中，我们研究了这种情况可能发生的原因。以往的文献采用范围有限的方法，侧重于选择少数变量作为严重孕产妇发病率的决定因素。我们采取了更广泛的方法，评估了大量变量在较长时间跨度内的贡献，让数据告诉我们哪些因素可能对决定严重孕产妇发病率最具影响力。我们使用 1998 年至 2019 年的住院数据，观察产妇、医院和县级特征如何与严重孕产妇发病率的上升趋势和种族差异相关联。分解方法表明，观察到的特征几乎无法解释严重孕产妇发病率的总体变异，但解释了黑人与白人之间严重孕产妇发病率差距的很大一部分。医学和妊娠相关的合并症是观察到的变异的最大驱动因素。这些关联性发现表明，关注患有合并症的患者并更深入地研究医院环境的特征，可能有助于研究人员识别与政策相关的严重孕产妇发病率及其差异的驱动因素。

【**NBER**】: NBER Working Paper No. 35062，https://www.nber.org/papers/w35062

#### 101. Human Capital Markets {#35061}

【**Author**】: Jishnu Das, Cauê Dobbin
...
【**摘要**】：在许多低收入和中等收入国家，消费者在存在大量提供者选择的环境中获取教育和健康服务。在这些环境中，出现了密集的收费私立提供者网络，通常位于公共设施附近，并争夺相同的客户群。我们将这些环境称为人力资本市场。本章首先记录了这类市场现已普遍存在。我们提供的经验证据表明，人力资本市场与传统产品市场有许多共同特征：家庭在具有异质性属性的广泛公共和私人提供者之间进行选择，而提供者则对政策干预和竞争压力做出战略性反应。然后，我们评估了产业组织中的经典模型在多大程度上能够解释观察到的行为，强调了它们的洞察力和局限性。接下来，我们考察了人力资本市场偏离标准产品市场基准的关键方式——最显著的是，教育和健康既是消费品也是投资品，而且质量通常难以观察——并回顾了为应对这些特征而开发的经验和概念方法。最后，我们概述了主要未解决的问题和未来研究的有希望的方向。

【**NBER**】: NBER Working Paper No. 35061，https://www.nber.org/papers/w35061

#### 102. The Emergence of the Poverty–Mental Health Gradient and the Great Pakistan Earthquake of 2005 {#35060}

【**Author**】: Tahir Andrabi, Benjamin Daniels, Jishnu Das
...
【**摘要**】：贫困与心理健康之间的梯度在不同人群中差异很大，远超抽样变异本身的预测。我们将这种异质性视为经验研究的主要对象。利用 2005 年巴基斯坦大地震四年后从距活动断层线 0 至 75 公里的 126 个村庄收集的数据，我们表明，在未受影响的人群中，消费贫困与心理健康之间没有相关性。相比之下，在距离断层最近的人群中，每对数单位的消费，心理健康改善 0.12 个标准差，而在 20 公里以外，这种关系精确为零。这种梯度对于替代距离阈值、样本分割和二元心理健康指标是稳健的，并且不受急性家庭创伤的中介作用。这些结果表明，大规模逆境可以激活贫困与心理健康梯度，有助于解释更广泛文献中的异质性。

【**NBER**】: NBER Working Paper No. 35060，https://www.nber.org/papers/w35060

#### 103. When Policy Shapes Perception: The 2021 Child Tax Credit and Consumer Sentiment {#35059}

【**Author**】: Jacob Bastian, Melody Harvey
...
【**摘要**】：消费者情绪以重要方式影响家庭行为，但我们缺乏关于政府政策本身是否塑造这些认知的因果证据。我们通过研究 2021 年扩大的儿童税收抵免的到期来帮助填补这一空白，该抵免的到期突然减少了数百万家庭的收入。利用密歇根大学消费者情绪调查的月度微观数据以及家庭间福利损失的可信外生变异，我们实施了连续双重差分和工具变量策略。我们发现，每损失 1000 美元的儿童税收抵免福利，情绪就会下降 1.7 个百分点（约 2.4%），对有多名子女的低收入家庭影响最大。这些影响在到期两年后仍然存在，并且在对通货膨胀、利率和宏观经济状况进行控制后依然稳健。结果表明，财政政策对感知经济福祉的影响超出了同期收入效应，可能对家庭经济活动、政治态度和投票行为产生影响。

【**NBER**】: NBER Working Paper No. 35059，https://www.nber.org/papers/w35059
...
【**摘要**】：尽管有越来越多的证据表明，近年来年轻人的主观幸福感有所下降，但不同调查的证据并不一致。我们考察了三个主要调查中年龄与各种福祉和不良福祉指标之间的关系——盖洛普世界民意调查、全球思维和全球繁荣调查。盖洛普世界民意调查通过面对面和电话调查进行；全球思维调查基于网络；全球繁荣调查则同时使用电话和网络调查。我们重点关注出现在所有三个调查中的 23 个国家。福祉随年龄增长而上升、不良福祉随年龄增长而下降的最清晰证据来自全球思维和全球繁荣调查中的网络调查。当通过电话进行调查时，年龄分布看起来非常不同：在这些调查中，年轻人中较高的不良福祉率远不那么明显。由于调查模式并非随机分配，我们无法确定福祉和不良福祉的年龄分布差异是否由调查模式因果导致。无论是在国家之间还是国家内部，对调查模式的选择，以及不同年龄范围调查的差异无应答，都可能起到一定作用。然而，证据表明，在不同的调查模式下，福祉和不良福祉的年龄模式呈现出非常不同的结果。

【**NBER**】: NBER Working Paper No. 35058，https://www.nber.org/papers/w35058

#### 105. Credit Crunches and the Great Stagflation {#35057}

【**Author**】: Itamar Drechsler, Alexi Savov, Philipp Schnabl
...
【**摘要**】：我们认为，银行体系中的严重信贷紧缩是导致20世纪70年代“大滞胀”的原因之一。信贷紧缩源于Q条例，该银行法对存款利率设置了上限。在Q条例下，美联储收紧货币政策引发了大规模存款外流，导致银行收缩贷款。信贷紧缩在时间序列上与滞胀高度吻合。为解释这一现象，我们将Q条例纳入一个标准模型，在该模型中，企业利用银行贷款为营运资本融资。当Q条例生效且信贷收缩时，营运资本成本上升，促使企业提高价格并缩减产出。该模型推导出一个扩展的菲利普斯曲线，其中货币紧缩在减少需求的同时也降低了总供给。对供给的影响程度随信贷紧缩的严重性、企业的外部融资依赖度及其营运资本密集度的增加而增强。我们利用制造业行业截面数据检验了所有三个预测。在每种情况下，我们发现，相对于其他行业，受冲击更大的行业提高了价格并削减了产出。我们的研究结果表明，在严重的金融摩擦下，货币政策不仅影响需求，也影响总供给。

【**NBER**】: NBER Working Paper No. 35057，https://www.nber.org/papers/w35057
...
【**摘要**】：中国庞大的经常账户盈余一直是其贸易伙伴的刺激因素。虽然产业和贸易政策常常导致部门层面的失衡，但它们在整个经济范围的盈余中所起的作用相对有限。结构性因素，如失衡的性别比例以及国有企业和非国有企业融资机会的不均等，是经常账户失衡更重要的决定因素。虽然宏观经济刺激措施能在短期内提振进口并减少盈余，但任何长期解决方案都需要涉及旨在解决结构性问题的改革。

【**NBER**】: NBER Working Paper No. 35056，https://www.nber.org/papers/w35056

#### 107. The Impacts of Medicaid's Managed Long-Term Services and Supports on Health Outcomes in Medicare {#35055}

【**Author**】: Ajin Lee, Maya Rossin-Slater, Becky Staiger, Amanda Su
...
【**摘要**】：美国人口老龄化引发了关于长期服务与支持（LTSS）的组织、提供和资金筹措的重要问题，促使许多州的医疗补助计划从按服务收费模式转向管理式医疗模式来提供LTSS。我们分析了佛罗里达州和纽约州向管理式长期服务与支持（MLTSS）过渡对65岁及以上同时享受Medicare和Medicaid双重资格受益人的健康结果的影响。利用Medicare索赔数据和基于县级MLTSS逐步推广的双重差分设计，我们发现，在佛罗里达州，MLTSS导致住院率增加4.2%，但在纽约州没有显著变化。对预防性护理的分析表明，佛罗里达州流感疫苗接种率的下降可能导致了呼吸系统原因住院的增加。这些发现凸显了MLTSS在不同州的效果存在重要差异，并强调了利用Medicare数据衡量双重资格人群健康影响的价值。

【**NBER**】: NBER Working Paper No. 35055，https://www.nber.org/papers/w35055

#### 108. A Tale of Two Countries – The Real Estate Crises in 1990s Japan and Contemporary China {#35054}

【**Author**】: Kenneth S. Rogoff, Yuanchen Yang
...
【**摘要**】：房地产长期以来一直是中国增长模式的核心，但自2018年以来，其贡献急剧下降，该部门从经济增长的关键引擎转变为经济活动的主要拖累。虽然政策收紧可能触发了此次低迷，但它反映了该部门更深层次的结构性失衡，该部门连同其上下游关联产业和基础设施，几乎占到了总需求的三分之一。由于住房占家庭财富的近70%，正在进行的价格调整产生了巨大的负财富效应，通过抑制消费、投资和信心加剧了经济收缩。我们记录了中国房地产低迷的宏观经济传导机制，并评估了如果该部门继续恶化可能陷入长期停滞的风险。为了提供参考，我们将中国的经历与日本1990年代的房地产崩盘进行比较，发现尽管存在深刻的制度差异，但在投资动态和消费反应方面存在惊人的相似之处。我们的研究结果强调了实体渠道（包括除银行业之外的替代放大机制）在房地产泡沫破灭后导致持续产出损失方面的重要性。

【**NBER**】: NBER Working Paper No. 35054，https://www.nber.org/papers/w35054
...
【**摘要**】：本文记录了关于人工智能相关产品国际贸易的事实。我开发了一个大型语言模型（LLM）分类工具，将美国贸易数据中的HS10编码映射到用于构建和运营AI基础设施的产品上。AI相关产品在2025年占美国进口的23%，自2023年以来，这些产品的进口增长了73%。同期，非AI相关产品的进口仅增长了3%，这两类产品之间的分化始于2024年初。墨西哥是进口和出口两方面的关键市场，与台湾一起，这两个国家和地区约占美国AI相关产品贸易总额的一半。贸易政策对这些产品处理较轻，产品层面的豁免保护了大部分AI相关进口免受关税影响。如果没有AI热潮，一个简单的会计估算表明，2025年美国商品贸易逆差将减少近2000亿美元。

【**NBER**】: NBER Working Paper No. 35053，https://www.nber.org/papers/w35053

#### 110. The Economic Value of Eliminating Cancer {#35052}

【**Author**】: Tomas J. Philipson, Deyu Zhang, Shumaila Abbasi, Noah Fisher
...
【**摘要**】：本文估算了从2030年开始的35年时间内，美国消除癌症死亡的经济价值，这将消除3070万例癌症死亡，总死亡负担为3.8亿生命年。我们通过纳入延长寿命的货币化价值，量化了癌症死亡率大幅降低的经济价值。为了用货币术语衡量寿命延长的价值，我们采用了美国联邦政府在其监管成本效益评估中使用的估值。消除癌症死亡在35年内产生197万亿美元的经济效益，相当于每个美国人每年约16,282美元，或每个美国家庭每年约41,684美元。如果将消除癌症视为一项研发投资，基于基准化的研发成本，它将产生巨大的内部收益率，范围从570%到1,024%。此外，我们通过改变消除持续时间和成功程度进行了敏感性分析，使用基准情景，即在20年的过渡期内将癌症死亡率降低80%。这实现了上述完全消除总经济价值的约70%，对应的总收益约为134万亿美元，或每人每年约11,112美元。

【**NBER**】: NBER Working Paper No. 35052，https://www.nber.org/papers/w35052
...
【**摘要**】：可信度革命在多大程度上已扩展到应用微观经济学之外？我更新了Currie, Kleven, and Zwiers (2020b)的研究，使用了大约44,000篇论文——31,500篇NBER工作论文（1982-2025年）和来自11个顶级经济与金融期刊的12,300篇文章（2011-2024年）——通过关键词匹配来衡量对实证方法的提及。三个发现浮现出来。首先，金融学和宏观/其他领域在提及可信度革命方法方面与应用微观经济学存在显著差异：截至2024年，63%的应用微观经济学论文提及实验或准实验方法，而金融学为47%，宏观/其他领域为39%。金融学和宏观/其他领域目前的水平与应用微观经济学在2008-2010年间的水平相当，尽管长期轨迹可能不同。其次，应用微观经济学之外的增长绝大多数由双重差分驱动；纳入DiD使提及任何实验或准实验方法的金融学论文比例提高了约55%，而应用微观经济学则提高了约30%。其他准实验方法——工具变量、断点回归、实验——的增长则少得多。第三，我记录了《计量经济学杂志》研究的方法（非参数估计和渐近理论占主导）与应用研究人员使用的方法（DiD和识别策略占主导）之间存在显著差距。已发表的期刊文章证实，这些模式并非NBER样本的产物。

【**NBER**】: NBER Working Paper No. 35051，https://www.nber.org/papers/w35051

#### 112. A Model of Leveraged Bubbles {#35050}

【**Author**】: Nina Biljanovska, Jordi Galí, Lucyna Górnicka, Alexandros P. Vardoulakis
...
【**摘要**】：伴随着高信贷增长的资产价格繁荣之后出现的衰退，比那些没有伴随强劲债务积累的资产价格繁荣之后的衰退更深、更持久。我们构建了一个动态一般均衡模型，其中包含理性资产泡沫和偶尔具有约束力的借贷约束，该模型再现了这些经验规律。泡沫在上行期提高了抵押品价值并放松了借贷限制，但在泡沫破裂时收紧了这些限制。我们推导了时间一致的最优政策，并刻画了近似该政策的简单借贷税规则，表明此类政策能显著降低由杠杆泡沫破裂引发的衰退的频率和严重程度。

【**NBER**】: NBER Working Paper No. 35050，https://www.nber.org/papers/w35050

#### 113. Disagreement of Disagreement {#35049}

【**Author**】: Christian L. Goulding, Campbell R. Harvey, Hrvoje Kurtović
...
【**摘要**】：我们表明，主要投资者分歧代理指标之间的相关性接近于零——这使得关于分歧定价的推断充满挑战。我们开发了一个无摩擦模型，该模型从潜在分歧中产生高估，共同解释了主要代理指标，并产生了新的可检验预测。均衡的相互关系催生了一个新的分歧度量指标DIS，它在横截面上比主要代理指标更能预测回报，并且在宏观经济体制间具有更一致的预测能力。我们提供的证据表明，Miller（1977）基于摩擦的渠道与一种无摩擦机制并存，并且在实证上可以分离。DIS还为IVOL之谜提供了一个基于微观基础、以分歧为核心的解释，吸收了IVOL的可预测性，同时揭示了其体制依赖性和摩擦依赖性。

【**NBER**】: NBER Working Paper No. 35049，https://www.nber.org/papers/w35049

#### 114. Consumer Tobacco Product Choices in China: The Impact of a Ban on Flavored E-cigarettes {#35048}

【**Author**】: Hua Wang, Yuhan Deng, Donald S. Kenkel, Alan D. Mathios, Sen Zeng
...
【**摘要**】：越来越多的经济学研究探讨了美国电子烟监管对消费者烟草选择的影响，但对中国这个世界最大烟草市场的电子烟监管知之甚少。我们研究了中国对调味电子烟的禁令。禁止除烟草味以外的所有调味电子烟，是2022年实施的一揽子综合监管政策的一部分。我们通过分别在2021年和2023年进行的两次离散选择实验收集了陈述偏好数据，每次实验约有600名受试者。所有受试者均为当前吸烟的成年人。在实验中，受试者在香烟、电子烟和戒烟之间做出假设性选择。产品价格和电子烟属性通过实验方式变化，使我们能够识别调味品可用性对陈述偏好的影响。我们利用这些数据估计条件Logit模型，并预测调味禁令及其他政策的影响。实证结果表明，禁止调味电子烟降低了电子烟的陈述偏好，但也产生了增加香烟陈述偏好的意外后果。尽管电子烟选择预计会减少，但在调味电子烟非法但执法宽松的情况下，其预测选择份额是合法情况下预测份额的53%。这一巨大的非法份额与传闻证据以及我们2023年背景调查的证据一致，该调查显示，尽管禁令实施后，调味电子烟仍然受欢迎，但报告从专卖店或普通零售商处购买电子烟的电子烟使用者有所减少。

【**NBER**】: NBER Working Paper No. 35048，https://www.nber.org/papers/w35048

#### 115. Identification and Estimation of Labor Supply Elasticities from Kinked Budget Sets {#35047}

【**Author**】: Deniz Dutz, Morten Håvarstein, Magne Mogstad, Alexander Torgovitsky
...
【**摘要**】：我们研究了在存在收入效应和弹性个体异质性的模型中，从拐点预算集识别劳动供给弹性的问题。我们提供了补偿弹性、非补偿弹性和收入效应的点识别和部分识别结果。我们利用行政数据将我们的结果应用于挪威税收体系，该体系对自雇人士存在一个拐点。在拐点附近存在明显的聚集现象，表明自雇人士对拐点产生的激励变化做出了反应。我们发现，即使在弱假设下，边界通常也是紧的。我们的结果表明，非补偿弹性接近于零，而补偿弹性足够小，可以得出税收超额负担较低的结论。

【**NBER**】: NBER Working Paper No. 35047，https://www.nber.org/papers/w35047

#### 116. Forecasting the Economic Effects of AI {#35046}

【**Author**】: Ezra Karger, Otto Kuusela, Jason Abaluck, Kevin A. Bryan, Basil Halperin, Todd R. Jones, Connacher Murphy, Philip Trammell, Matt Reynolds, Dan Mayland, Ria Viswanathan, Ananaya Mittal, Rebecca Ceppas de Castro, Josh Rosenberg, Philip Tetlock
...
【**摘要**】：我们征集了关于人工智能将如何影响美国经济的预测，比较了五类群体的信念：学术经济学家、人工智能公司员工、专注于人工智能的政策研究者、高精度预测者以及普通公众。每组受访者的中位数预期是：到2030年人工智能能力将取得实质性进步，劳动力参与率小幅下降（与人口结构变化一致），以及年GDP增长率为2.5%，这超过了政府机构和私营部门预测者通常给出的中期（2.0%）和长期（1.7%）基线预测。在“快速”人工智能进展情景下（即人工智能系统在许多认知和体力任务上超越人类表现），专家预测了实质性但并非历史上前所未有的经济转变：年化GDP增长率上升至约4%，劳动力参与率从目前的62%下降到2050年的55%，其中约一半的下降（相当于约1000万个工作岗位的损失）可归因于人工智能。方差分解表明，专家对这些效应的分歧主要源于对高能力人工智能系统经济效应的不同信念，而非对人工智能进展速度的分歧。这些预测映射出不同群体间显著不同的政策偏好：专家强烈支持工人再培训等针对性措施，而普通公众既支持针对性计划，也支持更广泛的干预措施，包括工作保障和全民基本收入。

【**NBER**】: NBER Working Paper No. 35046，https://www.nber.org/papers/w35046

#### 117. Bad News and Policy Views: Expectations, Disappointment, and Opposition to Affirmative Action {#35045}

【**Author**】: Louis-Pierre Lepage, Heather Sarsons, Michael Thaler
...
【**摘要**】：对平权行动政策的反对普遍存在。我们研究个人失望是否会影响对此类政策的偏好。具体来说，我们检验了个人的大学录取结果（相对于其期望）如何影响他们对平权行动政策的态度。通过对近期申请大学的美国白人和亚裔进行回顾性调查，我们发现，失望的个体——即被录取学校少于预期的人——相对更可能认为平权行动在其录取结果中发挥了重要作用，对平权行动政策的支持度最低，并且更愿意向反平权行动组织捐款。他们对少数族裔的学术资质也持有更负面的看法。为了从选择效应中分离出“坏消息”的因果效应，我们进行了一项补充性的调查实验，对象是未来大学申请者的家长。我们随机向家长提供关于其子女录取前景的信息。向过度自信的家长提供坏消息，会导致他们增加对平权行动的反对，并向反平权行动组织捐款。结果表明，一些个体将坏消息归因于外部因素，特别是那些有利于外群体的政策。

【**NBER**】: NBER Working Paper No. 35045，https://www.nber.org/papers/w35045
...
【**摘要**】：随机对照试验（RCT）提供了最可信的广告增量估计，但难以规模化。我们提出了基于实验的预测增量（PIE），它将广告测量重新定义为一场战役层面的预测问题。PIE利用一个RCT样本，学习从战役特征到因果效应的映射，然后将其应用于未进行RCT的战役。由于RCT识别了因果效应，PIE可以纳入事后确定的特征——即战役结束后计算的战役层面汇总指标，如测试组结果、曝光率和最后一次点击转化率。这些指标反映了产生处理效应的消费者行为，因此它们携带关于增量的预测信息，尽管它们在因果模型中会是无效的控制变量。利用2226个Meta广告实验，PIE在每美元增量转化上实现了样本外R²=0.88，而行业标准的7天最后一次点击归因的R²=0.19。在一个决策框架中，PIE与基于RCT的决策不一致的战役仅占8-12%，而最后一次点击归因的这一比例为12-20%。我们得出结论，PIE有助于将因果测量从有限数量的RCT扩展到大量非实验性战役。

【**NBER**】: NBER Working Paper No. 35044，https://www.nber.org/papers/w35044

#### 119. Profit Regulation and Strategic Transfer Pricing by Vertically Integrated Firms: Evidence from Health Care {#35043}

【**Author**】: Pragya Kakani, Eric Yde, Genevieve P. Kanter, Richard G. Frank, Amelia M. Bond
...
【**摘要**】：我们提供了纵向一体化医疗保健企业为应对保险公司利润监管而采取战略性转移定价的证据。在Medicare D部分引入保险公司利润上限后，保险公司将其纵向一体化药房的价格提高了9.5%。我们检测到，那些最有可能超过允许利润水平的保险公司提价幅度更大。这些更高价格中超过五分之一由联邦政府承担。我们的分析表明，纵向一体化企业可以通过将利润“隧道转移”至未受监管的子公司来规避利润监管，从而破坏监管意图并增加医疗保健支出。

【**NBER**】: NBER Working Paper No. 35043，https://www.nber.org/papers/w35043

#### 120. Capital in the Capitol: Congressional Trades Resemble Uninformed Retail Trading {#35041}

【**Author**】: Haotian Chen, Bruce Sacerdote
...
【**摘要**】：民选官员是否利用信息优势谋取个人经济利益？这个问题在国会股票交易受到更严格审查的背景下引起了高度关注，尤其是在COVID-19大流行之后。先前的研究发现很少有证据表明立法者能跑赢市场，但现有研究依赖于有限的时间段，并且对交易时机背后的机制提供的见解有限。我们通过构建一个涵盖2012年至2023年所有美国国会议员及其直系亲属股票交易活动的新数据集，重新审视了这个问题。我们发现，平均而言，在《股票法案》之后，立法者的投资组合表现逊于或最多与市场基准持平。是什么导致了这种平庸的表现？我们表明，立法者的持仓追踪了金融专业人士的建议，并且他们的交易时机在很大程度上反映了从散户投资者社交媒体帖子中估计的当前市场情绪，而不是预测未来的价格变化。总之，这些结果表明，立法者可观察到的交易行为更符合跟随公开信号，而非系统性地利用私人信息获利。

【**NBER**】: NBER Working Paper No. 35041，https://www.nber.org/papers/w35041

#### 121. Investment-based Costs of Equity {#35040}

【**Author**】: Yicheng Liu, Chen Xue, Lu Zhang
...
【**摘要**】：q5特征模型通过截面回归的Lewellen（2015）样本外预测来估计股权成本。在评估测试中，q5股权成本具有竞争力，在预测截面收益方面优于会计隐含股权成本。q5股权成本在行业层面是精确的，并与平均因子溢价保持一致。其公司层面的分布呈弱左偏态，而会计隐含股权成本呈右偏态。然而，会计股权成本在时间序列上表现更优。因子模型在样本外测试中表现不佳。梯度提升树改进了截面回归，但效果不可靠。

【**NBER**】: NBER Working Paper No. 35040，https://www.nber.org/papers/w35040

#### 122. Measuring Organizational Capital {#35039}

【**Author**】: Wei Cai, Andrea Prat, Jiehang Yu
...
【**摘要**】：先前的研究指出，组织资本的差异是导致其他方面相似的公司在绩效上持续存在差异的原因。在本文中，我们开发并验证了一种新的组织资本衡量方法。基于从Glassdoor抓取的超过一百万条众包员工评论，我们使用词嵌入模型和ChatGPT生成的合成评论，在公司-年度层面构建了组织资本衡量指标。我们的衡量指标随时间变化，与宏观趋势一致，并且在公司之间和公司内部都存在差异，反映了公司的异质性和重大内部变化。我们通过检验先前文献中讨论的组织资本属性的实证预测来验证我们的衡量指标。我们的发现表明，该衡量指标捕捉了一种缓慢演变的无形资产，该资产与公司绩效和高层管理者的影响力显著相关，这与Dessein和Prat（2022）对组织资本的概念化相一致。我们进一步展示了我们的衡量指标在会计学、经济学、金融学和管理学文献中的应用。总之，本文为有兴趣评估和管理公司组织资本的各种利益相关者提供了启示。

【**NBER**】: NBER Working Paper No. 35039，https://www.nber.org/papers/w35039

#### 123. Immigrants at the Margin: Labor Market Effects of the Minimum Wage {#35038}

【**Author**】: Mark Borgschulte, Heepyung Cho, Darren Lubotsky
...
【**摘要**】：我们研究了美国最低工资对移民和本土工人的差异化影响。我们发现，最低工资的提高导致移民的工作时间减少，但对他们的就业没有影响。这些影响集中在高流动率行业中近期抵达、可能无证件的工人身上。本土工人没有表现出这种反应，即使考察与受影响最严重的移民具有相似特征的本土子群体也是如此。我们得出结论，受影响的移民劳动力市场具有低剩余、低投资的雇佣关系，工作时间灵活，但它们嵌入在替代成本异常高昂的劳动力市场中。

【**NBER**】: NBER Working Paper No. 35038，https://www.nber.org/papers/w35038

#### 124. Amortized Inference for Correlated Discrete Choice Models via Equivariant Neural Networks {#35037}

【**Author**】: Easton K. Huch, Michael P. Keane
...
【**摘要**】：离散选择模型是管理科学、经济学和市场营销中理解和预测决策的基本工具。基于Logit的模型在应用工作中占主导地位，这主要是由于其选择概率的便捷闭式表达式。然而，这些模型对随机效用成分施加了限制性假设，限制了我们在捕捉现实且具有理论依据的选择行为方面的能力——最显著的是替代模式。在这项工作中，我们提出了一种使用神经网络模拟器的摊销推断方法，以近似一般误差分布（包括具有相关误差的分布）的选择概率。我们的方案包括一个专门的神经网络架构和配套的训练程序，旨在尊重离散选择模型的等变性。我们为该架构提供了群论基础，包括在给定最小等变特征集下的通用近似证明。一旦训练完成，该模拟器能够实现快速的似然评估和梯度计算。我们使用Sobolev训练，通过梯度匹配惩罚增强似然损失，使模拟器同时学习选择概率及其导数。我们证明，在温和的近似条件下，基于模拟器的最大似然估计量是一致的且渐近正态的，并且我们提供了即使在似然近似不完美的情况下仍然有效的三明治标准误。模拟显示，在准确性和速度方面，该方法显著优于GHK模拟器。

【**NBER**】: NBER Working Paper No. 35037，https://www.nber.org/papers/w35037

#### 125. How AI Aggregation Affects Knowledge {#35036}

【**Author**】: Daron Acemoglu, Tianyi Lin, Asuman Ozdaglar, James Siderius
...
【**摘要**】：当聚合输出成为未来预测的训练数据时，人工智能会改变社会学习。为了研究这一点，我们扩展了DeGroot模型，引入了一个人工智能聚合器，该聚合器在总体信念上进行训练，并将合成信号反馈给代理人。我们将学习差距定义为长期信念与有效基准的偏差，从而能够捕捉人工智能聚合如何影响学习。我们的主要结果确定了更新速度的一个阈值：当聚合器更新过快时，不存在一组正测度的训练权重能够在广泛的环境类别中稳健地改善学习，而当更新足够慢时，这样的权重存在。然后，我们比较了全局架构和局部架构。基于邻近或主题特定数据训练的局部聚合器能够在所有环境中稳健地改善学习。因此，用单一的全局聚合器取代专门的局部聚合器会至少在一个状态维度上恶化学习。

【**NBER**】: NBER Working Paper No. 35036，https://www.nber.org/papers/w35036

#### 126. Liquidity-Driven Growth Cycles in Small Open Economies {#35035}

【**Author**】: Jess Benhabib, Feng Dong, Pengfei Wang, Zhenyang Xu
...
【**摘要**】：虽然标准的突然停止模型很好地解释了金融危机的剧烈性，但解释新兴市场通常由信贷驱动的资本账户自由化之后持续的增长停滞仍然具有挑战性。本文提出了一个具有内生增长和借贷约束的小型开放经济模型来解释这一现象。该模型强调了一种估值乐观的增长预期：由具有完全弹性供给的外国信贷推动，乐观的增长预期提高了资产价格并放松了流动性约束，从而诱导投资，验证了最初的乐观情绪。这种正反馈循环产生了多个平衡增长路径和自我实现的周期。然而，在封闭经济或仅有外商直接投资流入的情况下，投资的资金供给受到消费平滑的限制，削弱了这种反馈，导致唯一的增长路径。信念驱动的体制转换可以复制危机动态，包括资产价格和增长的急剧下降。该框架还表现出周期轨道，在完美预见下产生内生确定性波动。逆周期的宏观审慎措施可以打破有害的反馈循环，而优先考虑外商直接投资而非信贷的政策则完全阻止了坏均衡，引导经济走向稳定、高增长的轨迹。

【**NBER**】: NBER Working Paper No. 35035，https://www.nber.org/papers/w35035

#### 127. Thinking versus Doing: Cognitive Capacity, Decision Making and Medical Diagnosis {#35034}

【**Author**】: Benjamin R. Handel, Louis-Jonas Heizlsperger, Jonas Knecht, Jonathan T. Kolstad, Ulrike Malmendier, Filip Matějka
...
【**摘要**】：我们研究了认知能力的情境波动如何影响高风险、实时决策中的行为。借鉴行为经济学中围绕注意力不集中、认知和复杂性的最新进展，我们表明认知负荷会影响急诊科医生在做出诊断和治疗决策时如何分配脑力劳动和注意力。我们利用患者-医生配对的准随机变异，以及来自许多临床互动的细粒度电子病历和审计日志数据，来证明在更高的认知负荷下，医生会用数量更多但精确度更低的诊断行动来替代脑力思考。具体来说，我们记录了更高的负荷（i）增加了诊断测试的总订单数量，（ii）减少了针对性更强但不太常见的测试的使用，（iii）增加了常见测试的使用，以及（iv）增加了诊断信念的不确定性。认知负荷影响从急诊科到住院部的下游入院：与同一医生在最低认知负荷十分位数时相比，最高认知负荷十分位数的医生对完全相同类型的患者的入院率增加了28%。这些结果提供了关于注意力动态和信念形成的新颖实地证据，并揭示了认知约束如何在复杂的现实环境中塑造诊断行为。

【**NBER**】: NBER Working Paper No. 35034，https://www.nber.org/papers/w35034

#### 128. Real Effects of Nominal Interest Rates {#35033}

【**Author**】: Joshua K. Hausman, John V. Leahy, John Mondragon, Johannes Wieland
...
【**摘要**】：名义利率具有实际效应。住房抵押贷款和其他现实世界的债务合同要求一系列固定的名义支付。结合还款收入比约束，这些名义支付迫使借款人在名义利率上升时承担更少的债务，无论实际利率的行为如何。调查数据显示，在给定实际利率的条件下，较高的名义抵押贷款利率会降低购房情绪。而名义抵押贷款利率的增加在还款收入比约束更可能起作用的城市中，会更多地减少抵押贷款发放。我们在一个修改后包含信贷商品的新凯恩斯模型中探讨了还款收入比约束的宏观经济含义。还款收入比约束放大了当前短期名义利率对产出和通胀的影响，使得该模型比标准的新凯恩斯模型更不具前瞻性。

【**NBER**】: NBER Working Paper No. 35033，https://www.nber.org/papers/w35033

#### 129. Skill Formation, Child Labor, and the Schooling Consequences of the World War I Agricultural Boom {#35032}

【**Author**】: Taylor Jaworski, Carl T. Kitchens, Luke P. Rodgers
...
【**摘要**】：我们研究了一战农产品价格繁荣如何影响美国高中运动早期几十年间的人力资本积累。首先，基于新收集的县级入学数据，我们发现入学率和平均每日出勤率在繁荣高峰期急剧下降。其次，利用1910年至1940年间的关联人口普查数据，我们发现青少年时期受到更大影响使完成学业年限减少了0.27至0.47年，其中最大的影响集中在高中阶段。对于年龄较小的儿童，家庭资源增加的净效应取决于当地童工强度：在童工盛行的县，父母收入提高对完成学业的正面影响被抵消。我们的结果与技能形成中的动态互补性一致，这种互补性对终身教育的影响受到童工机会成本的调节。

【**NBER**】: NBER Working Paper No. 35032，https://www.nber.org/papers/w35032

#### 130. Adversarial Selection {#35031}

【**Author**】: Alma Cohen, Alon Klement, Zvika Neeman, Eilon Solan
...
【**摘要**】：在许多制度环境中，选择k个项目旨在代表大量人口中主张、意见或特征的潜在分布。我们研究有两个对抗方且其项目偏好已知且对立的环境。我们提出分位数机制：一方将人口划分为k个不相交的子集，另一方从每个子集中选择一个项目。我们证明，在所有可行机制中，该程序具有最优的代表性，并说明其在陪审团选择、多地区诉讼和委员会组建中的应用。

【**NBER**】: NBER Working Paper No. 35031，https://www.nber.org/papers/w35031

#### 131. A Gender Quota for Top Executives: Diversity without Disruption {#35030}

【**Author**】: David A. Matsa, Amalia R. Miller
...
【**摘要**】：我们研究了德国具有里程碑意义的配额制度，该制度要求大型上市公司的高管团队中至少包括一名女性。该配额使高管层中的女性比例提高了约三分之二。企业主要从自身网络之外招募女性，且这些女性此前没有上市公司高管经验，企业选择她们而非具有类似背景的男性候选人。大多数女性被任命为人力资源或利基职位，女性首席执行官的数量没有增加。我们发现，该配额对较低层级管理层的女性比例、促进性别平等的政策、企业价值或绩效没有显著影响。总体而言，该配额在未造成太多破坏的情况下提升了多样性。

【**NBER**】: NBER Working Paper No. 35030，https://www.nber.org/papers/w35030

#### 132. Climate Change, Deforestation, and the Expansion of the Global Agricultural Frontier {#35029}

【**Author**】: Allan Hsiao, Jacob Moscona, Benjamin A. Olken, Karthik A. Sastry
...
【**摘要**】：本文研究全球变暖如何影响森林砍伐和农业用地。利用2001年至2019年全球温度、森林砍伐和土地覆盖的高分辨率卫星数据，我们发现农业生产力遭受极端热冲击会导致全球农业边疆出现大规模且持久的森林损失。这种效应在热带地区、种植对温度最敏感作物的地区以及农产品需求最缺乏弹性的地区最为强烈，且似乎未被国际溢出效应所抵消。此外，我们表明，对极端热量的森林砍伐反应几乎完全可以由耕地扩张来解释。我们利用巴西的农业普查数据证实了这些发现，并找到了一个机制的证据：热量降低产量并提高当地农产品价格，从而推动耕地扩张，但在其他方面几乎没有土地利用或投入调整。我们的估计表明，极端热量已导致大量森林损失，而到2100年预计的变暖可能导致额外2800万公顷的森林砍伐。我们的发现挑战了重新分配将缓解气候变化环境后果的观点，反而表明当生产力下降时，农民会加倍努力并在当地扩大耕地。

【**NBER**】: NBER Working Paper No. 35029，https://www.nber.org/papers/w35029

#### 133. Which U.S. States Suffered a Greater Great Depression and Why? {#35028}

【**Author**】: Dong Cheng, Mario J. Crucini, Hanjo T. Kim
...
【**摘要**】：1929年至1932年间，美国实际国内生产总值总量下降了约26%，但大萧条的严重程度在各州之间差异巨大：马里兰州经消费者价格指数平减的人均收入下降了15%，而南达科他州下降了48%。为分析这种异质性，我们将Slaughter（1937）所有48个州的按部门生产收入面板数据数字化，并构建了一套新的按部门和州特定的平减指数，使我们能够将实际生产数量的变动与大萧条期间发生的巨大相对价格变化分离开来。然后，我们约束一个三部门、48区域的动态空间随机一般均衡模型，并恢复出完全再现观察到的部门-州数量路径的部门-州生产率冲击序列。平减指数的选择至关重要，因为正确的平减将总体收缩从农业转向制造业，同时保留了农业依赖州之间特有的收入差异。我们进一步表明，基于共同冲击甚至部门特定冲击的叙事与观察到的州级数量和相对价格的演变不一致。因此，解释大萧条的地理分布需要高维度的部门-州冲击结构。

【**NBER**】: NBER Working Paper No. 35028，https://www.nber.org/papers/w35028

#### 134. Subjective Earnings and Employment Dynamics {#35027}

【**Author**】: Manuel Arellano, Orazio Attanasio, Margherita Borella, Mariacristina De Nardi, Gonzalo Paz-Pardo
...
【**摘要**】：我们利用纽约联邦储备银行消费者预期调查的主观预期数据，开发了一种估计收入、工作和就业动态的新方法。这些数据提供了关于未来收入报价和接受概率的信念，直接提供了反事实结果的信息，并能在更弱的假设下进行识别。我们的框架避免了使用实现结果的模型中因选择和未观测异质性而产生的偏差。第一步的固定效应回归识别了风险、持续性和转换效应；第二步的广义矩估计恢复了未观测异质性（如能力、流动性和匹配质量）的协方差结构。我们发现个体生产力成分的风险和持续性低于先前研究，但能力和匹配质量的异质性更大。模拟表明，简化形式估计因工作转换和分类而夸大了个体层面生产力的持续性和波动性。在考虑异质性后，波动性下降并在收入分布中变得平坦。这些结果凸显了预期数据的价值。

【**NBER**】: NBER Working Paper No. 35027，https://www.nber.org/papers/w35027

#### 135. How Responsive are Durables Expenditures to Transitory Income Shocks? {#35026}

【**Author**】: Christoph E. Boehm, Changseok Ma
...
【**摘要**】：我们利用2008年《经济刺激法案》带来的变化，估计了耐用品支出如何响应暂时性收入冲击。估计的响应很大：家庭在收到收入转移后的三个月内，仅耐用品一项就花费了约80%的刺激款项。大部分支出用于机动车，无论是融资购买、二手车还是两者兼有，而耐用品总响应中约20%用于较小物品。为购买机动车，平均家庭利用汽车贷款每美元杠杆了40美分。我们的发现表明，耐用品及其融资是理解当前收入与支出之间联系的关键。

【**NBER**】: NBER Working Paper No. 35026，https://www.nber.org/papers/w35026

#### 136. Pharmaceutical Advertising in Dynamic Equilibrium {#35025}

【**Author**】: Pierre Dubois, Ariel Pakes

【**Abstract**】: Direct-to-consumer advertising (DTCA) of prescription drugs may expand treatment access but also risks promoting overuse and business stealing without generating welfare gains. Among developed nations, only the United States and New Zealand permit DTCA, whereas detailing - promotion aimed at prescribers - is widely practiced. This paper analyzes the impact of DTCA on profits by modeling a counterfactual environment in which DTCA is banned. This is implemented through a dynamic equilibrium framework that adapts the Experience-Based Equilibrium (Fershtman and Pakes, 2012) for empirical analysis. EBE incorporates constraints on the cognitive abilities of decision-makers and mitigates researchers’ computational concerns. Using data from four therapeutic markets, we first validate the EBE’s ability to replicate observed advertising patterns, then simulate counterfactual DTCA bans. Both the data and our empirical work indicate that DTCA and detailing are strong complements in generating current profits, and our results illuminate the need to account for this when evaluating the ban. The ban leads firms to reduce detailing and has a negative effect on profits in all markets, but the magnitude of the effect varies from under 5% in the market for Ulcer to 27.5% for Asthma medications.

【**摘要**】：处方药直接面向消费者广告可能扩大治疗可及性，但也存在促进过度使用和业务窃取而不产生福利收益的风险。在发达国家中，只有美国和新西兰允许直接面向消费者广告，而面向处方者的推广——即“详细说明”——则被广泛实践。本文通过模拟直接面向消费者广告被禁止的反事实环境，分析其对利润的影响。这是通过一个动态均衡框架实现的，该框架将基于经验的均衡（Fershtman and Pakes, 2012）应用于实证分析。基于经验的均衡纳入了决策者认知能力的约束，并减轻了研究者的计算问题。利用四个治疗市场的数据，我们首先验证了基于经验的均衡复制观察到的广告模式的能力，然后模拟了反事实的直接面向消费者广告禁令。数据和我们的实证工作都表明，直接面向消费者广告和详细说明在产生当前利润方面是强互补品，我们的结果阐明了在评估禁令时需要考虑这一点。禁令导致企业减少详细说明，并对所有市场的利润产生负面影响，但影响幅度从溃疡药物市场低于5%到哮喘药物市场的27.5%不等。

【**NBER**】: NBER Working Paper No. 35025，https://www.nber.org/papers/w35025

#### 137. Learning How To Borrow in a Fintech World: Consumer Behavior When Search Costs Are (Near) Zero {#35024}

【**Author**】: Alex Günsberg, Camelia M. Kuhnen
...
【**摘要**】：在线贷款市场正在改变消费贷款。本文研究了搜索成本近乎为零的这类市场中的消费者行为。利用包含73万份申请、75万份报价和20万个个体的行政数据，并结合信用登记记录，我们记录了四个事实。第一，同一申请人收到的报价条件存在显著差异，这使得搜索极具价值。第二，市场平台的助推措施减轻了选择的复杂性。第三，申请人会进行大量搜索，反复申请、要求不同条件并拒绝报价，其行为方式与其信用状况相符。第四，动态逆向选择限制了搜索，因为贷方会惩罚重复申请人。我们的研究结果凸显了搜索带来的信息收益与声誉成本和认知成本之间的权衡。

【**NBER**】: NBER Working Paper No. 35024，https://www.nber.org/papers/w35024

#### 138. Tariffs, Global Value Chains, and the Incidence of Protection: Evidence from US Automobiles {#35023}

【**Author**】: Luke Heeney, Christopher R. Knittel, Jasdeep Mandia
...
【**摘要**】：在许多现代产业中，企业在差异化产品市场上竞争，同时依赖复杂的全球价值链获取中间投入。在此背景下，对车辆和零部件征收关税等贸易政策不仅通过消费者替代和企业定价发挥作用，还通过企业的成本结构和采购决策产生影响。我们构建了一个美国汽车市场的结构模型，该模型整合了随机系数需求、多产品企业定价以及一个灵活的供给侧框架，在该框架中，进口零部件成本冲击会不完全地传导至制造商的边际成本。该模型受到新颖的模型层面进口零部件敞口数据的约束，并利用汇率变动来识别成本传导。我们的反事实分析量化了替代性关税政策对价格、利润和福利的影响。首先，仅对进口车辆征收关税会将需求重新分配给国内组装的产品，并增加美国生产者剩余，为美国总部企业带来约10亿美元的收益，同时使消费者剩余减少约140亿美元。其次，将关税扩展到进口中间投入品会从根本上改变这些影响：消费者剩余损失大约翻倍，美国总部企业的生产者剩余下降约26亿美元。这些总体效应掩盖了显著的异质性：对进口零部件敞口较大的企业遭受损失，而更依赖国内投入的企业则更能增加利润。总体而言，结果表明关税的影响关键取决于企业对全球价值链的敞口，不能仅从最终组装地点推断。

【**NBER**】: NBER Working Paper No. 35023，https://www.nber.org/papers/w35023

#### 139. AI Patents in the United States and China: Measurement, Organization, and Knowledge Flows {#35022}

【**Author**】: Hanming Fang, Xian Gu, Hanyin Yan, Wu Zhu
...
【**摘要**】：我们开发了一个高精度分类器来测度人工智能（AI）专利，方法是在美国专利商标局（USPTO）AI专利数据集的人工标注数据上对PatentSBERTa进行微调。我们的分类器显著改进了现有的USPTO方法，实现了97.0%的精确率、91.3%的召回率和94.0%的F1分数，并且基于引文和词汇验证，该分类器能很好地泛化到中国专利。将其应用于已授权的美国专利（1976-2023年）和中国专利（2010-2023年），我们记录了两国AI专利的快速增长，以及AI专利密度和子领域构成的广泛趋同，即使中国在近年的年度专利数量上超过了美国。然而，AI创新的组织方式存在显著差异：美国AI专利集中在大型私营在位企业和成熟中心，而中国AI专利在地理上更分散、在制度上更多元，大学和国有企业的角色更为突出。对于上市公司而言，AI专利在两国都带来了强劲的市场价值溢价。跨境引文显示的是持续的技术相互依存而非脱钩，中国AI发明家对美国前沿知识的依赖程度高于美国对中国知识的依赖。

【**NBER**】: NBER Working Paper No. 35022，https://www.nber.org/papers/w35022

#### 140. The Empathy Channel in Fertility {#35021}

【**Author**】: Sebastian Galiani, Raul A. Sosa
...
【**摘要**】：身边有婴儿会让人想要孩子。我们将这一观察形式化为共情渠道：在社会环境中接触婴儿会激活神经生物学机制，从而增加为人父母的愿望。随着孩子变得越来越稀缺，这种情感刺激会减弱，进一步削弱生育动机。我们将这一机制嵌入一个两组群重叠世代数量-质量模型中。共情渠道产生正外部性，因为每一次生育都会提高他人对孩子的渴望，使得分散均衡无效率。我们刻画了最优的每个孩子补贴，并表明一阶庇古税率会大幅超过一般均衡最优值。最优目标规则遵循类似拉姆齐的逻辑，将补贴导向每财政美元产生最大外部性的组群，而非每个孩子产生最大外部性的组群。校准后的模型表明，共情渠道可以解释3-33%的生育率下降，基线值为13.4%。在此基线值下，庇古超额为23-32%，最优补贴以消费等价计算使福利提高0.22%。

【**NBER**】: NBER Working Paper No. 35021，https://www.nber.org/papers/w35021

#### 141. Why Do Americans No Longer Work So Much More Than Non-Americans? {#35020}

【**Author**】: Serdar Birinci, Loukas Karabarbounis, Kurt See
...
【**摘要**】：在1990年代，美国人过去比非美国人工作多得多。如今，工作时间差距大约有一半已经逆转。为了评估工作时间的趋同，我们开发了一个易于处理的劳动供给模型，该模型融入了个体间的多种异质性来源、参与决策的广延边际、多成员家庭以及针对非就业状态的复杂税收和福利体系。利用来自微观层面和总体数据集的详细测量，我们识别了不同国家个体间的模型参数和异质性来源。我们对相互竞争的解释进行了赛马分析，发现2000年后美国人均工作时间下降主要是由于向非就业者提供的政府健康福利增加。非美国国家为非就业者提供了慷慨的福利，但这种慷慨程度随时间的变化不如美国那么大，并且公共健康覆盖不依赖于就业状态或收入水平。对于这些国家，劳动供给的增加通常由多种因素共同解释，例如工资上涨和工作负效用的下降。

【**NBER**】: NBER Working Paper No. 35020，https://www.nber.org/papers/w35020

#### 142. Can Personal Access to Medical Expertise Overcome Vaccine Hesitancy? {#35019}

【**Author**】: D. Mark Anderson, Ron Diris, Raymond Montizaan, Daniel I. Rees
...
【**摘要**】：利用荷兰医学院申请者及其年长亲属（即60岁以上的父母、姑姨和叔舅）的数据，我们估计了个人接触医学专业知识对疫苗犹豫的影响。利用决定医学院录取的抽签结果的变化，我们发现，家中有医生会增加遵循政府建议（即所有59岁以上人群接种第二剂COVID-19疫苗加强针）的可能性。我们估计的影响在家中有女医生时最为显著，这表明医学专业知识的沟通方式存在重要的性别差异。

【**NBER**】: NBER Working Paper No. 35019，https://www.nber.org/papers/w35019

#### 143. Market Power in Mortgage Pricing: the Role of Referral Lending {#35015}

【**Author**】: Dayin Zhang, Panle Jia Barwick, Lu Han, Jonathan Kroah

【**Abstract**】: Despite intense competition among mortgage lenders, borrowers face substantial price dispersion. We argue that realtor–loan officer referral networks are a key source of lender market power: by steering homebuyers toward a small set of loan officers, these networks restrict effective borrower choice even in competitive markets. Using a novel dataset linking 81,306 realtors to 102,860 loan officers across 41 states, we document that such networks are pervasive and highly concentrated — 85% of realtors direct over 40% of their clients to fewer than four loan officers — and that this concentration persists and even increases in markets with more lenders. IV estimates indicate that borrowers using referred loan officers pay 18.6 basis points higher mortgage rates, equivalent to $\$2,609$ in upfront costs on the average loan of $\$306$K. Referral lending raises rate spreads by 36.5% and accounts for half of the residual cross-sectional variation in spreads. The premium is nearly three times as large for Hispanic borrowers as for White borrowers, and is systematically higher for Black borrowers and financially constrained households. We identify two channels: referrals reduce borrowers' search intensity across lenders, and referred loan officers exercise pricing power relative to colleagues within the same institution. Efficiency gains from faster processing and reduced denial risk do not offset the additional costs.

【**摘要**】：尽管抵押贷款机构之间存在激烈竞争，但借款人面临显著的价格离散。我们认为，房地产经纪人-贷款官员推荐网络是贷款机构市场势力的一个关键来源：通过将购房者引导至一小部分贷款官员，这些网络即使在竞争激烈的市场中也限制了借款人的有效选择。利用一个将41个州的81,306名房地产经纪人与102,860名贷款官员联系起来的新数据集，我们记录了此类网络普遍存在且高度集中——85%的房地产经纪人将超过40%的客户引导至少于四名贷款官员——并且这种集中度在拥有更多贷款机构的市场中持续存在甚至增加。IV估计表明，使用推荐贷款官员的借款人支付的抵押贷款利率高出18.6个基点，相当于平均30.6万美元贷款中2,609美元的前期成本。推荐贷款使利率利差提高了36.5%，并解释了利差横截面残差变异的一半。对于西班牙裔借款人，这一溢价几乎是白人借款人的三倍，并且对于黑人借款人和财务受限家庭系统性更高。我们识别出两个渠道：推荐减少了借款人在不同贷款机构间的搜索强度，并且被推荐的贷款官员相对于同一机构内的同事行使定价权。更快处理和降低拒绝风险带来的效率提升并不能抵消额外成本。

【**NBER**】: NBER Working Paper No. 35015，https://www.nber.org/papers/w35015
