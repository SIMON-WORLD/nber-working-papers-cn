...
- RSS Feed：`https://simon-world.github.io/nber-working-papers-cn/feed.xml`
- JSON Feed：`https://simon-world.github.io/nber-working-papers-cn/feed.json`
- 访问统计采用可选的 Cloudflare Web Analytics；未配置统计 token 时，站点不会加载第三方统计脚本。
...
<p align="center">
  <img src="docs/assets/images/academic-door-qr.jpg" alt="学术传送门微信公众号二维码" width="180">
</p>
